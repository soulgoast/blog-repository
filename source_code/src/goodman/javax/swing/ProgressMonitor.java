...
import goodman.javax.swing.JProgressBar;
...
public class ProgressMonitor implements Accessible
{
    ...
    private ProgressMonitor(Component parentComponent,
        ...
        cancelOption[0] = javax.swing.UIManager.getString("OptionPane.cancelButtonText");
    ...
    private class ProgressOptionPane extends javax.swing.JOptionPane
    {
        ...
        public javax.swing.JDialog createDialog(Component parentComponent, String title) {
            ...
            if (window instanceof Frame) {
                dialog = new javax.swing.JDialog((Frame)window, title, false);
            } else {
                dialog = new JDialog((Dialog)window, title, false);
            }
            if (window instanceof javax.swing.SwingUtilities.SharedOwnerFrame) {
    ...
    protected class AccessibleProgressMonitor extends AccessibleContext
        ...
        public int getIndexAtPoint(Point p) {
            ...
            if (at != null && sameWindowAncestor(pane, noteLabel)) {
                ...
                Point noteLabelPoint = javax.swing.SwingUtilities.convertPoint(pane,
                                                                   p,
                                                                   noteLabel);
        ...
        public Rectangle getCharacterBounds(int i) {
            ...
            if (at != null && sameWindowAncestor(pane, noteLabel)) {
                ...
                if (noteLabelRect != null) {
                    return javax.swing.SwingUtilities.convertRectangle(noteLabel,
                                                           noteLabelRect,
                                                           pane);
                }
            }
