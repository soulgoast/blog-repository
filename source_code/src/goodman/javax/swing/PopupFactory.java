...
public class PopupFactory {
     ...
     */
    public javax.swing.Popup getPopup(Component owner, Component contents,
        ...
        javax.swing.Popup popup = getPopup(owner, contents, x, y, popupType);
    ...
    private int getPopupType(Component owner, Component contents,
        ...
        if (owner == null || invokerInHeavyWeightPopup(owner)) {
            popupType = HEAVY_WEIGHT_POPUP;
                 ...
                 !(contents instanceof javax.swing.JPopupMenu)) {
        ...
        while (c != null) {
            if (c instanceof javax.swing.JComponent) {
                if (((javax.swing.JComponent)c).getClientProperty(
     ...
     * <code>popupType</code>.
     */
    private javax.swing.Popup getPopup(Component owner, Component contents,
        ...
        case HEAVY_WEIGHT_POPUP:
            javax.swing.Popup popup = getHeavyWeightPopup(owner, contents, ownerX, ownerY);
     ...
     */
    private javax.swing.Popup getHeadlessPopup(Component owner, Component contents,
                                               int ownerX, int ownerY) {
     ...
     */
    private javax.swing.Popup getLightWeightPopup(Component owner, Component contents,
                                                  int ownerX, int ownerY) {
     ...
     */
    private javax.swing.Popup getMediumWeightPopup(Component owner, Component contents,
                                                   int ownerX, int ownerY) {
     ...
     */
    private javax.swing.Popup getHeavyWeightPopup(Component owner, Component contents,
                                                  int ownerX, int ownerY) {
        if (GraphicsEnvironment.isHeadless()) {
            return getMediumWeightPopup(owner, contents, ownerX, ownerY);
        }
    ...
    private boolean invokerInHeavyWeightPopup(Component i) {
        if (i != null) {
            ...
            for(parent = i.getParent() ; parent != null ; parent =
                    parent.getParent()) {
                if (parent instanceof javax.swing.Popup.HeavyWeightWindow) {
                    return true;
                }
            }
        }
     ...
     */
    private static class HeavyWeightPopup extends javax.swing.Popup {
         ...
         */
        static javax.swing.Popup getHeavyWeightPopup(Component owner, Component contents,
                                                     int ownerX, int ownerY) {
            ...
            if(contents != null && contents.isFocusable()) {
                if(contents instanceof javax.swing.JPopupMenu) {
                    javax.swing.JPopupMenu jpm = (javax.swing.JPopupMenu) contents;
            ...
            if (popup == null ||
                ((javax.swing.JWindow) popup.getComponent())
            ...
            if(focusPopup) {
                javax.swing.JWindow wnd = (javax.swing.JWindow) popup.getComponent();
        ...
        private static void recycleHeavyWeightPopup(HeavyWeightPopup popup) {
            synchronized (HeavyWeightPopup.class) {
                ...
                if (window instanceof javax.swing.Popup.DefaultFrame ||
                                      !window.isVisible()) {
     ...
     */
    private static class ContainerPopup extends javax.swing.Popup {
        ...
        void reset(Component owner, Component contents, int ownerX,
                   int ownerY) {
            if ((owner instanceof javax.swing.JFrame) || (owner instanceof javax.swing.JDialog) ||
                                                 (owner instanceof javax.swing.JWindow)) {
    ...
    private static class HeadlessPopup extends ContainerPopup {
        static javax.swing.Popup getHeadlessPopup(Component owner, Component contents,
                                                  int ownerX, int ownerY) {
    ...
    private static class LightWeightPopup extends ContainerPopup {
         ...
         */
        static javax.swing.Popup getLightWeightPopup(Component owner, Component contents,
                                                     int ownerX, int ownerY) {
        ...
        public void show() {
            ...
            if (parent instanceof javax.swing.JLayeredPane) {
                parent.add(component, javax.swing.JLayeredPane.POPUP_LAYER, 0);
            } else {
        ...
        Component createComponent(Component owner) {
            javax.swing.JComponent component = new JPanel(new BorderLayout(), true);
        ...
        void reset(Component owner, Component contents, int ownerX,
            ...
            javax.swing.JComponent component = (JComponent)getComponent();
