...
public class ToolTipManager extends MouseAdapter implements MouseMotionListener  {
    ...
    javax.swing.JComponent insideComponent;
    ...
    private javax.swing.KeyStroke postTip;
    private javax.swing.KeyStroke hideTip;
    ...
    ToolTipManager() {
        enterTimer = new javax.swing.Timer(750, new insideTimerAction());
        ...
        postTip = javax.swing.KeyStroke.getKeyStroke(KeyEvent.VK_F1, InputEvent.CTRL_MASK);
        hideTip =  javax.swing.KeyStroke.getKeyStroke(KeyEvent.VK_ESCAPE, 0);
    }
    ...
    void showTipWindow() {
        ...
        boolean leftToRight
                = javax.swing.SwingUtilities.isLeftToRight(insideComponent);
...
;
        ...
        if (x>0 || y>0) {
            popupFactory.setPopupType(javax.swing.PopupFactory.MEDIUM_WEIGHT_POPUP);
        } else {
            popupFactory.setPopupType(javax.swing.PopupFactory.LIGHT_WEIGHT_POPUP);
        }
            }
            else {
                popupFactory.setPopupType(javax.swing.PopupFactory.MEDIUM_WEIGHT_POPUP);
        ...
        tipWindow.show();
            ...
            Window componentWindow = javax.swing.SwingUtilities.windowForComponent(
                                                    insideComponent);

            window = javax.swing.SwingUtilities.windowForComponent(tip);
    ...
    public static ToolTipManager sharedInstance() {
        Object value = javax.swing.SwingUtilities.appContextGet(TOOL_TIP_MANAGER_KEY);
        if (value instanceof ToolTipManager) {
            return (ToolTipManager) value;
        }
        ToolTipManager manager = new ToolTipManager();
        javax.swing.SwingUtilities.appContextPut(TOOL_TIP_MANAGER_KEY, manager);
        return manager;
    }
        ...
        if (window != null && event.getSource() == window && insideComponent != null) {
          ...
          // we need to check if it if overlapping the inside component
            ...
            if (insideComponentWindow != null) {
                Point location = event.getPoint();
                javax.swing.SwingUtilities.convertPointToScreen(location, window);

                location.x -= insideComponentWindow.getX();
                location.y -= insideComponentWindow.getY();

                location = javax.swing.SwingUtilities.convertPoint(null, location, insideComponent);
            ...
            Window win = javax.swing.SwingUtilities.getWindowAncestor(insideComponent);
            if (win != null) {  // insideComponent may have been hidden (e.g. in a menu)
                Point location = javax.swing.SwingUtilities.convertPoint(insideComponent,
                                                             event.getPoint(),
                                                             win);
    ...
    public void mouseMoved(MouseEvent event) {
        if (tipShowing) {
            ...
            insideComponent = (javax.swing.JComponent)event.getSource();
            mouseEvent = event;
            toolTipText = null;
            enterTimer.restart();
        }
  ...
  private int getPopupFitWidth(Rectangle popupRectInScreen, Component invoker){
    if (invoker != null){
      ...
      for (parent = invoker.getParent(); parent != null; parent = parent.getParent()){
        ...
        if(parent instanceof javax.swing.JFrame || parent instanceof javax.swing.JDialog ||
           parent instanceof javax.swing.JWindow) { // no check for awt.Frame since we use Heavy tips
          return getWidthAdjust(parent.getBounds(),popupRectInScreen);
        } else if (parent instanceof javax.swing.JApplet || parent instanceof javax.swing.JInternalFrame) {
  ...
  private int getWidthAdjust(Rectangle a, Rectangle b){
    ...
    private class AccessibilityKeyListener extends KeyAdapter {
        public void keyPressed(KeyEvent e) {
            if (!e.isConsumed()) {
                javax.swing.JComponent source = (JComponent) e.getComponent();
                javax.swing.KeyStroke keyStrokeForEvent = KeyStroke.getKeyStrokeForEvent(e);
