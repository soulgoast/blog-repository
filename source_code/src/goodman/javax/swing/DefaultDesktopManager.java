...
import goodman.javax.swing.DesktopManager;
import goodman.javax.swing.JComponent;
import goodman.javax.swing.JDesktopPane;
import goodman.javax.swing.JInternalFrame;
import goodman.javax.swing.JLayeredPane;
import goodman.javax.swing.RepaintManager;
...
public class DefaultDesktopManager implements DesktopManager, java.io.Serializable {
    ...
    public void closeFrame(javax.swing.JInternalFrame f) {
        javax.swing.JDesktopPane d = f.getDesktopPane();
        if (d == null) {
            return;
        }
        boolean findNext = f.isSelected();
        Container c = f.getParent();
        javax.swing.JInternalFrame nextFrame = null;
        if (findNext) {
    ...
    public void iconifyFrame(javax.swing.JInternalFrame f) {
        ...
        if (c instanceof javax.swing.JLayeredPane) {
            javax.swing.JLayeredPane lp = (JLayeredPane)c;
    ...
    public void deiconifyFrame(javax.swing.JInternalFrame f) {
        javax.swing.JInternalFrame.JDesktopIcon desktopIcon = f.getDesktopIcon();
    ...
    public void activateFrame(javax.swing.JInternalFrame f) {
        ...
        Component[] c;
        javax.swing.JDesktopPane d = f.getDesktopPane();
        javax.swing.JInternalFrame currentlyActiveFrame =
    ...
    public void beginDraggingFrame(javax.swing.JComponent f) {
        ...
        if (dragMode == FASTER_DRAG_MODE) {
          ...
          if (desktop instanceof javax.swing.JComponent) {
              desktopBounds = ((javax.swing.JComponent)desktop).getVisibleRect();
          }
          else {
              desktopBounds = desktop.getBounds();
              desktopBounds.x = desktopBounds.y = 0;
          }
          desktopGraphics = javax.swing.JComponent.safelyGetGraphics(desktop);
          ((javax.swing.JInternalFrame)f).isDragging = true;
          didDrag = false;
        }
    ...
    private void setupDragMode(javax.swing.JComponent f) {
        javax.swing.JDesktopPane p = getDesktopPane(f);
        Container parent = f.getParent();
        dragMode = DEFAULT_DRAG_MODE;
        if (p != null) {
            String mode = (String)p.getClientProperty("JDesktopPane.dragMode");
            Window window = javax.swing.SwingUtilities.getWindowAncestor(f);
            if (window != null && !AWTUtilities.isWindowOpaque(window)) {
                ...
                dragMode = OUTLINE_DRAG_MODE;
                    ...
                    && f instanceof javax.swing.JInternalFrame
                    && ((javax.swing.JInternalFrame)f).isOpaque() &&
                       (parent == null || parent.isOpaque())) {
                dragMode = FASTER_DRAG_MODE;
            } else {
                if (p.getDragMode() == javax.swing.JDesktopPane.OUTLINE_DRAG_MODE ) {
                    dragMode = OUTLINE_DRAG_MODE;
                } else if ( p.getDragMode() == javax.swing.JDesktopPane.LIVE_DRAG_MODE
                        && f instanceof javax.swing.JInternalFrame
                        && ((javax.swing.JInternalFrame)f).isOpaque()) {
                    dragMode = FASTER_DRAG_MODE;
                } else {
    ...
    public void dragFrame(javax.swing.JComponent f, int newX, int newY) {
        ...
        if (dragMode == OUTLINE_DRAG_MODE) {
            javax.swing.JDesktopPane desktopPane = getDesktopPane(f);
            if (desktopPane != null){
              Graphics g = javax.swing.JComponent.safelyGetGraphics(desktopPane);
...
;
    ...
    public void endDraggingFrame(javax.swing.JComponent f) {
        if ( dragMode == OUTLINE_DRAG_MODE && currentLoc != null) {
            ...
            desktopBounds = null;
            ((javax.swing.JInternalFrame)f).isDragging = false;
        }
    }
    ...
    protected void removeIconFor(javax.swing.JInternalFrame f) {
        javax.swing.JInternalFrame.JDesktopIcon di = f.getDesktopIcon();
    ...
    protected Rectangle getBoundsForIconOf(javax.swing.JInternalFrame f) {
      //
      // Get the icon for this internal frame and its preferred size
      //

      javax.swing.JInternalFrame.JDesktopIcon icon = f.getDesktopIcon();
      ...
      javax.swing.JInternalFrame.JDesktopIcon currentIcon = null;
      ...
      while (!found) {
        ...
        for ( int i=0; i<components.length; i++ ) {
          ...
          if ( components[i] instanceof javax.swing.JInternalFrame) {
            currentIcon = ((javax.swing.JInternalFrame)components[i]).getDesktopIcon();
          }
          else if ( components[i] instanceof javax.swing.JInternalFrame.JDesktopIcon ){
            currentIcon = (javax.swing.JInternalFrame.JDesktopIcon)components[i];
          } else
     ...
     */
    protected void setPreviousBounds(javax.swing.JInternalFrame f, Rectangle r)     {
        f.setNormalBounds(r);
    }
     ...
     */
    protected Rectangle getPreviousBounds(javax.swing.JInternalFrame f)     {
     ...
     */
    protected void setWasIcon(javax.swing.JInternalFrame f, Boolean value)  {
        if (value != null) {
    ...
    javax.swing.JDesktopPane getDesktopPane(javax.swing.JComponent frame ) {
        javax.swing.JDesktopPane pane = null;
  ...
  // =========== stuff for faster frame dragging ===================
   ...
   // move the frame
      ...
      if (didDrag) {
          ...
          ((javax.swing.JInternalFrame)f).danger = false;
      }

      boolean floaterCollision = isFloaterCollision(previousBounds, currentBounds);

      javax.swing.JComponent parent = (javax.swing.JComponent)f.getParent();
      Rectangle visBounds = previousBounds.intersection(desktopBounds);

      javax.swing.RepaintManager currentManager = RepaintManager.currentManager(f);
      ...
      try {
          ...
          if ( previousBounds.intersects(currentBounds) ) {
              dirtyRects = javax.swing.SwingUtilities.computeDifference(previousBounds,
                                                            currentBounds);
          } else {
      ...
      Window topLevel = javax.swing.SwingUtilities.getWindowAncestor(f);
   ...
   private Rectangle[] findFloatingItems(javax.swing.JComponent f) {
   ...
   private void emergencyCleanup(final JComponent f) {
        ...
        if ( ((javax.swing.JInternalFrame)f).danger ) {
