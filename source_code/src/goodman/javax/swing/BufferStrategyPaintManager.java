...
import goodman.javax.swing.RootPaneContainer;
...
class BufferStrategyPaintManager extends RepaintManager.PaintManager {
     ...
     */
    private javax.swing.JComponent rootJ;
    /**
    ...
    public void copyArea(javax.swing.JComponent c, Graphics g, int x, int y, int w, int h,
     ...
     * cache we may have.
     */
    public void doubleBufferingChanged(final javax.swing.JRootPane rootPane) {
     ...
     */
    private void doubleBufferingChanged0(javax.swing.JRootPane rootPane) {
     ...
     */
    private boolean prepare(javax.swing.JComponent c, Container root, boolean isPaint, int x, int y,
                            int w, int h) {
        if (bsg != null) {
            bsg.dispose();
            bsg = null;
    ...
    private Container fetchRoot(javax.swing.JComponent c) {
        ...
        if ((root instanceof RootPaneContainer) &&
            (rootJ instanceof javax.swing.JRootPane)) {
