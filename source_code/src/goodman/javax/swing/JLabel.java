...
import goodman.javax.swing.plaf.LabelUI;
...
public class JLabel extends JComponent implements SwingConstants, Accessible
{
     ...
     *           <code>TRAILING</code>.
     */
    public JLabel(String text, javax.swing.Icon icon, int horizontalAlignment) {
        setText(text);
        setIcon(icon);
     ...
     *           <code>TRAILING</code>.
     */
    public JLabel(javax.swing.Icon image, int horizontalAlignment) {
    ...
    public void setIcon(javax.swing.Icon icon) {
        javax.swing.Icon oldValue = defaultIcon;
        defaultIcon = icon;
