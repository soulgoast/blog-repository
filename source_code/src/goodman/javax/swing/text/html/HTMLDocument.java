...
import goodman.java.awt.font.TextAttribute;
...
import goodman.javax.swing.text.html.*;
import goodman.javax.swing.text.html.CSS;
import goodman.javax.swing.text.html.HTML;
import goodman.javax.swing.text.html.Map;
import goodman.javax.swing.text.html.Option;
import goodman.javax.swing.text.html.StyleSheet;
 ...
 * element.</p>
 *
 * <p>The {@link #getIterator(javax.swing.text.html.HTML.Tag t)} method can also be used for
...
public class HTMLDocument extends DefaultStyledDocument {
     ...
     */
    public HTMLDocument() {
        this(new GapContent(BUFFER_SIZE_DEFAULT), new javax.swing.text.html.StyleSheet());
    }
     ...
     * @param styles the styles
     */
    public HTMLDocument(Content c, javax.swing.text.html.StyleSheet styles) {
        super(c, styles);
    }
    ...
    public javax.swing.text.html.StyleSheet getStyleSheet() {
        return (javax.swing.text.html.StyleSheet) getAttributeContext();
    }
     ...
     */
    public Iterator getIterator(javax.swing.text.html.HTML.Tag t) {
        if (t.isBlock()) {
            // TBD
            return null;
        }
    ...
    protected AbstractElement createDefaultRoot() {
        ...
        a.addAttribute(StyleConstants.NameAttribute, javax.swing.text.html.HTML.Tag.HTML);
        BlockElement html = new BlockElement(null, a.copyAttributes());
        a.removeAttributes(a);
        a.addAttribute(StyleConstants.NameAttribute, javax.swing.text.html.HTML.Tag.BODY);
        BlockElement body = new BlockElement(html, a.copyAttributes());
        a.removeAttributes(a);
        a.addAttribute(StyleConstants.NameAttribute, javax.swing.text.html.HTML.Tag.P);
        getStyleSheet().addCSSAttributeFromHTML(a, javax.swing.text.html.CSS.Attribute.MARGIN_TOP, "0");
        BlockElement paragraph = new BlockElement(body, a.copyAttributes());
        a.removeAttributes(a);
        a.addAttribute(StyleConstants.NameAttribute, javax.swing.text.html.HTML.Tag.CONTENT);
    ...
    private Element findFrame(String frameName) {
        ...
        while ((next = it.next()) != null) {
            ...
            if (matchNameAttribute(attr, javax.swing.text.html.HTML.Tag.FRAME)) {
                String frameTarget = (String)attr.getAttribute(javax.swing.text.html.HTML.Attribute.NAME);
     ...
     */
    static boolean matchNameAttribute(AttributeSet attr, javax.swing.text.html.HTML.Tag tag) {
    ...
    private void updateFrame(Element element, String url) {
        ...
        try {
            ...
            attr.removeAttribute(javax.swing.text.html.HTML.Attribute.SRC);
            attr.addAttribute(javax.swing.text.html.HTML.Attribute.SRC, url);
            changes.end();
            fireChangedUpdate(changes);
            fireUndoableEditUpdate(new UndoableEditEvent(this, changes));
        } finally {
    ...
    public void insertAfterEnd(Element elem, String htmlText) throws
        ...
        if (elem != null) {
            ...
            if (parent != null) {
                ...
                if (javax.swing.text.html.HTML.Tag.BODY.name.equals(parent.getName())) {
                    insertInBody = true;
                }
                int offset = elem.getEndOffset();
    ...
    public Element getElement(String id) {
        ...
        return getElement(getDefaultRootElement(), javax.swing.text.html.HTML.Attribute.ID, id,
                          true);
    }
        ...
        if (!e.isLeaf()) {
            ...
            if (names != null) {
                while (names.hasMoreElements()) {
                    ...
                    if ((name instanceof javax.swing.text.html.HTML.Tag) &&
    ...
    static class LeafIterator extends Iterator {
        ...
        LeafIterator(javax.swing.text.html.HTML.Tag t, Document doc) {
            tag = t;
    ...
    public class HTMLReader extends HTMLEditorKit.ParserCallback {
        ...
        HTMLReader(int offset, int popDepth, int pushDepth,
                   javax.swing.text.html.HTML.Tag insertTag, boolean insertInsertTag,
            ...
            tagMap = new Hashtable<javax.swing.text.html.HTML.Tag, TagAction>(57);
            ...
            tagMap.put(javax.swing.text.html.HTML.Tag.A, new AnchorAction());
            tagMap.put(javax.swing.text.html.HTML.Tag.ADDRESS, ca);
            tagMap.put(javax.swing.text.html.HTML.Tag.APPLET, ha);
            tagMap.put(javax.swing.text.html.HTML.Tag.AREA, new AreaAction());
            tagMap.put(javax.swing.text.html.HTML.Tag.B, conv);
            tagMap.put(javax.swing.text.html.HTML.Tag.BASE, new BaseAction());
            tagMap.put(javax.swing.text.html.HTML.Tag.BASEFONT, ca);
            tagMap.put(javax.swing.text.html.HTML.Tag.BIG, ca);
            tagMap.put(javax.swing.text.html.HTML.Tag.BLOCKQUOTE, ba);
            tagMap.put(javax.swing.text.html.HTML.Tag.BODY, ba);
            tagMap.put(javax.swing.text.html.HTML.Tag.BR, sa);
            tagMap.put(javax.swing.text.html.HTML.Tag.CAPTION, ba);
            tagMap.put(javax.swing.text.html.HTML.Tag.CENTER, ba);
            tagMap.put(javax.swing.text.html.HTML.Tag.CITE, ca);
            tagMap.put(javax.swing.text.html.HTML.Tag.CODE, ca);
            tagMap.put(javax.swing.text.html.HTML.Tag.DD, ba);
            tagMap.put(javax.swing.text.html.HTML.Tag.DFN, ca);
            tagMap.put(javax.swing.text.html.HTML.Tag.DIR, ba);
            tagMap.put(javax.swing.text.html.HTML.Tag.DIV, ba);
            tagMap.put(javax.swing.text.html.HTML.Tag.DL, ba);
            tagMap.put(javax.swing.text.html.HTML.Tag.DT, pa);
            tagMap.put(javax.swing.text.html.HTML.Tag.EM, ca);
            tagMap.put(javax.swing.text.html.HTML.Tag.FONT, conv);
            tagMap.put(javax.swing.text.html.HTML.Tag.FORM, new FormTagAction());
            tagMap.put(javax.swing.text.html.HTML.Tag.FRAME, sa);
            tagMap.put(javax.swing.text.html.HTML.Tag.FRAMESET, ba);
            tagMap.put(javax.swing.text.html.HTML.Tag.H1, pa);
            tagMap.put(javax.swing.text.html.HTML.Tag.H2, pa);
            tagMap.put(javax.swing.text.html.HTML.Tag.H3, pa);
            tagMap.put(javax.swing.text.html.HTML.Tag.H4, pa);
            tagMap.put(javax.swing.text.html.HTML.Tag.H5, pa);
            tagMap.put(javax.swing.text.html.HTML.Tag.H6, pa);
            tagMap.put(javax.swing.text.html.HTML.Tag.HEAD, new HeadAction());
            tagMap.put(javax.swing.text.html.HTML.Tag.HR, sa);
            tagMap.put(javax.swing.text.html.HTML.Tag.HTML, ba);
            tagMap.put(javax.swing.text.html.HTML.Tag.I, conv);
            tagMap.put(javax.swing.text.html.HTML.Tag.IMG, sa);
            tagMap.put(javax.swing.text.html.HTML.Tag.INPUT, fa);
            tagMap.put(javax.swing.text.html.HTML.Tag.ISINDEX, new IsindexAction());
            tagMap.put(javax.swing.text.html.HTML.Tag.KBD, ca);
            tagMap.put(javax.swing.text.html.HTML.Tag.LI, ba);
            tagMap.put(javax.swing.text.html.HTML.Tag.LINK, new LinkAction());
            tagMap.put(javax.swing.text.html.HTML.Tag.MAP, new MapAction());
            tagMap.put(javax.swing.text.html.HTML.Tag.MENU, ba);
            tagMap.put(javax.swing.text.html.HTML.Tag.META, new MetaAction());
            tagMap.put(javax.swing.text.html.HTML.Tag.NOBR, ca);
            tagMap.put(javax.swing.text.html.HTML.Tag.NOFRAMES, ba);
            tagMap.put(javax.swing.text.html.HTML.Tag.OBJECT, sa);
            tagMap.put(javax.swing.text.html.HTML.Tag.OL, ba);
            tagMap.put(javax.swing.text.html.HTML.Tag.OPTION, fa);
            tagMap.put(javax.swing.text.html.HTML.Tag.P, pa);
            tagMap.put(javax.swing.text.html.HTML.Tag.PARAM, new ObjectAction());
            tagMap.put(javax.swing.text.html.HTML.Tag.PRE, new PreAction());
            tagMap.put(javax.swing.text.html.HTML.Tag.SAMP, ca);
            tagMap.put(javax.swing.text.html.HTML.Tag.SCRIPT, ha);
            tagMap.put(javax.swing.text.html.HTML.Tag.SELECT, fa);
            tagMap.put(javax.swing.text.html.HTML.Tag.SMALL, ca);
            tagMap.put(javax.swing.text.html.HTML.Tag.SPAN, ca);
            tagMap.put(javax.swing.text.html.HTML.Tag.STRIKE, conv);
            tagMap.put(javax.swing.text.html.HTML.Tag.S, ca);
            tagMap.put(javax.swing.text.html.HTML.Tag.STRONG, ca);
            tagMap.put(javax.swing.text.html.HTML.Tag.STYLE, new StyleAction());
            tagMap.put(javax.swing.text.html.HTML.Tag.SUB, conv);
            tagMap.put(javax.swing.text.html.HTML.Tag.SUP, conv);
            tagMap.put(javax.swing.text.html.HTML.Tag.TABLE, ba);
            tagMap.put(javax.swing.text.html.HTML.Tag.TD, ba);
            tagMap.put(javax.swing.text.html.HTML.Tag.TEXTAREA, fa);
            tagMap.put(javax.swing.text.html.HTML.Tag.TH, ba);
            tagMap.put(javax.swing.text.html.HTML.Tag.TITLE, new TitleAction());
            tagMap.put(javax.swing.text.html.HTML.Tag.TR, ba);
            tagMap.put(javax.swing.text.html.HTML.Tag.TT, ca);
            tagMap.put(javax.swing.text.html.HTML.Tag.U, conv);
            tagMap.put(javax.swing.text.html.HTML.Tag.UL, ba);
            tagMap.put(javax.swing.text.html.HTML.Tag.VAR, ca);
            ...
            if (!emptyDocument && !midInsert) {
                ...
                if (attrs != null) {
                    javax.swing.text.html.HTML.Tag tagToInsertInto =
                            (javax.swing.text.html.HTML.Tag) attrs.getAttribute(StyleConstants.NameAttribute);
        ...
        private void generateEndsSpecsForMidInsert() {
            int           count = heightToElementWithName(javax.swing.text.html.HTML.Tag.BODY,
                                                   Math.max(0, offset - 1));
            boolean       joinNext = false;

            if (count == -1 && offset > 0) {
                count = heightToElementWithName(javax.swing.text.html.HTML.Tag.BODY, offset);
                if (count != -1) {
        ...
        private void adjustEndElement() {
            ...
            try {
                ...
                if (pLength > 1 && pPath[1].getAttributes().getAttribute
                         (StyleConstants.NameAttribute) == javax.swing.text.html.HTML.Tag.BODY &&
        ...
        public void handleStartTag(javax.swing.text.html.HTML.Tag t, MutableAttributeSet a, int pos) {
            ...
            if (midInsert && !inBody) {
                if (t == javax.swing.text.html.HTML.Tag.BODY) {
                    inBody = true;
            ...
            if (!inBody && t == javax.swing.text.html.HTML.Tag.BODY) {
                inBody = true;
            }
            if (isStyleCSS && a.isDefined(javax.swing.text.html.HTML.Attribute.STYLE)) {
                // Map the style attributes.
                String decl = (String)a.getAttribute(javax.swing.text.html.HTML.Attribute.STYLE);
                a.removeAttribute(javax.swing.text.html.HTML.Attribute.STYLE);
        ...
        public void handleComment(char[] data, int pos) {
            ...
            if (inStyle) {
                ...
                if (inBlock == 0 && (foundInsertTag ||
                                     insertTag != javax.swing.text.html.HTML.Tag.COMMENT)) {
                ...
                SimpleAttributeSet sas = new SimpleAttributeSet();
                sas.addAttribute(javax.swing.text.html.HTML.Attribute.COMMENT, new String(data));
                addSpecialElement(javax.swing.text.html.HTML.Tag.COMMENT, sas);
            }

            TagAction action = tagMap.get(javax.swing.text.html.HTML.Tag.COMMENT);
            if (action != null) {
                action.start(javax.swing.text.html.HTML.Tag.COMMENT, new SimpleAttributeSet());
                action.end(javax.swing.text.html.HTML.Tag.COMMENT);
            }
        }
        ...
        public void handleEndTag(javax.swing.text.html.HTML.Tag t, int pos) {
            ...
            if (t == javax.swing.text.html.HTML.Tag.HTML) {
         ...
         */
        protected void registerTag(javax.swing.text.html.HTML.Tag t, TagAction a) {
            tagMap.put(t, a);
        }
        ...
        public class TagAction {
             ...
             */
            public void start(javax.swing.text.html.HTML.Tag t, MutableAttributeSet a) {
            }
        ...
        public class BlockAction extends TagAction {
            ...
            public void start(javax.swing.text.html.HTML.Tag t, MutableAttributeSet attr) {
                blockOpen(t, attr);
            }
        ...
        public class IsindexAction extends TagAction {
            ...
            public void start(javax.swing.text.html.HTML.Tag t, MutableAttributeSet a) {
                blockOpen(javax.swing.text.html.HTML.Tag.IMPLIED, new SimpleAttributeSet());
                addSpecialElement(t, a);
                blockClose(javax.swing.text.html.HTML.Tag.IMPLIED);
            }
        ...
        public class HiddenAction extends TagAction {
            ...
            public void end(javax.swing.text.html.HTML.Tag t) {
                if (!isEmpty(t)) {
                    MutableAttributeSet a = new SimpleAttributeSet();
                    a.addAttribute(javax.swing.text.html.HTML.Attribute.ENDTAG, "true");
                    addSpecialElement(t, a);
                }
            }

            boolean isEmpty(javax.swing.text.html.HTML.Tag t) {
                if (t == javax.swing.text.html.HTML.Tag.APPLET ||
                    t == javax.swing.text.html.HTML.Tag.SCRIPT) {
                    return false;
                }
                return true;
            }
        ...
        class MetaAction extends HiddenAction {
            ...
            public void start(javax.swing.text.html.HTML.Tag t, MutableAttributeSet a) {
                Object equiv = a.getAttribute(javax.swing.text.html.HTML.Attribute.HTTPEQUIV);
                if (equiv != null) {
        ...
        class HeadAction extends BlockAction {
            ...
            public void start(javax.swing.text.html.HTML.Tag t, MutableAttributeSet a) {
                ...
                if ((insertTag == null && !insertAfterImplied) ||
                    (insertTag == javax.swing.text.html.HTML.Tag.HEAD) ||
                    (insertAfterImplied &&
            ...
            public void end(javax.swing.text.html.HTML.Tag t) {
                ...
                if (styles != null) {
                    ...
                    for (int counter = 0, maxCounter = styles.size();
                        ...
                        if (value == javax.swing.text.html.HTML.Tag.LINK) {
            ...
            private void handleLink(AttributeSet attr) {
                // Link.
                String type = (String)attr.getAttribute(javax.swing.text.html.HTML.Attribute.TYPE);
                if (type == null) {
                ...
                if (type.equals("text/css")) {
                    String rel = (String)attr.getAttribute(javax.swing.text.html.HTML.Attribute.REL);
                    String title = (String)attr.getAttribute
                                               (javax.swing.text.html.HTML.Attribute.TITLE);
                    String media = (String)attr.getAttribute
                                                   (javax.swing.text.html.HTML.Attribute.MEDIA);
                    if (media == null) {
                        media = "all";
                    }
                    else {
        ...
        class LinkAction extends HiddenAction {
            ...
            public void start(javax.swing.text.html.HTML.Tag t, MutableAttributeSet a) {
                String rel = (String)a.getAttribute(javax.swing.text.html.HTML.Attribute.REL);
                if (rel != null) {
                    rel = rel.toLowerCase();
        ...
        class MapAction extends TagAction {
            ...
            public void start(javax.swing.text.html.HTML.Tag t, MutableAttributeSet a) {
                lastMap = new javax.swing.text.html.Map((String)a.getAttribute(javax.swing.text.html.HTML.Attribute.NAME));
                addMap(lastMap);
            }
        ...
        class StyleAction extends TagAction {
            ...
            public void start(javax.swing.text.html.HTML.Tag t, MutableAttributeSet a) {
                if (inHead) {
                    ...
                    styles.addElement(t);
                    styles.addElement(a.getAttribute(javax.swing.text.html.HTML.Attribute.TYPE));
                    inStyle = true;
                }
            }
        ...
        public class PreAction extends BlockAction {
            ...
            public void start(javax.swing.text.html.HTML.Tag t, MutableAttributeSet attr) {
                inPre = true;
                blockOpen(t, attr);
                attr.addAttribute(javax.swing.text.html.CSS.Attribute.WHITE_SPACE, "pre");
                blockOpen(javax.swing.text.html.HTML.Tag.IMPLIED, attr);
            }
        ...
        class ConvertAction extends TagAction {
            ...
            public void start(javax.swing.text.html.HTML.Tag t, MutableAttributeSet attr) {
                ...
                if (t == javax.swing.text.html.HTML.Tag.B) {
                    sheet.addCSSAttribute(charAttr, javax.swing.text.html.CSS.Attribute.FONT_WEIGHT, "bold");
                } else if (t == javax.swing.text.html.HTML.Tag.I) {
                    sheet.addCSSAttribute(charAttr, javax.swing.text.html.CSS.Attribute.FONT_STYLE, "italic");
                } else if (t == javax.swing.text.html.HTML.Tag.U) {
                    Object v = charAttr.getAttribute(javax.swing.text.html.CSS.Attribute.TEXT_DECORATION);
                    String value = "underline";
                    value = (v != null) ? value + "," + v.toString() : value;
                    sheet.addCSSAttribute(charAttr, javax.swing.text.html.CSS.Attribute.TEXT_DECORATION, value);
                } else if (t == javax.swing.text.html.HTML.Tag.STRIKE) {
                    Object v = charAttr.getAttribute(javax.swing.text.html.CSS.Attribute.TEXT_DECORATION);
                    String value = "line-through";
                    value = (v != null) ? value + "," + v.toString() : value;
                    sheet.addCSSAttribute(charAttr, javax.swing.text.html.CSS.Attribute.TEXT_DECORATION, value);
                } else if (t == javax.swing.text.html.HTML.Tag.SUP) {
                    Object v = charAttr.getAttribute(javax.swing.text.html.CSS.Attribute.VERTICAL_ALIGN);
                    String value = "sup";
                    value = (v != null) ? value + "," + v.toString() : value;
                    sheet.addCSSAttribute(charAttr, javax.swing.text.html.CSS.Attribute.VERTICAL_ALIGN, value);
                } else if (t == javax.swing.text.html.HTML.Tag.SUB) {
                    Object v = charAttr.getAttribute(javax.swing.text.html.CSS.Attribute.VERTICAL_ALIGN);
                    String value = "sub";
                    value = (v != null) ? value + "," + v.toString() : value;
                    sheet.addCSSAttribute(charAttr, javax.swing.text.html.CSS.Attribute.VERTICAL_ALIGN, value);
                } else if (t == javax.swing.text.html.HTML.Tag.FONT) {
                    String color = (String) attr.getAttribute(javax.swing.text.html.HTML.Attribute.COLOR);
                    if (color != null) {
                        sheet.addCSSAttribute(charAttr, javax.swing.text.html.CSS.Attribute.COLOR, color);
                    }
                    String face = (String) attr.getAttribute(javax.swing.text.html.HTML.Attribute.FACE);
                    if (face != null) {
                        sheet.addCSSAttribute(charAttr, javax.swing.text.html.CSS.Attribute.FONT_FAMILY, face);
                    }
                    String size = (String) attr.getAttribute(javax.swing.text.html.HTML.Attribute.SIZE);
                    if (size != null) {
                        sheet.addCSSAttributeFromHTML(charAttr, javax.swing.text.html.CSS.Attribute.FONT_SIZE, size);
                    }
                }
            }
        ...
        class BaseAction extends TagAction {
            ...
            public void start(javax.swing.text.html.HTML.Tag t, MutableAttributeSet attr) {
                String href = (String) attr.getAttribute(javax.swing.text.html.HTML.Attribute.HREF);
                if (href != null) {
                    try {
                ...
                baseTarget = (String) attr.getAttribute(javax.swing.text.html.HTML.Attribute.TARGET);
            }
        }
        ...
        class ObjectAction extends SpecialAction {
            ...
            public void start(javax.swing.text.html.HTML.Tag t, MutableAttributeSet a) {
                if (t == javax.swing.text.html.HTML.Tag.PARAM) {
                    addParameter(a);
                } else {
                    super.start(t, a);
                }
            ...
            void addParameter(AttributeSet a) {
                String name = (String) a.getAttribute(javax.swing.text.html.HTML.Attribute.NAME);
                String value = (String) a.getAttribute(javax.swing.text.html.HTML.Attribute.VALUE);
        ...
        public class FormAction extends SpecialAction {
            ...
            public void start(javax.swing.text.html.HTML.Tag t, MutableAttributeSet attr) {
                if (t == javax.swing.text.html.HTML.Tag.INPUT) {
                    String type = (String)
                        attr.getAttribute(javax.swing.text.html.HTML.Attribute.TYPE);
                    /*
                    ...
                    if (type == null) {
                        type = "text";
                        attr.addAttribute(javax.swing.text.html.HTML.Attribute.TYPE, "text");
                    }
                    setModel(type, attr);
                } else if (t == javax.swing.text.html.HTML.Tag.TEXTAREA) {
                    inTextArea = true;
                    textAreaDocument = new TextAreaDocument();
                    attr.addAttribute(StyleConstants.ModelAttribute,
                                      textAreaDocument);
                } else if (t == javax.swing.text.html.HTML.Tag.SELECT) {
                    int size = javax.swing.text.html.HTML.getIntegerAttributeValue(attr,
                                                             javax.swing.text.html.HTML.Attribute.SIZE,
                                                             1);
                    boolean multiple = attr.getAttribute(javax.swing.text.html.HTML.Attribute.MULTIPLE) != null;
                    if ((size > 1) || multiple) {
                        OptionListModel<javax.swing.text.html.Option> m = new OptionListModel<javax.swing.text.html.Option>();
                        if (multiple) {
                            m.setSelectionMode(ListSelectionModel.MULTIPLE_INTERVAL_SELECTION);
                        }
                        selectModel = m;
                    } else {
                        selectModel = new OptionComboBoxModel<javax.swing.text.html.Option>();
                    }
                    attr.addAttribute(StyleConstants.ModelAttribute,
                                      selectModel);
                ...
                if (t == javax.swing.text.html.HTML.Tag.OPTION) {
                    option = new javax.swing.text.html.Option(attr);

                    if (selectModel instanceof OptionListModel) {
                        OptionListModel<javax.swing.text.html.Option> m = (OptionListModel<javax.swing.text.html.Option>) selectModel;
                        m.addElement(option);
                        ...
                        OptionComboBoxModel<javax.swing.text.html.Option> m = (OptionComboBoxModel<javax.swing.text.html.Option>) selectModel;
                        m.addElement(option);
                        if (option.isSelected()) {
            ...
            public void end(javax.swing.text.html.HTML.Tag t) {
                if (t == javax.swing.text.html.HTML.Tag.OPTION) {
                    ...
                    if (t == javax.swing.text.html.HTML.Tag.SELECT) {
                        selectModel = null;
                        optionCount = 0;
                    } else if (t == javax.swing.text.html.HTML.Tag.TEXTAREA) {
                        inTextArea = false;
            ...
            void setModel(String type, MutableAttributeSet attr) {
                if (type.equals("submit") ||
                    ...
                    // plain text model
                    int maxLength = javax.swing.text.html.HTML.getIntegerAttributeValue(
                                       attr, javax.swing.text.html.HTML.Attribute.MAXLENGTH, -1);
                    Document doc;
                    ...
                    String value = (String)
                        attr.getAttribute(javax.swing.text.html.HTML.Attribute.VALUE);
                    try {
                    ...
                    if (type.equals("radio")) {
                        String name = (String) attr.getAttribute(javax.swing.text.html.HTML.Attribute.NAME);
                    ...
                    boolean checked = (attr.getAttribute(javax.swing.text.html.HTML.Attribute.CHECKED) != null);
        ...
        protected void preContent(char[] data) {
            ...
            for (int i = 0; i < data.length; i++) {
                if (data[i] == '\n') {
                    ...
                    blockOpen(javax.swing.text.html.HTML.Tag.IMPLIED, a);
                    last = i + 1;
                }
            }
            if (last < data.length) {
         ...
         */
        protected void blockOpen(javax.swing.text.html.HTML.Tag t, MutableAttributeSet attr) {
            if (impliedP) {
                blockClose(javax.swing.text.html.HTML.Tag.IMPLIED);
            }
        ...
        protected void blockClose(javax.swing.text.html.HTML.Tag t) {
            ...
            if (impliedP) {
                impliedP = false;
                inParagraph = false;
                if (t != javax.swing.text.html.HTML.Tag.IMPLIED) {
                    blockClose(javax.swing.text.html.HTML.Tag.IMPLIED);
                }
            }
        ...
        protected void addContent(char[] data, int offs, int length,
            ...
            emptyAnchor = false;
            charAttr.addAttribute(StyleConstants.NameAttribute, javax.swing.text.html.HTML.Tag.CONTENT);
         ...
         */
        protected void addSpecialElement(javax.swing.text.html.HTML.Tag t, MutableAttributeSet a) {
            if ((t != javax.swing.text.html.HTML.Tag.FRAME) && (! inParagraph) && (! inPre)) {
            ...
            if (t == javax.swing.text.html.HTML.Tag.FRAME) {
                lastWasNewline = true;
            }
        }
         ...
         * yet.
         */
        private boolean canInsertTag(javax.swing.text.html.HTML.Tag t, AttributeSet attr,
                                     boolean isBlockTag) {
            if (!foundInsertTag) {
                boolean needPImplied = ((t == javax.swing.text.html.HTML.Tag.IMPLIED)
                                                          && (!inParagraph)
                                                          && (!inPre));
                     ...
                     */
                               ...
                               || (insertAfterImplied
                                    && (attr == null
                                        ...
                                        || t == javax.swing.text.html.HTML.Tag.IMPLIED
                                       )
                                   )
                           ) {
                    return false;
        ...
        private boolean isInsertTag(javax.swing.text.html.HTML.Tag tag) {
                    ...
                    if (offset == 0 || !getText(offset - 1, 1).equals("\n")) {
                        ...
                        if (offset != 0) {
                            ...
                            if (attrs.isDefined(StyleConstants.
                                ...
                                if (name instanceof javax.swing.text.html.HTML.Tag) {
                                    javax.swing.text.html.HTML.Tag tag = (javax.swing.text.html.HTML.Tag)name;
                                    if (tag == javax.swing.text.html.HTML.Tag.IMG ||
                                        tag == javax.swing.text.html.HTML.Tag.HR ||
                                        tag == javax.swing.text.html.HTML.Tag.COMMENT ||
                                        (tag instanceof javax.swing.text.html.HTML.UnknownTag)) {
                                        joinP = false;
                                    }
                                }
                            }
        ...
        Hashtable<javax.swing.text.html.HTML.Tag, TagAction> tagMap;
        int inBlock = 0;
