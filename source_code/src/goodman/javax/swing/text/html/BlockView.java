...
/*
         ...
         */
        if (axis == X_AXIS) {
            Object o = getAttributes().getAttribute(javax.swing.text.html.CSS.Attribute.TEXT_ALIGN);
            if (o != null) {
    ...
    static boolean spanSetFromAttributes(int axis, SizeRequirements r,
                                         javax.swing.text.html.CSS.LengthValue cssWidth,
                                         javax.swing.text.html.CSS.LengthValue cssHeight) {
        if (axis == X_AXIS) {
    ...
    protected void layoutMinorAxis(int targetSpan, int axis, int[] offsets, int[] spans) {
        int n = getViewCount();
        Object key = (axis == X_AXIS) ? javax.swing.text.html.CSS.Attribute.WIDTH : javax.swing.text.html.CSS.Attribute.HEIGHT;
        for (int i = 0; i < n; i++) {
            View v = getView(i);
    ...
    protected void setPropertiesFromAttributes() {
        ...
        cssWidth = (javax.swing.text.html.CSS.LengthValue) attr.getAttribute(javax.swing.text.html.CSS.Attribute.WIDTH);
        cssHeight = (javax.swing.text.html.CSS.LengthValue) attr.getAttribute(javax.swing.text.html.CSS.Attribute.HEIGHT);
    }
