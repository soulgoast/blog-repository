...
import goodman.java.net.*;
import goodman.javax.swing.Icon;
import goodman.javax.swing.ImageIcon;
import goodman.javax.swing.UIManager;
import goodman.javax.swing.border.*;
import goodman.javax.swing.event.ChangeListener;
import goodman.javax.swing.text.*;
import goodman.javax.swing.text.html.CSS;
import goodman.javax.swing.text.html.CSSBorder;
import goodman.javax.swing.text.html.CSSParser;
import goodman.javax.swing.text.html.HTML;
import goodman.javax.swing.text.html.HTMLDocument;
import goodman.javax.swing.text.html.HTMLEditorKit;
import goodman.javax.swing.text.html.MuxingAttributeSet;
...
public class StyleSheet extends StyleContext {
    ...
    public StyleSheet() {
        ...
        if (css == null) {
            css = new javax.swing.text.html.CSS();
        }
    }
     ...
     *  the tag
     */
    public Style getRule(javax.swing.text.html.HTML.Tag t, Element e) {
        ...
        try {
            ...
            for (int counter = n - 1; counter >= 1; counter--) {
                ...
                if (attr != null) {
                    if (attr.isDefined(javax.swing.text.html.HTML.Attribute.ID)) {
                        cacheLookup.append('#');
                        cacheLookup.append(attr.getAttribute
                                           (javax.swing.text.html.HTML.Attribute.ID));
                    }
                    else if (attr.isDefined(javax.swing.text.html.HTML.Attribute.CLASS)) {
                        cacheLookup.append('.');
                        cacheLookup.append(attr.getAttribute
            ...
            if (attr != null) {
                if (attr.isDefined(javax.swing.text.html.HTML.Attribute.ID)) {
                    cacheLookup.append('#');
                    cacheLookup.append(attr.getAttribute(javax.swing.text.html.HTML.Attribute.ID));
                }
                else if (attr.isDefined(javax.swing.text.html.HTML.Attribute.CLASS)) {
                    cacheLookup.append('.');
                    cacheLookup.append(attr.getAttribute
     ...
     * @since 1.3
     */
    public void addCSSAttribute(MutableAttributeSet attr, javax.swing.text.html.CSS.Attribute key,
                                String value) {
    ...
    public AttributeSet addAttribute(AttributeSet old, Object key,
        ...
        if (key instanceof StyleConstants) {
            javax.swing.text.html.HTML.Tag tag = javax.swing.text.html.HTML.getTagForStyleConstantsKey(
                                (StyleConstants)key);
    ...
    public Color getForeground(AttributeSet a) {
        Color c = css.getColor(a, javax.swing.text.html.CSS.Attribute.COLOR);
        if (c == null) {
            return Color.black;
        }
        return c;
    ...
    public Color getBackground(AttributeSet a) {
        return css.getColor(a, javax.swing.text.html.CSS.Attribute.BACKGROUND_COLOR);
    }
    ...
    public static int getIndexOfSize(float pt) {
        return javax.swing.text.html.CSS.getIndexOfSize(pt, sizeMapDefault);
    }
    ...
    public Color stringToColor(String string) {
        return javax.swing.text.html.CSS.stringToColor(string);
    }
    ...
    ImageIcon getBackgroundImage(AttributeSet attr) {
        Object value = attr.getAttribute(javax.swing.text.html.CSS.Attribute.BACKGROUND_IMAGE);

        if (value != null) {
            return ((javax.swing.text.html.CSS.BackgroundImage)value).getImage(getBase());
        }
        return null;
    }
    ...
    private Style createResolvedStyle(String selector, Vector elements,
        ...
        for (int counter = 0; counter < numElements; counter++) {
            ...
            if (attr != null) {
                javax.swing.text.html.HTML.Tag tag = (javax.swing.text.html.HTML.Tag)attr.getAttribute(StyleConstants.
                                                           NameAttribute);
                if (tag != null) {
                ...
                if (attr.isDefined(javax.swing.text.html.HTML.Attribute.CLASS)) {
                    classes[counter] = attr.getAttribute
                                      (javax.swing.text.html.HTML.Attribute.CLASS).toString();
                }
                else {
                    classes[counter] = null;
                }
                if (attr.isDefined(javax.swing.text.html.HTML.Attribute.ID)) {
                    ids[counter] = attr.getAttribute(javax.swing.text.html.HTML.Attribute.ID).
                                        toString();
                }
                else {
                    ids[counter] = null;
    ...
    public static class BoxPainter implements Serializable {
        ...
        BoxPainter(AttributeSet a, javax.swing.text.html.CSS css, StyleSheet ss) {
            this.ss = ss;
            this.css = css;
            border = getBorder(a);
            binsets = border.getBorderInsets(null);
            topMargin = getLength(javax.swing.text.html.CSS.Attribute.MARGIN_TOP, a);
            bottomMargin = getLength(javax.swing.text.html.CSS.Attribute.MARGIN_BOTTOM, a);
            leftMargin = getLength(javax.swing.text.html.CSS.Attribute.MARGIN_LEFT, a);
            rightMargin = getLength(javax.swing.text.html.CSS.Attribute.MARGIN_RIGHT, a);
        ...
        Border getBorder(AttributeSet a) {
            return new javax.swing.text.html.CSSBorder(a);
        }
        ...
        Color getBorderColor(AttributeSet a) {
            Color color = css.getColor(a, javax.swing.text.html.CSS.Attribute.BORDER_COLOR);
            if (color == null) {
                color = css.getColor(a, javax.swing.text.html.CSS.Attribute.COLOR);
                if (color == null) {
                    return Color.black;
                }
            }
        ...
        public float getInset(int side, View v) {
            ...
            case View.LEFT:
                ...
                inset += binsets.left;
                inset += getLength(javax.swing.text.html.CSS.Attribute.PADDING_LEFT, a);
                break;
            case View.RIGHT:
                inset += getOrientationMargin(HorizontalMargin.RIGHT,
                                              rightMargin, a, isLeftToRight(v));
                inset += binsets.right;
                inset += getLength(javax.swing.text.html.CSS.Attribute.PADDING_RIGHT, a);
                break;
            case View.TOP:
                inset += topMargin;
                inset += binsets.top;
                inset += getLength(javax.swing.text.html.CSS.Attribute.PADDING_TOP, a);
                break;
            case View.BOTTOM:
                inset += bottomMargin;
                inset += binsets.bottom;
                inset += getLength(javax.swing.text.html.CSS.Attribute.PADDING_BOTTOM, a);
                break;
            default:
        ...
        public void paint(Graphics g, float x, float y, float w, float h, View v) {
            ...
            if (border instanceof BevelBorder) {
                ...
                int bw = (int) getLength(javax.swing.text.html.CSS.Attribute.BORDER_TOP_WIDTH, a);
        ...
        float getLength(javax.swing.text.html.CSS.Attribute key, AttributeSet a) {
        ...
        static boolean isOrientationAware(View v) {
            ...
            if (v != null
                ...
                && (obj = attr.getAttribute(StyleConstants.NameAttribute)) instanceof javax.swing.text.html.HTML.Tag
                && (obj == javax.swing.text.html.HTML.Tag.DIR
                    || obj == javax.swing.text.html.HTML.Tag.MENU
                    || obj == javax.swing.text.html.HTML.Tag.UL
                    || obj == javax.swing.text.html.HTML.Tag.OL)) {
                ret = true;
            }
            ...
            case RIGHT:
                {
                    orientationMargin = (isLeftToRight) ?
                        getLength(javax.swing.text.html.CSS.Attribute.MARGIN_RIGHT_LTR, a) :
                        getLength(javax.swing.text.html.CSS.Attribute.MARGIN_RIGHT_RTL, a);
                    cssMarginValue = a.getAttribute(javax.swing.text.html.CSS.Attribute.MARGIN_RIGHT);
                }
                break;
            case LEFT :
                {
                    orientationMargin = (isLeftToRight) ?
                        getLength(javax.swing.text.html.CSS.Attribute.MARGIN_LEFT_LTR, a) :
                        getLength(javax.swing.text.html.CSS.Attribute.MARGIN_LEFT_RTL, a);
                    cssMarginValue = a.getAttribute(javax.swing.text.html.CSS.Attribute.MARGIN_LEFT);
                }
                break;
            }
    ...
    public static class ListPainter implements Serializable {
        ...
        ListPainter(AttributeSet attr, StyleSheet ss) {
            ...
            String imgstr = (String)attr.getAttribute(javax.swing.text.html.CSS.Attribute.
                                                      LIST_STYLE_IMAGE);
            type = null;
            ...
            if (img == null) {
                type = (javax.swing.text.html.CSS.Value)attr.getAttribute(javax.swing.text.html.CSS.Attribute.
                                                    LIST_STYLE_TYPE);
            }
            start = 1;
         ...
         */
        private javax.swing.text.html.CSS.Value getChildType(View childView) {
            javax.swing.text.html.CSS.Value childtype = (javax.swing.text.html.CSS.Value)childView.getAttributes().
                                  getAttribute(javax.swing.text.html.CSS.Attribute.LIST_STYLE_TYPE);
            ...
            if (childtype == null) {
                if (type == null) {
                    ...
                    if (doc.matchNameAttribute(v.getElement().getAttributes(),
                        ...
                        childtype = javax.swing.text.html.CSS.Value.DECIMAL;
                    } else {
                        childtype = javax.swing.text.html.CSS.Value.DISC;
                    }
                } else {
                    childtype = type;
                }
        ...
        private void getStart(View parent) {
            ...
            if (element != null) {
                ...
                Object startValue;
                if (attr != null && attr.isDefined(javax.swing.text.html.HTML.Attribute.START) &&
                    (startValue = attr.getAttribute
                     (javax.swing.text.html.HTML.Attribute.START)) != null &&
        ...
        private int getRenderIndex(View parentView, int childIndex) {
            ...
            for (int counter = childIndex; counter >= 0; counter--) {
                ...
                if (as.getAttribute(StyleConstants.NameAttribute) !=
                    ...
                    retIndex--;
                } else if (as.isDefined(javax.swing.text.html.HTML.Attribute.VALUE)) {
                    Object value = as.getAttribute(javax.swing.text.html.HTML.Attribute.VALUE);
                    if (value != null &&
        ...
        public void paint(Graphics g, float x, float y, float w, float h, View v, int item) {
            ...
            if (!(name instanceof javax.swing.text.html.HTML.Tag) ||
                name != javax.swing.text.html.HTML.Tag.LI) {
                return;
            }
            ...
            if (cv.getViewCount() > 0) {
                ...
                if ((cName == javax.swing.text.html.HTML.Tag.P || cName == javax.swing.text.html.HTML.Tag.IMPLIED) &&
            ...
            javax.swing.text.html.CSS.Value childtype = getChildType(cv);
            Font font = ((StyledDocument)cv.getDocument()).
                                         getFont(cv.getAttributes());
            if (font != null) {
                g.setFont(font);
            }
            if (childtype == javax.swing.text.html.CSS.Value.SQUARE || childtype == javax.swing.text.html.CSS.Value.CIRCLE
                || childtype == javax.swing.text.html.CSS.Value.DISC) {
                drawShape(g, childtype, (int) x, (int) y,
                          (int) w, (int) h, align);
            } else if (childtype == javax.swing.text.html.CSS.Value.DECIMAL) {
                drawLetter(g, '1', (int) x, (int) y, (int) w, (int) h, align,
                           getRenderIndex(v, item));
            } else if (childtype == javax.swing.text.html.CSS.Value.LOWER_ALPHA) {
                drawLetter(g, 'a', (int) x, (int) y, (int) w, (int) h, align,
                           getRenderIndex(v, item));
            } else if (childtype == javax.swing.text.html.CSS.Value.UPPER_ALPHA) {
                drawLetter(g, 'A', (int) x, (int) y, (int) w, (int) h, align,
                           getRenderIndex(v, item));
            } else if (childtype == javax.swing.text.html.CSS.Value.LOWER_ROMAN) {
                drawLetter(g, 'i', (int) x, (int) y, (int) w, (int) h, align,
                           getRenderIndex(v, item));
            } else if (childtype == javax.swing.text.html.CSS.Value.UPPER_ROMAN) {
                drawLetter(g, 'I', (int) x, (int) y, (int) w, (int) h, align,
                           getRenderIndex(v, item));
            }
        }
         ...
         * @param align preferred alignment factor for the child view
         */
        void drawShape(Graphics g, javax.swing.text.html.CSS.Value type, int ax, int ay, int aw,
                       int ah, float align) {
            ...
            if (type == javax.swing.text.html.CSS.Value.SQUARE) {
                g.drawRect(x, y, 8, 8);
            } else if (type == javax.swing.text.html.CSS.Value.CIRCLE) {
                g.drawOval(x, y, 8, 8);
            } else {
                g.fillOval(x, y, 8, 8);
            }
    ...
    static class BackgroundImagePainter implements Serializable {
        ...
        BackgroundImagePainter(AttributeSet a, javax.swing.text.html.CSS css, StyleSheet ss) {
            backgroundImage = ss.getBackgroundImage(a);
            // Determine the position.
            javax.swing.text.html.CSS.BackgroundPosition pos = (javax.swing.text.html.CSS.BackgroundPosition)a.getAttribute
            ...
            javax.swing.text.html.CSS.Value repeats = (javax.swing.text.html.CSS.Value)a.getAttribute(javax.swing.text.html.CSS.Attribute.
                                                          BACKGROUND_REPEAT);
            if (repeats == null || repeats == javax.swing.text.html.CSS.Value.BACKGROUND_REPEAT) {
                flags |= 3;
            }
            else if (repeats == javax.swing.text.html.CSS.Value.BACKGROUND_REPEAT_X) {
                flags |= 1;
            }
            else if (repeats == javax.swing.text.html.CSS.Value.BACKGROUND_REPEAT_Y) {
                flags |= 2;
            }
        }
    ...
    class ViewAttributeSet extends MuxingAttributeSet {
            ...
            try {
                if (doc instanceof HTMLDocument) {
                    ...
                    if (elem.isLeaf()) {
                        ...
                        while (keys.hasMoreElements()) {
                            Object key = keys.nextElement();
                            if (key instanceof javax.swing.text.html.HTML.Tag) {
                                if (key == javax.swing.text.html.HTML.Tag.A) {
                                 ...
                                 **/
                                    if (o != null && o instanceof AttributeSet) {
                                        ...
                                        if (attr.getAttribute(javax.swing.text.html.HTML.Attribute.HREF) == null) {
                                            continue;
                                        }
                                    }
                                }
                                AttributeSet cssRule = styles.getRule((javax.swing.text.html.HTML.Tag) key, elem);
                                if (cssRule != null) {
                        ...
                        javax.swing.text.html.HTML.Tag t = (HTML.Tag) a.getAttribute
                                     (StyleConstants.NameAttribute);
        ...
        public Object getAttribute(Object key) {
            if (key instanceof StyleConstants) {
                ...
                if (cssKey != null) {
                    ...
                    if (value instanceof javax.swing.text.html.CSS.CssValue) {
                        return ((javax.swing.text.html.CSS.CssValue)value).toStyleConstants
        ...
        Object doGetAttribute(Object key) {
            ...
            // that is inherited.
            if (key instanceof javax.swing.text.html.CSS.Attribute) {
                javax.swing.text.html.CSS.Attribute css = (javax.swing.text.html.CSS.Attribute) key;
                if (css.isInherited()) {
     ...
     */
    class CssParser implements javax.swing.text.html.CSSParser.CSSParserCallback {
        ...
        public void handleImport(String importString) {
            URL url = javax.swing.text.html.CSS.getURL(base, importString);
            if (url != null) {
        ...
        public void handleValue(String value) {
            if (propertyName != null && value != null && value.length() > 0) {
                javax.swing.text.html.CSS.Attribute cssKey = javax.swing.text.html.CSS.getAttribute(propertyName);
                if (cssKey != null) {
                    ...
                    if (cssKey == javax.swing.text.html.CSS.Attribute.LIST_STYLE_IMAGE) {
                        if (value != null && !value.equals("none")) {
                            URL url = javax.swing.text.html.CSS.getURL(base, value);
        ...
        URL base;
        javax.swing.text.html.CSSParser parser = new javax.swing.text.html.CSSParser();
    }
