...
public class FormView extends ComponentView implements ActionListener {
    ...
    protected Component createComponent() {
        ...
        javax.swing.text.html.HTML.Tag t = (javax.swing.text.html.HTML.Tag)
        ...
        if (t == javax.swing.text.html.HTML.Tag.INPUT) {
            ...
            int rows = javax.swing.text.html.HTML.getIntegerAttributeValue(attr,
                                                     javax.swing.text.html.HTML.Attribute.ROWS,
                                                     1);
            area.setRows(rows);
            int cols = javax.swing.text.html.HTML.getIntegerAttributeValue(attr,
    ...
    private JComponent createInputComponent(AttributeSet attr, Object model) {
        ...
        if (type.equals("submit") || type.equals("reset")) {
            ...
            String srcAtt = (String) attr.getAttribute(javax.swing.text.html.HTML.Attribute.SRC);
            JButton button;
            try {
            ...
            int size = javax.swing.text.html.HTML.getIntegerAttributeValue(attr, javax.swing.text.html.HTML.Attribute.SIZE,
                                                     -1);
            field.setColumns((size > 0) ? size : 20);
    ...
    protected void submitData(String data) {
        ...
        String target = (String) attrs.getAttribute(javax.swing.text.html.HTML.Attribute.TARGET);
        if (target == null) {
            target = "_self";
        }

        String method = (String) attrs.getAttribute(javax.swing.text.html.HTML.Attribute.METHOD);
        if (method == null) {
            method = "GET";
        }
        ...
        String action = (String) attrs.getAttribute(javax.swing.text.html.HTML.Attribute.ACTION);
        URL actionURL;
        try {
    ...
    private String getImageData(Point point) {
        ...
        String name = (String) getElement().getAttributes().getAttribute(javax.swing.text.html.HTML.Attribute.NAME);
    ...
    private Element getFormElement() {
        ...
        while (elem != null) {
            if (elem.getAttributes().getAttribute
                (StyleConstants.NameAttribute) == javax.swing.text.html.HTML.Tag.FORM) {
                return elem;
            }
    ...
    private void loadElementDataIntoBuffer(Element elem, StringBuilder buffer) {
        ...
        String value = null;
        javax.swing.text.html.HTML.Tag tag = (javax.swing.text.html.HTML.Tag)elem.getAttributes().getAttribute
                                  (StyleConstants.NameAttribute);

        if (tag == javax.swing.text.html.HTML.Tag.INPUT) {
            value = getInputElementData(attr);
        } else if (tag ==  javax.swing.text.html.HTML.Tag.TEXTAREA) {
            value = getTextAreaData(attr);
        } else if (tag == javax.swing.text.html.HTML.Tag.SELECT) {
    ...
    private String getInputElementData(AttributeSet attr) {
        ...
        if (type.equals("text") || type.equals("password")) {
            ...
            value = (String) attr.getAttribute(javax.swing.text.html.HTML.Attribute.VALUE);
            if (value == null) {
                value = "";
            }
    ...
    private void loadSelectData(AttributeSet attr, StringBuilder buffer) {
        ...
        if (m instanceof OptionListModel) {
            OptionListModel<javax.swing.text.html.Option> model = (OptionListModel<javax.swing.text.html.Option>) m;

            for (int i = 0; i < model.getSize(); i++) {
                if (model.isSelectedIndex(i)) {
                    javax.swing.text.html.Option option = model.getElementAt(i);
                    appendBuffer(buffer, name, option.getValue());
                }
            }
        } else if (m instanceof ComboBoxModel) {
            ComboBoxModel model = (ComboBoxModel)m;
            javax.swing.text.html.Option option = (javax.swing.text.html.Option)model.getSelectedItem();
            if (option != null) {
                appendBuffer(buffer, name, option.getValue());
            }
        }
            ...
            while ((next = it.next()) != null) {
                if (next == elem) {
                    ...
                    if (HTMLDocument.matchNameAttribute
                                     (elemAttr, javax.swing.text.html.HTML.Tag.INPUT)) {
                        ...
                        try {
                            ...
                            if (HTMLDocument.matchNameAttribute
                                ...
                                String value = (String)elemAttr.
                                           getAttribute(javax.swing.text.html.HTML.Attribute.VALUE);
                                if (value != null) {
