...
import goodman.java.lang.Integer;
...
class HRuleView extends View  {
    ...
    protected void setPropertiesFromAttributes() {
        ...
        if (attr != null) {
            ...
            noshade = (String)eAttr.getAttribute(javax.swing.text.html.HTML.Attribute.NOSHADE);
            ...
            value = attr.getAttribute(javax.swing.text.html.CSS.Attribute.WIDTH);
            if (value != null && (value instanceof javax.swing.text.html.CSS.LengthValue)) {
                widthValue = (javax.swing.text.html.CSS.LengthValue)value;
            }
            topMargin = getLength(javax.swing.text.html.CSS.Attribute.MARGIN_TOP, attr);
            bottomMargin = getLength(javax.swing.text.html.CSS.Attribute.MARGIN_BOTTOM, attr);
            leftMargin = getLength(javax.swing.text.html.CSS.Attribute.MARGIN_LEFT, attr);
            rightMargin = getLength(javax.swing.text.html.CSS.Attribute.MARGIN_RIGHT, attr);
        }
        else {
    ...
    private float getLength(javax.swing.text.html.CSS.Attribute key, AttributeSet a) {
        javax.swing.text.html.CSS.LengthValue lv = (javax.swing.text.html.CSS.LengthValue) a.getAttribute(key);
