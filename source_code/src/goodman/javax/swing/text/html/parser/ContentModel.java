...
public final class ContentModel implements Serializable {
     ...
     */
     public void getElements(Vector<javax.swing.text.html.parser.Element> elemVec) {
         switch (type) {
         case '*':
         case '?':
         case '+':
         ...
         case '&':
             ...
             break;
         default:
             elemVec.addElement((javax.swing.text.html.parser.Element)content);
         }
     }
    ...
    public boolean first(Object token) {
        switch (type) {
          ...
          case '|':
          case '&': {
            javax.swing.text.html.parser.Element e = (javax.swing.text.html.parser.Element) token;
            if (valSet == null || valSet.length <= javax.swing.text.html.parser.Element.getMaxIndex()) {
                valSet = new boolean[javax.swing.text.html.parser.Element.getMaxIndex() + 1];
