...
import goodman.javax.swing.text.html.parser.ContentModel;
import goodman.javax.swing.text.html.parser.DTD;
import goodman.javax.swing.text.html.parser.Element;
import goodman.javax.swing.text.html.parser.Parser;
 ...
 * @see Parser
 * @see DTD
 * @see javax.swing.text.html.parser.Element
 * @see javax.swing.text.html.parser.ContentModel
...
class ContentModelState {
     ...
     */
    public ContentModelState(javax.swing.text.html.parser.ContentModel model) {
        this(model, null, 0);
    }
    ...
    ContentModelState(Object content, ContentModelState next, long value) {
        this.model = (javax.swing.text.html.parser.ContentModel)content;
        this.next = next;
        this.value = value;
    }
    ...
    public javax.swing.text.html.parser.ContentModel getModel() {
        javax.swing.text.html.parser.ContentModel m = model;
    ...
    public boolean terminate() {
        switch (model.type) {
          ...
          case '|':
            for (javax.swing.text.html.parser.ContentModel m = (javax.swing.text.html.parser.ContentModel)model.content; m != null ; m = m.next) {
                if (m.empty()) {
                    return (next == null) || next.terminate();
                }
            }
          ...
          case '&': {
            javax.swing.text.html.parser.ContentModel m = (javax.swing.text.html.parser.ContentModel)model.content;
    ...
    public ContentModelState advance(Object token) {
        switch (model.type) {
          ...
          case '&': {
            javax.swing.text.html.parser.ContentModel m = (ContentModel)model.content;
          ...
          default:
            if (model.content == token) {
                if (next == null && (token instanceof javax.swing.text.html.parser.Element) &&
                    ((javax.swing.text.html.parser.Element)token).content != null) {
