...
import goodman.javax.swing.text.ChangedCharSetException;
import goodman.javax.swing.text.html.parser.DTD;
import goodman.javax.swing.text.html.parser.Element;
import goodman.javax.swing.text.html.parser.TagElement;
...
public class DocumentParser extends javax.swing.text.html.parser.Parser {
    ...
    protected void handleStartTag(javax.swing.text.html.parser.TagElement tag) {
        ...
        javax.swing.text.html.parser.Element elem = tag.getElement();
        if (elem == dtd.body) {
            inbody++;
     ...
     * Handle Empty Tag.
     */
    protected void handleEmptyTag(javax.swing.text.html.parser.TagElement tag) throws ChangedCharSetException {
