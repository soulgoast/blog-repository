...
import goodman.javax.swing.text.html.InlineView;
...
public class ImageView extends View {
    ...
    protected void setPropertiesFromAttributes() {
        ...
        // Gutters
        borderSize = (short)getIntAttr(javax.swing.text.html.HTML.Attribute.BORDER, isLink() ?
                                       DEFAULT_BORDER : 0);

        leftInset = rightInset = (short)(getIntAttr(javax.swing.text.html.HTML.Attribute.HSPACE,
                                                    0) + borderSize);
        topInset = bottomInset = (short)(getIntAttr(javax.swing.text.html.HTML.Attribute.VSPACE,
                                                    0) + borderSize);
        ...
        Object alignment = attr.getAttribute(javax.swing.text.html.HTML.Attribute.ALIGN);
        ...
        AttributeSet anchorAttr = (AttributeSet)attr.getAttribute(javax.swing.text.html.HTML.Tag.A);
    ...
    private void updateImageSize() {
        ...
        if (newImage != null) {
            ...
            newWidth = getIntAttr(javax.swing.text.html.HTML.Attribute.WIDTH, -1);
            if (newWidth > 0) {
                newState |= WIDTH_FLAG;
            }
            newHeight = getIntAttr(javax.swing.text.html.HTML.Attribute.HEIGHT, -1);
            if (newHeight > 0) {
        ...
        public boolean imageUpdate(Image img, int flags, int x, int y,
            ...
            if (image == img) {
                ...
                if ((flags & ImageObserver.HEIGHT) != 0 && !getElement().
                      getAttributes().isDefined(javax.swing.text.html.HTML.Attribute.HEIGHT)) {
                    changed |= 1;
                }
