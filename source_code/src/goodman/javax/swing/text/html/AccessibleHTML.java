...
import goodman.javax.swing.text.html.ImageView;
...
class AccessibleHTML implements Accessible {
    ...
    ElementInfo createElementInfo(Element e, ElementInfo parent) {
        ...
        if (attrs != null) {
            ...
            if (name == javax.swing.text.html.HTML.Tag.IMG) {
                return new IconElementInfo(e, parent);
            }
            else if (name == javax.swing.text.html.HTML.Tag.CONTENT || name == javax.swing.text.html.HTML.Tag.CAPTION) {
                return new TextElementInfo(e, parent);
            }
            else if (name == javax.swing.text.html.HTML.Tag.TABLE) {
    ...
    private class IconElementInfo extends ElementInfo implements Accessible {
        ...
        private int getImageSize(Object key) {
            if (validateIfNecessary()) {
                ...
                if (size == -1) {
                    ...
                    size = 0;
                    if (v instanceof javax.swing.text.html.ImageView) {
                        Image img = ((javax.swing.text.html.ImageView)v).getImage();
                        if (img != null) {
                            if (key == javax.swing.text.html.HTML.Attribute.WIDTH) {
        ...
        protected class IconAccessibleContext extends HTMLAccessibleContext
            ...
            public int getAccessibleIconWidth() {
                if (width == -1) {
                    width = getImageSize(javax.swing.text.html.HTML.Attribute.WIDTH);
                }
                return width;
            }
            ...
            public int getAccessibleIconHeight() {
                if (height == -1) {
                    height = getImageSize(javax.swing.text.html.HTML.Attribute.HEIGHT);
                }
                return height;
            }
        }
            ...
            public int getRowCount() {
                if (validateIfNecessary()) {
                    return Math.max(1, getIntAttr(getAttributes(),
                                                  javax.swing.text.html.HTML.Attribute.ROWSPAN, 1));
                }
                return 0;
            }
