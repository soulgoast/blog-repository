...
import goodman.javax.swing.text.html.EditableView;
...
class HiddenTagView extends javax.swing.text.html.EditableView implements DocumentListener {
    ...
    void _updateModelFromText() {
        ...
        if ((name instanceof javax.swing.text.html.HTML.UnknownTag) &&
            ...
            if (textComponent != null) {
                ...
                try {
                    sas.addAttribute(StyleConstants.NameAttribute,
                                     new javax.swing.text.html.HTML.UnknownTag(text));
