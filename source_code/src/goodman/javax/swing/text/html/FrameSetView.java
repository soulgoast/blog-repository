...
import goodman.javax.swing.text.html.FrameView;
...
class FrameSetView extends BoxView {
     ...
     *
     */
    private String[] parseRowColSpec(javax.swing.text.html.HTML.Attribute key) {
    ...
    private void init() {
        if (getAxis() == View.Y_AXIS) {
            children = parseRowColSpec(javax.swing.text.html.HTML.Attribute.ROWS);
        } else {
    ...
    protected SizeRequirements[] getChildRequests(int targetSpan, int axis) {
        ...
        for (int i = 0, sIndex = 0; i < n; i++) {
            View v = getView(i);
            if ((v instanceof javax.swing.text.html.FrameView) || (v instanceof FrameSetView)) {
