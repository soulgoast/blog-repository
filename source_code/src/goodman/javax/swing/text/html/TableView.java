...
/*public*/ class TableView extends BoxView implements ViewFactory {
    ...
    protected RowView createTableRow(Element elem) {
        ...
        if (o == javax.swing.text.html.HTML.Tag.TR) {
    ...
    protected int getColumnsOccupied(View v) {
        ...
        if (a.isDefined(javax.swing.text.html.HTML.Attribute.COLSPAN)) {
            String s = (String) a.getAttribute(javax.swing.text.html.HTML.Attribute.COLSPAN);
            if (s != null) {
                try {
    ...
    protected int getRowsOccupied(View v) {
        ...
        if (a.isDefined(javax.swing.text.html.HTML.Attribute.ROWSPAN)) {
            String s = (String) a.getAttribute(javax.swing.text.html.HTML.Attribute.ROWSPAN);
            if (s != null) {
                try {
                    return Integer.parseInt(s);
                } catch (NumberFormatException nfe) {
    ...
    void updateInsets() {
        ...
        if (captionIndex != -1) {
            ...
            Object align = a.getAttribute(javax.swing.text.html.CSS.Attribute.CAPTION_SIDE);
    ...
    protected void setPropertiesFromAttributes() {
        ...
        if (attr != null) {
            ...
            javax.swing.text.html.CSS.LengthValue lv = (javax.swing.text.html.CSS.LengthValue)
                attr.getAttribute(javax.swing.text.html.CSS.Attribute.BORDER_SPACING);
            if (lv != null) {
            ...
            lv = (javax.swing.text.html.CSS.LengthValue)
                    attr.getAttribute(javax.swing.text.html.CSS.Attribute.BORDER_TOP_WIDTH);
            if (lv != null) {
            ...
            for (int i = 0; i < n; i++) {
                ...
                if (v instanceof RowView) {
                    ...
                    if (o instanceof javax.swing.text.html.HTML.Tag) {
                        ...
                        if (kind == javax.swing.text.html.HTML.Tag.CAPTION) {
                            captionIndex = i;
                        }
                    }
                }
            ...
            for (int row = 0; row < nrows; row++) {
                ...
                for (int cell = 0; cell < rv.getViewCount(); cell++, col++) {
                    ...
                    if (! relativeCells) {
                        ...
                        javax.swing.text.html.CSS.LengthValue lv = (javax.swing.text.html.CSS.LengthValue)
                            a.getAttribute(javax.swing.text.html.CSS.Attribute.WIDTH);
    ...
    protected void layoutColumns(int targetSpan, int[] offsets, int[] spans,
        ...
        javax.swing.text.html.CSS.calculateTiledLayout(colIterator, targetSpan);
    }
    ...
    protected SizeRequirements calculateMinorAxisRequirements(int axis, SizeRequirements r) {
        ...
        javax.swing.text.html.CSS.LengthValue cssWidth = (javax.swing.text.html.CSS.LengthValue)attr.getAttribute(
                                                    javax.swing.text.html.CSS.Attribute.WIDTH);

        if (javax.swing.text.html.BlockView.spanSetFromAttributes(axis, r, cssWidth, null)) {
        ...
        // set the alignment
        Object o = attr.getAttribute(javax.swing.text.html.CSS.Attribute.TEXT_ALIGN);
        if (o != null) {
    ...
    protected SizeRequirements calculateMajorAxisRequirements(int axis, SizeRequirements r) {
        ...
        r = javax.swing.text.html.CSS.calculateTiledRequirements(rowIterator, r);
    ...
    protected void layoutMajorAxis(int targetSpan, int axis, int[] offsets, int[] spans) {
        ...
        javax.swing.text.html.CSS.calculateTiledLayout(rowIterator, targetSpan);
    ...
    public View create(Element elem) {
        ...
        if (o instanceof javax.swing.text.html.HTML.Tag) {
            javax.swing.text.html.HTML.Tag kind = (javax.swing.text.html.HTML.Tag) o;
            if (kind == javax.swing.text.html.HTML.Tag.TR) {
                return createTableRow(elem);
            } else if ((kind == javax.swing.text.html.HTML.Tag.TD) || (kind == javax.swing.text.html.HTML.Tag.TH)) {
                return new CellView(elem);
            } else if (kind == javax.swing.text.html.HTML.Tag.CAPTION) {
    ...
    class ColumnIterator implements javax.swing.text.html.CSS.LayoutIterator {
