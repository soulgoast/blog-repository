...
import goodman.javax.swing.text.html.FormView;
...
class FrameView extends ComponentView implements HyperlinkListener {
    ...
    protected Component createComponent() {
        ...
        String srcAtt = (String)attributes.getAttribute(javax.swing.text.html.HTML.Attribute.SRC);
    ...
    private void setMargin() {
        ...
        String marginStr = (String)attributes.getAttribute(javax.swing.text.html.HTML.Attribute.MARGINWIDTH);
        if ( in != null) {
        ...
        marginStr = (String)attributes.getAttribute(javax.swing.text.html.HTML.Attribute.MARGINHEIGHT);
        if (marginStr != null) {
            margin = Integer.parseInt(marginStr);
            if (margin > 0) {
    ...
    private void setBorder() {
        ...
        AttributeSet attributes = getElement().getAttributes();
        String frameBorder = (String)attributes.getAttribute(javax.swing.text.html.HTML.Attribute.FRAMEBORDER);
        if ((frameBorder != null) &&
    ...
    private void createScrollPane() {
        AttributeSet attributes = getElement().getAttributes();
        String scrolling = (String)attributes.getAttribute(javax.swing.text.html.HTML.Attribute.SCROLLING);
        if (scrolling == null) {
            scrolling = "auto";
        }
    ...
    private Object movePostData(JEditorPane targetPane, String frameName) {
        ...
        if (p != null) {
            ...
            if (frameName != null) {
                String propName = javax.swing.text.html.FormView.PostDataProperty + "." + frameName;
