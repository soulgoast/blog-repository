...
import goodman.javax.swing.plaf.TextUI;
import goodman.java.util.*;
import goodman.javax.accessibility.*;
import goodman.javax.swing.text.html.AccessibleHTML;
import goodman.javax.swing.text.html.BlockView;
import goodman.javax.swing.text.html.FormSubmitEvent;
import goodman.javax.swing.text.html.HTML;
import goodman.javax.swing.text.html.HTMLDocument;
import goodman.javax.swing.text.html.HTMLFrameHyperlinkEvent;
import goodman.javax.swing.text.html.MinimalHTMLWriter;
import goodman.javax.swing.text.html.ObjectView;
import goodman.javax.swing.text.html.ParagraphView;
import goodman.java.lang.ref.*;
...
public class HTMLEditorKit extends StyledEditorKit implements Accessible {
    ...
    public Document createDefaultDocument() {
        javax.swing.text.html.StyleSheet styles = getStyleSheet();
        javax.swing.text.html.StyleSheet ss = new javax.swing.text.html.StyleSheet();

        ss.addStyleSheet(styles);

        javax.swing.text.html.HTMLDocument doc = new javax.swing.text.html.HTMLDocument(ss);
     ...
     */
    private Parser ensureParser(javax.swing.text.html.HTMLDocument doc) throws IOException {
    ...
    public void insertHTML(javax.swing.text.html.HTMLDocument doc, int offset, String html,
                           ...
                           javax.swing.text.html.HTML.Tag insertTag) throws
    ...
    public void write(Writer out, Document doc, int pos, int len)
        ...
        if (doc instanceof javax.swing.text.html.HTMLDocument) {
            javax.swing.text.html.HTMLWriter w = new javax.swing.text.html.HTMLWriter(out, (javax.swing.text.html.HTMLDocument)doc, pos, len);
            w.write();
    ...
    public javax.swing.text.html.StyleSheet getStyleSheet() {
        ...
        javax.swing.text.html.StyleSheet defaultStyles = (javax.swing.text.html.StyleSheet) appContext.get(DEFAULT_STYLES_KEY);

        if (defaultStyles == null) {
            defaultStyles = new javax.swing.text.html.StyleSheet();
    ...
    protected void createInputAttributes(Element element,
        ...
        if (o instanceof javax.swing.text.html.HTML.Tag) {
            javax.swing.text.html.HTML.Tag tag = (javax.swing.text.html.HTML.Tag)o;
            ...
            if(tag == javax.swing.text.html.HTML.Tag.IMG) {
                ...
                set.removeAttribute(javax.swing.text.html.HTML.Attribute.SRC);
                set.removeAttribute(javax.swing.text.html.HTML.Attribute.HEIGHT);
                set.removeAttribute(javax.swing.text.html.HTML.Attribute.WIDTH);
                set.addAttribute(StyleConstants.NameAttribute,
                                 javax.swing.text.html.HTML.Tag.CONTENT);
            }
            else if (tag == javax.swing.text.html.HTML.Tag.HR || tag == javax.swing.text.html.HTML.Tag.BR) {
                // Don't copy HRs or BRs either.
                set.addAttribute(StyleConstants.NameAttribute,
                                 javax.swing.text.html.HTML.Tag.CONTENT);
            }
            else if (tag == javax.swing.text.html.HTML.Tag.COMMENT) {
                // Don't copy COMMENTs either
                set.addAttribute(StyleConstants.NameAttribute,
                                 javax.swing.text.html.HTML.Tag.CONTENT);
                set.removeAttribute(javax.swing.text.html.HTML.Attribute.COMMENT);
            }
            else if (tag == javax.swing.text.html.HTML.Tag.INPUT) {
                // or INPUT either
                set.addAttribute(StyleConstants.NameAttribute,
                                 javax.swing.text.html.HTML.Tag.CONTENT);
                set.removeAttribute(javax.swing.text.html.HTML.Tag.INPUT);
            }
            else if (tag instanceof javax.swing.text.html.HTML.UnknownTag) {
                // Don't copy unknowns either:(
                set.addAttribute(StyleConstants.NameAttribute,
                                 javax.swing.text.html.HTML.Tag.CONTENT);
                set.removeAttribute(javax.swing.text.html.HTML.Attribute.ENDTAG);
            }
        }
    }
    ...
    public static class LinkController extends MouseAdapter implements MouseMotionListener, Serializable {
        ...
        public void mouseMoved(MouseEvent e) {
            ...
            if (!editor.isEditable()) {
                ...
                if (pos >= 0 &&(editor.getDocument() instanceof javax.swing.text.html.HTMLDocument)){
                    javax.swing.text.html.HTMLDocument hdoc = (javax.swing.text.html.HTMLDocument)editor.getDocument();
                        ...
                        if (elem != null) {
                            ...
                            if (anchor == null) {
                                curElemImage = (a.getAttribute(StyleConstants.
                                            NameAttribute) == javax.swing.text.html.HTML.Tag.IMG);
                                if (curElemImage) {
         ...
         */
        private String getMapHREF(JEditorPane html, javax.swing.text.html.HTMLDocument hdoc,
                                  Element elem, AttributeSet attr, int offset,
                                  int x, int y) {
            Object useMap = attr.getAttribute(javax.swing.text.html.HTML.Attribute.USEMAP);
                ...
                if (m != null && offset < hdoc.getLength()) {
                    ...
                    if (bounds != null) {
                        AttributeSet area = m.getArea(x - bounds.x,
                                                      ...
                                                      bounds.height);
                        if (area != null) {
                            return (String)area.getAttribute(javax.swing.text.html.HTML.Attribute.
                                                             HREF);
                        }
                    }
                }
        ...
        void activateLink(int pos, JEditorPane html, MouseEvent mouseEvent) {
            ...
            if (doc instanceof javax.swing.text.html.HTMLDocument) {
                ...
                AttributeSet anchor = (AttributeSet)a.getAttribute(javax.swing.text.html.HTML.Tag.A);
                ...
                if (anchor == null) {
                    ...
                    href = (String)anchor.getAttribute(javax.swing.text.html.HTML.Attribute.HREF);
                }
        ...
        HyperlinkEvent createHyperlinkEvent(JEditorPane html,
                                            javax.swing.text.html.HTMLDocument hdoc, String href,
                                            AttributeSet anchor,
                                            Element element,
            ...
            if (!hdoc.isFrameDocument()) {
                ...
                String target = (anchor != null) ?
                    (String)anchor.getAttribute(javax.swing.text.html.HTML.Attribute.TARGET) : null;
        ...
        void fireEvents(JEditorPane editor, javax.swing.text.html.HTMLDocument doc, String href,
    ...
    public static class HTMLFactory implements ViewFactory {
        ...
        public View create(Element elem) {
            ...
            if (o instanceof javax.swing.text.html.HTML.Tag) {
                ...
                if (kind == javax.swing.text.html.HTML.Tag.CONTENT) {
                    return new javax.swing.text.html.InlineView(elem);
                } else if (kind == javax.swing.text.html.HTML.Tag.IMPLIED) {
                ...
                } else if ((kind == javax.swing.text.html.HTML.Tag.P) ||
                           (kind == javax.swing.text.html.HTML.Tag.H1) ||
                           (kind == javax.swing.text.html.HTML.Tag.H2) ||
                           (kind == javax.swing.text.html.HTML.Tag.H3) ||
                           (kind == javax.swing.text.html.HTML.Tag.H4) ||
                           (kind == javax.swing.text.html.HTML.Tag.H5) ||
                           (kind == javax.swing.text.html.HTML.Tag.H6) ||
                           (kind == javax.swing.text.html.HTML.Tag.DT)) {
                    // paragraph
                    return new javax.swing.text.html.ParagraphView(elem);
                } else if ((kind == javax.swing.text.html.HTML.Tag.MENU) ||
                           (kind == javax.swing.text.html.HTML.Tag.DIR) ||
                           (kind == javax.swing.text.html.HTML.Tag.UL)   ||
                           (kind == javax.swing.text.html.HTML.Tag.OL)) {
                    return new javax.swing.text.html.ListView(elem);
                } else if (kind == javax.swing.text.html.HTML.Tag.BODY) {
                    return new BodyBlockView(elem);
                } else if (kind == javax.swing.text.html.HTML.Tag.HTML) {
                    return new javax.swing.text.html.BlockView(elem, View.Y_AXIS);
                } else if ((kind == javax.swing.text.html.HTML.Tag.LI) ||
                           (kind == javax.swing.text.html.HTML.Tag.CENTER) ||
                           (kind == javax.swing.text.html.HTML.Tag.DL) ||
                           (kind == javax.swing.text.html.HTML.Tag.DD) ||
                           (kind == javax.swing.text.html.HTML.Tag.DIV) ||
                           (kind == javax.swing.text.html.HTML.Tag.BLOCKQUOTE) ||
                           (kind == javax.swing.text.html.HTML.Tag.PRE) ||
                           (kind == javax.swing.text.html.HTML.Tag.FORM)) {
                    // vertical box
                    return new javax.swing.text.html.BlockView(elem, View.Y_AXIS);
                } else if (kind == javax.swing.text.html.HTML.Tag.NOFRAMES) {
                    return new javax.swing.text.html.NoFramesView(elem, View.Y_AXIS);
                } else if (kind== javax.swing.text.html.HTML.Tag.IMG) {
                    return new javax.swing.text.html.ImageView(elem);
                } else if (kind == javax.swing.text.html.HTML.Tag.ISINDEX) {
                    return new javax.swing.text.html.IsindexView(elem);
                } else if (kind == javax.swing.text.html.HTML.Tag.HR) {
                    return new javax.swing.text.html.HRuleView(elem);
                } else if (kind == javax.swing.text.html.HTML.Tag.BR) {
                    return new javax.swing.text.html.BRView(elem);
                } else if (kind == javax.swing.text.html.HTML.Tag.TABLE) {
                    return new javax.swing.text.html.TableView(elem);
                } else if ((kind == javax.swing.text.html.HTML.Tag.INPUT) ||
                           (kind == javax.swing.text.html.HTML.Tag.SELECT) ||
                           (kind == javax.swing.text.html.HTML.Tag.TEXTAREA)) {
                    return new javax.swing.text.html.FormView(elem);
                } else if (kind == javax.swing.text.html.HTML.Tag.OBJECT) {
                    return new javax.swing.text.html.ObjectView(elem);
                } else if (kind == javax.swing.text.html.HTML.Tag.FRAMESET) {
                     if (elem.getAttributes().isDefined(javax.swing.text.html.HTML.Attribute.ROWS)) {
                         return new javax.swing.text.html.FrameSetView(elem, View.Y_AXIS);
                     } else if (elem.getAttributes().isDefined(javax.swing.text.html.HTML.Attribute.COLS)) {
                ...
                } else if (kind == javax.swing.text.html.HTML.Tag.FRAME) {
                    return new javax.swing.text.html.FrameView(elem);
                } else if (kind instanceof javax.swing.text.html.HTML.UnknownTag) {
                    return new javax.swing.text.html.HiddenTagView(elem);
                } else if (kind == javax.swing.text.html.HTML.Tag.COMMENT) {
                    return new javax.swing.text.html.CommentView(elem);
                } else if (kind == javax.swing.text.html.HTML.Tag.HEAD) {
                    ...
                    return new javax.swing.text.html.BlockView(elem, View.X_AXIS) {
                ...
                } else if ((kind == javax.swing.text.html.HTML.Tag.TITLE) ||
                           (kind == javax.swing.text.html.HTML.Tag.META) ||
                           (kind == javax.swing.text.html.HTML.Tag.LINK) ||
                           (kind == javax.swing.text.html.HTML.Tag.STYLE) ||
                           (kind == javax.swing.text.html.HTML.Tag.SCRIPT) ||
                           (kind == javax.swing.text.html.HTML.Tag.AREA) ||
                           (kind == javax.swing.text.html.HTML.Tag.MAP) ||
                           (kind == javax.swing.text.html.HTML.Tag.PARAM) ||
                           (kind == javax.swing.text.html.HTML.Tag.APPLET)) {
                    return new javax.swing.text.html.HiddenTagView(elem);
                }
            }
...
*/
    ...
    private static final Action[] defaultActions = {
        new InsertHTMLTextAction("InsertTable", INSERT_TABLE_HTML,
                                 javax.swing.text.html.HTML.Tag.BODY, javax.swing.text.html.HTML.Tag.TABLE),
        new InsertHTMLTextAction("InsertTableRow", INSERT_TABLE_HTML,
                                 javax.swing.text.html.HTML.Tag.TABLE, javax.swing.text.html.HTML.Tag.TR,
                                 javax.swing.text.html.HTML.Tag.BODY, javax.swing.text.html.HTML.Tag.TABLE),
        new InsertHTMLTextAction("InsertTableDataCell", INSERT_TABLE_HTML,
                                 javax.swing.text.html.HTML.Tag.TR, javax.swing.text.html.HTML.Tag.TD,
                                 javax.swing.text.html.HTML.Tag.BODY, javax.swing.text.html.HTML.Tag.TABLE),
        new InsertHTMLTextAction("InsertUnorderedList", INSERT_UL_HTML,
                                 javax.swing.text.html.HTML.Tag.BODY, javax.swing.text.html.HTML.Tag.UL),
        ...
        new InsertHTMLTextAction("InsertOrderedList", INSERT_OL_HTML,
                                 javax.swing.text.html.HTML.Tag.BODY, javax.swing.text.html.HTML.Tag.OL),
        new InsertHTMLTextAction("InsertOrderedListItem", INSERT_OL_HTML,
                                 javax.swing.text.html.HTML.Tag.OL, javax.swing.text.html.HTML.Tag.LI,
                                 javax.swing.text.html.HTML.Tag.BODY, javax.swing.text.html.HTML.Tag.OL),
        new InsertHRAction(),
        new InsertHTMLTextAction("InsertPre", INSERT_PRE_HTML,
                                 javax.swing.text.html.HTML.Tag.BODY, javax.swing.text.html.HTML.Tag.PRE),
    ...
    public static abstract class HTMLTextAction extends StyledTextAction {
         ...
         */
        protected javax.swing.text.html.HTMLDocument getHTMLDocument(JEditorPane e) {
            Document d = e.getDocument();
            if (d instanceof javax.swing.text.html.HTMLDocument) {
                return (javax.swing.text.html.HTMLDocument) d;
            }
         ...
         */
        protected Element[] getElementsAt(javax.swing.text.html.HTMLDocument doc, int offset) {
         ...
         * <code>tag</code>.
         */
        protected int elementCountToTag(javax.swing.text.html.HTMLDocument doc, int offset,
         ...
         * <code>tag</code>.
         */
        protected Element findElementMatchingTag(javax.swing.text.html.HTMLDocument doc, int offset,
                                                 javax.swing.text.html.HTML.Tag tag) {
    ...
    public static class InsertHTMLTextAction extends HTMLTextAction {
        public InsertHTMLTextAction(String name, String html,
                                    javax.swing.text.html.HTML.Tag parentTag, javax.swing.text.html.HTML.Tag addTag) {
         ...
         */
        protected void insertHTML(JEditorPane editor, javax.swing.text.html.HTMLDocument doc,
                                  int offset, String html, int popDepth,
                                  int pushDepth, javax.swing.text.html.HTML.Tag addTag) {
            try {
         ...
         * @since 1.3
         */
        protected void insertAtBoundary(JEditorPane editor, javax.swing.text.html.HTMLDocument doc,
                                        int offset, Element insertElement,
                                        String html, javax.swing.text.html.HTML.Tag parentTag,
                                        javax.swing.text.html.HTML.Tag addTag) {
         ...
         */
        @Deprecated
        protected void insertAtBoundry(JEditorPane editor, javax.swing.text.html.HTMLDocument doc,
                                       int offset, Element insertElement,
                                       String html, javax.swing.text.html.HTML.Tag parentTag,
                                       javax.swing.text.html.HTML.Tag addTag) {
         ...
         */
        /*protected*/
        boolean insertIntoTag(JEditorPane editor, javax.swing.text.html.HTMLDocument doc,
                              int offset, javax.swing.text.html.HTML.Tag tag, javax.swing.text.html.HTML.Tag addTag) {
         ...
         */
        /* protected */
        void adjustSelection(JEditorPane pane, javax.swing.text.html.HTMLDocument doc,
        ...
        public void actionPerformed(ActionEvent ae) {
            ...
            if (editor != null) {
                javax.swing.text.html.HTMLDocument doc = getHTMLDocument(editor);
    ...
    static class InsertHRAction extends InsertHTMLTextAction {
        InsertHRAction() {
            super("InsertHR", "<hr>", null, javax.swing.text.html.HTML.Tag.IMPLIED, null, null,
                  false);
        }
        ...
        public void actionPerformed(ActionEvent ae) {
            ...
            if (editor != null) {
                ...
                if (paragraph.getParentElement() != null) {
                    parentTag = (javax.swing.text.html.HTML.Tag)paragraph.getParentElement().
     ...
     */
    static private Object getAttrValue(AttributeSet attr, javax.swing.text.html.HTML.Attribute key) {
    ...
    static class NavigateLinkAction extends TextAction implements CaretListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            while ((nextElement = ei.next()) != null) {
                ...
                Object href = getAttrValue(attr, javax.swing.text.html.HTML.Attribute.HREF);
                if (!(name.equals(javax.swing.text.html.HTML.Tag.OBJECT.toString())) && href == null) {
                    continue;
                }
    ...
    static class ActivateLinkAction extends TextAction {
         ...
         */
        private void activateLink(String href, javax.swing.text.html.HTMLDocument doc,
        ...
        private void doObjectAction(JEditorPane editor, Element elem) {
            ...
            if (view != null && view instanceof javax.swing.text.html.ObjectView) {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (d == null || !(d instanceof javax.swing.text.html.HTMLDocument)) {
                return;
            }
            javax.swing.text.html.HTMLDocument doc = (HTMLDocument)d;
            ...
            while ((currentElement = ei.next()) != null) {
                ...
                } else if (name.equals(javax.swing.text.html.HTML.Tag.OBJECT.toString())) {
