...
public class HTMLWriter extends AbstractWriter {
     ...
     * &lt;b&gt;, &lt;i&gt;, &lt;font&gt;, and &lt;a&gt;.
     */
    private Vector<javax.swing.text.html.HTML.Tag> tags = new Vector<javax.swing.text.html.HTML.Tag>(10);
     ...
     */
    private Vector<javax.swing.text.html.HTML.Tag> tagsToRemove = new Vector<javax.swing.text.html.HTML.Tag>(10);
                    ...
                    while (top != next.getParentElement()) {
                        ...
                        */
                        ...
                        if (!synthesizedElement(top)) {
                            ...
                            if (!matchNameAttribute(attrs, javax.swing.text.html.HTML.Tag.PRE) &&
    ...
    protected void writeAttributes(AttributeSet attr) throws IOException {
        ...
        while (names.hasMoreElements()) {
            ...
            if (name instanceof javax.swing.text.html.HTML.Tag ||
                ...
                name == javax.swing.text.html.HTML.Attribute.ENDTAG) {
                continue;
            }
    ...
    protected void emptyTag(Element elem) throws BadLocationException, IOException {
        ...
        if (matchNameAttribute(attr, javax.swing.text.html.HTML.Tag.CONTENT)) {
            inContent = true;
            text(elem);
        } else if (matchNameAttribute(attr, javax.swing.text.html.HTML.Tag.COMMENT)) {
            comment(elem);
        }  else {
            ...
            Object endTag = (attr != null) ? attr.getAttribute
                              (javax.swing.text.html.HTML.Attribute.ENDTAG) : null;
            ...
            if (completeDoc && matchNameAttribute(attr, javax.swing.text.html.HTML.Tag.HEAD)) {
                if (outputEndTag) {
            ...
            write('>');
            if (matchNameAttribute(attr, javax.swing.text.html.HTML.Tag.TITLE) && !outputEndTag) {
    ...
    protected void startTag(Element elem) throws IOException, BadLocationException {
        ...
        javax.swing.text.html.HTML.Tag name;
        if (nameAttribute instanceof javax.swing.text.html.HTML.Tag) {
            name = (javax.swing.text.html.HTML.Tag)nameAttribute;
        }
        else {
            name = null;
        }

        if (name == javax.swing.text.html.HTML.Tag.PRE) {
            inPre = true;
        ...
        if (completeDoc && name == javax.swing.text.html.HTML.Tag.BODY && !wroteHead) {
        ...
        if (name == javax.swing.text.html.HTML.Tag.TEXTAREA) {
            textAreaContent(elem.getAttributes());
        } else if (name == javax.swing.text.html.HTML.Tag.SELECT) {
            selectContent(elem.getAttributes());
        } else if (completeDoc && name == javax.swing.text.html.HTML.Tag.BODY) {
            // Write out the maps, which is not stored as Elements in
            // the Document.
            writeMaps(((HTMLDocument)getDocument()).getMaps());
        }
        else if (name == javax.swing.text.html.HTML.Tag.HEAD) {
    ...
    protected void selectContent(AttributeSet attr) throws IOException {
        ...
        if (model instanceof OptionListModel) {
            OptionListModel<javax.swing.text.html.Option> listModel = (OptionListModel<javax.swing.text.html.Option>) model;
            int size = listModel.getSize();
            for (int i = 0; i < size; i++) {
                javax.swing.text.html.Option option = listModel.getElementAt(i);
                writeOption(option);
            }
        } else if (model instanceof OptionComboBoxModel) {
            OptionComboBoxModel<javax.swing.text.html.Option> comboBoxModel = (OptionComboBoxModel<javax.swing.text.html.Option>) model;
            int size = comboBoxModel.getSize();
            for (int i = 0; i < size; i++) {
                javax.swing.text.html.Option option = comboBoxModel.getElementAt(i);
                writeOption(option);
            }
        }
        decrIndent();
    ...
    protected void endTag(Element elem) throws IOException {
        ...
        if (matchNameAttribute(elem.getAttributes(), javax.swing.text.html.HTML.Tag.PRE)) {
            inPre = false;
        }
        write('<');
        write('/');
    ...
    protected void comment(Element elem) throws BadLocationException, IOException {
        ...
        if (matchNameAttribute(as, javax.swing.text.html.HTML.Tag.COMMENT)) {
            Object comment = as.getAttribute(javax.swing.text.html.HTML.Attribute.COMMENT);
    ...
    protected boolean synthesizedElement(Element elem) {
        if (matchNameAttribute(elem.getAttributes(), javax.swing.text.html.HTML.Tag.IMPLIED)) {
            return true;
        }
        return false;
    }
     ...
     */
    protected boolean matchNameAttribute(AttributeSet attr, javax.swing.text.html.HTML.Tag tag) {
        Object o = attr.getAttribute(StyleConstants.NameAttribute);
        if (o instanceof javax.swing.text.html.HTML.Tag) {
            javax.swing.text.html.HTML.Tag name = (javax.swing.text.html.HTML.Tag) o;
            if (name == tag) {
    ...
    protected void writeEmbeddedTags(AttributeSet attr) throws IOException {
        ...
        while (names.hasMoreElements()) {
            ...
            if (name instanceof javax.swing.text.html.HTML.Tag) {
                ...
                if (tag == javax.swing.text.html.HTML.Tag.FORM || tags.contains(tag)) {
                    continue;
                }
                write('<');
                write(tag.toString());
     ...
     * and false otherwise.
     */
    private boolean noMatchForTagInAttributes(AttributeSet attr, javax.swing.text.html.HTML.Tag t,
                                              Object tagValue) {
    ...
    private boolean isFormElementWithContent(AttributeSet attr) {
        return matchNameAttribute(attr, javax.swing.text.html.HTML.Tag.TEXTAREA) ||
                matchNameAttribute(attr, javax.swing.text.html.HTML.Tag.SELECT);
    }
    ...
    void writeMaps(Enumeration maps) throws IOException {
        if (maps != null) {
            while(maps.hasMoreElements()) {
                javax.swing.text.html.Map map = (javax.swing.text.html.Map)maps.nextElement();
    ...
    boolean writeStyle(String name, Style style, boolean outputStyle)
        ...
        if (attributes != null) {
            while (attributes.hasMoreElements()) {
                ...
                if (attribute instanceof javax.swing.text.html.CSS.Attribute) {
    ...
    private static void convertToHTML32(AttributeSet from, MutableAttributeSet to) {
        ...
        while (keys.hasMoreElements()) {
            ...
            if (key instanceof javax.swing.text.html.CSS.Attribute) {
                if ((key == javax.swing.text.html.CSS.Attribute.FONT_FAMILY) ||
                    (key == javax.swing.text.html.CSS.Attribute.FONT_SIZE) ||
                    (key == javax.swing.text.html.CSS.Attribute.COLOR)) {

                    createFontAttribute((javax.swing.text.html.CSS.Attribute)key, from, to);
                } else if (key == javax.swing.text.html.CSS.Attribute.FONT_WEIGHT) {
                    // add a bold tag is weight is bold
                    javax.swing.text.html.CSS.FontWeight weightValue = (javax.swing.text.html.CSS.FontWeight)
                        from.getAttribute(javax.swing.text.html.CSS.Attribute.FONT_WEIGHT);
                    if ((weightValue != null) && (weightValue.getValue() > 400)) {
                        addAttribute(to, javax.swing.text.html.HTML.Tag.B, SimpleAttributeSet.EMPTY);
                    }
                } else if (key == javax.swing.text.html.CSS.Attribute.FONT_STYLE) {
                    String s = from.getAttribute(key).toString();
                    if (s.indexOf("italic") >= 0) {
                        addAttribute(to, javax.swing.text.html.HTML.Tag.I, SimpleAttributeSet.EMPTY);
                    }
                } else if (key == javax.swing.text.html.CSS.Attribute.TEXT_DECORATION) {
                    String decor = from.getAttribute(key).toString();
                    if (decor.indexOf("underline") >= 0) {
                        addAttribute(to, javax.swing.text.html.HTML.Tag.U, SimpleAttributeSet.EMPTY);
                    }
                    if (decor.indexOf("line-through") >= 0) {
                        addAttribute(to, javax.swing.text.html.HTML.Tag.STRIKE, SimpleAttributeSet.EMPTY);
                    }
                } else if (key == javax.swing.text.html.CSS.Attribute.VERTICAL_ALIGN) {
                    String vAlign = from.getAttribute(key).toString();
                    if (vAlign.indexOf("sup") >= 0) {
                        addAttribute(to, javax.swing.text.html.HTML.Tag.SUP, SimpleAttributeSet.EMPTY);
                    }
                    if (vAlign.indexOf("sub") >= 0) {
                        addAttribute(to, javax.swing.text.html.HTML.Tag.SUB, SimpleAttributeSet.EMPTY);
                    }
                } else if (key == javax.swing.text.html.CSS.Attribute.TEXT_ALIGN) {
                    addAttribute(to, javax.swing.text.html.HTML.Attribute.ALIGN,
        ...
        if (value.length() > 0) {
            to.addAttribute(javax.swing.text.html.HTML.Attribute.STYLE, value);
        }
    }
     ...
     */
    private static void createFontAttribute(javax.swing.text.html.CSS.Attribute a, AttributeSet from,
                                            MutableAttributeSet to) {
        MutableAttributeSet fontAttr = (MutableAttributeSet)
            to.getAttribute(javax.swing.text.html.HTML.Tag.FONT);
        if (fontAttr == null) {
            fontAttr = new SimpleAttributeSet();
            to.addAttribute(javax.swing.text.html.HTML.Tag.FONT, fontAttr);
        }
        // edit the parameters to the font tag
        String htmlValue = from.getAttribute(a).toString();
        if (a == javax.swing.text.html.CSS.Attribute.FONT_FAMILY) {
            fontAttr.addAttribute(javax.swing.text.html.HTML.Attribute.FACE, htmlValue);
        } else if (a == javax.swing.text.html.CSS.Attribute.FONT_SIZE) {
            fontAttr.addAttribute(javax.swing.text.html.HTML.Attribute.SIZE, htmlValue);
        } else if (a == javax.swing.text.html.CSS.Attribute.COLOR) {
            fontAttr.addAttribute(javax.swing.text.html.HTML.Attribute.COLOR, htmlValue);
        }
    }
