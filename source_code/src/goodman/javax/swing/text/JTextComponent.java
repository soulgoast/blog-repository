...
import goodman.java.beans.Transient;
...
import goodman.java.util.concurrent.*;

import goodman.java.io.*;

import goodman.java.awt.*;
import goodman.java.awt.event.*;
import goodman.java.awt.print.*;
import goodman.java.awt.datatransfer.*;
import goodman.java.awt.im.InputContext;
import goodman.java.awt.im.InputMethodRequests;
import goodman.java.awt.font.TextHitInfo;
import goodman.java.awt.font.TextAttribute;

import goodman.java.awt.print.Printable;
...
import goodman.java.text.*;
import goodman.java.text.AttributedCharacterIterator.Attribute;
...
import goodman.javax.print.attribute.*;
import goodman.javax.swing.text.*;
import goodman.javax.swing.text.AttributeSet;
import goodman.javax.swing.text.Caret;
import goodman.javax.swing.text.DefaultCaret;
import goodman.javax.swing.text.Document;
import goodman.javax.swing.text.EditorKit;
import goodman.javax.swing.text.Element;
import goodman.javax.swing.text.Highlighter;
import goodman.javax.swing.text.Keymap;
import goodman.javax.swing.text.PlainDocument;
...
import goodman.javax.swing.text.ViewFactory;
 ...
 * behavior can be changed by the {@link javax.swing.text.DefaultCaret#setUpdatePolicy} method.
 * <br>
 ...
 *
 * <p>
 * The model is defined by the {@link javax.swing.text.Document} interface.
...
public abstract class JTextComponent extends JComponent implements Scrollable, Accessible
{
    ...
    public void setDocument(javax.swing.text.Document doc) {
        javax.swing.text.Document old = model;
    ...
    public void setCaret(javax.swing.text.Caret c) {
        ...
        javax.swing.text.Caret old = caret;
        caret = c;
        if (caret != null) {
            caret.install(this);
    ...
    public void setHighlighter(javax.swing.text.Highlighter h) {
        ...
        javax.swing.text.Highlighter old = highlighter;
        highlighter = h;
        if (highlighter != null) {
    ...
    public void setKeymap(javax.swing.text.Keymap map) {
        javax.swing.text.Keymap old = keymap;
        keymap = map;
        ...
        if (dropMode == DropMode.USE_SELECTION) {
            if (textLocation == null) {
                if (state != null) {
                    ...
                    if (!forDrop) {
                        if (caret instanceof javax.swing.text.DefaultCaret) {
                            ((javax.swing.text.DefaultCaret)caret).setDot(((Integer)vals[0]).intValue(),
                                                         (javax.swing.text.Position.Bias)vals[3]);
                            ((javax.swing.text.DefaultCaret)caret).moveDot(((Integer)vals[1]).intValue(),
                                                         (javax.swing.text.Position.Bias)vals[4]);
                        } else {
                ...
                if (dropLocation == null) {
                    ...
                    if (caret instanceof javax.swing.text.DefaultCaret) {
                        javax.swing.text.DefaultCaret dc = (javax.swing.text.DefaultCaret)caret;
                        visible = dc.isActive();
                ...
                if (caret instanceof javax.swing.text.DefaultCaret) {
                    ((javax.swing.text.DefaultCaret)caret).setDot(textLocation.getIndex(), textLocation.getBias());
                } else {
            ...
            if (textLocation == null) {
                ...
                if (dropLocation == null) {
                    boolean visible = caret instanceof javax.swing.text.DefaultCaret
                                      ? ((javax.swing.text.DefaultCaret)caret).isActive()
                                      : caret.isVisible();
     ...
     * @return the keymap
     */
    public static javax.swing.text.Keymap addKeymap(String nm, javax.swing.text.Keymap parent) {
        javax.swing.text.Keymap map = new DefaultKeymap(nm, parent);
        if (nm != null) {
     ...
     */
    public static javax.swing.text.Keymap removeKeymap(String nm) {
     ...
     * @return the keymap
     */
    public static javax.swing.text.Keymap getKeymap(String nm) {
        return getKeymapTable().get(nm);
    }

    private static HashMap<String, javax.swing.text.Keymap> getKeymapTable() {
        synchronized (KEYMAP_TABLE) {
            AppContext appContext = AppContext.getAppContext();
            HashMap<String, javax.swing.text.Keymap> keymapTable =
                (HashMap<String, javax.swing.text.Keymap>)appContext.get(KEYMAP_TABLE);
            if (keymapTable == null) {
                keymapTable = new HashMap<String, javax.swing.text.Keymap>(17);
                appContext.put(KEYMAP_TABLE, keymapTable);
                //initialize default keymap
                javax.swing.text.Keymap binding = addKeymap(DEFAULT_KEYMAP, null);
     ...
     */
    public static void loadKeymap(javax.swing.text.Keymap map, KeyBinding[] bindings, Action[] actions) {
    ...
    public void read(Reader in, Object desc) throws IOException {
        ...
        if (desc != null) {
            doc.putProperty(javax.swing.text.Document.StreamDescriptionProperty, desc);
        }
        try {
            kit.read(in, doc, 0);
            setDocument(doc);
...
////////////////
    ...
    implements AccessibleText, CaretListener, DocumentListener,
        ...
        public AccessibleJTextComponent() {
            javax.swing.text.Document doc = JTextComponent.this.getDocument();
            if (doc != null) {
        ...
        public Rectangle getCharacterBounds(int i) {
            ...
            try {
                javax.swing.text.View rootView = ui.getRootView(JTextComponent.this);
                if (rootView != null) {
                    rootView.setSize(alloc.width, alloc.height);

                    Shape bounds = rootView.modelToView(i,
                                    javax.swing.text.Position.Bias.Forward, i+1,
                                    javax.swing.text.Position.Bias.Backward, alloc);
        ...
        public javax.swing.text.AttributeSet getCharacterAttribute(int i) {
            javax.swing.text.Element e = null;
            if (model instanceof AbstractDocument) {
                ((AbstractDocument)model).readLock();
            }
            try {
       ...
       /**
         ...
         */
        private javax.swing.text.Element getParagraphElement(int index) {
            if (model instanceof javax.swing.text.PlainDocument) {
                javax.swing.text.PlainDocument sdoc = (PlainDocument)model;
        ...
        private IndexedSegment getParagraphElementText(int index)
            ...
            javax.swing.text.Element para = getParagraphElement(index);
...
// call this new method instead and return only the string portion
        ...
        private AccessibleTextSequence getSequenceAtIndex(int part,
            ...
            case AccessibleExtendedText.LINE:
                ...
                try {
                    int startIndex =
                        javax.swing.text.Utilities.getRowStart(JTextComponent.this, index);
                    int endIndex =
                        javax.swing.text.Utilities.getRowEnd(JTextComponent.this, index);
                    if (startIndex >= 0 && endIndex >= startIndex) {
                        if (direction == 0) {
                            ...
                            endIndex =
                                javax.swing.text.Utilities.getRowEnd(JTextComponent.this,
                                    startIndex - 1);
                            startIndex =
                                javax.swing.text.Utilities.getRowStart(JTextComponent.this,
                                    startIndex - 1);
                            if (startIndex >= 0 && endIndex >= startIndex) {
                                lineSequence =
        ...
        private int getRunEdge(int index, int direction) throws
         BadLocationException {
            ...
            javax.swing.text.Element indexElement;
            ...
            javax.swing.text.AttributeSet indexAS = indexElement.getAttributes();
            javax.swing.text.Element parent = indexElement.getParentElement();
            ...
            javax.swing.text.Element edgeElement;
            switch (direction) {
            case -1:
            case 1:
            ...
            try {
                ...
                if (rootView != null) {
                    Shape bounds = rootView.modelToView(startIndex,
                                    javax.swing.text.Position.Bias.Forward, endIndex,
                                    javax.swing.text.Position.Bias.Backward, alloc);
    ...
    public static final class DropLocation extends TransferHandler.DropLocation {
        ...
        private final javax.swing.text.Position.Bias bias;

        private DropLocation(Point p, int index, javax.swing.text.Position.Bias bias) {
            super(p);
            this.index = index;
            this.bias = bias;
        }
    ...
    static class DefaultKeymap implements javax.swing.text.Keymap {

        DefaultKeymap(String nm, javax.swing.text.Keymap parent) {
            this.nm = nm;
            this.parent = parent;
    ...
    static class KeymapWrapper extends InputMap {
        ...
        private javax.swing.text.Keymap keymap;

        KeymapWrapper(javax.swing.text.Keymap keymap) {
            this.keymap = keymap;
        }
    ...
    static class KeymapActionMap extends ActionMap {
        ...
        KeymapActionMap(javax.swing.text.Keymap keymap) {
            this.keymap = keymap;
        }
    ...
    private void exchangeCaret(javax.swing.text.Caret oldCaret, Caret newCaret) {
        ...
        protected void positionCaret(MouseEvent me) {
            ...
            if ((offset < composedStartIndex) ||
                ...
                try {
                    ...
                    javax.swing.text.Position newPos = host.getDocument().createPosition(offset);
    ...
    private class DoSetCaretPosition implements Runnable {
        JTextComponent host;
        javax.swing.text.Position newPos;
