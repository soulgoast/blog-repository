...
import goodman.javax.swing.text.DefaultFormatter;
...
public class InternationalFormatter extends DefaultFormatter {
    ...
    void updateMask() {
        if (getFormat() != null) {
            javax.swing.text.Document doc = getFormattedTextField().getDocument();
     ...
     */
    boolean replace(ReplaceHolder rh) throws javax.swing.text.BadLocationException {
        int start = -1;
        int direction = 1;
        int literalCount = -1;
    ...
    Object adjustValue(Object value, Map attributes, Object field,
            ...
            javax.swing.text.BadLocationException, ParseException {
        return null;
    }
     ...
     * <code>value</code>.
     */
    void resetValue(Object value) throws javax.swing.text.BadLocationException, ParseException {
