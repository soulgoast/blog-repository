...
public abstract class CompositeView extends javax.swing.text.View {
    ...
    public CompositeView(javax.swing.text.Element elem) {
        super(elem);
        children = new javax.swing.text.View[1];
        nchildren = 0;
    ...
    public void replace(int offset, int length, javax.swing.text.View[] views) {
        ...
        if ((nchildren + delta) >= children.length) {
            ...
            javax.swing.text.View[] newChildren = new javax.swing.text.View[newLength];
    ...
    public Shape modelToView(int pos, Shape a, javax.swing.text.Position.Bias b) throws BadLocationException {
        boolean isBackward = (b == javax.swing.text.Position.Bias.Backward);
        ...
        if ((vIndex != -1) && (vIndex < getViewCount())) {
            javax.swing.text.View v = getView(vIndex);
     ...
     */
    public Shape modelToView(int p0, javax.swing.text.Position.Bias b0, int p1, javax.swing.text.Position.Bias b1, Shape a) throws BadLocationException {
        if (p0 == getStartOffset() && p1 == getEndOffset()) {
            return a;
        }
        Rectangle alloc = getInsideAllocation(a);
        Rectangle r0 = new Rectangle(alloc);
        javax.swing.text.View v0 = getViewAtPosition((b0 == javax.swing.text.Position.Bias.Backward) ?
                                    Math.max(0, p0 - 1) : p0, r0);
        Rectangle r1 = new Rectangle(alloc);
        javax.swing.text.View v1 = getViewAtPosition((b1 == javax.swing.text.Position.Bias.Backward) ?
        ...
        while (counter < viewCount) {
            ...
            if ((v = getView(counter)) == v0 || v == v1) {
                javax.swing.text.View endView;
                Rectangle retRect;
                Rectangle tempRect = new Rectangle();
                if (v == v0) {
                    retRect = v0.modelToView(p0, b0, v0.getEndOffset(),
                                             javax.swing.text.Position.Bias.Backward, r0).
                              getBounds();
                    endView = v1;
                }
                else {
     ...
     * @see javax.swing.text.View#viewToModel
     */
    public int viewToModel(float x, float y, Shape a, javax.swing.text.Position.Bias[] bias) {
        Rectangle alloc = getInsideAllocation(a);
        if (isBefore((int) x, (int) y, alloc)) {
            ...
            try {
                retValue = getNextVisualPositionFrom(-1, javax.swing.text.Position.Bias.Forward,
                                                     a, EAST, bias);
     ...
     */
    public int getNextVisualPositionFrom(int pos, javax.swing.text.Position.Bias b, Shape a,
     ...
     */
    protected javax.swing.text.View getViewAtPosition(int pos, Rectangle a) {
        int index = getViewIndexAtPosition(pos);
        if ((index >= 0) && (index < getViewCount())) {
            javax.swing.text.View v = getView(index);
            if (a != null) {
    ...
    protected int getNextNorthSouthVisualPositionFrom(int pos, javax.swing.text.Position.Bias b,
                                                ...
                                                throws BadLocationException {
        return javax.swing.text.Utilities.getNextVisualPositionFrom(
    ...
    * @param pos the position to convert &gt;= 0
     ...
     * @see #getNextVisualPositionFrom
     */
    protected int getNextEastWestVisualPositionFrom(int pos, javax.swing.text.Position.Bias b,
                                                    Shape a,
                                                    int direction,
                                                    javax.swing.text.Position.Bias[] biasRet)
                                                throws BadLocationException {
    ...
    private static javax.swing.text.View[] ZERO = new javax.swing.text.View[0];
