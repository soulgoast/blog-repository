...
import goodman.java.awt.font.TextLayout;
...
import goodman.javax.swing.text.ParagraphView.Row;
...
public class Utilities {
     ...
     */
    static JComponent getJComponent(javax.swing.text.View view) {
        if (view != null) {
     ...
     */
    public static final int drawTabbedText(javax.swing.text.Segment s, int x, int y, Graphics g,
     ...
     * @return  the X location at the end of the rendered text
     */
    static final int drawTabbedText(javax.swing.text.View view,
                                    javax.swing.text.Segment s, int x, int y, Graphics g,
                                    TabExpander e, int startOffset) {
    ...
    static final int drawTabbedText(javax.swing.text.View view,
        ...
        if (justificationData != null) {
            ...
            javax.swing.text.View parent = null;
            if (view != null
     ...
     */
    public static final int getTabbedTextWidth(javax.swing.text.Segment s, FontMetrics metrics, int x,
                                               TabExpander e, int startOffset) {
    ...
    // @param justificationData justificationData for the row.
    // if null not justification is needed
    static final int getTabbedTextWidth(javax.swing.text.View view, javax.swing.text.Segment s, FontMetrics metrics, int x,
                                        TabExpander e, int startOffset,
                                        int[] justificationData) {
        int nextX = x;
        char[] txt = s.array;
     ...
     */
    public static final int getTabbedTextOffset(javax.swing.text.Segment s, FontMetrics metrics,
                                                int x0, int x, TabExpander e,
                                                int startOffset) {
        return getTabbedTextOffset(s, metrics, x0, x, e, startOffset, true);
    }

    static final int getTabbedTextOffset(javax.swing.text.View view, javax.swing.text.Segment s, FontMetrics metrics,
                                         int x0, int x, TabExpander e,
                                         int startOffset,
                                         int[] justificationData) {
    ...
    public static final int getTabbedTextOffset(javax.swing.text.Segment s,
                                                FontMetrics metrics,
                                                int x0, int x, TabExpander e,
                                                int startOffset,
                                                boolean round) {
    ...
    // @param justificationData justificationData for the row.
    // if null not justification is needed
    static final int getTabbedTextOffset(javax.swing.text.View view,
     ...
     */
    public static final int getBreakLocation(javax.swing.text.Segment s, FontMetrics metrics,
                                             int x0, int x, TabExpander e,
                                             int startOffset) {
        char[] txt = s.array;
        int txtOffset = s.offset;
    ...
    public static final int getWordStart(JTextComponent c, int offs) throws BadLocationException {
        ...
        javax.swing.text.Element line = getParagraphElement(c, offs);
        if (line == null) {
        ...
        javax.swing.text.Segment seg = SegmentCache.getSharedSegment();
     ...
     */
    static int getNextWordInParagraph(JTextComponent c, javax.swing.text.Element line, int offs, boolean first) throws BadLocationException {
        if (line == null) {
            throw new BadLocationException("No more words", offs);
        }
        javax.swing.text.Document doc = line.getDocument();
        int lineStart = line.getStartOffset();
        int lineEnd = Math.min(line.getEndOffset(), doc.getLength());
     ...
     * if there are no more words in the element.
     */
    static int getPrevWordInParagraph(JTextComponent c, javax.swing.text.Element line, int offs) throws BadLocationException {
        if (line == null) {
            throw new BadLocationException("No more words", offs);
        }
        javax.swing.text.Document doc = line.getDocument();
    ...
    public static final javax.swing.text.Element getParagraphElement(JTextComponent c, int offs) {
        ...
        javax.swing.text.Element paragraph = map.getElement(index);
     ...
     */
    static int drawComposedText(javax.swing.text.View view, AttributeSet attr, Graphics g,
     ...
     */
    static int getNextVisualPositionFrom(javax.swing.text.View v, int pos, javax.swing.text.Position.Bias b,
