...
public class PlainDocument extends AbstractDocument {
    ...
    protected AbstractElement createDefaultRoot() {
        ...
        javax.swing.text.Element line = createLeafElement(map, null, 0, 1);
        javax.swing.text.Element[] lines = new javax.swing.text.Element[1];
        lines[0] = line;
    ...
    public javax.swing.text.Element getParagraphElement(int pos){
        javax.swing.text.Element lineMap = getDefaultRootElement();
    ...
    protected void insertUpdate(DefaultDocumentEvent chng, javax.swing.text.AttributeSet attr) {
        ...
        javax.swing.text.Element rmCandidate = lineMap.getElement(index);
        ...
        try {
            ...
            if (hasBreaks) {
                ...
                if ((offset + length == rmOffs1) && (lastOffset != rmOffs1) &&
                    ...
                    javax.swing.text.Element e = lineMap.getElement(index+1);
                ...
                javax.swing.text.Element[] aelems = new javax.swing.text.Element[added.size()];
                added.copyInto(aelems);
                javax.swing.text.Element[] relems = new javax.swing.text.Element[removed.size()];
    ...
    protected void removeUpdate(DefaultDocumentEvent chng) {
        ...
        if (line0 != line1) {
            ...
            javax.swing.text.Element[] aelems = new javax.swing.text.Element[1];
            ...
            javax.swing.text.Element line = map.getElement(line0);
            if (!line.isLeaf()) {
                javax.swing.text.Element leaf = line.getElement(line.getElementIndex(offset));
                if (Utilities.isComposedTextElement(leaf)) {
                    javax.swing.text.Element[] aelem = new javax.swing.text.Element[1];
                    aelem[0] = createLeafElement(map, null,
                        line.getStartOffset(), line.getEndOffset());
                    javax.swing.text.Element[] relem = new javax.swing.text.Element[1];
                    relem[0] = line;
    ...
    private void insertComposedTextUpdate(DefaultDocumentEvent chng, AttributeSet attr) {
        ...
        int length = chng.getLength();
        int index = lineMap.getElementIndex(offset);
        javax.swing.text.Element elem = lineMap.getElement(index);
        ...
        javax.swing.text.Element[] alelem = new javax.swing.text.Element[added.size()];
    ...
    private Vector<javax.swing.text.Element> added = new Vector<javax.swing.text.Element>();
    private Vector<javax.swing.text.Element> removed = new Vector<Element>();
