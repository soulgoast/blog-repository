...
import goodman.javax.swing.text.DocumentFilter;
...
import goodman.javax.swing.tree.TreeNode;
 ...
 */
public abstract class AbstractDocument implements javax.swing.text.Document, Serializable {
    ...
    protected AbstractDocument(Content data) {
        this(data, javax.swing.text.StyleContext.getDefaultStyleContext());
    }
    ...
    protected AbstractDocument(Content data, AttributeContext context) {
        ...
        writeLock();
        try {
            javax.swing.text.Element[] p = new javax.swing.text.Element[1];
     ...
     * @see javax.swing.text.Document#addUndoableEditListener
     */
    ...
    public void remove(int offs, int len) throws BadLocationException {
        javax.swing.text.DocumentFilter filter = getDocumentFilter();
     ...
     */
    private void handleInsertString(int offs, String str, javax.swing.text.AttributeSet a)
     ...
     * @see javax.swing.text.Document#createPosition
     */
    public synchronized javax.swing.text.Position createPosition(int offs) throws BadLocationException {
    ...
    public javax.swing.text.Element[] getRootElements() {
        javax.swing.text.Element[] elems = new javax.swing.text.Element[2];
     ...
     */
    static boolean isLeftToRight(javax.swing.text.Document doc, int p0, int p1) {
        if (Boolean.TRUE.equals(doc.getProperty(I18NProperty))) {
            if (doc instanceof AbstractDocument) {
                AbstractDocument adoc = (AbstractDocument) doc;
                javax.swing.text.Element bidiRoot = adoc.getBidiRootElement();
                int index = bidiRoot.getElementIndex(p0);
                javax.swing.text.Element bidiElem = bidiRoot.getElement(index);
                if (bidiElem.getEndOffset() >= p1) {
                    javax.swing.text.AttributeSet bidiAttrs = bidiElem.getAttributes();
    ...
    protected void insertUpdate(DefaultDocumentEvent chng, javax.swing.text.AttributeSet attr) {
        ...
        if (chng.type == DocumentEvent.EventType.INSERT &&
            ...
            javax.swing.text.Segment segment = javax.swing.text.SegmentCache.getSharedSegment();
            try {
                ...
                } while (segment.next() != javax.swing.text.Segment.DONE);
    ...
    void updateBidi( DefaultDocumentEvent chng ) {
            ...
            || chng.type == DocumentEvent.EventType.CHANGE )
        {
            ...
            javax.swing.text.Element paragraph = getParagraphElement( chng.getOffset() );
        ...
        Vector<javax.swing.text.Element> newElements = new Vector<javax.swing.text.Element>();
        ...
        if( firstSpanStart > 0 ) {
            ...
            javax.swing.text.Element prevElem = bidiRoot.getElement(prevElemIndex);
            int prevLevel= javax.swing.text.StyleConstants.getBidiLevel(prevElem.getAttributes());
        ...
        javax.swing.text.Element newNextElem = null;
        ...
        if( lastSpanEnd <= getLength() ) {
            ...
            javax.swing.text.Element nextElem = bidiRoot.getElement( nextElemIndex );
            int nextLevel = javax.swing.text.StyleConstants.getBidiLevel(nextElem.getAttributes());
        ...
        javax.swing.text.Element[] removedElems = new javax.swing.text.Element[removedElemCount];
        for( int i=0; i<removedElemCount; i++ ) {
            removedElems[i] = bidiRoot.getElement(removeFromIndex+i);
        }

        javax.swing.text.Element[] addedElems = new javax.swing.text.Element[ newElements.size() ];
    ...
    private byte[] calculateBidiLevels( int firstPStart, int lastPEnd ) {
        ...
        for(int o=firstPStart; o<lastPEnd; ) {
            javax.swing.text.Element p = getParagraphElement( o );
            ...
            // array.
            javax.swing.text.Segment seg = javax.swing.text.SegmentCache.getSharedSegment();
            try {
     ...
     *
     * @see javax.swing.text.StyleContext
     */
    public interface AttributeContext {
         ...
         */
        public javax.swing.text.AttributeSet addAttribute(javax.swing.text.AttributeSet old, Object name, Object value);
         ...
         * @see MutableAttributeSet#addAttribute
         */
        public javax.swing.text.AttributeSet addAttributes(javax.swing.text.AttributeSet old, javax.swing.text.AttributeSet attr);
         ...
         */
        public javax.swing.text.AttributeSet removeAttribute(javax.swing.text.AttributeSet old, Object name);
         ...
         */
        public javax.swing.text.AttributeSet removeAttributes(javax.swing.text.AttributeSet old, Enumeration<?> names);
         ...
         * @see MutableAttributeSet#removeAttributes
         */
        public javax.swing.text.AttributeSet removeAttributes(javax.swing.text.AttributeSet old, javax.swing.text.AttributeSet attrs);
     ...
     * Please see {@link java.beans.XMLEncoder}.
     */
    public abstract class AbstractElement implements javax.swing.text.Element, MutableAttributeSet, Serializable, TreeNode {
         ...
         * @since 1.4
         */
        public AbstractElement(javax.swing.text.Element parent, javax.swing.text.AttributeSet a) {
            this.parent = parent;
         ...
         * @see javax.swing.text.AttributeSet#getAttributeCount
         */
         ...
         * @see javax.swing.text.AttributeSet#isDefined
         */
         ...
         * @see javax.swing.text.AttributeSet#isEqual
         */
         ...
         *
         * @return the copy
         * @see javax.swing.text.AttributeSet#copyAttributes
         */
         ...
         * @see javax.swing.text.AttributeSet#getAttribute
         */
        public Object getAttribute(Object attrName) {
            ...
            if (value == null) {
                ...
                // element.
                javax.swing.text.AttributeSet a = (parent != null) ? parent.getAttributes() : null;
                if (a != null) {
         ...
         * @see javax.swing.text.AttributeSet#getAttributeNames
         */
         ...
         * @see javax.swing.text.AttributeSet#containsAttribute
         */
         ...
         * @see javax.swing.text.AttributeSet#containsAttributes
         */
         ...
         * @see javax.swing.text.AttributeSet#getResolveParent
         */
        public javax.swing.text.AttributeSet getResolveParent() {
            javax.swing.text.AttributeSet a = attributes.getResolveParent();
        ...
        public void setResolveParent(javax.swing.text.AttributeSet parent) {
            ...
            if (parent != null) {
                attributes =
                    context.addAttribute(attributes, javax.swing.text.StyleConstants.ResolveAttribute,
                                         parent);
            } else {
                attributes =
                    context.removeAttribute(attributes, javax.swing.text.StyleConstants.ResolveAttribute);
            }
        }
        ...
        private void writeObject(ObjectOutputStream s) throws IOException {
            ...
            javax.swing.text.StyleContext.writeAttributeSet(s, attributes);
        }
    ...
    public class BranchElement extends AbstractElement {
         ...
         * @since 1.4
         */
        public BranchElement(javax.swing.text.Element parent, javax.swing.text.AttributeSet a) {
            super(parent, a);
        ...
        public javax.swing.text.Element positionToElement(int pos) {
            ...
            javax.swing.text.Element child = children[index];
        ...
        public int getElementIndex(int offset) {
            ...
            if ((lastIndex >= lower) && (lastIndex <= upper)) {
                javax.swing.text.Element lastHit = children[lastIndex];
            ...
            while (lower <= upper) {
                ...
                javax.swing.text.Element elem = children[mid];
    ...
    public class LeafElement extends AbstractElement {
         ...
         * @since 1.4
         */
        public LeafElement(javax.swing.text.Element parent, javax.swing.text.AttributeSet a, int offs0, int offs1) {
            super(parent, a);
            try {
    ...
    class BidiElement extends LeafElement {
         ...
         */
        BidiElement(javax.swing.text.Element parent, int start, int end, int level) {
            super(parent, new SimpleAttributeSet(), start, end);
            addAttribute(javax.swing.text.StyleConstants.BidiLevel, Integer.valueOf(level));
    ...
    public class DefaultDocumentEvent extends CompoundEdit implements DocumentEvent {
        ...
        public boolean addEdit(UndoableEdit anEdit) {
            ...
            if ((changeLookup == null) && (edits.size() > 10)) {
                changeLookup = new Hashtable<javax.swing.text.Element, ElementChange>();
                int n = edits.size();
                for (int i = 0; i < n; i++) {
         ...
         * @return the changes
         */
        public ElementChange getChange(javax.swing.text.Element elem) {
        ...
        private int offset;
        private int length;
        private Hashtable<javax.swing.text.Element, ElementChange> changeLookup;
    ...
    public static class ElementEdit extends AbstractUndoableEdit implements DocumentEvent.ElementChange {
        ...
        public void redo() throws CannotRedoException {
            ...
            javax.swing.text.Element[] tmp = removed;
            removed = added;
            added = tmp;
    ...
    private class DefaultFilterBypass extends DocumentFilter.FilterBypass {
        ...
        public void insertString(int offset, String string,
                                 javax.swing.text.AttributeSet attr) throws
                                        BadLocationException {
