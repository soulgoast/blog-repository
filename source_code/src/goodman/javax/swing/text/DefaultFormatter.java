...
import goodman.java.text.ParseException;
...
public class DefaultFormatter extends JFormattedTextField.AbstractFormatter
     ...
     */
    int getNextVisualPositionFrom(javax.swing.text.JTextComponent text, int pos,
                                  javax.swing.text.Position.Bias bias, int direction,
     ...
     */
    void replace(javax.swing.text.DocumentFilter.FilterBypass fb, int offset,
     ...
     * override this.
     */
    void setDot(NavigationFilter.FilterBypass fb, int dot, javax.swing.text.Position.Bias bias){
        fb.setDot(dot, bias);
    }
     ...
     * text.
     */
    ReplaceHolder getReplaceHolder(javax.swing.text.DocumentFilter.FilterBypass fb, int offset,
                                   int length, String text,
    ...
    static class ReplaceHolder {
        ...
        void reset(javax.swing.text.DocumentFilter.FilterBypass fb, int offset, int length,
    ...
    private class DefaultNavigationFilter extends NavigationFilter
        ...
        public void setDot(FilterBypass fb, int dot, javax.swing.text.Position.Bias bias) {
            javax.swing.text.JTextComponent tc = DefaultFormatter.this.getFormattedTextField();
        ...
        public void moveDot(FilterBypass fb, int dot, javax.swing.text.Position.Bias bias) {
            javax.swing.text.JTextComponent tc = DefaultFormatter.this.getFormattedTextField();
            if (tc.composedTextExists()) {
                // bypass the filter
                fb.moveDot(dot, bias);
        ...
        public int getNextVisualPositionFrom(javax.swing.text.JTextComponent text, int pos,
                                             javax.swing.text.Position.Bias bias,
                                             int direction,
    ...
    private class DefaultDocumentFilter extends DocumentFilter implements
        ...
        public void insertString(FilterBypass fb, int offset,
                                 String string, javax.swing.text.AttributeSet attr) throws
                              BadLocationException {
            javax.swing.text.JTextComponent tc = DefaultFormatter.this.getFormattedTextField();
            if (tc.composedTextExists() ||
                javax.swing.text.Utilities.isComposedTextAttributeDefined(attr)) {
                // bypass the filter
