...
import goodman.java.text.AttributedCharacterIterator;
import goodman.java.text.BreakIterator;
import goodman.java.awt.font.*;
import goodman.java.awt.geom.AffineTransform;
import goodman.javax.swing.JComponent;
import goodman.javax.swing.event.DocumentEvent;
...
import goodman.javax.swing.text.GlyphPainter2;
...
class TextLayoutStrategy extends javax.swing.text.FlowView.FlowStrategy {
     ...
     */
    protected int layoutRow(javax.swing.text.FlowView fv, int rowIndex, int p0) {
        int p1 = super.layoutRow(fv, rowIndex, p0);
        javax.swing.text.View row = fv.getView(rowIndex);
        javax.swing.text.Document doc = fv.getDocument();
        Object i18nFlag = doc.getProperty(javax.swing.text.AbstractDocument.I18NProperty);
        if ((i18nFlag != null) && i18nFlag.equals(Boolean.TRUE)) {
            int n = row.getViewCount();
            if (n > 1) {
                javax.swing.text.AbstractDocument d = (javax.swing.text.AbstractDocument)fv.getDocument();
                javax.swing.text.Element bidiRoot = d.getBidiRootElement();
                byte[] levels = new byte[n];
                javax.swing.text.View[] reorder = new javax.swing.text.View[n];

                for( int i=0; i<n; i++ ) {
                    javax.swing.text.View v = row.getView(i);
                    int bidiIndex =bidiRoot.getElementIndex(v.getStartOffset());
                    javax.swing.text.Element bidiElem = bidiRoot.getElement( bidiIndex );
    ...
    protected javax.swing.text.View createView(javax.swing.text.FlowView fv, int startOffset, int spanLeft, int rowIndex) {
        ...
        javax.swing.text.View lv = getLogicalView(fv);
        javax.swing.text.View row = fv.getView(rowIndex);
        boolean requireNextWord = (viewBuffer.size() == 0) ? false : true;
        int childIndex = lv.getViewIndex(startOffset, javax.swing.text.Position.Bias.Forward);
        javax.swing.text.View v = lv.getView(childIndex);
        ...
        if ((frag instanceof javax.swing.text.GlyphView) && (measurer != null)) {
            ...
            if ((p1 - p0) == 1) {
                // check for tab
                javax.swing.text.Segment s = ((javax.swing.text.GlyphView)frag).getText(p0, p1);
                char ch = s.first();
                if (ch == '\t') {
                    isTab = true;
                }
            ...
            TextLayout tl = (isTab) ? null :
                measurer.nextLayout(spanLeft, text.toIteratorIndex(endOffset),
                                    requireNextWord);
            if (tl != null) {
                ((javax.swing.text.GlyphView)frag).setGlyphPainter(new javax.swing.text.GlyphPainter2(tl));
            }
        }
        return frag;
    }
     ...
     */
    int getLimitingOffset(javax.swing.text.View v, int startOffset, int spanLeft, boolean requireNextWord) {
        int endOffset = v.getEndOffset();

        // check for direction change
        javax.swing.text.Document doc = v.getDocument();
        if (doc instanceof javax.swing.text.AbstractDocument) {
            javax.swing.text.AbstractDocument d = (AbstractDocument) doc;
            javax.swing.text.Element bidiRoot = d.getBidiRootElement();
        ...
        // check for tab
        if (v instanceof javax.swing.text.GlyphView) {
            javax.swing.text.Segment s = ((javax.swing.text.GlyphView)v).getText(startOffset, endOffset);
            char ch = s.first();
            if (ch == '\t') {
                ...
                for (ch = s.next(); ch != javax.swing.text.Segment.DONE; ch = s.next()) {
                    if (ch == '\t') {
    ...
    void sync(FlowView fv) {
        ...
        for( int i=0; i<n; i++ ) {
            javax.swing.text.View child = lv.getView(i);
            if( child instanceof javax.swing.text.GlyphView) {
                ...
                ((javax.swing.text.GlyphView)child).setGlyphPainter(new javax.swing.text.GlyphPainter2(layout));
            }
        }
    ...
    static class AttributedSegment extends Segment implements AttributedCharacterIterator {
        ...
        int getFontBoundary(int childIndex, int dir) {
            javax.swing.text.View child = v.getView(childIndex);
        ...
        public int getRunStart() {
            ...
            int i = v.getViewIndex(pos, javax.swing.text.Position.Bias.Forward);
            javax.swing.text.View child = v.getView(i);
