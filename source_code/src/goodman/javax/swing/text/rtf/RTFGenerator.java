...
import goodman.javax.swing.text.rtf.RTFAttributes;
...
class RTFGenerator extends Object
{
    ...
    static {
        ...
        Dictionary textKeywordDictionary = javax.swing.text.rtf.RTFReader.textKeywords;
...
static int[] outputConversionForName(String name)
    throws IOException
{
    char[] table = (char[]) javax.swing.text.rtf.RTFReader.getCharacterSet(name);
