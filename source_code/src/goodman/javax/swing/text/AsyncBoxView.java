...
import goodman.javax.swing.text.LayoutQueue;
...
public class AsyncBoxView extends javax.swing.text.View {
     ...
     */
    public AsyncBoxView(javax.swing.text.Element elem, int axis) {
        super(elem);
    ...
    protected javax.swing.text.LayoutQueue getLayoutQueue() {
        return javax.swing.text.LayoutQueue.getDefaultQueue();
    }
     ...
     */
    protected ChildState createChildState(javax.swing.text.View v) {
            ...
            synchronized(this) {
                ...
                synchronized(stats) {
                    ...
                    if ((n > 0) && (minorChanged || estimatedMajorSpan)) {
                        javax.swing.text.LayoutQueue q = getLayoutQueue();
     ...
     */
    protected synchronized int getViewIndexAtPosition(int pos, javax.swing.text.Position.Bias b) {
     ...
     */
    public synchronized void preferenceChanged(javax.swing.text.View child, boolean width, boolean height) {
        if (child == null) {
            getParent().preferenceChanged(this, width, height);
        } else {
            if (changing != null) {
                javax.swing.text.View cv = changing.getChildView();
                if (cv == child) {
    ...
    public float getPreferredSpan(int axis) {
        ...
        if (prefRequest != null) {
            javax.swing.text.View child = prefRequest.getChildView();
    ...
    public float getMinimumSpan(int axis) {
        ...
        if (minRequest != null) {
            javax.swing.text.View child = minRequest.getChildView();
    ...
    public Shape modelToView(int pos, Shape a, javax.swing.text.Position.Bias b) throws BadLocationException {
        ...
        ChildState cs = getChildState(index);
        synchronized (cs) {
            javax.swing.text.View cv = cs.getChildView();
     ...
     * character in the model or the previous character in the model.
     */
    public int viewToModel(float x, float y, Shape a, javax.swing.text.Position.Bias[] biasReturn) {
        ...
        ChildState cs = getChildState(index);
        synchronized (cs) {
            javax.swing.text.View v = cs.getChildView();
    ...
    public class ChildLocator {
        ...
        protected int getViewIndexAtVisualOffset(float targetOffset) {
            ...
            if (n > 0) {
                ...
                if (targetOffset > majorSpan) {
                    ...
                    int index = getViewIndex(pos, javax.swing.text.Position.Bias.Forward);
                    return index;
        ...
        int updateChildOffsets(float targetOffset) {
            ...
            int targetIndex = n - 1;
            int pos = lastValidOffset.getChildView().getStartOffset();
            int startIndex = getViewIndex(pos, javax.swing.text.Position.Bias.Forward);
    ...
    public class ChildState implements Runnable {
         ...
         * @since 1.4
         */
        public ChildState(javax.swing.text.View v) {
            child = v;
            minorValid = false;
            majorValid = false;
