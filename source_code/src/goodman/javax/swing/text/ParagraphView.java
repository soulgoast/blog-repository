...
import goodman.javax.swing.text.TabSet;
import goodman.javax.swing.text.TabStop;
import goodman.javax.swing.text.TabableView;
...
public class ParagraphView extends FlowView implements TabExpander {
    ...
    public ParagraphView(javax.swing.text.Element elem) {
        super(elem, javax.swing.text.View.Y_AXIS);
        setPropertiesFromAttributes();
        javax.swing.text.Document doc = elem.getDocument();
    ...
    protected void setPropertiesFromAttributes() {
        javax.swing.text.AttributeSet attr = getAttributes();
        if (attr != null) {
            setParagraphInsets(attr);
            Integer a = (Integer)attr.getAttribute(StyleConstants.Alignment);
            int alignment;
            if (a == null) {
                javax.swing.text.Document doc = getElement().getDocument();
     ...
     */
    protected int getNextNorthSouthVisualPositionFrom(int pos, javax.swing.text.Position.Bias b,
    ...
    protected int getClosestPositionTo(int pos, javax.swing.text.Position.Bias b, Shape a,
                                       int direction, javax.swing.text.Position.Bias[] biasRet,
                                       int rowIndex, int x)
              throws BadLocationException {
        JTextComponent text = (JTextComponent)getContainer();
        javax.swing.text.Document doc = getDocument();
        javax.swing.text.View row = getView(rowIndex);
        int lastPos = -1;
        ...
        for(int vc = 0, numViews = row.getViewCount(); vc < numViews; vc++) {
            javax.swing.text.View v = row.getView(vc);
    ...
    public int getFlowSpan(int index) {
        javax.swing.text.View child = getView(index);
        int adjust = 0;
     ...
     * @see javax.swing.text.TabSet
     * @see javax.swing.text.TabStop
     * @see LabelView
     */
    public float nextTabStop(float x, int tabOffset) {
        ...
        if(justification != StyleConstants.ALIGN_LEFT)
            return x + 10.0f;
        x -= tabBase;
        javax.swing.text.TabSet tabs = getTabSet();
        if(tabs == null) {
            // a tab every 72 pixels.
            return (float)(tabBase + (((int)x / 72 + 1) * 72));
        }
        javax.swing.text.TabStop tab = tabs.getTabAfter(x + .01f);
        if(tab == null) {
        ...
        switch(alignment) {
        default:
        case javax.swing.text.TabStop.ALIGN_LEFT:
            // Simple case, left tab.
            return tabBase + tab.getPosition();
        case javax.swing.text.TabStop.ALIGN_BAR:
    ...
    protected int findOffsetToCharactersInString(char[] string,
        ...
        javax.swing.text.Segment seg = new Segment();
        try {
    ...
    public float getAlignment(int axis) {
        ...
        case Y_AXIS:
            float a = 0.5f;
            if (getViewCount() != 0) {
                int paragraphSpan = (int) getPreferredSpan(javax.swing.text.View.Y_AXIS);
                javax.swing.text.View v = getView(0);
                int rowSpan = (int) v.getPreferredSpan(javax.swing.text.View.Y_AXIS);
     ...
     */
    public javax.swing.text.View breakView(int axis, float len, Shape a) {
        if(axis == javax.swing.text.View.Y_AXIS) {
            if(a != null) {
     ...
     * @see javax.swing.text.View#getBreakWeight
     */
    ...
    protected SizeRequirements calculateMinorAxisRequirements(int axis,
        ...
        for (int i = 0; i < n; i++) {
            javax.swing.text.View v = getLayoutView(i);
            float span = v.getMinimumSpan(axis);
            if (v.getBreakWeight(axis, 0, v.getMaximumSpan(axis)) > javax.swing.text.View.BadBreakWeight) {
     ...
     */
    private float findEdgeSpan(javax.swing.text.View v, int axis, int fp, int p0, int p1) {
        int len = p1 - p0;
        if (len <= 1) {
            ...
            javax.swing.text.View f = startEdge ?
                v.createFragment(fp, mid) : v.createFragment(mid, fp);
            boolean breakable = f.getBreakWeight(
                    axis, 0, f.getMaximumSpan(axis)) > javax.swing.text.View.BadBreakWeight;
     ...
     */
    public void changedUpdate(DocumentEvent changes, Shape a, javax.swing.text.ViewFactory f) {
    ...
    class Row extends BoxView {
        ...
        Row(Element elem) {
            super(elem, javax.swing.text.View.X_AXIS);
        }
        ...
        public AttributeSet getAttributes() {
            javax.swing.text.View p = getParent();
        ...
        public Shape modelToView(int pos, Shape a, Position.Bias b) throws BadLocationException {
            ...
            javax.swing.text.View v = getViewAtPosition(pos, r);
         ...
         * @see javax.swing.text.View#getRange
         */
        ...
        private boolean isBrokenRow() {
            ...
            if (viewsCount > 0) {
                javax.swing.text.View lastView = getView(viewsCount - 1);
        ...
        protected void layoutMajorAxis(int targetSpan, int axis,
            ...
            for (int i = getViewCount() - 1; i >= 0 ; i--) {
                javax.swing.text.View view = getView(i);
                if (view instanceof javax.swing.text.GlyphView) {
                    javax.swing.text.GlyphView.JustificationInfo justificationInfo =
        ...
        public float getMaximumSpan(int axis) {
            float ret;
            if (javax.swing.text.View.X_AXIS == axis
                  && isJustifyEnabled()) {
                ret = Float.MAX_VALUE;
            } else {
        ...
        protected int getViewIndexAtPosition(int pos) {
            ...
            for(int counter = getViewCount() - 1; counter >= 0; counter--) {
                javax.swing.text.View v = getView(counter);
