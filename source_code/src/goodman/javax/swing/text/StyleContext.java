...
import goodman.javax.swing.event.EventListenerList;
...
public class StyleContext implements Serializable, AbstractDocument.AttributeContext {
    ...
    public javax.swing.text.Style addStyle(String nm, javax.swing.text.Style parent) {
        javax.swing.text.Style style = new NamedStyle(nm, parent);
        if (nm != null) {
    ...
    public javax.swing.text.Style getStyle(String nm) {
        return (javax.swing.text.Style) styles.getAttribute(nm);
    }
     ...
     */
    public synchronized javax.swing.text.AttributeSet addAttribute(javax.swing.text.AttributeSet old, Object name, Object value) {
     ...
     * @see MutableAttributeSet#addAttribute
     */
    public synchronized javax.swing.text.AttributeSet addAttributes(javax.swing.text.AttributeSet old, javax.swing.text.AttributeSet attr) {
     ...
     */
    public synchronized javax.swing.text.AttributeSet removeAttribute(javax.swing.text.AttributeSet old, Object name) {
        if ((old.getAttributeCount() - 1) <= getCompressionThreshold()) {
            // build a search key and find/create an immutable and unique
            // set.
            search.removeAttributes(search);
     ...
     */
    public synchronized javax.swing.text.AttributeSet removeAttributes(javax.swing.text.AttributeSet old, Enumeration<?> names) {
     ...
     * @see MutableAttributeSet#removeAttributes
     */
    public synchronized javax.swing.text.AttributeSet removeAttributes(javax.swing.text.AttributeSet old, javax.swing.text.AttributeSet attrs) {
        if (old.getAttributeCount() <= getCompressionThreshold()) {
            // build a search key and find/create an immutable and unique
            // set.
            search.removeAttributes(search);
     ...
     *  the compact form.
     */
    protected SmallAttributeSet createSmallAttributeSet(javax.swing.text.AttributeSet a) {
     ...
     *  the larger form.
     */
    protected MutableAttributeSet createLargeAttributeSet(javax.swing.text.AttributeSet a) {
     ...
     */
    MutableAttributeSet getMutableAttributeSet(javax.swing.text.AttributeSet a) {
    ...
    public void writeAttributes(ObjectOutputStream out,
                                  javax.swing.text.AttributeSet a) throws IOException {
    ...
    public class SmallAttributeSet implements javax.swing.text.AttributeSet {
        ...
        public SmallAttributeSet(javax.swing.text.AttributeSet attrs) {
        ...
        private void updateResolveParent() {
            ...
            for (int i = 0; i < tbl.length; i += 2) {
                if (tbl[i] == StyleConstants.ResolveAttribute) {
                    resolveParent = (javax.swing.text.AttributeSet)tbl[i + 1];
                    break;
                }
            }
        }
        ...
        public String toString() {
            ...
            Object[] tbl = attributes;
            for (int i = 0; i < tbl.length; i += 2) {
                if (tbl[i+1] instanceof javax.swing.text.AttributeSet) {
                    // don't recurse
    ...
    class KeyBuilder {
        ...
        public void initialize(javax.swing.text.AttributeSet a) {
         ...
         */
        public void removeAttributes(javax.swing.text.AttributeSet attr) {
            Enumeration names = attr.getAttributeNames();
            while (names.hasMoreElements()) {
                Object name = names.nextElement();
     ...
     * Please see {@link java.beans.XMLEncoder}.
     */
    public class NamedStyle implements javax.swing.text.Style, Serializable {
         ...
         * @since 1.4
         */
        public NamedStyle(String name, javax.swing.text.Style parent) {
