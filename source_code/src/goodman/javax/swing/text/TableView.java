...
public abstract class TableView extends javax.swing.text.BoxView {
     ...
     * @return the row
     */
    protected TableRow createTableRow(javax.swing.text.Element elem) {
     ...
     */
    @Deprecated
    protected TableCell createTableCell(javax.swing.text.Element elem) {
    ...
    int getRowSpan(int row) {
        javax.swing.text.View rv = getRow(row);
        if (rv != null) {
        ...
        if (! gridValid) {
            ...
            for (int row = 0; row < nrows; row++) {
                ...
                for (int cell = 0; cell < rv.getViewCount(); cell++, col++) {
                    javax.swing.text.View cv = rv.getView(cell);
    ...
    */
    ...
    void calculateColumnRequirements(int axis) {
        ...
        for (int i = 0; i < nrows; i++) {
            ...
            for (int cell = 0; cell < ncells; cell++, col++) {
                javax.swing.text.View cv = row.getView(cell);
     ...
     */
    void checkSingleColumnCell(int axis, int col, javax.swing.text.View v) {
     ...
     * columns.
     */
    void checkMultiColumnCell(int axis, int col, int ncols, javax.swing.text.View v) {
    ...
    protected javax.swing.text.View getViewAtPosition(int pos, Rectangle a) {
        ...
        if (pos == getEndOffset()) {
            javax.swing.text.View v = getView(n - 1);
            if (a != null) {
    ...
    public class TableRow extends javax.swing.text.BoxView {
        ...
        protected void layoutMajorAxis(int targetSpan, int axis, int[] offsets, int[] spans) {
            ...
            for (int cell = 0; cell < ncells; cell++, col++) {
                javax.swing.text.View cv = getView(cell);
