...
public class ZoneView extends BoxView {
    ...
    Vector<javax.swing.text.View> loadedZones;
     ...
     */
    public ZoneView(javax.swing.text.Element elem, int axis) {
        super(elem, axis);
        loadedZones = new Vector<javax.swing.text.View>();
    }
    ...
    void unloadOldZones() {
        while (loadedZones.size() > getMaxZonesLoaded()) {
            javax.swing.text.View zone = loadedZones.elementAt(0);
     ...
     */
    protected javax.swing.text.View createZone(int p0, int p1) {
        javax.swing.text.Document doc = getDocument();
        javax.swing.text.View zone;
        try {
    ...
    void splitZone(int index, int offs0, int offs1) {
        ...
        Vector<javax.swing.text.View> zones = new Vector<javax.swing.text.View>();
        int offs = offs0;
        do {
            offs0 = offs;
        ...
        javax.swing.text.View oldZone = getView(index);
        javax.swing.text.View[] newZones = new javax.swing.text.View[zones.size()];
    ...
    class Zone extends AsyncBoxView {
        ...
        public Zone(javax.swing.text.Element elem, javax.swing.text.Position start, javax.swing.text.Position end) {
        ...
        public void load() {
            if (! isLoaded()) {
                ...
                javax.swing.text.View[] added = new javax.swing.text.View[index1 - index0 + 1];
        ...
        protected void loadChildren(ViewFactory f) {
            ...
            javax.swing.text.View first = f.create(elem.getElement(index0));
        ...
        protected boolean updateChildren(DocumentEvent.ElementChange ec,
            ...
            if ((index >= index0) && (index <= index1)) {
                ...
                javax.swing.text.View[] added = new javax.swing.text.View[nadd];
