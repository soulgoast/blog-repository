...
import goodman.javax.swing.JEditorPane;
...
public class StyledEditorKit extends DefaultEditorKit {
    ...
    public Action[] getActions() {
        return javax.swing.text.TextAction.augmentList(super.getActions(), this.defaultActions);
    }
   ...
   /**
    ...
    private static final javax.swing.text.ViewFactory defaultFactory = new StyledViewFactory();
    ...
    class AttributeTracker implements CaretListener, PropertyChangeListener, Serializable {
         ...
         */
        void updateInputAttributes(int dot, int mark, javax.swing.text.JTextComponent c) {
            // EditorKit might not have installed the StyledDocument yet.
            javax.swing.text.Document aDoc = c.getDocument();
            if (!(aDoc instanceof javax.swing.text.StyledDocument)) {
                return ;
            }
            int start = Math.min(dot, mark);
            // record current character attributes.
            javax.swing.text.StyledDocument doc = (javax.swing.text.StyledDocument)aDoc;
        ...
        public void propertyChange(PropertyChangeEvent evt) {
            ...
            if ((source instanceof javax.swing.text.JTextComponent) &&
                (newValue instanceof javax.swing.text.Document)) {
                // New document will have changed selection to 0,0.
                updateInputAttributes(0, 0, (javax.swing.text.JTextComponent)source);
            }
        }
    ...
    private static final Action[] defaultActions = {
        ...
        new AlignmentAction("left-justify", javax.swing.text.StyleConstants.ALIGN_LEFT),
        new AlignmentAction("center-justify", javax.swing.text.StyleConstants.ALIGN_CENTER),
        new AlignmentAction("right-justify", javax.swing.text.StyleConstants.ALIGN_RIGHT),
        new BoldAction(),
        new ItalicAction(),
    ...
    public abstract static class StyledTextAction extends TextAction {
        ...
        protected final JEditorPane getEditor(ActionEvent e) {
            javax.swing.text.JTextComponent tcomp = getTextComponent(e);
         ...
         */
        protected final javax.swing.text.StyledDocument getStyledDocument(JEditorPane e) {
            Document d = e.getDocument();
            if (d instanceof javax.swing.text.StyledDocument) {
                return (javax.swing.text.StyledDocument) d;
            }
        ...
        protected final void setCharacterAttributes(JEditorPane editor,
                                                    javax.swing.text.AttributeSet attr, boolean replace) {
            int p0 = editor.getSelectionStart();
            int p1 = editor.getSelectionEnd();
            if (p0 != p1) {
                javax.swing.text.StyledDocument doc = getStyledDocument(editor);
    ...
    public static class BoldAction extends StyledTextAction {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (editor != null) {
                ...
                javax.swing.text.StyleConstants.setBold(sas, bold);
    ...
    public static class ItalicAction extends StyledTextAction {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (editor != null) {
                ...
                SimpleAttributeSet sas = new SimpleAttributeSet();
                javax.swing.text.StyleConstants.setItalic(sas, italic);
                setCharacterAttributes(editor, sas, false);
            }
        }
    }
