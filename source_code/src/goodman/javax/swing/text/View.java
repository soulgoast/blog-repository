...
A view has the following responsibilities:
  ...
  <p>The <code>setSize</code> method should be prepared to be called a number of times
    ...
    <ul>
    <li>{@link #modelToView(int, javax.swing.text.Position.Bias, int, javax.swing.text.Position.Bias, Shape) modelToView}
    <li>{@link #viewToModel(float, float, Shape, javax.swing.text.Position.Bias[]) viewToModel}
