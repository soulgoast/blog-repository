...
public abstract class FlowView extends BoxView {
     ...
     */
    public FlowView(javax.swing.text.Element elem, int axis) {
        super(elem, axis);
    ...
    public static class FlowStrategy {
        ...
        Vector<javax.swing.text.View> viewBuffer;
         ...
         */
        protected javax.swing.text.View getLogicalView(FlowView fv) {
        ...
        public void layout(FlowView fv) {
            javax.swing.text.View pool = getLogicalView(fv);
            int rowIndex, p0;
            ...
            viewBuffer = new Vector<javax.swing.text.View>(10, 10);
            int rowCount = fv.getViewCount();
            while (p0 < p1) {
                javax.swing.text.View row;
        ...
        protected int layoutRow(FlowView fv, int rowIndex, int pos) {
            ...
            while (pos < end && spanLeft >= 0) {
                javax.swing.text.View v = createView(fv, pos, (int)spanLeft, rowIndex);
                if (v == null) {
                    break;
                }
                ...
                if (bw >= ForcedBreakWeight) {
                    javax.swing.text.View w = v.breakView(flowAxis, pos, x, spanLeft);
                    if (w != null) {
                        viewBuffer.add(w);
                    } else if (n == 0) {
            ...
            javax.swing.text.View[] views = new javax.swing.text.View[viewBuffer.size()];
        ...
        protected void adjustRow(FlowView fv, int rowIndex, int desiredSpan, int x) {
            final int flowAxis = fv.getFlowAxis();
            javax.swing.text.View r = fv.getView(rowIndex);
            ...
            javax.swing.text.View[] va = new javax.swing.text.View[1];
            va[0] = v;
            ...
            for (int i = 0; i < lv.getViewCount(); i++) {
                javax.swing.text.View tmpView = lv.getView(i);
        ...
        void reparentViews(javax.swing.text.View pool, int startPos) {
         ...
         */
        protected javax.swing.text.View createView(FlowView fv, int startOffset, int spanLeft, int rowIndex) {
    ...
    static class LogicalView extends CompositeView {
        ...
        LogicalView(javax.swing.text.Element elem) {
            super(elem);
        }
        ...
        protected void forwardUpdateToView(javax.swing.text.View v, DocumentEvent e,
            ...
            javax.swing.text.View parent = v.getParent();
            v.setParent(this);
