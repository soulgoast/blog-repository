...
import goodman.javax.swing.text.LayeredHighlighter;
...
public class DefaultHighlighter extends LayeredHighlighter {
    ...
    public void paintLayeredHighlights(Graphics g, int p0, int p1,
                                       Shape viewBounds,
                                       javax.swing.text.JTextComponent editor, javax.swing.text.View view) {
     ...
     */
    private void safeDamageRange(final javax.swing.text.Position p0, final javax.swing.text.Position p1) {
    ...
    public static class DefaultHighlightPainter extends LayerPainter {
         ...
         * @param c the editor
         */
        public void paint(Graphics g, int offs0, int offs1, Shape bounds, javax.swing.text.JTextComponent c) {
        ...
        public Shape paintLayer(Graphics g, int offs0, int offs1,
                                Shape bounds, javax.swing.text.JTextComponent c, javax.swing.text.View view) {
            Color color = getColor();
            ...
            if (offs0 == view.getStartOffset() &&
                ...
                try {
                    ...
                    Shape shape = view.modelToView(offs0, javax.swing.text.Position.Bias.Forward,
                                                   offs1, javax.swing.text.Position.Bias.Backward,
                                                   bounds);
    ...
    class SafeDamager implements Runnable {
        private Vector<javax.swing.text.Position> p0 = new Vector<javax.swing.text.Position>(10);
        private Vector<javax.swing.text.Position> p1 = new Vector<javax.swing.text.Position>(10);
        private javax.swing.text.Document lastDoc = null;
         ...
         */
        public synchronized void damageRange(javax.swing.text.Position pos0, Position pos1) {
            if (component == null) {
                p0.clear();
                lastDoc = null;
                return;
