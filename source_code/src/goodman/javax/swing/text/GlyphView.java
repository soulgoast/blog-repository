 ...
 */
public class GlyphView extends javax.swing.text.View implements TabableView, Cloneable {
     ...
     */
     public javax.swing.text.Segment getText(int p0, int p1) {
         ...
         javax.swing.text.Segment text = SegmentCache.getSharedSegment();
         try {
    ...
    final void paintTextUsingColor(Graphics g, Shape a, Color c, int p0, int p1) {
        ...
        if (underline || strike) {
            ...
            if ((parent != null) && (parent.getEndOffset() == p1)) {
                ...
                javax.swing.text.Segment s = getText(p0, p1);
    ...
    public int getBreakWeight(int axis, float pos, float len) {
        if (axis == javax.swing.text.View.X_AXIS) {
            ...
            return p1 == p0 ? javax.swing.text.View.BadBreakWeight :
                   getBreakSpot(p0, p1) != BreakIterator.DONE ?
                            javax.swing.text.View.ExcellentBreakWeight : javax.swing.text.View.GoodBreakWeight;
        }
    ...
    private int getBreakSpot(int p0, int p1) {
        if (breakSpots == null) {
            ...
            javax.swing.text.Element parent = getElement().getParentElement();
            int pstart = (parent == null ? start : parent.getStartOffset());
            int pend = (parent == null ? end : parent.getEndOffset());

            javax.swing.text.Segment s = getText(pstart, pend);
            s.first();
    ...
    JustificationInfo getJustificationInfo(int rowStartOffset) {
        ...
        javax.swing.text.Segment segment = getText(startOffset, endOffset);
    ...
    */
    ...
    public static abstract class GlyphPainter {
        ...
        public abstract Shape modelToView(GlyphView v,
                                          int pos, javax.swing.text.Position.Bias bias,
         ...
         * @exception IllegalArgumentException for an invalid direction
         */
        public int getNextVisualPositionFrom(GlyphView v, int pos, javax.swing.text.Position.Bias b, Shape a,
                                             int direction,
                                             javax.swing.text.Position.Bias[] biasRet)
            throws BadLocationException {
            ...
            switch (direction) {
            case javax.swing.text.View.NORTH:
            case javax.swing.text.View.SOUTH:
                if (pos != -1) {
                ...
                break;
            case javax.swing.text.View.EAST:
