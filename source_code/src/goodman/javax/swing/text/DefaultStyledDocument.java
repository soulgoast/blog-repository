...
import goodman.javax.swing.text.AbstractDocument;
import goodman.javax.swing.text.AttributeSet;
import goodman.javax.swing.text.BadLocationException;
import goodman.javax.swing.text.Document;
import goodman.javax.swing.text.Element;
import goodman.javax.swing.text.GapContent;
...
import goodman.javax.swing.text.StateInvariantError;
import goodman.javax.swing.text.Style;
import goodman.javax.swing.text.StyleConstants;
import goodman.javax.swing.text.StyleContext;
import goodman.javax.swing.text.StyledDocument;
import goodman.javax.swing.text.Utilities;
import goodman.javax.swing.undo.AbstractUndoableEdit;
import goodman.javax.swing.undo.CannotRedoException;
import goodman.javax.swing.undo.CannotUndoException;
import goodman.javax.swing.undo.UndoableEdit;
import goodman.javax.swing.SwingUtilities;
 ...
 */
public class DefaultStyledDocument extends javax.swing.text.AbstractDocument implements StyledDocument {
     ...
     */
    public DefaultStyledDocument(Content c, javax.swing.text.StyleContext styles) {
        super(c, styles);
        listeningStyles = new Vector<javax.swing.text.Style>();
        buffer = new ElementBuffer(createDefaultRoot());
        javax.swing.text.Style defaultStyle = styles.getStyle(javax.swing.text.StyleContext.DEFAULT_STYLE);
    ...
    public DefaultStyledDocument() {
        this(new GapContent(BUFFER_SIZE_DEFAULT), new javax.swing.text.StyleContext());
    }
    ...
    protected void create(ElementSpec[] data) {
        try {
            ...
            throw new javax.swing.text.StateInvariantError("problem initializing");
        } finally {
            writeUnlock();
        }
     ...
     * @exception javax.swing.text.BadLocationException for an invalid starting offset
     */
    protected void insert(int offset, ElementSpec[] data) throws javax.swing.text.BadLocationException {
     ...
     * @since  1.7
     */
    public void removeElement(javax.swing.text.Element elem) {
        try {
            writeLock();
    ...
    private void removeElementImpl(javax.swing.text.Element elem) {
        ...
        boolean atEnd = false;
        boolean isComposedText = javax.swing.text.Utilities.isComposedTextElement(elem);
        ...
        if (endOffset >= lastEndOffset) {
            ...
            } catch (javax.swing.text.BadLocationException ble) { // can't happen
        ...
        javax.swing.text.Element[] removed = { elem };
        ...
        if (atEnd) {
            ...
            javax.swing.text.Element prevLeaf = parent.getElement(parent.getElementCount() - 1);
            ...
            javax.swing.text.Element newElem;
            newElem = createLeafElement(prevParent, prevLeaf.getAttributes(),
                                            prevStartOffset, lastEndOffset);
            javax.swing.text.Element[] prevRemoved = { prevLeaf };
            javax.swing.text.Element[] prevAdded = { newElem };
    ...
    public javax.swing.text.Style addStyle(String nm, javax.swing.text.Style parent) {
        javax.swing.text.StyleContext styles = (javax.swing.text.StyleContext) getAttributeContext();
    ...
    public Enumeration<?> getStyleNames() {
        return ((javax.swing.text.StyleContext) getAttributeContext()).getStyleNames();
    }
    ...
    public void setLogicalStyle(int pos, javax.swing.text.Style s) {
        javax.swing.text.Element paragraph = getParagraphElement(pos);
    ...
    public javax.swing.text.Style getLogicalStyle(int p) {
        ...
        javax.swing.text.Element paragraph = getParagraphElement(p);
        if (paragraph != null) {
            javax.swing.text.AttributeSet a = paragraph.getAttributes();
            javax.swing.text.AttributeSet parent = a.getResolveParent();
            if (parent instanceof javax.swing.text.Style) {
                s = (javax.swing.text.Style) parent;
            }
        }
        return s;
    }
    ...
    public void setCharacterAttributes(int offset, int length, javax.swing.text.AttributeSet s, boolean replace) {
        ...
        try {
            ...
            javax.swing.text.AttributeSet sCopy = s.copyAttributes();

            // PENDING(prinz) - this isn't a very efficient way to iterate
            int lastEnd;
            for (int pos = offset; pos < (offset + length); pos = lastEnd) {
                javax.swing.text.Element run = getCharacterElement(pos);
                lastEnd = run.getEndOffset();
                if (pos == lastEnd) {
                    // offset + length beyond length of document, bail.
                    break;
                }
                javax.swing.text.MutableAttributeSet attr = (javax.swing.text.MutableAttributeSet) run.getAttributes();
     ...
     */
    public void setParagraphAttributes(int offset, int length, javax.swing.text.AttributeSet s,
                                       boolean replace) {
        try {
            writeLock();
            DefaultDocumentEvent changes =
            ...
            javax.swing.text.Element section = getDefaultRootElement();
            ...
            for (int i = index0; i <= index1; i++) {
                javax.swing.text.Element paragraph = section.getElement(i);
                javax.swing.text.MutableAttributeSet attr = (javax.swing.text.MutableAttributeSet) paragraph.getAttributes();
    ...
    protected void insertUpdate(DefaultDocumentEvent chng, javax.swing.text.AttributeSet attr) {
        ...
        if (attr == null) {
            attr = javax.swing.text.SimpleAttributeSet.EMPTY;
        }

        // Paragraph attributes should come from point after insertion.
        // You really only notice this when inserting at a paragraph
        // boundary.
        javax.swing.text.Element paragraph = getParagraphElement(offset + length);
        javax.swing.text.AttributeSet pattr = paragraph.getAttributes();
        // Character attributes should come from actual insertion point.
        javax.swing.text.Element pParagraph = getParagraphElement(offset);
        javax.swing.text.Element run = pParagraph.getElement(pParagraph.getElementIndex
                                            (offset));
        int endOffset = offset + length;
        boolean insertingAtBoundry = (run.getEndOffset() == endOffset);
        javax.swing.text.AttributeSet cattr = run.getAttributes();

        try {
            javax.swing.text.Segment s = new Segment();
            ...
            if(lastStartSpec != null) {
                ...
                // element after pParagraph, and it isn't a leaf.
                    ...
                    javax.swing.text.Element parent = pParagraph.getParentElement();
            ...
            if(insertingAtBoundry && endOffset < docLength) {
                ...
                if(last.getType() == ElementSpec.ContentType &&
                   ...
                   ((lastStartSpec == null && (paragraph == pParagraph ||
                    ...
                    javax.swing.text.Element nextRun = paragraph.getElement(paragraph.
            ...
            if (Utilities.isComposedTextAttributeDefined(attr)) {
                javax.swing.text.MutableAttributeSet mattr = (javax.swing.text.MutableAttributeSet) attr;
                mattr.addAttributes(cattr);
                mattr.addAttribute(javax.swing.text.AbstractDocument.ElementNameAttribute,
                        javax.swing.text.AbstractDocument.ContentElementName);
     ...
     */
    short createSpecsForInsertAfterNewline(javax.swing.text.Element paragraph,
                                           javax.swing.text.Element pParagraph, javax.swing.text.AttributeSet pattr, Vector<ElementSpec> parseBuffer,
        ...
        if(paragraph.getParentElement() == pParagraph.getParentElement()) {
            ...
            Vector<javax.swing.text.Element> leftParents = new Vector<javax.swing.text.Element>();
            Vector<javax.swing.text.Element> rightParents = new Vector<javax.swing.text.Element>();
            javax.swing.text.Element e = pParagraph;
            while(e != null) {
    ...
    protected AbstractElement createDefaultRoot() {
        ...
        javax.swing.text.Element[] buff = new javax.swing.text.Element[1];
        buff[0] = brk;
     ...
     * @return the color
     */
    public Color getForeground(javax.swing.text.AttributeSet attr) {
        javax.swing.text.StyleContext styles = (javax.swing.text.StyleContext) getAttributeContext();
     ...
     * @return the color
     */
    public Color getBackground(javax.swing.text.AttributeSet attr) {
        javax.swing.text.StyleContext styles = (javax.swing.text.StyleContext) getAttributeContext();
     ...
     * @return the font
     */
    public Font getFont(javax.swing.text.AttributeSet attr) {
        javax.swing.text.StyleContext styles = (javax.swing.text.StyleContext) getAttributeContext();
        ...
        synchronized(listeningStyles) {
            ...
            if (styleChangeListener != null && styles != null) {
                ...
                while (styleNames.hasMoreElements()) {
                    ...
                    javax.swing.text.Style aStyle = styles.getStyle(name);
                ...
                for (int counter = v.size() - 1; counter >= 0; counter--) {
                    javax.swing.text.Style aStyle = (javax.swing.text.Style)v.elementAt(counter);
    ...
    private void readObject(ObjectInputStream s)
        ...
        if (styleContextChangeListener == null &&
            ...
            if (styleContextChangeListener != null) {
                javax.swing.text.StyleContext styles = (StyleContext)getAttributeContext();
                styles.addChangeListener(styleContextChangeListener);
            }
            updateStylesListeningTo();
        }
    ...
    /** Styles listening to. */
    private transient Vector<javax.swing.text.Style> listeningStyles;
    ...
    public static class ElementSpec {
         ...
         *  ContentType)
         */
        public ElementSpec(javax.swing.text.AttributeSet a, short type) {
         ...
         */
        public ElementSpec(javax.swing.text.AttributeSet a, short type, int len) {
         ...
         */
        public ElementSpec(javax.swing.text.AttributeSet a, short type, char[] txt,
                           int offs, int len) {
            attr = a;
            this.type = type;
            this.data = txt;
    ...
    public class ElementBuffer implements Serializable {
        ...
        void create(int length, ElementSpec[] data, DefaultDocumentEvent de) {
            ...
            javax.swing.text.Element elem = root;
            int index = elem.getElementIndex(0);
            while (! elem.isLeaf()) {
                javax.swing.text.Element child = elem.getElement(index);
                push(elem, index);
                elem = child;
                index = elem.getElementIndex(0);
            }
            ElemChanges ec = path.peek();
            javax.swing.text.Element child = ec.parent.getElement(ec.index);
            ...
            javax.swing.text.AttributeSet newAttrs = null;
            ...
            javax.swing.text.MutableAttributeSet attr = (javax.swing.text.MutableAttributeSet)root.
                                       getAttributes();
        ...
        boolean split(int offs, int len) {
            ...
            // push the path
            javax.swing.text.Element e = root;
        ...
        void endEdits(DefaultDocumentEvent de) {
            ...
            for (int i = 0; i < n; i++) {
                ...
                javax.swing.text.Element[] removed = new javax.swing.text.Element[ec.removed.size()];
                ec.removed.copyInto(removed);
                javax.swing.text.Element[] added = new javax.swing.text.Element[ec.added.size()];
         ...
         */
        void push(javax.swing.text.Element e, int index, boolean isFracture) {
            ElemChanges ec = new ElemChanges(e, index, isFracture);
            path.push(ec);
        }

        void push(javax.swing.text.Element e, int index) {
            push(e, index, false);
        }
        ...
        void pop() {
            ...
            if ((ec.added.size() > 0) || (ec.removed.size() > 0)) {
                ...
                javax.swing.text.Element e = ec.parent;
        ...
        void insertElement(ElementSpec es) {
            ...
            case ElementSpec.StartTagType:
                ...
                case ElementSpec.JoinNextDirection:
                    ...
                    javax.swing.text.Element parent = ec.parent.getElement(ec.index);
                    ...
                    if(parent.isLeaf()) {
                        ...
                        if((ec.index + 1) < ec.parent.getElementCount())
                            ...
                            throw new javax.swing.text.StateInvariantError("Join next to leaf");
                    }
                ...
                case ElementSpec.JoinFractureDirection:
                    ...
                    break;
                default:
                    javax.swing.text.Element belem = createBranchElement(ec.parent,
                                                        es.getAttributes());
            ...
            case ElementSpec.ContentType:
              int len = es.getLength();
                if (es.getDirection() != ElementSpec.JoinNextDirection) {
                    javax.swing.text.Element leaf = createLeafElement(ec.parent, es.getAttributes(),
                                                     pos, pos + len);
                    ...
                    if(!ec.isFracture) {
                        javax.swing.text.Element first = null;
                        if(insertPath != null) {
                        ...
                        javax.swing.text.Element leaf = createLeafElement(ec.parent, first.
                        ...
                        javax.swing.text.Element first = ec.parent.getElement(0);
                        javax.swing.text.Element leaf = createLeafElement(ec.parent, first.
                                 getAttributes(), pos, first.getEndOffset());
                        ec.added.addElement(leaf);
                        ec.removed.addElement(first);
         ...
         */
        boolean removeElements(javax.swing.text.Element elem, int rmOffs0, int rmOffs1) {
            if (! elem.isLeaf()) {
                ...
                if (index0 == index1) {
                    javax.swing.text.Element child0 = elem.getElement(index0);
                    ...
                    javax.swing.text.Element child0 = elem.getElement(index0);
                    javax.swing.text.Element child1 = elem.getElement(index1);
                    ...
                    if (containsOffs1 && canJoin(child0, child1)) {
                        ...
                        javax.swing.text.Element e = join(elem, child0, child1, rmOffs0, rmOffs1);
                        ec.added.addElement(e);
                    } else {
         ...
         * into one element?
         */
        boolean canJoin(javax.swing.text.Element e0, javax.swing.text.Element e1) {
            if ((e0 == null) || (e1 == null)) {
                return false;
            }
         ...
         * given removed range.
         */
        javax.swing.text.Element join(javax.swing.text.Element p, javax.swing.text.Element left, javax.swing.text.Element right, int rmOffs0, int rmOffs1) {
            if (left.isLeaf() && right.isLeaf()) {
                ...
                javax.swing.text.Element to = createBranchElement(p, left.getAttributes());
                int ljIndex = left.getElementIndex(rmOffs0);
                int rjIndex = right.getElementIndex(rmOffs1);
                javax.swing.text.Element lj = left.getElement(ljIndex);
                if (lj.getStartOffset() >= rmOffs0) {
                    lj = null;
                }
                javax.swing.text.Element rj = right.getElement(rjIndex);
                if (rj.getStartOffset() == rmOffs1) {
                    rj = null;
                }
                Vector<javax.swing.text.Element> children = new Vector<javax.swing.text.Element>();
                ...
                if (canJoin(lj, rj)) {
                    javax.swing.text.Element e = join(to, lj, rj, rmOffs0, rmOffs1);
                ...
                javax.swing.text.Element[] c = new javax.swing.text.Element[children.size()];
                children.copyInto(c);
                ((BranchElement)to).replace(0, 0, c);
                return to;
            } else {
                throw new javax.swing.text.StateInvariantError(
        ...
        public javax.swing.text.Element clone(javax.swing.text.Element parent, javax.swing.text.Element clonee) {
            ...
            javax.swing.text.Element e = createBranchElement(parent, clonee.getAttributes());
            int n = clonee.getElementCount();
            javax.swing.text.Element[] children = new javax.swing.text.Element[n];
            for (int i = 0; i < n; i++) {
         ...
         */
        javax.swing.text.Element cloneAsNecessary(javax.swing.text.Element parent, javax.swing.text.Element clonee, int rmOffs0, int rmOffs1) {
            if (clonee.isLeaf()) {
                return createLeafElement(parent, clonee.getAttributes(),
                                         clonee.getStartOffset(),
                                         clonee.getEndOffset());
            ...
            javax.swing.text.Element e = createBranchElement(parent, clonee.getAttributes());
            int n = clonee.getElementCount();
            ArrayList<javax.swing.text.Element> childrenList = new ArrayList<javax.swing.text.Element>(n);
            for (int i = 0; i < n; i++) {
                javax.swing.text.Element elem = clonee.getElement(i);
                if (elem.getStartOffset() < rmOffs0 || elem.getEndOffset() > rmOffs1) {
                    childrenList.add(cloneAsNecessary(e, elem, rmOffs0, rmOffs1));
                }
            }
            javax.swing.text.Element[] children = new javax.swing.text.Element[childrenList.size()];
        ...
        void fractureFrom(ElemChanges[] changed, int startIndex,
            ...
            javax.swing.text.Element newChild;
            ...
            // insertion point.
            javax.swing.text.Element parent = newChild;
            ...
            while(++startIndex < endFractureIndex) {
                ...
                if(newChild == null) {
                    ...
                    kidStartIndex = 0;
                    kids = new javax.swing.text.Element[kidsToMove];
                }
                else {
                    if(!isEnd) {
                        // Branch.
                ...
                for(int counter = kidStartIndex; counter < kidsToMove;
                    counter++) {
                    javax.swing.text.Element toMove =change.parent.getElement(moveStartIndex++);
         ...
         */
        javax.swing.text.Element recreateFracturedElement(javax.swing.text.Element parent, javax.swing.text.Element toDuplicate) {
            ...
            // Not a leaf
            javax.swing.text.Element newParent = createBranchElement(parent, toDuplicate.
                                                    getAttributes());
            int childCount = toDuplicate.getElementCount();
            javax.swing.text.Element[] newKids = new javax.swing.text.Element[childCount];
        ...
        void fractureDeepestLeaf(ElementSpec[] specs) {
            ...
            // have a length of 0!).
            if (offset != 0) {
                javax.swing.text.Element newChild = createLeafElement(ec.parent,
                                                 child.getAttributes(),
        ...
        void insertFirstContent(ElementSpec[] specs) {
            ...
            case ElementSpec.JoinPreviousDirection:
                if(child.getEndOffset() != firstEndOffset &&
                    ...
                    javax.swing.text.Element newE = createLeafElement(ec.parent,
            ...
            case ElementSpec.JoinNextDirection:
                if(offset != 0) {
                    ...
                    javax.swing.text.Element nextChild = ec.parent.getElement(ec.index + 1);
                    if(isOnlyContent)
        ...
        class ElemChanges {
            ...
            ElemChanges(javax.swing.text.Element parent, int index, boolean isFracture) {
                this.parent = parent;
                this.index = index;
                this.isFracture = isFracture;
                added = new Vector<javax.swing.text.Element>();
                removed = new Vector<javax.swing.text.Element>();
            }
            ...
            int index;
            Vector<javax.swing.text.Element> added;
            Vector<javax.swing.text.Element> removed;
            boolean isFracture;
        }
    ...
    public static class AttributeUndoableEdit extends AbstractUndoableEdit {
        public AttributeUndoableEdit(javax.swing.text.Element element, javax.swing.text.AttributeSet newAttributes,
                                     boolean isReplacing) {
            super();
        ...
        public void redo() throws CannotRedoException {
            super.redo();
            javax.swing.text.MutableAttributeSet as = (javax.swing.text.MutableAttributeSet)element
                                     .getAttributes();
            if(isReplacing)
        ...
        public void undo() throws CannotUndoException {
            super.undo();
            javax.swing.text.MutableAttributeSet as = (MutableAttributeSet)element.getAttributes();
            as.removeAttributes(as);
    ...
    static class StyleChangeHandler extends AbstractChangeHandler {
        ...
        void fireStateChanged(DefaultStyledDocument d, ChangeEvent e) {
            ...
            if (source instanceof javax.swing.text.Style) {
