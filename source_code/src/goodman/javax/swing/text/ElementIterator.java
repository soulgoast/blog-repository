...
public class ElementIterator implements Cloneable {
    ...
    private class StackItem implements Cloneable {
        javax.swing.text.Element item;
        int childIndex;

        private StackItem(javax.swing.text.Element elem) {
            /**
        ...
        private javax.swing.text.Element getElement() {
            return item;
        }
    ...
    public javax.swing.text.Element current() {
        ...
        */
        if (! elementStack.empty()) {
            ...
            javax.swing.text.Element elem = item.getElement();
    ...
    public javax.swing.text.Element next() {
        ...
        if (index+1 < elem.getElementCount()) {
            javax.swing.text.Element child = elem.getElement(index+1);
            if (child.isLeaf()) {
     ...
     */
    private javax.swing.text.Element getDeepestLeaf(javax.swing.text.Element parent) {
        if (parent.isLeaf()) {
            return parent;
        }
