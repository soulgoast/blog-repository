...
public class WrappedPlainView extends BoxView implements TabExpander {
    ...
    protected void drawLine(int p0, int p1, Graphics g, int x, int y) {
        javax.swing.text.Element lineMap = getElement();
        javax.swing.text.Element line = lineMap.getElement(lineMap.getElementIndex(p0));
    ...
    private int drawText(javax.swing.text.Element elem, int p0, int p1, Graphics g, int x, int y) throws BadLocationException {
        p1 = Math.min(getDocument().getLength(), p1);
        AttributeSet attr = elem.getAttributes();

        if (javax.swing.text.Utilities.isComposedTextAttributeDefined(attr)) {
            g.setColor(unselected);
            x = javax.swing.text.Utilities.drawComposedText(this, attr, g, x, y,
    ...
    protected int drawUnselectedText(Graphics g, int x, int y,
        ...
        int ret = javax.swing.text.Utilities.drawTabbedText(this, segment, x, y, g, this, p0);
    ...
    protected final javax.swing.text.Segment getLineBuffer() {
        if (lineBuffer == null) {
            lineBuffer = new javax.swing.text.Segment();
        }
        return lineBuffer;
    }
    ...
    protected int calculateBreakPosition(int p0, int p1) {
        ...
        if (wordWrap) {
            p = p0 + javax.swing.text.Utilities.getBreakLocation(segment, metrics,
                                                tabBase, tabBase + currentWidth,
                                                this, p0);
        } else {
            p = p0 + javax.swing.text.Utilities.getTabbedTextOffset(segment, metrics,
                                                   tabBase, tabBase + currentWidth,
                                                   this, p0, false);
        }
        javax.swing.text.SegmentCache.releaseSharedSegment(segment);
    ...
    protected void loadChildren(javax.swing.text.ViewFactory f) {
        javax.swing.text.Element e = getElement();
        int n = e.getElementCount();
        if (n > 0) {
            javax.swing.text.View[] added = new javax.swing.text.View[n];
            for (int i = 0; i < n; i++) {
    ...
    void updateChildren(DocumentEvent e, Shape a) {
        javax.swing.text.Element elem = getElement();
        DocumentEvent.ElementChange ec = e.getChange(elem);
        if (ec != null) {
            // the structure of this element changed.
            javax.swing.text.Element[] removedElems = ec.getChildrenRemoved();
            javax.swing.text.Element[] addedElems = ec.getChildrenAdded();
            javax.swing.text.View[] added = new javax.swing.text.View[addedElems.length];
     ...
     * view itself.
     */
    final void loadText(javax.swing.text.Segment segment, int p0, int p1) {
        try {
    ...
    public void paint(Graphics g, Shape a) {
        ...
        tabBase = alloc.x;
        javax.swing.text.JTextComponent host = (javax.swing.text.JTextComponent) getContainer();
     ...
     *           that is returned, although there is no guarantee.
     *           The parent may choose to resize or break the view.
     * @see javax.swing.text.View#getMaximumSpan
     */
     ...
     */
    public void insertUpdate(DocumentEvent e, Shape a, javax.swing.text.ViewFactory f) {
        updateChildren(e, a);

        Rectangle alloc = ((a != null) && isAllocationValid()) ?
            getInsideAllocation(a) : null;
        int pos = e.getOffset();
        javax.swing.text.View v = getViewAtPosition(pos, alloc);
        if (v != null) {
     ...
     */
    public void removeUpdate(DocumentEvent e, Shape a, javax.swing.text.ViewFactory f) {
        updateChildren(e, a);
     ...
     */
    public void changedUpdate(DocumentEvent e, Shape a, javax.swing.text.ViewFactory f) {
        updateChildren(e, a);
    }
     ...
     * with it's sibblings.
     */
    class WrappedLine extends javax.swing.text.View {
        ...
        public void paint(Graphics g, Shape a) {
            ...
            javax.swing.text.JTextComponent host = (JTextComponent)getContainer();
         ...
         */
        public Shape modelToView(int pos, Shape a, javax.swing.text.Position.Bias b)
            ...
            int testP = (b == javax.swing.text.Position.Bias.Forward) ? pos :
                        Math.max(p0, pos - 1);
            int line = 0;
            int[] lineEnds = getLineEnds();
            if (lineEnds != null) {
            ...
            if (pos > p0) {
                ...
                alloc.x += javax.swing.text.Utilities.getTabbedTextWidth(segment, metrics,
