...
class GlyphPainter2 extends javax.swing.text.GlyphView.GlyphPainter {
     ...
     */
    public javax.swing.text.GlyphView.GlyphPainter getPainter(javax.swing.text.GlyphView v, int p0, int p1) {
        return null;
    }
        ...
        if (g instanceof Graphics2D) {
            ...
            if( p0 > v.getStartOffset() || p1 < v.getEndOffset() ) {
                try {
                    ...
                    Shape s = v.modelToView(p0, javax.swing.text.Position.Bias.Forward,
                                            p1, javax.swing.text.Position.Bias.Backward, a);
    ...
    public Shape modelToView(javax.swing.text.GlyphView v, int pos, javax.swing.text.Position.Bias bias,
        ...
        Rectangle2D alloc = a.getBounds2D();
        TextHitInfo hit = (bias == javax.swing.text.Position.Bias.Forward) ?
    ...
    public int viewToModel(javax.swing.text.GlyphView v, float x, float y, Shape a,
        ...
        biasReturn[0] = hit.isLeadingEdge() ? javax.swing.text.Position.Bias.Forward : javax.swing.text.Position.Bias.Backward;
    ...
    /**
        ...
        public int getNextVisualPositionFrom(GlyphView v, int pos,
                                             javax.swing.text.Position.Bias b, Shape a,
                                             int direction,
            ...
            case javax.swing.text.View.EAST:
                ...
                if(pos == -1) {
                    ...
                    if( viewIsLeftToRight ) {
                        ...
                        biasRet[0] = javax.swing.text.Position.Bias.Backward;
                        return endOffset;
                    }
                }
                if( b== javax.swing.text.Position.Bias.Forward )
