 ...
 */
public class PlainView extends javax.swing.text.View implements TabExpander {
    ...
    protected void drawLine(int lineIndex, Graphics g, int x, int y) {
        javax.swing.text.Element line = getElement().getElement(lineIndex);
    ...
    private int drawElement(int lineIndex, javax.swing.text.Element elem, Graphics g, int x, int y) throws BadLocationException {
    ...
    protected int drawUnselectedText(Graphics g, int x, int y,
        ...
        javax.swing.text.Segment s = SegmentCache.getSharedSegment();
    ...
    public void paint(Graphics g, Shape a) {
        ...
        int x = lineArea.x;
        javax.swing.text.Element map = getElement();
    ...
    public Shape modelToView(int pos, Shape a, javax.swing.text.Position.Bias b) throws BadLocationException {
        ...
        tabBase = lineArea.x;
        javax.swing.text.Element line = map.getElement(lineIndex);
    ...
    protected void updateDamage(DocumentEvent changes, Shape a, ViewFactory f) {
        ...
        javax.swing.text.Element[] added = (ec != null) ? ec.getChildrenAdded() : null;
        javax.swing.text.Element[] removed = (ec != null) ? ec.getChildrenRemoved() : null;
        if (((added != null) && (added.length > 0)) ||
            ...
            if (changes.getType() == DocumentEvent.EventType.INSERT) {
                ...
                javax.swing.text.Element e = map.getElement(line);
                if (e == longLine) {
    ...
    private void calculateLongestLine() {
        ...
        javax.swing.text.Element lines = getElement();
        int n = lines.getElementCount();
        int maxWidth = -1;
        for (int i = 0; i < n; i++) {
            javax.swing.text.Element line = lines.getElement(i);
     ...
     */
    private int getLineWidth(javax.swing.text.Element line) {
        if (line == null) {
            return 0;
        }
        int p0 = line.getStartOffset();
