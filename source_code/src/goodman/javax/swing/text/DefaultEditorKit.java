...
import goodman.javax.swing.KeyStroke;
import goodman.javax.swing.SwingConstants;
...
import goodman.javax.swing.text.TextAction;
...
public class DefaultEditorKit extends EditorKit {
     ...
     */
    public void read(InputStream in, javax.swing.text.Document doc, int pos)
     ...
     *   location within the document.
     */
    public void write(OutputStream out, javax.swing.text.Document doc, int pos, int len)
        throws IOException, BadLocationException {
     ...
     */
    public void write(Writer out, javax.swing.text.Document doc, int pos, int len)
        throws IOException, BadLocationException {

        if ((pos < 0) || ((pos + len) > doc.getLength())) {
            throw new BadLocationException("DefaultEditorKit.write", pos);
        }
        javax.swing.text.Segment data = new Segment();
        int nleft = len;
        int offs = pos;
     ...
     * @see #getActions
     * @see javax.swing.text.JTextComponent#getSelectionStart
     * @since 1.6
     */
     ...
     * @see javax.swing.text.Keymap#setDefaultAction
    ...
    public static class DefaultKeyTypedAction extends javax.swing.text.TextAction {
        ...
        public void actionPerformed(ActionEvent e) {
            javax.swing.text.JTextComponent target = getTextComponent(e);
     ...
     * @see DefaultEditorKit#getActions
     */
    static class DeletePrevCharAction extends javax.swing.text.TextAction {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if ((target != null) && (target.isEditable())) {
                try {
                    ...
                    javax.swing.text.Caret caret = target.getCaret();
     ...
     * @see DefaultEditorKit#getActions
     */
    static class DeleteNextCharAction extends javax.swing.text.TextAction {
     ...
     * @see DefaultEditorKit#getActions
     */
    static class DeleteWordAction extends javax.swing.text.TextAction {
         ...
         */
        public void actionPerformed(ActionEvent e) {
            final javax.swing.text.JTextComponent target = getTextComponent(e);
            if ((target != null) && (e != null)) {
                if ((! target.isEditable()) || (! target.isEnabled())) {
                    UIManager.getLookAndFeel().provideErrorFeedback(target);
                    return;
                ...
                try {
                    ...
                    final javax.swing.text.Element line =
                        javax.swing.text.Utilities.getParagraphElement(target, start);
                    int end;
     ...
     * @see DefaultEditorKit#getActions
     */
    static class ReadOnlyAction extends javax.swing.text.TextAction {
     ...
     * @see DefaultEditorKit#getActions
     */
    static class WritableAction extends javax.swing.text.TextAction {
     ...
     * @see DefaultEditorKit#getActions
     */
    static class VerticalPageAction extends javax.swing.text.TextAction {
         ...
         * <code>target</code>.
         */
        private int constrainY(javax.swing.text.JTextComponent target, int y, int vis) {
            if (y < 0) {
                y = 0;
            }
         ...
         */
        private int constrainOffset(javax.swing.text.JTextComponent text, int offset) {
         ...
         */
        private int getAdjustedY(javax.swing.text.JTextComponent text, Rectangle visible, int index) {
     ...
     */
    static class PageAction extends javax.swing.text.TextAction {
    ...
    static class DumpModelAction extends javax.swing.text.TextAction {
        ...
        public void actionPerformed(ActionEvent e) {
            javax.swing.text.JTextComponent target = getTextComponent(e);
            if (target != null) {
                javax.swing.text.Document d = target.getDocument();
     ...
     * to use.
     */
    static class NextVisualPositionAction extends javax.swing.text.TextAction {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (target != null) {
                ...
                javax.swing.text.DefaultCaret bidiCaret = (caret instanceof javax.swing.text.DefaultCaret) ?
                    ...
                    if (filter != null) {
                        dot = filter.getNextVisualPositionFrom
                                     (target, dot, (bidiCaret != null) ?
                                      bidiCaret.getDotBias() :
                                      javax.swing.text.Position.Bias.Forward, direction, bias);
                    }
                    else {
     ...
     * @see DefaultEditorKit#getActions
     */
    static class BeginWordAction extends javax.swing.text.TextAction {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (target != null) {
                try {
                    ...
                    int begOffs = javax.swing.text.Utilities.getWordStart(target, offs);
                    if (select) {
     ...
     * @see DefaultEditorKit#getActions
     */
    static class EndWordAction extends javax.swing.text.TextAction {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (target != null) {
                try {
                    int offs = target.getCaretPosition();
                    int endOffs = javax.swing.text.Utilities.getWordEnd(target, offs);
                    if (select) {
     ...
     * @see DefaultEditorKit#getActions
     */
    static class PreviousWordAction extends javax.swing.text.TextAction {
            ...
            if (target != null) {
                ...
                try {
                    javax.swing.text.Element curPara =
                            javax.swing.text.Utilities.getParagraphElement(target, offs);
                    offs = javax.swing.text.Utilities.getPreviousWord(target, offs);
                    if(offs < curPara.getStartOffset()) {
                        // we should first move to the end of the
                        // previous paragraph (bug #4278839)
                        offs = javax.swing.text.Utilities.getParagraphElement(target, offs).
                                getEndOffset() - 1;
                    }
                } catch (BadLocationException bl) {
                    if (offs != 0) {
     ...
     * @see DefaultEditorKit#getActions
     */
    static class NextWordAction extends javax.swing.text.TextAction {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (target != null) {
                ...
                javax.swing.text.Element curPara =
                        javax.swing.text.Utilities.getParagraphElement(target, offs);
                try {
                    offs = javax.swing.text.Utilities.getNextWord(target, offs);
     ...
     * @see DefaultEditorKit#getActions
     */
    static class BeginLineAction extends javax.swing.text.TextAction {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (target != null) {
                try {
                    int offs = target.getCaretPosition();
                    int begOffs = javax.swing.text.Utilities.getRowStart(target, offs);
                    if (select) {
                        target.moveCaretPosition(begOffs);
                    } else {
                        target.setCaretPosition(begOffs);
     ...
     * @see DefaultEditorKit#getActions
     */
    static class EndLineAction extends javax.swing.text.TextAction {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (target != null) {
                try {
                    int offs = target.getCaretPosition();
                    int endOffs = javax.swing.text.Utilities.getRowEnd(target, offs);
                    if (select) {
                        target.moveCaretPosition(endOffs);
                    } else {
                        target.setCaretPosition(endOffs);
     ...
     * @see DefaultEditorKit#getActions
     */
    static class BeginParagraphAction extends javax.swing.text.TextAction {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (target != null) {
                int offs = target.getCaretPosition();
                javax.swing.text.Element elem = javax.swing.text.Utilities.getParagraphElement(target, offs);
     ...
     * @see DefaultEditorKit#getActions
     */
    static class EndParagraphAction extends javax.swing.text.TextAction {
     ...
     * @see DefaultEditorKit#getActions
     */
    static class BeginAction extends javax.swing.text.TextAction {
     ...
     * @see DefaultEditorKit#getActions
     */
    static class EndAction extends javax.swing.text.TextAction {
     ...
     * @see DefaultEditorKit#getActions
     */
    static class SelectWordAction extends javax.swing.text.TextAction {
     ...
     * @see DefaultEditorKit#getActions
     */
    static class SelectLineAction extends javax.swing.text.TextAction {
     ...
     * @see DefaultEditorKit#getActions
     */
    static class SelectParagraphAction extends javax.swing.text.TextAction {
     ...
     * @see DefaultEditorKit#getActions
     */
    static class SelectAllAction extends javax.swing.text.TextAction {
     ...
     * @see DefaultEditorKit#getActions
     */
    static class UnselectAction extends javax.swing.text.TextAction {
