...
import goodman.java.awt.event.ActionListener;
 ...
 */
public class DefaultCaret extends Rectangle implements javax.swing.text.Caret, FocusListener, MouseListener, MouseMotionListener {
     ...
     * @see javax.swing.text.Caret#install
     */
     ...
     *
     * @param c the component
     * @see javax.swing.text.Caret#deinstall
     */
     ...
     * @see javax.swing.text.Caret#addChangeListener
     */
     ...
     *
     * @param l the listener
     * @see javax.swing.text.Caret#removeChangeListener
     */
    ...
    public void setSelectionVisible(boolean vis) {
        if (vis != selectionVisible) {
            ...
            if (selectionVisible) {
                // show
                javax.swing.text.Highlighter h = component.getHighlighter();
                if ((dot != mark) && (h != null) && (selectionTag == null)) {
                    int p0 = Math.min(dot, mark);
                    int p1 = Math.max(dot, mark);
                    javax.swing.text.Highlighter.HighlightPainter p = getSelectionPainter();
                    try {
     ...
     * @see #isActive
     * @see javax.swing.text.Caret#setVisible
     */
     ...
     * @see #setDot(int, javax.swing.text.Position.Bias)
     ...
     * @see javax.swing.text.Caret#moveDot
     */
    ...
    boolean isPositionLTR(int position, javax.swing.text.Position.Bias bias) {
        javax.swing.text.Document doc = component.getDocument();
        if(bias == javax.swing.text.Position.Bias.Backward && --position < 0)
            position = 0;
    ...
    javax.swing.text.Position.Bias guessBiasForOffset(int offset, javax.swing.text.Position.Bias lastBias,
        ...
        else if(lastBias != javax.swing.text.Position.Bias.Backward &&
                lastLTR != isPositionLTR(offset, javax.swing.text.Position.Bias.Backward)) {
            lastBias = javax.swing.text.Position.Bias.Backward;
        }
      ...
      throws ClassNotFoundException, IOException
    {
        ...
        if (!s.readBoolean()) {
            markBias = javax.swing.text.Position.Bias.Forward;
        }
        else {
            markBias = javax.swing.text.Position.Bias.Backward;
        }
    }

    private void writeObject(ObjectOutputStream s) throws IOException {
        s.defaultWriteObject();
        s.writeBoolean((dotBias == javax.swing.text.Position.Bias.Backward));
        s.writeBoolean((markBias == javax.swing.text.Position.Bias.Backward));
    }
