...
public abstract class EditorKit implements Cloneable, Serializable {
     ...
     */
    public abstract void read(InputStream in, javax.swing.text.Document doc, int pos)
     ...
     *   location within the document.
     */
    public abstract void write(OutputStream out, javax.swing.text.Document doc, int pos, int len)
        throws IOException, BadLocationException;
     ...
     *   location within the document.
     */
    public abstract void read(Reader in, javax.swing.text.Document doc, int pos)
        throws IOException, BadLocationException;
