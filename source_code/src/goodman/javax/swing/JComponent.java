...
import goodman.java.util.Dictionary;
...
import goodman.java.awt.image.VolatileImage;
import goodman.java.awt.Graphics2D;
import goodman.java.awt.peer.LightweightPeer;
import goodman.java.awt.dnd.DropTarget;
import goodman.java.awt.font.FontRenderContext;
import goodman.java.beans.PropertyChangeListener;
import goodman.java.beans.VetoableChangeListener;
import goodman.java.beans.VetoableChangeSupport;
...
import goodman.java.io.ObjectInputValidation;
...
import goodman.javax.swing.ActionMap;
import goodman.javax.swing.ArrayTable;
import goodman.javax.swing.InputMap;
import goodman.javax.swing.JLabel;
import goodman.javax.swing.JRootPane;
import goodman.javax.swing.JToolTip;
import goodman.javax.swing.JViewport;
                                              ...
                                              TransferHandler.HasGetTransferHandler
{
     ...
     * managing focus.
     */
    private static Set<javax.swing.KeyStroke> managingFocusForwardTraversalKeys;

    /**
     * Keys to use for backward focus traversal when the JComponent is
     * managing focus.
     */
    private static Set<javax.swing.KeyStroke> managingFocusBackwardTraversalKeys;
    ...
    static void getGraphicsInvoked(Component root) {
        if (!JComponent.isComponentObtainingGraphicsFrom(root)) {
            javax.swing.JRootPane rootPane = ((RootPaneContainer)root).getRootPane();
            if (rootPane != null) {
     ...
     */
    static Set<javax.swing.KeyStroke> getManagingFocusForwardTraversalKeys() {
        synchronized(JComponent.class) {
            if (managingFocusForwardTraversalKeys == null) {
                managingFocusForwardTraversalKeys = new HashSet<javax.swing.KeyStroke>(1);
                managingFocusForwardTraversalKeys.add(
                    javax.swing.KeyStroke.getKeyStroke(KeyEvent.VK_TAB,
     ...
     */
    static Set<javax.swing.KeyStroke> getManagingFocusBackwardTraversalKeys() {
        synchronized(JComponent.class) {
            if (managingFocusBackwardTraversalKeys == null) {
                managingFocusBackwardTraversalKeys = new HashSet<javax.swing.KeyStroke>(1);
     ...
     *
     * @see #setUI
     * @see javax.swing.UIManager#getLookAndFeel
     * @see javax.swing.UIManager#getUI
     */
    public void updateUI() {}
     ...
     * @see javax.swing.KeyStroke
     */
    public void registerKeyboardAction(ActionListener anAction, String aCommand, javax.swing.KeyStroke aKeyStroke, int aCondition) {

        javax.swing.InputMap inputMap = getInputMap(aCondition, true);

        if (inputMap != null) {
            javax.swing.ActionMap actionMap = getActionMap(true);
    ...
    private void registerWithKeyboardManager(boolean onlyIfNew) {
        javax.swing.InputMap inputMap = getInputMap(WHEN_IN_FOCUSED_WINDOW, false);
        javax.swing.KeyStroke[] strokes;
        Hashtable<javax.swing.KeyStroke, javax.swing.KeyStroke> registered =
                (Hashtable<javax.swing.KeyStroke, javax.swing.KeyStroke>)getClientProperty
        ...
        if (registered != null && registered.size() > 0) {
            Enumeration<javax.swing.KeyStroke> keys = registered.keys();

            while (keys.hasMoreElements()) {
                javax.swing.KeyStroke ks = keys.nextElement();
        ...
        if (strokes != null && strokes.length > 0) {
            if (registered == null) {
                registered = new Hashtable<javax.swing.KeyStroke, javax.swing.KeyStroke>(strokes.length);
    ...
    void componentInputMapChanged(ComponentInputMap inputMap) {
        javax.swing.InputMap km = getInputMap(WHEN_IN_FOCUSED_WINDOW, false);
     ...
     * similar behavior.
     */
    public void registerKeyboardAction(ActionListener anAction, javax.swing.KeyStroke aKeyStroke, int aCondition) {
    ...
    public void unregisterKeyboardAction(javax.swing.KeyStroke aKeyStroke) {
        javax.swing.ActionMap am = getActionMap(false);
        for (int counter = 0; counter < 3; counter++) {
            javax.swing.InputMap km = getInputMap(counter, false);
            if (km != null) {
    ...
    public javax.swing.KeyStroke[] getRegisteredKeyStrokes() {
        ...
        javax.swing.KeyStroke[][] strokes = new javax.swing.KeyStroke[3][];
        ...
        javax.swing.KeyStroke[] retValue = new javax.swing.KeyStroke[counts[0] + counts[1] +
                                            counts[2]];
    ...
    public int getConditionForKeyStroke(javax.swing.KeyStroke aKeyStroke) {
        for (int counter = 0; counter < 3; counter++) {
            javax.swing.InputMap inputMap = getInputMap(counter, false);
        ...
        for (int counter = 0; counter < 3; counter++) {
            ...
            if (inputMap != null) {
                ...
                if (actionBinding != null) {
                    javax.swing.Action action = am.get(actionBinding);
     ...
     * @since 1.3
     */
    public final void setInputMap(int condition, javax.swing.InputMap map) {
        switch (condition) {
     ...
     */
    final javax.swing.InputMap getInputMap(int condition, boolean create) {
        switch (condition) {
        case WHEN_FOCUSED:
            ...
            if (create) {
                javax.swing.InputMap km = new javax.swing.InputMap();
     ...
     */
    final javax.swing.ActionMap getActionMap(boolean create) {
     ...
     * @since 1.3
     */
    protected boolean processKeyBinding(javax.swing.KeyStroke ks, KeyEvent e,
    ...
    boolean processKeyBindings(KeyEvent e, boolean pressed) {
      ...
      javax.swing.KeyStroke ksE = null;

      if (e.getID() == KeyEvent.KEY_TYPED) {
          ks = javax.swing.KeyStroke.getKeyStroke(e.getKeyChar());
      }
      else {
          ks = javax.swing.KeyStroke.getKeyStroke(e.getKeyCode(),e.getModifiers(),
                                    (pressed ? false:true));
    ...
    public javax.swing.JToolTip createToolTip() {
        javax.swing.JToolTip tip = new JToolTip();
     ...
     */
    final class ActionStandin implements javax.swing.Action {
        ...
        ActionStandin(ActionListener actionListener, String command) {
            ...
            if (actionListener instanceof javax.swing.Action) {
                this.action = (javax.swing.Action)actionListener;
            }
            else {
                this.action = null;
            }
       ...
       implements AccessibleExtendedComponent
    {
        ...
        public String getAccessibleName() {
            ...
            //
            if (name == null) {
                Object o = getClientProperty(javax.swing.JLabel.LABELED_BY_PROPERTY);
