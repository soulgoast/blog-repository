...
import goodman.javax.swing.JList;
...
import goodman.javax.swing.plaf.PopupMenuUI;
import goodman.javax.swing.plaf.ComponentUI;
import goodman.javax.swing.plaf.basic.BasicComboPopup;
...
public class JPopupMenu extends javax.swing.JComponent implements Accessible, MenuElement {
    ...
    transient javax.swing.Popup popup;
     ...
     */
    public javax.swing.JMenuItem add(String s) {
        return add(new javax.swing.JMenuItem(s));
    }
    ...
    public javax.swing.JMenuItem add(javax.swing.Action a) {
        javax.swing.JMenuItem mi = createActionComponent(a);
        mi.setAction(a);
        add(mi);
        return mi;
    }
    ...
    protected javax.swing.JMenuItem createActionComponent(javax.swing.Action a) {
        ...
        mi.setHorizontalTextPosition(javax.swing.JButton.TRAILING);
     ...
     */
    protected PropertyChangeListener createActionChangeListener(javax.swing.JMenuItem b) {
    ...
    private void showPopup() {
        javax.swing.Popup oldPopup = popup;
        ...
        javax.swing.Popup newPopup = getUI().getPopup(this, desiredLocationX,
                                          desiredLocationY);
    ...
    private boolean isPopupMenu() {
        return  ((invoker != null) && !(invoker instanceof javax.swing.JMenu));
    }
    ...
    boolean isSubPopupMenu(JPopupMenu popup) {
        ...
        for (int i = 0 ; i < ncomponents ; i++) {
            ...
            if (comp instanceof javax.swing.JMenu) {
                javax.swing.JMenu menu = (javax.swing.JMenu)comp;
...
////////////
    ...
    public void menuSelectionChanged(boolean isIncluded) {
        ...
        if(invoker instanceof javax.swing.JMenu) {
            javax.swing.JMenu m = (JMenu) invoker;
            if(isIncluded)
