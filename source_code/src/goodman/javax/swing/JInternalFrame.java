 ...
 *                   another window.
 */
public class JInternalFrame extends javax.swing.JComponent implements
        ...
        RootPaneContainer
{
    ...
    public void updateUI() {
        setUI((InternalFrameUI) javax.swing.UIManager.getUI(this));
        invalidate();
        if (desktopIcon != null) {
...
//////////////////////////////////////////////////////////////////////////
    ...
    public void setMenuBar(javax.swing.JMenuBar m) {
        javax.swing.JMenuBar oldValue = getMenuBar();
    ...
    public void setLayeredPane(javax.swing.JLayeredPane layered) {
        javax.swing.JLayeredPane oldValue = getLayeredPane();
  ...
  public void setFrameIcon(javax.swing.Icon icon) {
        javax.swing.Icon oldIcon = frameIcon;
        frameIcon = icon;
    ...
    public void moveToFront() {
        if (isIcon()) {
            if (getDesktopIcon().getParent() instanceof javax.swing.JLayeredPane) {
                ((javax.swing.JLayeredPane)getDesktopIcon().getParent()).
                    moveToFront(getDesktopIcon());
            }
        }
        else if (getParent() instanceof javax.swing.JLayeredPane) {
            ((javax.swing.JLayeredPane)getParent()).moveToFront(this);
        }
    }
    ...
    public void moveToBack() {
        if (isIcon()) {
            ...
            ((javax.swing.JLayeredPane)getParent()).moveToBack(this);
        }
    }
    ...
    public void setLayer(Integer layer) {
        if(getParent() != null && getParent() instanceof javax.swing.JLayeredPane) {
            // Normally we want to do this, as it causes the LayeredPane
            // to draw properly.
            javax.swing.JLayeredPane p = (javax.swing.JLayeredPane)getParent();
            p.setLayer(this, layer.intValue(), p.getPosition(this));
        } else {
             // Try to do the right thing
             javax.swing.JLayeredPane.putLayer(this, layer.intValue());
             if(getParent() != null)
    ...
    public javax.swing.JDesktopPane getDesktopPane() {
        ...
        p = getParent();
        while(p != null && !(p instanceof javax.swing.JDesktopPane))
            p = p.getParent();
        ...
        return (javax.swing.JDesktopPane)p;
    }
...
////////////////
     ...
     * @author David Kloba
     */
    static public class JDesktopIcon extends javax.swing.JComponent implements Accessible
    {
        ...
        public void updateUI() {
            ...
            setUI((DesktopIconUI) javax.swing.UIManager.getUI(this));
            invalidate();
