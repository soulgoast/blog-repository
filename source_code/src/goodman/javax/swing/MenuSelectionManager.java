...
public class MenuSelectionManager {
    private Vector<javax.swing.MenuElement> selection = new Vector<javax.swing.MenuElement>();
    ...
    public void setSelectedPath(javax.swing.MenuElement[] path) {
        ...
        if(path == null) {
            path = new javax.swing.MenuElement[0];
        }
        ...
        for(i=currentSelectionCount - 1 ; i >= firstDifference ; i--) {
            javax.swing.MenuElement me = selection.elementAt(i);
    ...
    public javax.swing.MenuElement[] getSelectedPath() {
        javax.swing.MenuElement res[] = new javax.swing.MenuElement[selection.size()];
        int i,c;
    ...
    public void processMouseEvent(MouseEvent event) {
        ...
        Vector<javax.swing.MenuElement> tmp;
        int selectionSize;
        p = event.getPoint();
        ...
        tmp = (Vector<javax.swing.MenuElement>)selection.clone();
        selectionSize = tmp.size();
        boolean success = false;
        for (i=selectionSize - 1;i >= 0 && success == false; i--) {
            menuElement = (javax.swing.MenuElement) tmp.elementAt(i);
            ...
            for (j = 0, d = subElements.length;j < d && success == false; j++) {
                ...
                if(
                   (p.x >= 0 && p.x < cWidth && p.y >= 0 && p.y < cHeight)) {
                    int k;
                    if(path == null) {
                        path = new javax.swing.MenuElement[i+2];
                        for(k=0;k<=i;k++)
                            path[k] = (javax.swing.MenuElement)tmp.elementAt(k);
                    }
                    path[i+1] = subElements[j];
                    javax.swing.MenuElement currentSelection[] = getSelectedPath();
    ...
    private void printMenuElementArray(javax.swing.MenuElement path[], boolean dumpStack) {
        ...
        for(i=0,j=path.length; i<j ;i++){
            ...
            if(me instanceof javax.swing.JMenuItem) {
    ...
    public void processKeyEvent(KeyEvent e) {
        javax.swing.MenuElement[] sel2 = new javax.swing.MenuElement[0];
        ...
        for (int i=selSize-1; i>=0; i--) {
            javax.swing.MenuElement elem = sel2[i];
            javax.swing.MenuElement[] subs = elem.getSubElements();
            path = null;
        ...
        path = new javax.swing.MenuElement[1];
        path[0] = sel2[0];
    ...
    public boolean isComponentPartOfCurrentMenu(Component c) {
        if(selection.size() > 0) {
            javax.swing.MenuElement me = selection.elementAt(0);
            return isComponentPartOfCurrentMenu(me,c);
        } else
            return false;
    }

    private boolean isComponentPartOfCurrentMenu(javax.swing.MenuElement root, Component c) {
