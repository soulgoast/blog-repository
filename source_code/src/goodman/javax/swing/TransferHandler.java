...
public class TransferHandler implements Serializable {
    ...
    public final static class TransferSupport {
        ...
        private void setDNDVariables(Component component,
            ...
            if (SunToolkit.isInstanceOf(component, "javax.swing.text.JTextComponent")) {
                ...
                dropLocation = ((javax.swing.JComponent)component).dropLocationForPoint(p);
            }
     ...
     */
    public void exportAsDrag(javax.swing.JComponent comp, InputEvent e, int action) {
     ...
     */
    public void exportToClipboard(javax.swing.JComponent comp, Clipboard clip, int action)
    ...
    public boolean importData(TransferSupport support) {
        return support.getComponent() instanceof javax.swing.JComponent
            ? importData((javax.swing.JComponent)support.getComponent(), support.getTransferable())
            : false;
    }
     ...
     * @see #importData(TransferSupport)
     */
    public boolean importData(javax.swing.JComponent comp, Transferable t) {
    ...
    public boolean canImport(TransferSupport support) {
        return support.getComponent() instanceof javax.swing.JComponent
            ? canImport((javax.swing.JComponent)support.getComponent(), support.getDataFlavors())
            : false;
    }
     ...
     * @see #canImport(TransferSupport)
     */
    public boolean canImport(javax.swing.JComponent comp, DataFlavor[] transferFlavors) {
        PropertyDescriptor prop = getPropertyDescriptor(comp);
        if (prop != null) {
            Method writer = prop.getWriteMethod();
            if (writer == null) {
     ...
     */
    private PropertyDescriptor getPropertyDescriptor(javax.swing.JComponent comp) {
    ...
    static class PropertyTransferable implements Transferable {
        ...
        PropertyTransferable(PropertyDescriptor p, javax.swing.JComponent c) {
            property = p;
            component = c;
        }
    ...
    private static class DropHandler implements DropTargetListener,
         ...
         */
        private void updateAutoscrollRegion(javax.swing.JComponent c) {
            // compute the outer
            ...
            if (c instanceof javax.swing.Scrollable) {
         ...
         * scroll.
         */
        private void autoscroll(javax.swing.JComponent c, Point pos) {
            if (c instanceof javax.swing.Scrollable) {
                javax.swing.Scrollable s = (Scrollable) c;
                if (pos.y < inner.y) {
                    // scroll upward
                    int dy = s.getScrollableUnitIncrement(outer, javax.swing.SwingConstants.VERTICAL, -1);
                ...
                if (pos.x < inner.x) {
                    // scroll left
                    int dx = s.getScrollableUnitIncrement(outer, javax.swing.SwingConstants.HORIZONTAL, -1);
        ...
        public void actionPerformed(ActionEvent e) {
            updateAutoscrollRegion((javax.swing.JComponent)component);
            if (outer.contains(lastPosition) && !inner.contains(lastPosition)) {
                autoscroll((javax.swing.JComponent)component, lastPosition);
            }
        }
        ...
        private void setComponentDropLocation(TransferSupport support,
            ...
            if (SunToolkit.isInstanceOf(component, "javax.swing.text.JTextComponent")) {
                ...
                state = ((javax.swing.JComponent)component).setDropLocation(dropLocation, state, forDrop);
            }
        }
        ...
        private void cleanup(boolean forDrop) {
            ...
            if (component instanceof javax.swing.JComponent) {
                ((javax.swing.JComponent)component).dndDone();
            }
    ...
    private static class SwingDragGestureRecognizer extends DragGestureRecognizer {
        ...
        void gestured(javax.swing.JComponent c, MouseEvent e, int srcActions, int action) {
            setComponent(c);
    ...
    static final javax.swing.Action cutAction = new TransferAction("cut");
    static final javax.swing.Action copyAction = new TransferAction("copy");
    static final javax.swing.Action pasteAction = new TransferAction("paste");
    ...
    static class TransferAction extends UIAction implements UIResource {
        ...
        public boolean isEnabled(Object sender) {
            if (sender instanceof javax.swing.JComponent
                && ((javax.swing.JComponent)sender).getTransferHandler() == null) {
                    return false;
            }
        ...
        private void actionPerformedImpl(ActionEvent e) {
            ...
            if (src instanceof javax.swing.JComponent) {
                javax.swing.JComponent c = (javax.swing.JComponent) src;
                TransferHandler th = c.getTransferHandler();
