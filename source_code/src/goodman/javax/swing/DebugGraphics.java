 ...
 *
 * @see javax.swing.JComponent#setDebugGraphicsOptions
...
public class DebugGraphics extends Graphics {
    ...
    private static javax.swing.ImageIcon imageLoadingIcon = new ImageIcon();
    ...
    static {
        javax.swing.JComponent.DEBUG_GRAPHICS_LOADED = true;
    }
     ...
     */
    public DebugGraphics(Graphics graphics, javax.swing.JComponent component) {
        this(graphics);
    ...
    /** Static wrapper method for DebugGraphicsInfo.setDebugOptions(). Stores
      ...
      */
    static void setDebugOptions(javax.swing.JComponent component, int options) {
        info().setDebugOptions(component, options);
    }

    /** Static wrapper method for DebugGraphicsInfo.getDebugOptions().
      */
    static int getDebugOptions(javax.swing.JComponent component) {
    ...
    /** Returns non-zero if <b>component</b> should display with DebugGraphics,
      ...
      */
    static int shouldComponentDebug(javax.swing.JComponent component) {
        DebugGraphicsInfo info = info();
        if (info == null) {
            return 0;
        } else {
            ...
            while (container != null && (container instanceof javax.swing.JComponent)) {
