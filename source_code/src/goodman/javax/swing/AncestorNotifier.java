...
class AncestorNotifier implements ComponentListener, PropertyChangeListener, Serializable
{
     ...
     */
    protected void fireAncestorAdded(javax.swing.JComponent source, int id, Container ancestor, Container ancestorParent) {
     ...
     * @see EventListenerList
     */
    protected void fireAncestorRemoved(javax.swing.JComponent source, int id, Container ancestor, Container ancestorParent) {
        // Guaranteed to return a non-null array
        Object[] listeners = listenerList.getListenerList();
        // Process the listeners last to first, notifying
        // those that are interested in this event
     ...
     * @see EventListenerList
     */
    protected void fireAncestorMoved(javax.swing.JComponent source, int id, Container ancestor, Container ancestorParent) {
        // Guaranteed to return a non-null array
        Object[] listeners = listenerList.getListenerList();
        // Process the listeners last to first, notifying
        // those that are interested in this event
    ...
    void addListeners(Component ancestor, boolean addToFirst) {
        ...
        for (a = ancestor;
            ...
            if (addToFirst || a != ancestor) {
                ...
                if (a instanceof javax.swing.JComponent) {
                    javax.swing.JComponent jAncestor = (javax.swing.JComponent)a;
    ...
    public void propertyChange(PropertyChangeEvent evt) {
        ...
        if (s!=null && (s.equals("parent") || s.equals("ancestor"))) {
            javax.swing.JComponent component = (JComponent)evt.getSource();
