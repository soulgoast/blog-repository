...
package goodman.javax.swing.table;
...
import goodman.javax.swing.table.DefaultTableColumnModel;
...
//
    ...
    transient protected javax.swing.table.TableColumn resizingColumn;

    /** The index of the column being dragged. <code>null</code> if not dragging. */
    transient protected javax.swing.table.TableColumn draggedColumn;
...
//
    ...
    public String getToolTipText(MouseEvent event) {
        ...
        if ((column = columnAtPoint(p)) != -1) {
            javax.swing.table.TableColumn aColumn = columnModel.getColumn(column);
    ...
    protected class AccessibleJTableHeader extends AccessibleJComponent {
        ...
        public Accessible getAccessibleAt(Point p) {
            ...
            if ((column = JTableHeader.this.columnAtPoint(p)) != -1) {
                javax.swing.table.TableColumn aColumn = JTableHeader.this.columnModel.getColumn(column);
                TableCellRenderer renderer = aColumn.getHeaderRenderer();
                if (renderer == null) {
        ...
        public Accessible getAccessibleChild(int i) {
            if (i < 0 || i >= getAccessibleChildrenCount()) {
                ...
                javax.swing.table.TableColumn aColumn = JTableHeader.this.columnModel.getColumn(i)
;
                TableCellRenderer renderer = aColumn.getHeaderRenderer();
                if (renderer == null) {
                    if (defaultRenderer != null) {
        ...
        protected class AccessibleJTableHeaderEntry extends AccessibleContext
            ...
            private AccessibleContext getCurrentAccessibleContext() {
                ...
                if (tcm != null) {
                    ...
                    javax.swing.table.TableColumn aColumn = tcm.getColumn(column);
                    TableCellRenderer renderer = aColumn.getHeaderRenderer();
                    if (renderer == null) {
                        if (defaultRenderer != null) {
                            renderer = defaultRenderer;
