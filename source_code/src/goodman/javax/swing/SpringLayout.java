 ...
 * {@link javax.swing.Spring#sum} method description.
 ...
 * {@link javax.swing.Spring#constant(int)}.
...
public class SpringLayout implements LayoutManager2 {
    ...
    private javax.swing.Spring cyclicReference = javax.swing.Spring.constant(javax.swing.Spring.UNSET);
    private Set<javax.swing.Spring> cyclicSprings;
    private Set<javax.swing.Spring> acyclicSprings;
     ...
     * See the
     * {@link javax.swing.Spring Spring API documentation}
     * for further details
    ...
    public static class Constraints {
       private javax.swing.Spring x;
       private javax.swing.Spring y;
       private javax.swing.Spring width;
       private javax.swing.Spring height;
       private javax.swing.Spring east;
       private javax.swing.Spring south;
        private javax.swing.Spring horizontalCenter;
        private javax.swing.Spring verticalCenter;
        private javax.swing.Spring baseline;
        ...
        */
       public Constraints(javax.swing.Spring x, javax.swing.Spring y) {
           setX(x);
           setY(y);
       }
        ...
        */
       public Constraints(javax.swing.Spring x, javax.swing.Spring y, javax.swing.Spring width, javax.swing.Spring height) {
           setX(x);
           setY(y);
           setWidth(width);
           setHeight(height);
        ...
        public Constraints(Component c) {
            this.c = c;
            setX(javax.swing.Spring.constant(c.getX()));
            setY(javax.swing.Spring.constant(c.getY()));
            setWidth(javax.swing.Spring.width(c));
            setHeight(javax.swing.Spring.height(c));
        }

        private void pushConstraint(String name, javax.swing.Spring value, boolean horizontal) {
            boolean valid = true;
       ...
       private javax.swing.Spring sum(javax.swing.Spring s1, javax.swing.Spring s2) {
           return (s1 == null || s2 == null) ? null : javax.swing.Spring.sum(s1, s2);
       }

       private javax.swing.Spring difference(javax.swing.Spring s1, javax.swing.Spring s2) {
           return (s1 == null || s2 == null) ? null : javax.swing.Spring.difference(s1, s2);
       }

        private javax.swing.Spring scale(javax.swing.Spring s, float factor) {
            return (s == null) ? null : javax.swing.Spring.scale(s, factor);
        }
        ...
        private int getHeightFromBaseLine(int baseline) {
         ...
         private javax.swing.Spring heightToRelativeBaseline(javax.swing.Spring s) {
            return new javax.swing.Spring.SpringMap(s) {
        ...
        private javax.swing.Spring relativeBaselineToHeight(javax.swing.Spring s) {
            return new javax.swing.Spring.SpringMap(s) {
                protected int map(int i) {
                    return getHeightFromBaseLine(i);
                 }
...
*/
       ...
       private void setEast(javax.swing.Spring east) {
           this.east = east;
           pushConstraint(EAST, east, true);
       }

       private javax.swing.Spring getEast() {
           if (east == null) {
       ...
       private void setSouth(javax.swing.Spring south) {
           this.south = south;
           pushConstraint(SOUTH, south, false);
       }

       private javax.swing.Spring getSouth() {
           if (south == null) {
        ...
        private javax.swing.Spring getHorizontalCenter() {
        ...
        private void setHorizontalCenter(javax.swing.Spring horizontalCenter) {
            this.horizontalCenter = horizontalCenter;
            pushConstraint(HORIZONTAL_CENTER, horizontalCenter, true);
        }

        private javax.swing.Spring getVerticalCenter() {
        ...
        private void setVerticalCenter(javax.swing.Spring verticalCenter) {
            this.verticalCenter = verticalCenter;
            pushConstraint(VERTICAL_CENTER, verticalCenter, false);
        }

        private javax.swing.Spring getBaseline() {
            if (baseline == null) {
        ...
        private void setBaseline(javax.swing.Spring baseline) {
        ...
        * @see Constraints
        */
       public void setConstraint(String edgeName, javax.swing.Spring s) {
        ...
        * @see Constraints
        */
       public javax.swing.Spring getConstraint(String edgeName) {
           edgeName = edgeName.intern();
       ...
       /*pp*/ void reset() {
           javax.swing.Spring[] allSprings = {x, y, width, height, east, south,
               horizontalCenter, verticalCenter, baseline};
           for (javax.swing.Spring s : allSprings) {
               if (s != null) {
                   s.setValue(javax.swing.Spring.UNSET);
               }
           }
       }
   }

   private static class SpringProxy extends javax.swing.Spring {
       ...
       private javax.swing.Spring getConstraint() {
    ...
    private void resetCyclicStatuses() {
        cyclicSprings = new HashSet<javax.swing.Spring>();
        acyclicSprings = new HashSet<javax.swing.Spring>();
    }
    ...
    private void setParent(Container p) {
        ...
        javax.swing.Spring width = pc.getWidth();
        if (width instanceof javax.swing.Spring.WidthSpring && ((javax.swing.Spring.WidthSpring)width).c == p) {
            pc.setWidth(javax.swing.Spring.constant(0, 0, Integer.MAX_VALUE));
        }
        javax.swing.Spring height = pc.getHeight();
        if (height instanceof javax.swing.Spring.HeightSpring && ((javax.swing.Spring.HeightSpring)height).c == p) {
            pc.setHeight(javax.swing.Spring.constant(0, 0, Integer.MAX_VALUE));
        }
    }

    /*pp*/ boolean isCyclic(javax.swing.Spring s) {
        if (s == null) {
            return false;
        }
   ...
   /**
     ...
     *
     * @see #putConstraint(String, Component, javax.swing.Spring, String, Component)
     */
    public void putConstraint(String e1, Component c1, int pad, String e2, Component c2) {
        putConstraint(e1, c1, javax.swing.Spring.constant(pad), e2, c2);
    }
     ...
     * @see #BASELINE
     */
    public void putConstraint(String e1, Component c1, javax.swing.Spring s, String e2, Component c2) {
        putConstraint(e1, c1, javax.swing.Spring.sum(s, getConstraint(e2, c2)));
    }

    private void putConstraint(String e, Component c, javax.swing.Spring s) {
        if (s != null) {
    ...
    private Constraints applyDefaults(Component c, Constraints constraints) {
        ...
        if (constraints.horizontalHistory.size() < 2) {
            applyDefaults(constraints, WEST, javax.swing.Spring.constant(0), WIDTH,
                          javax.swing.Spring.width(c), constraints.horizontalHistory);
        }
        if (constraints.verticalHistory.size() < 2) {
            applyDefaults(constraints, NORTH, javax.swing.Spring.constant(0), HEIGHT,
                          javax.swing.Spring.height(c), constraints.verticalHistory);
        }
        return constraints;
    }

    private void applyDefaults(Constraints constraints, String name1,
                               javax.swing.Spring spring1, String name2, javax.swing.Spring spring2,
                               List<String> history) {
        if (history.size() == 0) {
