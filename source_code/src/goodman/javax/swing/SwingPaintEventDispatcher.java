...
import goodman.java.awt.event.PaintEvent;
...
import goodman.javax.swing.SwingHeavyWeight;
...
class SwingPaintEventDispatcher extends sun.awt.PaintEventDispatcher {
    ...
    public PaintEvent createPaintEvent(Component component, int x, int y,
                                         int w, int h) {
        if (component instanceof javax.swing.RootPaneContainer) {
            AppContext appContext = SunToolkit.targetToAppContext(component);
            javax.swing.RepaintManager rm = javax.swing.RepaintManager.currentManager(appContext);
        ...
        else if (component instanceof javax.swing.SwingHeavyWeight) {
            AppContext appContext = SunToolkit.targetToAppContext(component);
            javax.swing.RepaintManager rm = javax.swing.RepaintManager.currentManager(appContext);
            rm.nativeAddDirtyRegion(appContext, (Container)component,
                                    x, y, w, h);
    ...
    public boolean shouldDoNativeBackgroundErase(Component c) {
        return ERASE_BACKGROUND || !(c instanceof javax.swing.RootPaneContainer);
    }
