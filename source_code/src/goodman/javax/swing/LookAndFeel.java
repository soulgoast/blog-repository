...
import goodman.javax.swing.LayoutStyle;
 ...
 * {@link javax.swing.UIDefaults#getUI(javax.swing.JComponent)} for details on how the implementation
...
public abstract class LookAndFeel
{
     ...
     * @see javax.swing.UIManager#getColor
                                     ...
                                     String defaultFgName)
    {
        ...
        if (bg == null || bg instanceof UIResource) {
            c.setBackground(javax.swing.UIManager.getColor(defaultBgName));
        }

        Color fg = c.getForeground();
        if (fg == null || fg instanceof UIResource) {
            c.setForeground(javax.swing.UIManager.getColor(defaultFgName));
        }
    }
     ...
     * @see #installColors
     * @see javax.swing.UIManager#getColor
     * @see javax.swing.UIManager#getFont
     */
     ...
     *         <a href="#exceptions">exceptions</a>
     */
    public static void installBorder(javax.swing.JComponent c, String defaultBorderName) {
        Border b = c.getBorder();
        if (b == null || b instanceof UIResource) {
            c.setBorder(javax.swing.UIManager.getBorder(defaultBorderName));
        }
    }
    ...
    public static JTextComponent.KeyBinding[] makeKeyBindings(Object[] keyBindingList)
    {
        ...
        for(int i = 0; i < rv.length; i ++) {
            ...
            javax.swing.KeyStroke keystroke = (o instanceof javax.swing.KeyStroke)
                ? (javax.swing.KeyStroke) o
                : javax.swing.KeyStroke.getKeyStroke((String) o);
     ...
     * @since 1.3
     */
    public static javax.swing.InputMap makeInputMap(Object[] keys) {
        javax.swing.InputMap retMap = new InputMapUIResource();
     ...
     * @since 1.3
     */
    public static ComponentInputMap makeComponentInputMap(javax.swing.JComponent c,
                                                          Object[] keys) {
    ...
    public static void loadKeyBindings(InputMap retMap, Object[] keys) {
        if (keys != null) {
            for (int counter = 0, maxCounter = keys.length;
                ...
                javax.swing.KeyStroke ks = (keyStrokeO instanceof javax.swing.KeyStroke) ?
                                (javax.swing.KeyStroke)keyStrokeO :
     ...
     * @see javax.swing.UIDefaults.LazyValue
     ...
     *
     * @see javax.swing.LayoutStyle#getInstance
     ...
     * @since 1.5
     */
    public javax.swing.Icon getDisabledSelectedIcon(JComponent component, Icon icon) {
