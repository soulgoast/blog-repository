...
import goodman.javax.swing.JMenuBar;
...
class KeyboardManager {
    ...
    /**
      ...
      */
     public void registerKeyStroke(javax.swing.KeyStroke k, javax.swing.JComponent c) {
         ...
         if (tmp == null) {
         ...
         } else if (tmp instanceof javax.swing.JComponent) {
           ...
           if (tmp != c) {  // this means this is already registered for this component, no need to dup
               Vector<javax.swing.JComponent> v = new Vector<javax.swing.JComponent>();
               v.addElement((javax.swing.JComponent) tmp);
               v.addElement(c);
               keyMap.put(k, v);
           }
         } else {
     ...
     /**
       ...
       */
     private static Container getTopAncestor(javax.swing.JComponent c) {
     ...
     public void unregisterKeyStroke(javax.swing.KeyStroke ks, javax.swing.JComponent c) {
       ...
       // need to look up the container using the componentKeyStrokeMap.
         ...
         if (tmp instanceof javax.swing.JComponent && tmp == c) {
    ...
    public boolean fireKeyboardAction(KeyEvent e, boolean pressed, Container topAncestor) {
         ...
         if(e.getID() == KeyEvent.KEY_TYPED) {
               ...
               if(e.getKeyCode() != e.getExtendedKeyCode()) {
                   ksE= javax.swing.KeyStroke.getKeyStroke(e.getExtendedKeyCode(), e.getModifiers(), !pressed);
               }
         ...
         if (keyMap != null) { // this container isn't registered, so bail
             ...
             if (tmp == null) {
               // don't do anything
                 ...
                 javax.swing.JComponent c = (javax.swing.JComponent)tmp;
                 ...
                 for (int counter = v.size() - 1; counter >= 0; counter--) {
                     javax.swing.JComponent c = (javax.swing.JComponent)v.elementAt(counter);
         ...
         // process the event
         if ( keyMap != null) {
             Vector v = (Vector)keyMap.get(javax.swing.JMenuBar.class);
             if (v != null) {
                 Enumeration iter = v.elements();
                 while (iter.hasMoreElements()) {
                     javax.swing.JMenuBar mb = (javax.swing.JMenuBar)iter.nextElement();
    ...
    void fireBinding(javax.swing.JComponent c, KeyStroke ks, KeyEvent e, boolean pressed) {
    ...
    public void registerMenuBar(javax.swing.JMenuBar mb) {
        ...
        Vector menuBars = (Vector)keyMap.get(javax.swing.JMenuBar.class);

        if (menuBars == null) {  // if we don't have a list of menubars,
                                 // then make one.
            menuBars = new Vector();
            keyMap.put(javax.swing.JMenuBar.class, menuBars);
        }
    ...
    public void unregisterMenuBar(javax.swing.JMenuBar mb) {
