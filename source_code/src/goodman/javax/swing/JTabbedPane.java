 ...
 */
public class JTabbedPane extends javax.swing.JComponent
    ...
    */
    ...
    public void setUI(TabbedPaneUI ui) {
        ...
        for (int i = 0; i < getTabCount(); i++) {
            javax.swing.Icon icon = pages.get(i).disabledIcon;
    ...
    public void updateUI() {
        setUI((TabbedPaneUI) javax.swing.UIManager.getUI(this));
    }
   ...
   /**
    ...
    public void add(Component component, Object constraints) {
        if (!(component instanceof UIResource)) {
            ...
            } else if (constraints instanceof javax.swing.Icon) {
                addTab(null, (javax.swing.Icon)constraints, component);
            } else {
                add(component);
            }
        } else {
    ...
    public void add(Component component, Object constraints, int index) {
        if (!(component instanceof UIResource)) {
            ...
            javax.swing.Icon icon = constraints instanceof javax.swing.Icon ? (javax.swing.Icon)constraints : null;
...
// Setters for the Pages
    ...
    public void setIconAt(int index, javax.swing.Icon icon) {
        Page page = pages.get(index);
        javax.swing.Icon oldIcon = page.icon;
        if (icon != oldIcon) {
            page.icon = icon;
    ...
    public void setDisabledIconAt(int index, javax.swing.Icon disabledIcon) {
        javax.swing.Icon oldIcon = pages.get(index).disabledIcon;
...
// end of Page setters
    ...
    public int indexOfTab(javax.swing.Icon icon) {
        for(int i = 0; i < getTabCount(); i++) {
            javax.swing.Icon tabIcon = getIconAt(i);
...
////////////////
    ...
    private class Page extends AccessibleContext
        ...
        Page(JTabbedPane parent,
             String title, javax.swing.Icon icon, Icon disabledIcon, Component component, String tip) {
            this.title = title;
            this.icon = icon;
        ...
        public AccessibleIcon [] getAccessibleIcon() {
            ...
            if (enabled && icon instanceof javax.swing.ImageIcon) {
                AccessibleContext ac =
                    ((javax.swing.ImageIcon)icon).getAccessibleContext();
                accessibleIcon = (AccessibleIcon)ac;
            } else if (!enabled && disabledIcon instanceof javax.swing.ImageIcon) {
                AccessibleContext ac =
