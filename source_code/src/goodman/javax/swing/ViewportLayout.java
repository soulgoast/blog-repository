...
public class ViewportLayout implements LayoutManager, Serializable
{
    ...
    public Dimension preferredLayoutSize(Container parent) {
        Component view = ((javax.swing.JViewport)parent).getView();
        if (view == null) {
            return new Dimension(0, 0);
        }
        else if (view instanceof javax.swing.Scrollable) {
            return ((javax.swing.Scrollable)view).getPreferredScrollableViewportSize();
        }
        else {
    ...
    {
        javax.swing.JViewport vp = (JViewport)parent;
