...
import goodman.javax.swing.AbstractAction;
import goodman.javax.swing.Action;
import goodman.javax.swing.ButtonGroup;
import goodman.javax.swing.ButtonModel;
import goodman.javax.swing.Icon;
import goodman.javax.swing.JComponent;
import goodman.javax.swing.KeyStroke;
import goodman.javax.swing.OverlayLayout;
...
public abstract class AbstractButton extends JComponent implements ItemSelectable, SwingConstants {
    ...
    private javax.swing.Icon defaultIcon             = null;
    private javax.swing.Icon pressedIcon             = null;
    private javax.swing.Icon disabledIcon            = null;

    private javax.swing.Icon selectedIcon            = null;
    private javax.swing.Icon disabledSelectedIcon    = null;

    private javax.swing.Icon rolloverIcon            = null;
    private javax.swing.Icon rolloverSelectedIcon    = null;
    ...
    public void setIcon(javax.swing.Icon defaultIcon) {
        javax.swing.Icon oldValue = this.defaultIcon;
    ...
    public void setPressedIcon(javax.swing.Icon pressedIcon) {
        javax.swing.Icon oldValue = this.pressedIcon;
    ...
    public void setSelectedIcon(javax.swing.Icon selectedIcon) {
        javax.swing.Icon oldValue = this.selectedIcon;
    ...
    public void setRolloverIcon(javax.swing.Icon rolloverIcon) {
        javax.swing.Icon oldValue = this.rolloverIcon;
    ...
    public void setRolloverSelectedIcon(javax.swing.Icon rolloverSelectedIcon) {
        javax.swing.Icon oldValue = this.rolloverSelectedIcon;
    ...
    public javax.swing.Icon getDisabledIcon() {
        if (disabledIcon == null) {
            disabledIcon = javax.swing.UIManager.getLookAndFeel().getDisabledIcon(this, getIcon());
            if (disabledIcon != null) {
    ...
    public void setDisabledIcon(javax.swing.Icon disabledIcon) {
        javax.swing.Icon oldValue = this.disabledIcon;
    ...
    public javax.swing.Icon getDisabledSelectedIcon() {
        if (disabledSelectedIcon == null) {
             if (selectedIcon != null) {
                 disabledSelectedIcon = javax.swing.UIManager.getLookAndFeel().
    ...
    public void setDisabledSelectedIcon(javax.swing.Icon disabledSelectedIcon) {
        javax.swing.Icon oldValue = this.disabledSelectedIcon;
    ...
    public void setAction(javax.swing.Action a) {
        javax.swing.Action oldValue = getAction();
    ...
    protected void configurePropertiesFromAction(javax.swing.Action a) {
        ...
        if (javax.swing.AbstractAction.hasSelectedKey(a) &&
     ...
     * @see #configurePropertiesFromAction
     */
    protected void actionPropertyChanged(javax.swing.Action action, String propertyName) {
        if (propertyName == javax.swing.Action.NAME) {
        ...
        } else if (propertyName == javax.swing.Action.SMALL_ICON) {
            smallIconChanged(action);
        } else if (propertyName == javax.swing.Action.MNEMONIC_KEY) {
            setMnemonicFromAction(action);
        } else if (propertyName == javax.swing.Action.ACTION_COMMAND_KEY) {
            setActionCommandFromAction(action);
        } else if (propertyName == javax.swing.Action.SELECTED_KEY &&
                   javax.swing.AbstractAction.hasSelectedKey(action) &&
                   shouldUpdateSelectedStateFromAction()) {
            setSelectedFromAction(action);
        } else if (propertyName == javax.swing.Action.DISPLAYED_MNEMONIC_INDEX_KEY) {
            setDisplayedMnemonicIndexFromAction(action, true);
        } else if (propertyName == javax.swing.Action.LARGE_ICON_KEY) {
            largeIconChanged(action);
        }
    }

    private void setDisplayedMnemonicIndexFromAction(
            javax.swing.Action a, boolean fromPropertyChange) {
        Integer iValue = (a == null) ? null :
                (Integer)a.getValue(javax.swing.Action.DISPLAYED_MNEMONIC_INDEX_KEY);
    ...
    private void setMnemonicFromAction(javax.swing.Action a) {
        Integer n = (a == null) ? null :
                                  (Integer)a.getValue(javax.swing.Action.MNEMONIC_KEY);
    ...
    private void setTextFromAction(javax.swing.Action a, boolean propertyChange) {
        ...
        if (!propertyChange) {
            setText((a != null && !hideText) ?
                        (String)a.getValue(javax.swing.Action.NAME) : null);
        }
        else if (!hideText) {
            setText((String)a.getValue(javax.swing.Action.NAME));
        }
    }
    ...
    void setIconFromAction(javax.swing.Action a) {
        ...
        if (a != null) {
            icon = (javax.swing.Icon)a.getValue(javax.swing.Action.LARGE_ICON_KEY);
            if (icon == null) {
                icon = (javax.swing.Icon)a.getValue(javax.swing.Action.SMALL_ICON);
            }
        }
        setIcon(icon);
    }
    ...
    void smallIconChanged(javax.swing.Action a) {
        if (a.getValue(javax.swing.Action.LARGE_ICON_KEY) == null) {
            setIconFromAction(a);
        }
    }
    ...
    private void setActionCommandFromAction(javax.swing.Action a) {
        setActionCommand((a != null) ?
                             (String)a.getValue(javax.swing.Action.ACTION_COMMAND_KEY) :
                             null);
    }
     ...
     * @param a the Action
     */
    private void setSelectedFromAction(javax.swing.Action a) {
        ...
        if (selected != isSelected()) {
            ...
            if (!selected && isSelected()) {
                if (getModel() instanceof DefaultButtonModel) {
                    javax.swing.ButtonGroup group = ((DefaultButtonModel)getModel()).getGroup();
                    if (group != null) {
    ...
    PropertyChangeListener createActionPropertyChangeListener0(javax.swing.Action a) {
    ...
    private static class ButtonActionPropertyChangeListener
        ...
        ButtonActionPropertyChangeListener(AbstractButton b, javax.swing.Action a) {
            super(b, a);
        }
        protected void actionPropertyChanged(AbstractButton button,
                                             javax.swing.Action action,
                                             PropertyChangeEvent e) {
            if (javax.swing.AbstractAction.shouldReconfigure(e)) {
   ...
   /**
    ...
    protected void init(String text, javax.swing.Icon icon) {
        if(text != null) {
            setText(text);
        }
    ...
    public boolean imageUpdate(Image img, int infoflags,
        ...
        javax.swing.Icon iconDisplayed = null;
    ...
    class Handler implements ActionListener, ChangeListener, ItemListener,
        ...
        public void itemStateChanged(ItemEvent event) {
            ...
            if (shouldUpdateSelectedStateFromAction()) {
                javax.swing.Action action = getAction();
                if (action != null && javax.swing.AbstractAction.hasSelectedKey(action)) {
