...
import goodman.javax.swing.JTextArea;
...
public class JEditorPane extends JTextComponent {
            ...
            try {
                ...
                if (doc == null) {
                    try {
                        ...
                        javax.swing.UIManager.getLookAndFeel().provideErrorFeedback(
                                                            JEditorPane.this);
                        return old;
                ...
                javax.swing.UIManager.getLookAndFeel().provideErrorFeedback(JEditorPane.this);
            } finally {
                if (pageLoaded) {
                    SwingUtilities.invokeLater(new Runnable() {
                        public void run() {
    ...
    public boolean getScrollableTracksViewportHeight() {
        Container parent = SwingUtilities.getUnwrappedParent(this);
        if (parent instanceof javax.swing.JViewport) {
            javax.swing.JViewport port = (JViewport) parent;
            TextUI ui = getUI();
            int h = port.getHeight();
            Dimension min = ui.getMinimumSize(this);
            if (h >= min.height) {
