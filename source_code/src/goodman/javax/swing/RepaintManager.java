...
public class RepaintManager
{
     ...
     */
    private javax.swing.JComponent repaintRoot;
    ...
    * Note: This method exists for backward binary compatibility with earlier
     ...
     * @return the RepaintManager object
     */
    public static RepaintManager currentManager(javax.swing.JComponent c) {
     ...
     *  dirty.
     */
    public Rectangle getDirtyRegion(javax.swing.JComponent aComponent) {
                ...
                javaSecurityAccess.doIntersectionPrivilege(new PrivilegedAction<Void>() {
                    public Void run() {
                        ...
                        SwingUtilities.computeIntersection(0,
                                                           ...
                                                           localBoundsH,
                                                           rect);
                        if (dirtyComponent instanceof javax.swing.JComponent) {
                            ((javax.swing.JComponent)dirtyComponent).paintImmediately(
                                rect.x,rect.y,rect.width, rect.height);
                        }
                        else if (dirtyComponent.isShowing()) {
                            Graphics g = javax.swing.JComponent.safelyGetGraphics(
     ...
     * root.
     */
    private void adjustRoots(javax.swing.JComponent root,
                             java.util.List<Component> roots, int index) {
        for (int i = roots.size() - 1; i >= index; i--) {
            Component c = roots.get(i);
            for(;;) {
                if (c == root || c == null || !(c instanceof javax.swing.JComponent)) {
                    break;
                }
                c = c.getParent();
            }
   ...
   */
    ...
    private Image _getOffscreenBuffer(Component c, int proposedWidth, int proposedHeight) {
        ...
        if (doubleBuffer.image == null) {
            ...
            if (c instanceof javax.swing.JComponent) {
                ((javax.swing.JComponent)c).setCreatedDoubleBuffer(true);
     ...
     * @param h Height
     */
    void paint(javax.swing.JComponent paintingComponent,
               javax.swing.JComponent bufferComponent, Graphics g,
               int x, int y, int w, int h) {
        PaintManager paintManager = getPaintManager();
        if (!isPaintingThread()) {
     ...
     *             Component's bounds.
     */
    void copyArea(javax.swing.JComponent c, Graphics g, int x, int y, int w, int h,
     ...
     */
    void notifyRepaintPerformed(javax.swing.JComponent c, int x, int y, int w, int h) {
     ...
     */
    void doubleBufferingChanged(javax.swing.JRootPane rootPane) {
    ...
    static class PaintManager {
         ...
         */
        public boolean paint(javax.swing.JComponent paintingComponent,
                             javax.swing.JComponent bufferComponent, Graphics g,
                             int x, int y, int w, int h) {
         ...
         * Does a copy area on the specified region.
         */
        public void copyArea(javax.swing.JComponent c, Graphics g, int x, int y, int w,
         ...
         */
        protected void paintDoubleBuffered(javax.swing.JComponent c, Image image,
         ...
         */
        protected void repaintRoot(javax.swing.JComponent root) {
