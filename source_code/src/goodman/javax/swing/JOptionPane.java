...
import goodman.javax.swing.plaf.OptionPaneUI;
import goodman.javax.swing.event.InternalFrameEvent;
import goodman.javax.swing.event.InternalFrameAdapter;
 ...
 * @author Scott Violet
 */
public class JOptionPane extends javax.swing.JComponent implements Accessible
{
    /**
     * @see #getUIClassID
     * @see #readObject
    ...
    /** Icon used in pane. */
    transient protected javax.swing.Icon icon;
    /** Message to display. */
    ...
    public static String showInputDialog(Component parentComponent,
        ...
        return showInputDialog(parentComponent, message, javax.swing.UIManager.getString(
    ...
    public static Object showInputDialog(Component parentComponent,
        Object message, String title, int messageType, javax.swing.Icon icon,
        ...
        javax.swing.JDialog dialog = pane.createDialog(parentComponent, title, style);
    ...
    public static void showMessageDialog(Component parentComponent,
        Object message) throws HeadlessException {
        showMessageDialog(parentComponent, message, javax.swing.UIManager.getString(
    ...
    public static int showConfirmDialog(Component parentComponent,
        ...
        return showConfirmDialog(parentComponent, message,
                                 javax.swing.UIManager.getString("OptionPane.titleText"),
    ...
    public static int showConfirmDialog(Component parentComponent,
        Object message, String title, int optionType,
        int messageType, javax.swing.Icon icon) throws HeadlessException {
    ...
    public static int showOptionDialog(Component parentComponent,
                                       Object message, String title, int optionType, int messageType,
                                       javax.swing.Icon icon, Object[] options, Object initialValue)
        throws HeadlessException {
        JOptionPane             pane = new JOptionPane(message, messageType,
                                                       optionType, icon,
     ...
     * @see java.awt.GraphicsEnvironment#isHeadless
     */
    public javax.swing.JDialog createDialog(Component parentComponent, String title)
        throws HeadlessException {
     ...
     * @since 1.6
     */
    public javax.swing.JDialog createDialog(String title) throws HeadlessException {
        int style = styleFromMessageType(getMessageType());
        javax.swing.JDialog dialog = new javax.swing.JDialog((Dialog) null, title, true);
        initDialog(dialog, style, null);
        return dialog;
    }

    private javax.swing.JDialog createDialog(Component parentComponent, String title,
                                             int style)
            throws HeadlessException {
        ...
        if (window instanceof Frame) {
            dialog = new javax.swing.JDialog((Frame)window, title, true);
        } else {
            dialog = new javax.swing.JDialog((Dialog)window, title, true);
        }
    ...
    private void initDialog(final javax.swing.JDialog dialog, int style, Component parentComponent) {
    ...
    public static void showInternalMessageDialog(Component parentComponent,
                                                 Object message) {
        showInternalMessageDialog(parentComponent, message, javax.swing.UIManager.
    ...
    public static int showInternalConfirmDialog(Component parentComponent,
                                        Object message,
                                        String title, int optionType,
                                        int messageType, javax.swing.Icon icon) {
    ...
    public static String showInternalInputDialog(Component parentComponent,
                                                 Object message) {
        return showInternalInputDialog(parentComponent, message, javax.swing.UIManager.
     ...
     */
    public JOptionPane(Object message, int messageType, int optionType,
                       javax.swing.Icon icon, Object[] options) {
