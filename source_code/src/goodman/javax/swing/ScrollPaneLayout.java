...
import goodman.javax.swing.JScrollPane;
...
import goodman.javax.swing.ViewportLayout;
    ...
    implements LayoutManager, ScrollPaneConstants, Serializable
{
    ...
    public void addLayoutComponent(String s, Component c)
    {
        if (s.equals(VIEWPORT)) {
            viewport = (javax.swing.JViewport)addSingletonComponent(viewport, c);
        }
        else if (s.equals(VERTICAL_SCROLLBAR)) {
            vsb = (javax.swing.JScrollBar)addSingletonComponent(vsb, c);
        }
        else if (s.equals(HORIZONTAL_SCROLLBAR)) {
            hsb = (javax.swing.JScrollBar)addSingletonComponent(hsb, c);
        }
        else if (s.equals(ROW_HEADER)) {
            rowHead = (javax.swing.JViewport)addSingletonComponent(rowHead, c);
        }
        else if (s.equals(COLUMN_HEADER)) {
            colHead = (javax.swing.JViewport)addSingletonComponent(colHead, c);
        }
    ...
    public Dimension preferredLayoutSize(Container parent)
    {
        ...
        if ((vsb != null) && (vsbPolicy != VERTICAL_SCROLLBAR_NEVER)) {
            if (vsbPolicy == VERTICAL_SCROLLBAR_ALWAYS) {
                ...
                if (view instanceof javax.swing.Scrollable) {
                    canScroll = !((javax.swing.Scrollable)view).getScrollableTracksViewportHeight();
                }
        ...
        if ((hsb != null) && (hsbPolicy != HORIZONTAL_SCROLLBAR_NEVER)) {
            if (hsbPolicy == HORIZONTAL_SCROLLBAR_ALWAYS) {
                ...
                boolean canScroll = true;
                if (view instanceof javax.swing.Scrollable) {
                    canScroll = !((javax.swing.Scrollable)view).getScrollableTracksViewportWidth();
                }
    ...
    public void layoutContainer(Container parent)
    {
        ...
        // case anyway.
        if (!isEmpty && view instanceof javax.swing.Scrollable) {
            sv = (Scrollable)view;
        ...
        if (vsb != null) {
            if (vsbNeeded) {
                if (colHead != null &&
                    javax.swing.UIManager.getBoolean("ScrollPane.fillUpperCorner"))
                {
