...
public class JFormattedTextField extends javax.swing.JTextField {
     ...
     * <code>actions</code>.
     */
    private void setFormatterActions(javax.swing.Action[] actions) {
        if (actions == null) {
            ...
            if (textFormatterActionMap == null) {
                ...
                textFormatterActionMap = new javax.swing.ActionMap();
                while (map != null) {
            ...
            for (int counter = actions.length - 1; counter >= 0;
                 counter--) {
                Object key = actions[counter].getValue(javax.swing.Action.NAME);
