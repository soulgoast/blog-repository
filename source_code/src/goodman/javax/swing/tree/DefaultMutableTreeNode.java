...
import goodman.javax.swing.tree.MutableTreeNode;
...
public class DefaultMutableTreeNode implements Cloneable,
        javax.swing.tree.MutableTreeNode, Serializable
{
     ...
     */
    static public final Enumeration<javax.swing.tree.TreeNode> EMPTY_ENUMERATION
    ...
    public void insert(javax.swing.tree.MutableTreeNode newChild, int childIndex) {
        if (!allowsChildren) {
            ...
            javax.swing.tree.MutableTreeNode oldParent = (javax.swing.tree.MutableTreeNode)newChild.getParent();
    ...
    public javax.swing.tree.TreeNode getChildAt(int index) {
        ...
        return (javax.swing.tree.TreeNode)children.elementAt(index);
    }
    ...
    public void removeFromParent() {
        javax.swing.tree.MutableTreeNode parent = (javax.swing.tree.MutableTreeNode)getParent();
        if (parent != null) {
            parent.remove(this);
        }
    }
     ...
     *          or null if none
     */
    public javax.swing.tree.TreeNode getSharedAncestor(DefaultMutableTreeNode aNode) {
        if (aNode == this) {
            return this;
        } else if (aNode == null) {
            return null;
        ...
        javax.swing.tree.TreeNode node1, node2;
     ...
     */
    public int getLevel() {
        javax.swing.tree.TreeNode ancestor;
        int levels = 0;
    ...
    public Object[] getUserObjectPath() {
        javax.swing.tree.TreeNode[]          realPath = getPath();
    ...
    public javax.swing.tree.TreeNode getRoot() {
        javax.swing.tree.TreeNode ancestor = this;
        javax.swing.tree.TreeNode previous;
     ...
     */
    public Enumeration pathFromAncestorEnumeration(javax.swing.tree.TreeNode ancestor) {
    ...
    public boolean isNodeSibling(javax.swing.tree.TreeNode anotherNode) {
        ...
        if (anotherNode == null) {
            ...
            javax.swing.tree.TreeNode myParent = getParent();
    ...
    public int getLeafCount() {
        ...
        while (enum_.hasMoreElements()) {
            node = (javax.swing.tree.TreeNode)enum_.nextElement();
            if (node.isLeaf()) {
                count++;
            }
        }
    ...
    private final class PreorderEnumeration implements Enumeration<javax.swing.tree.TreeNode> {
        private final Stack<Enumeration> stack = new Stack<Enumeration>();

        public PreorderEnumeration(javax.swing.tree.TreeNode rootNode) {
            super();
            Vector<javax.swing.tree.TreeNode> v = new Vector<javax.swing.tree.TreeNode>(1);
        ...
        public javax.swing.tree.TreeNode nextElement() {
            ...
            javax.swing.tree.TreeNode node = (javax.swing.tree.TreeNode)enumer.nextElement();
    ...
    final class PostorderEnumeration implements Enumeration<javax.swing.tree.TreeNode> {
        protected javax.swing.tree.TreeNode root;
        protected Enumeration<javax.swing.tree.TreeNode> children;
        protected Enumeration<javax.swing.tree.TreeNode> subtree;

        public PostorderEnumeration(javax.swing.tree.TreeNode rootNode) {
            super();
            root = rootNode;
        ...
        public javax.swing.tree.TreeNode nextElement() {
            javax.swing.tree.TreeNode retval;
    ...
    final class BreadthFirstEnumeration implements Enumeration<javax.swing.tree.TreeNode> {
        protected Queue queue;

        public BreadthFirstEnumeration(javax.swing.tree.TreeNode rootNode) {
            super();
            Vector<javax.swing.tree.TreeNode> v = new Vector<javax.swing.tree.TreeNode>(1);
            v.addElement(rootNode);     // PENDING: don't really need a vector
            queue = new Queue();
    ...
    final class PathBetweenNodesEnumeration implements Enumeration<javax.swing.tree.TreeNode> {
        protected Stack<javax.swing.tree.TreeNode> stack;

        public PathBetweenNodesEnumeration(javax.swing.tree.TreeNode ancestor,
                                           javax.swing.tree.TreeNode descendant)
        {
            super();
            ...
            javax.swing.tree.TreeNode current;

            stack = new Stack<javax.swing.tree.TreeNode>();
