...
public class FixedHeightLayoutCache extends AbstractLayoutCache {
     ...
     */
    private Hashtable<javax.swing.tree.TreePath, FHTreeStateNode> treePathMapping;
    ...
    public FixedHeightLayoutCache() {
        ...
        treePathMapping = new Hashtable<javax.swing.tree.TreePath, FHTreeStateNode>();
        info = new SearchInfo();
        setRowHeight(1);
    }
    ...
    public void treeNodesRemoved(TreeModelEvent e) {
        if(e != null) {
            int                  changedIndexs[];
            int                  maxCounter;
            javax.swing.tree.TreePath parentPath = SwingUtilities2.getTreePath(e, getModel());
     ...
     */
    private FHTreeStateNode getMapping(javax.swing.tree.TreePath path) {
    ...
    private void rebuild(boolean clearSelection) {
        ...
        if(treeModel != null && (rootUO = treeModel.getRoot()) != null) {
            ...
            root.path = new javax.swing.tree.TreePath(rootUO);
            addMapping(root);
            if(isRootVisible()) {
                rowCount = 1;
                root.row = 0;
     ...
     */
    private boolean ensurePathIsExpanded(javax.swing.tree.TreePath aPath,
                                         boolean expandLast) {
        if(aPath != null) {
     ...
     */
    private FHTreeStateNode getNodeForPath(javax.swing.tree.TreePath path,
    ...
    private class VisibleFHTreeStateNodeEnumeration
        implements Enumeration<javax.swing.tree.TreePath>
    {
