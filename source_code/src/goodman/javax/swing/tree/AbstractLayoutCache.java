...
public abstract class AbstractLayoutCache implements RowMapper {
    ...
    public int getPreferredWidth(Rectangle bounds) {
        ...
        if(rowCount > 0) {
            // Get the width
            javax.swing.tree.TreePath firstPath;
            int           endY;
            ...
            if(paths != null && paths.hasMoreElements()) {
                Rectangle   pBounds = getBounds((javax.swing.tree.TreePath)paths.nextElement(),
                                                null);
                int         width;
                ...
                while (pBounds != null && paths.hasMoreElements()) {
                    pBounds = getBounds((javax.swing.tree.TreePath)paths.nextElement(),
                                        pBounds);
     ...
     */
    public abstract Rectangle getBounds(javax.swing.tree.TreePath path, Rectangle placeIn);
    ...
    /**
      ...
      */
    public abstract javax.swing.tree.TreePath getPathClosestTo(int x, int y);
     ...
     */
    public abstract Enumeration<javax.swing.tree.TreePath> getVisiblePathsFrom(javax.swing.tree.TreePath path);
     ...
     */
    public abstract void setExpandedState(javax.swing.tree.TreePath path, boolean isExpanded);
