...
package goodman.javax.swing.tree;
...
import goodman.javax.swing.DefaultListSelectionModel;
import goodman.javax.swing.tree.RowMapper;
import goodman.javax.swing.tree.TreePath;
import goodman.javax.swing.tree.TreeSelectionModel;
...
public class DefaultTreeSelectionModel implements Cloneable, Serializable, javax.swing.tree.TreeSelectionModel
{
    ...
    transient protected javax.swing.tree.RowMapper rowMapper;
     ...
     */
    private Hashtable<javax.swing.tree.TreePath, Boolean>    uniquePaths;
    private Hashtable<javax.swing.tree.TreePath, Boolean>    lastPaths;
    private javax.swing.tree.TreePath[]                      tempPaths;
    ...
    public DefaultTreeSelectionModel() {
        ...
        leadIndex = leadRow = -1;
        uniquePaths = new Hashtable<javax.swing.tree.TreePath, Boolean>();
        lastPaths = new Hashtable<javax.swing.tree.TreePath, Boolean>();
        tempPaths = new javax.swing.tree.TreePath[1];
    }
    ...
    public void setSelectionMode(int mode) {
        ...
        selectionMode = mode;
        if(selectionMode != javax.swing.tree.TreeSelectionModel.SINGLE_TREE_SELECTION &&
           selectionMode != javax.swing.tree.TreeSelectionModel.CONTIGUOUS_TREE_SELECTION &&
           selectionMode != javax.swing.tree.TreeSelectionModel.DISCONTIGUOUS_TREE_SELECTION)
            selectionMode = javax.swing.tree.TreeSelectionModel.DISCONTIGUOUS_TREE_SELECTION;
    ...
    public void setSelectionPath(javax.swing.tree.TreePath path) {
        if(path == null)
            ...
            javax.swing.tree.TreePath[]          newPaths = new javax.swing.tree.TreePath[1];
    ...
    public void setSelectionPaths(javax.swing.tree.TreePath[] pPaths) {
        ...
        javax.swing.tree.TreePath[]     paths = pPaths;
        ...
        if((newCount + oldCount) != 0) {
            if(selectionMode == javax.swing.tree.TreeSelectionModel.SINGLE_TREE_SELECTION) {
                /* If single selection and more than one path, only allow
                   first. */
                if(newCount > 1) {
                    paths = new javax.swing.tree.TreePath[1];
                    paths[0] = pPaths[0];
                    newCount = 1;
                }
            }
            ...
            javax.swing.tree.TreePath beginLeadPath = leadPath;
            Vector<PathPlaceHolder> cPaths = new Vector<PathPlaceHolder>(newCount + oldCount);
            List<javax.swing.tree.TreePath> newSelectionAsList =
                    new ArrayList<javax.swing.tree.TreePath>(newCount);

            lastPaths.clear();
            leadPath = null;
            /* Find the paths that are new. */
            for(newCounter = 0; newCounter < newCount; newCounter++) {
                javax.swing.tree.TreePath path = paths[newCounter];
            ...
            javax.swing.tree.TreePath[] newSelection = newSelectionAsList.toArray(
                    new javax.swing.tree.TreePath[newSelectionAsList.size()]);
            ...
            Hashtable<javax.swing.tree.TreePath, Boolean>  tempHT = uniquePaths;
    ...
    public void addSelectionPath(javax.swing.tree.TreePath path) {
        if(path != null) {
            javax.swing.tree.TreePath[]            toAdd = new javax.swing.tree.TreePath[1];
    ...
    public void addSelectionPaths(javax.swing.tree.TreePath[] paths) {
        ...
        if(newPathLength > 0) {
            if(selectionMode == javax.swing.tree.TreeSelectionModel.SINGLE_TREE_SELECTION) {
            ...
            else if(selectionMode == javax.swing.tree.TreeSelectionModel.
                ...
                if(validCount > 0) {
                    javax.swing.tree.TreePath newSelection[] = new javax.swing.tree.TreePath[oldCount +
                                                                  validCount];
                    ...
                    if(validCount != paths.length) {
                        /* Some of the paths in paths are already in
                           the selection. */
                        Enumeration<javax.swing.tree.TreePath> newPaths = lastPaths.keys();
    ...
    public void removeSelectionPath(javax.swing.tree.TreePath path) {
        if(path != null) {
            javax.swing.tree.TreePath[]             rPath = new javax.swing.tree.TreePath[1];
            ...
            if(!canPathsBeRemoved(paths)) {
                ...
                if(pathsToRemove != null) {
                    ...
                    if(removeCount == selection.length) {
                        ...
                        Enumeration<javax.swing.tree.TreePath> pEnum = uniquePaths.keys();
                        int                  validCount = 0;

                        selection = new javax.swing.tree.TreePath[selection.length -
                                                removeCount];
    ...
    public javax.swing.tree.TreePath[] getSelectionPaths() {
        if(selection != null) {
            ...
            javax.swing.tree.TreePath[]          result = new javax.swing.tree.TreePath[pathSize];

            System.arraycopy(selection, 0, result, 0, pathSize);
            return result;
        }
        return new javax.swing.tree.TreePath[0];
    }
    ...
    protected void insureRowContinuity() {
        if(selectionMode == javax.swing.tree.TreeSelectionModel.CONTIGUOUS_TREE_SELECTION &&
                ...
                for(int counter = min,
                    ...
                    if(!lModel.isSelectedIndex(counter)) {
                        if(counter == min) {
                            ...
                            javax.swing.tree.TreePath[] newSel = new javax.swing.tree.TreePath[counter - min];
        ...
        else if(selectionMode == javax.swing.tree.TreeSelectionModel.SINGLE_TREE_SELECTION &&
    ...
    protected boolean arePathsContiguous(javax.swing.tree.TreePath[] paths) {
        if(rowMapper == null || paths.length < 2)
            ...
            int                                validCount = 0;
            javax.swing.tree.TreePath[]                         tempPath = new javax.swing.tree.TreePath[1];
    ...
    protected void notifyPathChange(Vector<?> changedPaths,
        ...
        javax.swing.tree.TreePath[]            paths = new javax.swing.tree.TreePath[cPathCount];
    ...
    public Object clone() throws CloneNotSupportedException {
        ...
        if(selection != null) {
            ...
            clone.selection = new javax.swing.tree.TreePath[selLength];
        ...
        clone.uniquePaths = new Hashtable<javax.swing.tree.TreePath, Boolean>();
        clone.lastPaths = new Hashtable<javax.swing.tree.TreePath, Boolean>();
        clone.tempPaths = new javax.swing.tree.TreePath[1];
        return clone;
    }
