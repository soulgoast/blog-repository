...
import goodman.javax.swing.event.TreeModelEvent;
import goodman.javax.swing.tree.AbstractLayoutCache;
import goodman.javax.swing.tree.DefaultMutableTreeNode;
import goodman.javax.swing.tree.MutableTreeNode;
import goodman.javax.swing.tree.TreeModel;
...
public class VariableHeightLayoutCache extends AbstractLayoutCache {
     ...
     */
    private Hashtable<javax.swing.tree.TreePath, TreeStateNode> treePathMapping;

    /**
     * A stack of stacks.
     */
    private Stack<Stack<javax.swing.tree.TreePath>> tempStacks;


    public VariableHeightLayoutCache() {
        super();
        tempStacks = new Stack<Stack<javax.swing.tree.TreePath>>();
        visibleNodes = new Vector<Object>();
        boundsBuffer = new Rectangle();
        treePathMapping = new Hashtable<javax.swing.tree.TreePath, TreeStateNode>();
    }
     ...
     */
    public void setExpandedState(javax.swing.tree.TreePath path, boolean isExpanded) {
        if(path != null) {
            if(isExpanded)
    ...
    /**
      ...
      */
    public Rectangle getBounds(javax.swing.tree.TreePath path, Rectangle placeIn) {
        TreeStateNode       node = getNodeForPath(path, true, false);
    ...
    /**
      ...
      */
    public javax.swing.tree.TreePath getPathClosestTo(int x, int y) {
        if(getRowCount() == 0)
            return null;
     ...
     *     paths
     */
    public Enumeration<javax.swing.tree.TreePath> getVisiblePathsFrom(javax.swing.tree.TreePath path) {
        TreeStateNode       node = getNodeForPath(path, true, false);
    ...
    public void treeStructureChanged(TreeModelEvent e) {
        if(e != null)
        {
            javax.swing.tree.TreePath changedPath = SwingUtilities2.getTreePath(e, getModel());
            TreeStateNode     changedNode;
     ...
     */
    private TreeStateNode getMapping(javax.swing.tree.TreePath path) {
    ...
    private void rebuild(boolean clearSelection) {
        ...
        if(treeModel != null && (rootObject = treeModel.getRoot()) != null) {
            ...
            root.path = new javax.swing.tree.TreePath(rootObject);
            addMapping(root);
            root.updatePreferredSize(0);
    ...
    /**
      ...
      */
    private TreeStateNode getNodeForPath(javax.swing.tree.TreePath path,
        ...
        if(path != null) {
            ...
            Stack<javax.swing.tree.TreePath> paths;

            if(tempStacks.size() == 0) {
                paths = new Stack<javax.swing.tree.TreePath>();
            }
            else {
     ...
     */
    private void ensurePathIsExpanded(javax.swing.tree.TreePath aPath, boolean expandLast) {
        if(aPath != null) {
     ...
     */
    private class TreeStateNode extends javax.swing.tree.DefaultMutableTreeNode {
         ...
         */
        protected void resetChildrenPaths(javax.swing.tree.TreePath parentPath) {
            removeMapping(this);
            if(parentPath == null)
                path = new javax.swing.tree.TreePath(getUserObject());
            else
        ...
        protected Enumeration getLoadedChildren(boolean createIfNeeded) {
            ...
            javax.swing.tree.TreeModel treeModel = getModel();
    ...
    private class VisibleTreeStateNodeEnumeration implements
                     Enumeration<javax.swing.tree.TreePath> {
