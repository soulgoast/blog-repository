...
public class JMenuItem extends AbstractButton implements Accessible,MenuElement  {
     ...
     */
    public JMenuItem() {
        this(null, (javax.swing.Icon)null);
    }
    ...
    public JMenuItem(String text) {
        this(text, (javax.swing.Icon)null);
    }
     ...
     * @param icon the icon of the <code>JMenuItem</code>
     */
    public JMenuItem(String text, javax.swing.Icon icon) {
    ...
    protected void init(String text, javax.swing.Icon icon) {
        ...
        setHorizontalTextPosition(javax.swing.JButton.TRAILING);
    ...
    void setIconFromAction(javax.swing.Action a) {
        ...
        if (a != null) {
            icon = (Icon)a.getValue(javax.swing.Action.SMALL_ICON);
        }
        setIcon(icon);
    }
    ...
    void configureAcceleratorFromAction(javax.swing.Action a) {
        KeyStroke ks = (a==null) ? null :
            (KeyStroke)a.getValue(javax.swing.Action.ACCELERATOR_KEY);
        setAccelerator(ks);
    }
