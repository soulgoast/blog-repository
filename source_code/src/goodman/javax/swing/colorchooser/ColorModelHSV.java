...
final class ColorModelHSV extends javax.swing.colorchooser.ColorModel {
    ...
    private static float[] RGBtoHSV(float[] rgb, float[] hsv) {
        ...
        float max = javax.swing.colorchooser.ColorModelHSL.max(rgb[0], rgb[1], rgb[2]);
        float min = javax.swing.colorchooser.ColorModelHSL.min(rgb[0], rgb[1], rgb[2]);

        float saturation = max - min;
        if (saturation > 0.0f) {
            saturation /= max;
        }
        hsv[0] = javax.swing.colorchooser.ColorModelHSL.getHue(rgb[0], rgb[1], rgb[2], max, min);
        hsv[1] = saturation;
        hsv[2] = max;
        return hsv;
    }
