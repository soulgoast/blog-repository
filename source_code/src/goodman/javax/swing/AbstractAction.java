 ...
 */
public abstract class AbstractAction implements javax.swing.Action, Cloneable, Serializable
{
    /**
     ...
     */
    static void setToolTipTextFromAction(JComponent c, javax.swing.Action a) {
        c.setToolTipText(a != null ?
                         (String)a.getValue(javax.swing.Action.SHORT_DESCRIPTION) : null);
    }
    ...
    static boolean isSelected(javax.swing.Action a) {
        return Boolean.TRUE.equals(a.getValue(javax.swing.Action.SELECTED_KEY));
    }
