...
import goodman.javax.swing.JLayer;
import goodman.javax.swing.JMenu;
...
public class SwingUtilities implements SwingConstants
{
     ...
     */
    public static javax.swing.JRootPane getRootPane(Component c) {
    ...
    static javax.swing.JComponent getPaintingOrigin(javax.swing.JComponent c) {
        Container p = c;
        while ((p = p.getParent()) instanceof javax.swing.JComponent) {
            javax.swing.JComponent jp = (javax.swing.JComponent) p;
        ...
        if (event != null) {
            ...
            while (component != null) {
                if (component instanceof javax.swing.JComponent) {
                    return ((javax.swing.JComponent)component).processKeyBindings(
                                                   event, pressed);
                }
                if ((component instanceof Applet) ||
                    ...
                    return javax.swing.JComponent.processKeyBindingsForAllComponents(
     ...
     * @since 1.3
     */
    public static boolean notifyAction(javax.swing.Action action, KeyStroke ks,
        ...
        if (commandO == null && (action instanceof javax.swing.JComponent.ActionStandin)) {
     ...
     * @since 1.3
     */
    public static void replaceUIInputMap(javax.swing.JComponent component, int type,
                                         javax.swing.InputMap uiInputMap) {
        javax.swing.InputMap map = component.getInputMap(type, (uiInputMap != null));
     ...
     * @since 1.3
     */
    public static void replaceUIActionMap(javax.swing.JComponent component,
                                          javax.swing.ActionMap uiActionMap) {
        javax.swing.ActionMap map = component.getActionMap((uiActionMap != null));

        while (map != null) {
            javax.swing.ActionMap parent = map.getParent();
            if (parent == null || (parent instanceof UIResource)) {
     ...
     * @since 1.3
     */
    public static javax.swing.InputMap getUIInputMap(javax.swing.JComponent component, int condition) {
        javax.swing.InputMap map = component.getInputMap(condition, false);
        while (map != null) {
    ...
    public static javax.swing.ActionMap getUIActionMap(javax.swing.JComponent component) {
        javax.swing.ActionMap map = component.getActionMap(false);
        while (map != null) {
   ...
   /*
    ...
    static boolean doesIconReferenceImage(Icon icon, Image image) {
        Image iconImage = (icon != null && (icon instanceof javax.swing.ImageIcon)) ?
     ...
     * which is not an instance of {@link javax.swing.JLayer}.
     *
     * @param component {@code Component} to get
     * the first ancestor of, which is not a {@link javax.swing.JLayer} instance.
     *
    ...
    public static Container getUnwrappedParent(Component component) {
        ...
        while(parent instanceof javax.swing.JLayer) {
            parent = parent.getParent();
        }
        return parent;
    }
     ...
     * this method is equivalent to {@link javax.swing.JViewport#getView()}
     * otherwise {@link javax.swing.JLayer#getView()} will be recursively
    ...
    public static Component getUnwrappedView(JViewport viewport) {
        ...
        while (view instanceof javax.swing.JLayer) {
