...
import goodman.javax.swing.plaf.metal.*;
import goodman.javax.swing.plaf.metal.MetalBorders;
import goodman.javax.swing.plaf.metal.MetalIconFactory;
import goodman.javax.swing.plaf.metal.MetalTheme;
import goodman.javax.swing.plaf.metal.MetalUtils;
import goodman.javax.swing.plaf.metal.OceanTheme;
import goodman.javax.swing.text.DefaultEditorKit;
import goodman.javax.swing.UIDefaults.LazyValue;
 ...
 * @see javax.swing.plaf.metal.OceanTheme
 *
 * @author Steve Wilson
 */
public class MetalLookAndFeel extends BasicLookAndFeel
{
    ...
    static boolean usingOcean() {
        return (getCurrentTheme() instanceof javax.swing.plaf.metal.OceanTheme);
    }
    ...
    {
        javax.swing.plaf.metal.MetalTheme theme = getCurrentTheme();
  ...
  "inactiveCaptionBorder", theme.getControlShadow(), /* Border color for inactive caption (title bar) window borders. */
    ...
    protected void initComponentDefaults(UIDefaults table) {
        ...
        LazyValue dialogBorder = t -> new javax.swing.plaf.metal.MetalBorders.DialogBorder();

        LazyValue questionDialogBorder = t -> new javax.swing.plaf.metal.MetalBorders.QuestionDialogBorder();
        ...
        Object menuTextValue = new FontActiveValue(theme,
                                                   javax.swing.plaf.metal.MetalTheme.MENU_TEXT_FONT);
        Object controlTextValue = new FontActiveValue(theme,
                               javax.swing.plaf.metal.MetalTheme.CONTROL_TEXT_FONT);
        Object userTextValue = new FontActiveValue(theme,
                                                   javax.swing.plaf.metal.MetalTheme.USER_TEXT_FONT);
        Object windowTitleValue = new FontActiveValue(theme,
                               javax.swing.plaf.metal.MetalTheme.WINDOW_TITLE_FONT);
        Object subTextValue = new FontActiveValue(theme,
                                                  javax.swing.plaf.metal.MetalTheme.SUB_TEXT_FONT);
        Object systemTextValue = new FontActiveValue(theme,
                                                 javax.swing.plaf.metal.MetalTheme.SYSTEM_TEXT_FONT);
        //
        // DEFAULTS TABLE
        //
       ...
       "shift ctrl alt F6", "selectPreviousFrame",
           ...
           "shift ctrl F12", "navigatePrevious"
            ...
            "Tree.expandedIcon", new SwingLazyValue(
                                     "javax.swing.plaf.metal.MetalIconFactory",
                                     "getTreeControlIcon",
                                     new Object[] {Boolean.valueOf(javax.swing.plaf.metal.MetalIconFactory.DARK)}),
            ...
            "ToolBar.rolloverBorder", (LazyValue) t -> javax.swing.plaf.metal.MetalBorders.getToolBarRolloverBorder(),
            "ToolBar.nonrolloverBorder", (LazyValue) t -> javax.swing.plaf.metal.MetalBorders.getToolBarNonrolloverBorder(),
            ...
            // RootPane
            "RootPane.frameBorder", (LazyValue) t -> new javax.swing.plaf.metal.MetalBorders.FrameBorder(),
            "RootPane.plainDialogBorder", dialogBorder,
            "RootPane.informationDialogBorder", dialogBorder,
            "RootPane.errorDialogBorder", (LazyValue) t -> new javax.swing.plaf.metal.MetalBorders.ErrorDialogBorder(),
        ...
        if (isWindows() && useSystemFonts() && theme.isSystemTheme()) {
            Object messageFont = new MetalFontDesktopProperty(
                "win.messagebox.font.height", javax.swing.plaf.metal.MetalTheme.CONTROL_TEXT_FONT);
     ...
     * @see javax.swing.plaf.metal.MetalTheme#addCustomEntriesToTable(UIDefaults)
     */
    public UIDefaults getDefaults() {
        ...
        javax.swing.plaf.metal.MetalTheme currentTheme = getCurrentTheme();
    ...
    public static javax.swing.plaf.metal.MetalTheme getCurrentTheme() {
        javax.swing.plaf.metal.MetalTheme currentTheme;
        AppContext context = AppContext.getAppContext();
        currentTheme = (javax.swing.plaf.metal.MetalTheme) context.get( "currentMetalTheme" );
    ...
    private static class FontActiveValue implements UIDefaults.ActiveValue {
        ...
        FontActiveValue(javax.swing.plaf.metal.MetalTheme theme, int type) {
            this.theme = theme;
            this.type = type;
        }
        ...
        public Object createValue(UIDefaults table) {
            Object value = null;
            switch (type) {
            case javax.swing.plaf.metal.MetalTheme.CONTROL_TEXT_FONT:
                value = theme.getControlTextFont();
                break;
            case javax.swing.plaf.metal.MetalTheme.SYSTEM_TEXT_FONT:
                value = theme.getSystemTextFont();
                break;
            case javax.swing.plaf.metal.MetalTheme.USER_TEXT_FONT:
                value = theme.getUserTextFont();
                break;
            case javax.swing.plaf.metal.MetalTheme.MENU_TEXT_FONT:
                value = theme.getMenuTextFont();
                break;
            case javax.swing.plaf.metal.MetalTheme.WINDOW_TITLE_FONT:
