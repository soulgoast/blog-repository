...
import goodman.javax.swing.plaf.metal.MetalScrollBarUI;
...
public class MetalScrollPaneUI extends BasicScrollPaneUI
{
    ...
    public void uninstallUI(JComponent c) {
        ...
        if (hsb != null) {
            hsb.putClientProperty( javax.swing.plaf.metal.MetalScrollBarUI.FREE_STANDING_PROP, null);
        }
        if (vsb != null) {
            vsb.putClientProperty( javax.swing.plaf.metal.MetalScrollBarUI.FREE_STANDING_PROP, null);
        }
    }
    ...
    private void updateScrollbarsFreeStanding() {
        ...
        if (sb != null) {
            sb.putClientProperty
                   (javax.swing.plaf.metal.MetalScrollBarUI.FREE_STANDING_PROP, value);
        }
                  ...
                  if (propertyName.equals("verticalScrollBar") ||
                      ...
                      if (oldSB != null) {
                          oldSB.putClientProperty(
                              javax.swing.plaf.metal.MetalScrollBarUI.FREE_STANDING_PROP, null);
                      }
