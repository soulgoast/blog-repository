...
import goodman.javax.swing.plaf.basic.BasicTabbedPaneUI;
...
public class MetalTabbedPaneUI extends BasicTabbedPaneUI {
    ...
    protected void installDefaults() {
        ...
        ocean = javax.swing.plaf.metal.MetalLookAndFeel.usingOcean();
        if (ocean) {
    ...
    protected void paintLeftTabBorder( int tabIndex, Graphics g,
        ...
        if ( tabIndex != firstIndex ) {
            if (tabPane.getSelectedIndex() == tabIndex - 1) {
                ...
                g.setColor(ocean ? javax.swing.plaf.metal.MetalLookAndFeel.getWhite() : highlight);
            }
