...
public class MetalIconFactory implements Serializable {
        ...
        private void paintOceanIcon(Component c, Graphics g, int x, int y) {
            ...
            if ( model.isEnabled() ) {
                if (model.isPressed() && model.isArmed()) {
                    ...
                    javax.swing.plaf.metal.MetalUtils.drawGradient(c, g, "CheckBox.gradient", 0, 0,
                                            w, h, true);
                    g.setColor(MetalLookAndFeel.getControlDarkShadow());
    ...
    private static class RadioButtonIcon implements Icon, UIResource, Serializable {
        public void paintOceanIcon(Component c, Graphics g, int x, int y) {
            ...
            if (enabled && !pressed) {
                ...
                javax.swing.plaf.metal.MetalUtils.drawGradient(c, g, "RadioButton.gradient",
                                        1, 1, 10, 10, true);
    ...
    public static class TreeControlIcon implements Icon, Serializable {
        ...
        public void paintIcon(Component c, Graphics g, int x, int y) {
            ...
            if (image == null || cachedOrientation != javax.swing.plaf.metal.MetalUtils.isLeftToRight(c)) {
                cachedOrientation = javax.swing.plaf.metal.MetalUtils.isLeftToRight(c);
                if (gc != null) {
                    image = gc.createCompatibleImage(getIconWidth(),
                                                     getIconHeight(),
                                                     Transparency.BITMASK);
        ...
        public void paintMe(Component c, Graphics g, int x, int y) {
            ...
            int xoff = (javax.swing.plaf.metal.MetalUtils.isLeftToRight(c)) ? 0 : 4;
  ...
  //
    ...
    private static class MenuArrowIcon implements Icon, UIResource, Serializable
    {
        public void paintIcon( Component c, Graphics g, int x, int y )
        {
            ...
            if( javax.swing.plaf.metal.MetalUtils.isLeftToRight(b) ) {
                g.drawLine( 0, 0, 0, 7 );
                g.drawLine( 1, 1, 1, 6 );
                g.drawLine( 2, 2, 2, 5 );
                g.drawLine( 3, 3, 3, 4 );
    ...
    private static class CheckBoxMenuItemIcon implements Icon, UIResource, Serializable
    {
        public void paintOceanIcon(Component c, Graphics g, int x, int y) {
            ...
            g.translate(x, y);
            if (isEnabled) {
                javax.swing.plaf.metal.MetalUtils.drawGradient(c, g, "CheckBoxMenuItem.gradient",
                                        1, 1, 7, 7, true);
    ...
    private static class RadioButtonMenuItemIcon implements Icon, UIResource, Serializable
    {
        public void paintOceanIcon(Component c, Graphics g, int x, int y) {
            ...
            if (isEnabled) {
                javax.swing.plaf.metal.MetalUtils.drawGradient(c, g, "RadioButtonMenuItem.gradient",
                                        1, 1, 7, 7, true);
                if (isPressed || isArmed) {
                    g.setColor(MetalLookAndFeel.getPrimaryControl());
                }
...
private static class VerticalSliderThumbIcon implements Icon, Serializable, UIResource {
    protected static javax.swing.plaf.metal.MetalBumps controlBumps;
    protected static javax.swing.plaf.metal.MetalBumps primaryBumps;

    public VerticalSliderThumbIcon() {
        controlBumps = new javax.swing.plaf.metal.MetalBumps( 6, 10,
                                MetalLookAndFeel.getControlHighlight(),
                                MetalLookAndFeel.getControlInfo(),
                                MetalLookAndFeel.getControl() );
        primaryBumps = new javax.swing.plaf.metal.MetalBumps( 6, 10,
                                MetalLookAndFeel.getPrimaryControl(),
                                MetalLookAndFeel.getPrimaryControlDarkShadow(),
                                MetalLookAndFeel.getPrimaryControlShadow() );
    }
...
private static class HorizontalSliderThumbIcon implements Icon, Serializable, UIResource {
    ...
    public HorizontalSliderThumbIcon() {
        controlBumps = new javax.swing.plaf.metal.MetalBumps( 10, 6,
                                MetalLookAndFeel.getControlHighlight(),
                                MetalLookAndFeel.getControlInfo(),
                                MetalLookAndFeel.getControl() );
        primaryBumps = new javax.swing.plaf.metal.MetalBumps( 10, 6,
                                MetalLookAndFeel.getPrimaryControl(),
                                MetalLookAndFeel.getPrimaryControlDarkShadow(),
                                MetalLookAndFeel.getPrimaryControlShadow() );
    }
    ...
    private static class OceanVerticalSliderThumbIcon extends CachedPainter
        ...
        public void paintIcon(Component c, Graphics g, int x, int y) {
            ...
            paint(c, g, x, y, getIconWidth(), getIconHeight(),
                  javax.swing.plaf.metal.MetalUtils.isLeftToRight(c), c.hasFocus(), c.isEnabled(),
        ...
        protected void paintToImage(Component c, Image image, Graphics g2,
            ...
            if (!enabled) {
                ...
                javax.swing.plaf.metal.MetalUtils.drawGradient(c, g, "Slider.focusGradient",
                                        1, 1, 14, 14, false);
            }
            else {
                javax.swing.plaf.metal.MetalUtils.drawGradient(c, g, "Slider.gradient",
                                        1, 1, 14, 14, false);
            }
            g.setClip(clip);
