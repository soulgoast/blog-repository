...
import goodman.javax.swing.plaf.nimbus.Effect;
import goodman.javax.swing.plaf.nimbus.EffectUtils;
import goodman.javax.swing.plaf.nimbus.ShadowEffect;
...
class InnerShadowEffect extends javax.swing.plaf.nimbus.ShadowEffect {
    ...
    javax.swing.plaf.nimbus.Effect.EffectType getEffectType() {
        return javax.swing.plaf.nimbus.Effect.EffectType.OVER;
    }
    ...
    BufferedImage applyEffect(BufferedImage src, BufferedImage dst, int w, int h) {
        ...
        // blur
        float[] kernel = javax.swing.plaf.nimbus.EffectUtils.createGaussianKernel(size * 2);
        javax.swing.plaf.nimbus.EffectUtils.blur(srcAlphaBuf, tmpBuf2, tmpW, tmpH, kernel, size * 2); // horizontal pass
        javax.swing.plaf.nimbus.EffectUtils.blur(tmpBuf2, tmpBuf1, tmpH, tmpW, kernel, size * 2);// vertical pass
        //rescale
