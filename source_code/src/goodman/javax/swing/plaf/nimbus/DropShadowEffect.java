...
class DropShadowEffect extends javax.swing.plaf.nimbus.ShadowEffect {
    ...
    BufferedImage applyEffect(BufferedImage src, BufferedImage dst, int w, int h) {
        ...
        // blur
        float[] kernel = javax.swing.plaf.nimbus.EffectUtils.createGaussianKernel(size);
        javax.swing.plaf.nimbus.EffectUtils.blur(tmpBuf1, tmpBuf2, tmpW, tmpH, kernel, size); // horizontal pass
        javax.swing.plaf.nimbus.EffectUtils.blur(tmpBuf2, tmpBuf1, tmpH, tmpW, kernel, size);// vertical pass
        //rescale
