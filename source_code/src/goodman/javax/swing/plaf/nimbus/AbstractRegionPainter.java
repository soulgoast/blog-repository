...
import goodman.javax.swing.plaf.nimbus.ImageScalingHelper;
import goodman.javax.swing.plaf.nimbus.NimbusLookAndFeel;
import goodman.java.awt.print.PrinterGraphics;
    ...
    */
    ...
    public final void paint(Graphics2D g, JComponent c, int w, int h) {
        ...
        if (cacheMode == PaintContext.CacheMode.NO_CACHING ||
                !javax.swing.plaf.nimbus.ImageCache.getInstance().isImageCachable(w, h) ||
    ...
    protected final Color decodeColor(String key, float hOffset, float sOffset,
        ...
        if (UIManager.getLookAndFeel() instanceof javax.swing.plaf.nimbus.NimbusLookAndFeel){
            javax.swing.plaf.nimbus.NimbusLookAndFeel laf = (javax.swing.plaf.nimbus.NimbusLookAndFeel) UIManager.getLookAndFeel();
    ...
    private VolatileImage getImage(GraphicsConfiguration config, JComponent c,
        ...
        javax.swing.plaf.nimbus.ImageCache imageCache = javax.swing.plaf.nimbus.ImageCache.getInstance();
