...
import goodman.javax.swing.BorderFactory;
import goodman.javax.swing.JComponent;
import goodman.javax.swing.JInternalFrame;
import goodman.javax.swing.UIDefaults;
import goodman.javax.swing.UIManager;
import goodman.javax.swing.plaf.BorderUIResource;
import goodman.javax.swing.plaf.ColorUIResource;
import goodman.javax.swing.plaf.DimensionUIResource;
import goodman.javax.swing.plaf.FontUIResource;
import goodman.javax.swing.plaf.InsetsUIResource;
import goodman.javax.swing.plaf.nimbus.*;
import goodman.javax.swing.plaf.nimbus.ButtonPainter;
import goodman.javax.swing.plaf.nimbus.DerivedColor;
import goodman.javax.swing.plaf.nimbus.MenuBarPainter;
import goodman.javax.swing.plaf.nimbus.MenuPainter;
import goodman.javax.swing.plaf.nimbus.NimbusIcon;
import goodman.javax.swing.plaf.nimbus.NimbusStyle;
import goodman.javax.swing.plaf.nimbus.TreePainter;
...
final class NimbusDefaults {
    ...
    void initializeDefaults(UIDefaults d) {
        ...
        d.put("Menu[Enabled+Selected].backgroundPainter", new LazyPainter("javax.swing.plaf.nimbus.MenuPainter", javax.swing.plaf.nimbus.MenuPainter.BACKGROUND_ENABLED_SELECTED, new Insets(0, 0, 0, 0), new Dimension(100, 30), false, AbstractRegionPainter.PaintContext.CacheMode.NO_CACHING, 1.0, 1.0));
        d.put("Menu[Disabled].arrowIconPainter", new LazyPainter("javax.swing.plaf.nimbus.MenuPainter", javax.swing.plaf.nimbus.MenuPainter.ARROWICON_DISABLED, new Insets(5, 5, 5, 5), new Dimension(9, 10), false, AbstractRegionPainter.PaintContext.CacheMode.FIXED_SIZES, 1.0, 1.0));
        d.put("Menu[Enabled].arrowIconPainter", new LazyPainter("javax.swing.plaf.nimbus.MenuPainter", javax.swing.plaf.nimbus.MenuPainter.ARROWICON_ENABLED, new Insets(5, 5, 5, 5), new Dimension(9, 10), false, AbstractRegionPainter.PaintContext.CacheMode.FIXED_SIZES, 1.0, 1.0));
        d.put("Menu[Enabled+Selected].arrowIconPainter", new LazyPainter("javax.swing.plaf.nimbus.MenuPainter", javax.swing.plaf.nimbus.MenuPainter.ARROWICON_ENABLED_SELECTED, new Insets(1, 1, 1, 1), new Dimension(9, 10), false, AbstractRegionPainter.PaintContext.CacheMode.FIXED_SIZES, 1.0, 1.0));
        ...
        d.put("Tree[Enabled].leafIconPainter", new LazyPainter("javax.swing.plaf.nimbus.TreePainter", javax.swing.plaf.nimbus.TreePainter.LEAFICON_ENABLED, new Insets(5, 5, 5, 5), new Dimension(16, 16), false, AbstractRegionPainter.PaintContext.CacheMode.FIXED_SIZES, 1.0, 1.0));
        d.put("Tree.leafIcon", new javax.swing.plaf.nimbus.NimbusIcon("Tree", "leafIconPainter", 16, 16));
        d.put("Tree[Enabled].closedIconPainter", new LazyPainter("javax.swing.plaf.nimbus.TreePainter", javax.swing.plaf.nimbus.TreePainter.CLOSEDICON_ENABLED, new Insets(5, 5, 5, 5), new Dimension(16, 16), false, AbstractRegionPainter.PaintContext.CacheMode.FIXED_SIZES, 1.0, 1.0));
        d.put("Tree.closedIcon", new javax.swing.plaf.nimbus.NimbusIcon("Tree", "closedIconPainter", 16, 16));
        d.put("Tree[Enabled].openIconPainter", new LazyPainter("javax.swing.plaf.nimbus.TreePainter", javax.swing.plaf.nimbus.TreePainter.OPENICON_ENABLED, new Insets(5, 5, 5, 5), new Dimension(16, 16), false, AbstractRegionPainter.PaintContext.CacheMode.FIXED_SIZES, 1.0, 1.0));
        d.put("Tree.openIcon", new javax.swing.plaf.nimbus.NimbusIcon("Tree", "openIconPainter", 16, 16));
        d.put("Tree[Enabled].collapsedIconPainter", new LazyPainter("javax.swing.plaf.nimbus.TreePainter", javax.swing.plaf.nimbus.TreePainter.COLLAPSEDICON_ENABLED, new Insets(5, 5, 5, 5), new Dimension(18, 7), false, AbstractRegionPainter.PaintContext.CacheMode.FIXED_SIZES, 1.0, 1.0));
        d.put("Tree[Enabled+Selected].collapsedIconPainter", new LazyPainter("javax.swing.plaf.nimbus.TreePainter", javax.swing.plaf.nimbus.TreePainter.COLLAPSEDICON_ENABLED_SELECTED, new Insets(5, 5, 5, 5), new Dimension(18, 7), false, AbstractRegionPainter.PaintContext.CacheMode.FIXED_SIZES, 1.0, 1.0));
        d.put("Tree.collapsedIcon", new javax.swing.plaf.nimbus.NimbusIcon("Tree", "collapsedIconPainter", 18, 7));
        d.put("Tree[Enabled].expandedIconPainter", new LazyPainter("javax.swing.plaf.nimbus.TreePainter", javax.swing.plaf.nimbus.TreePainter.EXPANDEDICON_ENABLED, new Insets(5, 5, 5, 5), new Dimension(18, 7), false, AbstractRegionPainter.PaintContext.CacheMode.FIXED_SIZES, 1.0, 1.0));
        d.put("Tree[Enabled+Selected].expandedIconPainter", new LazyPainter("javax.swing.plaf.nimbus.TreePainter", javax.swing.plaf.nimbus.TreePainter.EXPANDEDICON_ENABLED_SELECTED, new Insets(5, 5, 5, 5), new Dimension(18, 7), false, AbstractRegionPainter.PaintContext.CacheMode.FIXED_SIZES, 1.0, 1.0));
    ...
    private final class LazyStyle {
        ...
        SynthStyle getStyle(JComponent c, Region r) {
            ...
            if (c.getClientProperty("Nimbus.Overrides") != null) {
                ...
                if (s == null) {
                    s = new javax.swing.plaf.nimbus.NimbusStyle(prefix, c);
                    map.put(r, s);
                }
                return s;
            }
