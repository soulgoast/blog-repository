...
import goodman.javax.swing.plaf.basic.BasicSpinnerUI;
...
public class SynthSpinnerUI extends BasicSpinnerUI
    ...
    protected void uninstallDefaults() {
        ...
        javax.swing.plaf.synth.SynthContext context = getContext(spinner, ENABLED);
    ...
    private void updateEditorAlignment(JComponent editor) {
        if (editor instanceof JSpinner.DefaultEditor) {
            javax.swing.plaf.synth.SynthContext context = getContext(spinner);
