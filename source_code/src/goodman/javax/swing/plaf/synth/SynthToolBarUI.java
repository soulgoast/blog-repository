...
import goodman.javax.swing.JToolBar;
...
public class SynthToolBarUI extends BasicToolBarUI
    ...
    private javax.swing.plaf.synth.SynthStyle contentStyle;
    private javax.swing.plaf.synth.SynthStyle dragWindowStyle;
    ...
    private void updateStyle(JToolBar c) {
        javax.swing.plaf.synth.SynthContext context = getContext(
                c, javax.swing.plaf.synth.Region.TOOL_BAR_CONTENT, null, ENABLED);
        contentStyle = SynthLookAndFeel.updateStyle(context, this);
        context.dispose();

        context = getContext(c, javax.swing.plaf.synth.Region.TOOL_BAR_DRAG_WINDOW, null, ENABLED);
    ...
    protected void uninstallDefaults() {
        javax.swing.plaf.synth.SynthContext context = getContext(toolBar, ENABLED);
        ...
        context = getContext(toolBar, javax.swing.plaf.synth.Region.TOOL_BAR_CONTENT,
                             contentStyle, ENABLED);
        contentStyle.uninstallDefaults(context);
        context.dispose();
        contentStyle = null;

        context = getContext(toolBar, javax.swing.plaf.synth.Region.TOOL_BAR_DRAG_WINDOW,
    ...
    private javax.swing.plaf.synth.SynthContext getContext(JComponent c, javax.swing.plaf.synth.Region region, javax.swing.plaf.synth.SynthStyle style) {
        return javax.swing.plaf.synth.SynthContext.getContext(c, region,
    ...
    protected void paint(javax.swing.plaf.synth.SynthContext context, Graphics g) {
        ...
        javax.swing.plaf.synth.SynthContext subcontext = getContext(
                toolBar, javax.swing.plaf.synth.Region.TOOL_BAR_CONTENT, contentStyle);
     ...
     */
    protected void paintContent(javax.swing.plaf.synth.SynthContext context, Graphics g,
                                Rectangle bounds) {
    ...
    class SynthToolBarLayoutManager implements LayoutManager {
        ...
        public Dimension minimumLayoutSize(Container parent) {
            ...
            javax.swing.plaf.synth.SynthContext context = getContext(tb);
