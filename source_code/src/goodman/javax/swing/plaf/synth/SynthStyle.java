...
public abstract class SynthStyle {
     ...
     * @return Color
     */
    public Color getColor(SynthContext context, javax.swing.plaf.synth.ColorType type) {
        JComponent c = context.getComponent();
        javax.swing.plaf.synth.Region id = context.getRegion();
                ...
                if (disabledColor == null || disabledColor instanceof UIResource) {
                    return getColorForState(context, type);
                            ...
                            (type == javax.swing.plaf.synth.ColorType.FOREGROUND ||
                             type == javax.swing.plaf.synth.ColorType.TEXT_FOREGROUND)) {
                return getColorForState(context, type);
            }
        }
        ...
        Color color = null;
        if (!id.isSubregion()) {
            if (type == javax.swing.plaf.synth.ColorType.BACKGROUND) {
                color = c.getBackground();
            }
            else if (type == javax.swing.plaf.synth.ColorType.FOREGROUND) {
                color = c.getForeground();
            }
            else if (type == javax.swing.plaf.synth.ColorType.TEXT_FOREGROUND) {
                color = c.getForeground();
            }
        }
        ...
        if (color == null) {
            ...
            if (type == javax.swing.plaf.synth.ColorType.BACKGROUND ||
                        type == javax.swing.plaf.synth.ColorType.TEXT_BACKGROUND) {
