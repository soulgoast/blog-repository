...
public class SynthButtonUI extends BasicButtonUI implements
    ...
    void updateStyle(AbstractButton b) {
        javax.swing.plaf.synth.SynthContext context = getContext(b, SynthConstants.ENABLED);
    ...
    protected void uninstallDefaults(AbstractButton b) {
        javax.swing.plaf.synth.SynthContext context = getContext(b, ENABLED);
    ...
    public int getBaseline(JComponent c, int width, int height) {
        ...
        javax.swing.plaf.synth.SynthContext context = getContext(b);
     ...
     */
    private int getTextShiftOffset(javax.swing.plaf.synth.SynthContext state) {
    ...
    public Dimension getMinimumSize(JComponent c) {
        ...
        AbstractButton b = (AbstractButton)c;
        javax.swing.plaf.synth.SynthContext ss = getContext(c);
