...
import goodman.java.text.DateFormat;
import goodman.java.text.Format;
...
import goodman.javax.swing.JCheckBox;
import goodman.javax.swing.JComponent;
import goodman.javax.swing.JLabel;
import goodman.javax.swing.JTable;
import goodman.javax.swing.LookAndFeel;
import goodman.javax.swing.border.Border;
import goodman.javax.swing.plaf.*;
import goodman.javax.swing.plaf.basic.BasicTableUI;
...
import goodman.javax.swing.table.DefaultTableCellRenderer;
import goodman.javax.swing.table.JTableHeader;
import goodman.javax.swing.table.TableCellRenderer;
import goodman.javax.swing.table.TableColumn;
import goodman.javax.swing.table.TableColumnModel;
        ...
        if (style != oldStyle) {
            ...
            if (sbg == null || sbg instanceof UIResource) {
                table.setSelectionBackground(style.getColor(
                                        context, javax.swing.plaf.synth.ColorType.TEXT_BACKGROUND));
            }

            Color sfg = table.getSelectionForeground();
            if (sfg == null || sfg instanceof UIResource) {
                table.setSelectionForeground(style.getColor(
                                  context, javax.swing.plaf.synth.ColorType.TEXT_FOREGROUND));
            }
            ...
            if (gridColor == null || gridColor instanceof UIResource) {
                ...
                if (gridColor == null) {
                    gridColor = style.getColor(context, javax.swing.plaf.synth.ColorType.FOREGROUND);
                }
...
//            if (d == null || d instanceof UIResource) {
    ...
    protected void uninstallDefaults() {
        ...
        javax.swing.plaf.synth.SynthContext context = getContext(table, ENABLED);
...
//
    ...
    private void paintDropLines(javax.swing.plaf.synth.SynthContext context, Graphics g) {
     ...
     * returns true.
     */
    private void paintGrid(javax.swing.plaf.synth.SynthContext context, Graphics g, int rMin,
    ...
    private void paintCells(javax.swing.plaf.synth.SynthContext context, Graphics g, int rMin,
                            int rMax, int cMin, int cMax) {
    ...
    private void paintDraggedArea(javax.swing.plaf.synth.SynthContext context, Graphics g, int rMin, int rMax, TableColumn draggedColumn, int distance) {
    ...
    private class SynthTableCellRenderer extends DefaultTableCellRenderer {
        ...
        public void setBorder(Border b) {
            if (useUIBorder || b instanceof javax.swing.plaf.synth.SynthBorder) {
                super.setBorder(b);
            }
        }
        ...
        public Component getTableCellRendererComponent(
            ...
            if (!useTableColors && (isSelected || hasFocus)) {
                SynthLookAndFeel.setSelectedUI((javax.swing.plaf.synth.SynthLabelUI)SynthLookAndFeel.
