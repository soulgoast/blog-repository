...
import goodman.java.util.regex.*;
...
class DefaultSynthStyleFactory extends SynthStyleFactory {
     ...
     */
    private Map<BakedArrayList, javax.swing.plaf.synth.SynthStyle> _resolvedStyles;
    ...
    DefaultSynthStyleFactory() {
        ...
        _resolvedStyles = new HashMap<BakedArrayList, javax.swing.plaf.synth.SynthStyle>();
    }
     ...
     */
    public synchronized javax.swing.plaf.synth.SynthStyle getStyle(JComponent c, javax.swing.plaf.synth.Region id) {
        ...
        javax.swing.plaf.synth.SynthStyle style = getCachedStyle(matches);
     ...
     */
    private void cacheStyle(List styles, javax.swing.plaf.synth.SynthStyle style) {
     ...
     */
    private javax.swing.plaf.synth.SynthStyle getCachedStyle(List styles) {
        if (styles.size() == 0) {
            return null;
        }
     ...
     * match will be first.
     */
    private javax.swing.plaf.synth.SynthStyle mergeStyles(List styles) {
