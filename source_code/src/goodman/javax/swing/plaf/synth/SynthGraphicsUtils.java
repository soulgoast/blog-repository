...
public class SynthGraphicsUtils {
     ...
     */
    public void drawLine(javax.swing.plaf.synth.SynthContext context, Object paintKey,
     ...
     */
    public String layoutText(javax.swing.plaf.synth.SynthContext ss, FontMetrics fm,
     ...
     */
    public int computeStringWidth(javax.swing.plaf.synth.SynthContext ss, Font font,
     ...
     */
    public Dimension getMinimumSize(javax.swing.plaf.synth.SynthContext ss, Font font, String text,
     ...
     *        indicates no mnemonic.
     */
    public Dimension getMaximumSize(javax.swing.plaf.synth.SynthContext ss, Font font, String text,
                                    Icon icon, int hAlign, int vAlign, int hTextPosition,
                                    int vTextPosition, int iconTextGap, int mnemonicIndex) {
        JComponent c = ss.getComponent();
        Dimension size = getPreferredSize(ss, font, text, icon, hAlign,
     ...
     *        indicates no mnemonic.
     */
    public Dimension getPreferredSize(javax.swing.plaf.synth.SynthContext ss, Font font, String text,
                                      Icon icon, int hAlign, int vAlign, int hTextPosition,
                                      int vTextPosition, int iconTextGap, int mnemonicIndex) {
        JComponent c = ss.getComponent();
     ...
     */
    public void paintText(javax.swing.plaf.synth.SynthContext ss, Graphics g, String text,
    ...
    public void paintText(javax.swing.plaf.synth.SynthContext ss, Graphics g, String text,
        ...
        JComponent c = ss.getComponent();
        FontMetrics fm = SwingUtilities2.getFontMetrics(c, g);
        Insets insets = javax.swing.plaf.synth.SynthLookAndFeel.getPaintingInsets(ss, paintInsets);
      ...
      */
    static Dimension getPreferredMenuItemSize(javax.swing.plaf.synth.SynthContext context,
                                              javax.swing.plaf.synth.SynthContext accContext, JComponent c,
         ...
         SynthMenuItemLayoutHelper lh = new SynthMenuItemLayoutHelper(
                 ...
                 acceleratorDelimiter, javax.swing.plaf.synth.SynthLookAndFeel.isLeftToRight(mi),
    ...
    static void paint(javax.swing.plaf.synth.SynthContext context, javax.swing.plaf.synth.SynthContext accContext, Graphics g,
    ...
    static void paintBackground(javax.swing.plaf.synth.SynthContext context, Graphics g, JComponent c) {
    ...
    private static class SynthIconWrapper implements Icon {
        ...
        private javax.swing.plaf.synth.SynthContext context;

        static SynthIconWrapper get(SynthIcon icon, javax.swing.plaf.synth.SynthContext context) {
            synchronized(CACHE) {
                int size = CACHE.size();
                if (size > 0) {
        ...
        SynthIconWrapper(SynthIcon icon, javax.swing.plaf.synth.SynthContext context) {
            reset(icon, context);
        }
