...
public class SynthTabbedPaneUI extends BasicTabbedPaneUI
    ...
    private void updateStyle(JTabbedPane c) {
        ...
        tabContext = getContext(c, javax.swing.plaf.synth.Region.TABBED_PANE_TAB, ENABLED);
        this.tabStyle = javax.swing.plaf.synth.SynthLookAndFeel.updateStyle(tabContext, this);
        ...
        tabAreaContext = getContext(c, javax.swing.plaf.synth.Region.TABBED_PANE_TAB_AREA, ENABLED);
        this.tabAreaStyle = javax.swing.plaf.synth.SynthLookAndFeel.updateStyle(tabAreaContext, this);
        ...
        tabContentContext = getContext(c, javax.swing.plaf.synth.Region.TABBED_PANE_CONTENT, ENABLED);
        this.tabContentStyle = javax.swing.plaf.synth.SynthLookAndFeel.updateStyle(tabContentContext,
                                                            this);
        contentBorderInsets =
    ...
    protected void uninstallDefaults() {
        javax.swing.plaf.synth.SynthContext context = getContext(tabPane, ENABLED);
    ...
    private javax.swing.plaf.synth.SynthContext getContext(JComponent c, javax.swing.plaf.synth.Region subregion, int state){
        SynthStyle style = null;

        if (subregion == javax.swing.plaf.synth.Region.TABBED_PANE_TAB) {
            style = tabStyle;
        }
        else if (subregion == javax.swing.plaf.synth.Region.TABBED_PANE_TAB_AREA) {
            style = tabAreaStyle;
        }
        else if (subregion == Region.TABBED_PANE_CONTENT) {
            style = tabContentStyle;
        }
        return javax.swing.plaf.synth.SynthContext.getContext(c, subregion, style, state);
    }
    ...
    private void paintTabArea(javax.swing.plaf.synth.SynthContext ss, Graphics g,
        ...
        if (tabAreaStatesMatchSelectedTab && selectedIndex >= 0) {
            ...
            ss.setComponentState(javax.swing.plaf.synth.SynthConstants.ENABLED);
        }

        // Paint the tab area.
        javax.swing.plaf.synth.SynthLookAndFeel.updateSubregion(ss, g, tabAreaBounds);
    ...
    private void paintTab(javax.swing.plaf.synth.SynthContext ss, Graphics g,
        ...
        javax.swing.plaf.synth.SynthLookAndFeel.updateSubregion(ss, g, tabRect);
        int x = tabRect.x;
        int y = tabRect.y;
    ...
    private void layoutLabel(javax.swing.plaf.synth.SynthContext ss, int tabPlacement,
    ...
    private void paintText(javax.swing.plaf.synth.SynthContext ss,
    ...
    private void paintContentBorder(SynthContext ss, Graphics g,
        ...
        javax.swing.plaf.synth.SynthLookAndFeel.updateSubregion(ss, g, new Rectangle(x, y, w, h));
    ...
    private void updateTabContext(int index, boolean selected,
        ...
        if (!tabPane.isEnabled() || !tabPane.isEnabledAt(index)) {
            state |= javax.swing.plaf.synth.SynthConstants.DISABLED;
            if (selected) {
                state |= javax.swing.plaf.synth.SynthConstants.SELECTED;
            }
        }
        else if (selected) {
            state |= (javax.swing.plaf.synth.SynthConstants.ENABLED | javax.swing.plaf.synth.SynthConstants.SELECTED);
            if (isMouseOver && UIManager.getBoolean("TabbedPane.isTabRollover")) {
                state |= javax.swing.plaf.synth.SynthConstants.MOUSE_OVER;
            }
        }
        else if (isMouseOver) {
            state |= (javax.swing.plaf.synth.SynthConstants.ENABLED | javax.swing.plaf.synth.SynthConstants.MOUSE_OVER);
        }
        else {
            state = SynthLookAndFeel.getComponentState(tabPane);
            state &= ~javax.swing.plaf.synth.SynthConstants.FOCUSED; // don't use tabbedpane focus state
        }
        if (hasFocus && tabPane.hasFocus()) {
            state |= javax.swing.plaf.synth.SynthConstants.FOCUSED; // individual tab has focus
        }
        if (isMouseDown) {
    ...
    private class SynthScrollableTabButton extends javax.swing.plaf.synth.SynthArrowButton implements
            UIResource {
