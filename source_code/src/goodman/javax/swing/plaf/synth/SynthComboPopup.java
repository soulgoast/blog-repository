...
import goodman.javax.swing.plaf.ComboBoxUI;
...
class SynthComboPopup extends BasicComboPopup {
    ...
    protected Rectangle computePopupBounds(int px, int py, int pw, int ph) {
        ...
        if (ui instanceof javax.swing.plaf.synth.SynthComboBoxUI) {
            javax.swing.plaf.synth.SynthComboBoxUI sui = (SynthComboBoxUI) ui;
