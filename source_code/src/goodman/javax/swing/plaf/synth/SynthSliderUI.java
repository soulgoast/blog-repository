...
import goodman.javax.swing.plaf.basic.BasicSliderUI;
...
import goodman.javax.swing.plaf.synth.SynthGraphicsUtils;
...
public class SynthSliderUI extends BasicSliderUI
    ...
    protected void uninstallDefaults(JSlider slider) {
        javax.swing.plaf.synth.SynthContext context = getContext(slider, ENABLED);
        style.uninstallDefaults(context);
        context.dispose();
        style = null;

        context = getContext(slider, javax.swing.plaf.synth.Region.SLIDER_TRACK, ENABLED);
        sliderTrackStyle.uninstallDefaults(context);
        context.dispose();
        sliderTrackStyle = null;

        context = getContext(slider, javax.swing.plaf.synth.Region.SLIDER_THUMB, ENABLED);
    ...
    private void updateStyle(JSlider c) {
        ...
        context = getContext(c, javax.swing.plaf.synth.Region.SLIDER_TRACK, ENABLED);
        sliderTrackStyle =
            SynthLookAndFeel.updateStyle(context, this);
        context.dispose();

        context = getContext(c, javax.swing.plaf.synth.Region.SLIDER_THUMB, ENABLED);
        sliderThumbStyle =
            SynthLookAndFeel.updateStyle(context, this);
        context.dispose();
    }
    ...
    public int getBaseline(JComponent c, int width, int height) {
        ...
        if (slider.getPaintLabels() && labelsHaveSameBaselines()) {
            ...
            javax.swing.plaf.synth.SynthContext trackContext = getContext(slider,
            ...
            if (slider.getOrientation() == JSlider.HORIZONTAL) {
                int valueHeight = 0;
                if (paintValue) {
                    javax.swing.plaf.synth.SynthContext context = getContext(slider);
    ...
    protected void layout() {
        ...
        // Get the insets for the track.
        Insets trackInsets = new Insets(0, 0, 0, 0);
        javax.swing.plaf.synth.SynthContext trackContext = getContext(slider, javax.swing.plaf.synth.Region.SLIDER_TRACK);
        style.getInsets(trackContext, trackInsets);
        trackContext.dispose();
    ...
    private javax.swing.plaf.synth.SynthContext getContext(JComponent c, javax.swing.plaf.synth.Region subregion) {
    ...
    private javax.swing.plaf.synth.SynthContext getContext(JComponent c, javax.swing.plaf.synth.Region subregion, int state) {
        ...
        if (subregion == javax.swing.plaf.synth.Region.SLIDER_TRACK) {
            style = sliderTrackStyle;
        } else if (subregion == javax.swing.plaf.synth.Region.SLIDER_THUMB) {
    ...
    private int getComponentState(JComponent c, javax.swing.plaf.synth.Region region) {
        if (region == javax.swing.plaf.synth.Region.SLIDER_THUMB && thumbActive &&c.isEnabled()) {
    ...
    protected void paint(javax.swing.plaf.synth.SynthContext context, Graphics g) {
        ...
        if (slider.getPaintTrack() && clip.intersects(trackRect)) {
            javax.swing.plaf.synth.SynthContext subcontext = getContext(slider, javax.swing.plaf.synth.Region.SLIDER_TRACK);
            paintTrack(subcontext, g, trackRect);
            subcontext.dispose();
        }

        if (clip.intersects(thumbRect)) {
            javax.swing.plaf.synth.SynthContext subcontext = getContext(slider, Region.SLIDER_THUMB);
     ...
     */
    protected void paintThumb(javax.swing.plaf.synth.SynthContext context, Graphics g,
