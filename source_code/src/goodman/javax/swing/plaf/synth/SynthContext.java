...
import goodman.java.util.concurrent.ConcurrentLinkedQueue;
...
public class SynthContext {
    ...
    private javax.swing.plaf.synth.Region region;
    private javax.swing.plaf.synth.SynthStyle style;
    private int state;

    static SynthContext getContext(JComponent c, javax.swing.plaf.synth.SynthStyle style, int state) {
        return getContext(c, SynthLookAndFeel.getRegion(c), style, state);
    }

    static SynthContext getContext(JComponent component,
                                   javax.swing.plaf.synth.Region region, javax.swing.plaf.synth.SynthStyle style,
                                   int state) {
     ...
     */
    public SynthContext(JComponent component, javax.swing.plaf.synth.Region region, javax.swing.plaf.synth.SynthStyle style,
                        int state) {
