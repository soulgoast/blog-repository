...
import goodman.java.awt.event.FocusEvent;
import goodman.java.awt.event.FocusListener;
...
public class SynthTextFieldUI extends BasicTextFieldUI implements SynthUI {
    ...
    private void updateStyle(JTextComponent comp) {
        javax.swing.plaf.synth.SynthContext context = getContext(comp, ENABLED);
    ...
    static void updateStyle(JTextComponent comp, javax.swing.plaf.synth.SynthContext context,
            String prefix) {
        ...
        if (fg == null || fg instanceof UIResource) {
            fg = style.getColorForState(context, javax.swing.plaf.synth.ColorType.TEXT_FOREGROUND);
            if (fg != null) {
        ...
        if (s == null || s instanceof UIResource) {
            comp.setSelectionColor(
                style.getColor(context, javax.swing.plaf.synth.ColorType.TEXT_BACKGROUND));
        }

        Color sfg = comp.getSelectedTextColor();
        if (sfg == null || sfg instanceof UIResource) {
            comp.setSelectedTextColor(
                style.getColor(context, javax.swing.plaf.synth.ColorType.TEXT_FOREGROUND));
        }
        ...
        if (margin == null || margin instanceof UIResource) {
            ...
            if (margin == null) {
                ...
                margin = javax.swing.plaf.synth.SynthLookAndFeel.EMPTY_UIRESOURCE_INSETS;
            }
