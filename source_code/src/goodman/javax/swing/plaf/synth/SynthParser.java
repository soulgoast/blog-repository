...
import goodman.java.net.URLClassLoader;
...
import goodman.java.util.regex.PatternSyntaxException;

import goodman.javax.swing.ImageIcon;
import goodman.javax.swing.JSplitPane;
...
import goodman.javax.xml.parsers.SAXParser;
import goodman.javax.xml.parsers.SAXParserFactory;
...
class SynthParser extends DefaultHandler {
     ...
     */
    private List<javax.swing.plaf.synth.ColorType> _colorTypes;
    ...
    SynthParser() {
        ...
        _colorTypes = new ArrayList<javax.swing.plaf.synth.ColorType>();
        ...
        for(int i = attributes.getLength() - 1; i >= 0; i--) {
            ...
            if (key.equals(ATTRIBUTE_ID)) {
                ...
                while (tokenizer.hasMoreTokens()) {
                    ...
                    if (classIndex == -1) {
                        typeClass = javax.swing.plaf.synth.ColorType.class;
                        classIndex = 0;
                    }
                    else {
                        try {
                    ...
                    try {
                        _colorTypes.add((javax.swing.plaf.synth.ColorType)checkCast(typeClass.
