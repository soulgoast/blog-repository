...
import goodman.javax.swing.plaf.synth.ColorType;
import goodman.javax.swing.plaf.synth.Region;
import goodman.javax.swing.plaf.synth.SynthButtonUI;
import goodman.javax.swing.plaf.synth.SynthCheckBoxUI;
import goodman.javax.swing.plaf.synth.SynthComboBoxUI;
import goodman.javax.swing.plaf.synth.SynthConstants;
import goodman.javax.swing.plaf.synth.SynthContext;
import goodman.javax.swing.plaf.synth.SynthLabelUI;
import goodman.javax.swing.plaf.synth.SynthListUI;
import goodman.javax.swing.plaf.synth.SynthMenuBarUI;
import goodman.javax.swing.plaf.synth.SynthMenuItemUI;
import goodman.javax.swing.plaf.synth.SynthMenuUI;
import goodman.javax.swing.plaf.synth.SynthPanelUI;
import goodman.javax.swing.plaf.synth.SynthParser;
import goodman.javax.swing.plaf.synth.SynthRootPaneUI;
import goodman.javax.swing.plaf.synth.SynthSliderUI;
import goodman.javax.swing.plaf.synth.SynthSpinnerUI;
import goodman.javax.swing.plaf.synth.SynthStyle;
import goodman.javax.swing.plaf.synth.SynthTableUI;
import goodman.javax.swing.plaf.synth.SynthTextAreaUI;
import goodman.javax.swing.plaf.synth.SynthTextPaneUI;
import goodman.javax.swing.plaf.synth.SynthToolBarUI;
import goodman.javax.swing.plaf.synth.SynthToolTipUI;
import goodman.javax.swing.plaf.synth.SynthTreeUI;
import goodman.javax.swing.plaf.synth.SynthUI;
import goodman.javax.swing.plaf.synth.SynthViewportUI;
...
public class SynthLookAndFeel extends BasicLookAndFeel {
    ...
    static void setSelectedUI(ComponentUI uix, boolean selected,
        ...
        if (selected) {
            selectedUIState = javax.swing.plaf.synth.SynthConstants.SELECTED;
            if (focused) {
                selectedUIState |= javax.swing.plaf.synth.SynthConstants.FOCUSED;
            }
        }
        else if (rollover && enabled) {
            selectedUIState |=
                    javax.swing.plaf.synth.SynthConstants.MOUSE_OVER | javax.swing.plaf.synth.SynthConstants.ENABLED;
            if (focused) {
                selectedUIState |= javax.swing.plaf.synth.SynthConstants.FOCUSED;
            }
        }
            ...
            if (enabled) {
                selectedUIState |= javax.swing.plaf.synth.SynthConstants.ENABLED;
                if (focused) {
                    selectedUIState |= javax.swing.plaf.synth.SynthConstants.FOCUSED;
                }
            }
            else {
                selectedUIState |= javax.swing.plaf.synth.SynthConstants.DISABLED;
            }
        }
    ...
    static int getComponentState(Component c) {
        if (c.isEnabled()) {
            if (c.isFocusOwner()) {
                return javax.swing.plaf.synth.SynthUI.ENABLED | javax.swing.plaf.synth.SynthUI.FOCUSED;
            }
            return javax.swing.plaf.synth.SynthUI.ENABLED;
        }
        return javax.swing.plaf.synth.SynthUI.DISABLED;
    }
     ...
     */
    public static javax.swing.plaf.synth.SynthStyle getStyle(JComponent c, javax.swing.plaf.synth.Region region) {
    ...
    static javax.swing.plaf.synth.SynthStyle updateStyle(javax.swing.plaf.synth.SynthContext context, javax.swing.plaf.synth.SynthUI ui) {
        javax.swing.plaf.synth.SynthStyle newStyle = getStyle(context.getComponent(),
                                       context.getRegion());
        javax.swing.plaf.synth.SynthStyle oldStyle = context.getStyle();
     ...
     */
    public static javax.swing.plaf.synth.Region getRegion(JComponent c) {
        return javax.swing.plaf.synth.Region.getRegion(c);
    }
     ...
     */
    static Insets getPaintingInsets(javax.swing.plaf.synth.SynthContext state, Insets insets) {
     ...
     * this method.
     */
    static void update(javax.swing.plaf.synth.SynthContext state, Graphics g) {
     ...
     */
    static void updateSubregion(javax.swing.plaf.synth.SynthContext state, Graphics g,
                                Rectangle bounds) {
        paintRegion(state, g, bounds);
    }

    private static void paintRegion(javax.swing.plaf.synth.SynthContext state, Graphics g,
                                    Rectangle bounds) {
        JComponent c = state.getComponent();
        javax.swing.plaf.synth.SynthStyle style = state.getStyle();
        ...
        if ((subregion && style.isOpaque(state)) ||
            ...
            g.setColor(style.getColor(state, javax.swing.plaf.synth.ColorType.BACKGROUND));
    ...
    public void load(InputStream input, Class<?> resourceBase) throws
        ...
        new javax.swing.plaf.synth.SynthParser().parse(input, (DefaultSynthStyleFactory) factory,
    ...
    private class Handler implements PropertyChangeListener {
        ...
        private void repaintIfBackgroundsDiffer(JComponent comp) {
            ...
            if (ui instanceof javax.swing.plaf.synth.SynthUI) {
                javax.swing.plaf.synth.SynthUI synthUI = (SynthUI)ui;
                SynthContext context = synthUI.getContext(comp);
                SynthStyle style = context.getStyle();
                int state = context.getComponentState();

                // Get the current background color.
                Color currBG = style.getColor(context, javax.swing.plaf.synth.ColorType.BACKGROUND);

                // Get the last background color.
                state ^= javax.swing.plaf.synth.SynthConstants.FOCUSED;
