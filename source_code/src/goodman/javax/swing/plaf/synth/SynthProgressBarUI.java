...
import goodman.javax.swing.plaf.basic.BasicProgressBarUI;
...
public class SynthProgressBarUI extends BasicProgressBarUI
    ...
    protected void uninstallDefaults() {
        javax.swing.plaf.synth.SynthContext context = getContext(progressBar, ENABLED);
        ...
        if (!pBar.isIndeterminate()) {
            ...
            if (percentComplete != 0.0) {
                if (pBar.getOrientation() == JProgressBar.HORIZONTAL) {
                    ...
                    if (!javax.swing.plaf.synth.SynthLookAndFeel.isLeftToRight(pBar)) {
     ...
     */
    protected void paintText(javax.swing.plaf.synth.SynthContext context, Graphics g, String title) {
        if (progressBar.isStringPainted()) {
            ...
            if (rotateText &&
                ...
                g2.setFont(font);
                g2.setColor(style.getColor(context, javax.swing.plaf.synth.ColorType.TEXT_FOREGROUND));
