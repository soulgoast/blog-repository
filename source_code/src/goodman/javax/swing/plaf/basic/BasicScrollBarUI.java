    ...
    extends ScrollBarUI implements LayoutManager, SwingConstants
{
    ...
    protected void installKeyboardActions(){
        javax.swing.plaf.basic.LazyActionMap.installLazyActionMap(scrollbar, BasicScrollBarUI.class,
                                           "ScrollBar.actionMap");
    ...
    protected JButton createDecreaseButton(int orientation)  {
        return new javax.swing.plaf.basic.BasicArrowButton(orientation,
    ...
    private void updateButtonDirections() {
        ...
        if (scrollbar.getComponentOrientation().isLeftToRight()) {
            if (incrButton instanceof javax.swing.plaf.basic.BasicArrowButton) {
                ((javax.swing.plaf.basic.BasicArrowButton)incrButton).setDirection(
                        orient == HORIZONTAL? EAST : SOUTH);
            }
            if (decrButton instanceof javax.swing.plaf.basic.BasicArrowButton) {
                ((javax.swing.plaf.basic.BasicArrowButton)decrButton).setDirection(
