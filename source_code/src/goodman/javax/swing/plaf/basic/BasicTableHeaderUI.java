        ...
        private void repaintHeader(Object source) {
            if (source instanceof JTableHeader) {
                ...
                BasicTableHeaderUI ui =
                   (BasicTableHeaderUI) javax.swing.plaf.basic.BasicLookAndFeel.
...
//  Installation
    ...
    protected void installKeyboardActions() {
        ...
        javax.swing.plaf.basic.LazyActionMap.installLazyActionMap(header, BasicTableHeaderUI.class,
    ...
    private static class Actions extends UIAction {
        ...
        public boolean isEnabled(Object sender) {
            if (sender instanceof JTableHeader) {
                ...
                String key = getName();
                BasicTableHeaderUI ui =
                    (BasicTableHeaderUI) javax.swing.plaf.basic.BasicLookAndFeel.getUIOfType(th.getUI(),
                                                      BasicTableHeaderUI.class);
                if (ui != null) {
