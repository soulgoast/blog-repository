...
import goodman.javax.swing.plaf.basic.BasicMenuItemUI;
...
public class BasicPopupMenuUI extends PopupMenuUI {
    ...
    public BasicPopupMenuUI() {
        javax.swing.plaf.basic.BasicLookAndFeel.needsEventHelper = true;
    ...
    static ActionMap getActionMap() {
        return javax.swing.plaf.basic.LazyActionMap.getActionMap(BasicPopupMenuUI.class,
                                          "PopupMenu.actionMap");
    }
    ...
    private class BasicPopupMenuListener implements PopupMenuListener {
        ...
        public void popupMenuWillBecomeVisible(PopupMenuEvent e) {
            javax.swing.plaf.basic.BasicLookAndFeel.playSound((JPopupMenu)e.getSource(),
        ...
        private void doReturn() {
            ...
            if(path.length > 0) {
                ...
                if(lastElement instanceof JMenu) {
                    ...
                    if (mi.getUI() instanceof javax.swing.plaf.basic.BasicMenuItemUI) {
