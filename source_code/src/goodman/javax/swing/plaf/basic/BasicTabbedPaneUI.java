...
import goodman.javax.swing.plaf.basic.BasicArrowButton;
import goodman.javax.swing.plaf.basic.BasicGraphicsUtils;
...
// UI Installation/De-installation
    ...
    protected void installKeyboardActions() {
        ...
        javax.swing.plaf.basic.LazyActionMap.installLazyActionMap(tabPane, BasicTabbedPaneUI.class,
    ...
    private void addMnemonic(int index, int mnemonic) {
        ...
        mnemonicInputMap.put(KeyStroke.getKeyStroke(mnemonic, javax.swing.plaf.basic.BasicLookAndFeel.getFocusAcceleratorKeyMask()),
                             "setSelectedIndex");
    ...
    protected int getBaseline(int tab) {
        if (tabPane.getTabComponentAt(tab) != null) {
            ...
            if (view != null) {
                ...
                int baseline = javax.swing.plaf.basic.BasicHTML.getHTMLBaseline(
...
// Controller: event listeners
    ...
    private class Handler implements ChangeListener, ContainerListener,
        ...
        private void updateHtmlViews(int index) {
            ...
            boolean isHTML = javax.swing.plaf.basic.BasicHTML.isHTMLString(title);
            if (isHTML) {
                if (htmlViews==null) {    // Initialize vector
                    htmlViews = createHTMLVector();
                } else {                  // Vector already exists
                    View v = javax.swing.plaf.basic.BasicHTML.createHTMLView(tabPane, title);
    ...
    private Vector<View> createHTMLVector() {
        ...
        if (count>0) {
            for (int i=0 ; i<count; i++) {
                ...
                if (javax.swing.plaf.basic.BasicHTML.isHTMLString(title)) {
