    ...
    extends ScrollPaneUI implements ScrollPaneConstants
{
    ...
    protected void installKeyboardActions(JScrollPane c) {
        ...
        javax.swing.plaf.basic.LazyActionMap.installLazyActionMap(c, BasicScrollPaneUI.class,
            ...
            if (scrollpane.isWheelScrollingEnabled() &&
                ...
                if (e.getScrollType() == MouseWheelEvent.WHEEL_UNIT_SCROLL) {
                    ...
                    if (Boolean.TRUE == fastWheelScroll &&
                        ...
                        javax.swing.plaf.basic.BasicScrollBarUI.scrollByUnits(toScroll, direction,
                                                       units, limitScroll);
                    }
                }
