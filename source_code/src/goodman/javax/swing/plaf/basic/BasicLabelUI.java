...
public class BasicLabelUI extends LabelUI implements  PropertyChangeListener
{
    ...
    */
    ...
    public int getBaseline(JComponent c, int width, int height) {
        ...
        return javax.swing.plaf.basic.BasicHTML.getBaseline(label, paintTextR.y, fm.getAscent(),
    ...
    public Component.BaselineResizeBehavior getBaselineResizeBehavior(
        ...
        if (c.getClientProperty(javax.swing.plaf.basic.BasicHTML.propertyKey) != null) {
    ...
    protected void installComponents(JLabel c){
        javax.swing.plaf.basic.BasicHTML.updateRenderer(c, c.getText());
    ...
    protected void uninstallComponents(JLabel c){
        javax.swing.plaf.basic.BasicHTML.updateRenderer(c, "");
    }
