...
import goodman.java.text.Collator;
...
import goodman.javax.swing.RowFilter;
import goodman.javax.swing.RowSorter;
import goodman.javax.swing.SortOrder;
...
public abstract class DefaultRowSorter<M, I> extends RowSorter<M> {
     ...
     */
    private javax.swing.RowFilter<? super M,? super I> filter;
    ...
    private javax.swing.RowFilter.Entry<M,I> getFilterEntry(int modelIndex) {
        if (filterEntry == null) {
    ...
    private boolean include(int row) {
        javax.swing.RowFilter<? super M, ? super I> filter = getRowFilter();
        if (filter != null) {
     ...
     * @see javax.swing.RowFilter.Entry
     */
