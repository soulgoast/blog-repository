...
public abstract class RowFilter<M,I> {
    ...
    private static abstract class GeneralFilter extends RowFilter<Object,Object> {
        ...
        public boolean include(javax.swing.RowFilter.Entry<? extends Object,? extends Object> value){
        ...
        protected abstract boolean include(
                javax.swing.RowFilter.Entry<? extends Object,? extends Object> value, int index);
    }
    ...
    private static class DateFilter extends GeneralFilter {
        private long date;
        private javax.swing.RowFilter.ComparisonType type;

        DateFilter(javax.swing.RowFilter.ComparisonType type, long date, int[] columns) {
            super(columns);
            if (type == null) {
    ...
    private static class NumberFilter extends GeneralFilter {
        ...
        NumberFilter(javax.swing.RowFilter.ComparisonType type, Number number, int[] columns) {
            super(columns);
    ...
    private static class OrFilter<M,I> extends RowFilter<M,I> {
        ...
        public boolean include(javax.swing.RowFilter.Entry<? extends M, ? extends I> value) {
            for (RowFilter<? super M,? super I> filter : filters) {
