...
public class GroupLayout implements LayoutManager2 {
    ...
    private void invalidateHost() {
        if (host instanceof javax.swing.JComponent) {
            ((javax.swing.JComponent)host).revalidate();
        } else {
            host.invalidate();
        }
        host.repaint();
    ...
    public class SequentialGroup extends Group {
         ...
         * @see LayoutStyle
         */
        public SequentialGroup addPreferredGap(javax.swing.JComponent comp1,
                                               javax.swing.JComponent comp2, ComponentPlacement type) {
         ...
         */
        public SequentialGroup addPreferredGap(javax.swing.JComponent comp1,
                                               javax.swing.JComponent comp2, ComponentPlacement type, int pref,
                                               int max) {
            if (type == null) {
    ...
    private class PreferredGapSpring extends Spring {
        ...
        private final javax.swing.JComponent target;
        private final ComponentPlacement type;
        private final int pref;
        private final int max;

        PreferredGapSpring(javax.swing.JComponent source, javax.swing.JComponent target,
    ...
    private class AutoPreferredGapSpring extends Spring {
        ...
        private int calculatePadding(LayoutStyle p, int position,
            ...
            if (delta >= 0) {
                int padding;
                if ((source.getComponent() instanceof javax.swing.JComponent) &&
                        (target.getComponent() instanceof javax.swing.JComponent)) {
                    padding = p.getPreferredGap(
                            (javax.swing.JComponent)source.getComponent(),
                            (javax.swing.JComponent)target.getComponent(), type, position,
                            host);
                } else {
                    padding = 10;
                }
    ...
    private class ContainerAutoPreferredGapSpring extends
        ...
        public void calculatePadding(int axis) {
            ...
            if (targets != null) {
                ...
                for (int i = targets.size() - 1; i >= 0; i--) {
                    ...
                    int padding = 10;
                    if (targetSpring.getComponent() instanceof javax.swing.JComponent) {
                        padding = p.getContainerGap(
                                (javax.swing.JComponent)targetSpring.getComponent(),
                                position, host);
        ...
        private int updateSize(LayoutStyle p, ComponentSpring sourceSpring,
                int position) {
            int padding = 10;
            if (sourceSpring.getComponent() instanceof javax.swing.JComponent) {
                padding = p.getContainerGap(
