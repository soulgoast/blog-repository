 ...
 */
package goodman.javax.xml.crypto.dsig;

import goodman.javax.xml.crypto.Data;
import goodman.javax.xml.crypto.MarshalException;
import goodman.javax.xml.crypto.NoSuchMechanismException;
import goodman.javax.xml.crypto.URIDereferencer;
import goodman.javax.xml.crypto.XMLStructure;
import goodman.javax.xml.crypto.dom.DOMStructure;
import goodman.javax.xml.crypto.dsig.CanonicalizationMethod;
import goodman.javax.xml.crypto.dsig.DigestMethod;
import goodman.javax.xml.crypto.dsig.Manifest;
import goodman.javax.xml.crypto.dsig.Reference;
import goodman.javax.xml.crypto.dsig.SignatureMethod;
import goodman.javax.xml.crypto.dsig.SignatureProperties;
import goodman.javax.xml.crypto.dsig.SignatureProperty;
import goodman.javax.xml.crypto.dsig.SignedInfo;
import goodman.javax.xml.crypto.dsig.Transform;
import goodman.javax.xml.crypto.dsig.XMLObject;
import goodman.javax.xml.crypto.dsig.XMLSignContext;
import goodman.javax.xml.crypto.dsig.XMLSignature;
import goodman.javax.xml.crypto.dsig.XMLValidateContext;
import goodman.javax.xml.crypto.dsig.keyinfo.KeyInfo;
import goodman.javax.xml.crypto.dsig.keyinfo.KeyInfoFactory;
import goodman.javax.xml.crypto.dsig.spec.*;
import goodman.javax.xml.crypto.dsig.dom.DOMValidateContext;
import goodman.javax.xml.crypto.dsig.dom.DOMSignContext;

import goodman.java.security.InvalidAlgorithmParameterException;
import goodman.java.security.NoSuchAlgorithmException;
import goodman.java.security.NoSuchProviderException;
import goodman.java.security.Provider;
import goodman.java.security.Security;
...
/**
 * A factory for creating {@link javax.xml.crypto.dsig.XMLSignature} objects from scratch or
 ...
 * {@link javax.xml.crypto.dsig.Reference} instance may be created by invoking one of the
 ...
 * {@link javax.xml.crypto.dsig.XMLValidateContext} instance containing the XML content:
 *
 * <pre>
 ...
 * {@link javax.xml.crypto.dsig.XMLSignature#sign sign} method of the
 * {@link javax.xml.crypto.dsig.XMLSignature} object and passing it a mechanism-specific
...
public abstract class XMLSignatureFactory {
     ...
     */
    public abstract javax.xml.crypto.dsig.XMLSignature newXMLSignature(javax.xml.crypto.dsig.SignedInfo si, KeyInfo ki);
     ...
     * @param si the signed info
     * @param ki the key info (may be <code>null</code>)
     * @param objects a list of {@link javax.xml.crypto.dsig.XMLObject}s (may be empty or
     *    <code>null</code>)
     ...
     */
    public abstract javax.xml.crypto.dsig.Reference newReference(String uri, javax.xml.crypto.dsig.DigestMethod dm);
     ...
     * @param uri the reference URI (may be <code>null</code>)
     * @param dm the digest method
     * @param transforms a list of {@link javax.xml.crypto.dsig.Transform}s. The list is defensively
     ...
     * @param uri the reference URI (may be <code>null</code>)
     * @param dm the digest method
     * @param appliedTransforms a list of {@link javax.xml.crypto.dsig.Transform}s that have
     ...
     * @param transforms a list of {@link javax.xml.crypto.dsig.Transform}s that are to be applied
     ...
     * @param references a list of one or more {@link javax.xml.crypto.dsig.Reference}s. The list is
     ...
     */
    @SuppressWarnings("rawtypes")
    public abstract javax.xml.crypto.dsig.SignedInfo newSignedInfo(CanonicalizationMethod cm,
                                                                   javax.xml.crypto.dsig.SignatureMethod sm, List references);
    ...
    public abstract SignedInfo newSignedInfo(CanonicalizationMethod cm,
                                             javax.xml.crypto.dsig.SignatureMethod sm, List references, String id);
     ...
     * list of {@link javax.xml.crypto.dsig.Reference}s.
     *
     ...
     *    entries that are not of type {@link javax.xml.crypto.dsig.Reference}
     */
    @SuppressWarnings("rawtypes")
    public abstract javax.xml.crypto.dsig.Manifest newManifest(List references);

    /**
     * Creates a <code>Manifest</code> containing the specified
     * list of {@link javax.xml.crypto.dsig.Reference}s and optional id.
     *
     * @param references a list of one or more <code>Reference</code>s. The list
     *    is defensively copied to protect against subsequent modification.
     * @param id the id (may be <code>null</code>)
     ...
     * list of {@link javax.xml.crypto.dsig.SignatureProperty}s and optional id.
     *
     ...
     *    <code>null</code>
     */
    public abstract javax.xml.crypto.dsig.Transform newTransform(String algorithm,
     ...
     */
    public abstract javax.xml.crypto.dsig.XMLSignature unmarshalXMLSignature
