 ...
 */
package goodman.javax.xml.crypto.dsig.spec;
...
import goodman.javax.xml.crypto.dsig.spec.TransformParameterSpec;
import goodman.javax.xml.crypto.dsig.spec.XPathFilterParameterSpec;
import goodman.javax.xml.crypto.dsig.spec.XPathType;

/**
 * Parameters for the W3C Recommendation
 * <a href="http://www.w3.org/TR/xmldsig-filter2/">
 * XPath Filter 2.0 Transform Algorithm</a>.
 * The parameters include a list of one or more {@link javax.xml.crypto.dsig.spec.XPathType} objects.
 *
 * @author Sean Mullan
...
public final class XPathFilter2ParameterSpec implements TransformParameterSpec {
    ...
    private final List<javax.xml.crypto.dsig.spec.XPathType> xPathList;

    /**
     * Creates an <code>XPathFilter2ParameterSpec</code>.
     *
     * @param xPathList a list of one or more {@link javax.xml.crypto.dsig.spec.XPathType} objects. The
     *    list is defensively copied to protect against subsequent modification.
     * @throws ClassCastException if <code>xPathList</code> contains any
     *    entries that are not of type {@link javax.xml.crypto.dsig.spec.XPathType}
    ...
    public XPathFilter2ParameterSpec(List xPathList) {
        ...
        for (int i = 0; i < size; i++) {
            if (!(xPathListCopy.get(i) instanceof javax.xml.crypto.dsig.spec.XPathType)) {
        ...
        List<javax.xml.crypto.dsig.spec.XPathType> temp = (List<javax.xml.crypto.dsig.spec.XPathType>)xPathListCopy;
