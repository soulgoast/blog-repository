 ...
 */
package goodman.javax.xml.crypto.dsig.keyinfo;

import goodman.java.math.BigInteger;
import goodman.java.security.KeyException;
...
import goodman.java.security.cert.X509CRL;
...
import goodman.javax.xml.crypto.dsig.*;
import goodman.javax.xml.crypto.dsig.keyinfo.*;
import goodman.javax.xml.crypto.dsig.keyinfo.KeyInfo;
import goodman.javax.xml.crypto.dsig.keyinfo.KeyName;
import goodman.javax.xml.crypto.dsig.keyinfo.KeyValue;
import goodman.javax.xml.crypto.dsig.keyinfo.PGPData;
import goodman.javax.xml.crypto.dsig.keyinfo.X509Data;

import sun.security.jca.*;
import sun.security.jca.GetInstance.Instance;

/**
 * A factory for creating {@link javax.xml.crypto.dsig.keyinfo.KeyInfo} objects from scratch or for
...
public abstract class KeyInfoFactory {
    ...
    public abstract javax.xml.crypto.dsig.keyinfo.KeyInfo newKeyInfo(List content);
     ...
     */
    @SuppressWarnings("rawtypes")
    public abstract javax.xml.crypto.dsig.keyinfo.KeyInfo newKeyInfo(List content, String id);
     ...
     */
    @SuppressWarnings("rawtypes")
    public abstract javax.xml.crypto.dsig.keyinfo.PGPData newPGPData(byte[] keyId, byte[] keyPacket,
                                                                     List other);
