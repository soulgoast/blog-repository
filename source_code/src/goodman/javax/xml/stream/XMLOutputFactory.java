...
import goodman.javax.xml.stream.FactoryConfigurationError;
import goodman.javax.xml.stream.FactoryFinder;
import goodman.javax.xml.stream.XMLEventWriter;
import goodman.javax.xml.stream.XMLInputFactory;
import goodman.javax.xml.stream.XMLStreamException;
import goodman.javax.xml.stream.XMLStreamWriter;
...
public abstract class XMLOutputFactory {
  ...
  {
    return javax.xml.stream.FactoryFinder.find(XMLOutputFactory.class, DEFAULIMPL);
  }
  ...
  public static XMLOutputFactory newFactory(String factoryId,
          ...
          throws FactoryConfigurationError {
      //do not fallback if given classloader can't find the class, throw exception
      return javax.xml.stream.FactoryFinder.find(XMLOutputFactory.class, factoryId, classLoader, null);
  }
   ...
   */
  public abstract javax.xml.stream.XMLStreamWriter createXMLStreamWriter(java.io.Writer stream) throws XMLStreamException;
   ...
   * @throws XMLStreamException
   */
  public abstract javax.xml.stream.XMLStreamWriter createXMLStreamWriter(java.io.OutputStream stream) throws XMLStreamException;
   ...
   * @throws XMLStreamException
   */
  public abstract javax.xml.stream.XMLEventWriter createXMLEventWriter(Result result) throws XMLStreamException;
   ...
   * @throws XMLStreamException
   */
  public abstract javax.xml.stream.XMLEventWriter createXMLEventWriter(java.io.OutputStream stream) throws XMLStreamException;
