...
package goodman.javax.xml.stream;

import goodman.javax.xml.stream.*;
import goodman.javax.xml.stream.EventFilter;
import goodman.javax.xml.stream.FactoryFinder;
import goodman.javax.xml.stream.StreamFilter;
import goodman.javax.xml.stream.XMLEventReader;
import goodman.javax.xml.stream.XMLReporter;
import goodman.javax.xml.stream.XMLResolver;
import goodman.javax.xml.stream.util.XMLEventAllocator;
 ...
 * @see XMLStreamReader
 * @see javax.xml.stream.EventFilter
 * @see javax.xml.stream.XMLReporter
 * @see javax.xml.stream.XMLResolver
...
public abstract class XMLInputFactory {
  ...
  {
    return javax.xml.stream.FactoryFinder.find(XMLInputFactory.class, DEFAULIMPL);
  }
  ...
  public static XMLInputFactory newInstance(String factoryId,
      ...
      return javax.xml.stream.FactoryFinder.find(XMLInputFactory.class, factoryId, classLoader, null);
  }
   ...
   * @throws XMLStreamException
   */
  public abstract javax.xml.stream.XMLEventReader createXMLEventReader(String systemId, java.io.Reader reader)
    throws XMLStreamException;
   ...
   * @throws XMLStreamException
   */
  public abstract javax.xml.stream.XMLEventReader createXMLEventReader(XMLStreamReader reader)
    throws XMLStreamException;
   ...
   * supported by this XMLInputFactory
   */
  public abstract javax.xml.stream.XMLEventReader createXMLEventReader(Source source)
    throws XMLStreamException;
   ...
   * @throws XMLStreamException
   */
  public abstract javax.xml.stream.XMLEventReader createXMLEventReader(java.io.InputStream stream, String encoding)
    throws XMLStreamException;
   ...
   * @throws XMLStreamException
   */
  public abstract javax.xml.stream.XMLEventReader createXMLEventReader(String systemId, java.io.InputStream stream)
    throws XMLStreamException;
   ...
   * @throws XMLStreamException
   */
  public abstract javax.xml.stream.XMLEventReader createFilteredReader(XMLEventReader reader, EventFilter filter)
    throws XMLStreamException;
