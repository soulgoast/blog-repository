...
import goodman.javax.xml.soap.SOAPConnection;
 ...
 * SAAJ communication infrastructure. Otherwise {@link javax.xml.soap.SOAPConnection} objects
...
public abstract class SOAPConnectionFactory {
    ...
    public static SOAPConnectionFactory newInstance()
        throws javax.xml.soap.SOAPException, UnsupportedOperationException
    {
        try {
        return (SOAPConnectionFactory)
                javax.xml.soap.FactoryFinder.find(SF_PROPERTY,
                                   DEFAULT_SOAP_CONNECTION_FACTORY);
        } catch (Exception ex) {
            throw new javax.xml.soap.SOAPException("Unable to create SOAP connection factory: "
                                    +ex.getMessage());
        }
    }
     ...
     *
     * @exception javax.xml.soap.SOAPException if there was an exception creating the
