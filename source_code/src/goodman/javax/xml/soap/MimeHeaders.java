...
import goodman.javax.xml.soap.AttachmentPart;
import goodman.javax.xml.soap.MimeHeader;
    ...
    */
    ...
    public String[] getHeader(String name) {
        ...
        for(int i = 0; i < headers.size(); i++) {
            javax.xml.soap.MimeHeader hdr = (javax.xml.soap.MimeHeader) headers.elementAt(i);
    ...
    public void setHeader(String name, String value)
    {
        ...
        for(int i = 0; i < headers.size(); i++) {
            ...
            if (hdr.getName().equalsIgnoreCase(name)) {
                if (!found) {
                    headers.setElementAt(new javax.xml.soap.MimeHeader(hdr.getName(),
                                                        value), i);
                    found = true;
                }
                else
    ...
    public void addHeader(String name, String value)
    {
        ...
        for(int i = pos - 1 ; i >= 0; i--) {
            javax.xml.soap.MimeHeader hdr = (javax.xml.soap.MimeHeader) headers.elementAt(i);
            if (hdr.getName().equalsIgnoreCase(name)) {
                headers.insertElementAt(new javax.xml.soap.MimeHeader(name, value),
                                        i+1);
                return;
            }
        }
        headers.addElement(new javax.xml.soap.MimeHeader(name, value));
    }
    ...
    class MatchingIterator implements Iterator {
        ...
        next:
            while (iterator.hasNext()) {
                javax.xml.soap.MimeHeader hdr = (MimeHeader) iterator.next();
