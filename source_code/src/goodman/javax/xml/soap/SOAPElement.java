...
import goodman.javax.xml.soap.Node;
...
public interface SOAPElement extends javax.xml.soap.Node, org.w3c.dom.Element {
     ...
     */
    public SOAPElement addChildElement(javax.xml.soap.Name name) throws SOAPException;
     ...
     * @exception SOAPException if there is an error in creating the
     *                          <code>SOAPElement</code> object
     * @see SOAPElement#addChildElement(javax.xml.soap.Name)
     * @since SAAJ 1.3
     */
     ...
     */
    public SOAPElement addAttribute(javax.xml.soap.Name name, String value)
        throws SOAPException;
     ...
     * @see SOAPElement#addAttribute(javax.xml.soap.Name, String)
     * @since SAAJ 1.3
     */
   ...
   /**
     ...
     * @return <code>true</code> if the attribute was
     *         removed successfully; <code>false</code> if it was not
     * @see SOAPElement#removeAttribute(javax.xml.soap.Name)
     * @since SAAJ 1.3
     */
     ...
     * {@link javax.xml.soap.Node}s of this element. This includes <code>javax.xml.soap.Text</code>
    ...
    /**
     * Returns an <code>Iterator</code> over all the immediate child
     * {@link javax.xml.soap.Node}s of this element with the specified name. All of these
