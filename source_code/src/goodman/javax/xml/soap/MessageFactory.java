...
import goodman.javax.xml.soap.FactoryFinder;
import goodman.javax.xml.soap.MimeHeaders;
import goodman.javax.xml.soap.SAAJMetaFactory;
import goodman.javax.xml.soap.SOAPConstants;
import goodman.javax.xml.soap.SOAPException;
import goodman.javax.xml.soap.SOAPMessage;
...
public abstract class MessageFactory {
     ...
     *
     * @exception javax.xml.soap.SOAPException if there was an error in creating the
     *            default implementation of the
     *            <code>MessageFactory</code>.
     * @see SAAJMetaFactory
     */

    public static MessageFactory newInstance() throws javax.xml.soap.SOAPException {


        try {
            MessageFactory factory = (MessageFactory) javax.xml.soap.FactoryFinder.find(
     ...
     * @since SAAJ 1.3
     */
    public static MessageFactory newInstance(String protocol) throws javax.xml.soap.SOAPException {
     ...
     * @exception javax.xml.soap.SOAPException if a SOAP error occurs
     ...
     *            the input stream
     *
     * @exception javax.xml.soap.SOAPException may be thrown if the message is invalid
     *
