...
import goodman.javax.activation.DataHandler;
...
public abstract class AttachmentPart {
     ...
     * @exception javax.xml.soap.SOAPException if the content of this attachment is
     ...
     *         object
     *
     * @exception javax.xml.soap.SOAPException if there is no content set into this
     *            <code>AttachmentPart</code> object or if there was a data
     *            transformation error
     */
    public abstract Object getContent() throws javax.xml.soap.SOAPException;
     ...
     *
     * @throws javax.xml.soap.SOAPException if there is no content set into this
     *      <code>AttachmentPart</code> object or if there was a data
     *      transformation error.
     *
     * @since SAAJ 1.3
     ...
     */
    public abstract InputStream getRawContent() throws javax.xml.soap.SOAPException;
     ...
     * @since SAAJ 1.3
     */
    public abstract InputStream getBase64Content() throws javax.xml.soap.SOAPException;
     ...
     * header
     *
     * @exception javax.xml.soap.SOAPException if an there is an error in setting the content
     * @exception NullPointerException if <code>content</code> is null
     * @since SAAJ 1.3
     */
    public abstract void setRawContent(InputStream content, String contentType) throws javax.xml.soap.SOAPException;
    ...
    public abstract void setBase64Content(
        InputStream content, String contentType) throws javax.xml.soap.SOAPException;
     ...
     *
     * @exception javax.xml.soap.SOAPException if there is no data in
