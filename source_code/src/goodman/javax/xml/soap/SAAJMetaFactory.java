...
public abstract class SAAJMetaFactory {
     ...
     * @exception javax.xml.soap.SOAPException if there is an error in creating the <code>SAAJMetaFactory</code>
     */
    static SAAJMetaFactory getInstance() throws javax.xml.soap.SOAPException {
            try {
                SAAJMetaFactory instance =
                    (SAAJMetaFactory) javax.xml.soap.FactoryFinder.find(
