...
import goodman.javax.xml.bind.*;
import goodman.javax.xml.bind.JAXBContext;
import goodman.javax.xml.bind.JAXBElement;
import goodman.javax.xml.bind.Marshaller;
import goodman.javax.xml.bind.Validator;
import goodman.javax.xml.bind.annotation.adapters.XmlAdapter;
import goodman.javax.xml.bind.attachment.AttachmentUnmarshaller;
import goodman.javax.xml.validation.Schema;
 ...
 * These unmarshal methods utilize {@link javax.xml.bind.JAXBContext}'s mapping of global XML element
 * declarations and type definitions to JAXB mapped classes to initiate the
 * unmarshalling of the root element of  XML data.  When the {@link javax.xml.bind.JAXBContext}'s
 ...
 * {@link javax.xml.bind.JAXBContext} to unmarshal the root element of an XML data. The {@link javax.xml.bind.JAXBContext}
 * instance is the one that was used to create this <tt>Unmarshaller</tt>. The {@link javax.xml.bind.JAXBContext}
 * instance maintains a mapping of globally declared XML element and type definition names to
 * JAXB mapped classes. The unmarshal method checks if {@link javax.xml.bind.JAXBContext} has a mapping
 ...
 * using that JAXB mapped class as the value of a {@link javax.xml.bind.JAXBElement}.
 * When the {@link javax.xml.bind.JAXBContext} object does not have a mapping for the root element's name
 ...
 * there is no mapping in {@link javax.xml.bind.JAXBContext} of the root element's XML name.
 ...
 * Note that even when the root element's element name is mapped by {@link javax.xml.bind.JAXBContext},
 ...
 * to a JAXB mapped class by {@link javax.xml.bind.JAXBContext}, that the root
 ...
 * by JAXB 1.0 binding compiler is registered with {@link javax.xml.bind.JAXBContext},
