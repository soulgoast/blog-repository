...
import goodman.javax.xml.bind.GetPropertyAction;
import goodman.javax.xml.bind.JAXBContext;
import goodman.javax.xml.bind.JAXBException;
import goodman.javax.xml.bind.Messages;
...
import goodman.java.util.logging.ConsoleHandler;
import goodman.java.util.logging.Level;
import goodman.java.util.logging.Logger;
...
class ContextFinder {
     ...
     */
    static javax.xml.bind.JAXBContext newInstance(String contextPath,
                                                  String className,
        ...
        throws JAXBException
    {
        try {
            ...
            if(!(context instanceof javax.xml.bind.JAXBContext)) {
                // the cast would fail, so generate an exception with a nice message
                throw handleClassCastException(context.getClass(), javax.xml.bind.JAXBContext.class);
            }
            return (javax.xml.bind.JAXBContext)context;
     ...
     */
    static javax.xml.bind.JAXBContext newInstance(
                              Class[] classes,
                              Map properties,
    ...
    static javax.xml.bind.JAXBContext newInstance(Class[] classes,
                                                  Map properties,
    ...
    static javax.xml.bind.JAXBContext find(String factoryId, String contextPath, ClassLoader classLoader, Map properties ) throws JAXBException {

        // TODO: do we want/need another layer of searching in $java.home/lib/jaxb.properties like JAXP?

        final String jaxbContextFQCN = javax.xml.bind.JAXBContext.class.getName();
        ...
        factoryClassName = AccessController.doPrivileged(new GetPropertyAction(javax.xml.bind.JAXBContext.JAXB_CONTEXT_FACTORY));
    ...
    static javax.xml.bind.JAXBContext find(Class[] classes, Map properties ) throws JAXBException {
        ...
        // search for a system property second (javax.xml.bind.JAXBContext)
        logger.log(Level.FINE, "Checking system property {0}", javax.xml.bind.JAXBContext.JAXB_CONTEXT_FACTORY);
        factoryClassName = AccessController.doPrivileged(new GetPropertyAction(javax.xml.bind.JAXBContext.JAXB_CONTEXT_FACTORY));
        if (factoryClassName != null) {
