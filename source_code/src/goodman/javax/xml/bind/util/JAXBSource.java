...
package goodman.javax.xml.bind.util;
...
import goodman.javax.xml.bind.util.Messages;
...
public class JAXBSource extends SAXSource {
    ...
    public JAXBSource( JAXBContext context, Object contentObject )
        ...
        this(
            ( context == null ) ?
                assertionFailed( javax.xml.bind.util.Messages.format( javax.xml.bind.util.Messages.SOURCE_NULL_CONTEXT ) ) :
                context.createMarshaller(),

            ( contentObject == null ) ?
                assertionFailed( javax.xml.bind.util.Messages.format( javax.xml.bind.util.Messages.SOURCE_NULL_CONTENT ) ) :
                contentObject);
    }
    ...
    public JAXBSource( Marshaller marshaller, Object contentObject )
        ...
        if( marshaller == null )
            throw new JAXBException(
                javax.xml.bind.util.Messages.format( javax.xml.bind.util.Messages.SOURCE_NULL_MARSHALLER ) );

        if( contentObject == null )
            throw new JAXBException(
                javax.xml.bind.util.Messages.format( javax.xml.bind.util.Messages.SOURCE_NULL_CONTENT ) );
