...
import goodman.javax.xml.ws.Dispatch;
import goodman.javax.xml.ws.Endpoint;
...
import goodman.javax.xml.ws.soap.AddressingFeature;
 ...
 *  extension if there is a corresponding {@link javax.xml.ws.WebServiceFeature} or annotation.
 ...
 *  {@link javax.xml.ws.WebServiceException} no sooner than when one of the methods
