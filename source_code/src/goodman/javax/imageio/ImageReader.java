...
public abstract class ImageReader {
     ...
     * @exception IOException if an error occurs during reading.
     */
    public javax.imageio.IIOImage readAll(int imageIndex, ImageReadParam param)
        throws IOException {
        ...
        return new javax.imageio.IIOImage(im, thumbnails, metadata);
    }
     ...
     */
    public Iterator<javax.imageio.IIOImage>
        ...
        throws IOException
    {
        ...
        while (true) {
            ...
            IIOMetadata metadata = getImageMetadata(imageIndex);
            javax.imageio.IIOImage im = new IIOImage(bi, thumbnails, metadata);
            output.add(im);
