...
import goodman.javax.imageio.ImageTranscoder;
...
public abstract class ImageWriter implements ImageTranscoder {
     ...
     * @exception IOException if an error occurs during writing.
     */
    public void write(javax.imageio.IIOImage image) throws IOException {
    ...
    public void write(RenderedImage image) throws IOException {
        write(null, new javax.imageio.IIOImage(image, null, null), null);
    }
     ...
     * @exception IOException if an error occurs during writing.
     */
    public void writeToSequence(javax.imageio.IIOImage image, ImageWriteParam param)
        throws IOException {
        unsupported();
    }
    ...
    public void addIIOWriteWarningListener(IIOWriteWarningListener listener) {
        ...
        warningListeners = javax.imageio.ImageReader.addToList(warningListeners, listener);
        warningLocales = javax.imageio.ImageReader.addToList(warningLocales, getLocale());
    }
    ...
    public void
        ...
        progressListeners = javax.imageio.ImageReader.addToList(progressListeners, listener);
    }
