...
import goodman.javax.print.attribute.PrintJobAttribute;
import goodman.javax.print.attribute.standard.JobState;
import goodman.javax.print.attribute.standard.JobStateReason;
 ...
 * i.e., information that augments the value of the job's {@link javax.print.attribute.standard.JobState
 * JobState} attribute.
 * <P>
 * Instances of {@link javax.print.attribute.standard.JobStateReason JobStateReason} do not appear in a Print
 ...
 * one, or more than one {@link javax.print.attribute.standard.JobStateReason JobStateReason} objects which
 * pertain to the Print Job's status. The printer adds a {@link javax.print.attribute.standard.JobStateReason
 ...
 * removes the {@link javax.print.attribute.standard.JobStateReason JobStateReason} object again when the
 ...
 * mutable; you can add {@link javax.print.attribute.standard.JobStateReason JobStateReason} objects to an
 ...
 * javax.print.attribute.standard.JobStateReason JobStateReason} object's <CODE>toString()</CODE> method gives
...
public final class JobStateReasons
    extends HashSet<javax.print.attribute.standard.JobStateReason> implements PrintJobAttribute {
     ...
     * {@link javax.print.attribute.standard.JobStateReason JobStateReason} objects as the given collection.
     ...
     *     javax.print.attribute.standard.JobStateReason JobStateReason}.
     */
   public JobStateReasons(Collection<javax.print.attribute.standard.JobStateReason> collection) {
       super (collection);
   }
     ...
     * {@link javax.print.attribute.standard.JobStateReason JobStateReason}. If this job state reasons
     ...
     *     instance of class {@link javax.print.attribute.standard.JobStateReason JobStateReason}.
     * @since 1.5
     */
