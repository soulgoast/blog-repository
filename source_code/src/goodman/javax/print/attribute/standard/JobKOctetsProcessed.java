 ...
 * javax.print.attribute.standard.JobKOctets JobKOctets} attribute. For implementations where multiple copies
 * are produced by the interpreter by processing the data for each copy, the
 * final value must be a multiple of the value of the {@link javax.print.attribute.standard.JobKOctets
