 ...
 * inherits its implementation from class {@link javax.print.attribute.HashAttributeSet
 * HashAttributeSet} and enforces the semantic restrictions of interface {@link
 * javax.print.attribute.DocAttributeSet DocAttributeSet}.
 * <P>
 *
...
public class HashDocAttributeSet extends HashAttributeSet
    ...
    public HashDocAttributeSet() {
        super (javax.print.attribute.DocAttribute.class);
    }
    ...
    public HashDocAttributeSet(javax.print.attribute.DocAttribute attribute) {
        super (attribute, javax.print.attribute.DocAttribute.class);
    }
    ...
    public HashDocAttributeSet(javax.print.attribute.DocAttribute[] attributes) {
        super (attributes, javax.print.attribute.DocAttribute.class);
    }
