 ...
 * javax.print.attribute.PrintJobAttribute PrintJobAttribute}. In the Print Service API, a
 * service uses a PrintJobAttributeSet to report the status of a print job.
 * <P>
 * A PrintJobAttributeSet is just an {@link javax.print.attribute.AttributeSet AttributeSet} whose
 ...
 * instances of interface {@link javax.print.attribute.PrintJobAttribute PrintJobAttribute}.
 * The {@link #add(javax.print.attribute.Attribute) add(Attribute)}, and
 * {@link #addAll(javax.print.attribute.AttributeSet) >addAll(AttributeSet)} operations
...
public interface PrintJobAttributeSet extends javax.print.attribute.AttributeSet {
     ...
     *     {@link javax.print.attribute.PrintJobAttribute PrintJobAttribute}.
