...
import goodman.javax.print.DocFlavor;
import goodman.javax.print.MultiDocPrintService;
import goodman.javax.print.PrintService;
import goodman.javax.print.StreamPrintService;
...
public abstract class PrintServiceLookup {
    ...
    public static final javax.print.PrintService[]
        lookupPrintServices(javax.print.DocFlavor flavor,
                            AttributeSet attributes) {
        ArrayList list = getServices(flavor, attributes);
        return (javax.print.PrintService[])(list.toArray(new javax.print.PrintService[list.size()]));
    }
    ...
    public static final MultiDocPrintService[]
        lookupMultiDocPrintServices(javax.print.DocFlavor[] flavors,
                                    AttributeSet attributes) {
    ...
    public static final javax.print.PrintService lookupDefaultPrintService() {
        ...
        while (psIterator.hasNext()) {
            try {
                ...
                javax.print.PrintService service = lus.getDefaultPrintService();
                if (service != null) {
                    return service;
                }
            } catch (Exception e) {
    ...
    */
    public abstract javax.print.PrintService[] getPrintServices(javax.print.DocFlavor flavor,
                                                                AttributeSet attributes);
    ...
    */
    public abstract MultiDocPrintService[]
        getMultiDocPrintServices(javax.print.DocFlavor[] flavors,
                                 AttributeSet attributes);
    ...
    private static ArrayList getServices(javax.print.DocFlavor flavor,
                                         AttributeSet attributes) {
        ...
        while (psIterator.hasNext()) {
            try {
                PrintServiceLookup lus = (PrintServiceLookup)psIterator.next();
                javax.print.PrintService[] services=null;
        ...
        if (registeredServices != null) {
            javax.print.PrintService[] services = (javax.print.PrintService[])
                registeredServices.toArray(
                           new javax.print.PrintService[registeredServices.size()]);
            for (int i=0; i<services.length; i++) {
