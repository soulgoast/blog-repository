...
import goodman.javax.management.relation.RoleUnresolvedList;
...
public class RoleResult implements Serializable {
    ...
    {
      new ObjectStreamField("myRoleList", javax.management.relation.RoleList.class),
    ...
    {
      new ObjectStreamField("roleList", javax.management.relation.RoleList.class),
     ...
     */
    private javax.management.relation.RoleList roleList = null;
     ...
     * descriptions).
     */
    public RoleResult(javax.management.relation.RoleList list,
    ...
    public void setRoles(javax.management.relation.RoleList list) {
        if (list != null) {
            ...
            roleList = new javax.management.relation.RoleList();

            for (Iterator<?> roleIter = list.iterator();
                 roleIter.hasNext();) {
                javax.management.relation.Role currRole = (javax.management.relation.Role)(roleIter.next());
