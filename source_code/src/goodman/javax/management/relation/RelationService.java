...
import goodman.java.util.concurrent.atomic.AtomicLong;
import goodman.java.util.logging.Level;

import goodman.javax.management.Attribute;
import goodman.javax.management.AttributeNotFoundException;
import goodman.javax.management.InstanceNotFoundException;
import goodman.javax.management.InvalidAttributeValueException;
import goodman.javax.management.MBeanException;
import goodman.javax.management.MBeanNotificationInfo;
import goodman.javax.management.MBeanRegistration;
import goodman.javax.management.MBeanServer;
import goodman.javax.management.MBeanServerDelegate;
import goodman.javax.management.MBeanServerNotification;
import goodman.javax.management.Notification;
import goodman.javax.management.NotificationBroadcasterSupport;
import goodman.javax.management.NotificationListener;
import goodman.javax.management.ObjectName;
import goodman.javax.management.ReflectionException;
import goodman.javax.management.relation.*;
import goodman.javax.management.relation.RelationType;
import goodman.javax.management.relation.Role;
import goodman.javax.management.relation.RoleInfo;
import goodman.javax.management.relation.RoleList;
import goodman.javax.management.relation.RoleResult;
import goodman.javax.management.relation.RoleStatus;
...
public class RelationService extends NotificationBroadcasterSupport
    ...
    private Map<String, javax.management.relation.RelationType> myRelType2ObjMap =
        new HashMap<String, javax.management.relation.RelationType>();
    ...
    public void createRelationType(String relationTypeName,
        ...
        javax.management.relation.RelationType relType =
     ...
     * {@link javax.management.relation.RelationType#getRelationTypeName
    ...
    public void addRelationType(javax.management.relation.RelationType relationTypeObj)
        ...
        List<javax.management.relation.RoleInfo> roleInfoList = relationTypeObj.getRoleInfos();
        if (roleInfoList == null) {
            String excMsg = "No role info provided.";
            throw new InvalidRelationTypeException(excMsg);
        }

        javax.management.relation.RoleInfo[] roleInfoArray = new javax.management.relation.RoleInfo[roleInfoList.size()];
        int i = 0;
        for (javax.management.relation.RoleInfo currRoleInfo : roleInfoList) {
    ...
    public List<javax.management.relation.RoleInfo> getRoleInfos(String relationTypeName)
        ...
        javax.management.relation.RelationType relType = getRelationType(relationTypeName);
     ...
     * relation type.
     */
    public javax.management.relation.RoleInfo getRoleInfo(String relationTypeName,
                                                          String roleInfoName)
        throws IllegalArgumentException,
               RelationTypeNotFoundException,
        ...
        javax.management.relation.RoleInfo roleInfo = relType.getRoleInfo(roleInfoName);
    ...
    public void addRelation(ObjectName relationObjectName)
        ...
        javax.management.relation.RoleList roleList;
        try {
            roleList = (javax.management.relation.RoleList)(myMBeanServer.invoke(relationObjectName,
                                                       "retrieveAllRoles",
                                                       null,
                                                       null));
        } catch (MBeanException exc1) {
    ...
    public Integer checkRoleReading(String roleName,
        ...
        try {
            ...
            javax.management.relation.RoleInfo roleInfo = relType.getRoleInfo(roleName);
            ...
            result = Integer.valueOf(javax.management.relation.RoleStatus.NO_ROLE_WITH_NAME);
        }
     ...
     */
    public Integer checkRoleWriting(javax.management.relation.Role role,
                                    String relationTypeName,
                                    Boolean initFlag)
        throws IllegalArgumentException,
               RelationTypeNotFoundException {
        ...
        try {
            ...
            RELATION_LOGGER.exiting(RelationService.class.getName(),
                    "checkRoleWriting");
            return Integer.valueOf(javax.management.relation.RoleStatus.NO_ROLE_WITH_NAME);
        }
    ...
    public void sendRoleUpdateNotification(String relationId,
        ...
        // Message
        String newRoleValString = javax.management.relation.Role.roleValueToString(newRoleVal);
        String oldRoleValString = javax.management.relation.Role.roleValueToString(oldValue);
     ...
     * @see #setRoles
     */
    public javax.management.relation.RoleResult getRoles(String relationId,
        ...
        javax.management.relation.RoleResult result;
        ...
        if (relObj instanceof RelationSupport) {
            ...
            // or MBeanException
            try {
                result = (javax.management.relation.RoleResult)
                    (myMBeanServer.invoke(((ObjectName)relObj),
                                          "getRoles",
                                          params,
                                          signature));
     ...
     * Service is not registered in the MBean Server
     */
    public javax.management.relation.RoleResult getAllRoles(String relationId)
        throws IllegalArgumentException,
               RelationNotFoundException,
               RelationServiceNotRegisteredException {
     ...
     * @see #getRoles
     */
    public javax.management.relation.RoleResult setRoles(String relationId,
                                                         javax.management.relation.RoleList roleList)
        throws RelationServiceNotRegisteredException,
               IllegalArgumentException,
               RelationNotFoundException {
    ...
    //  type with that name
    private void addRelationTypeInt(javax.management.relation.RelationType relationTypeObj)
        throws IllegalArgumentException,
               InvalidRelationTypeException {
        ...
        try {
            ...
            javax.management.relation.RelationType relType = getRelationType(relTypeName);
    ...
    //
    javax.management.relation.RelationType getRelationType(String relationTypeName)
        throws IllegalArgumentException,
               RelationTypeNotFoundException {
...
//              }
    ...
    private void addRelationInt(boolean relationBaseFlag,
        ...
        List<javax.management.relation.RoleInfo> roleInfoList = new ArrayList<javax.management.relation.RoleInfo>(relType.getRoleInfos());

        if (roleList != null) {

            for (javax.management.relation.Role currRole : roleList.asList()) {
    ...
    private Integer checkRoleInt(int chkType,
        ...
        if (chkType == 1) {
            ...
            if (!isReadable) {
                RELATION_LOGGER.exiting(RelationService.class.getName(),
                        "checkRoleInt");
                return Integer.valueOf(javax.management.relation.RoleStatus.ROLE_NOT_READABLE);
            } else {
                // End of check :)
                RELATION_LOGGER.exiting(RelationService.class.getName(),
                        "checkRoleInt");
        ...
        if (writeChkFlag) {
            ...
            if (!isWritable) {
                RELATION_LOGGER.exiting(RelationService.class.getName(),
                        "checkRoleInt");
                return new Integer(javax.management.relation.RoleStatus.ROLE_NOT_WRITABLE);
            }
        }
        ...
        if (!chkMinFlag) {
            RELATION_LOGGER.exiting(RelationService.class.getName(),
                    "checkRoleInt");
            return new Integer(javax.management.relation.RoleStatus.LESS_THAN_MIN_ROLE_DEGREE);
        }
        ...
        if (!chkMaxFlag) {
            RELATION_LOGGER.exiting(RelationService.class.getName(),
                    "checkRoleInt");
            return new Integer(javax.management.relation.RoleStatus.MORE_THAN_MAX_ROLE_DEGREE);
        }
        ...
        for (ObjectName currObjName : roleValue) {
            ...
            if (currObjName == null) {
                RELATION_LOGGER.exiting(RelationService.class.getName(),
                        "checkRoleInt");
                return new Integer(javax.management.relation.RoleStatus.REF_MBEAN_NOT_REGISTERED);
            }
            ...
            try {
                ...
                if (!classSts) {
                    RELATION_LOGGER.exiting(RelationService.class.getName(),
                            "checkRoleInt");
                    return new Integer(javax.management.relation.RoleStatus.REF_MBEAN_OF_INCORRECT_CLASS);
                }
    ...
    private void initializeMissingRoles(boolean relationBaseFlag,
                                        ...
                                        String relationId,
                                        String relationTypeName,
                                        List<javax.management.relation.RoleInfo> roleInfoList)
        throws IllegalArgumentException,
               RelationServiceNotRegisteredException,
               InvalidRoleValueException {
        ...
        for (javax.management.relation.RoleInfo currRoleInfo : roleInfoList) {
            ...
            // Creates a role
            javax.management.relation.Role role = new Role(roleName, emptyValue);
    ...
    static void throwRoleProblemException(int pbType,
        ...
        switch (pbType) {
        case javax.management.relation.RoleStatus.NO_ROLE_WITH_NAME:
            excMsgPart = " does not exist in relation.";
            excType = 1;
            break;
        case javax.management.relation.RoleStatus.ROLE_NOT_READABLE:
            excMsgPart = " is not readable.";
            excType = 1;
            break;
        case javax.management.relation.RoleStatus.ROLE_NOT_WRITABLE:
            excMsgPart = " is not writable.";
            excType = 1;
            break;
        case javax.management.relation.RoleStatus.LESS_THAN_MIN_ROLE_DEGREE:
            excMsgPart = " has a number of MBean references less than the expected minimum degree.";
            excType = 2;
            break;
        case javax.management.relation.RoleStatus.MORE_THAN_MAX_ROLE_DEGREE:
            excMsgPart = " has a number of MBean references greater than the expected maximum degree.";
            excType = 2;
            break;
        case javax.management.relation.RoleStatus.REF_MBEAN_OF_INCORRECT_CLASS:
