...
public class RoleUnresolvedList extends ArrayList<Object> {
     ...
     */
    public RoleUnresolvedList(List<javax.management.relation.RoleUnresolved> list)
    ...
    public List<javax.management.relation.RoleUnresolved> asList() {
        if (!typeSafe) {
            if (tainted)
                checkTypeSafe(this);
            typeSafe = true;
    ...
    private static void checkTypeSafe(Object o) {
        try {
            o = (javax.management.relation.RoleUnresolved) o;
    ...
    private static void checkTypeSafe(Collection<?> c) {
        try {
            javax.management.relation.RoleUnresolved r;
            for (Object o : c)
                r = (RoleUnresolved) o;
        } catch (ClassCastException e) {
            throw new IllegalArgumentException(e);
