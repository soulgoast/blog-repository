...
import goodman.javax.management.relation.InvalidRelationTypeException;
...
public class RelationTypeSupport implements RelationType {
     ...
     *              &lt;role name ({@link String})&gt; -&gt; &lt;role info ({@link javax.management.relation.RoleInfo} object)&gt;
     ...
     *           &lt;role name ({@link String})&gt; -&gt; &lt;role info ({@link javax.management.relation.RoleInfo} object)&gt;
     */
    private Map<String, javax.management.relation.RoleInfo> roleName2InfoMap =
        new HashMap<String, javax.management.relation.RoleInfo>();
    ...
    public List<javax.management.relation.RoleInfo> getRoleInfos() {
        return new ArrayList<javax.management.relation.RoleInfo>(roleName2InfoMap.values());
    }
     ...
     * relation type.
     */
    public javax.management.relation.RoleInfo getRoleInfo(String roleInfoName)
        throws IllegalArgumentException,
        ...
        javax.management.relation.RoleInfo result = roleName2InfoMap.get(roleInfoName);
    ...
    protected void addRoleInfo(javax.management.relation.RoleInfo roleInfo)
        ...
        roleName2InfoMap.put(roleName, new javax.management.relation.RoleInfo(roleInfo));
    ...
    private void initMembers(String relationTypeName,
        ...
        for (int i = 0; i < roleInfoArray.length; i++) {
            javax.management.relation.RoleInfo currRoleInfo = roleInfoArray[i];
            roleName2InfoMap.put(currRoleInfo.getName(),
                                 new javax.management.relation.RoleInfo(currRoleInfo));
        }
    ...
    //  - no role info provided
    //  - one null role info provided
    static void checkRoleInfos(javax.management.relation.RoleInfo[] roleInfoArray)
        throws IllegalArgumentException,
               InvalidRelationTypeException {
