...
public class RoleList extends ArrayList<Object> {
     ...
     */
    public RoleList(List<javax.management.relation.Role> list) throws IllegalArgumentException {
    ...
    public List<javax.management.relation.Role> asList() {
        if (!typeSafe) {
            if (tainted)
                checkTypeSafe(this);
            typeSafe = true;
    ...
    private static void checkTypeSafe(Object o) {
        try {
            o = (javax.management.relation.Role) o;
    ...
    private static void checkTypeSafe(Collection<?> c) {
        try {
            javax.management.relation.Role r;
            for (Object o : c)
                r = (Role) o;
        } catch (ClassCastException e) {
            throw new IllegalArgumentException(e);
