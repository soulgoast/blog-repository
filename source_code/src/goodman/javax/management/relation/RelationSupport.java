...
import goodman.javax.management.relation.RelationService;
...
import goodman.javax.management.relation.RoleUnresolved;
...
public class RelationSupport
    ...
    private final Map<String, javax.management.relation.Role> myRoleName2ValueMap = new HashMap<String, javax.management.relation.Role>();
     ...
     * @see #setRoles
     */
    public javax.management.relation.RoleResult getRoles(String[] roleNameArray)
        throws IllegalArgumentException,
               RelationServiceNotRegisteredException {
        ...
        javax.management.relation.RoleResult result = getRolesInt(roleNameArray, false, null);
    ...
    public javax.management.relation.RoleResult getAllRoles()
        ...
        javax.management.relation.RoleResult result = null;
        try {
    ...
    public javax.management.relation.RoleList retrieveAllRoles() {
        ...
        javax.management.relation.RoleList result;
        synchronized(myRoleName2ValueMap) {
            result =
                new javax.management.relation.RoleList(new ArrayList<javax.management.relation.Role>(myRoleName2ValueMap.values()));
        }
    ...
    public Integer getRoleCardinality(String roleName)
        ...
        if (role == null) {
            int pbType = javax.management.relation.RoleStatus.NO_ROLE_WITH_NAME;
            // Will throw a RoleNotFoundException
            //
            // Will not throw InvalidRoleValueException, so catch it for the
            // compiler
            try {
                javax.management.relation.RelationService.throwRoleProblemException(pbType,
                                                          roleName);
    ...
    public javax.management.relation.RoleResult setRoles(javax.management.relation.RoleList list)
        ...
        javax.management.relation.RoleResult result = setRolesInt(list, false, null);
    ...
    public Map<ObjectName,List<String>> getReferencedMBeans() {
        ...
        synchronized(myRoleName2ValueMap) {
            ...
            for (javax.management.relation.Role currRole : myRoleName2ValueMap.values()) {
    ...
    Object getRoleInt(String roleName,
                      ...
                      javax.management.relation.RelationService relationServ,
        ...
        if (pbType == 0) {
            ...
            if (!(multiRoleFlg)) {
                ...
                // role
                result = (javax.management.relation.Role)(role.clone());
            }
            ...
            if (!(multiRoleFlg)) {
                ...
                result = new javax.management.relation.RoleUnresolved(roleName, null, pbType);
            }
        }
    ...
    // -exception RelationServiceNotRegisteredException  if the Relation
    //  Service is not registered in the MBean Server
    javax.management.relation.RoleResult getRolesInt(String[] roleNameArray,
                                                     boolean relationServCallFlg,
                                                     javax.management.relation.RelationService relationServ)
        throws IllegalArgumentException,
               RelationServiceNotRegisteredException {
        ...
        javax.management.relation.RoleList roleList = new javax.management.relation.RoleList();
        ...
        for (int i = 0; i < roleNameArray.length; i++) {
            ...
            if (currResult instanceof javax.management.relation.Role) {
                // Can throw IllegalArgumentException if role is null
                // (normally should not happen :(
                try {
                    roleList.add((javax.management.relation.Role)currResult);
                } catch (IllegalArgumentException exc) {
                    throw new RuntimeException(exc.getMessage());
                }

            } else if (currResult instanceof javax.management.relation.RoleUnresolved) {
                // Can throw IllegalArgumentException if role is null
                // (normally should not happen :(
                try {
                    roleUnresList.add((javax.management.relation.RoleUnresolved)currResult);
                } catch (IllegalArgumentException exc) {
                    throw new RuntimeException(exc.getMessage());
                }
            }
        ...
        javax.management.relation.RoleResult result = new javax.management.relation.RoleResult(roleList, roleUnresList);
        RELATION_LOGGER.exiting(RelationSupport.class.getName(),
                "getRolesInt");
        return result;
    }
    ...
    //  Service is not registered in the MBean Server
    //
    javax.management.relation.RoleResult getAllRolesInt(boolean relationServCallFlg,
                                                        javax.management.relation.RelationService relationServ)
        throws IllegalArgumentException,
               RelationServiceNotRegisteredException {
        ...
        javax.management.relation.RoleResult result = getRolesInt(roleNames,
                                        relationServCallFlg,
                                        relationServ);
    ...
    //  added in the Relation Service
    Object setRoleInt(javax.management.relation.Role aRole,
                      boolean relationServCallFlg,
                      javax.management.relation.RelationService relationServ,
                      boolean multiRoleFlg)
        throws IllegalArgumentException,
        ...
        if (pbType == 0) {
            ...
            synchronized(myRoleName2ValueMap) {
                myRoleName2ValueMap.put(roleName,
                                        (javax.management.relation.Role)(aRole.clone()));
            }
            ...
            if (!(multiRoleFlg)) {
                ...
                // Problem when retrieving a role in a multi-role retrieval:
                // returns a RoleUnresolved object
                result = new javax.management.relation.RoleUnresolved(roleName,
                                            aRole.getRoleValue(),
                                            pbType);
            }
        }
    ...
    private void sendRoleUpdateNotification(javax.management.relation.Role newRole,
                                            List<ObjectName> oldRoleValue,
                                            boolean relationServCallFlg,
                                            javax.management.relation.RelationService relationServ)
        throws IllegalArgumentException,
    ...
    private void updateRelationServiceMap(javax.management.relation.Role newRole,
                                          List<ObjectName> oldRoleValue,
                                          boolean relationServCallFlg,
                                          javax.management.relation.RelationService relationServ)
        throws IllegalArgumentException,
    ...
    // and
    // - not added in the RS
    javax.management.relation.RoleResult setRolesInt(javax.management.relation.RoleList list,
                                                     boolean relationServCallFlg,
                                                     javax.management.relation.RelationService relationServ)
        throws IllegalArgumentException,
               RelationServiceNotRegisteredException,
        ...
        for (javax.management.relation.Role currRole : list.asList()) {
        ...
        javax.management.relation.RoleResult result = new RoleResult(roleList, roleUnresList);
        ...
        synchronized(myRoleName2ValueMap) {
            ...
            for (javax.management.relation.Role currRole : list.asList()) {
                ...
                myRoleName2ValueMap.put(currRoleName,
                                        (javax.management.relation.Role)(currRole.clone()));
            }
        }
    ...
    void handleMBeanUnregistrationInt(ObjectName objectName,
        ...
        javax.management.relation.Role newRole = new Role(roleName, newRoleValue);
