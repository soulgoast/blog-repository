...
public interface MBeanServerConnection {
     ...
     * javax.management.MBeanRegistration#preRegister preRegister} method.</p>
     *
     * <p>This method is equivalent to {@link
     * #createMBean(String, javax.management.ObjectName,Object[],String[])
     ...
     * also be thrown by <CODE>preRegister</CODE>, in which case the MBean
     * will not be registered.
     * @exception javax.management.MBeanException The constructor of the MBean has
     * thrown an exception
     ...
     */
    public javax.management.ObjectInstance createMBean(String className, javax.management.ObjectName name)
            throws javax.management.ReflectionException, InstanceAlreadyExistsException,
                   MBeanRegistrationException, javax.management.MBeanException,
     ...
     *
     * <p>This method is equivalent to {@link
     * #createMBean(String, javax.management.ObjectName, javax.management.ObjectName,Object[],String[])
     ...
     */
    public javax.management.ObjectInstance createMBean(String className, javax.management.ObjectName name,
                                                       javax.management.ObjectName loaderName, Object params[],
                                                       String signature[])
            throws javax.management.ReflectionException, InstanceAlreadyExistsException,
                   MBeanRegistrationException, javax.management.MBeanException,
                   NotCompliantMBeanException, InstanceNotFoundException,
     ...
     * talking to the MBean server.
     */
    public Set<ObjectInstance> queryMBeans(javax.management.ObjectName name, javax.management.QueryExp query)
            throws IOException;
     ...
     * talking to the MBean server.
     */
    public Set<javax.management.ObjectName> queryNames(javax.management.ObjectName name, QueryExp query)
            throws IOException;
     ...
     * @exception javax.management.MBeanException Wraps an exception thrown by the
     * MBean's getter.
     * @exception InstanceNotFoundException The MBean specified is not
     * registered in the MBean server.
     * @exception javax.management.ReflectionException Wraps a
     ...
     * @see #setAttribute
     */
    public Object getAttribute(javax.management.ObjectName name, String attribute)
            throws javax.management.MBeanException, AttributeNotFoundException,
                   InstanceNotFoundException, javax.management.ReflectionException,
                   IOException;
     ...
     * @exception InstanceNotFoundException The MBean specified is not
     * registered in the MBean server.
     * @exception javax.management.ReflectionException An exception occurred when
     ...
     * @see #setAttributes
     */
    public javax.management.AttributeList getAttributes(javax.management.ObjectName name, String[] attributes)
            throws InstanceNotFoundException, javax.management.ReflectionException,
                   IOException;
     ...
     * @see #getAttribute
     */
    public void setAttribute(javax.management.ObjectName name, Attribute attribute)
            throws InstanceNotFoundException, AttributeNotFoundException,
                   InvalidAttributeValueException, javax.management.MBeanException,
            javax.management.ReflectionException, IOException;
    ...
    public javax.management.AttributeList setAttributes(javax.management.ObjectName name,
        ...
        throws InstanceNotFoundException, javax.management.ReflectionException, IOException;
     ...
     * through an {@linkplain JMX#newMBeanProxy(MBeanServerConnection, javax.management.ObjectName,
     ...
     *
     */
    public Object invoke(javax.management.ObjectName name, String operationName,
                         Object params[], String signature[])
     ...
     * {@link javax.management.ObjectName#getDomain() getDomain()} is equal to that
     ...
     * talking to the MBean server.
     *
     * @see #removeNotificationListener(javax.management.ObjectName, javax.management.NotificationListener)
     * @see #removeNotificationListener(javax.management.ObjectName, javax.management.NotificationListener,
     ...
     * talking to the MBean server.
     *
     * @see #removeNotificationListener(javax.management.ObjectName, javax.management.ObjectName)
     * @see #removeNotificationListener(javax.management.ObjectName, javax.management.ObjectName,
     * javax.management.NotificationFilter, Object)
     */
    public void addNotificationListener(javax.management.ObjectName name,
     ...
     * talking to the MBean server.
     *
     * @see #addNotificationListener(javax.management.ObjectName, javax.management.ObjectName,
     * javax.management.NotificationFilter, Object)
     */
     ...
     * talking to the MBean server.
     *
     * @see #addNotificationListener(javax.management.ObjectName, javax.management.NotificationListener,
     * javax.management.NotificationFilter, Object)
     */
    public void removeNotificationListener(javax.management.ObjectName name,
                                           javax.management.NotificationListener listener)
