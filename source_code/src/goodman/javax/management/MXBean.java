...
import goodman.java.lang.management.MemoryUsage;
import goodman.java.lang.reflect.UndeclaredThrowableException;
...
import goodman.javax.management.openmbean.OpenMBeanInfo;
...
MemoryPool<b>MBean</b> proxy =
    JMX.<b>{@link javax.management.JMX#newMBeanProxy(MBeanServerConnection, ObjectName,
...
MemoryPool<b>MXBean</b> proxy =
    JMX.<b>{@link javax.management.JMX#newMXBeanProxy(MBeanServerConnection, ObjectName,
        ...
        <td><pre>
{
    ...
    <p id="reconstructible-def">If there is a way to convert
      ...
      generated by {@link javax.management.JMX#newMXBeanProxy(MBeanServerConnection,
...
public interface ModuleMXBean {
    ...
    <p>If you make an MXBean proxy for a {@code ModuleMXBean} and
      ...
      {@link javax.management.JMX#newMXBeanProxy(MBeanServerConnection, ObjectName,
       Class)
