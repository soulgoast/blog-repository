...
import goodman.javax.management.MBeanFeatureInfo;
...
public class MBeanOperationInfo extends MBeanFeatureInfo implements Cloneable {
    ...
    /** @see javax.management.MBeanInfo#arrayGettersSafe */
    private final transient boolean arrayGettersSafe;


    /**
     * Constructs an <CODE>MBeanOperationInfo</CODE> object.  The
     * {@link javax.management.Descriptor} of the constructed object will include
    ...
    public MBeanOperationInfo(String name,
                              ...
                              String type,
                              int impact) {
        this(name, description, signature, type, impact, (javax.management.Descriptor) null);
    }
