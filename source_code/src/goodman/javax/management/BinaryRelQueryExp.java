...
class BinaryRelQueryExp extends QueryEval implements QueryExp {
     ...
     * v2 values.
     */
    public BinaryRelQueryExp(int op, javax.management.ValueExp v1, javax.management.ValueExp v2) {
        relOp = op;
        exp1  = v1;
        exp2  = v2;
    }
    ...
    public boolean apply(ObjectName name) throws BadStringOperationException, BadBinaryOpValueExpException,
        ...
        if (numeric) {
            if (((javax.management.NumericValueExp)val1).isLong()) {
                ...
                switch (relOp) {
                case javax.management.Query.GT:
                    return lval1 > lval2;
                case javax.management.Query.LT:
                    return lval1 < lval2;
                case javax.management.Query.GE:
                    return lval1 >= lval2;
                case javax.management.Query.LE:
                    return lval1 <= lval2;
                case javax.management.Query.EQ:
                    return lval1 == lval2;
                }
            } else {
