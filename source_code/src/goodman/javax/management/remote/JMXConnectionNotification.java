 ...
 * sent by connector servers (instances of {@link javax.management.remote.JMXConnectorServer})
 * and by connector clients (instances of {@link javax.management.remote.JMXConnector}).  For
