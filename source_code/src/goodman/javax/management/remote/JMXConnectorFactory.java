...
package goodman.javax.management.remote;
...
import goodman.javax.management.remote.JMXProviderException;
 ...
 * #connect(javax.management.remote.JMXServiceURL) connect} method of this class.  More
 * advanced applications can separate the creation of the connector
 * client, using {@link #newJMXConnector(javax.management.remote.JMXServiceURL, Map)
 * newJMXConnector} and the establishment of the connection itself, using
 * {@link javax.management.remote.JMXConnector#connect(Map)}.</p>
 *
 * <p>Each client is created by an instance of {@link
 * JMXConnectorProvider}.  This instance is found as follows.  Suppose
 * the given {@link javax.management.remote.JMXServiceURL} looks like
 ...
 * #newJMXConnector(javax.management.remote.JMXServiceURL, Map) newJMXConnector} contains the
 ...
 * JMXConnectorProvider#newJMXConnector(javax.management.remote.JMXServiceURL,Map) newJMXConnector}
 * on the provider.</p>
 *
 ...
 * #newJMXConnector(javax.management.remote.JMXServiceURL,Map)
...
public class JMXConnectorFactory {
     ...
     * #connect(javax.management.remote.JMXServiceURL,Map) connect(serviceURL, null)}.</p>
     *
     * @param serviceURL the address of the connector server to
     * connect to.
     *
     * @return a <code>JMXConnector</code> whose {@link
     * javax.management.remote.JMXConnector#connect connect} method has been called.
     *
    ...
    public static javax.management.remote.JMXConnector connect(javax.management.remote.JMXServiceURL serviceURL,
        ...
        javax.management.remote.JMXConnector conn = newJMXConnector(serviceURL, environment);
        conn.connect(environment);
        return conn;
    }
     ...
     * {@link javax.management.remote.JMXConnector#connect(Map) connect} method is called.</p>
     *
     * @param serviceURL the address of the connector server to connect to.
     *
     * @param environment a set of attributes to determine how the
     ...
     * some reason.
     */
    public static javax.management.remote.JMXConnector newJMXConnector(javax.management.remote.JMXServiceURL serviceURL,
                                                                       Map<String,?> environment)
            throws IOException {
        ...
        final javax.management.remote.JMXServiceURL providerURL = serviceURL;
        ...
        if (provider == null) {
            ...
            if (loader != null) {
                try {
                    javax.management.remote.JMXConnector connection =
    ...
    static <T> T getProvider(javax.management.remote.JMXServiceURL serviceURL,
    ...
    private static javax.management.remote.JMXConnector getConnectorAsService(ClassLoader loader,
                                                                              JMXServiceURL url,
                                                                              Map<String, ?> map)
        throws IOException {
