...
import goodman.java.rmi.server.UnicastRemoteObject;
...
/**
 * <p>An {@link javax.management.remote.rmi.RMIServer} object that is exported through JRMP and that
...
public class RMIJRMPServerImpl extends RMIServerImpl {
    ...
    /**
     * <p>Creates a new {@link javax.management.remote.rmi.RMIServer} object that will be exported
     * on the given port using the given socket factories.</p>
     *
     * @param port the port on which this object and the {@link
     * javax.management.remote.rmi.RMIConnectionImpl} objects it creates will be exported.  Can be
     ...
     *
     * @exception IOException if the {@link javax.management.remote.rmi.RMIServer} object
     * cannot be created.
     *
    ...
    /**
     * <p>Returns a serializable stub for this {@link javax.management.remote.rmi.RMIServer} object.</p>
     *
     ...
     * {@link javax.management.remote.rmi.RMIConnection} object are the ones supplied
     ...
     *
     * @exception IOException if the new {@link javax.management.remote.rmi.RMIConnection}
    ...
    private static class ExportedWrapper implements javax.management.remote.rmi.RMIServer, DeserializationChecker {
        private final javax.management.remote.rmi.RMIServer impl;
