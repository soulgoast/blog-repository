...
import goodman.java.io.NotSerializableException;
import goodman.java.io.ObjectInputStream;
import goodman.java.io.ObjectStreamClass;
...
import goodman.java.rmi.MarshalException;
import goodman.java.rmi.MarshalledObject;
import goodman.java.rmi.NoSuchObjectException;
import goodman.java.rmi.Remote;
import goodman.java.rmi.ServerException;
import goodman.java.rmi.UnmarshalException;
import goodman.java.rmi.server.RMIClientSocketFactory;
import goodman.java.rmi.server.RemoteObject;
import goodman.java.rmi.server.RemoteObjectInvocationHandler;
import goodman.java.rmi.server.RemoteRef;
...
import goodman.java.security.ProtectionDomain;
...
import goodman.java.util.stream.Collectors;
import goodman.javax.management.Attribute;
import goodman.javax.management.AttributeList;
import goodman.javax.management.AttributeNotFoundException;
import goodman.javax.management.InstanceAlreadyExistsException;
import goodman.javax.management.InstanceNotFoundException;
import goodman.javax.management.IntrospectionException;
import goodman.javax.management.InvalidAttributeValueException;
import goodman.javax.management.ListenerNotFoundException;
import goodman.javax.management.MBeanException;
import goodman.javax.management.MBeanInfo;
import goodman.javax.management.MBeanRegistrationException;
import goodman.javax.management.MBeanServerConnection;
...
import goodman.javax.management.NotificationFilter;
import goodman.javax.management.NotificationFilterSupport;
import goodman.javax.management.NotificationListener;
import goodman.javax.management.ObjectInstance;
...
import goodman.javax.management.remote.JMXConnectionNotification;
import goodman.javax.management.remote.JMXConnector;
import goodman.javax.management.remote.JMXConnectorFactory;
import goodman.javax.management.remote.JMXServiceURL;
import goodman.javax.management.remote.NotificationResult;
import goodman.javax.management.remote.JMXAddressable;
import goodman.javax.management.remote.rmi.NoCallStackClassLoader;
import goodman.javax.management.remote.rmi.RMIConnection;
import goodman.javax.management.remote.rmi.RMIConnectorServer;
import goodman.javax.management.remote.rmi.RMIServer;
import goodman.javax.naming.InitialContext;
import goodman.javax.naming.NamingException;
import goodman.javax.rmi.ssl.SslRMIClientSocketFactory;
 ...
 * example with an {@link javax.management.remote.rmi.RMIServer} stub obtained without going
 * through JNDI.</p>
 *
 * @since 1.5
 */
public class RMIConnector implements JMXConnector, Serializable, JMXAddressable {
    ...
    private RMIConnector(javax.management.remote.rmi.RMIServer rmiServer, JMXServiceURL address,
     ...
     * is null.
     */
    public RMIConnector(javax.management.remote.rmi.RMIServer rmiServer, Map<String,?> environment) {
    ...
    throws IOException {
        ...
        try {
            ...
            javax.management.remote.rmi.RMIServer stub = (rmiServer!=null)?rmiServer:
    ...
    private class RMIClientCommunicatorAdmin extends ClientCommunicatorAdmin {
        ...
        protected void doStart() throws IOException {
            // Get RMIServer stub from directory or URL encoding if needed.
            javax.management.remote.rmi.RMIServer stub;
            try {
     ...
     **/
    static javax.management.remote.rmi.RMIServer connectStub(javax.management.remote.rmi.RMIServer rmiServer,
                                                             Map<String, ?> environment)
        throws IOException {
     ...
     * @see #RMIConnector(javax.management.remote.rmi.RMIServer,Map)
     **/
    ...
    private javax.management.remote.rmi.RMIServer findRMIServer(JMXServiceURL directoryURL,
     ...
     **/
    private javax.management.remote.rmi.RMIServer findRMIServerJNDI(String jndiURL, Map<String, ?> env,
                                                                    boolean isIiop)
    ...
    private static javax.management.remote.rmi.RMIServer narrowJRMPServer(Object objref) {

        return (javax.management.remote.rmi.RMIServer) objref;
    }

    private static javax.management.remote.rmi.RMIServer narrowIIOPServer(Object objref) {
        try {
            return IIOPHelper.narrow(objref, javax.management.remote.rmi.RMIServer.class);
    ...
    private javax.management.remote.rmi.RMIServer findRMIServerIIOP(String ior, Map<String, ?> env, boolean isIiop) {
        ...
        return IIOPHelper.narrow(stub, javax.management.remote.rmi.RMIServer.class);
    }

    private javax.management.remote.rmi.RMIServer findRMIServerJRMP(String base64, Map<String, ?> env, boolean isIiop)
        throws IOException {
        ...
        return (javax.management.remote.rmi.RMIServer)stub;
    }
    ...
    private static final String rmiServerImplStubClassName =
        javax.management.remote.rmi.RMIServer.class.getName() + "Impl_Stub";
  ...
  private static RMIConnection shadowIiopStub(Object stub)
    ...
    private static RMIConnection getConnection(javax.management.remote.rmi.RMIServer server,
                                               Object credentials,
                                               boolean checkStub)
            throws IOException {
