...
import goodman.java.rmi.server.RemoteServer;
import goodman.java.rmi.server.ServerNotActiveException;
...
import goodman.javax.management.remote.JMXAuthenticator;
...
public abstract class RMIServerImpl implements Closeable, RMIServer {
     ...
     * #close()} method, the {@link javax.management.remote.rmi.RMIConnection#close() close()}
     ...
     * is null.
     */
    public javax.management.remote.rmi.RMIConnection newClient(Object credentials) throws IOException {
     ...
     */
    javax.management.remote.rmi.RMIConnection doNewClient(Object credentials) throws IOException {
        ...
        javax.management.remote.rmi.RMIConnection client = makeClient(connectionId, subject);

        dropDeadReferences();
        WeakReference<javax.management.remote.rmi.RMIConnection> wr = new WeakReference<javax.management.remote.rmi.RMIConnection>(client);
     ...
     * created or exported.
     */
    protected abstract javax.management.remote.rmi.RMIConnection makeClient(String connectionId,
                                                                            Subject subject)
            throws IOException;
     ...
     * called when the resultant object's {@link javax.management.remote.rmi.RMIConnection#close()
     ...
     */
    protected void clientClosed(javax.management.remote.rmi.RMIConnection client) throws IOException {
        ...
        synchronized (clientList) {
            dropDeadReferences();
            for (Iterator<WeakReference<javax.management.remote.rmi.RMIConnection>> it = clientList.iterator();
                 it.hasNext(); ) {
                WeakReference<javax.management.remote.rmi.RMIConnection> wr = it.next();
                if (wr.get() == client) {
                    it.remove();
                    break;
                }
     ...
     * javax.management.remote.rmi.RMIConnection} object returned by {@link #makeClient
     * makeClient}, its {@link javax.management.remote.rmi.RMIConnection#close() close} method is
     * called.</p>
     *
     ...
     * {@link javax.management.remote.rmi.RMIConnection#close()} calls threw
        ...
        while (true) {
            synchronized (clientList) {
                ...
                for (Iterator<WeakReference<javax.management.remote.rmi.RMIConnection>> it = clientList.iterator();
                     it.hasNext(); ) {
                    WeakReference<javax.management.remote.rmi.RMIConnection> wr = it.next();
                    javax.management.remote.rmi.RMIConnection client = wr.get();
                    it.remove();
                    if (client != null) {
                        try {
                            client.close();
    ...
    private final List<WeakReference<javax.management.remote.rmi.RMIConnection>> clientList =
