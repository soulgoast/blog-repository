 ...
 * #newJMXConnectorServer(javax.management.remote.JMXServiceURL,Map,MBeanServer)
 ...
 * javax.management.remote.JMXProviderException} is thrown.</p>
 *
 ...
 * {@link javax.management.remote.JMXProviderException} whose {@link
 * javax.management.remote.JMXProviderException#getCause() <em>cause</em>} indicates the
 ...
 * {@link
 * JMXConnectorServerProvider#newJMXConnectorServer(javax.management.remote.JMXServiceURL,
...
public class JMXConnectorServerFactory {
    ...
    public static final String DEFAULT_CLASS_LOADER =
        javax.management.remote.JMXConnectorFactory.DEFAULT_CLASS_LOADER;
    ...
    private static javax.management.remote.JMXConnectorServer
        ...
        while (providers.hasNext()) {
            ...
            } catch (javax.management.remote.JMXProviderException e) {
                throw e;
            } catch (Exception e) {
                if (logger.traceOn())
     ...
     * javax.management.remote.JMXConnectorServer#start() start} method is called.</p>
     *
     ...
     * {@link javax.management.remote.JMXConnectorServer#getAddress() getAddress} method, will
     ...
     *
     * @exception javax.management.remote.JMXProviderException if there is a provider for the
    ...
    public static javax.management.remote.JMXConnectorServer
        ...
        final ClassLoader loader =
            javax.management.remote.JMXConnectorFactory.resolveClassLoader(envcopy);
        final String protocol = serviceURL.getProtocol();
        final String providerClassName = "ServerProvider";

        JMXConnectorServerProvider provider =
            javax.management.remote.JMXConnectorFactory.getProvider(serviceURL,
                                            envcopy,
                                            providerClassName,
                                            targetInterface,
                                            loader);
        ...
        if (provider == null) {
            ...
            provider =
                javax.management.remote.JMXConnectorFactory.getProvider(
                    protocol,
