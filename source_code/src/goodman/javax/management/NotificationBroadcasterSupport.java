...
public class NotificationBroadcasterSupport implements NotificationEmitter {
     ...
     * javax.management.MBeanNotificationInfo[] info) NotificationBroadcasterSupport(null, null)}.
     */
    public NotificationBroadcasterSupport() {
        this(null, (javax.management.MBeanNotificationInfo[]) null);
    }
     ...
     * {@link javax.management.NotificationFilter}, or if {@link javax.management.NotificationFilter#isNotificationEnabled
     ...
     * {@link NotificationBroadcasterSupport#NotificationBroadcasterSupport(Executor,
     * javax.management.MBeanNotificationInfo[] info) NotificationBroadcasterSupport(executor, null)}.
    ...
    public NotificationBroadcasterSupport(Executor executor) {
        this(executor, (javax.management.MBeanNotificationInfo[]) null);
    }
     ...
     * javax.management.NotificationFilter}, or if {@link
     * javax.management.NotificationFilter#isNotificationEnabled isNotificationEnabled}
    ...
    public void removeNotificationListener(javax.management.NotificationListener listener)
        ...
        if (!removed)
            throw new javax.management.ListenerNotFoundException("Listener not registered");
    }
    ...
    protected void handleNotification(javax.management.NotificationListener listener,
                                      javax.management.Notification notif, Object handback) {
        listener.handleNotification(notif, handback);
    }
    ...
    private static class ListenerInfo {
        ...
        ListenerInfo(javax.management.NotificationListener listener,
    ...
    private class SendNotifJob implements Runnable {
        public SendNotifJob(javax.management.Notification notif, ListenerInfo listenerInfo) {
            this.notif = notif;
