...
import goodman.javax.management.DynamicMBean;
...
import goodman.javax.management.openmbean.OpenMBeanConstructorInfo;
import goodman.javax.management.openmbean.OpenMBeanConstructorInfoSupport;
import goodman.javax.management.openmbean.OpenMBeanOperationInfo;
 ...
 * custom descriptions and names for the {@link javax.management.MBeanInfo} returned by
...
public class StandardMBean implements DynamicMBean, MBeanRegistration {
    ...
    // From the DynamicMBean interface.
    // ------------------------------------------------------------------
    public javax.management.AttributeList setAttributes(AttributeList attributes) {
    ...
    /**
     * Get the {@link javax.management.MBeanInfo} for this MBean.
     * <p>
    ...
    public javax.management.MBeanInfo getMBeanInfo() {
        try {
            final javax.management.MBeanInfo cached = getCachedMBeanInfo();
        ...
        final javax.management.MBeanInfo bi = msupport.getMBeanInfo();
        ...
        final javax.management.Descriptor desc  = getDescriptor(bi, immutableInfo);

        final javax.management.MBeanInfo nmbi = new javax.management.MBeanInfo(
     ...
     * {@link javax.management.MBeanInfo#getClassName() info.getClassName()}.
     ...
     * {@link javax.management.MBeanInfo#getDescription() info.getDescription()}.
     * @param info The default MBeanInfo derived by reflection.
     ...
     **/
    MBeanNotificationInfo[] getNotifications(javax.management.MBeanInfo info) {
        return null;
    }
     ...
     */
    javax.management.Descriptor getDescriptor(javax.management.MBeanInfo info, boolean immutableInfo) {
     ...
     * {@link javax.management.MBeanInfo} object per instance.
     *
     ...
     * sharing a unique {@link javax.management.MBeanInfo} object when several
     * <code>StandardMBean</code> instances have equal {@link
     * javax.management.MBeanInfo} values.
     *
    ...
    private MBeanConstructorInfo[]
            getConstructors(javax.management.MBeanInfo info, Object impl) {
    ...
    // ------------------------------------------------------------------
    private MBeanOperationInfo[] getOperations(javax.management.MBeanInfo info) {
    ...
    // ------------------------------------------------------------------
    private MBeanAttributeInfo[] getAttributes(javax.management.MBeanInfo info) {
     ...
     * <code>registerMBean</code> methods in the {@link javax.management.MBeanServer}
     ...
     * @since 1.6
     */
    public javax.management.ObjectName preRegister(MBeanServer server, ObjectName name)
            throws Exception {
