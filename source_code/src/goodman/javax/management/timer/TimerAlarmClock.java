...
import goodman.javax.management.timer.Timer;
...
class TimerAlarmClock extends java.util.TimerTask {
    ...
    javax.management.timer.Timer listener = null;
    long timeout = 10000;
    Date next = null;
    ...
    public TimerAlarmClock(javax.management.timer.Timer listener, long timeout) {
        this.listener = listener;
        this.timeout = Math.max(0L, timeout);
    }

    public TimerAlarmClock(javax.management.timer.Timer listener, Date next) {
        this.listener = listener;
        this.next = next;
    }
