...
import goodman.javax.management.BooleanValueExp;
...
public class AttributeValueExp implements javax.management.ValueExp {
     ...
     * of this {@link javax.management.ValueExp}.
     */
     ...
     */
    @Override
    public ValueExp apply(javax.management.ObjectName name) throws BadStringOperationException, BadBinaryOpValueExpException,
     ...
     * obtain an attribute value is {@link javax.management.QueryEval#getMBeanServer()}.
     */
     ...
     * javax.management.QueryEval#getMBeanServer()}.</p>
     *
