...
public class AttributeList extends ArrayList<Object> {
     ...
     * @since 1.6
     */
    public AttributeList(List<javax.management.Attribute> list) {
    ...
    public List<javax.management.Attribute> asList() {
        typeSafe = true;
        if (tainted)
            adding((Collection<?>) this);  // will throw IllegalArgumentException
        return (List<javax.management.Attribute>) (List<?>) this;
    }
     ...
     */
    public void add(int index, javax.management.Attribute object)  {
        try {
     ...
     */
    public void set(int index, javax.management.Attribute object)  {
        try {
