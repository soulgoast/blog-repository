 ...
 * documentation for the {@link javax.management.MBeanServer} interface.</p>
 *
 ...
 *
 * <p>For a permission you need, this is the {@link javax.management.ObjectName} of the
 ...
 *
 * <p>For a permission you have, this is the {@link javax.management.ObjectName} of the
 ...
 * javax.management.ObjectName}.  It may contain any legal characters, including
...
public class MBeanPermission extends Permission {
    ...
    private void parseName() {
        ...
        if (openingBracket == -1) {
            ...
            //
            objectName = javax.management.ObjectName.WILDCARD;
        } else {
            if (!name.endsWith("]")) {
                throw new IllegalArgumentException("MBeanPermission: " +
                ...
                try {
                    ...
                    if (on.equals(""))
                        ...
                        objectName = new javax.management.ObjectName(on);
     ...
     * {@link javax.management.ObjectName#equals <i>n1</i>.equals(<i>n2</i>)} or if
