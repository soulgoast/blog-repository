...
import goodman.javax.management.MXBean;
import goodman.javax.management.NotificationBroadcaster;
import goodman.javax.management.NotificationEmitter;
...
import goodman.javax.management.RuntimeErrorException;
import goodman.javax.management.RuntimeMBeanException;
 ...
 *
 * <p>Given an {@link javax.management.MBeanServerConnection}, the {@link javax.management.ObjectName}
 ...
 * javax.management.JMX#newMBeanProxy(javax.management.MBeanServerConnection, javax.management.ObjectName, Class)
 * JMX.newMBeanProxy} or {@link
 * javax.management.JMX#newMXBeanProxy(javax.management.MBeanServerConnection, javax.management.ObjectName, Class)
...
public class MBeanServerInvocationHandler implements InvocationHandler {
     ...
     * {@link #MBeanServerInvocationHandler(javax.management.MBeanServerConnection,
     * javax.management.ObjectName, boolean)} for that.  This constructor is equivalent
     ...
     */
    public MBeanServerInvocationHandler(javax.management.MBeanServerConnection connection,
     ...
     * javax.management.JMX#newMBeanProxy(javax.management.MBeanServerConnection, javax.management.ObjectName, Class)} and
     ...
     * implement {@link javax.management.NotificationEmitter} by forwarding its methods
     * via <code>connection</code>. A call to {@link
     * javax.management.NotificationBroadcaster#addNotificationListener} on the proxy will
     * result in a call to {@link
     * javax.management.MBeanServerConnection#addNotificationListener(javax.management.ObjectName,
     * javax.management.NotificationListener, javax.management.NotificationFilter, Object)}, and likewise
     * for the other methods of {@link javax.management.NotificationBroadcaster} and {@link
     ...
     */
    public static <T> T newProxyInstance(javax.management.MBeanServerConnection connection,
                                         javax.management.ObjectName objectName,
        ...
        try {
            if (isMXBean()) {
                ...
                if (methodName.startsWith("set")
                    ...
                    && nargs == 1
                    && returnType.equals(Void.TYPE)) {
                    javax.management.Attribute attr = new Attribute(methodName.substring(3), args[0]);
    ...
    private Object invokeBroadcasterMethod(Object proxy, Method method,
        ...
        if (methodName.equals("addNotificationListener")) {
            ...
            javax.management.NotificationListener listener = (javax.management.NotificationListener) args[0];
            javax.management.NotificationFilter filter = (javax.management.NotificationFilter) args[1];
            ...
            javax.management.NotificationListener listener = (NotificationListener) args[0];
            ...
            case 3:
                javax.management.NotificationFilter filter = (NotificationFilter) args[1];
                Object handback = args[2];
