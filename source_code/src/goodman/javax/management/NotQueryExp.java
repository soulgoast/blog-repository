 ...
 * @since 1.5
 */
class NotQueryExp extends QueryEval implements javax.management.QueryExp {
    ...
    /**
     * @serial The negated {@link javax.management.QueryExp}
     */
     ...
     */
    public NotQueryExp(javax.management.QueryExp q) {
        exp = q;
    }
