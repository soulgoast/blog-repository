...
public class ArrayType<T> extends javax.management.openmbean.OpenType<T> {
     ...
     * <p>
     * When invoked on an <tt>ArrayType</tt> instance, the {@link javax.management.openmbean.OpenType#getClassName() getClassName} method
    ...
    public ArrayType(int dimension,
                     javax.management.openmbean.OpenType<?> elementType) throws OpenDataException {
    ...
    ArrayType(String className, String typeName, String description,
              int dimension, javax.management.openmbean.OpenType<?> elementType,
     ...
     * by the {@link javax.management.openmbean.OpenType#getClassName() getClassName} method, which
