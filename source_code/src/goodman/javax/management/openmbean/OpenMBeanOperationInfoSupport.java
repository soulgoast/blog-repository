...
public class OpenMBeanOperationInfoSupport
     ...
     *         described by this {@link javax.management.openmbean.OpenMBeanOperationInfo} instance
     *
     */
    ...
    private static MBeanParameterInfo[]
            arrayCopyCast(javax.management.openmbean.OpenMBeanParameterInfo[] src) {
        if (src == null)
            return null;
    ...
    //
    private static javax.management.openmbean.OpenMBeanParameterInfo[]
            arrayCopyCast(MBeanParameterInfo[] src) {
        if (src == null)
            return null;

        javax.management.openmbean.OpenMBeanParameterInfo[] dst = new OpenMBeanParameterInfo[src.length];
        System.arraycopy(src, 0, dst, 0, src.length);
        // may throw an ArrayStoreException
        return dst;
    }
    ...
    public boolean equals(Object obj) {
        ...
        //
        javax.management.openmbean.OpenMBeanOperationInfo other;
        try {
