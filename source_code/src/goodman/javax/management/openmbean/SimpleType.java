...
public final class SimpleType<T> extends javax.management.openmbean.OpenType<T> {
     ...
     * name returned by the {@link javax.management.openmbean.OpenType#getClassName()
     * getClassName} method).
     *
     ...
     * {@link javax.management.openmbean.OpenType#getClassName() getClassName} methods return the same value.
     *
