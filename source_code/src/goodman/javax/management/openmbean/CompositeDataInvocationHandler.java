...
/**
   ...
   {@link javax.management.openmbean.CompositeData}.  If you have an interface that contains
...
public class CompositeDataInvocationHandler implements InvocationHandler {
    ...
    */
    ...
    /**
       ...
       is null.
    */
    CompositeDataInvocationHandler(javax.management.openmbean.CompositeData compositeData,
                                   MXBeanLookup lookup) {
