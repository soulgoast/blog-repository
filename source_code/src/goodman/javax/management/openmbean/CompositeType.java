 ...
 * whose instances describe the types of {@link javax.management.openmbean.CompositeData CompositeData} values.
 *
 *
 * @since 1.5
 */
public class CompositeType extends javax.management.openmbean.OpenType<javax.management.openmbean.CompositeData> {
     ...
     */
    private TreeMap<String, javax.management.openmbean.OpenType<?>> nameToType;
     ...
     * (ie the class name returned by the {@link javax.management.openmbean.OpenType#getClassName() getClassName} method)
    ...
    public CompositeType(String        typeName,
                         ...
                         javax.management.openmbean.OpenType<?>[] itemTypes) throws OpenDataException {

        // Check and construct state defined by parent
        //
        super(javax.management.openmbean.CompositeData.class.getName(), typeName, description, false);
        ...
        nameToType        = new TreeMap<String, javax.management.openmbean.OpenType<?>>();
        String key;
     ...
     * @return the type.
     */
    public javax.management.openmbean.OpenType<?> getType(String itemName) {

        if (itemName == null) {
            return null;
        }
        return (javax.management.openmbean.OpenType<?>) nameToType.get(itemName);
    }
     ...
     * javax.management.openmbean.CompositeData#getCompositeType()}.  The result is true if
     ...
     * javax.management.openmbean.TabularType#getTypeName() typeName} and {@linkplain
     * javax.management.openmbean.TabularType#getIndexNames() index name list}, and the
     ...
     * javax.management.openmbean.ArrayType#getDimension() dimension}; and both are {@linkplain
     * javax.management.openmbean.ArrayType#isPrimitiveArray() primitive arrays} or neither is;
    ...
    public boolean isValue(Object obj) {
        ...
        //
        javax.management.openmbean.CompositeData value = (CompositeData) obj;
    ...
    boolean isAssignableFrom(javax.management.openmbean.OpenType<?> ot) {
        ...
        for (String key : keySet()) {
            javax.management.openmbean.OpenType<?> otItemType = ct.getType(key);
