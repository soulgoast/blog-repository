...
public class CompositeDataSupport
    implements javax.management.openmbean.CompositeData, Serializable {
     ...
     */
    private final javax.management.openmbean.CompositeType compositeType;
     ...
     *
     * @throws javax.management.openmbean.OpenDataException <tt>itemNames[]</tt> or
    ...
    public CompositeDataSupport(
            javax.management.openmbean.CompositeType compositeType, String[] itemNames, Object[] itemValues)
    ...
    private static SortedMap<String, Object> makeMap(
        ...
        for (int i = 0; i < itemNames.length; i++) {
            ...
            if (map.containsKey(name))
                throw new javax.management.openmbean.OpenDataException("Duplicate item name " + name);
     ...
     * or empty string.
     * @throws javax.management.openmbean.OpenDataException <tt>items</tt>' size differs from the
    ...
    private CompositeDataSupport(
            SortedMap<String, Object> items, javax.management.openmbean.CompositeType compositeType)
            throws javax.management.openmbean.OpenDataException {
        ...
        if (!namesFromType.equals(namesFromItems)) {
            ...
            if (!extraFromType.isEmpty() || !extraFromItems.isEmpty()) {
                throw new javax.management.openmbean.OpenDataException(
     ...
     *
     * @throws javax.management.openmbean.InvalidKeyException  if <tt>key</tt> is not an existing item name for
    ...
    public Object get(String key) {
        ...
        if ( ! contents.containsKey(key.trim())) {
            throw new javax.management.openmbean.InvalidKeyException("Argument key=\""+ key.trim() +"\" is not an existing item name for this CompositeData instance.");
        }
    ...
    public boolean equals(Object obj) {
        ...
        javax.management.openmbean.CompositeData other = (CompositeData) obj;
