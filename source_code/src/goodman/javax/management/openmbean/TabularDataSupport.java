...
import goodman.javax.management.openmbean.InvalidKeyException;
import goodman.javax.management.openmbean.InvalidOpenTypeException;
import goodman.javax.management.openmbean.KeyAlreadyExistsException;
...
public class TabularDataSupport
    implements javax.management.openmbean.TabularData, Map<Object,Object>,
    ...
    private Map<Object, javax.management.openmbean.CompositeData> dataMap;

    /**
     * @serial This tabular data instance's tabular type
     */
    private final javax.management.openmbean.TabularType tabularType;
     ...
     */
    public TabularDataSupport(javax.management.openmbean.TabularType tabularType, int initialCapacity, float loadFactor) {
        ...
        this.dataMap = useHashMap ?
            new HashMap<Object, javax.management.openmbean.CompositeData>(initialCapacity, loadFactor) :
            new LinkedHashMap<Object, javax.management.openmbean.CompositeData>(initialCapacity, loadFactor);
    }
     ...
     *                                    row type definition.
     */
    public Object[] calculateIndex(javax.management.openmbean.CompositeData value) {
     ...
     */
    public javax.management.openmbean.CompositeData get(Object[] key) {
     ...
     * @param value the {@link javax.management.openmbean.CompositeData} to put.
     *
    ...
    public Object put(Object key, Object value) {
        internalPut((javax.management.openmbean.CompositeData) value);
    ...
    private javax.management.openmbean.CompositeData internalPut(javax.management.openmbean.CompositeData value) {
     ...
     *                               <tt>TabularType</tt> definition
     */
    public javax.management.openmbean.CompositeData remove(Object[] key) {
    ...
    public void putAll(Map<?,?> t) {
        ...
        try {
            values =
                t.values().toArray(new javax.management.openmbean.CompositeData[t.size()]);
     ...
     * {@link #put(javax.management.openmbean.CompositeData) <tt>put</tt>}, or if any two
    ...
    public Object clone() {
        try {
            ...
            c.dataMap = new HashMap<Object, javax.management.openmbean.CompositeData>(c.dataMap);
            return c;
        }
    ...
    public boolean equals(Object obj) {
        ...
        //
        javax.management.openmbean.TabularData other;
        try {
        ...
        for (javax.management.openmbean.CompositeData value : dataMap.values()) {
   ...
   public int hashCode() {
     ...
     */
    private List<?> internalCalculateIndex(javax.management.openmbean.CompositeData value) {
     ...
     * @throws  InvalidOpenTypeException
     */
    private void checkValueType(javax.management.openmbean.CompositeData value) {
