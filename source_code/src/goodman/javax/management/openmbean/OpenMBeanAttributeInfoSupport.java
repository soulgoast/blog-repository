...
package goodman.javax.management.openmbean;
...
import goodman.javax.management.DescriptorRead;
...
import goodman.javax.management.openmbean.OpenMBeanAttributeInfo;
...
public class OpenMBeanAttributeInfoSupport
     ...
     * null.
     *
     * @throws javax.management.openmbean.OpenDataException if {@code defaultValue} is not a
     ...
     * null.
     *
     * @throws javax.management.openmbean.OpenDataException if {@code defaultValue}, {@code
    ...
    private Object readResolve() {
        if (getDescriptor().getFieldNames().length == 0) {
            javax.management.openmbean.OpenType<Object> xopenType = cast(openType);
    ...
    static void check(javax.management.openmbean.OpenMBeanParameterInfo info) throws javax.management.openmbean.OpenDataException {
        javax.management.openmbean.OpenType<?> openType = info.getOpenType();
        if (openType == null)
        ...
        if (info.hasDefaultValue()) {
            ...
            if (openType.isArray() || (Object)openType instanceof javax.management.openmbean.TabularType) {
                throw new javax.management.openmbean.OpenDataException("Default value not supported " +
            ...
            if (!openType.isValue(info.getDefaultValue())) {
                ...
                throw new javax.management.openmbean.OpenDataException(msg);
            }
        }
        ...
        if (info.hasLegalValues() &&
            ...
            throw new javax.management.openmbean.OpenDataException("cannot have both legalValue and " +
        ...
        if (info.hasDefaultValue()) {
            ...
            if (info.hasLegalValues() &&
                ...
                throw new javax.management.openmbean.OpenDataException("defaultValue is not contained " +
                                            "in legalValues");
            }
            ...
            if (info.hasMinValue()) {
                if (compare(info.getMinValue(), defaultValue) > 0) {
                    throw new javax.management.openmbean.OpenDataException("minValue cannot be greater " +
                                                "than defaultValue");
                }
            }
            if (info.hasMaxValue()) {
                if (compare(info.getMaxValue(), defaultValue) < 0) {
                    throw new javax.management.openmbean.OpenDataException("maxValue cannot be less " +
                                                "than defaultValue");
                }
            }
        }
        ...
        if (info.hasLegalValues()) {
            ...
            if ((Object)openType instanceof TabularType || openType.isArray()) {
                throw new javax.management.openmbean.OpenDataException("Legal values not supported " +
    ...
    static <T> Descriptor makeDescriptor(javax.management.openmbean.OpenType<T> openType,
                                         T defaultValue,
                                         T[] legalValues,
                                         Comparable<T> minValue,
                                         Comparable<T> maxValue) {
    ...
    static <T> T valueFrom(Descriptor d, String name, javax.management.openmbean.OpenType<T> openType) {
    ...
    private static <T> T convertFrom(Object x, javax.management.openmbean.OpenType<T> openType) {
    ...
    private static <T> T convertFromStrings(Object x, javax.management.openmbean.OpenType<T> openType) {
        if (openType instanceof javax.management.openmbean.ArrayType<?>)
    ...
    private static <T> T convertFromString(String s, javax.management.openmbean.OpenType<T> openType) {
        Class<T> c;
        try {
    ...
    private static <T> T convertFromStringArray(Object x,
                                                javax.management.openmbean.OpenType<T> openType) {
        javax.management.openmbean.ArrayType<?> arrayType = (javax.management.openmbean.ArrayType<?>) openType;
        javax.management.openmbean.OpenType<?> baseType = arrayType.getElementOpenType();
        ...
        javax.management.openmbean.OpenType<?> componentOpenType;
        if (dim == 1)
    ...
    static boolean isValue(javax.management.openmbean.OpenMBeanParameterInfo info, Object obj) {
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof javax.management.openmbean.OpenMBeanAttributeInfo))
            return false;

        javax.management.openmbean.OpenMBeanAttributeInfo other = (OpenMBeanAttributeInfo) obj;
    ...
    static boolean equal(javax.management.openmbean.OpenMBeanParameterInfo x1, javax.management.openmbean.OpenMBeanParameterInfo x2) {
    ...
    static int hashCode(javax.management.openmbean.OpenMBeanParameterInfo info) {
        int value = 0;
