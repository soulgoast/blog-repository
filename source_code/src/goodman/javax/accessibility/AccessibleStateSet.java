...
public class AccessibleStateSet {
     ...
     * @see #clear
     */
    protected Vector<javax.accessibility.AccessibleState> states = null;
    ...
    public javax.accessibility.AccessibleState[] toArray() {
        if (states == null) {
            return new javax.accessibility.AccessibleState[0];
        } else {
            javax.accessibility.AccessibleState[] stateArray = new javax.accessibility.AccessibleState[states.size()];
            for (int i = 0; i < stateArray.length; i++) {
                stateArray[i] = (javax.accessibility.AccessibleState) states.elementAt(i);
            }
            return stateArray;
        }
    }
    ...
    public String toString() {
        ...
        if ((states != null) && (states.size() > 0)) {
            ret = ((javax.accessibility.AccessibleState) (states.elementAt(0))).toDisplayString();
