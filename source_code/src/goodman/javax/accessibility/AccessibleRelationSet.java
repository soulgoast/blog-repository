...
import goodman.javax.accessibility.AccessibleRelation;
 ...
 *
 * @see javax.accessibility.AccessibleRelation
 *
...
public class AccessibleRelationSet {
     ...
     * @see #clear
     */
    protected Vector<javax.accessibility.AccessibleRelation> relations = null;
    ...
    public boolean add(javax.accessibility.AccessibleRelation relation) {
        ...
        javax.accessibility.AccessibleRelation existingRelation = get(relation.getKey());
     ...
     */
    public javax.accessibility.AccessibleRelation get(String key) {
        if (relations == null) {
            return null;
        } else {
            int len = relations.size();
            for (int i = 0; i < len; i++) {
                javax.accessibility.AccessibleRelation relation =
                    (javax.accessibility.AccessibleRelation)relations.elementAt(i);
    ...
    public javax.accessibility.AccessibleRelation[] toArray() {
        if (relations == null) {
            return new javax.accessibility.AccessibleRelation[0];
        } else {
            javax.accessibility.AccessibleRelation[] relationArray
                = new javax.accessibility.AccessibleRelation[relations.size()];
            for (int i = 0; i < relationArray.length; i++) {
                relationArray[i] = (javax.accessibility.AccessibleRelation) relations.elementAt(i);
            }
    ...
    public String toString() {
        ...
        if ((relations != null) && (relations.size() > 0)) {
            ret = ((javax.accessibility.AccessibleRelation) (relations.elementAt(0))).toDisplayString();
