...
package goodman.javax.security.sasl;

import goodman.java.util.Map;
import goodman.javax.security.auth.callback.CallbackHandler;
import goodman.javax.security.sasl.Sasl;
import goodman.javax.security.sasl.SaslException;
import goodman.javax.security.sasl.SaslServer;
...
public abstract interface SaslServerFactory {
     ...
     *@exception javax.security.sasl.SaslException If cannot create a {@code SaslServer} because
     * of an error.
     */
