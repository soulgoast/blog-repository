...
package goodman.javax.security.auth.kerberos;
...
import goodman.javax.security.auth.kerberos.KerberosPrincipal;
import goodman.javax.security.auth.kerberos.KeyImpl;
import goodman.javax.security.auth.kerberos.KeyTab;
...
public class KerberosKey implements SecretKey, Destroyable {
    ...
    */
    ...
    public KerberosKey(KerberosPrincipal principal,
        ...
        key = new javax.security.auth.kerberos.KeyImpl(keyBytes, keyType);
    }
    ...
    public KerberosKey(KerberosPrincipal principal,
        ...
        key = new javax.security.auth.kerberos.KeyImpl(principal, password, algorithm);
    }
