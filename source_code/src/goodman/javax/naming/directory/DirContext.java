...
import goodman.javax.naming.directory.*;
...
public interface DirContext extends Context {
     ...
     */
    public javax.naming.directory.Attributes getAttributes(Name name) throws NamingException;
     ...
     * @throws  NamingException if a naming exception is encountered
     */
    public javax.naming.directory.Attributes getAttributes(String name) throws NamingException;
    ...
    /**
     * Modifies the attributes associated with a named object.
     * See {@link #modifyAttributes(Name, int, javax.naming.directory.Attributes)} for details.
     *
     * @param name
     *          the name of the object whose attributes will be updated
     * @param mod_op
     ...
     * @throws  NamingException if a naming exception is encountered
     *
     * @see #modifyAttributes(Name, int, javax.naming.directory.Attributes)
     * @see ModificationItem
     */
     ...
     * @see #rebind(Name, Object, javax.naming.directory.Attributes)
     */
    ...
    /**
     * Binds a name to an object, along with associated attributes.
     * See {@link #bind(Name, Object, javax.naming.directory.Attributes)} for details.
     *
     * @param name
     *          the name to bind; may not be empty
     * @param obj
     ...
     * Binds a name to an object, along with associated attributes,
     * overwriting any existing binding.
     * See {@link #rebind(Name, Object, javax.naming.directory.Attributes)} for details.
     *
     * @param name
     *          the name to bind; may not be empty
     * @param obj
     ...
     */
    public DirContext createSubcontext(Name name, javax.naming.directory.Attributes attrs)
            throws NamingException;

    /**
     * Creates and binds a new context, along with associated attributes.
     * See {@link #createSubcontext(Name, javax.naming.directory.Attributes)} for details.
     *
     * @param name
     *          the name of the context to create; may not be empty
     * @param attrs
     ...
     * @throws  NamingException if a naming exception is encountered
     */
    public DirContext createSubcontext(String name, javax.naming.directory.Attributes attrs)
            throws NamingException;
...
// -------------------- search operations
     ...
     * Searches in a single context for objects that contain a
     * specified set of attributes, and retrieves selected attributes.
     * See {@link #search(Name, javax.naming.directory.Attributes, String[])} for details.
     *
     * @param name
     *          the name of the context to search
     * @param matchingAttributes
     ...
     * <br>
     * See {@link #search(Name, javax.naming.directory.Attributes, String[])} for a full description.
     *
     * @param name
     *          the name of the context to search
     * @param matchingAttributes
     ...
     * @throws  NamingException if a naming exception is encountered
     *
     * @see #search(Name, javax.naming.directory.Attributes, String[])
     */
    public NamingEnumeration<SearchResult>
     ...
     * Searches in a single context for objects that contain a
     * specified set of attributes.
     * See {@link #search(Name, javax.naming.directory.Attributes)} for details.
     *
     * @param name
     *          the name of the context to search
     * @param matchingAttributes
