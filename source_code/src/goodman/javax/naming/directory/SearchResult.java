...
public class SearchResult extends Binding {
     ...
     * @serial
     */
    private javax.naming.directory.Attributes attrs;
    ...
    /**
      ...
      */
    public SearchResult(String name, Object obj, javax.naming.directory.Attributes attrs) {
        super(name, obj);
        this.attrs = attrs;
    }
    ...
    public SearchResult(String name, String className,
        Object obj, javax.naming.directory.Attributes attrs) {
    ...
    public SearchResult(String name, String className, Object obj,
                        javax.naming.directory.Attributes attrs, boolean isRelative) {
