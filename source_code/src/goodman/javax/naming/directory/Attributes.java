...
import goodman.javax.naming.directory.BasicAttributes;
...
public interface Attributes extends Cloneable, java.io.Serializable {
    ...
    /**
      ...
      * @see #remove
      */
    javax.naming.directory.Attribute get(String attrID);
    ...
    /**
      ...
      * @see #remove
      */
    javax.naming.directory.Attribute put(String attrID, Object val);
