...
public class ModificationItem implements java.io.Serializable {
     ...
     * @serial
     */
    private javax.naming.directory.Attribute attr;
    ...
    /**
      ...
      */
    public ModificationItem(int mod_op, javax.naming.directory.Attribute attr) {
        switch (mod_op) {
        case javax.naming.directory.DirContext.ADD_ATTRIBUTE:
        case javax.naming.directory.DirContext.REPLACE_ATTRIBUTE:
        case javax.naming.directory.DirContext.REMOVE_ATTRIBUTE:
            if (attr == null)
