...
import goodman.javax.naming.NamingEnumeration;
import goodman.javax.naming.directory.Attribute;
import goodman.javax.naming.directory.Attributes;
import goodman.javax.naming.directory.BasicAttribute;
...
public class BasicAttributes implements javax.naming.directory.Attributes {
    ...
    transient Hashtable<String, javax.naming.directory.Attribute> attrs = new Hashtable<>(11);
    ...
    public BasicAttributes(String attrID, Object val) {
        this();
        this.put(new javax.naming.directory.BasicAttribute(attrID, val));
    }
    ...
    public Object clone() {
        ...
        attrset.attrs = (Hashtable<String, javax.naming.directory.Attribute>)attrs.clone();
        return attrset;
    }
    ...
    public javax.naming.directory.Attribute get(String attrID) {
        javax.naming.directory.Attribute attr = attrs.get(
                ignoreCase ? attrID.toLowerCase(Locale.ENGLISH) : attrID);
        return (attr);
    }

    public NamingEnumeration<javax.naming.directory.Attribute> getAll() {
    ...
    public javax.naming.directory.Attribute put(String attrID, Object val) {
    ...
    public javax.naming.directory.Attribute remove(String attrID) {
    ...
    public boolean equals(Object obj) {
        if ((obj != null) && (obj instanceof javax.naming.directory.Attributes)) {
            javax.naming.directory.Attributes target = (Attributes)obj;
            ...
            if (size() == target.size()) {
                javax.naming.directory.Attribute their, mine;
                try {
                    NamingEnumeration<?> theirs = target.getAll();
                    while (theirs.hasMore()) {
                        their = (javax.naming.directory.Attribute)theirs.next();
    ...
    private void writeObject(java.io.ObjectOutputStream s)
        ...
        Enumeration<javax.naming.directory.Attribute> attrEnum = attrs.elements();
    ...
    private void readObject(java.io.ObjectInputStream s)
        ...
        while (--n >= 0) {
            put((javax.naming.directory.Attribute)s.readObject());
        }
    }


class AttrEnumImpl implements NamingEnumeration<javax.naming.directory.Attribute> {

    Enumeration<javax.naming.directory.Attribute> elements;
    ...
    public javax.naming.directory.Attribute nextElement() {
    ...
    public javax.naming.directory.Attribute next() throws NamingException {
        return nextElement();
    }
