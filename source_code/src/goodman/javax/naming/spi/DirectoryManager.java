...
import goodman.javax.naming.Reference;
import goodman.javax.naming.Referenceable;
import goodman.javax.naming.NamingException;
import goodman.javax.naming.CannotProceedException;
import goodman.javax.naming.directory.DirContext;
import goodman.javax.naming.directory.Attributes;
import goodman.javax.naming.spi.ContinuationDirContext;
import goodman.javax.naming.spi.DirObjectFactory;
import goodman.javax.naming.spi.DirStateFactory;
import goodman.javax.naming.spi.NamingManager;
import goodman.javax.naming.spi.ObjectFactory;
import goodman.javax.naming.spi.ObjectFactoryBuilder;
import goodman.javax.naming.spi.StateFactory;
...
/**
  ...
  * @see javax.naming.spi.DirStateFactory
  * @since 1.3
  */
...
public class DirectoryManager extends javax.naming.spi.NamingManager {
    ...
    /**
      ...
      *
      * @see javax.naming.spi.NamingManager#getContinuationContext(CannotProceedException)
      */
    ...
    public static Object
        ...
        throws Exception {
            ...
            javax.naming.spi.ObjectFactory factory;
    ...
    /**
      ...
      * @see javax.naming.spi.DirStateFactory
      * @see javax.naming.spi.DirStateFactory#getStateToBind
    ...
    public static javax.naming.spi.DirStateFactory.Result
        ...
        if (factories == null) {
            ...
            return new javax.naming.spi.DirStateFactory.Result(obj, attrs);
        }

        // Try each factory until one succeeds
        javax.naming.spi.StateFactory factory;
        Object objanswer;
        javax.naming.spi.DirStateFactory.Result answer = null;
        while (answer == null && factories.hasMore()) {
            factory = (StateFactory)factories.next();
            if (factory instanceof javax.naming.spi.DirStateFactory) {
                answer = ((javax.naming.spi.DirStateFactory)factory).
                    getStateToBind(obj, name, nameCtx, environment, attrs);
            } else {
                objanswer =
                    factory.getStateToBind(obj, name, nameCtx, environment);
                if (objanswer != null) {
                    answer = new javax.naming.spi.DirStateFactory.Result(objanswer, attrs);
                }
            }
        }
