...
class ContinuationContext implements Context, javax.naming.spi.Resolver {
    ...
    protected Context getTargetContext() throws NamingException {
        if (contCtx == null) {
            ...
            contCtx = javax.naming.spi.NamingManager.getContext(cpe.getResolvedObj(),
                                               cpe.getAltName(),
                                               cpe.getAltNameCtx(),
                                               env);
            if (contCtx == null)
        ...
        throws NamingException
    {
        ...
        javax.naming.spi.Resolver res = javax.naming.spi.NamingManager.getResolver(cpe.getResolvedObj(),
                                                 cpe.getAltName(),
                                                 cpe.getAltNameCtx(),
                                                 env);
        if (res == null)
