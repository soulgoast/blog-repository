...
import goodman.javax.naming.spi.*;
...
// --------- object factory stuff
    ...
    // Used by ContinuationContext
    static javax.naming.spi.Resolver getResolver(Object obj, Name name, Context nameCtx,
                                                 Hashtable<?,?> environment) throws NamingException {
        Object answer;

        if (obj instanceof javax.naming.spi.Resolver) {
            // %%% Ignore environment for now.  OK since method not public.
            return (javax.naming.spi.Resolver)obj;
        }
        ...
        return (answer instanceof javax.naming.spi.Resolver)
            ? (Resolver)answer
            : null;
    }
...
// ------------ State Factory Stuff
     ...
     * @see javax.naming.spi.StateFactory#getStateToBind
