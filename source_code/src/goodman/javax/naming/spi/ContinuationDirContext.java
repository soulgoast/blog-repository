...
import goodman.javax.naming.CompositeName;
import goodman.javax.naming.NamingException;
import goodman.javax.naming.CannotProceedException;
import goodman.javax.naming.OperationNotSupportedException;
...
import goodman.javax.naming.spi.ContinuationContext;
import goodman.javax.naming.spi.NamingManager;
import goodman.javax.naming.spi.ResolveResult;
import goodman.javax.naming.spi.Resolver;
...
class ContinuationDirContext extends javax.naming.spi.ContinuationContext implements DirContext {
    ...
    protected DirContextNamePair getTargetContext(Name name)
        ...
        Context ctx = javax.naming.spi.NamingManager.getContext(cpe.getResolvedObj(),
                                               cpe.getAltName(),
                                               cpe.getAltNameCtx(),
                                               env);
        if (ctx == null)
        ...
        if (ctx instanceof javax.naming.spi.Resolver) {
            javax.naming.spi.Resolver res = (javax.naming.spi.Resolver)ctx;
            javax.naming.spi.ResolveResult rr = res.resolveToClass(name, DirContext.class);
    ...
    protected DirContextStringPair getTargetContext(String name)
        ...
        if (ctx instanceof javax.naming.spi.Resolver) {
            javax.naming.spi.Resolver res = (Resolver)ctx;
