...
import goodman.javax.naming.NameImpl;
...
public class CompositeName implements javax.naming.Name {
    ...
    protected CompositeName(Enumeration<String> comps) {
        impl = new javax.naming.NameImpl(null, comps); // null means use default syntax
    }
    ...
    public CompositeName(String n) throws InvalidNameException {
        impl = new javax.naming.NameImpl(null, n);  // null means use default syntax
    }
    ...
    public CompositeName() {
        impl = new javax.naming.NameImpl(null);  // null means use default syntax
    }
    ...
    /**
      ...
      *         If posn is outside the specified range.
      */
    public javax.naming.Name addAll(int posn, javax.naming.Name n)
        throws InvalidNameException
    {
        if (n instanceof CompositeName) {
