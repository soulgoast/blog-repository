...
import goodman.javax.naming.BinaryRefAddr;
import goodman.javax.naming.RefAddr;
import goodman.javax.naming.StringRefAddr;
...
public class Reference implements Cloneable, java.io.Serializable {
     ...
     * @serial
     */
    protected Vector<javax.naming.RefAddr> addrs = null;
    ...
    /**
      ...
      */
    public Reference(String className, javax.naming.RefAddr addr) {
        this.className = className;
        addrs = new Vector<>();
    ...
    /**
      ...
      */
    public javax.naming.RefAddr get(String addrType) {
        int len = addrs.size();
    ...
    /**
      ...
      */
    public Enumeration<javax.naming.RefAddr> getAll() {
    ...
    /**
      ...
      *         range.
      */
    public void add(int posn, javax.naming.RefAddr addr) {
    ...
    public boolean equals(Object obj) {
        if ((obj != null) && (obj instanceof Reference)) {
            ...
            if (target.className.equals(this.className) &&
                ...
                Enumeration<javax.naming.RefAddr> mycomps = getAll();
                Enumeration<javax.naming.RefAddr> comps = target.getAll();
    ...
    public int hashCode() {
        ...
        for (Enumeration<javax.naming.RefAddr> e = getAll(); e.hasMoreElements();)
