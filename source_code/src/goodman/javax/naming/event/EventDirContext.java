...
public interface EventDirContext extends javax.naming.event.EventContext, DirContext {
    /**
    ...
    void addNamingListener(Name target, String filter, SearchControls ctls,
                           javax.naming.event.NamingListener l) throws NamingException;
    ...
    void addNamingListener(Name target, String filter, Object[] filterArgs,
                           SearchControls ctls, javax.naming.event.NamingListener l) throws NamingException;
