...
import goodman.javax.naming.ldap.Control;
import goodman.javax.naming.ldap.ExtendedRequest;
import goodman.javax.naming.ldap.ExtendedResponse;
import goodman.javax.naming.ldap.LdapContext;
...
public class InitialLdapContext extends InitialDirContext implements javax.naming.ldap.LdapContext {
     ...
     *
     * @see #reconnect
     * @see javax.naming.ldap.LdapContext#reconnect
     */
    ...
    public InitialLdapContext(Hashtable<?,?> environment,
        ...
        if (connCtls != null) {
            javax.naming.ldap.Control[] copy = new javax.naming.ldap.Control[connCtls.length];
     ...
     */
    private javax.naming.ldap.LdapContext getDefaultLdapInitCtx() throws NamingException{
        Context answer = getDefaultInitCtx();

        if (!(answer instanceof javax.naming.ldap.LdapContext)) {
            if (answer == null) {
        ...
        return (javax.naming.ldap.LdapContext)answer;
    }
...
// Most Javadoc is deferred to the LdapContext interface.
    ...
    public LdapContext newInstance(javax.naming.ldap.Control[] reqCtls)
        throws NamingException {
