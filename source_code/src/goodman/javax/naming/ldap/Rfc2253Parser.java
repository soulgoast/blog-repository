...
import goodman.javax.naming.InvalidNameException;
import goodman.javax.naming.ldap.Rdn;
...
final class Rfc2253Parser {
        ...
        List<javax.naming.ldap.Rdn> parseDn() throws InvalidNameException {
            cur = 0;

            // ArrayList<Rdn> rdns =
            //  new ArrayList<Rdn>(len / 3 + 10);  // leave room for growth

            ArrayList<javax.naming.ldap.Rdn> rdns =
            ...
            rdns.add(doParse(new javax.naming.ldap.Rdn()));
            while (cur < len) {
                if (chars[cur] == ',' || chars[cur] == ';') {
                    ++cur;
                    rdns.add(0, doParse(new javax.naming.ldap.Rdn()));
                } else {
         ...
         */
        javax.naming.ldap.Rdn parseRdn() throws InvalidNameException {
            return parseRdn(new javax.naming.ldap.Rdn());
        }

        /*
         * Parses the DN, if it is known to contain a single RDN.
         */
        javax.naming.ldap.Rdn parseRdn(javax.naming.ldap.Rdn rdn) throws InvalidNameException {
            rdn = doParse(rdn);
            if (cur < len) {
         ...
         */
         private javax.naming.ldap.Rdn doParse(javax.naming.ldap.Rdn rdn) throws InvalidNameException {
