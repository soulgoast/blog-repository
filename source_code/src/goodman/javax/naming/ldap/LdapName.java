...
public class LdapName implements Name {
    ...
    private transient List<javax.naming.ldap.Rdn> rdns;   // parsed name components
     ...
     * @see javax.naming.ldap.Rdn#escapeValue(Object value)
     */
     ...
     */
    public LdapName(List<javax.naming.ldap.Rdn> rdns) {
        ...
        for (int i = 0; i < rdns.size(); i++) {
            ...
            this.rdns.add((javax.naming.ldap.Rdn)obj);
        }
    }
     ...
     *
     */
    private LdapName(String name, List<javax.naming.ldap.Rdn> rdns, int beg, int end) {
        unparsed = name;
        // this.rdns = rdns.subList(beg, end);

        List<javax.naming.ldap.Rdn> sList = rdns.subList(beg, end);
    ...
    public Enumeration<String> getAll() {
        final Iterator<javax.naming.ldap.Rdn> iter = rdns.iterator();
     ...
     *          false otherwise.
     */
    public boolean startsWith(List<javax.naming.ldap.Rdn> rdns) {
        if (rdns == null) {
            return false;
        }
     ...
     *          false otherwise.
     */
    public boolean endsWith(List<javax.naming.ldap.Rdn> rdns) {
        if (rdns == null) {
            return false;
        }
        int len1 = this.rdns.size();
    ...
    private boolean doesListMatch(int beg, int end, List<javax.naming.ldap.Rdn> rdns) {
     ...
     * @return  The updated name (not a new instance).
     */
    public Name addAll(List<javax.naming.ldap.Rdn> suffixRdns) {
     ...
     *          If posn is outside the specified range.
     */
    public Name addAll(int posn, List<javax.naming.ldap.Rdn> suffixRdns) {
        unparsed = null;
        for (int i = 0; i < suffixRdns.size(); i++) {
            ...
            rdns.add(i + posn, (javax.naming.ldap.Rdn)obj);
        }
        return this;
    }
     ...
     *                  Cannot be null.
     */
    public Name add(javax.naming.ldap.Rdn comp) {
        return add(size(), comp);
    }
    ...
    public Name add(int posn, String comp) throws InvalidNameException {
        javax.naming.ldap.Rdn rdn = (new Rfc2253Parser(comp)).parseRdn();
        rdns.add(posn, rdn);
        unparsed = null;        // no longer valid
        return this;
    }
     ...
     *                  If posn is outside the specified range.
     */
    public Name add(int posn, javax.naming.ldap.Rdn comp) {
        if (comp == null) {
     ...
     *          the class {@link javax.naming.ldap.Rdn Rdn}.
     */
    public List<javax.naming.ldap.Rdn> getRdns() {
     ...
     * name returns true. See {@link javax.naming.ldap.Rdn#equals(Object obj)}
    ...
    public boolean equals(Object obj) {
        ...
        for (int i = 0; i < rdns.size(); i++) {
            ...
            javax.naming.ldap.Rdn rdn1 = rdns.get(i);
            javax.naming.ldap.Rdn rdn2 = that.rdns.get(i);
            if (!rdn1.equals(rdn2)) {
                return false;
            }
        }
     ...
     * See {@link javax.naming.ldap.Rdn#compareTo(Object obj) Rdn.compareTo(Object obj)}
