...
import goodman.javax.naming.ldap.BasicControl;
import goodman.javax.naming.ldap.SortKey;
import goodman.javax.naming.ldap.SortResponseControl;
...
final public class SortControl extends BasicControl {
    ...
    public SortControl(String sortBy, boolean criticality) throws IOException {
        ...
        super.value = setEncodedValue(new javax.naming.ldap.SortKey[]{ new javax.naming.ldap.SortKey(sortBy) });
    }
    ...
    public SortControl(String[] sortBy, boolean criticality)
        ...
        super(OID, criticality, null);
        javax.naming.ldap.SortKey[] sortKeys = new javax.naming.ldap.SortKey[sortBy.length];
        for (int i = 0; i < sortBy.length; i++) {
            sortKeys[i] = new javax.naming.ldap.SortKey(sortBy[i]);
        }
     ...
     *                        supplied arguments into a control.
     */
    public SortControl(javax.naming.ldap.SortKey[] sortBy, boolean criticality)
        throws IOException {
