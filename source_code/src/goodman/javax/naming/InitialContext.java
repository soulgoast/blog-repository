...
package goodman.javax.naming;

import goodman.java.util.Hashtable;
import goodman.javax.naming.Binding;
import goodman.javax.naming.Context;
import goodman.javax.naming.Name;
import goodman.javax.naming.NameClassPair;
import goodman.javax.naming.NameParser;
import goodman.javax.naming.NamingEnumeration;
import goodman.javax.naming.NamingException;
import goodman.javax.naming.NoInitialContextException;
 ...
 * (through the use of {@link javax.naming.Context#APPLET}).
 ...
 * "{@link javax.naming.Context#INITIAL_CONTEXT_FACTORY java.naming.factory.initial}",
...
public class InitialContext implements javax.naming.Context {
     ...
     */
    protected javax.naming.Context defaultInitCtx = null;
        ...
        throws NamingException
    {
        ...
        if (myProps.get(javax.naming.Context.INITIAL_CONTEXT_FACTORY) != null) {
     ...
     */
    @SuppressWarnings("unchecked")
    public static <T> T doLookup(javax.naming.Name name)
        throws NamingException {
   ...
   /**
     * A static method to retrieve the named object.
     * See {@link #doLookup(javax.naming.Name)} for details.
     * @param <T> the type of the returned object
     * @param name
     *          the name of the object to look up
     * @return  the object bound to <tt>name</tt>
     ...
     */
    protected javax.naming.Context getURLOrDefaultInitCtx(String name)
        throws NamingException {
        ...
        if (scheme != null) {
            javax.naming.Context ctx = NamingManager.getURLContext(scheme, myProps);
            if (ctx != null) {
                return ctx;
            }
        }
...
// Most Javadoc is deferred to the Context interface.
    ...
    public Object lookup(javax.naming.Name name) throws NamingException {
        return getURLOrDefaultInitCtx(name).lookup(name);
    }
    ...
    public void bind(javax.naming.Name name, Object obj) throws NamingException {
        getURLOrDefaultInitCtx(name).bind(name, obj);
    }
    ...
    public void rebind(javax.naming.Name name, Object obj) throws NamingException {
        getURLOrDefaultInitCtx(name).rebind(name, obj);
    }
    ...
    public void unbind(javax.naming.Name name) throws NamingException  {
        getURLOrDefaultInitCtx(name).unbind(name);
    }
    ...
    public NamingEnumeration<NameClassPair> list(javax.naming.Name name)
        throws NamingException
    {
        return (getURLOrDefaultInitCtx(name).list(name));
    }
    ...
    public NamingEnumeration<Binding> listBindings(javax.naming.Name name)
            throws NamingException  {
        return getURLOrDefaultInitCtx(name).listBindings(name);
    }
