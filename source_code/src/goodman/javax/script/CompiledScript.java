...
public abstract class CompiledScript {
    ...
    public abstract Object eval(javax.script.ScriptContext context) throws ScriptException;
    ...
    public Object eval(Bindings bindings) throws ScriptException {
        ...
        javax.script.ScriptContext ctxt = getEngine().getContext();

        if (bindings != null) {
            SimpleScriptContext tempctxt = new SimpleScriptContext();
            tempctxt.setBindings(bindings, javax.script.ScriptContext.ENGINE_SCOPE);
            tempctxt.setBindings(ctxt.getBindings(javax.script.ScriptContext.GLOBAL_SCOPE),
