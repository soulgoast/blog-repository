...
import goodman.javax.script.ScriptException;
import goodman.javax.script.SimpleScriptContext;
...
public abstract class AbstractScriptEngine  implements ScriptEngine {
    ...
    public AbstractScriptEngine(javax.script.Bindings n) {
        ...
        context.setBindings(n, javax.script.ScriptContext.ENGINE_SCOPE);
    }
    ...
    public javax.script.Bindings getBindings(int scope) {
        ...
        if (scope == javax.script.ScriptContext.GLOBAL_SCOPE) {
            return context.getBindings(javax.script.ScriptContext.GLOBAL_SCOPE);
        } else if (scope == javax.script.ScriptContext.ENGINE_SCOPE) {
            return context.getBindings(javax.script.ScriptContext.ENGINE_SCOPE);
        } else {
    ...
    public void put(String key, Object value) {
        ...
        javax.script.Bindings nn = getBindings(javax.script.ScriptContext.ENGINE_SCOPE);
        if (nn != null) {
            nn.put(key, value);
        }
     ...
     */
    public Object eval(Reader reader, javax.script.Bindings bindings ) throws javax.script.ScriptException {

        javax.script.ScriptContext ctxt = getScriptContext(bindings);
    ...
    protected javax.script.ScriptContext getScriptContext(javax.script.Bindings nn) {
        ...
        javax.script.SimpleScriptContext ctxt = new SimpleScriptContext();
        Bindings gs = getBindings(javax.script.ScriptContext.GLOBAL_SCOPE);

        if (gs != null) {
            ctxt.setBindings(gs, javax.script.ScriptContext.GLOBAL_SCOPE);
        }
