...
import goodman.javax.sound.sampled.*;
import goodman.javax.sound.sampled.AudioFormat;
import goodman.javax.sound.sampled.Clip;
import goodman.javax.sound.sampled.DataLine;
import goodman.javax.sound.sampled.Line;
import goodman.javax.sound.sampled.Mixer;
import goodman.javax.sound.sampled.Port;
import goodman.javax.sound.sampled.spi.AudioFileWriter;
import goodman.javax.sound.sampled.spi.AudioFileReader;
import goodman.javax.sound.sampled.spi.FormatConversionProvider;
import goodman.javax.sound.sampled.spi.MixerProvider;
 ...
 * for obtaining a <code>{@link javax.sound.sampled.Line}</code> directly from the
 ...
 *   <td>{@link javax.sound.sampled.Clip}</td>
 ...
 * @see javax.sound.sampled.Line.Info
 * @since 1.3
 */
public class AudioSystem {
    ...
    public static javax.sound.sampled.Mixer.Info[] getMixerInfo() {
        ...
        javax.sound.sampled.Mixer.Info[] allInfos = (javax.sound.sampled.Mixer.Info[]) infos.toArray(new javax.sound.sampled.Mixer.Info[infos.size()]);
        return allInfos;
    }
        ...
        if (info == null) {
            for(int i = 0; i < providers.size(); i++ ) {
                try {
                    ...
                    javax.sound.sampled.Mixer.Info[] infos = provider.getMixerInfo();
    ...
    public static javax.sound.sampled.Line.Info[] getSourceLineInfo(javax.sound.sampled.Line.Info info) {
        ...
        javax.sound.sampled.Line.Info[] currentInfoArray;

        javax.sound.sampled.Mixer mixer;
        javax.sound.sampled.Line.Info fullInfo = null;
        javax.sound.sampled.Mixer.Info[] infoArray = getMixerInfo();
        ...
        javax.sound.sampled.Line.Info[] returnedArray = new javax.sound.sampled.Line.Info[vector.size()];

        for (int i = 0; i < returnedArray.length; i++) {
            returnedArray[i] = (javax.sound.sampled.Line.Info)vector.get(i);
        }
    ...
    public static javax.sound.sampled.Line getLine(javax.sound.sampled.Line.Info info) throws LineUnavailableException {
        ...
        try {
            javax.sound.sampled.Mixer mixer = getDefaultMixer(providers, info);
        ...
        for(int i = 0; i < providers.size(); i++) {
            ...
            for (int j = 0; j < infos.length; j++) {
                try {
                    javax.sound.sampled.Mixer mixer = provider.getMixer(infos[j]);
     ...
     *
     * @see #getClip(javax.sound.sampled.Mixer.Info)
     * @since 1.5
     */
    public static javax.sound.sampled.Clip getClip() throws LineUnavailableException{
        javax.sound.sampled.AudioFormat format = new javax.sound.sampled.AudioFormat(javax.sound.sampled.AudioFormat.Encoding.PCM_SIGNED,
        ...
        return (javax.sound.sampled.Clip) AudioSystem.getLine(info);
    }
     ...
     * @since 1.5
     */
    public static javax.sound.sampled.Clip getClip(javax.sound.sampled.Mixer.Info mixerInfo) throws LineUnavailableException{
        javax.sound.sampled.AudioFormat format = new javax.sound.sampled.AudioFormat(javax.sound.sampled.AudioFormat.Encoding.PCM_SIGNED,
                                             AudioSystem.NOT_SPECIFIED,
                                             16, 2, 4,
                                             AudioSystem.NOT_SPECIFIED, true);
        ...
        return (javax.sound.sampled.Clip) mixer.getLine(info);
    }
     ...
     *
     * @see #getSourceDataLine(javax.sound.sampled.AudioFormat, javax.sound.sampled.Mixer.Info)
     * @since 1.5
     */
    public static SourceDataLine getSourceDataLine(javax.sound.sampled.AudioFormat format)
     ...
     *
     * @see #getSourceDataLine(javax.sound.sampled.AudioFormat)
     * @since 1.5
     */
    public static SourceDataLine getSourceDataLine(javax.sound.sampled.AudioFormat format,
     ...
     *         specified audio format through any installed mixer
     *
     * @see #getTargetDataLine(javax.sound.sampled.AudioFormat, javax.sound.sampled.Mixer.Info)
     * @see AudioPermission
     * @since 1.5
     */
    public static TargetDataLine getTargetDataLine(javax.sound.sampled.AudioFormat format)
        throws LineUnavailableException{

        javax.sound.sampled.DataLine.Info info = new javax.sound.sampled.DataLine.Info(TargetDataLine.class, format);
     ...
     *         the specified audio format
     *
     * @see #getTargetDataLine(javax.sound.sampled.AudioFormat)
     * @see AudioPermission
     * @since 1.5
     */
    public static TargetDataLine getTargetDataLine(javax.sound.sampled.AudioFormat format,
        ...
        javax.sound.sampled.DataLine.Info info = new DataLine.Info(TargetDataLine.class, format);
        javax.sound.sampled.Mixer mixer = AudioSystem.getMixer(mixerinfo);
    ...
    public static javax.sound.sampled.AudioFormat.Encoding[] getTargetEncodings(javax.sound.sampled.AudioFormat.Encoding sourceEncoding) {
        ...
        javax.sound.sampled.AudioFormat.Encoding encs[] = null;
        ...
        javax.sound.sampled.AudioFormat.Encoding encs2[] = (javax.sound.sampled.AudioFormat.Encoding[]) encodings.toArray(new javax.sound.sampled.AudioFormat.Encoding[0]);
        return encs2;
    }
    ...
    public static javax.sound.sampled.AudioFormat.Encoding[] getTargetEncodings(javax.sound.sampled.AudioFormat sourceFormat) {
        ...
        javax.sound.sampled.AudioFormat.Encoding encs2[] = new javax.sound.sampled.AudioFormat.Encoding[size];
        for(int i=0; i<encodings.size(); i++ ) {
            encs = (javax.sound.sampled.AudioFormat.Encoding [])(encodings.get(i));
            for(int j=0; j<encs.length; j++ ) {
                encs2[index++] = encs[j];
            }
        }
     ...
     */
    public static boolean isConversionSupported(javax.sound.sampled.AudioFormat.Encoding targetEncoding, javax.sound.sampled.AudioFormat sourceFormat) {
     ...
     * @see #getTargetEncodings(javax.sound.sampled.AudioFormat.Encoding)
     * @see #getTargetEncodings(javax.sound.sampled.AudioFormat)
     * @see #isConversionSupported(javax.sound.sampled.AudioFormat.Encoding, javax.sound.sampled.AudioFormat)
     * @see #getAudioInputStream(javax.sound.sampled.AudioFormat, AudioInputStream)
     */
    public static AudioInputStream getAudioInputStream(javax.sound.sampled.AudioFormat.Encoding targetEncoding,
    ...
    public static javax.sound.sampled.AudioFormat[] getTargetFormats(javax.sound.sampled.AudioFormat.Encoding targetEncoding, javax.sound.sampled.AudioFormat sourceFormat) {
        ...
        int size = 0;
        int index = 0;
        javax.sound.sampled.AudioFormat fmts[] = null;
        ...
        javax.sound.sampled.AudioFormat fmts2[] = new javax.sound.sampled.AudioFormat[size];
        for(int i=0; i<formats.size(); i++ ) {
            fmts = (javax.sound.sampled.AudioFormat[])(formats.get(i));
    ...
    public static boolean isConversionSupported(javax.sound.sampled.AudioFormat targetFormat, javax.sound.sampled.AudioFormat sourceFormat) {
     ...
     * @see #getTargetFormats(javax.sound.sampled.AudioFormat.Encoding, javax.sound.sampled.AudioFormat)
     * @see #isConversionSupported(javax.sound.sampled.AudioFormat, javax.sound.sampled.AudioFormat)
     * @see #getAudioInputStream(javax.sound.sampled.AudioFormat.Encoding, AudioInputStream)
     */
     ...
     */
    private static javax.sound.sampled.Mixer getDefaultMixer(List providers, javax.sound.sampled.Line.Info info) {
     ...
     */
    private static javax.sound.sampled.Mixer getNamedMixer(String mixerName,
                                                           MixerProvider provider,
                                                           javax.sound.sampled.Line.Info info) {
        javax.sound.sampled.Mixer.Info[] infos = provider.getMixerInfo();
        for (int i = 0; i < infos.length; i++) {
            if (infos[i].getName().equals(mixerName)) {
                javax.sound.sampled.Mixer mixer = provider.getMixer(infos[i]);
                if (isAppropriateMixer(mixer, info, false)) {
                    return mixer;
                }
            }
    ...
    private static javax.sound.sampled.Mixer getNamedMixer(String mixerName,
        ...
        for(int i = 0; i < providers.size(); i++) {
            MixerProvider provider = (MixerProvider) providers.get(i);
            javax.sound.sampled.Mixer mixer = getNamedMixer(mixerName, provider, info);
            if (mixer != null) {
                return mixer;
            }
        }
    ...
    /** From a given MixerProvider, return the first appropriate Mixer.
        ...
        if none is found.
     */
    private static javax.sound.sampled.Mixer getFirstMixer(MixerProvider provider,
                                                           javax.sound.sampled.Line.Info info,
     ...
     */
    private static boolean isAppropriateMixer(javax.sound.sampled.Mixer mixer,
                                              Line.Info lineInfo,
                                              boolean isMixingRequired) {
    ...
    private static List getMixerInfoList(List providers) {
        ...
        javax.sound.sampled.Mixer.Info[] someInfos; // per-mixer
        javax.sound.sampled.Mixer.Info[] allInfos;  // for all mixers
