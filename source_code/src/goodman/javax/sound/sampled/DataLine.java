 ...
 * superinterface, <code>{@link javax.sound.sampled.Line}</code>.  This functionality includes
 ...
 * <code>{@link javax.sound.sampled.Clip}</code>, which allow an application program to write data.  Similarly,
 ...
 * <code>{@link javax.sound.sampled.Mixer#synchronize synchronize}</code> method.
 * See the description of the <code>{@link javax.sound.sampled.Mixer Mixer}</code> interface
