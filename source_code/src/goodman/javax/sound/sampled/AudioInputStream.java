...
import goodman.java.io.PushbackInputStream;
...
public class AudioInputStream extends InputStream {
     ...
     */
    public AudioInputStream(InputStream stream, javax.sound.sampled.AudioFormat format, long length) {
        ...
        if( this.frameSize == javax.sound.sampled.AudioSystem.NOT_SPECIFIED || frameSize <= 0) {
            this.frameSize = 1;
        }
    ...
    public AudioInputStream(javax.sound.sampled.TargetDataLine line) {
        ...
        frameLength = javax.sound.sampled.AudioSystem.NOT_SPECIFIED;
        frameSize = format.getFrameSize();

        if( frameSize == javax.sound.sampled.AudioSystem.NOT_SPECIFIED || frameSize <= 0) {
            frameSize = 1;
        }
        this.stream = tstream;
        framePos = 0;
    ...
    public int read(byte[] b, int off, int len) throws IOException {
        ...
        if( frameLength != javax.sound.sampled.AudioSystem.NOT_SPECIFIED ) {
