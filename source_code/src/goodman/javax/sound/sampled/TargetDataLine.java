...
import goodman.javax.sound.sampled.SourceDataLine;

/**
 * A target data line is a type of <code>{@link javax.sound.sampled.DataLine}</code> from which
 ...
 * <code>{@link javax.sound.sampled.Mixer#getLine getLine}</code>
 * method of <code>Mixer</code> with an appropriate
 * <code>{@link javax.sound.sampled.DataLine.Info}</code> object.
 * <p>
...
public interface TargetDataLine extends javax.sound.sampled.DataLine {
     ...
     * that the system has chosen may be queried by subsequently calling <code>{@link javax.sound.sampled.DataLine#getBufferSize}</code>
     * <p>
     * If this operation succeeds, the line is marked as open, and an
     * <code>{@link javax.sound.sampled.LineEvent.Type#OPEN OPEN}</code> event is dispatched to the
     * line's listeners.
