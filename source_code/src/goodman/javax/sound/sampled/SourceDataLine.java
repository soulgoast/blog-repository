...
import goodman.javax.sound.sampled.LineUnavailableException;
import goodman.javax.sound.sampled.Mixer;
import goodman.javax.sound.sampled.TargetDataLine;
 ...
 * <code>{@link javax.sound.sampled.Mixer#getLine getLine}</code> method of <code>Mixer</code> with
 * an appropriate <code>{@link javax.sound.sampled.DataLine.Info}</code> object.
 * <p>
 ...
 * <code>{@link javax.sound.sampled.DataLine#available available}</code> method defined in the
 ...
 * stops due to underflow, a <code>{@link javax.sound.sampled.LineEvent.Type#STOP STOP}</code> event is
 * generated.  A <code>{@link javax.sound.sampled.LineEvent.Type#START START}</code> event is generated
...
public interface SourceDataLine extends javax.sound.sampled.DataLine {
     ...
     * queried by subsequently calling <code>{@link javax.sound.sampled.DataLine#getBufferSize}</code>.
     * <p>
     * If this operation succeeds, the line is marked as open, and an
     * <code>{@link javax.sound.sampled.LineEvent.Type#OPEN OPEN}</code> event is dispatched to the
     * line's listeners.
     * <p>
     ...
     *
     * @see #open(javax.sound.sampled.AudioFormat)
     ...
     */
    public void open(javax.sound.sampled.AudioFormat format, int bufferSize) throws LineUnavailableException;
     ...
     * <code>{@link javax.sound.sampled.DataLine#getBufferSize}</code>.
     * <p>
     * If this operation succeeds, the line is marked as open, and an
     * <code>{@link javax.sound.sampled.LineEvent.Type#OPEN OPEN}</code> event is dispatched to the
     * line's listeners.
     ...
     * opened due to security restrictions
     *
     * @see #open(javax.sound.sampled.AudioFormat, int)
     * @see javax.sound.sampled.Line#open
     * @see javax.sound.sampled.Line#close
     * @see Line#isOpen
     * @see LineEvent
     ...
     * currently be written (see <code>{@link javax.sound.sampled.DataLine#available available}</code>),
     ...
     * using the <code>{@link javax.sound.sampled.DataLine#available available}</code> method of the
