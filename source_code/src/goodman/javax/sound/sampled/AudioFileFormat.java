...
import goodman.javax.sound.sampled.AudioInputStream;
import goodman.javax.sound.sampled.AudioSystem;
 ...
 * <p>
 * The <code>{@link javax.sound.sampled.AudioSystem}</code> class includes methods for determining the format
...
public class AudioFileFormat {
     ...
     * @see #getType
     */
    protected AudioFileFormat(Type type, int byteLength, javax.sound.sampled.AudioFormat format, int frameLength) {
     ...
     * @param frameLength the audio data length in sample frames, or <code>AudioSystem.NOT_SPECIFIED</code>
     */
    public AudioFileFormat(Type type, javax.sound.sampled.AudioFormat format, int frameLength) {


        this(type, javax.sound.sampled.AudioSystem.NOT_SPECIFIED,format,frameLength);
    }
     ...
     * @since 1.5
     */
    public AudioFileFormat(Type type, javax.sound.sampled.AudioFormat format,
    ...
    public String toString() {
        ...
        if (byteLength != javax.sound.sampled.AudioSystem.NOT_SPECIFIED) {
