...
import goodman.javax.sound.midi.Patch;
import goodman.javax.sound.midi.Track;
 ...
 * information and one or more tracks.  Each <code>{@link javax.sound.midi.Track track}</code> consists of a
...
public class Sequence {
     ...
     * @see #getTracks
     */
    protected Vector<javax.sound.midi.Track> tracks = new Vector<javax.sound.midi.Track>();
    ...
    public Sequence(float divisionType, int resolution, int numTracks) throws InvalidMidiDataException {
        ...
        for (int i = 0; i < numTracks; i++) {
            tracks.addElement(new javax.sound.midi.Track());
        }
    }
    ...
    public javax.sound.midi.Track createTrack() {
        ...
        javax.sound.midi.Track track = new javax.sound.midi.Track();
    ...
    public javax.sound.midi.Track[] getTracks() {
        ...
        return (javax.sound.midi.Track[]) tracks.toArray(new javax.sound.midi.Track[tracks.size()]);
    }
     ...
     *
     * @return an array of <code>{@link javax.sound.midi.Patch}</code> objects used in this sequence
     *
