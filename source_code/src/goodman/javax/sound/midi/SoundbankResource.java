...
import goodman.javax.sound.midi.Instrument;
import goodman.javax.sound.midi.Sequence;
import goodman.javax.sound.midi.Soundbank;
import goodman.javax.sound.midi.Synthesizer;

/**
 * A <code>SoundbankResource</code> represents any audio resource stored
 * in a <code>{@link javax.sound.midi.Soundbank}</code>.  Common soundbank resources include:
 * <ul>
 ...
 * stored in <code>{@link javax.sound.midi.Instrument}</code> objects.
...
public abstract class SoundbankResource {
     ...
     */
    private final javax.sound.midi.Soundbank soundBank;
     ...
     * @see #getData
     */
    protected SoundbankResource(javax.sound.midi.Soundbank soundBank, String name, Class<?> dataClass) {
