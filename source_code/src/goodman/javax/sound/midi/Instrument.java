...
import goodman.javax.sound.midi.MidiChannel;
import goodman.javax.sound.midi.Patch;
import goodman.javax.sound.midi.Soundbank;
import goodman.javax.sound.midi.SoundbankResource;
...
public abstract class Instrument extends SoundbankResource {
     ...
     * Instrument patch
     */
    private final javax.sound.midi.Patch patch;
     ...
     * @see Synthesizer#loadInstrument(Instrument)
     */
    protected Instrument(Soundbank soundbank, javax.sound.midi.Patch patch, String name, Class<?> dataClass) {
