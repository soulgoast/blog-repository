...
import goodman.javax.sound.midi.*;
...
import goodman.javax.sound.midi.spi.MidiFileWriter;
import goodman.javax.sound.midi.spi.MidiFileReader;
import goodman.javax.sound.midi.spi.SoundbankReader;
import goodman.javax.sound.midi.spi.MidiDeviceProvider;
 ...
 *   <td>{@link javax.sound.midi.Sequencer}</td>
...
public class MidiSystem {
     ...
     * {@link #getMidiDevice(javax.sound.midi.MidiDevice.Info) getMidiDevice}.
     *
    ...
    public static javax.sound.midi.MidiDevice.Info[] getMidiDeviceInfo() {
        ...
        for(int i = 0; i < providers.size(); i++) {
            ...
            javax.sound.midi.MidiDevice.Info[] tmpinfo = provider.getDeviceInfo();
            for (int j = 0; j < tmpinfo.length; j++) {
                allInfos.add( tmpinfo[j] );
            }
        }
        javax.sound.midi.MidiDevice.Info[] infosArray = (javax.sound.midi.MidiDevice.Info[]) allInfos.toArray(new javax.sound.midi.MidiDevice.Info[0]);
        return infosArray;
    }
     ...
     */
    public static javax.sound.midi.MidiDevice getMidiDevice(javax.sound.midi.MidiDevice.Info info) throws MidiUnavailableException {
        List providers = getMidiDeviceProviders();

        for(int i = 0; i < providers.size(); i++) {
            MidiDeviceProvider provider = (MidiDeviceProvider) providers.get(i);
            if (provider.isDeviceSupported(info)) {
                javax.sound.midi.MidiDevice device = provider.getDevice(info);
                return device;
            }
        }
     ...
     */
    public static javax.sound.midi.Receiver getReceiver() throws MidiUnavailableException {
        // may throw MidiUnavailableException
        javax.sound.midi.MidiDevice device = getDefaultDeviceWrapper(javax.sound.midi.Receiver.class);
    ...
    public static Transmitter getTransmitter() throws MidiUnavailableException {
        // may throw MidiUnavailableException
        javax.sound.midi.MidiDevice device = getDefaultDeviceWrapper(Transmitter.class);
     ...
     * @see #getReceiver
     */
    public static javax.sound.midi.Sequencer getSequencer() throws MidiUnavailableException {
    ...
    public static javax.sound.midi.Sequencer getSequencer(boolean connected)
        ...
        javax.sound.midi.Sequencer seq = (javax.sound.midi.Sequencer) getDefaultDeviceWrapper(javax.sound.midi.Sequencer.class);
        ...
        if (connected) {
            ...
            javax.sound.midi.Receiver rec = null;
     ...
     */
    public static javax.sound.midi.Soundbank getSoundbank(InputStream stream)
        throws InvalidMidiDataException, IOException {

        SoundbankReader sp = null;
        javax.sound.midi.Soundbank s = null;
     ...
     * @throws IOException if an I/O error occurred when loading the soundbank
     */
    public static javax.sound.midi.Soundbank getSoundbank(URL url)
        throws InvalidMidiDataException, IOException {
     ...
     * @throws IOException if an I/O error occurred when loading the soundbank
     */
    public static javax.sound.midi.Soundbank getSoundbank(File file)
        throws InvalidMidiDataException, IOException {
     ...
     * @see InputStream#mark
     */
    public static javax.sound.midi.Sequence getSequence(InputStream stream)
        throws InvalidMidiDataException, IOException {
     ...
     * @throws IOException if an I/O exception occurs while accessing the URL
     */
    public static javax.sound.midi.Sequence getSequence(URL url)
        throws InvalidMidiDataException, IOException {
     ...
     */
    public static javax.sound.midi.Sequence getSequence(File file)
        throws InvalidMidiDataException, IOException {
     ...
     */
    public static boolean isFileTypeSupported(int fileType, javax.sound.midi.Sequence sequence) {
     ...
     * the system
     * @see #isFileTypeSupported(int, javax.sound.midi.Sequence)
     * @see     #getMidiFileTypes(javax.sound.midi.Sequence)
     */
    public static int write(javax.sound.midi.Sequence in, int fileType, OutputStream out) throws IOException {
     ...
     */
    private static javax.sound.midi.MidiDevice getDefaultDeviceWrapper(Class deviceClass)
        throws MidiUnavailableException{
        try {
     ...
     */
    private static javax.sound.midi.MidiDevice getDefaultDevice(Class deviceClass) {
        List providers = getMidiDeviceProviders();
    ...
    */
    private static javax.sound.midi.MidiDevice getNamedDevice(String deviceName,
        ...
        if (deviceClass == javax.sound.midi.Receiver.class) {
    ...
    private static javax.sound.midi.MidiDevice getNamedDevice(String deviceName,
        ...
        javax.sound.midi.MidiDevice.Info[] infos = provider.getDeviceInfo();
        for (int i = 0; i < infos.length; i++) {
            if (infos[i].getName().equals(deviceName)) {
                javax.sound.midi.MidiDevice device = provider.getDevice(infos[i]);
    ...
    */
    ...
    private static javax.sound.midi.MidiDevice getNamedDevice(String deviceName,
        ...
        for(int i = 0; i < providers.size(); i++) {
            MidiDeviceProvider provider = (MidiDeviceProvider) providers.get(i);
            javax.sound.midi.MidiDevice device = getNamedDevice(deviceName, provider,
                                               deviceClass,
                                               allowSynthesizer,
                                               allowSequencer);
            if (device != null) {
    ...
    */
    private static javax.sound.midi.MidiDevice getFirstDevice(MidiDeviceProvider provider,
                                                              Class deviceClass) {
        javax.sound.midi.MidiDevice device;
        // try to get MIDI port
    ...
    private static javax.sound.midi.MidiDevice getFirstDevice(MidiDeviceProvider provider,
        ...
        for (int j = 0; j < infos.length; j++) {
            javax.sound.midi.MidiDevice device = provider.getDevice(infos[j]);
            if (isAppropriateDevice(device, deviceClass,
                                    allowSynthesizer, allowSequencer)) {
                return device;
            }
    ...
    /** From a List of MidiDeviceProviders, return the first appropriate
        ...
        if none is found.
    */
    private static javax.sound.midi.MidiDevice getFirstDevice(List providers,
                                                              Class deviceClass) {
        javax.sound.midi.MidiDevice device;
        // try to get MIDI port
        device = getFirstDevice(providers, deviceClass,
    ...
    private static javax.sound.midi.MidiDevice getFirstDevice(List providers,
        ...
        for(int i = 0; i < providers.size(); i++) {
            MidiDeviceProvider provider = (MidiDeviceProvider) providers.get(i);
            javax.sound.midi.MidiDevice device = getFirstDevice(provider, deviceClass,
                                               allowSynthesizer,
                                               allowSequencer);
            if (device != null) {
                return device;
