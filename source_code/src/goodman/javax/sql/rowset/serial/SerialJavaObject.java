...
package goodman.javax.sql.rowset.serial;

import goodman.java.io.*;
import goodman.java.lang.reflect.*;
import goodman.java.util.Arrays;
import goodman.java.util.Vector;
import goodman.javax.sql.rowset.RowSetWarning;
import goodman.javax.sql.rowset.serial.SerialException;
...
public class SerialJavaObject implements Serializable, Cloneable {
    ...
    */
     ...
     */
    public SerialJavaObject(Object obj) throws javax.sql.rowset.serial.SerialException {
        ...
        if (hasStaticFields(fields)) {
            throw new javax.sql.rowset.serial.SerialException("Located static fields in " +
     ...
     */
    public Object getObject() throws javax.sql.rowset.serial.SerialException {
        return this.obj;
    }
     ...
     * @throws javax.sql.rowset.serial.SerialException if an error is encountered accessing
     ...
     */
    @CallerSensitive
    public Field[] getFields() throws javax.sql.rowset.serial.SerialException {
        if (fields != null) {
