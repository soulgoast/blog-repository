...
import goodman.javax.sql.rowset.serial.*;
import goodman.javax.sql.rowset.serial.SerialArray;
import goodman.javax.sql.rowset.serial.SerialBlob;
import goodman.javax.sql.rowset.serial.SerialClob;
import goodman.javax.sql.rowset.serial.SerialRef;
import goodman.javax.sql.rowset.serial.SerialStruct;
...
public class SQLOutputImpl implements SQLOutput {
    ...
    public void writeObject(SQLData x) throws SQLException {
        ...
        if (x == null) {
             ...
             */
            attribs.add(new javax.sql.rowset.serial.SerialStruct(x, map));
        }
    }
    ...
    public void writeStruct(Struct x) throws SQLException {
        javax.sql.rowset.serial.SerialStruct s = new SerialStruct(x,map);;
        attribs.add(s);
    }
