...
import goodman.javax.sql.rowset.serial.SerialDatalink;
import goodman.javax.sql.rowset.serial.SerialException;
import goodman.javax.sql.rowset.serial.SerialJavaObject;
     ...
     */
         ...
         throws SerialException, SQLException
     {
        ...
        switch (baseType) {
            ...
            case Types.BLOB:
            for (int i = 0; i < len; i++) {
                elements[i] = new javax.sql.rowset.serial.SerialBlob((Blob)elements[i]);
            }
            break;

            case Types.CLOB:
                for (int i = 0; i < len; i++) {
                    elements[i] = new javax.sql.rowset.serial.SerialClob((Clob)elements[i]);
                }
            break;
