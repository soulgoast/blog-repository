...
import goodman.javax.sql.rowset.Joinable;
import goodman.javax.sql.rowset.RowSetWarning;
import goodman.javax.sql.rowset.spi.*;
...
public interface CachedRowSet extends RowSet, javax.sql.rowset.Joinable {
    ...
    * @see #getKeyColumns
    * @see javax.sql.rowset.Joinable#setMatchColumn(String)
