...
package goodman.com.sun.corba.se.spi.resolver;
...
public class ResolverDefault {
    ...
    */
    public static com.sun.corba.se.spi.resolver.LocalResolver makeLocalResolver( )
    {
    ...
    */
    public static com.sun.corba.se.spi.resolver.Resolver makeORBInitRefResolver(Operation urlOperation,
                                                                                StringPair[] initRefs )
    {
        return new ORBInitRefResolverImpl( urlOperation, initRefs ) ;
    }

    public static com.sun.corba.se.spi.resolver.Resolver makeORBDefaultInitRefResolver(Operation urlOperation,
    ...
    */
    public static com.sun.corba.se.spi.resolver.Resolver makeBootstrapResolver(ORB orb, String host, int port )
    {
    ...
    * second.resolve( name ).
    */
    public static com.sun.corba.se.spi.resolver.Resolver makeCompositeResolver(com.sun.corba.se.spi.resolver.Resolver first, com.sun.corba.se.spi.resolver.Resolver second )
    {
        return new CompositeResolverImpl( first, second ) ;
    }

    public static Operation makeINSURLOperation( ORB orb, com.sun.corba.se.spi.resolver.Resolver bootstrapResolver )
    {
        return new INSURLOperationImpl(
            (ORB)orb, bootstrapResolver ) ;
    }

    public static com.sun.corba.se.spi.resolver.LocalResolver makeSplitLocalResolver(com.sun.corba.se.spi.resolver.Resolver resolver,
