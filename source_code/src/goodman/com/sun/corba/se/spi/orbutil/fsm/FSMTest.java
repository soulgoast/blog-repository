...
class TestAction1 implements Action
{
    ...
    public TestAction1(com.sun.corba.se.spi.orbutil.fsm.State oldState, Input label, com.sun.corba.se.spi.orbutil.fsm.State newState )
    {
    ...
    private Input label ;
    private com.sun.corba.se.spi.orbutil.fsm.State newState ;
}
...
class TestAction2 implements Action
{
    ...
    public TestAction2(com.sun.corba.se.spi.orbutil.fsm.State oldState, com.sun.corba.se.spi.orbutil.fsm.State newState )
    {
        this.oldState = oldState ;
        this.newState = newState ;
    }
...
class TestAction3 implements Action {
    ...
    public TestAction3(com.sun.corba.se.spi.orbutil.fsm.State oldState, Input label )
    {
        this.oldState = oldState ;
        this.label = label ;
    }
...
public class FSMTest {
    public static final com.sun.corba.se.spi.orbutil.fsm.State STATE1 = new StateImpl( "1" ) ;
    public static final com.sun.corba.se.spi.orbutil.fsm.State STATE2 = new StateImpl( "2" ) ;
    public static final com.sun.corba.se.spi.orbutil.fsm.State STATE3 = new StateImpl( "3" ) ;
    public static final com.sun.corba.se.spi.orbutil.fsm.State STATE4 = new StateImpl( "4" ) ;
    ...
    private static void add1(StateEngine se, com.sun.corba.se.spi.orbutil.fsm.State oldState, Input in, com.sun.corba.se.spi.orbutil.fsm.State newState )
    {
        se.add( oldState, in, new TestAction1( oldState, in, newState ), newState ) ;
    }

    private static void add2(StateEngine se, com.sun.corba.se.spi.orbutil.fsm.State oldState, State newState )
    {
