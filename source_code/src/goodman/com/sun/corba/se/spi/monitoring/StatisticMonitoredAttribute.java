 ...
 *
 */
package goodman.com.sun.corba.se.spi.monitoring;
...
public class StatisticMonitoredAttribute extends MonitoredAttributeBase {
    ...
    private com.sun.corba.se.spi.monitoring.StatisticsAccumulator statisticsAccumulator;
 ...
 */
    public  StatisticMonitoredAttribute(String name, String desc,
                                        com.sun.corba.se.spi.monitoring.StatisticsAccumulator s, Object mutex)
    {
        super( name );
