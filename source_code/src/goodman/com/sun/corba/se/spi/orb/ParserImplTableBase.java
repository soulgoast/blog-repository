...
public abstract class ParserImplTableBase extends ParserImplBase {
    ...
    public ParserImplTableBase( com.sun.corba.se.spi.orb.ParserData[] entries )
    {
    ...
    {
        com.sun.corba.se.spi.orb.PropertyParser result = new PropertyParser() ;
        for (int ctr=0; ctr<entries.length; ctr++ ) {
            com.sun.corba.se.spi.orb.ParserData entry = entries[ctr] ;
    ...
    private static class FieldMap extends AbstractMap {
        ...
        public FieldMap(com.sun.corba.se.spi.orb.ParserData[] entries, boolean useDefault )
        {
            this.entries = entries ;
