...
public interface StateEngine
{
        ...
        */
        public StateEngine add(com.sun.corba.se.spi.orbutil.fsm.State oldState, com.sun.corba.se.spi.orbutil.fsm.Input input, Guard guard,
                               com.sun.corba.se.spi.orbutil.fsm.Action action, com.sun.corba.se.spi.orbutil.fsm.State newState) throws IllegalStateException ;

        /** Add a transition with a guard that always evaluates to true.
        */
        public StateEngine add(com.sun.corba.se.spi.orbutil.fsm.State oldState, Input input,
                               com.sun.corba.se.spi.orbutil.fsm.Action action, com.sun.corba.se.spi.orbutil.fsm.State newState) throws IllegalStateException ;
        ...
        * call it after done() results in an IllegalStateException.
        */
        public StateEngine setDefault(com.sun.corba.se.spi.orbutil.fsm.State oldState, com.sun.corba.se.spi.orbutil.fsm.Action action, com.sun.corba.se.spi.orbutil.fsm.State newState)
                throws IllegalStateException ;

        /** Equivalent to setDefault( oldState, act, newState ) where act is an
         * action that does nothing.
         */
        public StateEngine setDefault(com.sun.corba.se.spi.orbutil.fsm.State oldState, com.sun.corba.se.spi.orbutil.fsm.State newState)
                throws IllegalStateException ;

        /** Euaivalent to setDefault( oldState, oldState )
         */
        public StateEngine setDefault(com.sun.corba.se.spi.orbutil.fsm.State oldState)
                throws IllegalStateException ;
