...
public class StubWrapper implements DynamicStub
{
    ...
    {
        if (!(com.sun.corba.se.spi.presentation.rmi.StubAdapter.isStub(object)))
    ...
    {
        com.sun.corba.se.spi.presentation.rmi.StubAdapter.setDelegate( object, delegate ) ;
    }

    public Delegate getDelegate()
    {
        return com.sun.corba.se.spi.presentation.rmi.StubAdapter.getDelegate( object ) ;
    }

    public ORB getORB()
    {
        return com.sun.corba.se.spi.presentation.rmi.StubAdapter.getORB( object ) ;
    }

    public String[] getTypeIds()
    {
        return com.sun.corba.se.spi.presentation.rmi.StubAdapter.getTypeIds( object ) ;
    }

    public void connect( ORB orb ) throws RemoteException
    {
        com.sun.corba.se.spi.presentation.rmi.StubAdapter.connect( object, (com.sun.corba.se.spi.orb.ORB)orb ) ;
    }

    public boolean isLocal()
    {
        return com.sun.corba.se.spi.presentation.rmi.StubAdapter.isLocal( object ) ;
    }
