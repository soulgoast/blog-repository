...
public class IORFactories {
     ...
     */
    public static com.sun.corba.se.spi.ior.ObjectId makeObjectId(byte[] id )
    {
     ...
     */
    public static com.sun.corba.se.spi.ior.IOR makeIOR(ORB orb, String typeid )
    {
     ...
     */
    public static com.sun.corba.se.spi.ior.IOR makeIOR(ORB orb )
    {
     ...
     */
    public static com.sun.corba.se.spi.ior.IOR makeIOR(InputStream is )
    {
     ...
     * is mutable.
     */
    public static com.sun.corba.se.spi.ior.IORTemplate makeIORTemplate(ObjectKeyTemplate oktemp )
    {
     ...
     */
    public static com.sun.corba.se.spi.ior.IORTemplate makeIORTemplate(InputStream is )
    {
