...
package goodman.com.sun.corba.se.spi.orbutil.threadpool;
...
public interface ThreadPoolManager extends Closeable
{
    ...
    * as a parameter
    */
    public com.sun.corba.se.spi.orbutil.threadpool.ThreadPool getThreadPool(String threadpoolId) throws NoSuchThreadPoolException;
    ...
    * as a parameter
    */
    public com.sun.corba.se.spi.orbutil.threadpool.ThreadPool getThreadPool(int numericIdForThreadpool) throws NoSuchThreadPoolException;
    ...
    */
     ...
     * passed as argument
     */
    public com.sun.corba.se.spi.orbutil.threadpool.ThreadPoolChooser getThreadPoolChooser(String componentId);
     ...
     */
    public com.sun.corba.se.spi.orbutil.threadpool.ThreadPoolChooser getThreadPoolChooser(int componentIndex);
