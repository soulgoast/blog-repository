 ...
 *
 */
package goodman.com.sun.corba.se.spi.oa;
    ...
    implements ObjectAdapter
{
    ...
    abstract public void getInvocationServant( com.sun.corba.se.spi.oa.OAInvocationInfo info ) ;
    ...
    public com.sun.corba.se.spi.oa.OAInvocationInfo makeInvocationInfo(byte[] objectId )
    {
        com.sun.corba.se.spi.oa.OAInvocationInfo info = new OAInvocationInfo( this, objectId ) ;
