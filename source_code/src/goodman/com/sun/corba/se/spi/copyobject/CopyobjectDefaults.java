...
package goodman.com.sun.corba.se.spi.copyobject;
...
public abstract class CopyobjectDefaults
{
    ...
    private static final com.sun.corba.se.spi.copyobject.ObjectCopier referenceObjectCopier = new ReferenceObjectCopierImpl() ;
        ...
        final ObjectCopierFactory f1, final ObjectCopierFactory f2 )
    {
        return new ObjectCopierFactory() {
            public com.sun.corba.se.spi.copyobject.ObjectCopier make()
            {
                com.sun.corba.se.spi.copyobject.ObjectCopier c1 = f1.make() ;
