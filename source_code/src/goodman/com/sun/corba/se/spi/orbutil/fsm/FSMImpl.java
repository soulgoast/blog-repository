...
public class FSMImpl implements FSM
{
    ...
    */
    public FSMImpl( StateEngine se, com.sun.corba.se.spi.orbutil.fsm.State startState )
    {
        this( se, startState, false ) ;
    }

    public FSMImpl(StateEngine se, com.sun.corba.se.spi.orbutil.fsm.State startState, boolean debug )
    {
        state = startState ;
