...
package goodman.com.sun.corba.se.spi.presentation.rmi;
...
public abstract class StubAdapter
{
    ...
    public static boolean isStubClass( Class cls )
    {
        return (ObjectImpl.class.isAssignableFrom( cls )) ||
            (com.sun.corba.se.spi.presentation.rmi.DynamicStub.class.isAssignableFrom( cls )) ;
    }

    public static boolean isStub( Object stub )
    {
        return (stub instanceof com.sun.corba.se.spi.presentation.rmi.DynamicStub) ||
            (stub instanceof ObjectImpl) ;
    }

    public static void setDelegate( Object stub, Delegate delegate )
    {
        if (stub instanceof com.sun.corba.se.spi.presentation.rmi.DynamicStub)
            ((com.sun.corba.se.spi.presentation.rmi.DynamicStub)stub).setDelegate( delegate ) ;
    ...
    {
        if (stub instanceof com.sun.corba.se.spi.presentation.rmi.DynamicStub)
            return ((com.sun.corba.se.spi.presentation.rmi.DynamicStub)stub).getDelegate() ;
        else if (stub instanceof ObjectImpl)
    ...
    {
        if (stub instanceof com.sun.corba.se.spi.presentation.rmi.DynamicStub)
            return ((com.sun.corba.se.spi.presentation.rmi.DynamicStub)stub).getORB() ;
        else if (stub instanceof ObjectImpl)
    ...
    {
        if (stub instanceof com.sun.corba.se.spi.presentation.rmi.DynamicStub)
            return ((com.sun.corba.se.spi.presentation.rmi.DynamicStub)stub).getTypeIds() ;
        else if (stub instanceof ObjectImpl)
    ...
    {
        if (stub instanceof com.sun.corba.se.spi.presentation.rmi.DynamicStub)
            ((com.sun.corba.se.spi.presentation.rmi.DynamicStub)stub).connect(
    ...
    {
        if (stub instanceof com.sun.corba.se.spi.presentation.rmi.DynamicStub)
            return ((com.sun.corba.se.spi.presentation.rmi.DynamicStub)stub).isLocal() ;
        else if (stub instanceof ObjectImpl)
