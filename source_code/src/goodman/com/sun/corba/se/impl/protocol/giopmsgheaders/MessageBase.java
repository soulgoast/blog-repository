...
import goodman.java.lang.Class;
...
public abstract class MessageBase implements com.sun.corba.se.impl.protocol.giopmsgheaders.Message {
    ...
    byte encodingVersion = (byte) com.sun.corba.se.impl.protocol.giopmsgheaders.Message.CDR_ENC_VERSION;
    ...
    public static MessageBase readGIOPMessage(ORB orb, CorbaConnection connection)
    {
        ...
        msg = (MessageBase)readGIOPBody(orb, connection, (com.sun.corba.se.impl.protocol.giopmsgheaders.Message)msg);
        return msg;
    }
    ...
    public static MessageBase readGIOPHeader(ORB orb, CorbaConnection connection)
    {
        ...
        */
        ...
        byte requestEncodingVersion = com.sun.corba.se.impl.protocol.giopmsgheaders.Message.CDR_ENC_VERSION;
        if ((buf.get(4) == 0x0D) &&
            (buf.get(5) <= com.sun.corba.se.impl.protocol.giopmsgheaders.Message.JAVA_ENC_VERSION) &&
            (buf.get(5) > com.sun.corba.se.impl.protocol.giopmsgheaders.Message.CDR_ENC_VERSION) &&
        ...
        case GIOPMessageError:
            ...
            if ( (buf.get(4) == 0x01) && (buf.get(5) == 0x00) ) { // 1.0
                msg = new com.sun.corba.se.impl.protocol.giopmsgheaders.Message_1_0();
            } else if ( (buf.get(4) == 0x01) && (buf.get(5) == 0x01) ) { // 1.1
                msg = new com.sun.corba.se.impl.protocol.giopmsgheaders.Message_1_1();
            } else if ( (buf.get(4) == 0x01) && (buf.get(5) == 0x02) ) { // 1.2
                msg = new com.sun.corba.se.impl.protocol.giopmsgheaders.Message_1_1();
            } else {
                throw wrapper.giopVersionError(
        ...
        if ( (buf.get(4) == 0x01) && (buf.get(5) == 0x00) ) { // 1.0
            com.sun.corba.se.impl.protocol.giopmsgheaders.Message_1_0 msg10 = (com.sun.corba.se.impl.protocol.giopmsgheaders.Message_1_0) msg;
            msg10.magic = magic;
            ...
            com.sun.corba.se.impl.protocol.giopmsgheaders.Message_1_1 msg11 = (com.sun.corba.se.impl.protocol.giopmsgheaders.Message_1_1) msg;
            msg11.magic = magic;
    ...
    public static com.sun.corba.se.impl.protocol.giopmsgheaders.Message readGIOPBody(ORB orb,
                                                                                     CorbaConnection connection,
                                                                                     com.sun.corba.se.impl.protocol.giopmsgheaders.Message msg)
    {
        ReadTimeouts readTimeouts =
                           orb.getORBData().getTransportTCPReadTimeouts();
    ...
    public static RequestMessage createRequest(
        ...
        if (addrDisp == com.sun.corba.se.impl.protocol.giopmsgheaders.KeyAddr.value) {
    ...
    public static com.sun.corba.se.impl.protocol.giopmsgheaders.Message createCloseConnection(GIOPVersion gv) {
        if (gv.equals(GIOPVersion.V1_0)) { // 1.0
            return new com.sun.corba.se.impl.protocol.giopmsgheaders.Message_1_0(com.sun.corba.se.impl.protocol.giopmsgheaders.Message.GIOPBigMagic, false,
                                   com.sun.corba.se.impl.protocol.giopmsgheaders.Message.GIOPCloseConnection, 0);
        } else if (gv.equals(GIOPVersion.V1_1)) { // 1.1
            return new com.sun.corba.se.impl.protocol.giopmsgheaders.Message_1_1(com.sun.corba.se.impl.protocol.giopmsgheaders.Message.GIOPBigMagic, GIOPVersion.V1_1,
                                   FLAG_NO_FRAG_BIG_ENDIAN,
                                   com.sun.corba.se.impl.protocol.giopmsgheaders.Message.GIOPCloseConnection, 0);
        } else if (gv.equals(GIOPVersion.V1_2)) { // 1.2
            return new com.sun.corba.se.impl.protocol.giopmsgheaders.Message_1_1(com.sun.corba.se.impl.protocol.giopmsgheaders.Message.GIOPBigMagic, GIOPVersion.V1_2,
                                   FLAG_NO_FRAG_BIG_ENDIAN,
                                   com.sun.corba.se.impl.protocol.giopmsgheaders.Message.GIOPCloseConnection, 0);
        } else {
            throw wrapper.giopVersionError(
    ...
    public static com.sun.corba.se.impl.protocol.giopmsgheaders.Message createMessageError(GIOPVersion gv) {
        if (gv.equals(GIOPVersion.V1_0)) { // 1.0
            return new Message_1_0(com.sun.corba.se.impl.protocol.giopmsgheaders.Message.GIOPBigMagic, false,
                                   com.sun.corba.se.impl.protocol.giopmsgheaders.Message.GIOPMessageError, 0);
        } else if (gv.equals(GIOPVersion.V1_1)) { // 1.1
            return new com.sun.corba.se.impl.protocol.giopmsgheaders.Message_1_1(com.sun.corba.se.impl.protocol.giopmsgheaders.Message.GIOPBigMagic, GIOPVersion.V1_1,
                                   FLAG_NO_FRAG_BIG_ENDIAN,
                                   com.sun.corba.se.impl.protocol.giopmsgheaders.Message.GIOPMessageError, 0);
        } else if (gv.equals(GIOPVersion.V1_2)) { // 1.2
            return new Message_1_1(com.sun.corba.se.impl.protocol.giopmsgheaders.Message.GIOPBigMagic, GIOPVersion.V1_2,
                                   FLAG_NO_FRAG_BIG_ENDIAN,
                                   com.sun.corba.se.impl.protocol.giopmsgheaders.Message.GIOPMessageError, 0);
        } else {
            throw wrapper.giopVersionError(
    ...
    static ObjectKey extractObjectKey(TargetAddress target, ORB orb) {
        ...
        case ORBConstants.ADDR_DISP_OBJKEY :
            if (reqAddrDisp != com.sun.corba.se.impl.protocol.giopmsgheaders.KeyAddr.value) {
                throw new AddressingDispositionException(com.sun.corba.se.impl.protocol.giopmsgheaders.KeyAddr.value);
            }
            break;
