...
abstract class DynAnyConstructedImpl extends com.sun.corba.se.impl.dynamicany.DynAnyImpl
{
    ...
    public Any to_any() {
        ...
        return com.sun.corba.se.impl.dynamicany.DynAnyUtil.copy(any, orb);
    }
    ...
    public boolean equal (DynAny dyn_any) {
        ...
        try {
            ...
            com.sun.corba.se.impl.dynamicany.DynAnyUtil.set_current_component(dyn_any, currentComponent);
        }
        return true;
    }
    ...
    public DynAny copy() {
        ...
        checkInitAny();
        try {
            return com.sun.corba.se.impl.dynamicany.DynAnyUtil.createMostDerivedDynAny(any, orb, true);
               ...
               InvalidValue
    {
        ...
        if (com.sun.corba.se.impl.dynamicany.DynAnyUtil.isConstructedDynAny(currentComponent))
