...
public final class TypeCodeImpl extends TypeCode
{
    ...
    private com.sun.corba.se.impl.corba.AnyImpl _unionLabels[]  = null; // values of union labels
    ...
    // also see the 'convertToNative(ORB orb, TypeCode tc)' function
    {
        ...
        try {
            ...
            case TCKind._tk_union:
                ...
                _unionLabels = new com.sun.corba.se.impl.corba.AnyImpl[_memberCount];
                for (int i=0; i < _memberCount; i++)
                    _unionLabels[i] = new com.sun.corba.se.impl.corba.AnyImpl(_orb, tc.member_label(i));
                break;
            }
                        ...
                        // for unions
    {
        ...
        if (creationKind == TCKind._tk_union) {
            ...
            for (int i = 0 ; i < _memberCount ; i++) {
                ...
                _memberTypes[i] = convertToNative(_orb, members[i].type);
                _memberTypes[i].setParent(this);
                _unionLabels[i] = new com.sun.corba.se.impl.corba.AnyImpl(_orb, members[i].label);
        ...
        throws BadKind, org.omg.CORBA.TypeCodePackage.Bounds
    {
        ...
        case TCKind._tk_union:
            try {
                ...
                return new com.sun.corba.se.impl.corba.AnyImpl(_orb, _unionLabels[index]);
            } catch (ArrayIndexOutOfBoundsException e) {
                throw new org.omg.CORBA.TypeCodePackage.Bounds();
            }
        default:
                ...
                case TCKind._tk_union:
                    {
                        ...
                        for (int i=0; i < _memberCount; i++) {
                            _unionLabels[i] = new com.sun.corba.se.impl.corba.AnyImpl((ORB)is.orb());
                            if (i == _defaultIndex)
