...
package goodman.com.sun.corba.se.impl.interceptors;
...
public class SlotTableStack
{
    ...
    private class SlotTablePool {
        ...
        private com.sun.corba.se.impl.interceptors.SlotTable[] pool;
        ...
        SlotTablePool( ) {
            pool = new com.sun.corba.se.impl.interceptors.SlotTable[HIGH_WATER_MARK];
            currentIndex = 0;
        }
         ...
         */
        void putSlotTable( com.sun.corba.se.impl.interceptors.SlotTable table ) {
     ...
     */
    SlotTableStack( ORB orb, com.sun.corba.se.impl.interceptors.SlotTable table ) {
       this.orb = orb;
     ...
     */
    void pushSlotTable( ) {
        com.sun.corba.se.impl.interceptors.SlotTable table = tablePool.getSlotTable( );
        if( table == null ) {
            // get an existing PICurrent to get the slotSize
            com.sun.corba.se.impl.interceptors.SlotTable tableTemp = peekSlotTable();
            table = new com.sun.corba.se.impl.interceptors.SlotTable( orb, tableTemp.getSize( ));
        }
    ...
    void  popSlotTable( ) {
        ...
        currentIndex--;
        com.sun.corba.se.impl.interceptors.SlotTable table = (com.sun.corba.se.impl.interceptors.SlotTable)tableContainer.get( currentIndex );
     ...
     * popping.
     */
    com.sun.corba.se.impl.interceptors.SlotTable peekSlotTable( ) {
