...
import com.sun.corba.se.impl.dynamicany.DynValueCommonImpl;
...
public class DynValueBoxImpl extends DynValueCommonImpl implements DynValueBox
{
    ...
    protected boolean initializeComponentsFromAny() {
        try {
            components = new DynAny[] {com.sun.corba.se.impl.dynamicany.DynAnyUtil.createMostDerivedDynAny(any, orb, false)};
    ...
    protected boolean initializeComponentsFromTypeCode() {
        try {
            any = com.sun.corba.se.impl.dynamicany.DynAnyUtil.createDefaultAnyOfType(any.type(), orb);
