...
package goodman.com.sun.corba.se.impl.ior;
    ...
    */
        ...
        int orbid, int poaid)
    {
        super( orb, magic, scid, serverid,
            ...
            new com.sun.corba.se.impl.ior.ObjectAdapterIdNumber( poaid ) ) ;
    }
    ...
    public void writeTemplate(OutputStream os)
    {
        ...
        com.sun.corba.se.impl.ior.ObjectAdapterIdNumber oaid = (ObjectAdapterIdNumber)(getObjectAdapterId()) ;
