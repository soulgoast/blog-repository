...
package goodman.com.sun.corba.se.impl.naming.pcosnaming;
...
public class ServantManagerImpl extends LocalObject implements ServantLocator
{
    ...
    private com.sun.corba.se.impl.naming.pcosnaming.NameService theNameService;
    ...
    public com.sun.corba.se.impl.naming.pcosnaming.NamingContextImpl readInContext(String objKey)
    {
        com.sun.corba.se.impl.naming.pcosnaming.NamingContextImpl context = (com.sun.corba.se.impl.naming.pcosnaming.NamingContextImpl) contexts.get(objKey);
        if( context != null )
        {
        ...
        if (contextFile.exists()) {
            try {
                ...
                context = (com.sun.corba.se.impl.naming.pcosnaming.NamingContextImpl) ois.readObject();
                context.setORB( orb );
    ...
    public com.sun.corba.se.impl.naming.pcosnaming.NamingContextImpl addContext(String objKey,
                                                                                com.sun.corba.se.impl.naming.pcosnaming.NamingContextImpl context)
    {
        File contextFile =  new File(logDir, objKey);
