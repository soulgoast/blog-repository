               ...
               AlreadyBound
    {
        ...
        if( updateLogger.isLoggable( Level.FINE  ) ) {
            ...
            updateLogger.fine( LogKeywords.NAMING_BIND_SUCCESS + " Name = " +
                com.sun.corba.se.impl.naming.cosnaming.NamingUtils.getDirectoryStructuredName( n ) );
        }
    }
               ...
               InvalidName
    {
        ...
        if( obj != null ) {
            if( readLogger.isLoggable( Level.FINE ) ) {
                 ...
                 " Name: " + com.sun.corba.se.impl.naming.cosnaming.NamingUtils.getDirectoryStructuredName( n ) );
            }
        } else {
