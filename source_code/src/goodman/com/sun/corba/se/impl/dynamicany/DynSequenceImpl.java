...
import com.sun.corba.se.impl.dynamicany.DynAnyCollectionImpl;
...
public class DynSequenceImpl extends DynAnyCollectionImpl implements DynSequence
{
    ...
    protected boolean initializeComponentsFromAny() {
        ...
        for (int i=0; i<length; i++) {
            ...
            anys[i] = com.sun.corba.se.impl.dynamicany.DynAnyUtil.extractAnyFromStream(contentType, input, orb);
            try {
