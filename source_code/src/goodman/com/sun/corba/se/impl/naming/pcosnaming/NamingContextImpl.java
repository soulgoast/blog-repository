...
import com.sun.corba.se.impl.naming.pcosnaming.*;
    ...
    implements NamingContextDataStore, Serializable
{
    ...
    private transient com.sun.corba.se.impl.naming.pcosnaming.NameService theNameServiceHandle;
    ...
    public NamingContextImpl(ORB orb, String objKey,
                             com.sun.corba.se.impl.naming.pcosnaming.NameService theNameService, ServantManagerImpl theServantManagerImpl  )
        throws Exception
    {
        super();
