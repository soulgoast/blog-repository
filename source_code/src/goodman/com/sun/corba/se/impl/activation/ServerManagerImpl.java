    ...
    implements BadServerIdHandler
{
        ...
        throws ServerAlreadyActive, ServerNotRegistered, ServerHeldDown
    {
        ...
        com.sun.corba.se.impl.activation.ServerTableEntry entry;
        Integer key = new Integer(serverId);

        synchronized(serverTable) {
            entry = (com.sun.corba.se.impl.activation.ServerTableEntry) serverTable.get(key);
        }
    ...
    public int[] getActiveServers()
    {
        ...
        synchronized (serverTable) {
            ...
            for (int i = 0; i < servers.size(); i++) {
                entry = (com.sun.corba.se.impl.activation.ServerTableEntry) servers.get(i);
    ...
    public void shutdown(int serverId) throws ServerNotActive
    {
        ...
        synchronized(serverTable) {
            entry = (com.sun.corba.se.impl.activation.ServerTableEntry) serverTable.remove(key);
    ...
    private com.sun.corba.se.impl.activation.ServerTableEntry getEntry(int serverId )
        throws ServerNotRegistered
    {
        Integer key = new Integer(serverId);
        com.sun.corba.se.impl.activation.ServerTableEntry entry = null ;
        ...
        synchronized (serverTable) {
            ...
            if (entry == null) {
                ...
                entry = new com.sun.corba.se.impl.activation.ServerTableEntry( wrapper,
    ...
    private ServerLocation locateServer (com.sun.corba.se.impl.activation.ServerTableEntry entry, String endpointType,
                                         boolean block)
    ...
    private ServerLocationPerORB locateServerForORB (com.sun.corba.se.impl.activation.ServerTableEntry entry, String orbId,
                                                     boolean block)
    ...
    {
        try {
            com.sun.corba.se.impl.activation.ServerTableEntry entry = getEntry( serverId ) ;
    ...
    private com.sun.corba.se.impl.activation.ServerTableEntry getRunningEntry(int serverId )
        throws ServerNotRegistered
    {
        com.sun.corba.se.impl.activation.ServerTableEntry entry = getEntry( serverId ) ;
    ...
    {
        com.sun.corba.se.impl.activation.ServerTableEntry entry = getRunningEntry( serverId ) ;
        if (entry != null) {
    ...
    {
        com.sun.corba.se.impl.activation.ServerTableEntry entry =
            (com.sun.corba.se.impl.activation.ServerTableEntry) serverTable.get( new Integer(serverId) );

        if (entry != null) {

            entry =
                (com.sun.corba.se.impl.activation.ServerTableEntry) serverTable.remove(new Integer(serverId));
