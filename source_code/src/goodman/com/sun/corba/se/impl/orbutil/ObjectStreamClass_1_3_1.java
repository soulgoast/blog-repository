...
import goodman.java.security.MessageDigest;
import goodman.java.security.NoSuchAlgorithmException;
import goodman.java.security.DigestOutputStream;
...
import goodman.java.lang.reflect.Member;
...
import goodman.java.io.DataOutputStream;
import goodman.java.io.ByteArrayOutputStream;
import goodman.java.io.InvalidClassException;
import goodman.java.io.Serializable;
import goodman.java.io.Externalizable;
...
public class ObjectStreamClass_1_3_1 implements Serializable {
    ...
    public com.sun.corba.se.impl.orbutil.ObjectStreamField[] getFields() {
        ...
        if (fields.length > 0) {
            com.sun.corba.se.impl.orbutil.ObjectStreamField[] dup = new com.sun.corba.se.impl.orbutil.ObjectStreamField[fields.length];
    ...
    final com.sun.corba.se.impl.orbutil.ObjectStreamField[] getFieldsNoCopy() {
        return fields;
    }
        ...
        if (!serializable ||
            ...
            AccessController.doPrivileged(new PrivilegedAction() {
                ...
                try {
                    ...
                    {
                        fields = (com.sun.corba.se.impl.orbutil.ObjectStreamField[])translateFields((Object[])pf.get(cl));
                    }
                ...
                if (fields == null) {
                    ...
                    int numFields = 0;
                    com.sun.corba.se.impl.orbutil.ObjectStreamField[] tempFields =
                        new com.sun.corba.se.impl.orbutil.ObjectStreamField[actualfields.length];
                    for (int i = 0; i < actualfields.length; i++) {
                        int modifiers = actualfields[i].getModifiers();
                        if (!Modifier.isStatic(modifiers) &&
                            !Modifier.isTransient(modifiers)) {
                            tempFields[numFields++] =
                                new com.sun.corba.se.impl.orbutil.ObjectStreamField(actualfields[i]);
                        }
                    }
                    fields = new com.sun.corba.se.impl.orbutil.ObjectStreamField[numFields];
    ...
    private static long computeStructuralUID(ObjectStreamClass_1_3_1 osc, Class<?> cl) {
        ...
        try {
            ...
            com.sun.corba.se.impl.orbutil.ObjectStreamField[] fields = osc.getFields();
     ...
     * type and name.
     */
    private com.sun.corba.se.impl.orbutil.ObjectStreamField[] fields;
    ...
    public static final com.sun.corba.se.impl.orbutil.ObjectStreamField[] NO_FIELDS =
        new com.sun.corba.se.impl.orbutil.ObjectStreamField[0];
