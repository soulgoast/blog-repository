...
*/
        ...
        for (int i=0; i<value.length; i++) {
            if (value[i] != null) {
                ...
                try {
                    ...
                    memberDynAny = com.sun.corba.se.impl.dynamicany.DynAnyUtil.createMostDerivedDynAny(memberAny, orb, false);
    ...
    protected boolean initializeComponentsFromAny() {
        ...
        for (int i=0; i<length; i++) {
            ...
            memberAny = com.sun.corba.se.impl.dynamicany.DynAnyUtil.extractAnyFromStream(memberType, input, orb);
            try {
                // Creates the appropriate subtype without copying the Any
                memberDynAny = com.sun.corba.se.impl.dynamicany.DynAnyUtil.createMostDerivedDynAny(memberAny, orb, false);
                // _DEBUG_
