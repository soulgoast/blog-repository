...
public class TypeCodeInputStream extends EncapsInputStream implements com.sun.corba.se.impl.encoding.TypeCodeReader
{
    ...
    public com.sun.corba.se.impl.encoding.TypeCodeReader getTopLevelStream() {
        if (enclosure == null)
            return this;
        if (enclosure instanceof com.sun.corba.se.impl.encoding.TypeCodeReader)
            return ((com.sun.corba.se.impl.encoding.TypeCodeReader)enclosure).getTopLevelStream();
        return this;
    }

    public int getTopLevelPosition() {
        if (enclosure != null && enclosure instanceof com.sun.corba.se.impl.encoding.TypeCodeReader) {
