...
package goodman.com.sun.corba.se.impl.oa.toa;
...
public class TOAFactory implements ObjectAdapterFactory
{
    ...
    public synchronized com.sun.corba.se.impl.oa.toa.TOA getTOA(String codebase )
    {
        com.sun.corba.se.impl.oa.toa.TOA toa = (com.sun.corba.se.impl.oa.toa.TOA)(codebaseToTOA.get( codebase )) ;
        if (toa == null) {
