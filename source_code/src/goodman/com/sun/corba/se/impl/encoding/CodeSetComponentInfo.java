...
public final class CodeSetComponentInfo {
    ...
    public static final class CodeSetComponent {
        ...
        public void read(com.sun.corba.se.impl.encoding.MarshalInputStream in) {
        ...
        public void write(com.sun.corba.se.impl.encoding.MarshalOutputStream out) {
    ...
    static {
        CodeSetComponent charData
            = new CodeSetComponent(com.sun.corba.se.impl.encoding.OSFCodeSetRegistry.ISO_8859_1.getNumber(),
                                   new int[] {
                                       com.sun.corba.se.impl.encoding.OSFCodeSetRegistry.UTF_8.getNumber(),
                                       com.sun.corba.se.impl.encoding.OSFCodeSetRegistry.ISO_646.getNumber()
                                   });

        CodeSetComponent wcharData
            = new CodeSetComponent(com.sun.corba.se.impl.encoding.OSFCodeSetRegistry.UTF_16.getNumber(),
                                   new int[]
                                   {
                                       com.sun.corba.se.impl.encoding.OSFCodeSetRegistry.UCS_2.getNumber()
                                   });
    ...
    public static CodeSetComponent createFromString(String str) {
        ...
        try {
            ...
            if (com.sun.corba.se.impl.encoding.OSFCodeSetRegistry.lookupEntry(nativeSet) == null)
            ...
            while (stok.hasMoreTokens()) {
                ...
                if (com.sun.corba.se.impl.encoding.OSFCodeSetRegistry.lookupEntry(value.intValue()) == null)
    ...
    public static final CodeSetContext LOCAL_CODE_SETS
        = new CodeSetContext(com.sun.corba.se.impl.encoding.OSFCodeSetRegistry.ISO_8859_1.getNumber(),
