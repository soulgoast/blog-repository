...
public abstract class POAPolicyMediatorBase implements POAPolicyMediator {
    ...
    private com.sun.corba.se.impl.oa.poa.Policies policies ;
    ...
    public final com.sun.corba.se.impl.oa.poa.Policies getPolicies()
    {
        return policies ;
    }
    ...
    POAPolicyMediatorBase(Policies policies, POAImpl poa )
    {
        ...
        com.sun.corba.se.impl.oa.poa.POAManagerImpl poam = (POAManagerImpl)(poa.the_POAManager()) ;
