...
public abstract class POAPolicyMediatorBase_R extends POAPolicyMediatorBase {
    ...
    POAPolicyMediatorBase_R(Policies policies, POAImpl poa )
    {
        ...
        activeObjectMap = com.sun.corba.se.impl.oa.poa.ActiveObjectMap.create(poa, !isUnique);
    }
    ...
    protected Servant internalKeyToServant( com.sun.corba.se.impl.oa.poa.ActiveObjectMap.Key key )
    {
    ...
    protected void activateServant(com.sun.corba.se.impl.oa.poa.ActiveObjectMap.Key key, com.sun.corba.se.impl.oa.poa.AOMEntry entry, Servant servant )
    {
        ...
        if (Util.isInstanceDefined()) {
            com.sun.corba.se.impl.oa.poa.POAManagerImpl pm = (com.sun.corba.se.impl.oa.poa.POAManagerImpl)poa.the_POAManager() ;
            com.sun.corba.se.impl.oa.poa.POAFactory factory = pm.getFactory() ;
    ...
    protected void deactivateHelper(com.sun.corba.se.impl.oa.poa.ActiveObjectMap.Key key, com.sun.corba.se.impl.oa.poa.AOMEntry entry,
                                    Servant s ) throws ObjectNotActive, WrongPolicy
    {
        ...
        if (Util.isInstanceDefined()) {
            com.sun.corba.se.impl.oa.poa.POAManagerImpl pm = (POAManagerImpl)poa.the_POAManager() ;
            POAFactory factory = pm.getFactory() ;
            factory.unregisterPOAForServant(poa, s);
        }
    }

    public Servant deactivateObject( com.sun.corba.se.impl.oa.poa.ActiveObjectMap.Key key )
        throws ObjectNotActive, WrongPolicy
    {
        if (orb.poaDebugFlag) {
