...
import goodman.java.nio.charset.MalformedInputException;
import goodman.java.nio.charset.UnsupportedCharsetException;
import goodman.java.nio.charset.UnmappableCharacterException;
...
public class CodeSetConversion
{
    ...
    // converters.
    private com.sun.corba.se.impl.encoding.CodeSetCache cache = new com.sun.corba.se.impl.encoding.CodeSetCache();
}
