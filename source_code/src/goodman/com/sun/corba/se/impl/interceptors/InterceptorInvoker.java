...
public class InterceptorInvoker {
    ...
    private com.sun.corba.se.impl.interceptors.InterceptorList interceptorList;
    ...
    // PICurrent variable.
    private com.sun.corba.se.impl.interceptors.PICurrent current;
     ...
     */
    InterceptorInvoker( ORB orb, com.sun.corba.se.impl.interceptors.InterceptorList interceptorList,
                        PICurrent piCurrent )
    {
        this.orb = orb;
    ...
    void objectAdapterCreated( ObjectAdapter oa ) {
        ...
        if( enabled ) {
            ...
            com.sun.corba.se.impl.interceptors.IORInfoImpl info = new IORInfoImpl( oa );

            // Call each IORInterceptor:
            IORInterceptor[] iorInterceptors =
                (IORInterceptor[])interceptorList.getInterceptors(
                com.sun.corba.se.impl.interceptors.InterceptorList.INTERCEPTOR_TYPE_IOR );
        ...
        if( enabled ) {
            try {
                ...
                ClientRequestInterceptor[] clientInterceptors =
                    ...
                    getInterceptors( com.sun.corba.se.impl.interceptors.InterceptorList.INTERCEPTOR_TYPE_CLIENT );
        ...
        if( enabled ) {
            try {
                ...
                ServerRequestInterceptor[] serverInterceptors =
                    ...
                    getInterceptors( com.sun.corba.se.impl.interceptors.InterceptorList.INTERCEPTOR_TYPE_SERVER );
        ...
        ServerRequestInfoImpl info )
    {
                         ...
                         ServerRequestInfoImpl.CALL_INTERMEDIATE_NONE ) )
        {
            ...
            ServerRequestInterceptor[] serverInterceptors =
                ...
                com.sun.corba.se.impl.interceptors.InterceptorList.INTERCEPTOR_TYPE_SERVER );
            int size = serverInterceptors.length;
