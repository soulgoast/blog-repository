...
package goodman.com.sun.corba.se.impl.dynamicany;

import com.sun.corba.se.impl.dynamicany.DynAnyConstructedImpl;
...
public class DynUnionImpl extends DynAnyConstructedImpl implements DynUnion
{
    ...
    protected boolean initializeComponentsFromAny() {
        try {
            ...
            Any discriminatorAny = com.sun.corba.se.impl.dynamicany.DynAnyUtil.extractAnyFromStream(discriminatorType(), input, orb);
            discriminator = com.sun.corba.se.impl.dynamicany.DynAnyUtil.createMostDerivedDynAny(discriminatorAny, orb, false);
            currentMemberIndex = currentUnionMemberIndex(discriminatorAny);
            Any memberAny = com.sun.corba.se.impl.dynamicany.DynAnyUtil.extractAnyFromStream(memberType(currentMemberIndex), input, orb);
            currentMember = com.sun.corba.se.impl.dynamicany.DynAnyUtil.createMostDerivedDynAny(memberAny, orb, false);
    ...
    protected boolean initializeComponentsFromTypeCode() {
        ...
        try {
            ...
            discriminator = com.sun.corba.se.impl.dynamicany.DynAnyUtil.createMostDerivedDynAny(memberLabel(0), orb, false);
            index = 0;
            currentMemberIndex = 0;
            currentMember = com.sun.corba.se.impl.dynamicany.DynAnyUtil.createMostDerivedDynAny(memberType(0), orb);
            components = new DynAny[] {discriminator, currentMember};
        } catch (InconsistentTypeCode ictc) { // impossible
        }
        return true;
    ...
    */
        ...
        throws TypeMismatch
    {
        ...
        newDiscriminator = com.sun.corba.se.impl.dynamicany.DynAnyUtil.convertToNative(newDiscriminator, orb);
        ...
        if (newCurrentMemberIndex == NO_INDEX) {
            ...
            if (currentMemberIndex == NO_INDEX || newCurrentMemberIndex != currentMemberIndex) {
                ...
                try {
                currentMember = com.sun.corba.se.impl.dynamicany.DynAnyUtil.createMostDerivedDynAny(memberType(currentMemberIndex), orb);
        ...
        throws TypeMismatch
    {
        ...
        try {
            ...
            currentMember = com.sun.corba.se.impl.dynamicany.DynAnyUtil.createMostDerivedDynAny(memberType(defaultIndex), orb);
            components = new DynAny[] {discriminator, currentMember};
