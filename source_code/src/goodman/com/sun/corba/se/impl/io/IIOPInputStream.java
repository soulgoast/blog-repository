...
import goodman.java.io.WriteAbortedException;
...
import goodman.javax.rmi.PortableRemoteObject;
...
// d11623 : implement readFully, required for serializing some core classes
    ...
    private Object inputObjectField(ValueMember field,
        ...
        if (type != null)
            signature = com.sun.corba.se.impl.io.ValueUtility.getSignature(field);
