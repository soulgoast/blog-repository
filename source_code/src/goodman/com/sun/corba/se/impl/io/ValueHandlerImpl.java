...
package goodman.com.sun.corba.se.impl.io;
...
public final class ValueHandlerImpl implements javax.rmi.CORBA.ValueHandlerMultiFormat {
    ...
    private com.sun.corba.se.impl.io.IIOPOutputStream outputStreamBridge = null;
    private com.sun.corba.se.impl.io.IIOPInputStream inputStreamBridge = null;
    ...
    private void writeValueWithVersion(org.omg.CORBA.portable.OutputStream _out,
        ...
        com.sun.corba.se.impl.io.IIOPOutputStream jdkToOrbOutputStreamBridge = null;

        if (outputStreamPairs == null)
            outputStreamPairs = new Hashtable();

        jdkToOrbOutputStreamBridge = (com.sun.corba.se.impl.io.IIOPOutputStream)outputStreamPairs.get(_out);
    ...
    private void writeValueInternal(com.sun.corba.se.impl.io.IIOPOutputStream bridge,
                                    org.omg.CORBA_2_3.portable.OutputStream out,
                                    java.io.Serializable value,
                                    byte streamFormatVersion)
    {
                                          ...
                                          org.omg.SendingContext.RunTime _sender)
    {
        ...
        com.sun.corba.se.impl.io.IIOPInputStream jdkToOrbInputStreamBridge = null;
        if (inputStreamPairs == null)
            inputStreamPairs = new Hashtable();

        jdkToOrbInputStreamBridge = (com.sun.corba.se.impl.io.IIOPInputStream)inputStreamPairs.get(_in);
    ...
    private java.io.Serializable readValueInternal(com.sun.corba.se.impl.io.IIOPInputStream bridge,
                                                   org.omg.CORBA_2_3.portable.InputStream in,
                                                   int offset,
                                                   Class clazz,
                                                   String repositoryID,
    ...
    public org.omg.SendingContext.RunTime getRunTimeCodeBase() {
        if (codeBase != null)
            ...
            codeBase = new com.sun.corba.se.impl.io.FVDCodeBaseImpl();

            // backward compatability 4365188
            // set the valueHandler so that correct/incorrect RepositoryID
            // calculations can be done based on the ORB version
            com.sun.corba.se.impl.io.FVDCodeBaseImpl fvdImpl = (FVDCodeBaseImpl) codeBase;
    ...
    private Object read_Array(com.sun.corba.se.impl.io.IIOPInputStream bridge,
                              org.omg.CORBA_2_3.portable.InputStream in,
                              Class sequence,
                              CodeBase sender,
                              int offset)
   ...
   private com.sun.corba.se.impl.io.IIOPOutputStream createOutputStream() {
        ...
        try {
             com.sun.corba.se.impl.io.IIOPOutputStream stream = createOutputStreamBuiltIn(name);
             if (stream != null) {
                 return stream;
             }
             return createCustom(com.sun.corba.se.impl.io.IIOPOutputStream.class, name);
        } catch (Throwable t) {
     ...
     */
    private com.sun.corba.se.impl.io.IIOPOutputStream createOutputStreamBuiltIn(
        final String name
    ) throws Throwable {
        try {
            return AccessController.doPrivileged(
                new PrivilegedExceptionAction<com.sun.corba.se.impl.io.IIOPOutputStream>() {
                    public com.sun.corba.se.impl.io.IIOPOutputStream run() throws IOException {
     ...
     * Returning null indicates a non-built is specified.
     */
    private com.sun.corba.se.impl.io.IIOPOutputStream createOutputStreamBuiltInNoPriv(
        final String name
    ) throws IOException {
        return name.equals(com.sun.corba.se.impl.io.IIOPOutputStream.class.getName()) ?
    ...
    private com.sun.corba.se.impl.io.IIOPInputStream createInputStream() {
        ...
        try {
             com.sun.corba.se.impl.io.IIOPInputStream stream = createInputStreamBuiltIn(name);
             if (stream != null) {
                 return stream;
             }
             return createCustom(com.sun.corba.se.impl.io.IIOPInputStream.class, name);
        } catch (Throwable t) {
            // Throw exception under the carpet.
            InternalError ie = new InternalError(
                "Error loading " + name
     ...
     * Returning null indicates a non-built is specified.
     */
     private com.sun.corba.se.impl.io.IIOPInputStream createInputStreamBuiltIn(
         final String name
     ) throws Throwable {
         try {
             return AccessController.doPrivileged(
                 new PrivilegedExceptionAction<com.sun.corba.se.impl.io.IIOPInputStream>() {
                     public com.sun.corba.se.impl.io.IIOPInputStream run() throws IOException {
      ...
      * Returning null indicates a non-built is specified.
      */
     private com.sun.corba.se.impl.io.IIOPInputStream createInputStreamBuiltInNoPriv(
         final String name
     ) throws IOException {
         return name.equals(com.sun.corba.se.impl.io.IIOPInputStream.class.getName()) ?
