    ...
    implements RequestInfo, RequestInfoExt
{
    ...
    protected com.sun.corba.se.impl.interceptors.SlotTable slotTable;
    ...
    public RequestInfoImpl( ORB myORB ) {
        ...
        com.sun.corba.se.impl.interceptors.PICurrent current = (PICurrent)(myORB.getPIHandler().getPICurrent());
