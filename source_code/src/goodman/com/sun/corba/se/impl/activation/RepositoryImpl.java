    ...
    implements Serializable
{
        ...
        throws ServerAlreadyRegistered, BadServerDefinition
    {
        ...
        switch (entry.verify()) {
        case com.sun.corba.se.impl.activation.ServerMain.OK:
            break;
        case com.sun.corba.se.impl.activation.ServerMain.MAIN_CLASS_NOT_FOUND:
            throw new BadServerDefinition("main class not found.");
        case com.sun.corba.se.impl.activation.ServerMain.NO_MAIN_METHOD:
