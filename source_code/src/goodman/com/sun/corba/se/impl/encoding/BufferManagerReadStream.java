    ...
    implements BufferManagerRead, com.sun.corba.se.impl.encoding.MarkAndResetHandler
{
    ...
    private com.sun.corba.se.impl.encoding.BufferQueue fragmentQueue = new BufferQueue();
    ...
    {
        com.sun.corba.se.impl.encoding.ByteBufferWithInfo bbwi =
            new com.sun.corba.se.impl.encoding.ByteBufferWithInfo(orb, byteBuffer, msg.getHeaderLength());
    ...
    public com.sun.corba.se.impl.encoding.ByteBufferWithInfo underflow (com.sun.corba.se.impl.encoding.ByteBufferWithInfo bbwi)
    {
      ...
      com.sun.corba.se.impl.encoding.ByteBufferWithInfo result = null;
    ...
    public void close(com.sun.corba.se.impl.encoding.ByteBufferWithInfo bbwi)
    {
        ...
        if (fragmentQueue != null)
        {
            synchronized (fragmentQueue)
            {
                ...
                com.sun.corba.se.impl.encoding.ByteBufferWithInfo abbwi = null;
                ByteBufferPool byteBufferPool = getByteBufferPool();
                while (fragmentQueue.size() != 0)
                {
        ...
        if (fragmentStack != null && fragmentStack.size() != 0)
        {
            ...
            while (itr.hasNext())
            {
                abbwi = (com.sun.corba.se.impl.encoding.ByteBufferWithInfo)itr.next();
    ...
    public void fragmentationOccured(com.sun.corba.se.impl.encoding.ByteBufferWithInfo newFragment)
    {
        ...
        fragmentStack.addFirst(new com.sun.corba.se.impl.encoding.ByteBufferWithInfo(newFragment));
    }
