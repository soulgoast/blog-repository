...
public class InvocationHandlerFactoryImpl implements InvocationHandlerFactory
{
        ...
        Serializable
    {
        ...
        {
            ((com.sun.corba.se.impl.presentation.rmi.DynamicStubImpl)stub).setSelf( (DynamicStub)proxy ) ;
        }

        public Proxy getProxy()
        {
            return (Proxy)((com.sun.corba.se.impl.presentation.rmi.DynamicStubImpl)stub).getSelf() ;
        }
