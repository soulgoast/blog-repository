...
public class ImageUtil {
    ...
    */
    ...
    public static byte[] getPackedBinaryData(Raster raster,
        ...
        if(!isBinary(sm)) {
            throw new IllegalArgumentException(com.sun.imageio.plugins.common.I18N.getString("ImageUtil0"));
        }
    ...
    public static ColorModel createColorModel(ColorSpace colorSpace,
        ...
        if(sampleModel == null) {
            throw new IllegalArgumentException(com.sun.imageio.plugins.common.I18N.getString("ImageUtil1"));
        }
