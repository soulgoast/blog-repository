...
import goodman.javax.imageio.event.IIOReadProgressListener;
...
import goodman.java.awt.image.ComponentColorModel;
...
class JFIFMarkerSegment extends com.sun.imageio.plugins.jpeg.MarkerSegment {
     ...
     */
    JFIFMarkerSegment() {
        super(com.sun.imageio.plugins.jpeg.JPEG.APP0);
        majorVersion = 1;
        minorVersion = 2;
        resUnits = com.sun.imageio.plugins.jpeg.JPEG.DENSITY_UNIT_ASPECT_RATIO;
        Xdensity = 1;
        Ydensity = 1;
        thumbWidth = 0;
        thumbHeight = 0;
     ...
     * in a JPEGBuffer.
     */
    JFIFMarkerSegment(com.sun.imageio.plugins.jpeg.JPEGBuffer buffer) throws IOException {
        super(buffer);
     ...
     */
    void addJFXX(com.sun.imageio.plugins.jpeg.JPEGBuffer buffer, com.sun.imageio.plugins.jpeg.JPEGImageReader reader)
        throws IOException {
     ...
     * in the JPEGBuffer.
     */
    void addICC(com.sun.imageio.plugins.jpeg.JPEGBuffer buffer) throws IOException {
        if (inICC == false) {
            if (iccSegment != null) {
    ...
    BufferedImage getThumbnail(ImageInputStream iis,
                               int index,
                               com.sun.imageio.plugins.jpeg.JPEGImageReader reader) throws IOException {
    ...
    void write(ImageOutputStream ios,
               com.sun.imageio.plugins.jpeg.JPEGImageWriter writer) throws IOException {
        // No thumbnail
    ...
    void write(ImageOutputStream ios,
        ...
        if (thumb != null) {
            ...
            if ((thumbWidth > MAX_THUMB_WIDTH)
                ...
                writer.warningOccurred(com.sun.imageio.plugins.jpeg.JPEGImageWriter.WARNING_THUMB_CLIPPED);
            }
        ...
        if (cm instanceof IndexColorModel) {
            ...
            if (jfxx == null) {
                ...
                if (jfxx.code == THUMB_PALETTE) {
                    ...
                    writer.warningOccurred
                        (com.sun.imageio.plugins.jpeg.JPEGImageWriter.WARNING_NO_RGB_THUMB_AS_INDEXED);
                } else {
            ...
            if (jfxx == null) {
                ...
                if (jfxx.code == THUMB_RGB) {
                    ...
                    writeJFXXSegment(index, thumb, ios, writer); // default
                    writer.warningOccurred
                        (com.sun.imageio.plugins.jpeg.JPEGImageWriter.WARNING_NO_GRAY_THUMB_AS_INDEXED);
                }
            }
        } else {
            writer.warningOccurred
                (com.sun.imageio.plugins.jpeg.JPEGImageWriter.WARNING_ILLEGAL_THUMBNAIL);
        }
    }
    ...
    static void writeDefaultJFIF(ImageOutputStream ios,
                                 ...
                                 com.sun.imageio.plugins.jpeg.JPEGImageWriter writer)
        throws IOException {
    ...
    class JFIFExtensionMarkerSegment extends com.sun.imageio.plugins.jpeg.MarkerSegment {
        ...
        JFIFExtensionMarkerSegment(com.sun.imageio.plugins.jpeg.JPEGBuffer buffer, com.sun.imageio.plugins.jpeg.JPEGImageReader reader)
            throws IOException {
    ...
    abstract class JFIFThumb implements Cloneable {
        ...
        abstract BufferedImage getThumbnail(ImageInputStream iis,
                                            com.sun.imageio.plugins.jpeg.JPEGImageReader reader)
            throws IOException;

        protected JFIFThumb() {}

        protected JFIFThumb(com.sun.imageio.plugins.jpeg.JPEGBuffer buffer) throws IOException{
    ...
    abstract class JFIFThumbUncompressed extends JFIFThumb {
        ...
        JFIFThumbUncompressed(com.sun.imageio.plugins.jpeg.JPEGBuffer buffer,
                              int width,
                              int height,
                              int skip,
                              String name)
    ...
    class JFIFThumbRGB extends JFIFThumbUncompressed {
        ...
        JFIFThumbRGB(com.sun.imageio.plugins.jpeg.JPEGBuffer buffer, int width, int height)
            throws IOException {
        ...
        BufferedImage getThumbnail(ImageInputStream iis,
            ...
            WritableRaster raster =
                Raster.createInterleavedRaster(buffer,
                                               ...
                                               new int [] {0, 1, 2},
                                               null);
            ColorModel cm = new ComponentColorModel(com.sun.imageio.plugins.jpeg.JPEG.JCS.sRGB,
                                                    false,
                                                    false,
                                                    ColorModel.OPAQUE,
    ...
    class JFIFThumbPalette extends JFIFThumbUncompressed {
        ...
        JFIFThumbPalette(com.sun.imageio.plugins.jpeg.JPEGBuffer buffer, int width, int height)
            throws IOException {
            super(buffer,
                  width,
                  height,
    ...
    class JFIFThumbJPEG extends JFIFThumb {
        com.sun.imageio.plugins.jpeg.JPEGMetadata thumbMetadata = null;
        byte [] data = null;  // Compressed image data, for writing
        private static final int PREAMBLE_SIZE = 6;

        JFIFThumbJPEG(com.sun.imageio.plugins.jpeg.JPEGBuffer buffer,
                      int length,
                      com.sun.imageio.plugins.jpeg.JPEGImageReader reader) throws IOException {
            super(buffer);
            ...
            thumbMetadata = new com.sun.imageio.plugins.jpeg.JPEGMetadata(false, true, buffer.iis, reader);
        ...
        JFIFThumbJPEG(Node node) throws IIOInvalidTreeException {
            ...
            if (child != null) {
                ...
                thumbMetadata = new com.sun.imageio.plugins.jpeg.JPEGMetadata(false, true);
        ...
        JFIFThumbJPEG(BufferedImage thumb) throws IllegalThumbException {
            ...
            try {
                ...
                com.sun.imageio.plugins.jpeg.JPEGImageWriter thumbWriter = new com.sun.imageio.plugins.jpeg.JPEGImageWriter(null);

                thumbWriter.setOutput(mos);

                // get default metadata for the thumb
                com.sun.imageio.plugins.jpeg.JPEGMetadata metadata =
                    (com.sun.imageio.plugins.jpeg.JPEGMetadata) thumbWriter.getDefaultImageMetadata
        ...
        private class ThumbnailReadListener
            ...
            com.sun.imageio.plugins.jpeg.JPEGImageReader reader = null;
            ThumbnailReadListener (com.sun.imageio.plugins.jpeg.JPEGImageReader reader) {
                this.reader = reader;
            }
        ...
        BufferedImage getThumbnail(ImageInputStream iis,
            ...
            iis.mark();
            iis.seek(streamPos);
            com.sun.imageio.plugins.jpeg.JPEGImageReader thumbReader = new JPEGImageReader(null);
    ...
    static void writeICC(ICC_Profile profile, ImageOutputStream ios)
        ...
        for (int i = 0; i < numChunks; i++) {
            ...
            ios.write(0xff);
            ios.write(com.sun.imageio.plugins.jpeg.JPEG.APP2);
    ...
    class ICCMarkerSegment extends com.sun.imageio.plugins.jpeg.MarkerSegment {
        ...
        ICCMarkerSegment(ICC_ColorSpace cs) {
            super(com.sun.imageio.plugins.jpeg.JPEG.APP2);
            chunks = null;
            chunksRead = 0;
            numChunks = 0;
        ...
        ICCMarkerSegment(com.sun.imageio.plugins.jpeg.JPEGBuffer buffer) throws IOException {
        ...
        boolean addData(com.sun.imageio.plugins.jpeg.JPEGBuffer buffer) throws IOException {
            if (debug) {
