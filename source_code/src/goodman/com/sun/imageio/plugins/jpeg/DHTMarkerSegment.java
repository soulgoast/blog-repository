...
class DHTMarkerSegment extends com.sun.imageio.plugins.jpeg.MarkerSegment {
    ...
    DHTMarkerSegment(boolean needFour) {
        super(com.sun.imageio.plugins.jpeg.JPEG.DHT);
    ...
    DHTMarkerSegment(com.sun.imageio.plugins.jpeg.JPEGBuffer buffer) throws IOException {
        super(buffer);
        int count = length;
        while (count > 0) {
    ...
    class Htable implements Cloneable {
        ...
        Htable(com.sun.imageio.plugins.jpeg.JPEGBuffer buffer) {
