...
class SOFMarkerSegment extends com.sun.imageio.plugins.jpeg.MarkerSegment {
    ...
    SOFMarkerSegment(boolean wantProg,
                     ...
                     byte[] componentIDs,
                     int numComponents) {
        super(wantProg ? com.sun.imageio.plugins.jpeg.JPEG.SOF2
              : wantExtended ? com.sun.imageio.plugins.jpeg.JPEG.SOF1
              : com.sun.imageio.plugins.jpeg.JPEG.SOF0);
        samplePrecision = 8;
        numLines = 0;
        samplesPerLine = 0;
    ...
    SOFMarkerSegment(com.sun.imageio.plugins.jpeg.JPEGBuffer buffer) throws IOException{
        super(buffer);
    ...
    SOFMarkerSegment(Node node) throws IIOInvalidTreeException {
        ...
        super(com.sun.imageio.plugins.jpeg.JPEG.SOF0);
        samplePrecision = 8;
        numLines = 0;
        samplesPerLine = 0;
    ...
    IIOMetadataNode getNativeNode() {
        ...
        node.setAttribute("process", Integer.toString(tag- com.sun.imageio.plugins.jpeg.JPEG.SOF0));
    ...
    void updateFromNativeNode(Node node, boolean fromScratch)
        ...
        tag = (value != -1) ? value+ com.sun.imageio.plugins.jpeg.JPEG.SOF0 : tag;
    ...
    int getIDencodedCSType () {
        for (int i = 0; i < componentSpecs.length; i++) {
            if (componentSpecs[i].componentId < 'A') {
                return com.sun.imageio.plugins.jpeg.JPEG.JCS_UNKNOWN;
            }
        }
        ...
        case 3:
            if ((componentSpecs[0].componentId == 'R')
                ...
                return com.sun.imageio.plugins.jpeg.JPEG.JCS_RGB;
            }
            if ((componentSpecs[0].componentId == 'Y')
                &&(componentSpecs[0].componentId == 'C')
                &&(componentSpecs[0].componentId == 'c')) {
                return com.sun.imageio.plugins.jpeg.JPEG.JCS_YCC;
            }
            break;
        case 4:
            if ((componentSpecs[0].componentId == 'R')
                ...
                return com.sun.imageio.plugins.jpeg.JPEG.JCS_RGBA;
            }
            if ((componentSpecs[0].componentId == 'Y')
                &&(componentSpecs[0].componentId == 'C')
                &&(componentSpecs[0].componentId == 'c')
                &&(componentSpecs[0].componentId == 'A')) {
                return com.sun.imageio.plugins.jpeg.JPEG.JCS_YCCA;
            }
        }
    ...
    class ComponentSpec implements Cloneable {
        ...
        ComponentSpec(com.sun.imageio.plugins.jpeg.JPEGBuffer buffer) {
