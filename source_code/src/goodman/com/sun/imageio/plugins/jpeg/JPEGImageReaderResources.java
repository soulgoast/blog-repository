...
public class JPEGImageReaderResources extends ListResourceBundle {
    ...
    protected Object[][] getContents() {
        ...
        {Integer.toString(com.sun.imageio.plugins.jpeg.JPEGImageReader.WARNING_NO_EOI),
         "Truncated File - Missing EOI marker"},
        {Integer.toString(com.sun.imageio.plugins.jpeg.JPEGImageReader.WARNING_NO_JFIF_IN_THUMB),
