...
import goodman.java.util.ListIterator;
...
public class JPEGMetadata extends IIOMetadata implements Cloneable {
    ...
    JPEGMetadata(boolean isStream, boolean inThumb) {
        super(true,  // Supports standard format
              com.sun.imageio.plugins.jpeg.JPEG.nativeImageMetadataFormatName,  // and a native format
        ...
        if (isStream) {
            nativeMetadataFormatName = com.sun.imageio.plugins.jpeg.JPEG.nativeStreamMetadataFormatName;
    ...
    JPEGMetadata(boolean isStream,
        ...
        if (((buffer.buf[0] & 0xff) != 0xff)
            || ((buffer.buf[1] & 0xff) != com.sun.imageio.plugins.jpeg.JPEG.SOI)
        ...
        while (!done) {
            ...
            case 0:
                ...
                buffer.bufPtr++;
                break;
            case com.sun.imageio.plugins.jpeg.JPEG.SOF0:
            case com.sun.imageio.plugins.jpeg.JPEG.SOF1:
            case com.sun.imageio.plugins.jpeg.JPEG.SOF2:
                if (isStream) {
                ...
                break;
            case com.sun.imageio.plugins.jpeg.JPEG.DQT:
                newGuy = new DQTMarkerSegment(buffer);
                break;
            case com.sun.imageio.plugins.jpeg.JPEG.DHT:
                newGuy = new DHTMarkerSegment(buffer);
                break;
            case com.sun.imageio.plugins.jpeg.JPEG.DRI:
                newGuy = new DRIMarkerSegment(buffer);
                break;
            case com.sun.imageio.plugins.jpeg.JPEG.APP0:
                ...
                break;
            case com.sun.imageio.plugins.jpeg.JPEG.APP2:
                ...
                break;
            case com.sun.imageio.plugins.jpeg.JPEG.APP14:
                ...
                break;
            case com.sun.imageio.plugins.jpeg.JPEG.COM:
                newGuy = new COMMarkerSegment(buffer);
                break;
            case com.sun.imageio.plugins.jpeg.JPEG.SOS:
                if (isStream) {
                    throw new IIOException
                ...
                break;
            case com.sun.imageio.plugins.jpeg.JPEG.RST0:
            case com.sun.imageio.plugins.jpeg.JPEG.RST1:
            case com.sun.imageio.plugins.jpeg.JPEG.RST2:
            case com.sun.imageio.plugins.jpeg.JPEG.RST3:
            case com.sun.imageio.plugins.jpeg.JPEG.RST4:
            case com.sun.imageio.plugins.jpeg.JPEG.RST5:
            case com.sun.imageio.plugins.jpeg.JPEG.RST6:
            case com.sun.imageio.plugins.jpeg.JPEG.RST7:
                if (debug) {
                ...
                buffer.bufAvail--;
                break;
            case com.sun.imageio.plugins.jpeg.JPEG.EOI:
                done = true;
                buffer.bufPtr++;
                buffer.bufAvail--;
                break;
    ...
    JPEGMetadata(ImageWriteParam param, JPEGImageWriter writer) {
        ...
        if (jparam != null) {
            ...
            // default tables.
            markerSequence.add(new DQTMarkerSegment(com.sun.imageio.plugins.jpeg.JPEG.getDefaultQTables()));
            markerSequence.add(new DHTMarkerSegment(com.sun.imageio.plugins.jpeg.JPEG.getDefaultHuffmanTables(true),
                                                    com.sun.imageio.plugins.jpeg.JPEG.getDefaultHuffmanTables(false)));
        }
    ...
    JPEGMetadata(ImageTypeSpecifier imageType,
        ...
        int transform = com.sun.imageio.plugins.jpeg.JPEG.ADOBE_UNKNOWN;
        ...
        float quality = com.sun.imageio.plugins.jpeg.JPEG.DEFAULT_QUALITY;
            ...
            case ColorSpace.TYPE_YCbCr:
                if (hasExtraComponents) { // e.g. K or alpha
                    ...
                    if (!hasAlpha) { // Not alpha, so must be K
                        wantAdobe = true;
                        transform = com.sun.imageio.plugins.jpeg.JPEG.ADOBE_YCCK;
                    }
                }
                break;
        ...
        if (wantJFIF && com.sun.imageio.plugins.jpeg.JPEG.isNonStandardICC(cs)) {
            wantICC = true;
        }
    ...
    public Node getAsTree(String formatName) {
        ...
        if (isStream) {
            if (formatName.equals(com.sun.imageio.plugins.jpeg.JPEG.nativeStreamMetadataFormatName)) {
                return getNativeTree();
            }
        } else {
            if (formatName.equals(com.sun.imageio.plugins.jpeg.JPEG.nativeImageMetadataFormatName)) {
                return getNativeTree();
            }
    ...
    IIOMetadataNode getNativeTree() {
        ...
        Iterator iter = markerSequence.iterator();
        if (isStream) {
            root = new IIOMetadataNode(com.sun.imageio.plugins.jpeg.JPEG.nativeStreamMetadataFormatName);
            top = root;
        } else {
            IIOMetadataNode sequence = new IIOMetadataNode("markerSequence");
            if (!inThumb) {
                root = new IIOMetadataNode(com.sun.imageio.plugins.jpeg.JPEG.nativeImageMetadataFormatName);
    ...
    protected IIOMetadataNode getStandardChromaNode() {
        ...
        if (adobe != null){
            ...
            case com.sun.imageio.plugins.jpeg.JPEG.ADOBE_YCCK:
    ...
    protected IIOMetadataNode getStandardCompressionNode() {
        ...
        while (iter.hasNext()) {
            ...
            if (ms.tag == com.sun.imageio.plugins.jpeg.JPEG.SOS) {
                sosCount++;
            }
        }
        if (sosCount != 0) {
    ...
    protected IIOMetadataNode getStandardTextNode() {
        ...
        if (findMarkerSegment(com.sun.imageio.plugins.jpeg.JPEG.COM) != null) {
            text = new IIOMetadataNode("Text");
            Iterator iter = markerSequence.iterator();
            while (iter.hasNext()) {
                MarkerSegment seg = (MarkerSegment) iter.next();
                if (seg.tag == com.sun.imageio.plugins.jpeg.JPEG.COM) {
    ...
    public void mergeTree(String formatName, Node root)
        ...
        if (isStream &&
            (formatName.equals(com.sun.imageio.plugins.jpeg.JPEG.nativeStreamMetadataFormatName))) {
                mergeNativeTree(root);
        } else if (!isStream &&
                   (formatName.equals(com.sun.imageio.plugins.jpeg.JPEG.nativeImageMetadataFormatName))) {
            mergeNativeTree(root);
        } else if (!isStream &&
                   (formatName.equals
                    (IIOMetadataFormatImpl.standardMetadataFormatName))) {
    ...
    private void mergeNativeTree(Node root) throws IIOInvalidTreeException {
        ...
        if (name != ((isStream) ? com.sun.imageio.plugins.jpeg.JPEG.nativeStreamMetadataFormatName
    ...
    private void mergeStandardChromaNode(Node node, NodeList siblings)
        ...
        if (csName.equals("GRAY")) {
            ...
            numChannels = 3;
            wantAdobe = true;
            transform = com.sun.imageio.plugins.jpeg.JPEG.ADOBE_YCC;
            ids[0] = (byte) 'Y';
            ids[1] = (byte) 'C';
            ids[2] = (byte) 'c';
            ...
            numChannels = 3;
            wantAdobe = true;
            transform = com.sun.imageio.plugins.jpeg.JPEG.ADOBE_UNKNOWN;
            ids[0] = (byte) 'R';
            ids[1] = (byte) 'G';
            ids[2] = (byte) 'B';
        ...
        if ((sof != null) && (sof.tag == com.sun.imageio.plugins.jpeg.JPEG.SOF2)) { // Progressive
        ...
        if (sof != null) {
            ...
            progressive = (sof.tag == com.sun.imageio.plugins.jpeg.JPEG.SOF2);
        ...
        if (jfif != null) {
            ...
            for (int i = 0; i < children.getLength(); i++) {
                ...
                if (name.equals("PixelAspectRatio")) {
                    ...
                    jfif.resUnits = com.sun.imageio.plugins.jpeg.JPEG.DENSITY_UNIT_ASPECT_RATIO;
                    jfif.Xdensity = p.x;
                    jfif.Xdensity = p.y;
                    ...
                    jfif.resUnits = com.sun.imageio.plugins.jpeg.JPEG.DENSITY_UNIT_DOTS_CM;
                    jfif.Xdensity = dpcm;
                ...
                if (jfif != null) {
                    ...
                    if ((adobe != null)
                        && (((numSOFBands == 1)
                             && (adobe.transform != com.sun.imageio.plugins.jpeg.JPEG.ADOBE_UNKNOWN))
                            || ((numSOFBands == 3)
                                && (adobe.transform != com.sun.imageio.plugins.jpeg.JPEG.ADOBE_YCC)))) {
                        retval = false;
                    }
                }
            } else {
    ...
    void writeToStream(ImageOutputStream ios,
        ...
        if (forceJFIF) {
            ...
            if ((ignoreAdobe == false)
                && (newAdobeTransform != com.sun.imageio.plugins.jpeg.JPEG.ADOBE_IMPOSSIBLE)) {
                if ((newAdobeTransform != com.sun.imageio.plugins.jpeg.JPEG.ADOBE_UNKNOWN)
        ...
        while(iter.hasNext()) {
            ...
            if (seg instanceof JFIFMarkerSegment) {
                ...
                if (ignoreAdobe == false) {
                    if (newAdobeTransform != com.sun.imageio.plugins.jpeg.JPEG.ADOBE_IMPOSSIBLE) {
                        ...
                        if ((adobe.transform == com.sun.imageio.plugins.jpeg.JPEG.ADOBE_UNKNOWN)
