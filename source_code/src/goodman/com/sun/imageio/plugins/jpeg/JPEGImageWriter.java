...
import goodman.javax.imageio.ImageWriteParam;
import goodman.javax.imageio.IIOImage;
import goodman.javax.imageio.ImageTypeSpecifier;
import goodman.javax.imageio.metadata.IIOMetadata;
...
import goodman.javax.imageio.plugins.jpeg.JPEGImageWriteParam;
import goodman.javax.imageio.plugins.jpeg.JPEGQTable;
import goodman.javax.imageio.plugins.jpeg.JPEGHuffmanTable;
...
import goodman.java.awt.image.Raster;
import goodman.java.awt.image.WritableRaster;
import goodman.java.awt.image.DataBufferByte;
...
import goodman.java.awt.image.RenderedImage;
import goodman.java.awt.image.BufferedImage;
import goodman.java.awt.color.ColorSpace;
import goodman.java.awt.color.ICC_ColorSpace;
import goodman.java.awt.color.ICC_Profile;
import goodman.java.awt.Dimension;
import goodman.java.awt.Rectangle;
import goodman.java.awt.Transparency;
...
public class JPEGImageWriter extends ImageWriter {
    ...
    private int newAdobeTransform = com.sun.imageio.plugins.jpeg.JPEG.ADOBE_IMPOSSIBLE;  // Change if needed
    private boolean writeDefaultJFIF = false;
    private boolean writeAdobe = false;
    private com.sun.imageio.plugins.jpeg.JPEGMetadata metadata = null;
    ...
    public IIOMetadata getDefaultStreamMetadata(ImageWriteParam param) {
        setThreadLock();
        try {
            return new com.sun.imageio.plugins.jpeg.JPEGMetadata(param, this);
        } finally {
            clearThreadLock();
        }
    }
    ...
    public IIOMetadata
        ...
        setThreadLock();
        try {
            return new com.sun.imageio.plugins.jpeg.JPEGMetadata(imageType, param, this);
        } finally {
            clearThreadLock();
        }
    }
    ...
    public IIOMetadata convertStreamMetadata(IIOMetadata inData,
        ...
        if (inData instanceof com.sun.imageio.plugins.jpeg.JPEGMetadata) {
            com.sun.imageio.plugins.jpeg.JPEGMetadata jpegData = (com.sun.imageio.plugins.jpeg.JPEGMetadata) inData;
    ...
    private IIOMetadata
        ...
        if (inData.isStandardMetadataFormatSupported()) {
            ...
            if (tree != null) {
                com.sun.imageio.plugins.jpeg.JPEGMetadata jpegData = new com.sun.imageio.plugins.jpeg.JPEGMetadata(imageType,
                                                         param,
                                                         this);
                try {
    ...
    private boolean jfifOK(ImageTypeSpecifier imageType,
        ...
        if ((imageType != null) &&
            (!com.sun.imageio.plugins.jpeg.JPEG.isJFIFcompliant(imageType, true))) {
            return false;
        }
        if (imageMetadata != null) {
            com.sun.imageio.plugins.jpeg.JPEGMetadata metadata = null;
            if (imageMetadata instanceof com.sun.imageio.plugins.jpeg.JPEGMetadata) {
                metadata = (com.sun.imageio.plugins.jpeg.JPEGMetadata) imageMetadata;
            } else {
                metadata = (com.sun.imageio.plugins.jpeg.JPEGMetadata)convertImageMetadata(imageMetadata,
                                                              imageType,
                                                              param);
            }
    ...
    private void writeOnThread(IIOMetadata streamMetadata,
        ...
        srcBands = com.sun.imageio.plugins.jpeg.JPEG.bandOffsets[numSrcBands-1];
        ...
        if (param != null) {
            ...
            case ImageWriteParam.MODE_EXPLICIT:
                ...
                quality = com.sun.imageio.plugins.jpeg.JPEG.convertToLinearQuality(quality);
        ...
        if (mdata != null) {
            if (mdata instanceof com.sun.imageio.plugins.jpeg.JPEGMetadata) {
                metadata = (com.sun.imageio.plugins.jpeg.JPEGMetadata) mdata;
                if (debug) {
                    System.out.println
                ...
                if (!rasterOnly) {
                    ...
                    metadata = (com.sun.imageio.plugins.jpeg.JPEGMetadata) convertImageMetadata(mdata,
                                                                   type,
                                                                   param);
                } else {
        ...
        newAdobeTransform = com.sun.imageio.plugins.jpeg.JPEG.ADOBE_IMPOSSIBLE;  // Change if needed
        writeDefaultJFIF = false;
        writeAdobe = false;

        // By default we'll do no conversion:
        int inCsType = com.sun.imageio.plugins.jpeg.JPEG.JCS_UNKNOWN;
        int outCsType = com.sun.imageio.plugins.jpeg.JPEG.JCS_UNKNOWN;
        ...
        if (destType != null) {
            ...
            if (metadata != null) {
                ...
                if ((jfif != null) && (ignoreJFIF == false)) {
                    if (com.sun.imageio.plugins.jpeg.JPEG.isNonStandardICC(cs)) {
                ...
                if (com.sun.imageio.plugins.jpeg.JPEG.isJFIFcompliant(destType, false)) {
                    ...
                    int transform = com.sun.imageio.plugins.jpeg.JPEG.transformForType(destType, false);
                    if (transform != com.sun.imageio.plugins.jpeg.JPEG.ADOBE_IMPOSSIBLE) {
                        writeAdobe = true;
                        newAdobeTransform = transform;
                    }
                }
                // re-create the metadata
                metadata = new com.sun.imageio.plugins.jpeg.JPEGMetadata(destType, null, this);
            }
            ...
            if (metadata == null) {
                if (fullImage) {  // no dest, no metadata, full image
                    ...
                    metadata = new com.sun.imageio.plugins.jpeg.JPEGMetadata(new ImageTypeSpecifier(rimage),
                                                param, this);
                    if (metadata.findMarkerSegment
                        (JFIFMarkerSegment.class, true) != null) {
                ...
                if (fullImage) {  // no dest, metadata, image
                    ...
                    if (cm != null) {
                        ...
                        case ColorSpace.TYPE_GRAY:
                            if (!alpha) {
                                outCsType = com.sun.imageio.plugins.jpeg.JPEG.JCS_GRAYSCALE;
                            } else {
                                if (jfif != null) {
                                    ignoreJFIF = true;
                                    warningOccurred
                            ...
                            if ((adobe != null)
                                && (adobe.transform != com.sun.imageio.plugins.jpeg.JPEG.ADOBE_UNKNOWN)) {
                                newAdobeTransform = com.sun.imageio.plugins.jpeg.JPEG.ADOBE_UNKNOWN;
                                warningOccurred
                        ...
                        case ColorSpace.TYPE_RGB:
                            if (!alpha) {
                                if (jfif != null) {
                                    outCsType = com.sun.imageio.plugins.jpeg.JPEG.JCS_YCbCr;
                                    if (com.sun.imageio.plugins.jpeg.JPEG.isNonStandardICC(cs)
                                    ...
                                    case com.sun.imageio.plugins.jpeg.JPEG.ADOBE_UNKNOWN:
                                        outCsType = com.sun.imageio.plugins.jpeg.JPEG.JCS_RGB;
                                        break;
                                    case com.sun.imageio.plugins.jpeg.JPEG.ADOBE_YCC:
                                        outCsType = com.sun.imageio.plugins.jpeg.JPEG.JCS_YCbCr;
                                        break;
                                    default:
                                        warningOccurred
                                    ...
                                    if (outCS != com.sun.imageio.plugins.jpeg.JPEG.JCS_UNKNOWN) {
                                        outCsType = outCS;
                                    } else {
                                        boolean subsampled =
                                ...
                                if (adobe != null) {
                                    if (adobe.transform
                                        != com.sun.imageio.plugins.jpeg.JPEG.ADOBE_UNKNOWN) {
                                        newAdobeTransform = com.sun.imageio.plugins.jpeg.JPEG.ADOBE_UNKNOWN;
                                        warningOccurred
                                        (WARNING_IMAGE_METADATA_ADOBE_MISMATCH);
                                    }
                                    outCsType = com.sun.imageio.plugins.jpeg.JPEG.JCS_RGBA;
                                } else {
                                    // consult the ids
                                    int outCS = sof.getIDencodedCSType();
                                    // if they don't resolve it,
                                    ...
                                    if (outCS != com.sun.imageio.plugins.jpeg.JPEG.JCS_UNKNOWN) {
                                        ...
                                        outCsType = subsampled ?
                                            com.sun.imageio.plugins.jpeg.JPEG.JCS_YCbCrA : com.sun.imageio.plugins.jpeg.JPEG.JCS_RGBA;
                                    }
                                }
                            }
                            break;
                        case ColorSpace.TYPE_3CLR:
                            if (cs == com.sun.imageio.plugins.jpeg.JPEG.JCS.getYCC()) {
                                if (!alpha) {
                                    if (jfif != null) {
                                        convertTosRGB = true;
                                        convertOp =
                                        new ColorConvertOp(cs,
                                                           com.sun.imageio.plugins.jpeg.JPEG.JCS.sRGB,
                                                           null);
                                        outCsType = com.sun.imageio.plugins.jpeg.JPEG.JCS_YCbCr;
                                    } else if (adobe != null) {
                                        if (adobe.transform
                                            != com.sun.imageio.plugins.jpeg.JPEG.ADOBE_YCC) {
                                            newAdobeTransform = com.sun.imageio.plugins.jpeg.JPEG.ADOBE_YCC;
                                            warningOccurred
                                            (WARNING_IMAGE_METADATA_ADOBE_MISMATCH);
                                        }
                                        outCsType = com.sun.imageio.plugins.jpeg.JPEG.JCS_YCC;
                                    } else {
                                        outCsType = com.sun.imageio.plugins.jpeg.JPEG.JCS_YCC;
                                    }
                                } else { // PhotoYCCA
                                    ...
                                    outCsType = com.sun.imageio.plugins.jpeg.JPEG.JCS_YCCA;
                                }
                            }
                        }
                    }
        ...
        if (metadata != null) {
            ...
            if ((sof != null) && (sof.tag == com.sun.imageio.plugins.jpeg.JPEG.SOF2)) {
            ...
            if (metadata == null) {
                ...
                if (fullImage == false) {
                    ...
                    if (jfif == null) {  // Not JFIF
                        // Can it have JFIF?
                        if ((outCsType == com.sun.imageio.plugins.jpeg.JPEG.JCS_GRAYSCALE)
                            || (outCsType == com.sun.imageio.plugins.jpeg.JPEG.JCS_YCbCr)) {
                            if (numThumbs != 0) {
                                forceJFIF = true;
        ...
        if (qTables == null) { // Get them from metadata, or use defaults
            if (dqt != null) {
                ...
                qTables = com.sun.imageio.plugins.jpeg.JPEG.getDefaultQTables();
            }
        ...
        if (optimizeHuffman == false) {
            ...
            if ((dht != null) && (metadataProgressive == false)) {
                ...
                DCHuffmanTables = com.sun.imageio.plugins.jpeg.JPEG.getDefaultHuffmanTables(true);
                ACHuffmanTables = com.sun.imageio.plugins.jpeg.JPEG.getDefaultHuffmanTables(false);
            }
        }
        ...
        int [] bandOffs = com.sun.imageio.plugins.jpeg.JPEG.bandOffsets[numBandsUsed-1];
    ...
    private void prepareWriteSequenceOnThread(IIOMetadata streamMetadata)
         ...
         */
        if (streamMetadata != null) {
            if (streamMetadata instanceof com.sun.imageio.plugins.jpeg.JPEGMetadata) {
                // write a complete tables-only image at the beginning of
                // the stream.
                com.sun.imageio.plugins.jpeg.JPEGMetadata jmeta = (com.sun.imageio.plugins.jpeg.JPEGMetadata) streamMetadata;
                ...
                if (streamQTables == null) {
                    streamQTables = com.sun.imageio.plugins.jpeg.JPEG.getDefaultQTables();
                }
                streamDCHuffmanTables =
                    collectHTablesFromMetadata(jmeta, true);
                if (streamDCHuffmanTables == null) {
                    streamDCHuffmanTables = com.sun.imageio.plugins.jpeg.JPEG.getDefaultHuffmanTables(true);
                }
                streamACHuffmanTables =
                    collectHTablesFromMetadata(jmeta, false);
                if (streamACHuffmanTables == null) {
                    streamACHuffmanTables = com.sun.imageio.plugins.jpeg.JPEG.getDefaultHuffmanTables(false);
                }
    ...
    private void checkJFIF(JFIFMarkerSegment jfif,
                           ...
                           boolean input) {
        if (jfif != null) {
            if (!com.sun.imageio.plugins.jpeg.JPEG.isJFIFcompliant(type, input)) {
    ...
    private void checkAdobe(AdobeMarkerSegment adobe,
                           ...
                           boolean input) {
        if (adobe != null) {
            int rightTransform = com.sun.imageio.plugins.jpeg.JPEG.transformForType(type, input);
            if (adobe.transform != rightTransform) {
                warningOccurred(input
                                ? WARNING_IMAGE_METADATA_ADOBE_MISMATCH
                                : WARNING_DEST_METADATA_ADOBE_MISMATCH);
                if (rightTransform == com.sun.imageio.plugins.jpeg.JPEG.ADOBE_IMPOSSIBLE) {
                    ignoreAdobe = true;
                } else {
     ...
     */
    private int [] collectScans(com.sun.imageio.plugins.jpeg.JPEGMetadata metadata,
    ...
    private JPEGQTable [] collectQTablesFromMetadata
        (com.sun.imageio.plugins.jpeg.JPEGMetadata metadata) {
    ...
    private int getSrcCSType(ColorModel cm) {
        int retval = com.sun.imageio.plugins.jpeg.JPEG.JCS_UNKNOWN;
        if (cm != null) {
            boolean alpha = cm.hasAlpha();
            ColorSpace cs = cm.getColorSpace();
            switch (cs.getType()) {
            case ColorSpace.TYPE_GRAY:
                retval = com.sun.imageio.plugins.jpeg.JPEG.JCS_GRAYSCALE;
                break;
            case ColorSpace.TYPE_RGB:
                if (alpha) {
                    retval = com.sun.imageio.plugins.jpeg.JPEG.JCS_RGBA;
                } else {
                    retval = com.sun.imageio.plugins.jpeg.JPEG.JCS_RGB;
                }
                break;
            case ColorSpace.TYPE_YCbCr:
                if (alpha) {
                    retval = com.sun.imageio.plugins.jpeg.JPEG.JCS_YCbCrA;
                } else {
                    retval = com.sun.imageio.plugins.jpeg.JPEG.JCS_YCbCr;
                }
                break;
            case ColorSpace.TYPE_3CLR:
                if (cs == com.sun.imageio.plugins.jpeg.JPEG.JCS.getYCC()) {
                    if (alpha) {
                        retval = com.sun.imageio.plugins.jpeg.JPEG.JCS_YCCA;
                    } else {
                        retval = com.sun.imageio.plugins.jpeg.JPEG.JCS_YCC;
                    }
                }
            case ColorSpace.TYPE_CMYK:
                retval = com.sun.imageio.plugins.jpeg.JPEG.JCS_CMYK;
                break;
            }
        }
        return retval;
