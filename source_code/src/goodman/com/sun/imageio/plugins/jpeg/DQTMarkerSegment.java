...
class DQTMarkerSegment extends com.sun.imageio.plugins.jpeg.MarkerSegment {
    ...
    DQTMarkerSegment(float quality, boolean needTwo) {
        super(com.sun.imageio.plugins.jpeg.JPEG.DQT);
    ...
    DQTMarkerSegment(com.sun.imageio.plugins.jpeg.JPEGBuffer buffer) throws IOException {
        super(buffer);
        int count = length;
        while (count > 0) {
    ...
    class Qtable implements Cloneable {
        ...
        Qtable(boolean wantLuma, float quality) {
            ...
            if (quality != com.sun.imageio.plugins.jpeg.JPEG.DEFAULT_QUALITY) {
        ...
        Qtable(com.sun.imageio.plugins.jpeg.JPEGBuffer buffer) throws IIOException {
