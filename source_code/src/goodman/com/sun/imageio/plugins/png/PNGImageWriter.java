...
package goodman.com.sun.imageio.plugins.png;
...
import goodman.java.io.ByteArrayOutputStream;
import goodman.java.io.DataOutput;
...
import goodman.java.util.zip.Deflater;
import goodman.java.util.zip.DeflaterOutputStream;
...
import goodman.javax.imageio.stream.ImageOutputStreamImpl;
...
public class PNGImageWriter extends ImageWriter {
    ...
    com.sun.imageio.plugins.png.PNGMetadata metadata = null;
    ...
    com.sun.imageio.plugins.png.RowFilter rowFilter = new RowFilter();
    byte[] prevRow = null;
    byte[] currRow = null;
    ...
    public IIOMetadata getDefaultImageMetadata(ImageTypeSpecifier imageType,
        ...
        com.sun.imageio.plugins.png.PNGMetadata m = new com.sun.imageio.plugins.png.PNGMetadata();
    ...
    public IIOMetadata convertImageMetadata(IIOMetadata inData,
        ...
        if (inData instanceof com.sun.imageio.plugins.png.PNGMetadata) {
            return (com.sun.imageio.plugins.png.PNGMetadata)((com.sun.imageio.plugins.png.PNGMetadata)inData).clone();
        } else {
            return new com.sun.imageio.plugins.png.PNGMetadata(inData);
        }
    }
    ...
    private void write_IHDR() throws IOException {
        // Write IHDR chunk
        ChunkStream cs = new ChunkStream(com.sun.imageio.plugins.png.PNGImageReader.IHDR_TYPE, stream);
...
"Only interlace methods 0 (node) and 1 (adam7) are defined in PNG 1.1");
    ...
    private void write_cHRM() throws IOException {
        if (metadata.cHRM_present) {
            ChunkStream cs = new ChunkStream(com.sun.imageio.plugins.png.PNGImageReader.cHRM_TYPE, stream);
    ...
    private void write_gAMA() throws IOException {
        if (metadata.gAMA_present) {
            ChunkStream cs = new ChunkStream(com.sun.imageio.plugins.png.PNGImageReader.gAMA_TYPE, stream);
    ...
    private void write_iCCP() throws IOException {
        if (metadata.iCCP_present) {
            ChunkStream cs = new ChunkStream(com.sun.imageio.plugins.png.PNGImageReader.iCCP_TYPE, stream);
    ...
    private void write_sBIT() throws IOException {
        if (metadata.sBIT_present) {
            ChunkStream cs = new ChunkStream(com.sun.imageio.plugins.png.PNGImageReader.sBIT_TYPE, stream);
...
"The chunk will not be written.");
            ...
            if (colorType == com.sun.imageio.plugins.png.PNGImageReader.PNG_COLOR_GRAY ||
                colorType == com.sun.imageio.plugins.png.PNGImageReader.PNG_COLOR_GRAY_ALPHA) {
                cs.writeByte(metadata.sBIT_grayBits);
            } else if (colorType == com.sun.imageio.plugins.png.PNGImageReader.PNG_COLOR_RGB ||
                       colorType == com.sun.imageio.plugins.png.PNGImageReader.PNG_COLOR_PALETTE ||
                       colorType == com.sun.imageio.plugins.png.PNGImageReader.PNG_COLOR_RGB_ALPHA) {
                cs.writeByte(metadata.sBIT_redBits);
                cs.writeByte(metadata.sBIT_greenBits);
                cs.writeByte(metadata.sBIT_blueBits);
            }

            if (colorType == com.sun.imageio.plugins.png.PNGImageReader.PNG_COLOR_GRAY_ALPHA ||
                colorType == com.sun.imageio.plugins.png.PNGImageReader.PNG_COLOR_RGB_ALPHA) {
    ...
    private void write_sRGB() throws IOException {
        if (metadata.sRGB_present) {
            ChunkStream cs = new ChunkStream(com.sun.imageio.plugins.png.PNGImageReader.sRGB_TYPE, stream);
    ...
    private void write_PLTE() throws IOException {
        if (metadata.PLTE_present) {
            if (metadata.IHDR_colorType == com.sun.imageio.plugins.png.PNGImageReader.PNG_COLOR_GRAY ||
              metadata.IHDR_colorType == com.sun.imageio.plugins.png.PNGImageReader.PNG_COLOR_GRAY_ALPHA) {
...
"The chunk will not be written");
            ...
            ChunkStream cs = new ChunkStream(com.sun.imageio.plugins.png.PNGImageReader.PLTE_TYPE, stream);
    ...
    private void write_hIST() throws IOException, IIOException {
        if (metadata.hIST_present) {
            ChunkStream cs = new ChunkStream(com.sun.imageio.plugins.png.PNGImageReader.hIST_TYPE, stream);
    ...
    private void write_tRNS() throws IOException, IIOException {
        if (metadata.tRNS_present) {
            ChunkStream cs = new ChunkStream(com.sun.imageio.plugins.png.PNGImageReader.tRNS_TYPE, stream);
            int colorType = metadata.IHDR_colorType;
            ...
            if (colorType == com.sun.imageio.plugins.png.PNGImageReader.PNG_COLOR_RGB &&
                chunkType == com.sun.imageio.plugins.png.PNGImageReader.PNG_COLOR_GRAY) {
                chunkType = colorType;
...
"The chunk will not be written.");
            ...
            if (colorType == com.sun.imageio.plugins.png.PNGImageReader.PNG_COLOR_PALETTE) {
                if (!metadata.PLTE_present) {
                    throw new IIOException("tRNS chunk without PLTE chunk!");
                }
                cs.write(metadata.tRNS_alpha);
            } else if (colorType == com.sun.imageio.plugins.png.PNGImageReader.PNG_COLOR_GRAY) {
    ...
    private void write_bKGD() throws IOException {
        if (metadata.bKGD_present) {
            ChunkStream cs = new ChunkStream(com.sun.imageio.plugins.png.PNGImageReader.bKGD_TYPE, stream);
...
"The chunk will not be written.");
    ...
    private void write_pHYs() throws IOException {
        if (metadata.pHYs_present) {
            ChunkStream cs = new ChunkStream(com.sun.imageio.plugins.png.PNGImageReader.pHYs_TYPE, stream);
    ...
    private void write_sPLT() throws IOException {
        if (metadata.sPLT_present) {
            ChunkStream cs = new ChunkStream(com.sun.imageio.plugins.png.PNGImageReader.sPLT_TYPE, stream);
    ...
    private void write_tIME() throws IOException {
        if (metadata.tIME_present) {
            ChunkStream cs = new ChunkStream(com.sun.imageio.plugins.png.PNGImageReader.tIME_TYPE, stream);
    ...
    private void write_tEXt() throws IOException {
        ...
        while (keywordIter.hasNext()) {
            ChunkStream cs = new ChunkStream(com.sun.imageio.plugins.png.PNGImageReader.tEXt_TYPE, stream);
    ...
    private void write_iTXt() throws IOException {
        ...
        while (keywordIter.hasNext()) {
            ChunkStream cs = new ChunkStream(com.sun.imageio.plugins.png.PNGImageReader.iTXt_TYPE, stream);
    ...
    private void write_zTXt() throws IOException {
        ...
        while (keywordIter.hasNext()) {
            ChunkStream cs = new ChunkStream(com.sun.imageio.plugins.png.PNGImageReader.zTXt_TYPE, stream);
            String keyword = (String)keywordIter.next();
            cs.writeBytes(keyword);
            cs.writeByte(0);
    ...
    private void encodePass(ImageOutputStream os,
        ...
        if (metadata.IHDR_colorType == com.sun.imageio.plugins.png.PNGImageReader.PNG_COLOR_GRAY_ALPHA &&
            ...
            if (metadata.IHDR_interlaceMethod == 1) {
                for (int i = 0; i < 7; i++) {
                    encodePass(ios, image,
                               com.sun.imageio.plugins.png.PNGImageReader.adam7XOffset[i],
                               com.sun.imageio.plugins.png.PNGImageReader.adam7YOffset[i],
                               com.sun.imageio.plugins.png.PNGImageReader.adam7XSubsampling[i],
                               com.sun.imageio.plugins.png.PNGImageReader.adam7YSubsampling[i]);
                    if (abortRequested()) {
                        break;
                    }
                }
    ...
    public void write(IIOMetadata streamMetadata,
        ...
        if (imd != null) {
            metadata = (com.sun.imageio.plugins.png.PNGMetadata)convertImageMetadata(imd,
