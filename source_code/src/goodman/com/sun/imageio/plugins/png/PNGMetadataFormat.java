...
public class PNGMetadataFormat extends IIOMetadataFormatImpl {
    ...
    private PNGMetadataFormat() {
        super(com.sun.imageio.plugins.png.PNGMetadata.nativeMetadataFormatName,
              CHILD_POLICY_SOME);

        // root -> IHDR
        addElement("IHDR", com.sun.imageio.plugins.png.PNGMetadata.nativeMetadataFormatName,
                   CHILD_POLICY_EMPTY);
        ...
        addAttribute("IHDR", "bitDepth",
                     DATATYPE_INTEGER, true, null,
                     Arrays.asList(com.sun.imageio.plugins.png.PNGMetadata.IHDR_bitDepths));
        ...
        addAttribute("IHDR", "compressionMethod",
                     DATATYPE_STRING, true, null,
                     Arrays.asList(com.sun.imageio.plugins.png.PNGMetadata.IHDR_compressionMethodNames));

        addAttribute("IHDR", "filterMethod",
                     DATATYPE_STRING, true, null,
                     Arrays.asList(com.sun.imageio.plugins.png.PNGMetadata.IHDR_filterMethodNames));

        addAttribute("IHDR", "interlaceMethod",
                     DATATYPE_STRING, true, null,
                     Arrays.asList(com.sun.imageio.plugins.png.PNGMetadata.IHDR_interlaceMethodNames));

        // root -> PLTE
        addElement("PLTE", com.sun.imageio.plugins.png.PNGMetadata.nativeMetadataFormatName,
                   1, 256);
        ...
        // root -> bKGD
        addElement("bKGD", com.sun.imageio.plugins.png.PNGMetadata.nativeMetadataFormatName,
                   CHILD_POLICY_CHOICE);
        ...
        // root -> cHRM
        addElement("cHRM", com.sun.imageio.plugins.png.PNGMetadata.nativeMetadataFormatName,
                   CHILD_POLICY_EMPTY);
        ...
        // root -> gAMA
        addElement("gAMA", com.sun.imageio.plugins.png.PNGMetadata.nativeMetadataFormatName,
                   CHILD_POLICY_EMPTY);
        ...
        // root -> hIST
        addElement("hIST", com.sun.imageio.plugins.png.PNGMetadata.nativeMetadataFormatName,
                   1, 256);
        ...
        // root -> iCCP
        addElement("iCCP", com.sun.imageio.plugins.png.PNGMetadata.nativeMetadataFormatName,
                   CHILD_POLICY_EMPTY);
        ...
        addAttribute("iCCP", "compressionMethod",
                     DATATYPE_STRING, true, null,
                     Arrays.asList(com.sun.imageio.plugins.png.PNGMetadata.iCCP_compressionMethodNames));

        addObjectValue("iCCP", byte.class, 0, Integer.MAX_VALUE);

        // root -> iTXt
        addElement("iTXt", com.sun.imageio.plugins.png.PNGMetadata.nativeMetadataFormatName,
                   1, Integer.MAX_VALUE);
        ...
        // root -> pHYS
        addElement("pHYS", com.sun.imageio.plugins.png.PNGMetadata.nativeMetadataFormatName,
                   CHILD_POLICY_EMPTY);
        ...
        addAttribute("pHYS", "unitSpecifier",
                     DATATYPE_STRING, true, null,
                     Arrays.asList(com.sun.imageio.plugins.png.PNGMetadata.unitSpecifierNames));

        // root -> sBIT
        addElement("sBIT", com.sun.imageio.plugins.png.PNGMetadata.nativeMetadataFormatName,
                   CHILD_POLICY_CHOICE);
        ...
        // root -> sPLT
        addElement("sPLT", com.sun.imageio.plugins.png.PNGMetadata.nativeMetadataFormatName,
                   1, 256);
        ...
        // root -> sRGB
        addElement("sRGB", com.sun.imageio.plugins.png.PNGMetadata.nativeMetadataFormatName,
                   CHILD_POLICY_EMPTY);

        addAttribute("sRGB", "renderingIntent",
                     DATATYPE_STRING, true, null,
                     Arrays.asList(com.sun.imageio.plugins.png.PNGMetadata.renderingIntentNames));

        // root -> tEXt
        addElement("tEXt", com.sun.imageio.plugins.png.PNGMetadata.nativeMetadataFormatName,
                   1, Integer.MAX_VALUE);
        ...
        // root -> tIME
        addElement("tIME", com.sun.imageio.plugins.png.PNGMetadata.nativeMetadataFormatName,
                   CHILD_POLICY_EMPTY);
        ...
        // root -> tRNS
        addElement("tRNS", com.sun.imageio.plugins.png.PNGMetadata.nativeMetadataFormatName,
                   CHILD_POLICY_CHOICE);
        ...
        // root -> zTXt
        addElement("zTXt", com.sun.imageio.plugins.png.PNGMetadata.nativeMetadataFormatName,
                   1, Integer.MAX_VALUE);
        ...
        addAttribute("zTXtEntry", "compressionMethod",
                     DATATYPE_STRING, true, null,
                     Arrays.asList(com.sun.imageio.plugins.png.PNGMetadata.zTXt_compressionMethodNames));
