...
public abstract class lr_parser {
  ...
  public lr_parser(com.sun.java_cup.internal.runtime.Scanner s) {
   ...
   */
  public void setScanner(com.sun.java_cup.internal.runtime.Scanner s) { _scanner = s; }
   ...
   */
  public abstract com.sun.java_cup.internal.runtime.Symbol do_action(
    int       act_num,
    lr_parser parser,
    Stack     stack,
    int       top)
   ...
   */
  public com.sun.java_cup.internal.runtime.Symbol scan() throws Exception {
  ...
  public void report_error(String message, Object info)
    {
      ...
      if (info instanceof com.sun.java_cup.internal.runtime.Symbol)
        if (((com.sun.java_cup.internal.runtime.Symbol)info).left != -1)
        System.err.println(" at character " + ((com.sun.java_cup.internal.runtime.Symbol)info).left +
                           " of input");
   ...
   */
  public void syntax_error(com.sun.java_cup.internal.runtime.Symbol cur_token)
    {
   ...
   * @param cur_token the current lookahead Symbol.
   */
  public void unrecovered_syntax_error(com.sun.java_cup.internal.runtime.Symbol cur_token)
    throws Exception
    {
   ...
   */
  public com.sun.java_cup.internal.runtime.Symbol parse() throws Exception
    {
      /* the current action code */
      int act;

      /* the Symbol/stack element returned by a reduce */
      com.sun.java_cup.internal.runtime.Symbol lhs_sym = null;
      ...
      stack.push(new com.sun.java_cup.internal.runtime.Symbol(0, start_state()));
      tos = 0;
      ...
      for (_done_parsing = false; !_done_parsing; )
        {
          ...
          act = get_action(((com.sun.java_cup.internal.runtime.Symbol)stack.peek()).parse_state, cur_token.sym);
          ...
          /* if its less than zero, then it encodes a reduce action */
          else if (act < 0)
            {
              ...
              act = get_reduce(((com.sun.java_cup.internal.runtime.Symbol)stack.peek()).parse_state, lhs_sym_num);
              ...
              if (!error_recovery(false))
                {
                  ...
                  lhs_sym = (com.sun.java_cup.internal.runtime.Symbol)stack.peek();
                }
            }
        }
      return lhs_sym;
  ...
  public void dump_stack()
    {
      ...
      for (int i=0; i<stack.size(); i++)
        {
          debug_message("Symbol: " + ((com.sun.java_cup.internal.runtime.Symbol)stack.elementAt(i)).sym +
                        " State: " + ((com.sun.java_cup.internal.runtime.Symbol)stack.elementAt(i)).parse_state);
        }
      debug_message("==========================================");
    }
   ...
   */
  public void debug_shift(com.sun.java_cup.internal.runtime.Symbol shift_tkn)
    {
  ...
  public void debug_stack() {
      ...
      for (int i=0; i<stack.size(); i++) {
          com.sun.java_cup.internal.runtime.Symbol s = (com.sun.java_cup.internal.runtime.Symbol) stack.elementAt(i);
          ...
          /* if its less than zero, then it encodes a reduce action */
          else if (act < 0)
            {
              ...
              debug_message("# Reduce rule: top state " +
                             ((com.sun.java_cup.internal.runtime.Symbol)stack.peek()).parse_state +
  ...
  protected boolean shift_under_error()
    {
      ...
      return get_action(((com.sun.java_cup.internal.runtime.Symbol)stack.peek()).parse_state, error_sym()) > 0;
    }
  ...
  protected boolean find_recovery_config(boolean debug)
    {
      com.sun.java_cup.internal.runtime.Symbol error_token;
      int act;

      if (debug) debug_message("# Finding recovery state on stack");

      /* Remember the right-position of the top symbol on the stack */
      int right_pos = ((com.sun.java_cup.internal.runtime.Symbol)stack.peek()).right;
      int left_pos  = ((com.sun.java_cup.internal.runtime.Symbol)stack.peek()).left;
      ...
      while (!shift_under_error())
        {
          ...
          if (debug)
            debug_message("# Pop stack by one, state was # " +
                          ((com.sun.java_cup.internal.runtime.Symbol)stack.peek()).parse_state);
          left_pos = ((com.sun.java_cup.internal.runtime.Symbol)stack.pop()).left;
          tos--;
      ...
      act = get_action(((com.sun.java_cup.internal.runtime.Symbol)stack.peek()).parse_state, error_sym());
      if (debug)
        {
      ...
      error_token = new com.sun.java_cup.internal.runtime.Symbol(error_sym(), left_pos, right_pos);
  ...
  protected void read_lookahead() throws Exception
    {
      ...
      lookahead = new com.sun.java_cup.internal.runtime.Symbol[error_sync_size()];
  ...
  protected com.sun.java_cup.internal.runtime.Symbol cur_err_token() { return lookahead[lookahead_pos]; }
      ...
      while(!_done_parsing)
        {
          ...
          /* look up action out of the current state with the current input */
          act =
            get_action(((com.sun.java_cup.internal.runtime.Symbol)stack.peek()).parse_state, cur_err_token().sym);
