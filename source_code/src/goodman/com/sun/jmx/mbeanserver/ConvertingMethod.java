...
final class ConvertingMethod {
    ...
    void checkCallFromOpen() {
        try {
            for (com.sun.jmx.mbeanserver.MXBeanMapping paramConverter : paramMappings)
    ...
    final Object toOpenReturnValue(com.sun.jmx.mbeanserver.MXBeanLookup lookup, Object ret)
            throws OpenDataException {
        return returnMapping.toOpenValue(ret);
    }

    final Object fromOpenReturnValue(com.sun.jmx.mbeanserver.MXBeanLookup lookup, Object ret)
            throws InvalidObjectException {
        return returnMapping.fromOpenValue(ret);
    }

    final Object[] toOpenParameters(com.sun.jmx.mbeanserver.MXBeanLookup lookup, Object[] params)
            throws OpenDataException {
    ...
    final Object toOpenParameter(com.sun.jmx.mbeanserver.MXBeanLookup lookup,
                                 Object param,
                                 int paramNo)
        throws OpenDataException {
    ...
    final Object fromOpenParameter(com.sun.jmx.mbeanserver.MXBeanLookup lookup,
                                   Object param,
                                   int paramNo)
        throws InvalidObjectException {
    ...
    Object invokeWithOpenReturn(com.sun.jmx.mbeanserver.MXBeanLookup lookup,
                                Object obj, Object[] params)
            throws MBeanException, IllegalAccessException,
                   InvocationTargetException {
        com.sun.jmx.mbeanserver.MXBeanLookup old = com.sun.jmx.mbeanserver.MXBeanLookup.getLookup();
        try {
            com.sun.jmx.mbeanserver.MXBeanLookup.setLookup(lookup);
    ...
    private ConvertingMethod(Method m) throws OpenDataException {
        ...
        paramMappings = new com.sun.jmx.mbeanserver.MXBeanMapping[params.length];
