...
import goodman.java.util.BitSet;
...
import goodman.java.util.SortedMap;
import goodman.java.util.SortedSet;
import goodman.java.util.TreeSet;
import goodman.java.util.WeakHashMap;

import goodman.javax.management.JMX;
import goodman.javax.management.ObjectName;
import goodman.javax.management.openmbean.ArrayType;
import goodman.javax.management.openmbean.CompositeData;
import goodman.javax.management.openmbean.CompositeDataInvocationHandler;
import goodman.javax.management.openmbean.CompositeDataSupport;
import goodman.javax.management.openmbean.CompositeDataView;
import goodman.javax.management.openmbean.CompositeType;
import goodman.javax.management.openmbean.OpenDataException;
import goodman.javax.management.openmbean.OpenType;
import goodman.javax.management.openmbean.SimpleType;
import goodman.javax.management.openmbean.TabularData;
import goodman.javax.management.openmbean.TabularDataSupport;
import goodman.javax.management.openmbean.TabularType;
 ...
 * @since 1.6
 */
public class DefaultMXBeanMappingFactory extends com.sun.jmx.mbeanserver.MXBeanMappingFactory {
    static abstract class NonNullMXBeanMapping extends com.sun.jmx.mbeanserver.MXBeanMapping {
    ...
    static boolean isIdentity(com.sun.jmx.mbeanserver.MXBeanMapping mapping) {
        return (mapping instanceof NonNullMXBeanMapping &&
                ((NonNullMXBeanMapping) mapping).isIdentity());
    }

    private static final class Mappings
        extends WeakHashMap<Type, WeakReference<com.sun.jmx.mbeanserver.MXBeanMapping>> {}
    ...
    private static final List<com.sun.jmx.mbeanserver.MXBeanMapping> permanentMappings = newList();

    private static synchronized com.sun.jmx.mbeanserver.MXBeanMapping getMapping(Type type) {
        WeakReference<com.sun.jmx.mbeanserver.MXBeanMapping> wr = mappings.get(type);
        return (wr == null) ? null : wr.get();
    }

    private static synchronized void putMapping(Type type, com.sun.jmx.mbeanserver.MXBeanMapping mapping) {
        WeakReference<com.sun.jmx.mbeanserver.MXBeanMapping> wr =
            new WeakReference<com.sun.jmx.mbeanserver.MXBeanMapping>(mapping);
        mappings.put(type, wr);
    }

    private static synchronized void putPermanentMapping(
            Type type, com.sun.jmx.mbeanserver.MXBeanMapping mapping) {
    ...
    static {
        ...
        for (int i = 0; i < simpleTypes.length; i++) {
            ...
            final com.sun.jmx.mbeanserver.MXBeanMapping mapping = new IdentityMapping(c, t);
            ...
            if (c.getName().startsWith("java.lang.")) {
                try {
                    ...
                    final com.sun.jmx.mbeanserver.MXBeanMapping primitiveMapping =
                    ...
                    if (primitiveType != void.class) {
                        ...
                        final com.sun.jmx.mbeanserver.MXBeanMapping primitiveArrayMapping =
    ...
    @Override
    public synchronized com.sun.jmx.mbeanserver.MXBeanMapping mappingForType(Type objType,
                                                                             com.sun.jmx.mbeanserver.MXBeanMappingFactory factory)
            throws OpenDataException {
        ...
        com.sun.jmx.mbeanserver.MXBeanMapping mapping;
    ...
    private com.sun.jmx.mbeanserver.MXBeanMapping makeMapping(Type objType, com.sun.jmx.mbeanserver.MXBeanMappingFactory factory)
    throws OpenDataException {
    ...
    private static <T extends Enum<T>> com.sun.jmx.mbeanserver.MXBeanMapping
            makeEnumMapping(Class<?> enumClass, Class<T> fake) {
        ReflectUtil.checkPackageAccess(enumClass);
        return new EnumMapping<T>(com.sun.jmx.mbeanserver.Util.<Class<T>>cast(enumClass));
    }
     ...
     */
    private com.sun.jmx.mbeanserver.MXBeanMapping
        makeArrayOrCollectionMapping(Type collectionType, Type elementType,
                                     com.sun.jmx.mbeanserver.MXBeanMappingFactory factory)
            throws OpenDataException {

        final com.sun.jmx.mbeanserver.MXBeanMapping elementMapping = factory.mappingForType(elementType, factory);
    ...
    private com.sun.jmx.mbeanserver.MXBeanMapping
        ...
        final com.sun.jmx.mbeanserver.MXBeanMapping keyMapping = factory.mappingForType(keyType, factory);
        final com.sun.jmx.mbeanserver.MXBeanMapping valueMapping = factory.mappingForType(valueType, factory);
    ...
    private static com.sun.jmx.mbeanserver.MXBeanMapping makeMXBeanRefMapping(Type t)
            throws OpenDataException {
        return new MXBeanRefMapping(t);
    }

    private com.sun.jmx.mbeanserver.MXBeanMapping makeCompositeMapping(Class<?> c,
                                                                       com.sun.jmx.mbeanserver.MXBeanMappingFactory factory)
            throws OpenDataException {
    ...
    private static final class ArrayMapping extends NonNullMXBeanMapping {
        ArrayMapping(Type targetType,
                     ...
                     com.sun.jmx.mbeanserver.MXBeanMapping elementMapping) {
         ...
         */
        private final com.sun.jmx.mbeanserver.MXBeanMapping elementMapping;
    }
    ...
    private static final class MXBeanRefMapping extends NonNullMXBeanMapping {
        ...
        final Object toNonNullOpenValue(Object javaValue)
                throws OpenDataException {
            com.sun.jmx.mbeanserver.MXBeanLookup lookup = lookupNotNull(OpenDataException.class);
        ...
        final Object fromNonNullOpenValue(Object openValue)
                throws InvalidObjectException {
            com.sun.jmx.mbeanserver.MXBeanLookup lookup = lookupNotNull(InvalidObjectException.class);
        ...
        private <T extends Exception> com.sun.jmx.mbeanserver.MXBeanLookup
            lookupNotNull(Class<T> excClass)
                throws T {
            com.sun.jmx.mbeanserver.MXBeanLookup lookup = MXBeanLookup.getLookup();
            if (lookup == null) {
                final String msg =
    ...
    private static final class TabularMapping extends NonNullMXBeanMapping {
        TabularMapping(Type targetType,
                       ...
                       com.sun.jmx.mbeanserver.MXBeanMapping keyConverter,
                       com.sun.jmx.mbeanserver.MXBeanMapping valueConverter) {
        ...
        private final com.sun.jmx.mbeanserver.MXBeanMapping keyMapping;
        private final com.sun.jmx.mbeanserver.MXBeanMapping valueMapping;
    }
    ...
    private final class CompositeMapping extends NonNullMXBeanMapping {
        CompositeMapping(Class<?> targetClass,
            ...
            this.getterMappings = new com.sun.jmx.mbeanserver.MXBeanMapping[getters.length];
    ...
    private static abstract class CompositeBuilder {
        ...
        abstract Object fromCompositeData(CompositeData cd,
                                          String[] itemNames,
                                          com.sun.jmx.mbeanserver.MXBeanMapping[] converters)
                throws InvalidObjectException;
    ...
    private static class CompositeBuilderCheckGetters extends CompositeBuilder {
        CompositeBuilderCheckGetters(Class<?> targetClass, String[] itemNames,
                                     com.sun.jmx.mbeanserver.MXBeanMapping[] getterConverters) {
            super(targetClass, itemNames);
        ...
        private final com.sun.jmx.mbeanserver.MXBeanMapping[] getterConverters;
    ...
    private static final class CompositeBuilderViaConstructor
        ...
        final Object fromCompositeData(CompositeData cd,
                                       String[] itemNames,
                                       com.sun.jmx.mbeanserver.MXBeanMapping[] mappings)
                throws InvalidObjectException {
