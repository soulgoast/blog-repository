 ...
 * @since 1.6
 */
class StandardMBeanIntrospector extends com.sun.jmx.mbeanserver.MBeanIntrospector<Method> {
    ...
    @Override
    com.sun.jmx.mbeanserver.MBeanAnalyzer<Method> getAnalyzer(Class<?> mbeanInterface)
