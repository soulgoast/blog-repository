 ...
 */
public class ArrayNotificationBuffer implements com.sun.jmx.remote.internal.NotificationBuffer {
    ...
    public static com.sun.jmx.remote.internal.NotificationBuffer getNotificationBuffer(
        ...
        boolean create;
        com.sun.jmx.remote.internal.NotificationBuffer sharer;
    ...
    private class ShareBuffer implements com.sun.jmx.remote.internal.NotificationBuffer {
    ...
    private ArrayNotificationBuffer(MBeanServer mbs, int queueSize) {
        ...
        this.queue = new com.sun.jmx.remote.internal.ArrayQueue<NamedNotification>(queueSize);
        ...
        while (true) {
            ...
            synchronized (this) {
                ...
                if (nextSeq < nextSequenceNumber()) {
                    ...
                    if (!(filter instanceof com.sun.jmx.remote.internal.ServerNotifForwarder.NotifForwarderBufferFilter)) {
                        try {
