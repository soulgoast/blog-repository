...
import goodman.java.util.concurrent.Executor;
    ...
    */
    ...
    public synchronized void addNotificationListener(Integer listenerID,
        ...
        infoList.put(listenerID,
                     new com.sun.jmx.remote.internal.ClientListenerInfo(listenerID,
                                            name,
                                            listener,
                                            filter,
                                            handback,
    ...
    public synchronized Integer[]
        ...
        List<com.sun.jmx.remote.internal.ClientListenerInfo> values =
                new ArrayList<com.sun.jmx.remote.internal.ClientListenerInfo>(infoList.values());
        for (int i=values.size()-1; i>=0; i--) {
            com.sun.jmx.remote.internal.ClientListenerInfo li = values.get(i);
     ...
     */
    public synchronized com.sun.jmx.remote.internal.ClientListenerInfo[] preReconnection() throws IOException {
        if (state == TERMINATED || beingReconnected) { // should never
            throw new IOException("Illegal state.");
        }

        final com.sun.jmx.remote.internal.ClientListenerInfo[] tmp =
            infoList.values().toArray(new com.sun.jmx.remote.internal.ClientListenerInfo[0]);
     ...
     * <code>RMIConnector</code> and <code>ClientIntermediary</code>.
     */
    public synchronized void postReconnection(com.sun.jmx.remote.internal.ClientListenerInfo[] listenerInfos)
        throws IOException {
    ...
    private class NotifFetcher implements Runnable {
        ...
        private void doRun() {
            ...
            if (!shouldStop() && (nr = fetchNotifs()) != null) {
                ...
                final Map<Integer, com.sun.jmx.remote.internal.ClientListenerInfo> listeners;
                ...
                synchronized(ClientNotifForwarder.this) {
                    ...
                    listeners = new HashMap<Integer, com.sun.jmx.remote.internal.ClientListenerInfo>();
                    ...
                    for (int i = 0 ; i < len ; i++) {
                        ...
                        if (!listenerID.equals(mbeanRemovedNotifID)) {
                            final com.sun.jmx.remote.internal.ClientListenerInfo li = infoList.get(listenerID);
                            if (li != null) {
        ...
        void dispatchNotification(TargetedNotification tn,
                                  ...
                                  Map<Integer, com.sun.jmx.remote.internal.ClientListenerInfo> listeners) {
            final Notification notif = tn.getNotification();
            final Integer listenerID = tn.getListenerID();

            if (listenerID.equals(myListenerID)) return;
            final com.sun.jmx.remote.internal.ClientListenerInfo li = listeners.get(listenerID);
...
// -------------------------------------------------
    ...
    private final Map<Integer, com.sun.jmx.remote.internal.ClientListenerInfo> infoList =
