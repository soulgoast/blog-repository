...
import goodman.javax.management.remote.JMXPrincipal;
import goodman.javax.management.remote.JMXAuthenticator;
import goodman.javax.security.auth.AuthPermission;
import goodman.javax.security.auth.Subject;
import goodman.javax.security.auth.callback.*;
import goodman.javax.security.auth.login.AppConfigurationEntry;
import goodman.javax.security.auth.login.Configuration;
import goodman.javax.security.auth.login.LoginContext;
 ...
 * {@link com.sun.jmx.remote.security.FileLoginModule} is configured (<code>FileLoginConfig</code>).</p>
 *
