...
class SnmpSession implements SnmpDefinitions, Runnable {
     ...
     */
    protected transient com.sun.jmx.snmp.daemon.SnmpSocket informSocket = null;
    /**
    ...
    protected synchronized void initialize(SnmpAdaptorServer adp,
        ...
        informSocket = new com.sun.jmx.snmp.daemon.SnmpSocket(snmpRespHdlr, adp.getAddress(), adp.getBufferSize().intValue());
     ...
     */
    com.sun.jmx.snmp.daemon.SnmpSocket getSocket() {
        return informSocket;
    }
