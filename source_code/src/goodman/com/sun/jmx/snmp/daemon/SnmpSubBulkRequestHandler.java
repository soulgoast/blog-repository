...
class SnmpSubBulkRequestHandler extends com.sun.jmx.snmp.daemon.SnmpSubRequestHandler {
    private com.sun.jmx.snmp.daemon.SnmpAdaptorServer server = null;
    ...
    protected SnmpSubBulkRequestHandler(SnmpEngine engine,
                                        com.sun.jmx.snmp.daemon.SnmpAdaptorServer server,
     ...
     * in the original request.
     */
    protected SnmpSubBulkRequestHandler(com.sun.jmx.snmp.daemon.SnmpAdaptorServer server,
                                        SnmpMibAgent agent,
                                        SnmpPdu req,
                                        int nonRepeat,
                                        int maxRepeat,
