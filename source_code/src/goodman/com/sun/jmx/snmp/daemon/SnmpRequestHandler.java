...
package goodman.com.sun.jmx.snmp.daemon;
...
import goodman.java.io.InterruptedIOException;
...
import com.sun.jmx.snmp.daemon.*;
import com.sun.jmx.snmp.daemon.ClientHandler;
import com.sun.jmx.snmp.daemon.SnmpAdaptorServer;
import com.sun.jmx.snmp.daemon.SnmpMibTree;


class SnmpRequestHandler extends com.sun.jmx.snmp.daemon.ClientHandler implements SnmpDefinitions {
    ...
    private transient com.sun.jmx.snmp.daemon.SnmpAdaptorServer adaptor = null;
    /**
     * Full constructor
     */
    public SnmpRequestHandler(com.sun.jmx.snmp.daemon.SnmpAdaptorServer server, int id,
                              DatagramSocket s, DatagramPacket p,
                              com.sun.jmx.snmp.daemon.SnmpMibTree tree, Vector<SnmpMibAgent> m,
                              InetAddressAcl a,
    ...
    private DatagramPacket makeResponsePacket(DatagramPacket reqPacket) {
        ...
        try {
            ...
            reqMsg = null ;
            ((com.sun.jmx.snmp.daemon.SnmpAdaptorServer)adaptorServer).incSnmpInASNParseErrs(1) ;
        }
    ...
    private SnmpMessage makeResponseMessage(SnmpMessage reqMsg) {
        ...
        try {
            ...
            reqPdu = null ;
            com.sun.jmx.snmp.daemon.SnmpAdaptorServer snmpServer = (com.sun.jmx.snmp.daemon.SnmpAdaptorServer)adaptorServer ;
            ...
            if (pdu.type == SnmpDefinitions.pduSetRequestPdu) {
                ...
                if (!ipacl.checkReadPermission(pdu.address, community)) {
                    ...
                    response = newErrorResponsePdu(pdu,
                                                   err,
                                                   0);
                    com.sun.jmx.snmp.daemon.SnmpAdaptorServer snmpServer =
                        (com.sun.jmx.snmp.daemon.SnmpAdaptorServer)adaptorServer;
