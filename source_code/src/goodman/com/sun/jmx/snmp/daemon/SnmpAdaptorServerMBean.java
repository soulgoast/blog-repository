...
public interface SnmpAdaptorServerMBean extends CommunicatorServerMBean {
     ...
     */
    public Vector<?> snmpInformRequest(com.sun.jmx.snmp.daemon.SnmpInformHandler cb, SnmpOid trapOid,
                                       SnmpVarBindList varBindList)
     ...
     * @exception SnmpStatusException If the inform request exceeds the limit defined by <CODE>bufferSize</CODE>.
     */
    public com.sun.jmx.snmp.daemon.SnmpInformRequest snmpInformRequest(InetAddress address, String cs, com.sun.jmx.snmp.daemon.SnmpInformHandler cb,
