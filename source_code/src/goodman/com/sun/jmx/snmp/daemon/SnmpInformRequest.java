...
public class SnmpInformRequest implements SnmpDefinitions {
     ...
     */
    private transient com.sun.jmx.snmp.daemon.SnmpAdaptorServer adaptor;
     ...
     */
    private com.sun.jmx.snmp.daemon.SnmpInformHandler callback = null;
    ...
    SnmpInformRequest(com.sun.jmx.snmp.daemon.SnmpSession session,
                      ...
                      String cs,
                      int p,
                      com.sun.jmx.snmp.daemon.SnmpInformHandler requestCB)
    ...
    final public boolean waitForCompletion(long time) {
        ...
        if (informSession.thisSessionContext()) {
            ...
            //
            com.sun.jmx.snmp.daemon.SnmpInformHandler savedCallback = callback;
            callback = null;
    ...
    final void sendPduPacket(byte[] buffer, int length) throws java.io.IOException {
        ...
        com.sun.jmx.snmp.daemon.SnmpSocket theSocket = informSession.getSocket();
