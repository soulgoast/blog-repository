...
final class SnmpMibRequestImpl implements SnmpMibRequest {
    ...
    //
    // -------------------------------------------------------------------
    final void setRequestTree(com.sun.jmx.snmp.agent.SnmpRequestTree tree) {this.tree = tree;}

    // -------------------------------------------------------------------
    // Returns the SnmpRequestTree object built in the first operation
    // phase for two-phase SNMP requests (like SET).
    // -------------------------------------------------------------------
    final com.sun.jmx.snmp.agent.SnmpRequestTree getRequestTree() {return tree;}
    ...
    // Non final variable.
    private com.sun.jmx.snmp.agent.SnmpRequestTree tree = null;
