...
public abstract class SnmpMibGroup extends SnmpMibOid
     ...
     */
    @Override
    void registerNode(long[] oid, int cursor , com.sun.jmx.snmp.agent.SnmpMibNode node)
        throws IllegalAccessException {
    ...
    long[] findNextHandlingNode(SnmpVarBind varbind,
                                ...
                                SnmpRequestTree handlers, com.sun.jmx.snmp.agent.AcmChecker checker)
        throws SnmpStatusException {

        int length = oid.length;
        com.sun.jmx.snmp.agent.SnmpMibNode node = null;
