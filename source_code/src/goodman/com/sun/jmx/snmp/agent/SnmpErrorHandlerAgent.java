...
public class SnmpErrorHandlerAgent extends SnmpMibAgent
    ...
    @Override
    public void get(com.sun.jmx.snmp.agent.SnmpMibRequest inRequest) throws SnmpStatusException {
    ...
    @Override
    public void check(com.sun.jmx.snmp.agent.SnmpMibRequest inRequest) throws SnmpStatusException {
    ...
    @Override
    public void set(com.sun.jmx.snmp.agent.SnmpMibRequest inRequest) throws SnmpStatusException {
    ...
    @Override
    public void getNext(com.sun.jmx.snmp.agent.SnmpMibRequest inRequest) throws SnmpStatusException {
