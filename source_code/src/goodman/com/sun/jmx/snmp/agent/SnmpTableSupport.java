...
// end of NPCTE fix for bugId 4499265
     ...
     *
     **/
    protected SnmpTableSupport(com.sun.jmx.snmp.agent.SnmpMib mib) {
        theMib  = mib;
    ...
    public abstract void createNewEntry(SnmpMibSubRequest request,
                                        ...
                                        com.sun.jmx.snmp.agent.SnmpMibTable meta)
     ...
     *            given OID.
     **/
    public com.sun.jmx.snmp.agent.SnmpIndex buildSnmpIndex(SnmpOid rowOid)
        throws SnmpStatusException {
     ...
     **/
    public abstract SnmpOid buildOidFromIndex(com.sun.jmx.snmp.agent.SnmpIndex index)
        throws SnmpStatusException;
     ...
     * @exception SnmpStatusException if the given index is not valid.
     **/
    public abstract ObjectName buildNameFromIndex(com.sun.jmx.snmp.agent.SnmpIndex index)
        throws SnmpStatusException;
    ...
    public void addEntryCb(int pos, SnmpOid row, ObjectName name,
                           Object entry, com.sun.jmx.snmp.agent.SnmpMibTable meta)
        throws SnmpStatusException {
        try {
     ...
     * @exception SnmpStatusException if the given index is not valid.
     **/
    protected abstract com.sun.jmx.snmp.agent.SnmpIndex buildSnmpIndex(long oid[], int start )
        throws SnmpStatusException;
     ...
     * {@link com.sun.jmx.snmp.agent.SnmpTableSupport#addEntry(com.sun.jmx.snmp.agent.SnmpIndex, ObjectName, Object)} should be preferred.
     ...
     *            the given index.
     **/
    protected void addEntry(com.sun.jmx.snmp.agent.SnmpIndex index, Object entry)
        throws SnmpStatusException {
     ...
     *            the given index.
     **/
    protected void addEntry(com.sun.jmx.snmp.agent.SnmpIndex index, ObjectName name, Object entry)
        throws SnmpStatusException {
        SnmpOid oid = buildOidFromIndex(index);
        meta.addEntry(oid,name,entry);
    }
