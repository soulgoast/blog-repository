...
final class SnmpRequestTree {
    ...
    //         in SnmpDefinitions
    //
    SnmpRequestTree(com.sun.jmx.snmp.agent.SnmpMibRequest req, boolean creationflag, int pdutype) {
        this.request = req;
    ...
    static final class SnmpMibSubRequestImpl implements SnmpMibSubRequest {
        SnmpMibSubRequestImpl(com.sun.jmx.snmp.agent.SnmpMibRequest global, Vector<SnmpVarBind> sublist,
        ...
        final private com.sun.jmx.snmp.agent.SnmpMibRequest global;
    ...
    static final class Handler {
        com.sun.jmx.snmp.agent.SnmpMibNode meta;       // The meta  which handles the sublist.
...
//          if (entryoids != null) count += entryoids.size();
    ...
    public com.sun.jmx.snmp.agent.SnmpMibNode getMetaNode(Handler handler) {
        return handler.meta;
    }
    ...
    public void add(com.sun.jmx.snmp.agent.SnmpMibNode meta, int depth, SnmpVarBind varbind)
        throws SnmpStatusException {
    ...
    public void add(com.sun.jmx.snmp.agent.SnmpMibNode meta, int depth, SnmpOid entryoid,
