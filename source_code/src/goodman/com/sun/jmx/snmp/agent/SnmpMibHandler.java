...
public interface SnmpMibHandler {
     ...
     */
    public SnmpMibHandler addMib(com.sun.jmx.snmp.agent.SnmpMibAgent mib) throws IllegalArgumentException;
...
/**
     ...
     * @since 1.5
     */
    public SnmpMibHandler addMib(com.sun.jmx.snmp.agent.SnmpMibAgent mib, SnmpOid[] oids) throws IllegalArgumentException;
     ...
     * @since 1.5
     */
    public SnmpMibHandler addMib(com.sun.jmx.snmp.agent.SnmpMibAgent mib, String contextName)
     ...
     * @since 1.5
     */
    public SnmpMibHandler addMib(com.sun.jmx.snmp.agent.SnmpMibAgent mib, String contextName, SnmpOid[] oids)
        throws IllegalArgumentException;
     ...
     */
    public boolean removeMib(com.sun.jmx.snmp.agent.SnmpMibAgent mib);
  /**
     * Removes the specified MIB from the SNMP protocol adaptor.
     * This method is called automatically by {@link com.sun.jmx.snmp.agent.SnmpMibAgent#setSnmpAdaptor(SnmpMibHandler)} and
     * {@link com.sun.jmx.snmp.agent.SnmpMibAgent#setSnmpAdaptorName(ObjectName)} and should not be called directly.
     ...
     * @since 1.5
     */
    public boolean removeMib(com.sun.jmx.snmp.agent.SnmpMibAgent mib, SnmpOid[] oids);
     /**
     * Removes the specified MIB from the SNMP protocol adaptor.
     *
     * @param mib The MIB to be removed.
     ...
     * @since 1.5
     */
    public boolean removeMib(com.sun.jmx.snmp.agent.SnmpMibAgent mib, String contextName);
     /**
     * Removes the specified MIB from the SNMP protocol adaptor.
     *
     * @param mib The MIB to be removed.
