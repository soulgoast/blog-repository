...
public class SnmpStandardObjectServer implements Serializable {
     ...
     *  the MIB node.
     */
    public void get(com.sun.jmx.snmp.agent.SnmpStandardMetaServer meta, com.sun.jmx.snmp.agent.SnmpMibSubRequest req,
                    int depth)
        throws SnmpStatusException {
     ...
     *  the MIB node.
     */
    public void set(com.sun.jmx.snmp.agent.SnmpStandardMetaServer meta, com.sun.jmx.snmp.agent.SnmpMibSubRequest req,
                    int depth)
        throws SnmpStatusException {
