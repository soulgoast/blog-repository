...
package goodman.com.sun.jmx.snmp.agent;
...
import goodman.javax.management.MalformedObjectNameException;
...
public interface SnmpMibAgentMBean {
     ...
     * @see com.sun.jmx.snmp.agent.SnmpMibAgent#get(com.sun.jmx.snmp.agent.SnmpMibRequest)
     */
    public void get(com.sun.jmx.snmp.agent.SnmpMibRequest req) throws SnmpStatusException;
     ...
     *
     * @exception SnmpStatusException An error occurred during the operation.
     * @see com.sun.jmx.snmp.agent.SnmpMibAgent#getNext(com.sun.jmx.snmp.agent.SnmpMibRequest)
     */
    public void getNext(com.sun.jmx.snmp.agent.SnmpMibRequest req) throws SnmpStatusException;
     ...
     *
     * @exception SnmpStatusException An error occurred during the operation.
     * @see com.sun.jmx.snmp.agent.SnmpMibAgent#getBulk(com.sun.jmx.snmp.agent.SnmpMibRequest,int,int)
     */
    public void getBulk(com.sun.jmx.snmp.agent.SnmpMibRequest req, int nonRepeat, int maxRepeat)
     ...
     *
     * @exception SnmpStatusException An error occurred during the operation.
     * @see com.sun.jmx.snmp.agent.SnmpMibAgent#set(com.sun.jmx.snmp.agent.SnmpMibRequest)
     */
    public void set(com.sun.jmx.snmp.agent.SnmpMibRequest req) throws SnmpStatusException;
     ...
     *    cannot be performed.
     * @see SnmpMibAgent#check(com.sun.jmx.snmp.agent.SnmpMibRequest)
     */
     ...
     */
    public com.sun.jmx.snmp.agent.SnmpMibHandler getSnmpAdaptor();
     ...
     */
    public void setSnmpAdaptor(com.sun.jmx.snmp.agent.SnmpMibHandler stack);
     ...
     * @since 1.5
     */
    public void setSnmpAdaptor(com.sun.jmx.snmp.agent.SnmpMibHandler stack, SnmpOid[] oids);
     ...
     * @since 1.5
     */
    public void setSnmpAdaptor(com.sun.jmx.snmp.agent.SnmpMibHandler stack, String contextName);
