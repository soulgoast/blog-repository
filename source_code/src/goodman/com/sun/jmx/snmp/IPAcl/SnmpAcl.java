...
import goodman.java.security.acl.AclEntry;
import goodman.java.security.acl.NotOwnerException;
...
public class SnmpAcl implements InetAddressAcl, Serializable {
    ...
    private void readAuthorizedListFile() {
        ...
        if (authorizedListFile == null) {
            ...
            com.sun.jmx.snmp.IPAcl.Parser parser = null;
            try {
                parser= new com.sun.jmx.snmp.IPAcl.Parser(new FileInputStream(getAuthorizedListFile()));
