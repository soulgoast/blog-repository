...
public class SnmpOidTableSupport implements SnmpOidTable {
     ...
     */
    @Override
    public com.sun.jmx.snmp.SnmpOidRecord resolveVarName(String name) throws SnmpStatusException {

        com.sun.jmx.snmp.SnmpOidRecord var  = oidStore.get(name) ;
        if (var != null) {
            return var;
        } else {
     ...
     */
    @Override
    public com.sun.jmx.snmp.SnmpOidRecord resolveVarOid(String oid) throws SnmpStatusException {
        ...
        //
        for(Enumeration<com.sun.jmx.snmp.SnmpOidRecord> list = oidStore.elements(); list.hasMoreElements(); ) {
            com.sun.jmx.snmp.SnmpOidRecord element= list.nextElement();
     ...
     */
    @Override
    public Vector<com.sun.jmx.snmp.SnmpOidRecord> getAllEntries() {

        Vector<com.sun.jmx.snmp.SnmpOidRecord> elementsVector = new Vector<>();
        // get the locally defined elements ...
        for (Enumeration<com.sun.jmx.snmp.SnmpOidRecord> e = oidStore.elements();
             e.hasMoreElements(); ) {
     ...
     */
    public synchronized void loadMib(com.sun.jmx.snmp.SnmpOidRecord[] mibs) {
        try {
            for (int i = 0; ; i++) {
                com.sun.jmx.snmp.SnmpOidRecord s = mibs[i] ;
