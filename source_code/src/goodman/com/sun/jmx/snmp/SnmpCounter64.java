...
public class SnmpCounter64 extends com.sun.jmx.snmp.SnmpValue {
    ...
    public com.sun.jmx.snmp.SnmpOid toOid() {
        return new com.sun.jmx.snmp.SnmpOid(value) ;
    }
    ...
    public static com.sun.jmx.snmp.SnmpOid toOid(long[] index, int start) throws SnmpStatusException {
        try {
            return new com.sun.jmx.snmp.SnmpOid(index[start]) ;
        }
     ...
     */
    public static void appendToOid(com.sun.jmx.snmp.SnmpOid source, SnmpOid dest) {
     ...
     */
    final synchronized public com.sun.jmx.snmp.SnmpValue duplicate() {
