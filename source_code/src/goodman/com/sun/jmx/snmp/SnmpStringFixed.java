...
public class SnmpStringFixed extends SnmpString {
     ...
     */
    public static com.sun.jmx.snmp.SnmpOid toOid(int l, long[] index, int start) throws SnmpStatusException {
        try {
            long[] ids = new long[l] ;
            for (int i = 0 ; i < l ; i++) {
                ids[i] = index[start + i] ;
     ...
     */
    public static void appendToOid(int l, com.sun.jmx.snmp.SnmpOid source, SnmpOid dest) {
        dest.append(source) ;
    }
}
