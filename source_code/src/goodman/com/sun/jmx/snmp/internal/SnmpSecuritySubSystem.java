 ...
 *
 */
package goodman.com.sun.jmx.snmp.internal;
...
public interface SnmpSecuritySubSystem extends SnmpSubSystem {
     ...
     */
    public com.sun.jmx.snmp.internal.SnmpSecurityCache createSecurityCache(int id) throws SnmpUnknownSecModelException;
    /**
    ...
    public void releaseSecurityCache(int id,
                                     com.sun.jmx.snmp.internal.SnmpSecurityCache cache) throws SnmpUnknownSecModelException;
     ...
     */
    public int generateRequestMsg(com.sun.jmx.snmp.internal.SnmpSecurityCache cache,
                                  int version,
                                  int msgID,
                                  int msgMaxSize,
                                  byte msgFlags,
     ...
     * @return The marshalled byte number.
     */
    public int generateResponseMsg(com.sun.jmx.snmp.internal.SnmpSecurityCache cache,
                                   int version,
                                   int msgID,
                                   int msgMaxSize,
                                   byte msgFlags,
    ...
    public SnmpSecurityParameters
        processIncomingRequest(com.sun.jmx.snmp.internal.SnmpSecurityCache cache,
                               int version,
                               int msgID,
                               int msgMaxSize,
                               byte msgFlags,
                               ...
                               byte[] data,
                               byte[] encryptedPdu,
                               com.sun.jmx.snmp.internal.SnmpDecryptedPdu decryptedPdu)
