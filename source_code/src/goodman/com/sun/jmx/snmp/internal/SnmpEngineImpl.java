...
public class SnmpEngineImpl implements SnmpEngine, Serializable {
    ...
    transient private com.sun.jmx.snmp.internal.SnmpLcd lcd = null;
     ...
     */
    public com.sun.jmx.snmp.internal.SnmpLcd getLcd() {
        return lcd;
    }
    /**
    ...
    public SnmpEngineImpl(SnmpEngineFactory fact,
                          com.sun.jmx.snmp.internal.SnmpLcd lcd,
     ...
     */
    public SnmpEngineImpl(SnmpEngineFactory fact,
                          com.sun.jmx.snmp.internal.SnmpLcd lcd) throws UnknownHostException {
        init(lcd, fact);
        initEngineID();
        if(engineid == null)
