...
public interface SnmpSubSystem {
     ...
     */
    public void addModel(int id, com.sun.jmx.snmp.internal.SnmpModel model);
     ...
     */
    public com.sun.jmx.snmp.internal.SnmpModel removeModel(int id) throws SnmpUnknownModelException;
