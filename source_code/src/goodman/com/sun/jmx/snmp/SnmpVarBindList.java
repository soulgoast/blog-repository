...
public class SnmpVarBindList extends Vector<com.sun.jmx.snmp.SnmpVarBind> {
     ...
     */
    com.sun.jmx.snmp.Timestamp timestamp ;
     ...
     */
    public SnmpVarBindList(Vector<com.sun.jmx.snmp.SnmpVarBind> list) {
        super(list.size(), 5);
        for (Enumeration<com.sun.jmx.snmp.SnmpVarBind> e = list.elements(); e.hasMoreElements();) {
            final com.sun.jmx.snmp.SnmpVarBind varBind = e.nextElement();
     ...
     * @param list The vector of <CODE>SnmpVarBind</CODE> objects to copy.
     */
    public SnmpVarBindList(String name, Vector<com.sun.jmx.snmp.SnmpVarBind> list) {
        this(list);
        identity = name;
    }
     ...
     */
    public com.sun.jmx.snmp.Timestamp getTimestamp() {
        return timestamp ;
    }
     ...
     */
    public final synchronized com.sun.jmx.snmp.SnmpVarBind getVarBindAt(int pos) {
     ...
     */
    public synchronized Enumeration<com.sun.jmx.snmp.SnmpVarBind> getVarBindList() {
        return elements() ;
    }
     ...
     */
    public final synchronized void setVarBindList(Vector<com.sun.jmx.snmp.SnmpVarBind> list) {
     ...
     */
    public final synchronized void setVarBindList(Vector<com.sun.jmx.snmp.SnmpVarBind> list, boolean copy) {
        synchronized (list) {
            ...
            if (copy) {         // do deepcopy of all vars.
                for (int i = 0; i < max ; i++) {
                    com.sun.jmx.snmp.SnmpVarBind avar = (com.sun.jmx.snmp.SnmpVarBind)elementData[i] ;
     ...
     * @exception ArrayIndexOutOfBoundsException If the specified <CODE>pos</CODE> is beyond range.
     */
    public final synchronized void replaceVarBind(com.sun.jmx.snmp.SnmpVarBind var, int pos) {
    ...
    public final synchronized void addVarBind(String list[], String inst) throws SnmpStatusException {
        for (int i = 0; i < list.length; i++) {
            com.sun.jmx.snmp.SnmpVarBind avar = new com.sun.jmx.snmp.SnmpVarBind(list[i]) ;
    ...
    public synchronized void addVarBind(String name) throws SnmpStatusException {
        com.sun.jmx.snmp.SnmpVarBind avar ;
        avar = new com.sun.jmx.snmp.SnmpVarBind(name) ;
        addVarBind(avar) ;
    }
     ...
     */
    public synchronized void addVarBind(com.sun.jmx.snmp.SnmpVarBind var) {
        addElement(var) ;
    }
     ...
     * <CODE>SnmpVarBindList</CODE>, <CODE>false</CODE> otherwise.
     */
    public synchronized boolean removeVarBind(com.sun.jmx.snmp.SnmpVarBind var) {
    ...
    public synchronized void addInstance(String inst) throws SnmpStatusException {
        int max= size();
        for (int i = 0; i < max;  i++) {
            ((com.sun.jmx.snmp.SnmpVarBind)elementData[i]).addInstance(inst) ;
        }
    }
     ...
     */
    final public synchronized void concat(Vector<com.sun.jmx.snmp.SnmpVarBind> list) {
    ...
    public synchronized SnmpVarBindList splitAt(int pos) {
        ...
        for (int i = pos; i < max ; i++)
            splitVb.addElement((com.sun.jmx.snmp.SnmpVarBind) elementData[i]) ;
        elementCount = pos ;
        trimToSize() ;
        return splitVb ;
    }
     ...
     */
    public synchronized int indexOfOid(com.sun.jmx.snmp.SnmpVarBind var, int min, int max) {
        com.sun.jmx.snmp.SnmpOid oidarg = var.getOid() ;
     ...
     * @return The index of the OID in <CODE>SnmpVarBindList</CODE>.
     */
    public synchronized int indexOfOid(com.sun.jmx.snmp.SnmpVarBind var) {
    ...
    public synchronized SnmpVarBindList cloneWithoutValue() {
        ...
        for (int i = 0; i < max ; i++) {
            com.sun.jmx.snmp.SnmpVarBind avar = (com.sun.jmx.snmp.SnmpVarBind)elementData[i] ;
            newvb.addElement((com.sun.jmx.snmp.SnmpVarBind) avar.cloneWithoutValue()) ;
        }
        return newvb ;
    }
     ...
     */
    public synchronized Vector<com.sun.jmx.snmp.SnmpVarBind> toVector(boolean copy) {
        final int count = elementCount;
        if (copy == false) return new Vector<>(this);
        Vector<com.sun.jmx.snmp.SnmpVarBind> result = new Vector<>(count,5);
    ...
    public String oidListToString() {
        ...
        for (int i = 0 ; i < elementCount ; i++) {
            com.sun.jmx.snmp.SnmpVarBind avar = (SnmpVarBind)elementData[i] ;
