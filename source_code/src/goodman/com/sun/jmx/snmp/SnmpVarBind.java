...
package goodman.com.sun.jmx.snmp;
...
public class SnmpVarBind implements SnmpDataTypeEnums, Cloneable, Serializable {
     ...
     */
    public final static com.sun.jmx.snmp.SnmpNull noSuchObject   = new com.sun.jmx.snmp.SnmpNull(errNoSuchObjectTag) ;

    /**
     * Error code value as defined in RFC 1448 for: <CODE>noSuchInstance</CODE>.
     */
    public final static com.sun.jmx.snmp.SnmpNull noSuchInstance = new com.sun.jmx.snmp.SnmpNull(errNoSuchInstanceTag) ;

    /**
     * Error code value as defined in RFC 1448 for: <CODE>endOfMibView</CODE>.
     */
    public final static com.sun.jmx.snmp.SnmpNull endOfMibView   = new SnmpNull(errEndOfMibViewTag) ;
     ...
     */
    public com.sun.jmx.snmp.SnmpOid oid = null ;
     ...
     */
    public com.sun.jmx.snmp.SnmpValue value = null ;
     ...
     */
    public SnmpVarBind(com.sun.jmx.snmp.SnmpOid oid) {
        this.oid = oid ;
    }
     ...
     */
    public SnmpVarBind(com.sun.jmx.snmp.SnmpOid oid, com.sun.jmx.snmp.SnmpValue val) {
        this.oid = oid ;
    ...
    public SnmpVarBind(String name) throws SnmpStatusException {
        ...
        if (name.startsWith(".")) {
            this.oid = new com.sun.jmx.snmp.SnmpOid(name) ;
        } else {
            ...
            try {
                ...
                if (index <= 0) {
                    ...
                    this.oid = new com.sun.jmx.snmp.SnmpOid(record.getName()) ;
                } else {
                    record = resolveVarName(name.substring(0, index)) ;
                    this.oid = new com.sun.jmx.snmp.SnmpOid(record.getName() + name.substring(index)) ;
                }
            }
        }
    }
     ...
     */
    final public com.sun.jmx.snmp.SnmpOid getOid() {
        return this.oid ;
    }
     ...
     */
    final public void setOid(com.sun.jmx.snmp.SnmpOid oid) {
        this.oid = oid ;
        clearValue() ;
    }
     ...
     */
    final synchronized public com.sun.jmx.snmp.SnmpValue getSnmpValue() {
        return this.value ;
    }
     ...
     * it is not an instance.
     */
    final public com.sun.jmx.snmp.SnmpInt getSnmpIntValue() throws ClassCastException {
        return (com.sun.jmx.snmp.SnmpInt)this.value ;
    }
     ...
     * it is not an instance.
     */
    final public com.sun.jmx.snmp.SnmpCounter getSnmpCounterValue() throws ClassCastException {
        return (com.sun.jmx.snmp.SnmpCounter)this.value ;
    }
     ...
     * @see com.sun.jmx.snmp.SnmpCounter
     */
     ...
     * it is not an instance.
     */
    final public com.sun.jmx.snmp.SnmpGauge getSnmpGaugeValue() throws ClassCastException {
        return (com.sun.jmx.snmp.SnmpGauge)this.value ;
    }
     ...
     * @exception IllegalArgumentException The specified value is negative or larger than
     * <CODE>SnmpUnsignedInt.MAX_VALUE</CODE>.
     * @see com.sun.jmx.snmp.SnmpGauge
     */
     ...
     * it is not an instance.
     */
    final public com.sun.jmx.snmp.SnmpOid getSnmpOidValue() throws ClassCastException {
        return (com.sun.jmx.snmp.SnmpOid)this.value ;
    }
     ...
     * it is not an instance.
     */
    final public com.sun.jmx.snmp.SnmpString getSnmpStringValue() throws ClassCastException {
        return (com.sun.jmx.snmp.SnmpString)this.value ;
    }
     ...
     * @see com.sun.jmx.snmp.SnmpString
     */
     ...
     * it is not an instance.
     */
    final public com.sun.jmx.snmp.SnmpOpaque getSnmpOpaqueValue() throws ClassCastException {
        return (com.sun.jmx.snmp.SnmpOpaque)this.value ;
    }
     ...
     * @see com.sun.jmx.snmp.SnmpOpaque
     */
    ...
    public SnmpOidRecord resolveVarName(String name) throws SnmpStatusException {
        ...
        SnmpOidTable mibTable = com.sun.jmx.snmp.SnmpOid.getSnmpOidTable();
        if (mibTable == null)
     ...
     */
    public void appendInOid(com.sun.jmx.snmp.SnmpOid oid) {
        this.oid.append(oid) ;
    }
    ...
    public void copyValueAndOid(SnmpVarBind var) {
        setOid((com.sun.jmx.snmp.SnmpOid) (var.oid.clone())) ;
        copyValue(var) ;
    }
    ...
    public Object cloneWithoutValue() {
        com.sun.jmx.snmp.SnmpOid noid = (SnmpOid)this.oid.clone() ;
