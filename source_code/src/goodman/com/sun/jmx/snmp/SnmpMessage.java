...
public class SnmpMessage extends SnmpMsg implements SnmpDefinitions {
    ...
    public int encodeMessage(byte[] outputBytes) throws SnmpTooBigException {
        ...
        //
        try {
            com.sun.jmx.snmp.BerEncoder benc = new com.sun.jmx.snmp.BerEncoder(outputBytes) ;
            benc.openSequence() ;
    ...
    public int getRequestId(byte[] inputBytes) throws SnmpStatusException {
        int requestId = 0;
        com.sun.jmx.snmp.BerDecoder bdec = null;
        com.sun.jmx.snmp.BerDecoder bdec2 = null;
        byte[] any = null;
        try {
            bdec = new com.sun.jmx.snmp.BerDecoder(inputBytes);
            bdec.openSequence();
            bdec.fetchInteger();
            bdec.fetchOctetString();
            any = bdec.fetchAny();
            bdec2 = new com.sun.jmx.snmp.BerDecoder(any);
    ...
    public void decodeMessage(byte[] inputBytes, int byteCount)
        ...
        try {
            com.sun.jmx.snmp.BerDecoder bdec = new com.sun.jmx.snmp.BerDecoder(inputBytes/*, byteCount */) ; // FIXME
            bdec.openSequence() ;
     ...
     * @since 1.5
     */
    public void encodeSnmpPdu(com.sun.jmx.snmp.SnmpPdu pdu, int maxDataLength)
        ...
        try {
            com.sun.jmx.snmp.BerEncoder benc = new BerEncoder(data) ;
            benc.openSequence() ;
            ...
            case pduV1TrapPdu :
                ...
                benc.putInteger(trapPdu.timeStamp, com.sun.jmx.snmp.SnmpValue.TimeticksTag) ;
                benc.putInteger(trapPdu.specificTrap) ;
                benc.putInteger(trapPdu.genericTrap) ;
                if(trapPdu.agentAddr != null)
                    benc.putOctetString(trapPdu.agentAddr.byteValue(), com.sun.jmx.snmp.SnmpValue.IpAddressTag) ;
                else
                    benc.putOctetString(new byte[0], com.sun.jmx.snmp.SnmpValue.IpAddressTag);
    ...
    public SnmpPdu decodeSnmpPdu()
        ...
        com.sun.jmx.snmp.BerDecoder bdec = new BerDecoder(data) ;
        try {
            ...
            case pduV1TrapPdu :
                ...
                byte []b = bdec.fetchOctetString(com.sun.jmx.snmp.SnmpValue.IpAddressTag);
                if(b.length != 0)
