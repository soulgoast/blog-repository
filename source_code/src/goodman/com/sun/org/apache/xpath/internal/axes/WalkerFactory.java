...
public class WalkerFactory
{
   ...
   * @xsl.usage advanced
   */
  static com.sun.org.apache.xpath.internal.axes.AxesWalker loadOneWalker(
          WalkingIterator lpi, Compiler compiler, int stepOpCodePos)
            throws javax.xml.transform.TransformerException
  {

    com.sun.org.apache.xpath.internal.axes.AxesWalker firstWalker = null;
   ...
   * @xsl.usage advanced
   */
  static com.sun.org.apache.xpath.internal.axes.AxesWalker loadWalkers(
            ...
            throws javax.xml.transform.TransformerException
  {
    ...
    int stepType;
    com.sun.org.apache.xpath.internal.axes.AxesWalker firstWalker = null;
    com.sun.org.apache.xpath.internal.axes.AxesWalker walker, prevWalker = null;
...
//          || (Axis.PRECEDINGSIBLING == axis)
   ...
   */
  private static com.sun.org.apache.xpath.internal.axes.AxesWalker createDefaultWalker(Compiler compiler, int opPos,
                                                                                       WalkingIterator lpi, int analysis)
  {

    com.sun.org.apache.xpath.internal.axes.AxesWalker ai = null;
    int stepType = compiler.getOp(opPos);
    ...
    */
    ...
    case OpCodes.OP_GROUP :
      ...
      break;
    case OpCodes.FROM_ROOT :
      ai = new com.sun.org.apache.xpath.internal.axes.AxesWalker(lpi, Axis.ROOT);
      break;
    case OpCodes.FROM_ANCESTORS :
      prevIsOneStepDown = false;
    ...
    case OpCodes.FROM_ANCESTORS_OR_SELF :
      ...
      break;
    case OpCodes.FROM_ATTRIBUTES :
      ai = new com.sun.org.apache.xpath.internal.axes.AxesWalker(lpi, Axis.ATTRIBUTE);
      break;
    case OpCodes.FROM_NAMESPACE :
      ai = new com.sun.org.apache.xpath.internal.axes.AxesWalker(lpi, Axis.NAMESPACE);
      break;
    case OpCodes.FROM_CHILDREN :
      ai = new com.sun.org.apache.xpath.internal.axes.AxesWalker(lpi, Axis.CHILD);
      break;
    case OpCodes.FROM_DESCENDANTS :
      prevIsOneStepDown = false;
      ai = new com.sun.org.apache.xpath.internal.axes.AxesWalker(lpi, Axis.DESCENDANT);
      break;
    case OpCodes.FROM_DESCENDANTS_OR_SELF :
      prevIsOneStepDown = false;
      ai = new com.sun.org.apache.xpath.internal.axes.AxesWalker(lpi, Axis.DESCENDANTORSELF);
      break;
    case OpCodes.FROM_FOLLOWING :
      prevIsOneStepDown = false;
      ai = new com.sun.org.apache.xpath.internal.axes.AxesWalker(lpi, Axis.FOLLOWING);
      break;
    case OpCodes.FROM_FOLLOWING_SIBLINGS :
      prevIsOneStepDown = false;
      ai = new com.sun.org.apache.xpath.internal.axes.AxesWalker(lpi, Axis.FOLLOWINGSIBLING);
      break;
    case OpCodes.FROM_PRECEDING :
      prevIsOneStepDown = false;
