...
public class CachedXPathAPI
{
  ...
  */
  protected com.sun.org.apache.xpath.internal.XPathContext xpathSupport;

  /**
   * <p>Default constructor. Establishes its own {@link com.sun.org.apache.xpath.internal.XPathContext}, and hence
  ...
  {
    xpathSupport = new com.sun.org.apache.xpath.internal.XPathContext(JdkXmlUtils.OVERRIDE_PARSER_DEFAULT);
  }

  /**
   * <p>This constructor shares its {@link com.sun.org.apache.xpath.internal.XPathContext} with a pre-existing
          ...
          throws TransformerException
  {
    ...
    com.sun.org.apache.xpath.internal.XPath xpath = new com.sun.org.apache.xpath.internal.XPath(str, null, prefixResolver, com.sun.org.apache.xpath.internal.XPath.SELECT, null);
            ...
            throws TransformerException
  {
    ...
    //    XPathContext should be done away with.)
    // Create the XPath object.
    com.sun.org.apache.xpath.internal.XPath xpath = new com.sun.org.apache.xpath.internal.XPath(str, null, prefixResolver, XPath.SELECT, null);

    // Execute the XPath, and have it return the result
    com.sun.org.apache.xpath.internal.XPathContext xpathSupport = new XPathContext(JdkXmlUtils.OVERRIDE_PARSER_DEFAULT);
    int ctxtNode = xpathSupport.getDTMHandleFromNode(contextNode);
