...
import goodman.javax.xml.transform.SourceLocator;
 ...
 * @xsl.usage advanced
 */
public class Compiler extends com.sun.org.apache.xpath.internal.compiler.OpMap
{
  ...
  public Expression compile(int opPos) throws TransformerException
  {
    ...
    switch (op)
    {
    case com.sun.org.apache.xpath.internal.compiler.OpCodes.OP_XPATH :
      expr = compile(opPos + 2); break;
    case com.sun.org.apache.xpath.internal.compiler.OpCodes.OP_OR :
      expr = or(opPos); break;
    case com.sun.org.apache.xpath.internal.compiler.OpCodes.OP_AND :
      expr = and(opPos); break;
    case com.sun.org.apache.xpath.internal.compiler.OpCodes.OP_NOTEQUALS :
      expr = notequals(opPos); break;
    case com.sun.org.apache.xpath.internal.compiler.OpCodes.OP_EQUALS :
      expr = equals(opPos); break;
    case com.sun.org.apache.xpath.internal.compiler.OpCodes.OP_LTE :
      expr = lte(opPos); break;
    case com.sun.org.apache.xpath.internal.compiler.OpCodes.OP_LT :
      expr = lt(opPos); break;
    case com.sun.org.apache.xpath.internal.compiler.OpCodes.OP_GTE :
      expr = gte(opPos); break;
    case com.sun.org.apache.xpath.internal.compiler.OpCodes.OP_GT :
      expr = gt(opPos); break;
    case com.sun.org.apache.xpath.internal.compiler.OpCodes.OP_PLUS :
      expr = plus(opPos); break;
    case com.sun.org.apache.xpath.internal.compiler.OpCodes.OP_MINUS :
      expr = minus(opPos); break;
    case com.sun.org.apache.xpath.internal.compiler.OpCodes.OP_MULT :
      expr = mult(opPos); break;
    case com.sun.org.apache.xpath.internal.compiler.OpCodes.OP_DIV :
      expr = div(opPos); break;
    case com.sun.org.apache.xpath.internal.compiler.OpCodes.OP_MOD :
      expr = mod(opPos); break;
//    case OpCodes.OP_QUO :
//      expr = quo(opPos); break;
    case com.sun.org.apache.xpath.internal.compiler.OpCodes.OP_NEG :
      expr = neg(opPos); break;
    case com.sun.org.apache.xpath.internal.compiler.OpCodes.OP_STRING :
      expr = string(opPos); break;
    case com.sun.org.apache.xpath.internal.compiler.OpCodes.OP_BOOL :
      expr = bool(opPos); break;
    case com.sun.org.apache.xpath.internal.compiler.OpCodes.OP_NUMBER :
      expr = number(opPos); break;
    case com.sun.org.apache.xpath.internal.compiler.OpCodes.OP_UNION :
      expr = union(opPos); break;
    case com.sun.org.apache.xpath.internal.compiler.OpCodes.OP_LITERAL :
      expr = literal(opPos); break;
    case com.sun.org.apache.xpath.internal.compiler.OpCodes.OP_VARIABLE :
      expr = variable(opPos); break;
    case com.sun.org.apache.xpath.internal.compiler.OpCodes.OP_GROUP :
      expr = group(opPos); break;
    case com.sun.org.apache.xpath.internal.compiler.OpCodes.OP_NUMBERLIT :
      expr = numberlit(opPos); break;
    case com.sun.org.apache.xpath.internal.compiler.OpCodes.OP_ARGUMENT :
      expr = arg(opPos); break;
    case com.sun.org.apache.xpath.internal.compiler.OpCodes.OP_EXTFUNCTION :
      expr = compileExtension(opPos); break;
    case com.sun.org.apache.xpath.internal.compiler.OpCodes.OP_FUNCTION :
      expr = compileFunction(opPos); break;
    case com.sun.org.apache.xpath.internal.compiler.OpCodes.OP_LOCATIONPATH :
      expr = locationPath(opPos); break;
    case com.sun.org.apache.xpath.internal.compiler.OpCodes.OP_PREDICATE :
      expr = null; break;  // should never hit this here.
    case com.sun.org.apache.xpath.internal.compiler.OpCodes.OP_MATCHPATTERN :
      expr = matchPattern(opPos + 2); break;
    case com.sun.org.apache.xpath.internal.compiler.OpCodes.OP_LOCATIONPATHPATTERN :
      expr = locationPathPattern(opPos); break;
    case com.sun.org.apache.xpath.internal.compiler.OpCodes.OP_QUO:
...
//  }
  ...
  protected Expression variable(int opPos) throws TransformerException
  {
    ...
    String namespace
      = (com.sun.org.apache.xpath.internal.compiler.OpCodes.EMPTY == nsPos) ? null
  ...
  protected Expression matchPattern(int opPos) throws TransformerException
  {
    ...
    try
    {
      ...
      for (i = 0; getOp(nextOpPos) == com.sun.org.apache.xpath.internal.compiler.OpCodes.OP_LOCATIONPATHPATTERN; i++)
      {
      ...
      for (i = 0; getOp(opPos) == com.sun.org.apache.xpath.internal.compiler.OpCodes.OP_LOCATIONPATHPATTERN; i++)
      {
...
//      return DTMFilter.SHOW_ALL;
      switch (axesType)
      {
      case com.sun.org.apache.xpath.internal.compiler.OpCodes.FROM_NAMESPACE:
        return DTMFilter.SHOW_NAMESPACE;
      case com.sun.org.apache.xpath.internal.compiler.OpCodes.FROM_ATTRIBUTES :
      case com.sun.org.apache.xpath.internal.compiler.OpCodes.MATCH_ATTRIBUTE :
        return DTMFilter.SHOW_ATTRIBUTE;
      case com.sun.org.apache.xpath.internal.compiler.OpCodes.FROM_SELF:
      case com.sun.org.apache.xpath.internal.compiler.OpCodes.FROM_ANCESTORS_OR_SELF:
      case com.sun.org.apache.xpath.internal.compiler.OpCodes.FROM_DESCENDANTS_OR_SELF:
        return DTMFilter.SHOW_ALL;
      default:
        if (getOp(0) == com.sun.org.apache.xpath.internal.compiler.OpCodes.OP_MATCHPATTERN)
          return ~DTMFilter.SHOW_ATTRIBUTE
    ...
    case com.sun.org.apache.xpath.internal.compiler.OpCodes.NODETYPE_ROOT :
      return DTMFilter.SHOW_DOCUMENT | DTMFilter.SHOW_DOCUMENT_FRAGMENT;
    case com.sun.org.apache.xpath.internal.compiler.OpCodes.NODETYPE_FUNCTEST :
      return NodeTest.SHOW_BYFUNCTION;
    case com.sun.org.apache.xpath.internal.compiler.OpCodes.NODENAME :
      switch (axesType)
      {
      case com.sun.org.apache.xpath.internal.compiler.OpCodes.FROM_NAMESPACE :
        return DTMFilter.SHOW_NAMESPACE;
      ...
      // break;
      case com.sun.org.apache.xpath.internal.compiler.OpCodes.MATCH_ANY_ANCESTOR :
      case com.sun.org.apache.xpath.internal.compiler.OpCodes.MATCH_IMMEDIATE_ANCESTOR :
...
private static final boolean DEBUG = false;
            ...
            throws TransformerException
  {
    ...
    if (com.sun.org.apache.xpath.internal.compiler.OpCodes.ENDOP == stepType)
    {
      return null;
    }
    ...
    case com.sun.org.apache.xpath.internal.compiler.OpCodes.OP_FUNCTION :
      ...
      break;
    case com.sun.org.apache.xpath.internal.compiler.OpCodes.FROM_ROOT :
      if(DEBUG)
  ...
  public int countPredicates(int opPos) throws TransformerException
  {
    ...
    while (com.sun.org.apache.xpath.internal.compiler.OpCodes.OP_PREDICATE == getOp(opPos))
    {
      count++;
