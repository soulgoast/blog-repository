 ...
 */
package goodman.com.sun.org.apache.xpath.internal.compiler;

import goodman.javax.xml.transform.ErrorListener;
...
public class XPathParser
{
  ...
  public void initXPath(
          com.sun.org.apache.xpath.internal.compiler.Compiler compiler, String expression, PrefixResolver namespaceContext)
            throws TransformerException
  {
    ...
    com.sun.org.apache.xpath.internal.compiler.Lexer lexer = new com.sun.org.apache.xpath.internal.compiler.Lexer(compiler, namespaceContext, this);

    lexer.tokenize(expression);

    m_ops.setOp(0, com.sun.org.apache.xpath.internal.compiler.OpCodes.OP_XPATH);
    m_ops.setOp(com.sun.org.apache.xpath.internal.compiler.OpMap.MAPINDEX_LENGTH,2);
            ...
            throws TransformerException
  {
    ...
    m_ops.setOp(0, com.sun.org.apache.xpath.internal.compiler.OpCodes.OP_MATCHPATTERN);
    m_ops.setOp(com.sun.org.apache.xpath.internal.compiler.OpMap.MAPINDEX_LENGTH, 2);
    ...
    m_ops.setOp(m_ops.getOp(com.sun.org.apache.xpath.internal.compiler.OpMap.MAPINDEX_LENGTH), com.sun.org.apache.xpath.internal.compiler.OpCodes.ENDOP);
    m_ops.setOp(com.sun.org.apache.xpath.internal.compiler.OpMap.MAPINDEX_LENGTH, m_ops.getOp(com.sun.org.apache.xpath.internal.compiler.OpMap.MAPINDEX_LENGTH)+1);
  ...
  final int getFunctionToken(String key)
  {
    ...
    try
    {
      ...
      // a FilterExpr.
      id = com.sun.org.apache.xpath.internal.compiler.Keywords.lookupNodeTest(key);
  ...
  void insertOp(int pos, int length, int op)
  {
    ...
    int totalLen = m_ops.getOp(com.sun.org.apache.xpath.internal.compiler.OpMap.MAPINDEX_LENGTH);
    ...
    m_ops.setOp(pos,op);
    m_ops.setOp(com.sun.org.apache.xpath.internal.compiler.OpMap.MAPINDEX_LENGTH,totalLen + length);
  }
  ...
  void appendOp(int length, int op)
  {
    ...
    m_ops.setOp(totalLen + com.sun.org.apache.xpath.internal.compiler.OpMap.MAPINDEX_LENGTH, length);
    m_ops.setOp(com.sun.org.apache.xpath.internal.compiler.OpMap.MAPINDEX_LENGTH, totalLen + length);
  }
  ...
  protected void OrExpr() throws TransformerException
  {
    ...
    int opPos = m_ops.getOp(com.sun.org.apache.xpath.internal.compiler.OpMap.MAPINDEX_LENGTH);
    ...
    {
      nextToken();
      insertOp(opPos, 2, com.sun.org.apache.xpath.internal.compiler.OpCodes.OP_OR);
      OrExpr();

      m_ops.setOp(opPos + com.sun.org.apache.xpath.internal.compiler.OpMap.MAPINDEX_LENGTH,
        m_ops.getOp(com.sun.org.apache.xpath.internal.compiler.OpMap.MAPINDEX_LENGTH) - opPos);
    }
  }
  ...
  protected void AndExpr() throws TransformerException
  {
    ...
    {
      nextToken();
      insertOp(opPos, 2, com.sun.org.apache.xpath.internal.compiler.OpCodes.OP_AND);
      AndExpr();
  ...
  protected int EqualityExpr(int addPos) throws TransformerException
  {
    ...
    if (null != m_token)
    {
      if (tokenIs('!') && lookahead('=', 1))
      {
        nextToken();
        nextToken();
        insertOp(addPos, 2, com.sun.org.apache.xpath.internal.compiler.OpCodes.OP_NOTEQUALS);

        int opPlusLeftHandLen = m_ops.getOp(com.sun.org.apache.xpath.internal.compiler.OpMap.MAPINDEX_LENGTH) - addPos;

        addPos = EqualityExpr(addPos);
        m_ops.setOp(addPos + com.sun.org.apache.xpath.internal.compiler.OpMap.MAPINDEX_LENGTH,
      ...
      {
        nextToken();
        insertOp(addPos, 2, com.sun.org.apache.xpath.internal.compiler.OpCodes.OP_EQUALS);
  ...
  protected int RelationalExpr(int addPos) throws TransformerException
  {
    ...
    if (null != m_token)
    {
      if (tokenIs('<'))
      {
        ...
        {
          nextToken();
          insertOp(addPos, 2, com.sun.org.apache.xpath.internal.compiler.OpCodes.OP_LTE);
        }
        else
        {
          insertOp(addPos, 2, com.sun.org.apache.xpath.internal.compiler.OpCodes.OP_LT);
        }
      ...
      else if (tokenIs('>'))
      {
        ...
        {
          nextToken();
          insertOp(addPos, 2, com.sun.org.apache.xpath.internal.compiler.OpCodes.OP_GTE);
        }
        else
        {
          insertOp(addPos, 2, com.sun.org.apache.xpath.internal.compiler.OpCodes.OP_GT);
        }
  ...
  protected int AdditiveExpr(int addPos) throws TransformerException
  {
    ...
    if (null != m_token)
    {
      ...
      {
        nextToken();
        insertOp(addPos, 2, com.sun.org.apache.xpath.internal.compiler.OpCodes.OP_PLUS);
      ...
      {
        nextToken();
        insertOp(addPos, 2, com.sun.org.apache.xpath.internal.compiler.OpCodes.OP_MINUS);
  ...
  protected int MultiplicativeExpr(int addPos) throws TransformerException
  {
    ...
    if (null != m_token)
    {
      ...
      {
        nextToken();
        insertOp(addPos, 2, com.sun.org.apache.xpath.internal.compiler.OpCodes.OP_MULT);
      ...
      {
        nextToken();
        insertOp(addPos, 2, com.sun.org.apache.xpath.internal.compiler.OpCodes.OP_DIV);
      ...
      {
        nextToken();
        insertOp(addPos, 2, com.sun.org.apache.xpath.internal.compiler.OpCodes.OP_MOD);
      ...
      {
        nextToken();
        insertOp(addPos, 2, com.sun.org.apache.xpath.internal.compiler.OpCodes.OP_QUO);
  ...
  protected void UnaryExpr() throws TransformerException
  {
    ...
    {
      nextToken();
      appendOp(2, com.sun.org.apache.xpath.internal.compiler.OpCodes.OP_NEG);
  ...
  protected void StringExpr() throws TransformerException
  {
    ...
    appendOp(2, com.sun.org.apache.xpath.internal.compiler.OpCodes.OP_STRING);
    Expr();
  ...
  protected void BooleanExpr() throws TransformerException
  {
    ...
    appendOp(2, com.sun.org.apache.xpath.internal.compiler.OpCodes.OP_BOOL);
    Expr();

    int opLen = m_ops.getOp(com.sun.org.apache.xpath.internal.compiler.OpMap.MAPINDEX_LENGTH) - opPos;
    ...
    m_ops.setOp(opPos + com.sun.org.apache.xpath.internal.compiler.OpMap.MAPINDEX_LENGTH, opLen);
  }
  ...
  protected void NumberExpr() throws TransformerException
  {
    ...
    appendOp(2, com.sun.org.apache.xpath.internal.compiler.OpCodes.OP_NUMBER);
    Expr();
    ...
    do
    {
      ...
      if (tokenIs('|'))
      {
        if (false == foundUnion)
        {
          ...
          insertOp(opPos, 2, com.sun.org.apache.xpath.internal.compiler.OpCodes.OP_UNION);
        }
    ...
    if (filterExprMatch != FILTER_MATCH_FAILED)
    {
      ...
      if (tokenIs('/'))
      {
        ...
        if (!locationPathStarted)
        {
          ...
          insertOp(opPos, 2, com.sun.org.apache.xpath.internal.compiler.OpCodes.OP_LOCATIONPATH);
  ...
  protected boolean PrimaryExpr() throws TransformerException
  {
    ...
    {
      appendOp(2, com.sun.org.apache.xpath.internal.compiler.OpCodes.OP_LITERAL);
      Literal();
    ...
    {
      nextToken();  // consume '$'
      appendOp(2, com.sun.org.apache.xpath.internal.compiler.OpCodes.OP_VARIABLE);
      QName();
    ...
    {
      nextToken();
      appendOp(2, com.sun.org.apache.xpath.internal.compiler.OpCodes.OP_GROUP);
      Expr();
      consumeExpected(')');
    ...
    {
      appendOp(2, com.sun.org.apache.xpath.internal.compiler.OpCodes.OP_NUMBERLIT);
      Number();
  ...
  protected void Argument() throws TransformerException
  {
    ...
    appendOp(2, com.sun.org.apache.xpath.internal.compiler.OpCodes.OP_ARGUMENT);
    Expr();
  ...
  protected boolean FunctionCall() throws TransformerException
  {
    ...
    if (lookahead(':', 1))
    {
      appendOp(4, com.sun.org.apache.xpath.internal.compiler.OpCodes.OP_EXTFUNCTION);

      m_ops.setOp(opPos + com.sun.org.apache.xpath.internal.compiler.OpMap.MAPINDEX_LENGTH + 1, m_queueMark - 1);

      nextToken();
      consumeExpected(':');

      m_ops.setOp(opPos + com.sun.org.apache.xpath.internal.compiler.OpMap.MAPINDEX_LENGTH + 2, m_queueMark - 1);
    ...
    else
    {
      ...
      switch (funcTok)
      {
      case com.sun.org.apache.xpath.internal.compiler.OpCodes.NODETYPE_PI :
      case com.sun.org.apache.xpath.internal.compiler.OpCodes.NODETYPE_COMMENT :
      case com.sun.org.apache.xpath.internal.compiler.OpCodes.NODETYPE_TEXT :
      case com.sun.org.apache.xpath.internal.compiler.OpCodes.NODETYPE_NODE :
        // Node type tests look like function calls, but they're not
        return false;
      default :
        appendOp(3, com.sun.org.apache.xpath.internal.compiler.OpCodes.OP_FUNCTION);

        m_ops.setOp(opPos + com.sun.org.apache.xpath.internal.compiler.OpMap.MAPINDEX_LENGTH + 1, funcTok);
      }
  ...
  protected void LocationPath() throws TransformerException
  {
    ...
    // int locationPathOpPos = opPos;
    appendOp(2, com.sun.org.apache.xpath.internal.compiler.OpCodes.OP_LOCATIONPATH);

    boolean seenSlash = tokenIs('/');

    if (seenSlash)
    {
      appendOp(4, com.sun.org.apache.xpath.internal.compiler.OpCodes.FROM_ROOT);

      // Tell how long the step is without the predicate
      m_ops.setOp(m_ops.getOp(com.sun.org.apache.xpath.internal.compiler.OpMap.MAPINDEX_LENGTH) - 2, 4);
      m_ops.setOp(m_ops.getOp(com.sun.org.apache.xpath.internal.compiler.OpMap.MAPINDEX_LENGTH) - 1, com.sun.org.apache.xpath.internal.compiler.OpCodes.NODETYPE_ROOT);
  ...
  protected boolean Step() throws TransformerException
  {
    ...
    if (doubleSlash)
    {
      ...
      appendOp(2, com.sun.org.apache.xpath.internal.compiler.OpCodes.FROM_DESCENDANTS_OR_SELF);
      ...
      m_ops.setOp(com.sun.org.apache.xpath.internal.compiler.OpMap.MAPINDEX_LENGTH,m_ops.getOp(com.sun.org.apache.xpath.internal.compiler.OpMap.MAPINDEX_LENGTH) + 1);
      m_ops.setOp(m_ops.getOp(com.sun.org.apache.xpath.internal.compiler.OpMap.MAPINDEX_LENGTH), com.sun.org.apache.xpath.internal.compiler.OpCodes.NODETYPE_NODE);
      m_ops.setOp(com.sun.org.apache.xpath.internal.compiler.OpMap.MAPINDEX_LENGTH,m_ops.getOp(com.sun.org.apache.xpath.internal.compiler.OpMap.MAPINDEX_LENGTH) + 1);

      // Tell how long the step is without the predicate
      m_ops.setOp(opPos + com.sun.org.apache.xpath.internal.compiler.OpMap.MAPINDEX_LENGTH + 1,
          m_ops.getOp(com.sun.org.apache.xpath.internal.compiler.OpMap.MAPINDEX_LENGTH) - opPos);
      ...
      opPos = m_ops.getOp(com.sun.org.apache.xpath.internal.compiler.OpMap.MAPINDEX_LENGTH);
    }
    ...
    if (tokenIs("."))
    {
      ...
      appendOp(4, com.sun.org.apache.xpath.internal.compiler.OpCodes.FROM_SELF);

      // Tell how long the step is without the predicate
      m_ops.setOp(m_ops.getOp(com.sun.org.apache.xpath.internal.compiler.OpMap.MAPINDEX_LENGTH) - 2,4);
      m_ops.setOp(m_ops.getOp(com.sun.org.apache.xpath.internal.compiler.OpMap.MAPINDEX_LENGTH) - 1, com.sun.org.apache.xpath.internal.compiler.OpCodes.NODETYPE_NODE);
    }
    else if (tokenIs(".."))
    {
      nextToken();
      appendOp(4, com.sun.org.apache.xpath.internal.compiler.OpCodes.FROM_PARENT);
  ...
  protected void Basis() throws TransformerException
  {
    ...
    {
      axesType = com.sun.org.apache.xpath.internal.compiler.OpCodes.FROM_ATTRIBUTES;
    ...
    {
      axesType = com.sun.org.apache.xpath.internal.compiler.OpCodes.FROM_CHILDREN;
  ...
  protected int AxisName() throws TransformerException
  {
    ...
    Object val = com.sun.org.apache.xpath.internal.compiler.Keywords.getAxisName(m_token);
  ...
  protected void NodeTest(int axesType) throws TransformerException
  {
    ...
    if (lookahead('(', 1))
    {
      Object nodeTestOp = com.sun.org.apache.xpath.internal.compiler.Keywords.getNodeType(m_token);
      ...
      else
      {
        ...
        m_ops.setOp(m_ops.getOp(com.sun.org.apache.xpath.internal.compiler.OpMap.MAPINDEX_LENGTH), nt);
        m_ops.setOp(com.sun.org.apache.xpath.internal.compiler.OpMap.MAPINDEX_LENGTH, m_ops.getOp(com.sun.org.apache.xpath.internal.compiler.OpMap.MAPINDEX_LENGTH) + 1);

        consumeExpected('(');

        if (com.sun.org.apache.xpath.internal.compiler.OpCodes.NODETYPE_PI == nt)
        {
          if (!tokenIs(')'))
          {
            Literal();
    ...
    else
    {
      ...
      m_ops.setOp(m_ops.getOp(com.sun.org.apache.xpath.internal.compiler.OpMap.MAPINDEX_LENGTH), com.sun.org.apache.xpath.internal.compiler.OpCodes.NODENAME);
      m_ops.setOp(com.sun.org.apache.xpath.internal.compiler.OpMap.MAPINDEX_LENGTH, m_ops.getOp(com.sun.org.apache.xpath.internal.compiler.OpMap.MAPINDEX_LENGTH) + 1);
      ...
      if (lookahead(':', 1))
      {
        if (tokenIs('*'))
        {
          m_ops.setOp(m_ops.getOp(com.sun.org.apache.xpath.internal.compiler.OpMap.MAPINDEX_LENGTH), com.sun.org.apache.xpath.internal.compiler.OpCodes.ELEMWILDCARD);
        }
        else
        {
          m_ops.setOp(m_ops.getOp(com.sun.org.apache.xpath.internal.compiler.OpMap.MAPINDEX_LENGTH), m_queueMark - 1);
      ...
      {
        m_ops.setOp(m_ops.getOp(com.sun.org.apache.xpath.internal.compiler.OpMap.MAPINDEX_LENGTH), com.sun.org.apache.xpath.internal.compiler.OpCodes.EMPTY);
      }
  ...
  protected void PredicateExpr() throws TransformerException
  {
    ...
    appendOp(2, com.sun.org.apache.xpath.internal.compiler.OpCodes.OP_PREDICATE);
    Expr();
  ...
  protected void Literal() throws TransformerException
  {
    ...
    if (((c0 == '\"') && (cX == '\"')) || ((c0 == '\'') && (cX == '\'')))
    {
      ...
      m_ops.setOp(m_ops.getOp(com.sun.org.apache.xpath.internal.compiler.OpMap.MAPINDEX_LENGTH), tokenQueuePos);
      m_ops.setOp(com.sun.org.apache.xpath.internal.compiler.OpMap.MAPINDEX_LENGTH, m_ops.getOp(com.sun.org.apache.xpath.internal.compiler.OpMap.MAPINDEX_LENGTH) + 1);
  ...
  protected void LocationPathPattern() throws TransformerException
  {
    ...
    appendOp(2, com.sun.org.apache.xpath.internal.compiler.OpCodes.OP_LOCATIONPATHPATTERN);

    if (lookahead('(', 1)
            && (tokenIs(com.sun.org.apache.xpath.internal.compiler.Keywords.FUNC_ID_STRING)
                || tokenIs(Keywords.FUNC_KEY_STRING)))
    {
      ...
      if (tokenIs('/'))
      {
        ...
        if (tokenIs('/'))
        {
          appendOp(4, com.sun.org.apache.xpath.internal.compiler.OpCodes.MATCH_ANY_ANCESTOR);

          nextToken();
        }
        else
        {
          appendOp(4, com.sun.org.apache.xpath.internal.compiler.OpCodes.MATCH_IMMEDIATE_ANCESTOR);
        }

        // Tell how long the step is without the predicate
        m_ops.setOp(m_ops.getOp(com.sun.org.apache.xpath.internal.compiler.OpMap.MAPINDEX_LENGTH) - 2, 4);
        m_ops.setOp(m_ops.getOp(com.sun.org.apache.xpath.internal.compiler.OpMap.MAPINDEX_LENGTH) - 1, com.sun.org.apache.xpath.internal.compiler.OpCodes.NODETYPE_FUNCTEST);
            ...
            throws TransformerException
  {
    ...
    if (tokenIs('@'))
    {
      axesType = com.sun.org.apache.xpath.internal.compiler.OpCodes.MATCH_ATTRIBUTE;
    ...
    else if (this.lookahead("::", 1))
    {
      ...
      {
        matchTypePos = m_ops.getOp(com.sun.org.apache.xpath.internal.compiler.OpMap.MAPINDEX_LENGTH);
        axesType = com.sun.org.apache.xpath.internal.compiler.OpCodes.MATCH_IMMEDIATE_ANCESTOR;
    ...
    else if (tokenIs('/'))
    {
      ...
      axesType = com.sun.org.apache.xpath.internal.compiler.OpCodes.MATCH_ANY_ANCESTOR;
