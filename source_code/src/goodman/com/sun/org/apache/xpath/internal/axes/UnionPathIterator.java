 ...
 * @xsl.usage advanced
 */
public class UnionPathIterator extends com.sun.org.apache.xpath.internal.axes.LocPathIterator
        implements Cloneable, DTMIterator, java.io.Serializable, PathComponent
{
   ...
   * @throws javax.xml.transform.TransformerException
   */
  public static com.sun.org.apache.xpath.internal.axes.LocPathIterator createUnionIterator(Compiler compiler, int opPos)
          throws javax.xml.transform.TransformerException
  {
        ...
        {
                com.sun.org.apache.xpath.internal.axes.LocPathIterator lpi = upi.m_exprs[i];
   ...
   * @throws javax.xml.transform.TransformerException
   */
  protected com.sun.org.apache.xpath.internal.axes.LocPathIterator createDTMIterator(
          Compiler compiler, int opPos) throws javax.xml.transform.TransformerException
  {
    com.sun.org.apache.xpath.internal.axes.LocPathIterator lpi = (com.sun.org.apache.xpath.internal.axes.LocPathIterator) WalkerFactory.newDTMIterator(compiler, opPos,
          ...
          throws javax.xml.transform.TransformerException
  {
    ...
    else
    {
      ...
      case OpCodes.OP_GROUP :
        ...
        com.sun.org.apache.xpath.internal.axes.WalkingIterator iter =
          new com.sun.org.apache.xpath.internal.axes.WalkingIterator(compiler.getNamespaceContext());
        ...
        break;
      default :
        m_exprs = new com.sun.org.apache.xpath.internal.axes.LocPathIterator[count];
      }
    }
  }
   ...
   * @serial
   */
  protected com.sun.org.apache.xpath.internal.axes.LocPathIterator[] m_exprs;
  ...
  class iterOwner implements ExpressionOwner
  {
    ...
    public void setExpression(Expression exp)
    {
        ...
        if(!(exp instanceof com.sun.org.apache.xpath.internal.axes.LocPathIterator))
        {
                // Yuck.  Need FilterExprIter.  Or make it so m_exprs can be just
                // plain expressions?
                com.sun.org.apache.xpath.internal.axes.WalkingIterator wi = new WalkingIterator(getPrefixResolver());
                com.sun.org.apache.xpath.internal.axes.FilterExprWalker few = new FilterExprWalker(wi);
