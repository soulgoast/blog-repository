 ...
 */
package goodman.com.sun.org.apache.xpath.internal.patterns;
 ...
 * @xsl.usage advanced
 */
public class StepPattern extends com.sun.org.apache.xpath.internal.patterns.NodeTest implements SubContextList, ExpressionOwner
{
          ...
          throws javax.xml.transform.TransformerException
  {
    ...
    return com.sun.org.apache.xpath.internal.patterns.NodeTest.SCORE_NONE;
  }
            ...
            throws javax.xml.transform.TransformerException
  {
    ...
    if (m_whatToShow == com.sun.org.apache.xpath.internal.patterns.NodeTest.SHOW_BYFUNCTION)
    {
      if (null != m_relativePathPattern)
      {
    ...
    if (score == com.sun.org.apache.xpath.internal.patterns.NodeTest.SCORE_NONE)
      return com.sun.org.apache.xpath.internal.patterns.NodeTest.SCORE_NONE;
    ...
    try
    {
              ...
              child = traverser.next(context, child))
      {
        try
        {
          ...
          if (com.sun.org.apache.xpath.internal.patterns.NodeTest.SCORE_NONE != super.execute(xctxt, child))
          {
            boolean pass = true;
            ...
            throws javax.xml.transform.TransformerException
  {
    ...
    XObject score = com.sun.org.apache.xpath.internal.patterns.NodeTest.SCORE_NONE;
