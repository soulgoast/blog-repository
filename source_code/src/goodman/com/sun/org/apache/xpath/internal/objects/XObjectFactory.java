...
public class XObjectFactory
{
  ...
  static public com.sun.org.apache.xpath.internal.objects.XObject create(Object val)
  {
    ...
    com.sun.org.apache.xpath.internal.objects.XObject result;

    if (val instanceof com.sun.org.apache.xpath.internal.objects.XObject)
    {
      result = (com.sun.org.apache.xpath.internal.objects.XObject) val;
    }
    else if (val instanceof String)
    {
      result = new com.sun.org.apache.xpath.internal.objects.XString((String) val);
    }
    else if (val instanceof Boolean)
    {
      result = new com.sun.org.apache.xpath.internal.objects.XBoolean((Boolean)val);
    }
    else if (val instanceof Double)
    {
      result = new com.sun.org.apache.xpath.internal.objects.XNumber(((Double) val));
    }
    else
    {
      result = new com.sun.org.apache.xpath.internal.objects.XObject(val);
    }
  ...
  static public com.sun.org.apache.xpath.internal.objects.XObject create(Object val, XPathContext xctxt)
  {
    ...
    else if (val instanceof DTM)
    {
      ...
      try
      {
        ...
        result = new com.sun.org.apache.xpath.internal.objects.XNodeSet(iterator);
      }
      catch(Exception ex)
      {
    ...
    {
      result = new com.sun.org.apache.xpath.internal.objects.XNodeSetForDOM((org.w3c.dom.Node)val, xctxt);
    }
    ...
    {
      result = new com.sun.org.apache.xpath.internal.objects.XNodeSetForDOM((org.w3c.dom.NodeList)val, xctxt);
    }
