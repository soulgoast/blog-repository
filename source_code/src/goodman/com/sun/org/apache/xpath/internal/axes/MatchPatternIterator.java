 ...
 */
package goodman.com.sun.org.apache.xpath.internal.axes;
...
//  protected int m_nsElemBase = DTM.NULL;
          ...
          throws javax.xml.transform.TransformerException
  {
    ...
    m_pattern = com.sun.org.apache.xpath.internal.axes.WalkerFactory.loadSteps(this, compiler, firstStepPos, 0);
    ...
    if (0 != (analysis & (com.sun.org.apache.xpath.internal.axes.WalkerFactory.BIT_ROOT |
                          com.sun.org.apache.xpath.internal.axes.WalkerFactory.BIT_ANY_DESCENDANT_FROM_ROOT)))
      fromRoot = true;

    if (0 != (analysis
              & (com.sun.org.apache.xpath.internal.axes.WalkerFactory.BIT_ANCESTOR
                 | com.sun.org.apache.xpath.internal.axes.WalkerFactory.BIT_ANCESTOR_OR_SELF
                 | com.sun.org.apache.xpath.internal.axes.WalkerFactory.BIT_PRECEDING
                 | com.sun.org.apache.xpath.internal.axes.WalkerFactory.BIT_PRECEDING_SIBLING
                 | com.sun.org.apache.xpath.internal.axes.WalkerFactory.BIT_FOLLOWING
                 | com.sun.org.apache.xpath.internal.axes.WalkerFactory.BIT_FOLLOWING_SIBLING
                 | com.sun.org.apache.xpath.internal.axes.WalkerFactory.BIT_PARENT | com.sun.org.apache.xpath.internal.axes.WalkerFactory.BIT_FILTER)))
      walkBack = true;

    if (0 != (analysis
              & (com.sun.org.apache.xpath.internal.axes.WalkerFactory.BIT_DESCENDANT_OR_SELF
                 | com.sun.org.apache.xpath.internal.axes.WalkerFactory.BIT_DESCENDANT
                 | com.sun.org.apache.xpath.internal.axes.WalkerFactory.BIT_CHILD)))
      walkDescendants = true;

    if (0 != (analysis
              & (com.sun.org.apache.xpath.internal.axes.WalkerFactory.BIT_ATTRIBUTE | com.sun.org.apache.xpath.internal.axes.WalkerFactory.BIT_NAMESPACE)))
      walkAttributes = true;
