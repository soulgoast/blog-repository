 ...
 */
package goodman.com.sun.org.apache.xpath.internal;
...
public class SourceTreeManager
{
  ...
  public String findURIFromDoc(int owner)
  {
    ...
    for (int i = 0; i < n; i++)
    {
      com.sun.org.apache.xpath.internal.SourceTree sTree = (com.sun.org.apache.xpath.internal.SourceTree) m_sourceTree.elementAt(i);
  ...
  public void removeDocumentFromCache(int n)
  {
    ...
    {
      com.sun.org.apache.xpath.internal.SourceTree st=(com.sun.org.apache.xpath.internal.SourceTree)m_sourceTree.elementAt(i);
  ...
  public void putDocumentInCache(int n, Source source)
  {
    ...
    {
      m_sourceTree.addElement(new com.sun.org.apache.xpath.internal.SourceTree(n, source.getSystemId()));
    }
  }
...
//      return ((DOMSource) source).getNode();
    ...
    for (int i = 0; i < n; i++)
    {
      com.sun.org.apache.xpath.internal.SourceTree sTree = (SourceTree) m_sourceTree.elementAt(i);
  ...
  public int getSourceTree(
          String base, String urlString, SourceLocator locator, com.sun.org.apache.xpath.internal.XPathContext xctxt)
            throws TransformerException
  {
   ...
   *         a node.
   */
  public int getSourceTree(Source source, SourceLocator locator, com.sun.org.apache.xpath.internal.XPathContext xctxt)
          throws TransformerException
  {
