...
public class Keywords {
  ...
  // Proprietary, built in functions
    ...
    static {
        ...
        axisnames.put(FROM_ANCESTORS_STRING, com.sun.org.apache.xpath.internal.compiler.OpCodes.FROM_ANCESTORS);
        axisnames.put(FROM_ANCESTORS_OR_SELF_STRING, com.sun.org.apache.xpath.internal.compiler.OpCodes.FROM_ANCESTORS_OR_SELF);
        axisnames.put(FROM_ATTRIBUTES_STRING, com.sun.org.apache.xpath.internal.compiler.OpCodes.FROM_ATTRIBUTES);
        axisnames.put(FROM_CHILDREN_STRING, com.sun.org.apache.xpath.internal.compiler.OpCodes.FROM_CHILDREN);
        axisnames.put(FROM_DESCENDANTS_STRING, com.sun.org.apache.xpath.internal.compiler.OpCodes.FROM_DESCENDANTS);
        axisnames.put(FROM_DESCENDANTS_OR_SELF_STRING, com.sun.org.apache.xpath.internal.compiler.OpCodes.FROM_DESCENDANTS_OR_SELF);
        axisnames.put(FROM_FOLLOWING_STRING, com.sun.org.apache.xpath.internal.compiler.OpCodes.FROM_FOLLOWING);
        axisnames.put(FROM_FOLLOWING_SIBLINGS_STRING, com.sun.org.apache.xpath.internal.compiler.OpCodes.FROM_FOLLOWING_SIBLINGS);
        axisnames.put(FROM_PARENT_STRING, com.sun.org.apache.xpath.internal.compiler.OpCodes.FROM_PARENT);
        axisnames.put(FROM_PRECEDING_STRING, com.sun.org.apache.xpath.internal.compiler.OpCodes.FROM_PRECEDING);
        axisnames.put(FROM_PRECEDING_SIBLINGS_STRING, com.sun.org.apache.xpath.internal.compiler.OpCodes.FROM_PRECEDING_SIBLINGS);
        axisnames.put(FROM_SELF_STRING, com.sun.org.apache.xpath.internal.compiler.OpCodes.FROM_SELF);
        axisnames.put(FROM_NAMESPACE_STRING, com.sun.org.apache.xpath.internal.compiler.OpCodes.FROM_NAMESPACE);
        m_axisnames = Collections.unmodifiableMap(axisnames);

        nodetypes.put(NODETYPE_COMMENT_STRING, com.sun.org.apache.xpath.internal.compiler.OpCodes.NODETYPE_COMMENT);
        nodetypes.put(NODETYPE_TEXT_STRING, com.sun.org.apache.xpath.internal.compiler.OpCodes.NODETYPE_TEXT);
        nodetypes.put(NODETYPE_PI_STRING, com.sun.org.apache.xpath.internal.compiler.OpCodes.NODETYPE_PI);
        nodetypes.put(NODETYPE_NODE_STRING, com.sun.org.apache.xpath.internal.compiler.OpCodes.NODETYPE_NODE);
        nodetypes.put(NODETYPE_ANYELEMENT_STRING, com.sun.org.apache.xpath.internal.compiler.OpCodes.NODETYPE_ANYELEMENT);
        m_nodetypes = Collections.unmodifiableMap(nodetypes);

        keywords.put(FROM_SELF_ABBREVIATED_STRING, com.sun.org.apache.xpath.internal.compiler.OpCodes.FROM_SELF);
        ...
        nodetests.put(NODETYPE_COMMENT_STRING, com.sun.org.apache.xpath.internal.compiler.OpCodes.NODETYPE_COMMENT);
        nodetests.put(NODETYPE_TEXT_STRING, com.sun.org.apache.xpath.internal.compiler.OpCodes.NODETYPE_TEXT);
        nodetests.put(NODETYPE_PI_STRING, com.sun.org.apache.xpath.internal.compiler.OpCodes.NODETYPE_PI);
