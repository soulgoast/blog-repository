...
public class UnionChildIterator extends ChildTestIterator
{
   ...
   */
  private com.sun.org.apache.xpath.internal.axes.PredicatedNodeTest[] m_nodeTests = null;
   ...
   * this object.
   */
  public void addNodeTest(com.sun.org.apache.xpath.internal.axes.PredicatedNodeTest test)
  {
    ...
    if (null == m_nodeTests)
    {
      m_nodeTests = new com.sun.org.apache.xpath.internal.axes.PredicatedNodeTest[1];
      m_nodeTests[0] = test;
    }
    else
    {
      com.sun.org.apache.xpath.internal.axes.PredicatedNodeTest[] tests = m_nodeTests;
      int len = m_nodeTests.length;

      m_nodeTests = new com.sun.org.apache.xpath.internal.axes.PredicatedNodeTest[len + 1];
