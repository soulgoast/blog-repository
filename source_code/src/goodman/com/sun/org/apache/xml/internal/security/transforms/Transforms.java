 ...
 * under the License.
 */
package goodman.com.sun.org.apache.xml.internal.security.transforms;
 ...
 * @see com.sun.org.apache.xml.internal.security.transforms.Transform
...
public class Transforms extends SignatureElementProxy {
    ...
    public void addTransform(String transformURI) throws TransformationException {
        try {
            ...
            com.sun.org.apache.xml.internal.security.transforms.Transform transform = new com.sun.org.apache.xml.internal.security.transforms.Transform(this.doc, transformURI);
    ...
    public void addTransform(String transformURI, Element contextElement)
       throws TransformationException {
        try {
            ...
            com.sun.org.apache.xml.internal.security.transforms.Transform transform = new com.sun.org.apache.xml.internal.security.transforms.Transform(this.doc, transformURI, contextElement);
    ...
    public void addTransform(String transformURI, NodeList contextNodes)
       throws TransformationException {
        ...
        try {
            com.sun.org.apache.xml.internal.security.transforms.Transform transform = new com.sun.org.apache.xml.internal.security.transforms.Transform(this.doc, transformURI, contextNodes);
            this.addTransform(transform);
        } catch (InvalidTransformException ex) {
            throw new TransformationException("empty", ex);
        }
     ...
     *
     * @param transform {@link com.sun.org.apache.xml.internal.security.transforms.Transform} object
     */
    private void addTransform(com.sun.org.apache.xml.internal.security.transforms.Transform transform) {
        if (log.isLoggable(java.util.logging.Level.FINE)) {
    ...
    public XMLSignatureInput performTransforms(
        ...
        try {
            ...
            for (int i = 0; i < last; i++) {
                com.sun.org.apache.xml.internal.security.transforms.Transform t = this.item(i);
                String uri = t.getURI();
                if (log.isLoggable(java.util.logging.Level.FINE)) {
            ...
            if (last >= 0) {
                com.sun.org.apache.xml.internal.security.transforms.Transform t = this.item(last);
                checkSecureValidation(t);
    ...
    private void checkSecureValidation(com.sun.org.apache.xml.internal.security.transforms.Transform transform) throws TransformationException {
    ...
    /**
     * Return the <it>i</it><sup>th</sup> <code>{@link com.sun.org.apache.xml.internal.security.transforms.Transform}</code>.
     * Valid <code>i</code> values are 0 to <code>{@link #getLength}-1</code>.
     *
     * @param i index of {@link com.sun.org.apache.xml.internal.security.transforms.Transform} to return
     * @return the <it>i</it><sup>th</sup> Transform
     * @throws TransformationException
     */
    public com.sun.org.apache.xml.internal.security.transforms.Transform item(int i) throws TransformationException {
        try {
            if (transforms == null) {
                transforms =
                    XMLUtils.selectDsNodes(this.constructionElement.getFirstChild(), "Transform");
