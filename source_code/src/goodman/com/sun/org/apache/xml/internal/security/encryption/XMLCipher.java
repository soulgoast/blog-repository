 ...
 * under the License.
 */
package goodman.com.sun.org.apache.xml.internal.security.encryption;
...
import goodman.javax.crypto.BadPaddingException;
import goodman.javax.crypto.Cipher;
import goodman.javax.crypto.IllegalBlockSizeException;
import goodman.javax.crypto.NoSuchPaddingException;
import goodman.javax.crypto.spec.IvParameterSpec;
import goodman.javax.crypto.spec.OAEPParameterSpec;
import goodman.javax.crypto.spec.PSource;
...
public class XMLCipher {
    ...
    private class Factory {
        ...
        private class ReferenceListImpl implements ReferenceList {
            ...
            private List<com.sun.org.apache.xml.internal.security.encryption.Reference> references;
            ...
            public ReferenceListImpl(int type) {
                ...
                references = new LinkedList<com.sun.org.apache.xml.internal.security.encryption.Reference>();
            }

            /** @inheritDoc */
            public void add(com.sun.org.apache.xml.internal.security.encryption.Reference reference) {
            ...
            /** @inheritDoc */
            public void remove(com.sun.org.apache.xml.internal.security.encryption.Reference reference) {
                if (!reference.getClass().equals(sentry)) {
                    throw new IllegalArgumentException();
                }
            ...
            /** @inheritDoc */
            public Iterator<com.sun.org.apache.xml.internal.security.encryption.Reference> getReferences() {
            ...
            Element toElement() {
                ...
                Iterator<com.sun.org.apache.xml.internal.security.encryption.Reference> eachReference = references.iterator();
                while (eachReference.hasNext()) {
                    com.sun.org.apache.xml.internal.security.encryption.Reference reference = eachReference.next();
            ...
            /** @inheritDoc */
            public com.sun.org.apache.xml.internal.security.encryption.Reference newDataReference(String uri) {
                return new DataReference(uri);
            }

            /** @inheritDoc */
            public com.sun.org.apache.xml.internal.security.encryption.Reference newKeyReference(String uri) {
             ...
             * <code>Reference</code>.
             *
             * @see com.sun.org.apache.xml.internal.security.encryption.Reference
             */
