...
import goodman.java.util.PropertyResourceBundle;
...
public class CatalogManager {
  ...
  private static com.sun.org.apache.xml.internal.resolver.Catalog staticCatalog = null;
  ...
  public com.sun.org.apache.xml.internal.resolver.Catalog getPrivateCatalog() {
    com.sun.org.apache.xml.internal.resolver.Catalog catalog = staticCatalog;
    ...
    if (catalog == null || !useStaticCatalog.booleanValue()) {
      ...
      try {
        ...
        if (catalogClassName == null) {
          catalog = new com.sun.org.apache.xml.internal.resolver.Catalog();
        } else {
          try {
            catalog = (com.sun.org.apache.xml.internal.resolver.Catalog) ReflectUtil.forName(catalogClassName).newInstance();
