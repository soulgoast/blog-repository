...
public class TreeWalker
{
  ...
  protected void startNode(Node node) throws org.xml.sax.SAXException
  {
    ...
    case Node.ELEMENT_NODE :
      ...
      String ns = com.sun.org.apache.xml.internal.utils.DOM2Helper.getNamespaceOfNode(node);
      if(null == ns)
        ns = "";
      this.m_contentHandler.startElement(ns,
                                         com.sun.org.apache.xml.internal.utils.DOM2Helper.getLocalNameOfNode(node),
                                         node.getNodeName(),
                                         new AttList(atts));
      break;
