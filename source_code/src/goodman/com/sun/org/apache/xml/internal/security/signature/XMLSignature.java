 ...
 * under the License.
 */
package goodman.com.sun.org.apache.xml.internal.security.signature;
...
import goodman.java.security.cert.X509Certificate;

import goodman.javax.crypto.SecretKey;
...
public final class XMLSignature extends SignatureElementProxy {
    ...
    public XMLSignature(
        ...
        this.baseURI = baseURI;
        this.signedInfo =
            new com.sun.org.apache.xml.internal.security.signature.SignedInfo(this.doc, SignatureMethodElem, CanonicalizationMethodElem);
    ...
    public XMLSignature(Element element, String baseURI, boolean secureValidation)
        ...
        this.signedInfo = new com.sun.org.apache.xml.internal.security.signature.SignedInfo(signedInfoElem, baseURI, secureValidation);
            ...
            for (int i = 0; i < length; i++) {
                ...
                if (child.getNodeType() == Node.ELEMENT_NODE) {
                    ...
                    if (tag.equals("Manifest")) {
                        new com.sun.org.apache.xml.internal.security.signature.Manifest(childElem, baseURI);
    ...
    public void sign(Key signingKey) throws XMLSignatureException {
        ...
        try {
            ...
            com.sun.org.apache.xml.internal.security.signature.SignedInfo si = this.getSignedInfo();
    ...
    /**
     * This method is a proxy method for the {@link com.sun.org.apache.xml.internal.security.signature.Manifest#addDocument} method.
     *
    ...
    /**
     * Proxy method for {@link com.sun.org.apache.xml.internal.security.signature.SignedInfo#createSecretKey(byte[])}. If you want
