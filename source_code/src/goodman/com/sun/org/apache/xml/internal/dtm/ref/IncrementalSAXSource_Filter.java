...
implements com.sun.org.apache.xml.internal.dtm.ref.IncrementalSAXSource, ContentHandler, DTDHandler, LexicalHandler, ErrorHandler, Runnable
{
  ...
  // Data
  //
  private com.sun.org.apache.xml.internal.dtm.ref.CoroutineManager fCoroutineManager = null;
  ...
  public IncrementalSAXSource_Filter() {
    this.init( new com.sun.org.apache.xml.internal.dtm.ref.CoroutineManager(), -1, -1);
  }

  /** Create a IncrementalSAXSource_Filter which is not yet bound to a specific
   * SAX event source.
   * */
  public IncrementalSAXSource_Filter(com.sun.org.apache.xml.internal.dtm.ref.CoroutineManager co, int controllerCoroutineID)
  {
  ...
  // Factories
  //
  static public IncrementalSAXSource createIncrementalSAXSource(com.sun.org.apache.xml.internal.dtm.ref.CoroutineManager co, int controllerCoroutineID) {
  ...
  public void init(com.sun.org.apache.xml.internal.dtm.ref.CoroutineManager co, int controllerCoroutineID,
                   int sourceCoroutineID)
  {
    if(co==null)
      co = new com.sun.org.apache.xml.internal.dtm.ref.CoroutineManager();
