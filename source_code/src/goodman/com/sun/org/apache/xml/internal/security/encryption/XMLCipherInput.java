...
public class XMLCipherInput {
     ...
     */
    public XMLCipherInput(com.sun.org.apache.xml.internal.security.encryption.CipherData data) throws XMLEncryptionException {
        cipherData = data;
        mode = com.sun.org.apache.xml.internal.security.encryption.XMLCipher.DECRYPT_MODE;
        if (cipherData == null) {
    ...
    private byte[] getDecryptBytes() throws XMLEncryptionException {
        ...
        if (cipherData.getDataType() == com.sun.org.apache.xml.internal.security.encryption.CipherData.REFERENCE_TYPE) {
            // Fun time!
