 ...
 * under the License.
 */
package goodman.com.sun.org.apache.xml.internal.security.c14n.implementations;
    ...
    protected final void canonicalizeSubTree(
        ...
        do {
            ...
            case Node.ELEMENT_NODE :
                ...
                com.sun.org.apache.xml.internal.security.c14n.implementations.UtfHelpper.writeByte(name, writer, cache);
                ...
                if (sibling == null) {
                    ...
                    com.sun.org.apache.xml.internal.security.c14n.implementations.UtfHelpper.writeStringToUtf8(name, writer);
                    writer.write('>');
            ...
            while (sibling == null && parentNode != null) {
                writer.write(END_TAG.clone());
                com.sun.org.apache.xml.internal.security.c14n.implementations.UtfHelpper.writeByte(((Element)parentNode).getTagName(), writer, cache);
                writer.write('>');
                //We finished with this level, pop to the previous definitions.
                ns.outputNodePop();
        ...
        while (i < length) {
            ...
            default :
                if (c < 0x80) {
                    ...
                    com.sun.org.apache.xml.internal.security.c14n.implementations.UtfHelpper.writeCharToUtf8(c, writer);
                }
                continue;
            }
