...
public class MissingResourceFailureException extends XMLSignatureException {
    ...
    private com.sun.org.apache.xml.internal.security.signature.Reference uninitializedReference = null;
     ...
     * @see #getReference
     */
    public MissingResourceFailureException(String msgID, com.sun.org.apache.xml.internal.security.signature.Reference reference) {
        super(msgID);
     ...
     * @see #getReference
     */
    public MissingResourceFailureException(String msgID, Object exArgs[], com.sun.org.apache.xml.internal.security.signature.Reference reference) {
        super(msgID, exArgs);
    ...
    public MissingResourceFailureException(
        String msgID, Exception originalException, com.sun.org.apache.xml.internal.security.signature.Reference reference
    ) {
     ...
     */
    public MissingResourceFailureException(
        String msgID, Object exArgs[], Exception originalException, com.sun.org.apache.xml.internal.security.signature.Reference reference
    ) {
     ...
     * @see #getReference
     */
    public void setReference(com.sun.org.apache.xml.internal.security.signature.Reference reference) {
        this.uninitializedReference = reference;
    }
