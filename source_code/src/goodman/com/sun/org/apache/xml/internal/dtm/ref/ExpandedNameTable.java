 ...
 */
package goodman.com.sun.org.apache.xml.internal.dtm.ref;
...
public class ExpandedNameTable
{
  ...
  private com.sun.org.apache.xml.internal.dtm.ref.ExtendedType[] m_extendedTypes;
   ...
   * */
  com.sun.org.apache.xml.internal.dtm.ref.ExtendedType hashET = new com.sun.org.apache.xml.internal.dtm.ref.ExtendedType(-1, "", "");

  /** The array to store the default extended types. */
  private static com.sun.org.apache.xml.internal.dtm.ref.ExtendedType[] m_defaultExtendedTypes;
   ...
   */
  static {
    m_defaultExtendedTypes = new com.sun.org.apache.xml.internal.dtm.ref.ExtendedType[DTM.NTYPES];

    for (int i = 0; i < DTM.NTYPES; i++)
    {
      m_defaultExtendedTypes[i] = new com.sun.org.apache.xml.internal.dtm.ref.ExtendedType(i, "", "");
    }
  }
  ...
  {
    m_extendedTypes = new com.sun.org.apache.xml.internal.dtm.ref.ExtendedType[m_initialSize];
    for (int i = 0; i < DTM.NTYPES; i++) {
  ...
  public int getExpandedTypeID(String namespace, String localName, int type, boolean searchOnly)
  {
    ...
    com.sun.org.apache.xml.internal.dtm.ref.ExtendedType newET = new com.sun.org.apache.xml.internal.dtm.ref.ExtendedType(type, namespace, localName, hash);

    // Expand the m_extendedTypes array if necessary.
    if (m_extendedTypes.length == m_nextType) {
        com.sun.org.apache.xml.internal.dtm.ref.ExtendedType[] newArray = new com.sun.org.apache.xml.internal.dtm.ref.ExtendedType[m_extendedTypes.length * 2];
  ...
  {
    com.sun.org.apache.xml.internal.dtm.ref.ExtendedType key;
    int value;
    int hash;
    HashEntry next;
