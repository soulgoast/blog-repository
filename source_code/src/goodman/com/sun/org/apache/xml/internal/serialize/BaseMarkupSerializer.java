...
public abstract class BaseMarkupSerializer
    implements ContentHandler, DocumentHandler, LexicalHandler,
               DTDHandler, DeclHandler, com.sun.org.apache.xml.internal.serialize.DOMSerializer, Serializer
{
     ...
     */
    private com.sun.org.apache.xml.internal.serialize.ElementState[]  _elementStates;
     ...
     * by calling {@link #setOutputCharStream} or {@link #setOutputByteStream}
                 * first
     */
    protected BaseMarkupSerializer( com.sun.org.apache.xml.internal.serialize.OutputFormat format )
    {
        int i;

        _elementStates = new com.sun.org.apache.xml.internal.serialize.ElementState[ 10 ];
        for ( i = 0 ; i < _elementStates.length ; ++i )
            _elementStates[ i ] = new com.sun.org.apache.xml.internal.serialize.ElementState();
        _format = format;
    }
        ...
        throws IOException
    {
        ...
        if ( _format.getIndenting() ) {
            ...
            _indenting = false;
            _printer = new com.sun.org.apache.xml.internal.serialize.Printer( _writer, _format );
        }
        ...
        throws IOException
    {
        ...
        case Node.CDATA_SECTION_NODE : {
            ...
            if ((features & com.sun.org.apache.xml.internal.serialize.DOMSerializerImpl.CDATA) != 0) {
                if (text != null) {
                    if (fDOMFilter != null
        ...
        case Node.ENTITY_REFERENCE_NODE : {
            ...
            if (((features & com.sun.org.apache.xml.internal.serialize.DOMSerializerImpl.ENTITIES) != 0)
     ...
     *   serializing
     */
    protected com.sun.org.apache.xml.internal.serialize.ElementState content()
        throws IOException
    {
        com.sun.org.apache.xml.internal.serialize.ElementState state;
        ...
        for ( int index = 0 ; index <  length; ++index ) {
            ...
            if (ch == ']'
                ...
                if (fDOMErrorHandler != null) {
                    ...
                    if ((features & com.sun.org.apache.xml.internal.serialize.DOMSerializerImpl.SPLITCDATA) == 0) {
     ...
     */
    protected com.sun.org.apache.xml.internal.serialize.ElementState enterElementState(String namespaceURI, String localName,
                                                                                       String rawName, boolean preserveSpace )
    {
        com.sun.org.apache.xml.internal.serialize.ElementState state;

        if ( _elementStateCount + 1 == _elementStates.length ) {
            com.sun.org.apache.xml.internal.serialize.ElementState[] newStates;

            // Need to create a larger array of states. This does not happen
            // often, unless the document is really deep.
            newStates = new com.sun.org.apache.xml.internal.serialize.ElementState[ _elementStates.length + 10 ];
            for ( int i = 0 ; i < _elementStates.length ; ++i )
                newStates[ i ] = _elementStates[ i ];
            for ( int i = _elementStates.length ; i < newStates.length ; ++i )
                newStates[ i ] = new com.sun.org.apache.xml.internal.serialize.ElementState();
