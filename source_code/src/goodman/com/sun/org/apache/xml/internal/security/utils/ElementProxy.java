 ...
 * under the License.
 */
package goodman.com.sun.org.apache.xml.internal.security.utils;
...
public abstract class ElementProxy {
    ...
    protected Element createElementForFamilyLocal(
        ...
        if (namespace == null) {
            ...
            if ((prefix == null) || (prefix.length() == 0)) {
                ...
                result.setAttributeNS(com.sun.org.apache.xml.internal.security.utils.Constants.NamespaceSpecNS, "xmlns", namespace);
            } else {
                result = doc.createElementNS(namespace, prefix + ":" + localName);
                result.setAttributeNS(com.sun.org.apache.xml.internal.security.utils.Constants.NamespaceSpecNS, "xmlns:" + prefix, namespace);
            }
        }
        return result;
    }
    ...
    public void addBigIntegerElement(BigInteger bi, String localname) {
        if (bi != null) {
            Element e = com.sun.org.apache.xml.internal.security.utils.XMLUtils.createElementInSignatureSpace(this.doc, localname);

            com.sun.org.apache.xml.internal.security.utils.Base64.fillElementWithBigInteger(e, bi);
            this.constructionElement.appendChild(e);
            com.sun.org.apache.xml.internal.security.utils.XMLUtils.addReturnToElement(this.constructionElement);
        }
    }
    ...
    public void addBase64Element(byte[] bytes, String localname) {
        if (bytes != null) {
            Element e = com.sun.org.apache.xml.internal.security.utils.Base64.encodeToElement(this.doc, localname, bytes);

            this.constructionElement.appendChild(e);
            if (!com.sun.org.apache.xml.internal.security.utils.XMLUtils.ignoreLineBreaks()) {
    ...
    public void addBase64Text(byte[] bytes) {
        if (bytes != null) {
            Text t = com.sun.org.apache.xml.internal.security.utils.XMLUtils.ignoreLineBreaks()
                ? this.doc.createTextNode(com.sun.org.apache.xml.internal.security.utils.Base64.encode(bytes))
                : this.doc.createTextNode("\n" + com.sun.org.apache.xml.internal.security.utils.Base64.encode(bytes) + "\n");
    ...
    public BigInteger getBigIntegerFromChildElement(
        ...
        return com.sun.org.apache.xml.internal.security.utils.Base64.decodeBigIntegerFromText(
            com.sun.org.apache.xml.internal.security.utils.XMLUtils.selectNodeText(
    ...
    public byte[] getBytesFromChildElement(String localname, String namespace)
        ...
        return com.sun.org.apache.xml.internal.security.utils.Base64.decode(e);
    }
    ...
    public String getTextFromChildElement(String localname, String namespace) {
        return com.sun.org.apache.xml.internal.security.utils.XMLUtils.selectNode(
    ...
    public byte[] getBytesFromTextChild() throws XMLSecurityException {
        return Base64.decode(com.sun.org.apache.xml.internal.security.utils.XMLUtils.getFullTextChildrenFromElement(this.constructionElement));
    }
    ...
    public String getTextFromTextChild() {
        return com.sun.org.apache.xml.internal.security.utils.XMLUtils.getFullTextChildrenFromElement(this.constructionElement);
    }
    ...
    public void setXPathNamespaceContext(String prefix, String uri)
        ...
        Attr a = this.constructionElement.getAttributeNodeNS(com.sun.org.apache.xml.internal.security.utils.Constants.NamespaceSpecNS, ns);
        ...
        this.constructionElement.setAttributeNS(com.sun.org.apache.xml.internal.security.utils.Constants.NamespaceSpecNS, ns, uri);
    }
    ...
    public static void setDefaultPrefix(String namespace, String prefix)
        ...
        if (Constants.SignatureSpecNS.equals(namespace)) {
            com.sun.org.apache.xml.internal.security.utils.XMLUtils.setDsPrefix(prefix);
        }
