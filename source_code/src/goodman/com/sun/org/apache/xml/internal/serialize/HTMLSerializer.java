 ...
 * constructor.  For usage instructions see {@link com.sun.org.apache.xml.internal.serialize.Serializer}.
 * <p>
    ...
    extends BaseMarkupSerializer
{
     ...
     */
    protected HTMLSerializer( boolean xhtml, com.sun.org.apache.xml.internal.serialize.OutputFormat format )
    {
        super( format );
        _xhtml = xhtml;
    }
    ...
    {
        this( false, new com.sun.org.apache.xml.internal.serialize.OutputFormat( com.sun.org.apache.xml.internal.serialize.Method.HTML, "ISO-8859-1", false ) );
    }
     ...
     * first.
     */
    public HTMLSerializer( com.sun.org.apache.xml.internal.serialize.OutputFormat format )
    {
        this( false, format != null ? format : new com.sun.org.apache.xml.internal.serialize.OutputFormat( com.sun.org.apache.xml.internal.serialize.Method.HTML, "ISO-8859-1", false ) );
    }
     ...
     */
    public HTMLSerializer( Writer writer, com.sun.org.apache.xml.internal.serialize.OutputFormat format )
    {
        this( false, format != null ? format : new com.sun.org.apache.xml.internal.serialize.OutputFormat( com.sun.org.apache.xml.internal.serialize.Method.HTML, "ISO-8859-1", false ) );
     ...
     * @param format The output format to use, null for the default
     */
    public HTMLSerializer( OutputStream output, com.sun.org.apache.xml.internal.serialize.OutputFormat format )
    {
        this( false, format != null ? format : new com.sun.org.apache.xml.internal.serialize.OutputFormat( com.sun.org.apache.xml.internal.serialize.Method.HTML, "ISO-8859-1", false ) );
        ...
        throws SAXException
    {
        ...
        com.sun.org.apache.xml.internal.serialize.ElementState state;
        String       name;
        String       value;
        String       htmlName;
        ...
        try {
                ...
                for ( i = 0 ; i < attrs.getLength() ; ++i ) {
                    ...
                    if ( _xhtml || hasNamespaceURI ) {
                        ...
                        if ( !_format.getPreserveEmptyAttributes() && value.length() == 0 )
                            _printer.printText( name );
                        else if ( com.sun.org.apache.xml.internal.serialize.HTMLdtd.isURI( rawName, name ) ) {
                            _printer.printText( name );
                            _printer.printText( "=\"" );
                            _printer.printText( escapeURI( value ) );
                            _printer.printText( '"' );
                        } else if ( com.sun.org.apache.xml.internal.serialize.HTMLdtd.isBoolean( rawName, name ) )
                            _printer.printText( name );
                        else {
                            _printer.printText( name );
                            _printer.printText( "=\"" );
            ...
            if ( htmlName != null && com.sun.org.apache.xml.internal.serialize.HTMLdtd.isPreserveSpace( htmlName ) )
                preserveSpace = true;
        ...
        throws IOException
    {
        ...
        if ( _xhtml) {
            ...
            if ( htmlName == null || ! com.sun.org.apache.xml.internal.serialize.HTMLdtd.isOnlyOpening( htmlName ) ) {
        ...
        throws SAXException
    {
        ...
        try {
            ...
            if ( attrs != null ) {
                for ( i = 0 ; i < attrs.getLength() ; ++i ) {
                    ...
                    if ( _xhtml ) {
                        ...
                        if ( !_format.getPreserveEmptyAttributes() && value.length() == 0 )
                            _printer.printText( name );
                        else if ( com.sun.org.apache.xml.internal.serialize.HTMLdtd.isURI( tagName, name ) ) {
                            _printer.printText( name );
                            _printer.printText( "=\"" );
                            _printer.printText( escapeURI( value ) );
                            _printer.printText( '"' );
                        } else if ( com.sun.org.apache.xml.internal.serialize.HTMLdtd.isBoolean( tagName, name ) )
                            _printer.printText( name );
                        else {
                            _printer.printText( name );
                            _printer.printText( "=\"" );
            ...
            if ( com.sun.org.apache.xml.internal.serialize.HTMLdtd.isPreserveSpace( tagName ) )
                preserveSpace = true;
        ...
        throws IOException
    {
        ...
        if ( ! _started ) {
            ...
            if ( _docTypePublicId == null && _docTypeSystemId == null ) {
                if ( _xhtml ) {
                    _docTypePublicId = com.sun.org.apache.xml.internal.serialize.HTMLdtd.XHTMLPublicId;
                    _docTypeSystemId = com.sun.org.apache.xml.internal.serialize.HTMLdtd.XHTMLSystemId;
                } else {
                    _docTypePublicId = com.sun.org.apache.xml.internal.serialize.HTMLdtd.HTMLPublicId;
                    _docTypeSystemId = com.sun.org.apache.xml.internal.serialize.HTMLdtd.HTMLSystemId;
                }
            }
        ...
        throws IOException
    {
        ...
        if ( elem.hasChildNodes() || ! com.sun.org.apache.xml.internal.serialize.HTMLdtd.isEmptyTag( tagName ) ) {
