...
public class LocalVariableTypeTable extends com.sun.org.apache.bcel.internal.classfile.Attribute {
...
private int             local_variable_type_table_length; // Table of local
  private com.sun.org.apache.bcel.internal.classfile.LocalVariable[] local_variable_type_table;        // variables
  ...
  public LocalVariableTypeTable(int name_index, int length,
                            com.sun.org.apache.bcel.internal.classfile.LocalVariable[] local_variable_table,
  ...
  LocalVariableTypeTable(int nameIdx, int len, DataInputStream dis, com.sun.org.apache.bcel.internal.classfile.ConstantPool cpool) throws IOException {
    this(nameIdx, len, (com.sun.org.apache.bcel.internal.classfile.LocalVariable[])null, cpool);

    local_variable_type_table_length = (dis.readUnsignedShort());
    local_variable_type_table = new com.sun.org.apache.bcel.internal.classfile.LocalVariable[local_variable_type_table_length];

    for(int i=0; i < local_variable_type_table_length; i++)
      local_variable_type_table[i] = new com.sun.org.apache.bcel.internal.classfile.LocalVariable(dis, cpool);
  }
...
public final void dump(DataOutputStream file) throws IOException
  ...
  public final com.sun.org.apache.bcel.internal.classfile.LocalVariable[] getLocalVariableTypeTable() {
