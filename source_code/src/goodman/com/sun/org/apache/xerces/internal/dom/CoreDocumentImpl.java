 ...
 */
package goodman.com.sun.org.apache.xerces.internal.dom;
...
public class CoreDocumentImpl
        extends com.sun.org.apache.xerces.internal.dom.ParentNode implements Document {
    ...
    /** Document element. */
    protected com.sun.org.apache.xerces.internal.dom.ElementImpl docElement;

    /** NodeListCache free list */
    transient com.sun.org.apache.xerces.internal.dom.NodeListCache fFreeNLCache;
    ...
    transient com.sun.org.apache.xerces.internal.dom.DOMNormalizer domNormalizer = null;
    ...
    private static final ObjectStreamField[] serialPersistentFields =
        new ObjectStreamField[] {
            ...
            new ObjectStreamField("docElement", com.sun.org.apache.xerces.internal.dom.ElementImpl.class),
            new ObjectStreamField("fFreeNLCache", com.sun.org.apache.xerces.internal.dom.NodeListCache.class),
    ...
    public Node insertBefore(Node newChild, Node refChild)
        ...
        if (type == Node.ELEMENT_NODE) {
            docElement = (com.sun.org.apache.xerces.internal.dom.ElementImpl)newChild;
        }
    ...
    public Attr createAttribute(String name)
        ...
        return new com.sun.org.apache.xerces.internal.dom.AttrImpl(this, name);
    ...
    public Element createElement(String tagName)
        ...
        return new com.sun.org.apache.xerces.internal.dom.ElementImpl(this, tagName);
    ...
    throws DOMException{
        ...
        switch (n.getNodeType()) {
            case ELEMENT_NODE: {
                com.sun.org.apache.xerces.internal.dom.ElementImpl el = (com.sun.org.apache.xerces.internal.dom.ElementImpl) n;
                if (el instanceof com.sun.org.apache.xerces.internal.dom.ElementNSImpl) {
                    ((com.sun.org.apache.xerces.internal.dom.ElementNSImpl) el).rename(namespaceURI, name);
                    ...
                    if (namespaceURI == null) {
                        ...
                        com.sun.org.apache.xerces.internal.dom.ElementNSImpl nel =
                            new com.sun.org.apache.xerces.internal.dom.ElementNSImpl(this, namespaceURI, name);
            ...
            case ATTRIBUTE_NODE: {
                com.sun.org.apache.xerces.internal.dom.AttrImpl at = (com.sun.org.apache.xerces.internal.dom.AttrImpl) n;
                ...
                if (n instanceof com.sun.org.apache.xerces.internal.dom.AttrNSImpl) {
                    ((com.sun.org.apache.xerces.internal.dom.AttrNSImpl) at).rename(namespaceURI, name);
                    ...
                    if (namespaceURI == null) {
                        ...
                        // we need to create a new object
                        com.sun.org.apache.xerces.internal.dom.AttrNSImpl nat = new com.sun.org.apache.xerces.internal.dom.AttrNSImpl(this, namespaceURI, name);
    ...
    public Entity createEntity(String name)
        ...
        return new com.sun.org.apache.xerces.internal.dom.EntityImpl(this, name);
    ...
    public Notation createNotation(String name)
        ...
        return new com.sun.org.apache.xerces.internal.dom.NotationImpl(this, name);
    ...
    private Node importNode(Node source, boolean deep, boolean cloningDoc,
        ...
        // }
        // else
        if (source instanceof com.sun.org.apache.xerces.internal.dom.NodeImpl) {
            userData = ((com.sun.org.apache.xerces.internal.dom.NodeImpl) source).getUserDataRecord();
        }
        ...
        switch (type) {
            ...
            case ATTRIBUTE_NODE: {
                ...
                if (source instanceof com.sun.org.apache.xerces.internal.dom.AttrImpl) {
                    com.sun.org.apache.xerces.internal.dom.AttrImpl attr = (com.sun.org.apache.xerces.internal.dom.AttrImpl) source;
                    if (attr.hasStringValue()) {
                        com.sun.org.apache.xerces.internal.dom.AttrImpl newattr = (com.sun.org.apache.xerces.internal.dom.AttrImpl) newnode;
            ...
            case ENTITY_NODE: {
                ...
                com.sun.org.apache.xerces.internal.dom.EntityImpl newentity =
            ...
            case NOTATION_NODE: {
                ...
                com.sun.org.apache.xerces.internal.dom.NotationImpl newnotation =
        ...
        if (newnode.getNodeType() == Node.ENTITY_NODE) {
            ((com.sun.org.apache.xerces.internal.dom.NodeImpl)newnode).setReadOnly(true, true);
        }
        return newnode;
    ...
    public Node adoptNode(Node source) {
        ...
        try {
            node = (com.sun.org.apache.xerces.internal.dom.NodeImpl) source;
        } catch (ClassCastException e) {
        ...
        switch (node.getNodeType()) {
            case ATTRIBUTE_NODE: {
                com.sun.org.apache.xerces.internal.dom.AttrImpl attr = (com.sun.org.apache.xerces.internal.dom.AttrImpl) node;
            ...
            case ELEMENT_NODE: {
                ...
                ((com.sun.org.apache.xerces.internal.dom.ElementImpl)node).reconcileDefaultAttributes();
                break;
            }
            default: {
                userData = node.getUserDataRecord();
    ...
    protected void undeferChildren(Node node) {
        ...
        while (null != node) {
            ...
            if (((com.sun.org.apache.xerces.internal.dom.NodeImpl)node).needsSyncData()) {
                ((com.sun.org.apache.xerces.internal.dom.NodeImpl)node).synchronizeData();
            }
    ...
    public Element createElementNS(String namespaceURI, String qualifiedName)
            throws DOMException {
        return new com.sun.org.apache.xerces.internal.dom.ElementNSImpl(this, namespaceURI, qualifiedName);
    }
    ...
    public Attr createAttributeNS(String namespaceURI, String qualifiedName)
            throws DOMException {
        return new com.sun.org.apache.xerces.internal.dom.AttrNSImpl(this, namespaceURI, qualifiedName);
    }
     ...
     */
    com.sun.org.apache.xerces.internal.dom.NodeListCache getNodeListCache(ParentNode owner) {
        if (fFreeNLCache == null) {
            return new com.sun.org.apache.xerces.internal.dom.NodeListCache(owner);
        }
        com.sun.org.apache.xerces.internal.dom.NodeListCache c = fFreeNLCache;
     ...
     */
    void freeNodeListCache(com.sun.org.apache.xerces.internal.dom.NodeListCache c) {
        c.next = fFreeNLCache;
        fFreeNLCache = c;
    }
    ...
    void callUserDataHandlers(Node n, Node c, short operation) {
        ...
        if (n instanceof com.sun.org.apache.xerces.internal.dom.NodeImpl) {
            Map<String, UserDataRecord> t = ((com.sun.org.apache.xerces.internal.dom.NodeImpl) n).getUserDataRecord();
            if (t == null || t.isEmpty()) {
                return;
            }
     ...
     */
    protected void setUserData(com.sun.org.apache.xerces.internal.dom.NodeImpl n, Object data) {
     ...
     */
    protected Object getUserData(com.sun.org.apache.xerces.internal.dom.NodeImpl n) {
    ...
    protected void addEventListener(com.sun.org.apache.xerces.internal.dom.NodeImpl node, String type,
                                    EventListener listener,
                                    boolean useCapture) {
        // does nothing by default - overidden in subclass
    }

    protected void removeEventListener(com.sun.org.apache.xerces.internal.dom.NodeImpl node, String type,
                                       EventListener listener,
                                       boolean useCapture) {
        // does nothing by default - overidden in subclass
    }
    ...
    protected boolean dispatchEvent(com.sun.org.apache.xerces.internal.dom.NodeImpl node, Event event) {
        // does nothing by default - overidden in subclass
        return false;
    }
     ...
     */
    void replacedText(com.sun.org.apache.xerces.internal.dom.NodeImpl node) {
    }
     ...
     * so that live objects can be notified.
     */
    void deletedText(com.sun.org.apache.xerces.internal.dom.NodeImpl node, int offset, int count) {
    }
     ...
     * so that live objects can be notified.
     */
    void insertedText(com.sun.org.apache.xerces.internal.dom.NodeImpl node, int offset, int count) {
    }

    /**
     * A method to be called when a character data node is about to be modified
     */
    void modifyingCharacterData(com.sun.org.apache.xerces.internal.dom.NodeImpl node, boolean replace) {
    }

    /**
     * A method to be called when a character data node has been modified
     */
    void modifiedCharacterData(com.sun.org.apache.xerces.internal.dom.NodeImpl node, String oldvalue, String value, boolean replace) {
    }

    /**
     * A method to be called when a node is about to be inserted in the tree.
     */
    void insertingNode(com.sun.org.apache.xerces.internal.dom.NodeImpl node, boolean replace) {
    }

    /**
     * A method to be called when a node has been inserted in the tree.
     */
    void insertedNode(com.sun.org.apache.xerces.internal.dom.NodeImpl node, com.sun.org.apache.xerces.internal.dom.NodeImpl newInternal, boolean replace) {
    }

    /**
     * A method to be called when a node is about to be removed from the tree.
     */
    void removingNode(com.sun.org.apache.xerces.internal.dom.NodeImpl node, com.sun.org.apache.xerces.internal.dom.NodeImpl oldChild, boolean replace) {
    }

    /**
     * A method to be called when a node has been removed from the tree.
     */
    void removedNode(com.sun.org.apache.xerces.internal.dom.NodeImpl node, boolean replace) {
    }

    /**
     * A method to be called when a node is about to be replaced in the tree.
     */
    void replacingNode(com.sun.org.apache.xerces.internal.dom.NodeImpl node) {
    }

    /**
     * A method to be called when a node has been replaced in the tree.
     */
    void replacedNode(com.sun.org.apache.xerces.internal.dom.NodeImpl node) {
    }

    /**
     * A method to be called when a character data node is about to be replaced
     */
    void replacingData(com.sun.org.apache.xerces.internal.dom.NodeImpl node) {
    }

    /**
     *  method to be called when a character data node has been replaced.
     */
    void replacedCharacterData(com.sun.org.apache.xerces.internal.dom.NodeImpl node, String oldvalue, String value) {
    }
     ...
     */
    void modifiedAttrValue(com.sun.org.apache.xerces.internal.dom.AttrImpl attr, String oldvalue) {
    }

    /**
     * A method to be called when an attribute node has been set
     */
    void setAttrNode(com.sun.org.apache.xerces.internal.dom.AttrImpl attr, com.sun.org.apache.xerces.internal.dom.AttrImpl previous) {
    }
    ...
    private void readObject(ObjectInputStream in)
        ...
        fFreeNLCache = (com.sun.org.apache.xerces.internal.dom.NodeListCache)gf.get("fFreeNLCache", null);
