...
import com.sun.org.apache.xerces.internal.xpointer.*;
...
public final class XPointerHandler extends XIncludeHandler implements
    ...
    protected com.sun.org.apache.xerces.internal.xpointer.XPointerPart fXPointerPart = null;
   ...
   // Has the XPointer resolved the subresource
    ...
    public void parseXPointer(String xpointer) throws XNIException {
        ...
        while (tokens.hasMore()) {
            ...
            case Tokens.XPTRTOKEN_SHORTHAND: {
                ...
                com.sun.org.apache.xerces.internal.xpointer.XPointerPart shortHandPointer = new ShortHandPointer(
                        fSymbolTable);
            ...
            case Tokens.XPTRTOKEN_SCHEMENAME: {
                ...
                if (schemeName.equals(ELEMENT_SCHEME_NAME)) {
                    com.sun.org.apache.xerces.internal.xpointer.XPointerPart elementSchemePointer = new ElementSchemePointer(
    ...
    public boolean resolveXPointer(QName element, XMLAttributes attributes,
        ...
        if (!fFoundMatchingPtrPart) {
            ...
            for (int i = 0; i < fXPointerParts.size(); i++) {
                ...
                fXPointerPart = (com.sun.org.apache.xerces.internal.xpointer.XPointerPart) fXPointerParts.get(i);
    ...
    public void startElement(QName element, XMLAttributes attributes,
        ...
        if (!resolveXPointer(element, attributes, augs,
                com.sun.org.apache.xerces.internal.xpointer.XPointerPart.EVENT_ELEMENT_START)) {
    ...
    public void emptyElement(QName element, XMLAttributes attributes,
            Augmentations augs) throws XNIException {
        if (!resolveXPointer(element, attributes, augs,
                com.sun.org.apache.xerces.internal.xpointer.XPointerPart.EVENT_ELEMENT_EMPTY)) {
            // xml:base and xml:lang processing
                if (fFixupBase) {
                processXMLBaseAttributes(attributes);
                }
