...
package goodman.com.sun.org.apache.xerces.internal.jaxp.datatype;
...
import goodman.javax.xml.datatype.DatatypeConstants;
import goodman.javax.xml.datatype.Duration;
import goodman.javax.xml.datatype.XMLGregorianCalendar;
...
public class XMLGregorianCalendarImpl
    ...
    private void testHour() {
        ...
        if (getHour() == 24) {
            ...
            setHour(0, false);
            add(new com.sun.org.apache.xerces.internal.jaxp.datatype.DurationImpl(true, 0, 0, 1, 0, 0, 0));
        }
    }
    ...
    private XMLGregorianCalendar normalizeToTimezone(int timezone) {
        ...
        // addition.
        minutes = -minutes;
        Duration d = new com.sun.org.apache.xerces.internal.jaxp.datatype.DurationImpl(minutes >= 0, // isPositive
                0, //years
                0, //months
                0, //days
                0, //hours
    ...
    public void add(Duration duration) {
        ...
        BigDecimal dSeconds = com.sun.org.apache.xerces.internal.jaxp.datatype.DurationImpl.sanitize((BigDecimal) duration.getField(DatatypeConstants.SECONDS), signum);
