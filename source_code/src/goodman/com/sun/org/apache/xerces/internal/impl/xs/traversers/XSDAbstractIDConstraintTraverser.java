...
class XSDAbstractIDConstraintTraverser extends com.sun.org.apache.xerces.internal.impl.xs.traversers.XSDAbstractTraverser {
    ...
    boolean traverseIdentityConstraint(IdentityConstraint ic,
                                       Element icElem, com.sun.org.apache.xerces.internal.impl.xs.traversers.XSDocumentInfo schemaDoc, Object [] icElemAttrs) {
        ...
        String sText = ((String)attrValues[com.sun.org.apache.xerces.internal.impl.xs.traversers.XSAttributeChecker.ATTIDX_XPATH]);
        if(sText == null) {
