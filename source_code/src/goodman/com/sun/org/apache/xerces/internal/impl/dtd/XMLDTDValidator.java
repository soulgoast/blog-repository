...
package goodman.com.sun.org.apache.xerces.internal.impl.dtd;
...
public class XMLDTDValidator
    ...
    private com.sun.org.apache.xerces.internal.impl.dtd.XMLElementDecl fTempElementDecl = new com.sun.org.apache.xerces.internal.impl.dtd.XMLElementDecl();
    ...
    private final com.sun.org.apache.xerces.internal.impl.dtd.XMLEntityDecl fEntityDecl = new XMLEntityDecl();
    ...
    throws XNIException {
        ...
        if (fGrammarPool != null) {
            ...
            for (int i = 0; i < length; ++i) {
                fGrammarBucket.putGrammar((com.sun.org.apache.xerces.internal.impl.dtd.DTDGrammar)grammars[i]);
            }
        }
    ...
    throws XNIException {
        ...
        if(fDTDGrammar == null) {
            ...
            if (fGrammarPool != null && (systemId != null || publicId != null)) {
                fDTDGrammar = (com.sun.org.apache.xerces.internal.impl.dtd.DTDGrammar)fGrammarPool.retrieveGrammar(grammarDesc);
            }
        }
        if(fDTDGrammar == null) {
    ...
    public void characters(XMLString text, Augmentations augs) throws XNIException {
        ...
        if (fPerformValidation) {
            ...
            if (fCurrentContentSpecType == com.sun.org.apache.xerces.internal.impl.dtd.XMLElementDecl.TYPE_EMPTY) {
                charDataInContent();
            }
        }
    ...
    public void comment(XMLString text, Augmentations augs) throws XNIException {
        ...
        if (fPerformValidation && fElementDepth >= 0 && fDTDGrammar != null) {
            ...
            if (fTempElementDecl.type == com.sun.org.apache.xerces.internal.impl.dtd.XMLElementDecl.TYPE_EMPTY) {
                    fErrorReporter.reportError(XMLMessageFormatter.XML_DOMAIN,
                                               "MSG_CONTENT_INVALID_SPECIFIED",
                                               new Object[]{ fCurrentElement.rawname,
                                                             "EMPTY",
    ...
    throws XNIException {
        ...
        while (attlistIndex != -1) {
            ...
            if (DEBUG_ATTRIBUTES) {
                if (fTempAttDecl != null) {
                    com.sun.org.apache.xerces.internal.impl.dtd.XMLElementDecl elementDecl = new com.sun.org.apache.xerces.internal.impl.dtd.XMLElementDecl();
            ...
            boolean required = attDefaultType == com.sun.org.apache.xerces.internal.impl.dtd.XMLSimpleType.DEFAULT_TYPE_REQUIRED;
        ...
        for (int i = 0; i < attrCount; i++) {
            ...
            if (fTempAttDecl.simpleType.defaultType ==
                com.sun.org.apache.xerces.internal.impl.dtd.XMLSimpleType.DEFAULT_TYPE_FIXED) {
            ...
            if (fTempAttDecl.simpleType.type == com.sun.org.apache.xerces.internal.impl.dtd.XMLSimpleType.TYPE_ENTITY ||
                fTempAttDecl.simpleType.type == com.sun.org.apache.xerces.internal.impl.dtd.XMLSimpleType.TYPE_ENUMERATION ||
                fTempAttDecl.simpleType.type == com.sun.org.apache.xerces.internal.impl.dtd.XMLSimpleType.TYPE_ID ||
                fTempAttDecl.simpleType.type == com.sun.org.apache.xerces.internal.impl.dtd.XMLSimpleType.TYPE_IDREF ||
                fTempAttDecl.simpleType.type == com.sun.org.apache.xerces.internal.impl.dtd.XMLSimpleType.TYPE_NMTOKEN ||
                fTempAttDecl.simpleType.type == com.sun.org.apache.xerces.internal.impl.dtd.XMLSimpleType.TYPE_NOTATION
               ) {
    ...
    throws XNIException {
        ...
        case com.sun.org.apache.xerces.internal.impl.dtd.XMLSimpleType.TYPE_ENTITY: {
        ...
        case com.sun.org.apache.xerces.internal.impl.dtd.XMLSimpleType.TYPE_NOTATION:
        case com.sun.org.apache.xerces.internal.impl.dtd.XMLSimpleType.TYPE_ENUMERATION: {
                boolean found = false;
        ...
        case com.sun.org.apache.xerces.internal.impl.dtd.XMLSimpleType.TYPE_ID: {
                try {
        ...
        case com.sun.org.apache.xerces.internal.impl.dtd.XMLSimpleType.TYPE_IDREF: {
        ...
        case com.sun.org.apache.xerces.internal.impl.dtd.XMLSimpleType.TYPE_NMTOKEN: {
                boolean isAlistAttribute = attributeDecl.simpleType.list;//Caveat - Save this information because invalidStandaloneAttDef
                //changes fTempAttDef
                try {
                    if (isAlistAttribute) {
    ...
    private int checkContent(int elementIndex,
        ...
        //  full DFA treatment.
        //
        if (contentType == com.sun.org.apache.xerces.internal.impl.dtd.XMLElementDecl.TYPE_EMPTY) {
            //
        ...
        else if (contentType == com.sun.org.apache.xerces.internal.impl.dtd.XMLElementDecl.TYPE_ANY) {
            //
            //  This one is open game so we don't pass any judgement on it
            //  at all. Its assumed to fine since it can hold anything.
            //
        }
        else if (contentType == com.sun.org.apache.xerces.internal.impl.dtd.XMLElementDecl.TYPE_MIXED ||
                 contentType == com.sun.org.apache.xerces.internal.impl.dtd.XMLElementDecl.TYPE_CHILDREN) {
        ...
        else if (contentType == com.sun.org.apache.xerces.internal.impl.dtd.XMLElementDecl.TYPE_SIMPLE) {
    ...
    protected boolean handleStartElement(QName element, XMLAttributes attributes, Augmentations augs)
        ...
        fInElementContent = fCurrentContentSpecType == com.sun.org.apache.xerces.internal.impl.dtd.XMLElementDecl.TYPE_CHILDREN;
