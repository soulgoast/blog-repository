...
public class DocumentImpl
    ...
    protected Map<com.sun.org.apache.xerces.internal.dom.NodeImpl, List<LEntry>> eventListeners;
    ...
    public Range createRange() {
        ...
        Range range = new com.sun.org.apache.xerces.internal.dom.RangeImpl(this);
        ranges.add(range);
    ...
    void replacedText(com.sun.org.apache.xerces.internal.dom.NodeImpl node) {
        ...
        if (ranges != null) {
            ...
            for (int i = 0; i != size; i++) {
                ((com.sun.org.apache.xerces.internal.dom.RangeImpl)ranges.get(i)).receiveReplacedText(node);
            }
        }
    }
    ...
    void deletedText(com.sun.org.apache.xerces.internal.dom.NodeImpl node, int offset, int count) {
        ...
        if (ranges != null) {
            int size = ranges.size();
            for (int i = 0; i != size; i++) {
                ((com.sun.org.apache.xerces.internal.dom.RangeImpl)ranges.get(i)).receiveDeletedText(node,
                                                                offset, count);
            }
        }
    }
    ...
    void insertedText(com.sun.org.apache.xerces.internal.dom.NodeImpl node, int offset, int count) {
        ...
        if (ranges != null) {
            int size = ranges.size();
            for (int i = 0; i != size; i++) {
                ((com.sun.org.apache.xerces.internal.dom.RangeImpl)ranges.get(i)).receiveInsertedText(node,
                                                                offset, count);
            }
        }
    }
    ...
    void splitData(Node node, Node newNode, int offset) {
        ...
        if (ranges != null) {
            int size = ranges.size();
            for (int i = 0; i != size; i++) {
                ((com.sun.org.apache.xerces.internal.dom.RangeImpl)ranges.get(i)).receiveSplitData(node,
                                                              newNode, offset);
            }
        }
    }
     ...
     */
    private void setEventListeners(com.sun.org.apache.xerces.internal.dom.NodeImpl n, List<LEntry> listeners) {
     ...
     */
    private List<LEntry> getEventListeners(com.sun.org.apache.xerces.internal.dom.NodeImpl n) {
        if (eventListeners == null) {
            return null;
        }
                                    ...
                                    EventListener listener, boolean useCapture)
    {
        ...
        com.sun.org.apache.xerces.internal.dom.LCount lc = com.sun.org.apache.xerces.internal.dom.LCount.lookup(type);
        if (useCapture) {
            ++lc.captures;
            ++lc.total;
        }
    ...
    */
    ...
    protected boolean dispatchEvent(com.sun.org.apache.xerces.internal.dom.NodeImpl node, Event event) {
        ...
        com.sun.org.apache.xerces.internal.dom.LCount lc = com.sun.org.apache.xerces.internal.dom.LCount.lookup(evt.getType());
        if (lc.total == 0)
        ...
        if (lc.captures > 0) {
            ...
            for (int j = pv.size() - 1; j >= 0; --j) {
                ...
                com.sun.org.apache.xerces.internal.dom.NodeImpl nn = (com.sun.org.apache.xerces.internal.dom.NodeImpl) pv.get(j);
    ...
    protected void dispatchEventToSubtree(Node n, Event e) {
        ...
        ((com.sun.org.apache.xerces.internal.dom.NodeImpl) n).dispatchEvent(e);
    ...
    class EnclosingAttr implements Serializable {
        ...
        com.sun.org.apache.xerces.internal.dom.AttrImpl node;
        String oldvalue;
    }
     ...
     */
    protected void dispatchAggregateEvents(com.sun.org.apache.xerces.internal.dom.NodeImpl node, EnclosingAttr ea) {
        if (ea != null)
     ...
     */
    protected void dispatchAggregateEvents(com.sun.org.apache.xerces.internal.dom.NodeImpl node,
                                           com.sun.org.apache.xerces.internal.dom.AttrImpl enclosingAttr,
                                           String oldvalue, short change) {
        // We have to send DOMAttrModified.
        com.sun.org.apache.xerces.internal.dom.NodeImpl owner = null;
        if (enclosingAttr != null) {
            com.sun.org.apache.xerces.internal.dom.LCount lc = com.sun.org.apache.xerces.internal.dom.LCount.lookup(MutationEventImpl.DOM_ATTR_MODIFIED);
            owner = (com.sun.org.apache.xerces.internal.dom.NodeImpl) enclosingAttr.getOwnerElement();
            if (lc.total > 0) {
                if (owner != null) {
        ...
        com.sun.org.apache.xerces.internal.dom.LCount lc = com.sun.org.apache.xerces.internal.dom.LCount.lookup(MutationEventImpl.DOM_SUBTREE_MODIFIED);
        if (lc.total > 0) {
     ...
     */
    protected void saveEnclosingAttr(com.sun.org.apache.xerces.internal.dom.NodeImpl node) {
        ...
        com.sun.org.apache.xerces.internal.dom.LCount lc = com.sun.org.apache.xerces.internal.dom.LCount.lookup(MutationEventImpl.DOM_ATTR_MODIFIED);
        if (lc.total > 0) {
            com.sun.org.apache.xerces.internal.dom.NodeImpl eventAncestor = node;
            while (true) {
                ...
                if (type == Node.ATTRIBUTE_NODE) {
                    ...
                    retval.node = (com.sun.org.apache.xerces.internal.dom.AttrImpl) eventAncestor;
    ...
    void modifiedCharacterData(com.sun.org.apache.xerces.internal.dom.NodeImpl node, String oldvalue, String value, boolean replace) {
        if (mutationEvents) {
                if (!replace) {
                        ...
                        com.sun.org.apache.xerces.internal.dom.LCount lc =
                                com.sun.org.apache.xerces.internal.dom.LCount.lookup(MutationEventImpl.DOM_CHARACTER_DATA_MODIFIED);
                        if (lc.total > 0) {
                                MutationEvent me = new MutationEventImpl();
    ...
    void insertedNode(com.sun.org.apache.xerces.internal.dom.NodeImpl node, com.sun.org.apache.xerces.internal.dom.NodeImpl newInternal, boolean replace) {
        if (mutationEvents) {
            ...
            com.sun.org.apache.xerces.internal.dom.LCount lc = com.sun.org.apache.xerces.internal.dom.LCount.lookup(MutationEventImpl.DOM_NODE_INSERTED);
            if (lc.total > 0) {
                MutationEventImpl me = new MutationEventImpl();
            ...
            // to the Doc.
            lc = com.sun.org.apache.xerces.internal.dom.LCount.lookup(
                            MutationEventImpl.DOM_NODE_INSERTED_INTO_DOCUMENT);
            if (lc.total > 0) {
                com.sun.org.apache.xerces.internal.dom.NodeImpl eventAncestor = node;
                if (savedEnclosingAttr != null)
                    eventAncestor = (com.sun.org.apache.xerces.internal.dom.NodeImpl)
                        savedEnclosingAttr.node.getOwnerElement();
                if (eventAncestor != null) { // Might have been orphan Attr
                    com.sun.org.apache.xerces.internal.dom.NodeImpl p = eventAncestor;
                    while (p != null) {
                        eventAncestor = p; // Last non-null ancestor
                        // In this context, ancestry includes
                        // walking back from Attr to Element
                        if (p.getNodeType() == ATTRIBUTE_NODE) {
                            p = (com.sun.org.apache.xerces.internal.dom.NodeImpl) ((com.sun.org.apache.xerces.internal.dom.AttrImpl)p).getOwnerElement();
                        }
                        else {
                            p = p.parentNode();
                        }
        ...
        if (ranges != null) {
            int size = ranges.size();
            for (int i = 0; i != size; i++) {
                ((com.sun.org.apache.xerces.internal.dom.RangeImpl)ranges.get(i)).insertedNodeFromDOM(newInternal);
            }
        }
    }
    ...
    void removingNode(com.sun.org.apache.xerces.internal.dom.NodeImpl node, com.sun.org.apache.xerces.internal.dom.NodeImpl oldChild, boolean replace) {
        ...
        if (mutationEvents) {
            ...
            com.sun.org.apache.xerces.internal.dom.LCount lc = com.sun.org.apache.xerces.internal.dom.LCount.lookup(MutationEventImpl.DOM_NODE_REMOVED);
            if (lc.total > 0) {
                MutationEventImpl me= new MutationEventImpl();
            ...
            if (lc.total > 0) {
                com.sun.org.apache.xerces.internal.dom.NodeImpl eventAncestor = this;
                if(savedEnclosingAttr != null)
                    eventAncestor = (com.sun.org.apache.xerces.internal.dom.NodeImpl)
                        savedEnclosingAttr.node.getOwnerElement();
                if (eventAncestor != null) { // Might have been orphan Attr
                    for (com.sun.org.apache.xerces.internal.dom.NodeImpl p = eventAncestor.parentNode();
     ...
     */
    void removedAttrNode(AttrImpl attr, com.sun.org.apache.xerces.internal.dom.NodeImpl oldOwner, String name) {
    ...
    private void writeObject(ObjectOutputStream out) throws IOException {
        ...
        Hashtable<com.sun.org.apache.xerces.internal.dom.NodeImpl, Vector<LEntry>> el = null;
        if (eventListeners != null) {
            el = new Hashtable<>();
            for (Map.Entry<com.sun.org.apache.xerces.internal.dom.NodeImpl, List<LEntry>> e : eventListeners.entrySet()) {
    ...
    private void readObject(ObjectInputStream in)
        ...
        Hashtable<com.sun.org.apache.xerces.internal.dom.NodeImpl, Vector<LEntry>> el =
                (Hashtable<com.sun.org.apache.xerces.internal.dom.NodeImpl, Vector<LEntry>>)gf.get("eventListeners", null);
