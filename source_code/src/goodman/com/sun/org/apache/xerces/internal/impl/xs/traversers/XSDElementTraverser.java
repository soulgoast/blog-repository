...
class XSDElementTraverser extends XSDAbstractTraverser {
    ...
    XSDElementTraverser (com.sun.org.apache.xerces.internal.impl.xs.traversers.XSDHandler handler,
                         com.sun.org.apache.xerces.internal.impl.xs.traversers.XSAttributeChecker gAttrCheck) {
    ...
    protected void traverseLocal(XSParticleDecl particle,
        ...
        QName refAtt = (QName) attrValues[com.sun.org.apache.xerces.internal.impl.xs.traversers.XSAttributeChecker.ATTIDX_REF];
        XInt  minAtt = (XInt)  attrValues[com.sun.org.apache.xerces.internal.impl.xs.traversers.XSAttributeChecker.ATTIDX_MINOCCURS];
        XInt  maxAtt = (XInt)  attrValues[com.sun.org.apache.xerces.internal.impl.xs.traversers.XSAttributeChecker.ATTIDX_MAXOCCURS];

        XSElementDecl element = null;
        XSAnnotationImpl annotation = null;
        if (elmDecl.getAttributeNode(SchemaSymbols.ATT_REF) != null) {
            if (refAtt != null) {
                element = (XSElementDecl)fSchemaHandler.getGlobalDecl(schemaDoc, com.sun.org.apache.xerces.internal.impl.xs.traversers.XSDHandler.ELEMENT_TYPE, refAtt, elmDecl);
        ...
        Long defaultVals = (Long)attrValues[com.sun.org.apache.xerces.internal.impl.xs.traversers.XSAttributeChecker.ATTIDX_FROMDEFAULT];
    ...
    XSElementDecl traverseNamedElement(Element elmDecl,
        ...
        Boolean abstractAtt  = (Boolean) attrValues[com.sun.org.apache.xerces.internal.impl.xs.traversers.XSAttributeChecker.ATTIDX_ABSTRACT];
        XInt    blockAtt     = (XInt)    attrValues[com.sun.org.apache.xerces.internal.impl.xs.traversers.XSAttributeChecker.ATTIDX_BLOCK];
        String  defaultAtt   = (String)  attrValues[com.sun.org.apache.xerces.internal.impl.xs.traversers.XSAttributeChecker.ATTIDX_DEFAULT];
        XInt    finalAtt     = (XInt)    attrValues[com.sun.org.apache.xerces.internal.impl.xs.traversers.XSAttributeChecker.ATTIDX_FINAL];
        String  fixedAtt     = (String)  attrValues[com.sun.org.apache.xerces.internal.impl.xs.traversers.XSAttributeChecker.ATTIDX_FIXED];
        XInt    formAtt      = (XInt)    attrValues[com.sun.org.apache.xerces.internal.impl.xs.traversers.XSAttributeChecker.ATTIDX_FORM];
        String  nameAtt      = (String)  attrValues[com.sun.org.apache.xerces.internal.impl.xs.traversers.XSAttributeChecker.ATTIDX_NAME];
        Boolean nillableAtt  = (Boolean) attrValues[com.sun.org.apache.xerces.internal.impl.xs.traversers.XSAttributeChecker.ATTIDX_NILLABLE];
        QName   subGroupAtt  = (QName)   attrValues[com.sun.org.apache.xerces.internal.impl.xs.traversers.XSAttributeChecker.ATTIDX_SUBSGROUP];
        ...
        if (subGroupAtt != null) {
            element.fSubGroup = (XSElementDecl)fSchemaHandler.getGlobalDecl(schemaDoc, com.sun.org.apache.xerces.internal.impl.xs.traversers.XSDHandler.ELEMENT_TYPE, subGroupAtt, elmDecl);
        }
