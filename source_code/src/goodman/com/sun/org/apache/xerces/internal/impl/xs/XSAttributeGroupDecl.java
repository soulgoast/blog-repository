...
public class XSAttributeGroupDecl implements XSAttributeGroupDefinition {
    ...
    com.sun.org.apache.xerces.internal.impl.xs.XSAttributeUseImpl[] fAttributeUses = new com.sun.org.apache.xerces.internal.impl.xs.XSAttributeUseImpl[INITIAL_SIZE];
    ...
    public String addAttributeUse(com.sun.org.apache.xerces.internal.impl.xs.XSAttributeUseImpl attrUse) {

        // if this attribute use is prohibited, then don't check whether it's
        // of type ID
        if (attrUse.fUse != com.sun.org.apache.xerces.internal.impl.xs.SchemaSymbols.USE_PROHIBITED) {
    ...
    public void replaceAttributeUse(XSAttributeUse oldUse, com.sun.org.apache.xerces.internal.impl.xs.XSAttributeUseImpl newUse) {
    ...
    public XSAttributeUse getAttributeUseNoProhibited(String namespace, String name) {
        for (int i=0; i<fAttrUseNum; i++) {
            if ( (fAttributeUses[i].fAttrDecl.fTargetNamespace == namespace) &&
                 (fAttributeUses[i].fAttrDecl.fName == name) &&
                 (fAttributeUses[i].fUse != com.sun.org.apache.xerces.internal.impl.xs.SchemaSymbols.USE_PROHIBITED))
                return fAttributeUses[i];
        }
    ...
    public void removeProhibitedAttrs() {
        ...
        int count = 0;
        com.sun.org.apache.xerces.internal.impl.xs.XSAttributeUseImpl[] uses = new com.sun.org.apache.xerces.internal.impl.xs.XSAttributeUseImpl[fAttrUseNum];
        for (int i = 0; i < fAttrUseNum; i++) {
            if (fAttributeUses[i].fUse != com.sun.org.apache.xerces.internal.impl.xs.SchemaSymbols.USE_PROHIBITED) {
...
//        }
    ...
    public Object[] validRestrictionOf(String typeName, XSAttributeGroupDecl baseGroup) {
        ...
        com.sun.org.apache.xerces.internal.impl.xs.XSAttributeUseImpl attrUse = null;
        com.sun.org.apache.xerces.internal.impl.xs.XSAttributeDecl attrDecl = null;
        com.sun.org.apache.xerces.internal.impl.xs.XSAttributeUseImpl baseAttrUse = null;
        ...
        for (int i=0; i<fAttrUseNum; i++) {
            ...
            baseAttrUse = (com.sun.org.apache.xerces.internal.impl.xs.XSAttributeUseImpl)baseGroup.getAttributeUse(attrDecl.fTargetNamespace,attrDecl.fName);
            if (baseAttrUse != null) {
                //
                ...
                if (baseAttrUse.getRequired() && !attrUse.getRequired()) {
                    errorArgs = new Object[]{typeName, attrDecl.fName,
                                             attrUse.fUse == com.sun.org.apache.xerces.internal.impl.xs.SchemaSymbols.USE_OPTIONAL ? com.sun.org.apache.xerces.internal.impl.xs.SchemaSymbols.ATTVAL_OPTIONAL : com.sun.org.apache.xerces.internal.impl.xs.SchemaSymbols.ATTVAL_PROHIBITED,
    ...
    static final com.sun.org.apache.xerces.internal.impl.xs.XSAttributeUseImpl[] resize(com.sun.org.apache.xerces.internal.impl.xs.XSAttributeUseImpl[] oldArray, int newSize) {
        com.sun.org.apache.xerces.internal.impl.xs.XSAttributeUseImpl[] newArray = new XSAttributeUseImpl[newSize];
