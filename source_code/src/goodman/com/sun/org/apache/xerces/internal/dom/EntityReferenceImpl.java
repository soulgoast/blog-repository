...
implements EntityReference {
    ...
    public String getBaseURI() {
        ...
        if (baseURI == null) {
            ...
            com.sun.org.apache.xerces.internal.dom.EntityImpl entDef;
            if (null != (doctype = getOwnerDocument().getDoctype()) &&
                null != (entities = doctype.getEntities())) {

                entDef = (com.sun.org.apache.xerces.internal.dom.EntityImpl)entities.getNamedItem(getNodeName());
                if (entDef !=null) {
    ...
    protected String getEntityRefValue (){
        ...
        if (firstChild != null){
          ...
          if (firstChild.nextSibling == null){
            ...
            com.sun.org.apache.xerces.internal.dom.ChildNode next = firstChild.nextSibling;
            while (next != null){
