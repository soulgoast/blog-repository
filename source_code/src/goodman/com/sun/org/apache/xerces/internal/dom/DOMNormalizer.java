...
import goodman.java.io.StringReader;
...
public class DOMNormalizer implements XMLDocumentHandler {
     ...
     */
    private final com.sun.org.apache.xerces.internal.dom.DOMErrorImpl fError = new com.sun.org.apache.xerces.internal.dom.DOMErrorImpl();
    ...
    protected Node normalizeNode (Node node){
        ...
        case Node.ELEMENT_NODE: {
                ...
                com.sun.org.apache.xerces.internal.dom.ElementImpl elem = (com.sun.org.apache.xerces.internal.dom.ElementImpl)node;
                if (elem.needsSyncChildren()) {
                    elem.synchronizeChildren();
                }
                com.sun.org.apache.xerces.internal.dom.AttributeMap attributes = (elem.hasAttributes()) ? (com.sun.org.apache.xerces.internal.dom.AttributeMap) elem.getAttributes() : null;
                    ...
                    if ( attributes!=null ) {
                        for ( int i=0; i<attributes.getLength(); ++i ) {
                            ...
                            if (fDocument.errorChecking && ((fConfiguration.features & DOMConfigurationImpl.WELLFORMED) != 0)){
                                    isAttrValueWF(fErrorHandler, fError, fLocator, attributes, (com.sun.org.apache.xerces.internal.dom.AttrImpl)attr, attr.getValue(), fDocument.isXML11Version());
                ...
                if ((fConfiguration.features & DOMConfigurationImpl.COMMENTS) == 0) {
                    ...
                    if (prevSibling != null && prevSibling.getNodeType() == Node.TEXT_NODE) {
                        ...
                        if (nextSibling != null && nextSibling.getNodeType() == Node.TEXT_NODE) {
                            ((com.sun.org.apache.xerces.internal.dom.TextImpl)nextSibling).insertData(0, prevSibling.getNodeValue());
    ...
    protected final void namespaceFixUp (com.sun.org.apache.xerces.internal.dom.ElementImpl element, com.sun.org.apache.xerces.internal.dom.AttributeMap attributes){
        if (DEBUG) {
            ...
            for (int i = 0; i < fAttributeList.size(); i++) {
                ...
                if (uri != null) {  // attribute has namespace !=null
                    ...
                    */
                    ...
                    // reset id-attributes
                    ((com.sun.org.apache.xerces.internal.dom.AttrImpl)attr).setIdAttribute(false);
    ...
    protected final void addNamespaceDecl(String prefix, String uri, com.sun.org.apache.xerces.internal.dom.ElementImpl element){
        if (DEBUG) {
     ...
     */
    public static final void isCDataWF(DOMErrorHandler errorHandler, com.sun.org.apache.xerces.internal.dom.DOMErrorImpl error, DOMLocatorImpl locator,
     ...
     * @param isXML11Version = true if XML 1.1
     */
    public static final void isXMLCharWF(DOMErrorHandler errorHandler, com.sun.org.apache.xerces.internal.dom.DOMErrorImpl error, DOMLocatorImpl locator,
                                         String datavalue, boolean isXML11Version)
    {
        if ( datavalue == null || (datavalue.length() == 0) ) {
            return;
     ...
     * @param isXML11Version = true if XML 1.1
     */
    public static final void isCommentWF(DOMErrorHandler errorHandler, com.sun.org.apache.xerces.internal.dom.DOMErrorImpl error, DOMLocatorImpl locator,
                                         String datavalue, boolean isXML11Version)
    {
        if ( datavalue == null || (datavalue.length() == 0) ) {
            return;
     ...
     * @param value
     */
    public static final void isAttrValueWF(DOMErrorHandler errorHandler, com.sun.org.apache.xerces.internal.dom.DOMErrorImpl error,
            DOMLocatorImpl locator, NamedNodeMap attributes, Attr a, String value, boolean xml11Version) {
        if (a instanceof com.sun.org.apache.xerces.internal.dom.AttrImpl && ((com.sun.org.apache.xerces.internal.dom.AttrImpl)a).hasStringValue()) {
    ...
    implements XMLAttributes {
        protected com.sun.org.apache.xerces.internal.dom.AttributeMap fAttributes;
        protected CoreDocumentImpl fDocument;
        protected com.sun.org.apache.xerces.internal.dom.ElementImpl fElement;

        protected final Vector fAugmentations = new Vector(5);


        public void setAttributes(AttributeMap attributes, CoreDocumentImpl doc, com.sun.org.apache.xerces.internal.dom.ElementImpl elem) {
            fDocument = doc;
         ...
         * This method adds default declarations
                ...
                // be added back
                                com.sun.org.apache.xerces.internal.dom.AttrImpl attr = (com.sun.org.apache.xerces.internal.dom.AttrImpl)
        ...
        public void setValue(int attrIndex, String attrValue){
            ...
            if (fAttributes != null){
                com.sun.org.apache.xerces.internal.dom.AttrImpl attr = (com.sun.org.apache.xerces.internal.dom.AttrImpl)fAttributes.getItem(attrIndex);
     ...
     */
        ...
        if (DEBUG_EVENTS) {
            ...
            AttributePSVI attrPSVI =
                ...
                if (id){
                    ((com.sun.org.apache.xerces.internal.dom.ElementImpl)currentElement).setIdAttributeNode(attr, true);
                }
     ...
     */
        ...
        if(augs != null) {
                ...
                if (elementPSVI != null) {
                        com.sun.org.apache.xerces.internal.dom.ElementImpl elementNode = (ElementImpl) fCurrentNode;
                        if (fPSVI) {
