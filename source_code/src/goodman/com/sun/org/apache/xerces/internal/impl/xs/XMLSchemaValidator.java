...
public class XMLSchemaValidator
    ...
    protected com.sun.org.apache.xerces.internal.impl.xs.ElementPSVImpl fCurrentPSVI = new ElementPSVImpl();
    ...
    protected final com.sun.org.apache.xerces.internal.impl.xs.XSDDescription fXSDDescription = new com.sun.org.apache.xerces.internal.impl.xs.XSDDescription();
    protected final Map<String, com.sun.org.apache.xerces.internal.impl.xs.XMLSchemaLoader.LocationArray> fLocationPairs = new HashMap<>();
    ...
    */
    ...
    public boolean characterData(String data, Augmentations augs) {
        ...
        if (fCurrentType != null
            ...
            com.sun.org.apache.xerces.internal.impl.xs.XSComplexTypeDecl ctype = (com.sun.org.apache.xerces.internal.impl.xs.XSComplexTypeDecl) fCurrentType;
            if (ctype.fContentType == com.sun.org.apache.xerces.internal.impl.xs.XSComplexTypeDecl.CONTENTTYPE_ELEMENT) {
    ...
    private final com.sun.org.apache.xerces.internal.impl.xs.XSGrammarBucket fGrammarBucket = new XSGrammarBucket();
    ...
    private final XSSimpleType fQNameDV =
        (XSSimpleType) com.sun.org.apache.xerces.internal.impl.xs.SchemaGrammar.SG_SchemaNS.getGlobalTypeDecl(com.sun.org.apache.xerces.internal.impl.xs.SchemaSymbols.ATTVAL_QNAME);
    ...
    /** Element decl stack. */
    private com.sun.org.apache.xerces.internal.impl.xs.XSElementDecl[] fElemDeclStack = new com.sun.org.apache.xerces.internal.impl.xs.XSElementDecl[INITIAL_STACK_SIZE];
    ...
    /** notation stack */
    private com.sun.org.apache.xerces.internal.impl.xs.XSNotationDecl[] fNotationStack = new com.sun.org.apache.xerces.internal.impl.xs.XSNotationDecl[INITIAL_STACK_SIZE];
    ...
    public void reset(XMLComponentManager componentManager) throws XMLConfigurationException {
        ...
        if (!parser_settings){
            ...
            com.sun.org.apache.xerces.internal.impl.xs.XMLSchemaLoader.processExternalHints(
                fExternalSchemas,
    ...
    void ensureStackCapacity() {
        ...
        if (fElementDepth == fElemDeclStack.length) {
            ...
            com.sun.org.apache.xerces.internal.impl.xs.XSElementDecl[] newArrayE = new com.sun.org.apache.xerces.internal.impl.xs.XSElementDecl[newSize];
            ...
            com.sun.org.apache.xerces.internal.impl.xs.XSNotationDecl[] newArrayN = new XSNotationDecl[newSize];
    ...
    Augmentations handleStartElement(QName element, XMLAttributes attributes, Augmentations augs) {
        ...
        String sLocation =
            attributes.getValue(com.sun.org.apache.xerces.internal.impl.xs.SchemaSymbols.URI_XSI, com.sun.org.apache.xerces.internal.impl.xs.SchemaSymbols.XSI_SCHEMALOCATION);
        String nsLocation =
            attributes.getValue(com.sun.org.apache.xerces.internal.impl.xs.SchemaSymbols.URI_XSI, com.sun.org.apache.xerces.internal.impl.xs.SchemaSymbols.XSI_NONAMESPACESCHEMALOCATION);
        ...
        com.sun.org.apache.xerces.internal.impl.xs.SchemaGrammar sGrammar =
            findSchemaGrammar(
                com.sun.org.apache.xerces.internal.impl.xs.XSDDescription.CONTEXT_ELEMENT,
                element.uri,
                null,
                element,
                attributes);
        ...
        fElementDepth++;
        fCurrentElemDecl = null;
        com.sun.org.apache.xerces.internal.impl.xs.XSWildcardDecl wildcard = null;
        fCurrentType = null;
        fStrictAssess = true;
        fNil = false;
        fNotation = null;
        ...
        if (decl != null) {
            if (decl instanceof com.sun.org.apache.xerces.internal.impl.xs.XSElementDecl) {
                fCurrentElemDecl = (com.sun.org.apache.xerces.internal.impl.xs.XSElementDecl) decl;
            } else {
                wildcard = (com.sun.org.apache.xerces.internal.impl.xs.XSWildcardDecl) decl;
            }
        }

        // if the wildcard is skip, then return
        if (wildcard != null && wildcard.fProcessContents == com.sun.org.apache.xerces.internal.impl.xs.XSWildcardDecl.PC_SKIP) {
        ...
        String xsiType = attributes.getValue(com.sun.org.apache.xerces.internal.impl.xs.SchemaSymbols.URI_XSI, com.sun.org.apache.xerces.internal.impl.xs.SchemaSymbols.XSI_TYPE);
        ...
        if (fCurrentType == null && xsiType == null) {
            ...
            else if (wildcard != null && wildcard.fProcessContents == com.sun.org.apache.xerces.internal.impl.xs.XSWildcardDecl.PC_STRICT) {
            ...
            fCurrentType = com.sun.org.apache.xerces.internal.impl.xs.SchemaGrammar.fAnyType;
            fStrictAssess = false;
            ...
            // if the type is simple, we need to append
                ...
                com.sun.org.apache.xerces.internal.impl.xs.XSComplexTypeDecl ctype = (com.sun.org.apache.xerces.internal.impl.xs.XSComplexTypeDecl) fCurrentType;
                fAppendBuffer = (ctype.fContentType == com.sun.org.apache.xerces.internal.impl.xs.XSComplexTypeDecl.CONTENTTYPE_SIMPLE);
            }
        }
        ...
        if (fCurrentType.getTypeCategory() == XSTypeDefinition.COMPLEX_TYPE) {
            ...
            if (fNormalizeData) {
                ...
                if (ctype.fContentType == com.sun.org.apache.xerces.internal.impl.xs.XSComplexTypeDecl.CONTENTTYPE_SIMPLE) {
        ...
        fCurrentCM = null;
        if (fCurrentType.getTypeCategory() == XSTypeDefinition.COMPLEX_TYPE) {
            fCurrentCM = ((com.sun.org.apache.xerces.internal.impl.xs.XSComplexTypeDecl) fCurrentType).getContentModel(fCMBuilder);
        }
        ...
        String xsiNil = attributes.getValue(com.sun.org.apache.xerces.internal.impl.xs.SchemaSymbols.URI_XSI, com.sun.org.apache.xerces.internal.impl.xs.SchemaSymbols.XSI_NIL);
    ...
    Augmentations handleEndElement(QName element, Augmentations augs) {
        ...
        com.sun.org.apache.xerces.internal.impl.xs.SchemaGrammar[] grammars = null;
    ...
    final Augmentations endElementPSVI(
        boolean root,
        com.sun.org.apache.xerces.internal.impl.xs.SchemaGrammar[] grammars,
        Augmentations augs) {
    ...
    void storeLocations(String sLocation, String nsLocation) {
        if (sLocation != null) {
            if (!com.sun.org.apache.xerces.internal.impl.xs.XMLSchemaLoader.tokenizeSchemaLocationStr(sLocation, fLocationPairs)) {
                // error!
        ...
        if (nsLocation != null) {
            com.sun.org.apache.xerces.internal.impl.xs.XMLSchemaLoader.LocationArray la = fLocationPairs.get(XMLSymbols.EMPTY_STRING);
            if (la == null) {
                la = new com.sun.org.apache.xerces.internal.impl.xs.XMLSchemaLoader.LocationArray();
    ...
    com.sun.org.apache.xerces.internal.impl.xs.SchemaGrammar findSchemaGrammar(
        ...
        com.sun.org.apache.xerces.internal.impl.xs.SchemaGrammar grammar = null;
        ...
        if (grammar == null) {
            ...
            if (fGrammarPool != null) {
                grammar = (com.sun.org.apache.xerces.internal.impl.xs.SchemaGrammar) fGrammarPool.retrieveGrammar(fXSDDescription);
                if (grammar != null) {
        ...
        if ((grammar == null && !fUseGrammarPoolOnly) || fNamespaceGrowth) {
            ...
            Map<String, com.sun.org.apache.xerces.internal.impl.xs.XMLSchemaLoader.LocationArray> locationPairs = fLocationPairs;
            com.sun.org.apache.xerces.internal.impl.xs.XMLSchemaLoader.LocationArray locationArray =
    ...
    private void setLocationHints(com.sun.org.apache.xerces.internal.impl.xs.XSDDescription desc, String[] locations, com.sun.org.apache.xerces.internal.impl.xs.SchemaGrammar grammar) {
    ...
    private void setLocationHints(com.sun.org.apache.xerces.internal.impl.xs.XSDDescription desc, String[] locations, StringList docLocations) {
        int length = locations.length;
    ...
    XSTypeDefinition getAndCheckXsiType(QName element, String xsiType, XMLAttributes attributes) {
        ...
        try {
            ...
            reportSchemaError(
                ...
                new Object[] {
                    element.rawname,
                    com.sun.org.apache.xerces.internal.impl.xs.SchemaSymbols.URI_XSI + "," + com.sun.org.apache.xerces.internal.impl.xs.SchemaSymbols.XSI_TYPE,
                    xsiType });
            return null;
        }
        ...
        if (typeName.uri == com.sun.org.apache.xerces.internal.impl.xs.SchemaSymbols.URI_SCHEMAFORSCHEMA) {
            type = com.sun.org.apache.xerces.internal.impl.xs.SchemaGrammar.SG_SchemaNS.getGlobalTypeDecl(typeName.localpart);
        }
        // if it's not schema built-in types, then try to get a grammar
        if (type == null) {
            //try to find schema grammar by different means....
            com.sun.org.apache.xerces.internal.impl.xs.SchemaGrammar grammar =
                findSchemaGrammar(
                    com.sun.org.apache.xerces.internal.impl.xs.XSDDescription.CONTEXT_XSITYPE,
                    typeName.uri,
                    element,
                    typeName,
                    attributes);
        ...
        if (fCurrentType != null) {
            ...
            if (fCurrentType.getTypeCategory() == XSTypeDefinition.COMPLEX_TYPE)
                block |= ((com.sun.org.apache.xerces.internal.impl.xs.XSComplexTypeDecl) fCurrentType).fBlock;
            if (!com.sun.org.apache.xerces.internal.impl.xs.XSConstraints.checkTypeDerivationOk(type, fCurrentType, block))
                reportSchemaError(
                    "cvc-elt.4.3",
    ...
    boolean getXsiNil(QName element, String xsiNil) {
        ...
        if (fCurrentElemDecl != null && !fCurrentElemDecl.getNillable()) {
            reportSchemaError(
                ...
                new Object[] {
                    element.rawname,
                    com.sun.org.apache.xerces.internal.impl.xs.SchemaSymbols.URI_XSI + "," + com.sun.org.apache.xerces.internal.impl.xs.SchemaSymbols.XSI_NIL });
        }
        ...
        // 3.2.2 There must be no fixed {value constraint}.
            ...
            if (value.equals(com.sun.org.apache.xerces.internal.impl.xs.SchemaSymbols.ATTVAL_TRUE)
                || value.equals(com.sun.org.apache.xerces.internal.impl.xs.SchemaSymbols.ATTVAL_TRUE_1)) {
                if (fCurrentElemDecl != null
                    && fCurrentElemDecl.getConstraintType() == XSConstants.VC_FIXED) {
                    reportSchemaError(
                        "cvc-elt.3.2.2",
    ...
    void processAttributes(QName element, XMLAttributes attributes, XSAttributeGroupDecl attrGrp) {
        ...
        com.sun.org.apache.xerces.internal.impl.xs.AttributePSVImpl attrPSVI = null;
        ...
        int useCount = 0;
        com.sun.org.apache.xerces.internal.impl.xs.XSWildcardDecl attrWildcard = null;
        if (!isSimple) {
        ...
        for (int index = 0; index < attCount; index++) {
            ...
            if (fAugPSVI || fIdConstraint) {
                ...
                attrPSVI = (com.sun.org.apache.xerces.internal.impl.xs.AttributePSVImpl) augs.getItem(Constants.ATTRIBUTE_PSVI);
                if (attrPSVI != null) {
                    attrPSVI.reset();
                } else {
                    attrPSVI = new com.sun.org.apache.xerces.internal.impl.xs.AttributePSVImpl();
            ...
            if (fTempQName.uri == com.sun.org.apache.xerces.internal.impl.xs.SchemaSymbols.URI_XSI) {
                com.sun.org.apache.xerces.internal.impl.xs.XSAttributeDecl attrDecl = null;
                if (fTempQName.localpart == com.sun.org.apache.xerces.internal.impl.xs.SchemaSymbols.XSI_SCHEMALOCATION)
                    attrDecl =
                        com.sun.org.apache.xerces.internal.impl.xs.SchemaGrammar.SG_XSI.getGlobalAttributeDecl(
                            com.sun.org.apache.xerces.internal.impl.xs.SchemaSymbols.XSI_SCHEMALOCATION);
                else if (fTempQName.localpart == com.sun.org.apache.xerces.internal.impl.xs.SchemaSymbols.XSI_NONAMESPACESCHEMALOCATION)
                    attrDecl =
                        com.sun.org.apache.xerces.internal.impl.xs.SchemaGrammar.SG_XSI.getGlobalAttributeDecl(
                            com.sun.org.apache.xerces.internal.impl.xs.SchemaSymbols.XSI_NONAMESPACESCHEMALOCATION);
                else if (fTempQName.localpart == com.sun.org.apache.xerces.internal.impl.xs.SchemaSymbols.XSI_NIL)
                    attrDecl = com.sun.org.apache.xerces.internal.impl.xs.SchemaGrammar.SG_XSI.getGlobalAttributeDecl(com.sun.org.apache.xerces.internal.impl.xs.SchemaSymbols.XSI_NIL);
                else if (fTempQName.localpart == com.sun.org.apache.xerces.internal.impl.xs.SchemaSymbols.XSI_TYPE)
                    attrDecl = com.sun.org.apache.xerces.internal.impl.xs.SchemaGrammar.SG_XSI.getGlobalAttributeDecl(com.sun.org.apache.xerces.internal.impl.xs.SchemaSymbols.XSI_TYPE);
                if (attrDecl != null) {
            ...
            com.sun.org.apache.xerces.internal.impl.xs.XSAttributeDecl currDecl = null;
            if (currUse != null) {
                currDecl = currUse.fAttrDecl;
            } else {
                // which means it matches a wildcard
                // skip it if processContents is skip
                if (attrWildcard.fProcessContents == com.sun.org.apache.xerces.internal.impl.xs.XSWildcardDecl.PC_SKIP)
                    continue;
    ...
    void processOneAttribute(
        ...
        XMLAttributes attributes,
        int index,
        com.sun.org.apache.xerces.internal.impl.xs.XSAttributeDecl currDecl,
        XSAttributeUseImpl currUse,
        com.sun.org.apache.xerces.internal.impl.xs.AttributePSVImpl attrPSVI) {
    ...
    void addDefaultAttributes(
        ...
        for (int i = 0; i < useCount; i++) {
            ...
            if (currUse.fUse == com.sun.org.apache.xerces.internal.impl.xs.SchemaSymbols.USE_REQUIRED) {
                if (!isSpecified)
                    reportSchemaError(
                        "cvc-complex-type.4",
            ...
            if (!isSpecified && constType != XSConstants.VC_NONE) {
                ...
                if (fAugPSVI) {
                    ...
                    com.sun.org.apache.xerces.internal.impl.xs.AttributePSVImpl attrPSVI = new AttributePSVImpl();
                    augs.putItem(Constants.ATTRIBUTE_PSVI, attrPSVI);
        ...
        if (fNil) {
            if (fSubElement || fSawText) {
                reportSchemaError(
                    ...
                    new Object[] {
                        element.rawname,
                        com.sun.org.apache.xerces.internal.impl.xs.SchemaSymbols.URI_XSI + "," + SchemaSymbols.XSI_NIL });
            }
        }
        ...
        if (fCurrentElemDecl != null
            ...
            if (fCurrentElemDecl != null
                ...
                if (fCurrentType.getTypeCategory() == XSTypeDefinition.COMPLEX_TYPE) {
                    ...
                    if (ctype.fContentType == com.sun.org.apache.xerces.internal.impl.xs.XSComplexTypeDecl.CONTENTTYPE_MIXED) {
                    ...
                    else if (ctype.fContentType == com.sun.org.apache.xerces.internal.impl.xs.XSComplexTypeDecl.CONTENTTYPE_SIMPLE) {
    ...
    Object elementLocallyValidComplexType(QName element, Object textContent) {
        ...
        if (!fNil) {
            ...
            if (ctype.fContentType == com.sun.org.apache.xerces.internal.impl.xs.XSComplexTypeDecl.CONTENTTYPE_EMPTY
            ...
            else if (ctype.fContentType == com.sun.org.apache.xerces.internal.impl.xs.XSComplexTypeDecl.CONTENTTYPE_ELEMENT) {
                if (fSawCharacters) {
