...
public class XSConstraints {
    ...
    static final int OCCURRENCE_UNKNOWN = com.sun.org.apache.xerces.internal.impl.xs.SchemaSymbols.OCCURRENCE_UNBOUNDED-1;
    static final XSSimpleType STRING_TYPE = (XSSimpleType) com.sun.org.apache.xerces.internal.impl.xs.SchemaGrammar.SG_SchemaNS.getGlobalTypeDecl(com.sun.org.apache.xerces.internal.impl.xs.SchemaSymbols.ATTVAL_STRING);
    ...
    public static boolean checkTypeDerivationOk(XSTypeDefinition derived, XSTypeDefinition base, short block) {
        ...
        if (derived == com.sun.org.apache.xerces.internal.impl.xs.SchemaGrammar.fAnyType)
            return derived == base;
        // if derived is anySimpleType, then it's valid only if the base
        // is ur-type
        if (derived == com.sun.org.apache.xerces.internal.impl.xs.SchemaGrammar.fAnySimpleType) {
            return (base == com.sun.org.apache.xerces.internal.impl.xs.SchemaGrammar.fAnyType ||
                    base == com.sun.org.apache.xerces.internal.impl.xs.SchemaGrammar.fAnySimpleType);
        }
        ...
        if (derived.getTypeCategory() == XSTypeDefinition.SIMPLE_TYPE) {
            ...
            if (base.getTypeCategory() == XSTypeDefinition.COMPLEX_TYPE) {
                ...
                // otherwise, not valid
                if (base == com.sun.org.apache.xerces.internal.impl.xs.SchemaGrammar.fAnyType)
                    base = com.sun.org.apache.xerces.internal.impl.xs.SchemaGrammar.fAnySimpleType;
                else
                    return false;
            }
    ...
    private static boolean checkSimpleDerivation(XSSimpleType derived, XSSimpleType base, short block) {
        ...
        if (directBase != com.sun.org.apache.xerces.internal.impl.xs.SchemaGrammar.fAnySimpleType &&
    ...
    private static boolean checkComplexDerivation(XSComplexTypeDecl derived, XSTypeDefinition base, short block) {
        ...
        if (directBase == com.sun.org.apache.xerces.internal.impl.xs.SchemaGrammar.fAnyType ||
                directBase == com.sun.org.apache.xerces.internal.impl.xs.SchemaGrammar.fAnySimpleType) {
            return false;
        }
    ...
    public static void fullSchemaChecking(XSGrammarBucket grammarBucket,
        ...
        com.sun.org.apache.xerces.internal.impl.xs.SchemaGrammar[] grammars = grammarBucket.getGrammars();
        ...
        for (int g = grammars.length-1; g >= 0; g--) {
            com.sun.org.apache.xerces.internal.impl.xs.XSGroupDecl[] redefinedGroups = grammars[g].getRedefinedGroupDecls();
            SimpleLocator [] rgLocators = grammars[g].getRGLocators();
            for(int i=0; i<redefinedGroups.length; ) {
                com.sun.org.apache.xerces.internal.impl.xs.XSGroupDecl derivedGrp = redefinedGroups[i++];
            ...
            case XSModelGroupImpl.MODELGROUP_SEQUENCE:
            {
                switch (bType) {
                    ...
                    case XSModelGroupImpl.MODELGROUP_CHOICE:
                    {
                        ...
                        int max1 = (dMaxOccurs == com.sun.org.apache.xerces.internal.impl.xs.SchemaSymbols.OCCURRENCE_UNBOUNDED)?
    ...
    private static void checkNameAndTypeOK(XSElementDecl dElement, int dMin, int dMax,
        ...
        if (!checkOccurrenceRange(dMin, dMax, bMin, bMax)) {
            throw new XMLSchemaException("rcase-NameAndTypeOK.3",
                    ...
                    dMax== com.sun.org.apache.xerces.internal.impl.xs.SchemaSymbols.OCCURRENCE_UNBOUNDED?"unbounded":Integer.toString(dMax),
                            Integer.toString(bMin),
                            bMax== com.sun.org.apache.xerces.internal.impl.xs.SchemaSymbols.OCCURRENCE_UNBOUNDED?"unbounded":Integer.toString(bMax)});
        }
    ...
    private static boolean checkOccurrenceRange(int min1, int max1, int min2, int max2) {
        ...
        if ((min1 >= min2) &&
                ((max2== com.sun.org.apache.xerces.internal.impl.xs.SchemaSymbols.OCCURRENCE_UNBOUNDED) ||
                        (max1!= com.sun.org.apache.xerces.internal.impl.xs.SchemaSymbols.OCCURRENCE_UNBOUNDED && max1<=max2)))
            return true;
        else
            return false;
    }
    ...
    private static void checkNSCompat(XSElementDecl elem, int min1, int max1,
        ...
        if (checkWCOccurrence && !checkOccurrenceRange(min1,max1,min2,max2)) {
            throw new XMLSchemaException("rcase-NSCompat.2",
                    ...
                    max1== com.sun.org.apache.xerces.internal.impl.xs.SchemaSymbols.OCCURRENCE_UNBOUNDED?"unbounded":Integer.toString(max1),
                            Integer.toString(min2),
                            max2== com.sun.org.apache.xerces.internal.impl.xs.SchemaSymbols.OCCURRENCE_UNBOUNDED?"unbounded":Integer.toString(max2)});
        }
