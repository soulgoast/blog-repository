...
public final class XSDeclarationPool {
    ...
    private com.sun.org.apache.xerces.internal.impl.xs.XSElementDecl fElementDecl[][] = new com.sun.org.apache.xerces.internal.impl.xs.XSElementDecl[INITIAL_CHUNK_COUNT][];
    private int fElementDeclIndex = 0;

    /** Particle declaration pool */
    private com.sun.org.apache.xerces.internal.impl.xs.XSParticleDecl fParticleDecl[][] = new com.sun.org.apache.xerces.internal.impl.xs.XSParticleDecl[INITIAL_CHUNK_COUNT][];
    private int fParticleDeclIndex = 0;

    /** Particle declaration pool */
    private com.sun.org.apache.xerces.internal.impl.xs.XSModelGroupImpl fModelGroup[][] = new com.sun.org.apache.xerces.internal.impl.xs.XSModelGroupImpl[INITIAL_CHUNK_COUNT][];
    private int fModelGroupIndex = 0;

    /** Attribute declaration pool */
    private com.sun.org.apache.xerces.internal.impl.xs.XSAttributeDecl fAttrDecl[][] = new com.sun.org.apache.xerces.internal.impl.xs.XSAttributeDecl[INITIAL_CHUNK_COUNT][];
    private int fAttrDeclIndex = 0;

    /** ComplexType declaration pool */
    private com.sun.org.apache.xerces.internal.impl.xs.XSComplexTypeDecl fCTDecl[][] = new com.sun.org.apache.xerces.internal.impl.xs.XSComplexTypeDecl[INITIAL_CHUNK_COUNT][];
    ...
    public final com.sun.org.apache.xerces.internal.impl.xs.XSElementDecl getElementDecl(){
        ...
        if (fElementDecl[chunk][index] == null) {
            fElementDecl[chunk][index] = new com.sun.org.apache.xerces.internal.impl.xs.XSElementDecl();
        } else {
    ...
    public final com.sun.org.apache.xerces.internal.impl.xs.XSAttributeDecl getAttributeDecl(){
        ...
        if (fAttrDecl[chunk][index] == null) {
            fAttrDecl[chunk][index] = new com.sun.org.apache.xerces.internal.impl.xs.XSAttributeDecl();
        } else {
    ...
    public final com.sun.org.apache.xerces.internal.impl.xs.XSComplexTypeDecl getComplexTypeDecl(){
        ...
        if (fCTDecl[chunk][index] == null) {
            ...
            fCTDecl[chunk][index] = new com.sun.org.apache.xerces.internal.impl.xs.XSComplexTypeDecl();
        } else {
    ...
    public final com.sun.org.apache.xerces.internal.impl.xs.XSParticleDecl getParticleDecl(){
        ...
        if (fParticleDecl[chunk][index] == null) {
            fParticleDecl[chunk][index] = new com.sun.org.apache.xerces.internal.impl.xs.XSParticleDecl();
        } else {
    ...
    public final com.sun.org.apache.xerces.internal.impl.xs.XSModelGroupImpl getModelGroup(){
        ...
        if (fModelGroup[chunk][index] == null) {
            fModelGroup[chunk][index] = new com.sun.org.apache.xerces.internal.impl.xs.XSModelGroupImpl();
        } else {
    ...
    private boolean ensureElementDeclCapacity(int chunk) {
        ...
        fElementDecl[chunk] = new com.sun.org.apache.xerces.internal.impl.xs.XSElementDecl[CHUNK_SIZE];
        return true;
    }
    ...
    private static com.sun.org.apache.xerces.internal.impl.xs.XSElementDecl[][] resize(com.sun.org.apache.xerces.internal.impl.xs.XSElementDecl array[][], int newsize) {
        com.sun.org.apache.xerces.internal.impl.xs.XSElementDecl newarray[][] = new XSElementDecl[newsize][];
    ...
    private boolean ensureParticleDeclCapacity(int chunk) {
        ...
        fParticleDecl[chunk] = new com.sun.org.apache.xerces.internal.impl.xs.XSParticleDecl[CHUNK_SIZE];
        return true;
    }
    ...
    private boolean ensureModelGroupCapacity(int chunk) {
        ...
        fModelGroup[chunk] = new com.sun.org.apache.xerces.internal.impl.xs.XSModelGroupImpl[CHUNK_SIZE];
        return true;
    }
    ...
    private static com.sun.org.apache.xerces.internal.impl.xs.XSParticleDecl[][] resize(com.sun.org.apache.xerces.internal.impl.xs.XSParticleDecl array[][], int newsize) {
        com.sun.org.apache.xerces.internal.impl.xs.XSParticleDecl newarray[][] = new XSParticleDecl[newsize][];
        System.arraycopy(array, 0, newarray, 0, array.length);
        return newarray;
    }
    ...
    private static com.sun.org.apache.xerces.internal.impl.xs.XSModelGroupImpl[][] resize(com.sun.org.apache.xerces.internal.impl.xs.XSModelGroupImpl array[][], int newsize) {
        com.sun.org.apache.xerces.internal.impl.xs.XSModelGroupImpl newarray[][] = new XSModelGroupImpl[newsize][];
        System.arraycopy(array, 0, newarray, 0, array.length);
        return newarray;
    }
    ...
    private boolean ensureAttrDeclCapacity(int chunk) {
        ...
        fAttrDecl[chunk] = new com.sun.org.apache.xerces.internal.impl.xs.XSAttributeDecl[CHUNK_SIZE];
        return true;
    }
    ...
    private static com.sun.org.apache.xerces.internal.impl.xs.XSAttributeDecl[][] resize(com.sun.org.apache.xerces.internal.impl.xs.XSAttributeDecl array[][], int newsize) {
        com.sun.org.apache.xerces.internal.impl.xs.XSAttributeDecl newarray[][] = new XSAttributeDecl[newsize][];
        System.arraycopy(array, 0, newarray, 0, array.length);
        return newarray;
    }
    ...
    private boolean ensureCTDeclCapacity(int chunk) {
        ...
        fCTDecl[chunk] = new com.sun.org.apache.xerces.internal.impl.xs.XSComplexTypeDecl[CHUNK_SIZE];
        return true;
    }
    ...
    private static com.sun.org.apache.xerces.internal.impl.xs.XSComplexTypeDecl[][] resize(com.sun.org.apache.xerces.internal.impl.xs.XSComplexTypeDecl array[][], int newsize) {
        com.sun.org.apache.xerces.internal.impl.xs.XSComplexTypeDecl newarray[][] = new XSComplexTypeDecl[newsize][];
        System.arraycopy(array, 0, newarray, 0, array.length);
        return newarray;
    }
