...
package goodman.com.sun.org.apache.xerces.internal.utils;
...
public final class XMLSecurityManager {
    ...
    public boolean isOverLimit(Limit limit, String entityName, int size,
            com.sun.org.apache.xerces.internal.utils.XMLLimitAnalyzer limitAnalyzer) {
     ...
     * @return true if the size is over the limit, false otherwise
     */
    public boolean isOverLimit(Limit limit, com.sun.org.apache.xerces.internal.utils.XMLLimitAnalyzer limitAnalyzer) {
        return isOverLimit(limit.ordinal(), limitAnalyzer);
    }

    public boolean isOverLimit(int index, com.sun.org.apache.xerces.internal.utils.XMLLimitAnalyzer limitAnalyzer) {
        if (values[index] == NO_LIMIT) {
            return false;
        }
    ...
    private boolean getSystemProperty(Limit limit, String sysPropertyName) {
        try {
            String value = com.sun.org.apache.xerces.internal.utils.SecuritySupport.getSystemProperty(sysPropertyName);
