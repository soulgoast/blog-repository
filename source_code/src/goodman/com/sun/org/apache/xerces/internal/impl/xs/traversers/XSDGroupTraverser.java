...
class  XSDGroupTraverser extends XSDAbstractParticleTraverser {
    ...
    XSDGroupTraverser (com.sun.org.apache.xerces.internal.impl.xs.traversers.XSDHandler handler,
    ...
    XSParticleDecl traverseLocal(Element elmNode,
        ...
        if (refAttr == null) {
            ...
            group = (XSGroupDecl)fSchemaHandler.getGlobalDecl(schemaDoc, com.sun.org.apache.xerces.internal.impl.xs.traversers.XSDHandler.GROUP_TYPE, refAttr, elmNode);
        }
