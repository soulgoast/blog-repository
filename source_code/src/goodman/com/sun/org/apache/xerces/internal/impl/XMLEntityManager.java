...
package goodman.com.sun.org.apache.xerces.internal.impl;
...
import goodman.java.net.URISyntaxException;
import goodman.java.net.URL;
import goodman.java.net.URLConnection;
...
import goodman.javax.xml.stream.XMLInputFactory;
...
public class XMLEntityManager implements XMLComponent, XMLEntityResolver {
    ...
    protected static final String VALIDATION =
            com.sun.org.apache.xerces.internal.impl.Constants.SAX_FEATURE_PREFIX + com.sun.org.apache.xerces.internal.impl.Constants.VALIDATION_FEATURE;
    ...
    protected static final String EXTERNAL_GENERAL_ENTITIES =
            com.sun.org.apache.xerces.internal.impl.Constants.SAX_FEATURE_PREFIX + com.sun.org.apache.xerces.internal.impl.Constants.EXTERNAL_GENERAL_ENTITIES_FEATURE;

    /** Feature identifier: external parameter entities. */
    protected static final String EXTERNAL_PARAMETER_ENTITIES =
            com.sun.org.apache.xerces.internal.impl.Constants.SAX_FEATURE_PREFIX + com.sun.org.apache.xerces.internal.impl.Constants.EXTERNAL_PARAMETER_ENTITIES_FEATURE;

    /** Feature identifier: allow Java encodings. */
    protected static final String ALLOW_JAVA_ENCODINGS =
            com.sun.org.apache.xerces.internal.impl.Constants.XERCES_FEATURE_PREFIX + com.sun.org.apache.xerces.internal.impl.Constants.ALLOW_JAVA_ENCODINGS_FEATURE;

    /** Feature identifier: warn on duplicate EntityDef */
    protected static final String WARN_ON_DUPLICATE_ENTITYDEF =
            com.sun.org.apache.xerces.internal.impl.Constants.XERCES_FEATURE_PREFIX + com.sun.org.apache.xerces.internal.impl.Constants.WARN_ON_DUPLICATE_ENTITYDEF_FEATURE;

    /** Feature identifier: load external DTD. */
    protected static final String LOAD_EXTERNAL_DTD =
            com.sun.org.apache.xerces.internal.impl.Constants.XERCES_FEATURE_PREFIX + com.sun.org.apache.xerces.internal.impl.Constants.LOAD_EXTERNAL_DTD_FEATURE;

    // property identifiers

    /** Property identifier: symbol table. */
    protected static final String SYMBOL_TABLE =
            com.sun.org.apache.xerces.internal.impl.Constants.XERCES_PROPERTY_PREFIX + com.sun.org.apache.xerces.internal.impl.Constants.SYMBOL_TABLE_PROPERTY;

    /** Property identifier: error reporter. */
    protected static final String ERROR_REPORTER =
            com.sun.org.apache.xerces.internal.impl.Constants.XERCES_PROPERTY_PREFIX + com.sun.org.apache.xerces.internal.impl.Constants.ERROR_REPORTER_PROPERTY;

    /** Feature identifier: standard uri conformant */
    protected static final String STANDARD_URI_CONFORMANT =
            com.sun.org.apache.xerces.internal.impl.Constants.XERCES_FEATURE_PREFIX + com.sun.org.apache.xerces.internal.impl.Constants.STANDARD_URI_CONFORMANT_FEATURE;

    /** Property identifier: entity resolver. */
    protected static final String ENTITY_RESOLVER =
            com.sun.org.apache.xerces.internal.impl.Constants.XERCES_PROPERTY_PREFIX + com.sun.org.apache.xerces.internal.impl.Constants.ENTITY_RESOLVER_PROPERTY;

    protected static final String STAX_ENTITY_RESOLVER =
            com.sun.org.apache.xerces.internal.impl.Constants.XERCES_PROPERTY_PREFIX + com.sun.org.apache.xerces.internal.impl.Constants.STAX_ENTITY_RESOLVER_PROPERTY;

    // property identifier:  ValidationManager
    protected static final String VALIDATION_MANAGER =
            com.sun.org.apache.xerces.internal.impl.Constants.XERCES_PROPERTY_PREFIX + com.sun.org.apache.xerces.internal.impl.Constants.VALIDATION_MANAGER_PROPERTY;

    /** property identifier: buffer size. */
    protected static final String BUFFER_SIZE =
            com.sun.org.apache.xerces.internal.impl.Constants.XERCES_PROPERTY_PREFIX + com.sun.org.apache.xerces.internal.impl.Constants.BUFFER_SIZE_PROPERTY;
    ...
    protected static final String PARSER_SETTINGS =
        com.sun.org.apache.xerces.internal.impl.Constants.XERCES_FEATURE_PREFIX + com.sun.org.apache.xerces.internal.impl.Constants.PARSER_SETTINGS;
    ...
    static final String EXTERNAL_ACCESS_DEFAULT = com.sun.org.apache.xerces.internal.impl.Constants.EXTERNAL_ACCESS_DEFAULT;
    ...
    public XMLEntityManager() {
        ...
        setScannerVersion(com.sun.org.apache.xerces.internal.impl.Constants.XML_VERSION_1_0);
    } // <init>()

    /** Default constructor. */
    public XMLEntityManager(com.sun.org.apache.xerces.internal.impl.PropertyManager propertyManager) {
    ...
    public void setScannerVersion(short version) {
        ...
        if(version == com.sun.org.apache.xerces.internal.impl.Constants.XML_VERSION_1_0) {
            if(fXML10EntityScanner == null) {
                fXML10EntityScanner = new XMLEntityScanner();
            }
            fXML10EntityScanner.reset(fSymbolTable, this, fErrorReporter);
    ...
    throws IOException, XNIException {
        ...
        if (entity == null) {
            if (fEntityHandler != null) {
                ...
                fEntityAugs.putItem(com.sun.org.apache.xerces.internal.impl.Constants.ENTITY_SKIPPED, Boolean.TRUE);
        ...
        if (external) {
            ...
            if (!fISCreatedByResolver) {
                ...
                if (fLoadExternalDTD) {
                    String accessError = SecuritySupport.checkAccess(expandedSystemId, fAccessExternalDTD, com.sun.org.apache.xerces.internal.impl.Constants.ACCESS_EXTERNAL_ALL);
                    if (accessError != null) {
                        fErrorReporter.reportError(this.getEntityScanner(),XMLMessageFormatter.XML_DOMAIN,
    ...
    public void endEntity() throws IOException, XNIException {
        ...
        if (fEntityHandler != null) {
            ...
            if(entity == null){
                fEntityAugs.removeAllItems();
                fEntityAugs.putItem(com.sun.org.apache.xerces.internal.impl.Constants.LAST_ENTITY, Boolean.TRUE);
    ...
    public void reset(PropertyManager propertyManager){
        // xerces properties
        fSymbolTable = (SymbolTable)propertyManager.getProperty(com.sun.org.apache.xerces.internal.impl.Constants.XERCES_PROPERTY_PREFIX + com.sun.org.apache.xerces.internal.impl.Constants.SYMBOL_TABLE_PROPERTY);
        fErrorReporter = (XMLErrorReporter)propertyManager.getProperty(com.sun.org.apache.xerces.internal.impl.Constants.XERCES_PROPERTY_PREFIX + com.sun.org.apache.xerces.internal.impl.Constants.ERROR_REPORTER_PROPERTY);
        try {
        ...
        fLoadExternalDTD = !((Boolean)propertyManager.getProperty(com.sun.org.apache.xerces.internal.impl.Constants.ZEPHYR_PROPERTY_PREFIX + com.sun.org.apache.xerces.internal.impl.Constants.IGNORE_EXTERNAL_DTD)).booleanValue();
    ...
    throws XMLConfigurationException {
        ...
        entityExpansionIndex = fSecurityManager.getIndex(com.sun.org.apache.xerces.internal.impl.Constants.JDK_ENTITY_EXPANSION_LIMIT);
    ...
    throws XMLConfigurationException {
        ...
        // xerces features
        if (featureId.startsWith(com.sun.org.apache.xerces.internal.impl.Constants.XERCES_FEATURE_PREFIX)) {
            final int suffixLength = featureId.length() - com.sun.org.apache.xerces.internal.impl.Constants.XERCES_FEATURE_PREFIX.length();
            if (suffixLength == com.sun.org.apache.xerces.internal.impl.Constants.ALLOW_JAVA_ENCODINGS_FEATURE.length() &&
                featureId.endsWith(com.sun.org.apache.xerces.internal.impl.Constants.ALLOW_JAVA_ENCODINGS_FEATURE)) {
                fAllowJavaEncodings = state;
            }
            if (suffixLength == com.sun.org.apache.xerces.internal.impl.Constants.LOAD_EXTERNAL_DTD_FEATURE.length() &&
                featureId.endsWith(com.sun.org.apache.xerces.internal.impl.Constants.LOAD_EXTERNAL_DTD_FEATURE)) {
    ...
    public void setProperty(String propertyId, Object value){
        // Xerces properties
        if (propertyId.startsWith(com.sun.org.apache.xerces.internal.impl.Constants.XERCES_PROPERTY_PREFIX)) {
            final int suffixLength = propertyId.length() - com.sun.org.apache.xerces.internal.impl.Constants.XERCES_PROPERTY_PREFIX.length();

            if (suffixLength == com.sun.org.apache.xerces.internal.impl.Constants.SYMBOL_TABLE_PROPERTY.length() &&
                propertyId.endsWith(com.sun.org.apache.xerces.internal.impl.Constants.SYMBOL_TABLE_PROPERTY)) {
                fSymbolTable = (SymbolTable)value;
                return;
            }
            if (suffixLength == com.sun.org.apache.xerces.internal.impl.Constants.ERROR_REPORTER_PROPERTY.length() &&
                propertyId.endsWith(com.sun.org.apache.xerces.internal.impl.Constants.ERROR_REPORTER_PROPERTY)) {
                fErrorReporter = (XMLErrorReporter)value;
                return;
            }
            if (suffixLength == com.sun.org.apache.xerces.internal.impl.Constants.ENTITY_RESOLVER_PROPERTY.length() &&
                propertyId.endsWith(com.sun.org.apache.xerces.internal.impl.Constants.ENTITY_RESOLVER_PROPERTY)) {
                fEntityResolver = (XMLEntityResolver)value;
                return;
            }
            if (suffixLength == com.sun.org.apache.xerces.internal.impl.Constants.BUFFER_SIZE_PROPERTY.length() &&
                propertyId.endsWith(com.sun.org.apache.xerces.internal.impl.Constants.BUFFER_SIZE_PROPERTY)) {
            ...
            if (suffixLength == com.sun.org.apache.xerces.internal.impl.Constants.SECURITY_MANAGER_PROPERTY.length() &&
