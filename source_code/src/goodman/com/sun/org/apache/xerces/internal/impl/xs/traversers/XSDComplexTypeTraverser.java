...
import com.sun.org.apache.xerces.internal.impl.xs.traversers.XSDAbstractParticleTraverser;
...
class  XSDComplexTypeTraverser extends XSDAbstractParticleTraverser {
    ...
    XSDComplexTypeTraverser (com.sun.org.apache.xerces.internal.impl.xs.traversers.XSDHandler handler,
    ...
    XSComplexTypeDecl traverseGlobal (Element complexTypeNode,
        ...
        Object[] attrValues = fAttrChecker.checkAttributes(complexTypeNode, true,
                schemaDoc);
        String complexTypeName = (String)  attrValues[com.sun.org.apache.xerces.internal.impl.xs.traversers.XSAttributeChecker.ATTIDX_NAME];
        contentBackup();
        XSComplexTypeDecl type = traverseComplexTypeDecl (complexTypeNode,
                complexTypeName, attrValues, schemaDoc, grammar);
        contentRestore();
    ...
    private XSComplexTypeDecl traverseComplexTypeDecl(Element complexTypeDecl,
        ...
        Boolean mixedAtt     = (Boolean) attrValues[com.sun.org.apache.xerces.internal.impl.xs.traversers.XSAttributeChecker.ATTIDX_MIXED];
    ...
    throws ComplexTypeRecoverableError {
        ...
        Object [] derivationTypeAttrValues = fAttrChecker.checkAttributes(simpleContent, false,
                schemaDoc);
        QName baseTypeName = (QName)  derivationTypeAttrValues[com.sun.org.apache.xerces.internal.impl.xs.traversers.XSAttributeChecker.ATTIDX_BASE];
        ...
        XSTypeDefinition type = (XSTypeDefinition)fSchemaHandler.getGlobalDecl(schemaDoc,
                com.sun.org.apache.xerces.internal.impl.xs.traversers.XSDHandler.TYPEDECL_TYPE, baseTypeName,
                simpleContent);
        if (type==null) {
            fAttrChecker.returnAttrArray(simpleContentAttrValues, schemaDoc);
            fAttrChecker.returnAttrArray(derivationTypeAttrValues, schemaDoc);
    ...
    private void traverseComplexContent(Element complexContentElement,
            boolean mixedOnType, com.sun.org.apache.xerces.internal.impl.xs.traversers.XSDocumentInfo schemaDoc,
            SchemaGrammar grammar)
    throws ComplexTypeRecoverableError {
        ...
        Boolean mixedAtt     = (Boolean) complexContentAttrValues[com.sun.org.apache.xerces.internal.impl.xs.traversers.XSAttributeChecker.ATTIDX_MIXED];
        if (mixedAtt != null) {
