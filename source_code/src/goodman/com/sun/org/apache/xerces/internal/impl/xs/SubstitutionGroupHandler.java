...
public class SubstitutionGroupHandler {
    ...
    private static final com.sun.org.apache.xerces.internal.impl.xs.XSElementDecl[] EMPTY_GROUP = new com.sun.org.apache.xerces.internal.impl.xs.XSElementDecl[0];

    // grammar resolver
    com.sun.org.apache.xerces.internal.impl.xs.XSGrammarBucket fGrammarBucket;
    ...
    public com.sun.org.apache.xerces.internal.impl.xs.XSElementDecl getMatchingElemDecl(QName element, com.sun.org.apache.xerces.internal.impl.xs.XSElementDecl exemplar) {
        ...
        com.sun.org.apache.xerces.internal.impl.xs.SchemaGrammar sGrammar = fGrammarBucket.getGrammar(element.uri);
        if (sGrammar == null)
            return null;

        // get the decl for the element
        com.sun.org.apache.xerces.internal.impl.xs.XSElementDecl eDecl = sGrammar.getGlobalElementDecl(element.localpart);
        if (eDecl == null)
            return null;
    ...
    protected boolean substitutionGroupOK(com.sun.org.apache.xerces.internal.impl.xs.XSElementDecl element, com.sun.org.apache.xerces.internal.impl.xs.XSElementDecl exemplar, short blockingConstraint) {
        ...
        com.sun.org.apache.xerces.internal.impl.xs.XSElementDecl subGroup = element.fSubGroup;
    ...
    private boolean typeDerivationOK(XSTypeDefinition derived, XSTypeDefinition base, short blockingConstraint) {
        ...
        while (type != base && type != com.sun.org.apache.xerces.internal.impl.xs.SchemaGrammar.fAnyType) {
            if (type.getTypeCategory() == XSTypeDefinition.COMPLEX_TYPE) {
                devMethod |= ((com.sun.org.apache.xerces.internal.impl.xs.XSComplexTypeDecl)type).fDerivedBy;
            }
            else {
            ...
            if (type == null) {
                type = com.sun.org.apache.xerces.internal.impl.xs.SchemaGrammar.fAnyType;
            }
            if (type.getTypeCategory() == XSTypeDefinition.COMPLEX_TYPE) {
                blockConstraint |= ((com.sun.org.apache.xerces.internal.impl.xs.XSComplexTypeDecl)type).fBlock;
            }
        }
        if (type != base) {
    ...
    public boolean inSubstitutionGroup(com.sun.org.apache.xerces.internal.impl.xs.XSElementDecl element, com.sun.org.apache.xerces.internal.impl.xs.XSElementDecl exemplar) {
    ...
    Map<com.sun.org.apache.xerces.internal.impl.xs.XSElementDecl, Object> fSubGroupsB = new HashMap<>();
    private static final OneSubGroup[] EMPTY_VECTOR = new OneSubGroup[0];
    // The real substitution groups (after "block")
    Map<com.sun.org.apache.xerces.internal.impl.xs.XSElementDecl, com.sun.org.apache.xerces.internal.impl.xs.XSElementDecl[]> fSubGroups = new HashMap<>();
     ...
     */
    public void addSubstitutionGroup(com.sun.org.apache.xerces.internal.impl.xs.XSElementDecl[] elements) {
        com.sun.org.apache.xerces.internal.impl.xs.XSElementDecl subHead, element;
        Vector subGroup;
     ...
     */
    public com.sun.org.apache.xerces.internal.impl.xs.XSElementDecl[] getSubstitutionGroup(com.sun.org.apache.xerces.internal.impl.xs.XSElementDecl element) {
        // If we already have sub group for this element, just return it.
        com.sun.org.apache.xerces.internal.impl.xs.XSElementDecl[] subGroup = fSubGroups.get(element);
        if (subGroup != null)
            return subGroup;
        ...
        com.sun.org.apache.xerces.internal.impl.xs.XSElementDecl[] ret = new com.sun.org.apache.xerces.internal.impl.xs.XSElementDecl[len];
        ...
        if (rlen < len) {
            com.sun.org.apache.xerces.internal.impl.xs.XSElementDecl[] ret1 = new com.sun.org.apache.xerces.internal.impl.xs.XSElementDecl[rlen];
    ...
    private OneSubGroup[] getSubGroupB(com.sun.org.apache.xerces.internal.impl.xs.XSElementDecl element, OneSubGroup methods) {
        ...
        for (int i = group.size()-1, j; i >= 0; i--) {
            ...
            com.sun.org.apache.xerces.internal.impl.xs.XSElementDecl sub = (com.sun.org.apache.xerces.internal.impl.xs.XSElementDecl)group.elementAt(i);
    ...
    private boolean getDBMethods(XSTypeDefinition typed, XSTypeDefinition typeb,
        ...
        while (typed != typeb && typed != com.sun.org.apache.xerces.internal.impl.xs.SchemaGrammar.fAnyType) {
            if (typed.getTypeCategory() == XSTypeDefinition.COMPLEX_TYPE)
                dMethod |= ((com.sun.org.apache.xerces.internal.impl.xs.XSComplexTypeDecl)typed).fDerivedBy;
            else
    ...
    private static final class OneSubGroup {
        OneSubGroup() {}
        OneSubGroup(com.sun.org.apache.xerces.internal.impl.xs.XSElementDecl sub, short dMethod, short bMethod) {
            this.sub = sub;
