...
public class XSComplexTypeDecl implements XSComplexTypeDefinition, TypeInfo {
    ...
    com.sun.org.apache.xerces.internal.impl.xs.XSParticleDecl fParticle = null;
   ...
   public void setName(String name) {
    ...
    public boolean derivedFromType(XSTypeDefinition ancestor, short derivationMethod) {
        ...
        if (ancestor == com.sun.org.apache.xerces.internal.impl.xs.SchemaGrammar.fAnyType)
            return true;
        // recursively get base, and compare it with ancestor
        XSTypeDefinition type = this;
        while (type != ancestor &&                     // compare with ancestor
               type != com.sun.org.apache.xerces.internal.impl.xs.SchemaGrammar.fAnySimpleType &&  // reached anySimpleType
               type != com.sun.org.apache.xerces.internal.impl.xs.SchemaGrammar.fAnyType) {        // reached anyType
    ...
    public boolean derivedFrom(String ancestorNS, String ancestorName, short derivationMethod) {
        ...
        // ancestor is anyType, return true
        if (ancestorNS != null &&
            ancestorNS.equals(com.sun.org.apache.xerces.internal.impl.xs.SchemaSymbols.URI_SCHEMAFORSCHEMA) &&
            ancestorName.equals(com.sun.org.apache.xerces.internal.impl.xs.SchemaSymbols.ATTVAL_ANYTYPE)) {
            return true;
        }
        ...
        return type != com.sun.org.apache.xerces.internal.impl.xs.SchemaGrammar.fAnySimpleType &&
    ...
    public boolean isDOMDerivedFrom(String ancestorNS, String ancestorName,
        ...
        if ((((derivationMethod & DERIVATION_LIST) != 0) || ((derivationMethod & DERIVATION_UNION) != 0))
            ...
            if (ancestorNS.equals(com.sun.org.apache.xerces.internal.impl.xs.SchemaSymbols.URI_SCHEMAFORSCHEMA)
                    && ancestorName.equals(com.sun.org.apache.xerces.internal.impl.xs.SchemaSymbols.ATTVAL_ANYTYPE)) {
                ancestorName = com.sun.org.apache.xerces.internal.impl.xs.SchemaSymbols.ATTVAL_ANYSIMPLETYPE;
            }

            if(!(fName.equals(com.sun.org.apache.xerces.internal.impl.xs.SchemaSymbols.ATTVAL_ANYTYPE)
                            && fTargetNamespace.equals(com.sun.org.apache.xerces.internal.impl.xs.SchemaSymbols.URI_SCHEMAFORSCHEMA))){
    ...
    private boolean isDerivedByRestriction(String ancestorNS,
        ...
        while (type != null && type != oldType) {
            ...
            if (ancestorNS != null
                    && ancestorNS.equals(com.sun.org.apache.xerces.internal.impl.xs.SchemaSymbols.URI_SCHEMAFORSCHEMA)
                    && ancestorName.equals(com.sun.org.apache.xerces.internal.impl.xs.SchemaSymbols.ATTVAL_ANYSIMPLETYPE)) {
                return false;
            }
    ...
    private boolean isDerivedByExtension(String ancestorNS,
        ...
        while (type != null && type != oldType) {
            ...
            if (ancestorNS != null
                    && ancestorNS.equals(com.sun.org.apache.xerces.internal.impl.xs.SchemaSymbols.URI_SCHEMAFORSCHEMA)
                    && ancestorName.equals(com.sun.org.apache.xerces.internal.impl.xs.SchemaSymbols.ATTVAL_ANYSIMPLETYPE)
                    && com.sun.org.apache.xerces.internal.impl.xs.SchemaSymbols.URI_SCHEMAFORSCHEMA.equals(type.getNamespace())
                            && com.sun.org.apache.xerces.internal.impl.xs.SchemaSymbols.ATTVAL_ANYTYPE.equals(type.getName())) {
                break;
            }
