...
public class NamedNodeMapImpl
    ...
    protected com.sun.org.apache.xerces.internal.dom.NodeImpl ownerNode; // the node this map belongs to
    ...
    protected NamedNodeMapImpl(com.sun.org.apache.xerces.internal.dom.NodeImpl ownerNode) {
    ...
    throws DOMException {
        ...
        com.sun.org.apache.xerces.internal.dom.CoreDocumentImpl ownerDocument = ownerNode.ownerDocument();
        ...
        com.sun.org.apache.xerces.internal.dom.NodeImpl previous = null;
        if (i >= 0) {
            previous = (com.sun.org.apache.xerces.internal.dom.NodeImpl) nodes.get(i);
            nodes.set(i, arg);
        } else {
    ...
    public Node removeNamedItem(String name)
        ...
        com.sun.org.apache.xerces.internal.dom.NodeImpl n = (com.sun.org.apache.xerces.internal.dom.NodeImpl)nodes.get(i);
        nodes.remove(i);
        ...
        if (srcnodes != null) {
            ...
            if (size != 0) {
                ...
                for (int i = 0; i < size; ++i) {
                    com.sun.org.apache.xerces.internal.dom.NodeImpl n = (com.sun.org.apache.xerces.internal.dom.NodeImpl) srcmap.nodes.get(i);
    ...
    void setReadOnly(boolean readOnly, boolean deep) {
        ...
        if (deep && nodes != null) {
            for (int i = nodes.size() - 1; i >= 0; i--) {
                ((com.sun.org.apache.xerces.internal.dom.NodeImpl) nodes.get(i)).setReadOnly(readOnly,deep);
            }
        }
    ...
    protected void setOwnerDocument(CoreDocumentImpl doc) {
        if (nodes != null) {
            ...
            for (int i = 0; i < size; ++i) {
                ((com.sun.org.apache.xerces.internal.dom.NodeImpl)item(i)).setOwnerDocument(doc);
            }
        }
    }
    ...
    protected int findNamePoint(String namespaceURI, String name) {
        ...
        final int size = nodes.size();
        for (int i = 0; i < size; ++i) {
            com.sun.org.apache.xerces.internal.dom.NodeImpl a = (NodeImpl)nodes.get(i);
