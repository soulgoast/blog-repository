...
public class DOMImplementationSourceImpl
    ...
    public DOMImplementation getDOMImplementation(String features) {
        ...
        DOMImplementation impl =
            com.sun.org.apache.xerces.internal.dom.CoreDOMImplementationImpl.getDOMImplementation();
        if (testImpl(impl, features)) {
            return impl;
        }
        // if not try the DOMImplementation
        impl = com.sun.org.apache.xerces.internal.dom.DOMImplementationImpl.getDOMImplementation();
        if (testImpl(impl, features)) {
            return impl;
        }
