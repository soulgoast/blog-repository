...
import goodman.javax.xml.validation.SchemaFactory;

import com.sun.org.apache.xerces.internal.jaxp.validation.*;
import com.sun.org.apache.xerces.internal.jaxp.validation.EmptyXMLSchema;
import com.sun.org.apache.xerces.internal.jaxp.validation.SimpleXMLSchema;
import com.sun.org.apache.xerces.internal.jaxp.validation.Util;
import com.sun.org.apache.xerces.internal.jaxp.validation.XMLSchema;
...
public final class XMLSchemaFactory extends SchemaFactory {
    ...
    public Schema newSchema( Source[] schemas ) throws SAXException {
        ...
        if (grammarCount > 1) {
            schema = new com.sun.org.apache.xerces.internal.jaxp.validation.XMLSchema(new ReadOnlyGrammarPool(pool));
        }
        else if (grammarCount == 1) {
            Grammar[] grammars = pool.retrieveInitialGrammarSet(XMLGrammarDescription.XML_SCHEMA);
            schema = new com.sun.org.apache.xerces.internal.jaxp.validation.SimpleXMLSchema(grammars[0]);
        }
        else {
            schema = new com.sun.org.apache.xerces.internal.jaxp.validation.EmptyXMLSchema();
        }
