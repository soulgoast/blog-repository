...
public class SchemaGrammar implements XSGrammar, XSNamespaceItem {
    ...
    public SchemaGrammar(SchemaGrammar grammar) {
        ...
        if (fRGCount > 0) {
            fRedefinedGroupDecls = new com.sun.org.apache.xerces.internal.impl.xs.XSGroupDecl[grammar.fRedefinedGroupDecls.length];
    ...
    public static class BuiltinSchemaGrammar extends SchemaGrammar {
        ...
        public BuiltinSchemaGrammar(int grammar, short schemaVersion) {
            ...
            if (grammar == GRAMMAR_XS) {
                ...
                fGlobalAttrDecls.put(name, new com.sun.org.apache.xerces.internal.impl.xs.SchemaGrammar.BuiltinAttrDecl(name, tns, type, scope));
        ...
        public void addGlobalGroupDecl(com.sun.org.apache.xerces.internal.impl.xs.XSGroupDecl decl) {
            // ignore
        }
        public void addGlobalGroupDecl(com.sun.org.apache.xerces.internal.impl.xs.XSGroupDecl decl, String location) {
            // ignore
        }
        ...
        public void addRedefinedGroupDecl(com.sun.org.apache.xerces.internal.impl.xs.XSGroupDecl derived, com.sun.org.apache.xerces.internal.impl.xs.XSGroupDecl base, SimpleLocator locator) {
            // ignore
        }
    ...
    public static final class Schema4Annotations extends SchemaGrammar {
         ...
         * Singleton instance.
         */
        public static final com.sun.org.apache.xerces.internal.impl.xs.SchemaGrammar.Schema4Annotations INSTANCE = new com.sun.org.apache.xerces.internal.impl.xs.SchemaGrammar.Schema4Annotations();
     ...
     */
    public final com.sun.org.apache.xerces.internal.impl.xs.XSGroupDecl getGlobalGroupDecl(String declName) {
        return(com.sun.org.apache.xerces.internal.impl.xs.XSGroupDecl)fGlobalGroupDecls.get(declName);
    }

    public final com.sun.org.apache.xerces.internal.impl.xs.XSGroupDecl getGlobalGroupDecl(String declName, String location) {
        return(com.sun.org.apache.xerces.internal.impl.xs.XSGroupDecl)fGlobalGroupDeclsExt.get(((location != null) ? location : "") + "," + declName);
    }
    ...
    private com.sun.org.apache.xerces.internal.impl.xs.XSGroupDecl[] fRedefinedGroupDecls = new com.sun.org.apache.xerces.internal.impl.xs.XSGroupDecl[REDEFINED_GROUP_INIT_SIZE];
    ...
    static final com.sun.org.apache.xerces.internal.impl.xs.XSGroupDecl[] resize(com.sun.org.apache.xerces.internal.impl.xs.XSGroupDecl[] oldArray, int newSize) {
        com.sun.org.apache.xerces.internal.impl.xs.XSGroupDecl[] newArray = new XSGroupDecl[newSize];
        System.arraycopy(oldArray, 0, newArray, 0, Math.min(oldArray.length, newSize));
        return newArray;
    }
    ...
    public XSModel toXSModel() {
        return new com.sun.org.apache.xerces.internal.impl.xs.XSModelImpl(new SchemaGrammar[]{this});
    }
