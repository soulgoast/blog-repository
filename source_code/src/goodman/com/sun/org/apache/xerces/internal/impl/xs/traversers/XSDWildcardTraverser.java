...
class XSDWildcardTraverser extends com.sun.org.apache.xerces.internal.impl.xs.traversers.XSDAbstractTraverser {
    ...
    XSParticleDecl traverseAny(Element elmNode,
        ...
        if (wildcard != null) {
            int min = ((XInt)attrValues[com.sun.org.apache.xerces.internal.impl.xs.traversers.XSAttributeChecker.ATTIDX_MINOCCURS]).intValue();
            int max = ((XInt)attrValues[com.sun.org.apache.xerces.internal.impl.xs.traversers.XSAttributeChecker.ATTIDX_MAXOCCURS]).intValue();
            if (max != 0) {
    ...
    XSWildcardDecl traverseWildcardDecl(Element elmNode,
        ...
        // namespace type
        XInt namespaceTypeAttr = (XInt) attrValues[com.sun.org.apache.xerces.internal.impl.xs.traversers.XSAttributeChecker.ATTIDX_NAMESPACE];
        wildcard.fType = namespaceTypeAttr.shortValue();
        // namespace list
        wildcard.fNamespaceList = (String[])attrValues[com.sun.org.apache.xerces.internal.impl.xs.traversers.XSAttributeChecker.ATTIDX_NAMESPACE_LIST];
        // process contents
