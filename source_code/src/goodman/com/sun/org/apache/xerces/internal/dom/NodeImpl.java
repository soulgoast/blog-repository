...
public abstract class NodeImpl
    ...
    public short compareTreePosition(Node other) {
        ...
        if (thisAncestorType == Node.ATTRIBUTE_NODE)  {
           thisNode = ((com.sun.org.apache.xerces.internal.dom.AttrImpl)thisAncestor).getOwnerElement();
        }
        if (otherAncestorType == Node.ATTRIBUTE_NODE) {
           otherNode = ((com.sun.org.apache.xerces.internal.dom.AttrImpl)otherAncestor).getOwnerElement();
        }
