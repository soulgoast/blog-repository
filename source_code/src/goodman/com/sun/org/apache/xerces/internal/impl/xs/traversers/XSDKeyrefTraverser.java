...
class XSDKeyrefTraverser extends XSDAbstractIDConstraintTraverser {
    ...
    public XSDKeyrefTraverser (com.sun.org.apache.xerces.internal.impl.xs.traversers.XSDHandler handler,
    ...
    void traverse(Element krElem, XSElementDecl element,
        ...
        String krName = (String)attrValues[com.sun.org.apache.xerces.internal.impl.xs.traversers.XSAttributeChecker.ATTIDX_NAME];
        if(krName == null){
