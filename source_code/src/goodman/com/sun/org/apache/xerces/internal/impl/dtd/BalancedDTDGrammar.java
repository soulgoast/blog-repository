...
final class BalancedDTDGrammar extends DTDGrammar {
    ...
    public final void separator(short separator, Augmentations augs) throws XNIException {
        if (separator == XMLDTDContentModelHandler.SEPARATOR_CHOICE) {
            fOpStack[fDepth] = com.sun.org.apache.xerces.internal.impl.dtd.XMLContentSpec.CONTENTSPECNODE_CHOICE;
        }
        else if (separator == XMLDTDContentModelHandler.SEPARATOR_SEQUENCE) {
            fOpStack[fDepth] = com.sun.org.apache.xerces.internal.impl.dtd.XMLContentSpec.CONTENTSPECNODE_SEQ;
        }
    } // separator(short)
    ...
    public final void occurrence(short occurrence, Augmentations augs) throws XNIException {
        if (!fMixed) {
            ...
            if (occurrence == XMLDTDContentModelHandler.OCCURS_ZERO_OR_ONE) {
                fGroupIndexStack[fDepth][currentIndex] = addContentSpecNode(com.sun.org.apache.xerces.internal.impl.dtd.XMLContentSpec.CONTENTSPECNODE_ZERO_OR_ONE, fGroupIndexStack[fDepth][currentIndex], -1);
            }
            else if ( occurrence == XMLDTDContentModelHandler.OCCURS_ZERO_OR_MORE) {
                fGroupIndexStack[fDepth][currentIndex] = addContentSpecNode(com.sun.org.apache.xerces.internal.impl.dtd.XMLContentSpec.CONTENTSPECNODE_ZERO_OR_MORE, fGroupIndexStack[fDepth][currentIndex], -1);
            }
