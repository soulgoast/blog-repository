...
public class AttributeMap extends NamedNodeMapImpl {
    ...
    protected AttributeMap(com.sun.org.apache.xerces.internal.dom.ElementImpl ownerNode, NamedNodeMapImpl defaults) {
        super(ownerNode);
        if (defaults != null) {
    ...
    throws DOMException {
        ...
        com.sun.org.apache.xerces.internal.dom.AttrImpl argn = (com.sun.org.apache.xerces.internal.dom.AttrImpl)arg;
        ...
        com.sun.org.apache.xerces.internal.dom.AttrImpl previous = null;
        if (i >= 0) {
            previous = (com.sun.org.apache.xerces.internal.dom.AttrImpl) nodes.get(i);
            nodes.set(i, arg);
    ...
    protected Node removeItem(Node item, boolean addDefault)
        ...
        return remove((com.sun.org.apache.xerces.internal.dom.AttrImpl)item, index, addDefault);
    }
    ...
    final protected Node internalRemoveNamedItem(String name, boolean raiseEx){
        ...
        return remove((com.sun.org.apache.xerces.internal.dom.AttrImpl)nodes.get(i), i, true);

    } // internalRemoveNamedItem(String,boolean):Node

    private final Node remove(com.sun.org.apache.xerces.internal.dom.AttrImpl attr, int index,
                              boolean addDefault) {
        ...
        if (hasDefaults() && addDefault) {
            ...
            NamedNodeMapImpl defaults =
                ((com.sun.org.apache.xerces.internal.dom.ElementImpl) ownerNode).getDefaultAttributes();

            Node d;
            if (defaults != null &&
                (d = defaults.getNamedItem(name)) != null &&
                findNamePoint(name, index+1) < 0) {
                    com.sun.org.apache.xerces.internal.dom.NodeImpl clone = (com.sun.org.apache.xerces.internal.dom.NodeImpl)d.cloneNode(true);
                    if (d.getLocalName() !=null){
                            ...
                            ((com.sun.org.apache.xerces.internal.dom.AttrNSImpl)clone).namespaceURI = attr.getNamespaceURI();
                    }
                    ...
                    if (attr.isIdAttribute()) {
                        ownerDocument.putIdentifier(clone.getNodeValue(),
                                                (com.sun.org.apache.xerces.internal.dom.ElementImpl)ownerNode);
                    }
            } else {
                nodes.remove(index);
            }
    ...
    final protected Node internalRemoveNamedItemNS(String namespaceURI,
        ...
        com.sun.org.apache.xerces.internal.dom.AttrImpl n = (com.sun.org.apache.xerces.internal.dom.AttrImpl)nodes.get(i);
        ...
        if (hasDefaults()) {
            NamedNodeMapImpl defaults = ((com.sun.org.apache.xerces.internal.dom.ElementImpl) ownerNode).getDefaultAttributes();
            Node d;
            if (defaults != null
    ...
    public NamedNodeMapImpl cloneMap(com.sun.org.apache.xerces.internal.dom.NodeImpl ownerNode) {
        AttributeMap newmap =
    ...
    protected void cloneContent(NamedNodeMapImpl srcmap) {
        ...
        if (srcnodes != null) {
            ...
            if (size != 0) {
                ...
                for (int i = 0; i < size; ++i) {
                    com.sun.org.apache.xerces.internal.dom.NodeImpl n = (com.sun.org.apache.xerces.internal.dom.NodeImpl) srcnodes.get(i);
                    com.sun.org.apache.xerces.internal.dom.NodeImpl clone = (com.sun.org.apache.xerces.internal.dom.NodeImpl) n.cloneNode(true);
    ...
    void moveSpecifiedAttributes(AttributeMap srcmap) {
        ...
        for (int i = nsize - 1; i >= 0; i--) {
            com.sun.org.apache.xerces.internal.dom.AttrImpl attr = (com.sun.org.apache.xerces.internal.dom.AttrImpl) srcmap.nodes.get(i);
            if (attr.isSpecified()) {
    ...
    protected void reconcileDefaults(NamedNodeMapImpl defaults) {
        ...
        for (int i = nsize - 1; i >= 0; --i) {
            com.sun.org.apache.xerces.internal.dom.AttrImpl attr = (com.sun.org.apache.xerces.internal.dom.AttrImpl) nodes.get(i);
            if (!attr.isSpecified()) {
                remove(attr, i, false);
            }
        }
        ...
        if (nodes == null || nodes.size() == 0) {
            ...
            for (int n = 0; n < dsize; ++n) {
                com.sun.org.apache.xerces.internal.dom.AttrImpl d = (com.sun.org.apache.xerces.internal.dom.AttrImpl) defaults.nodes.get(n);
                int i = findNamePoint(d.getNodeName(), 0);
                if (i < 0) {
                        i = -1 - i;
                    com.sun.org.apache.xerces.internal.dom.NodeImpl clone = (NodeImpl) d.cloneNode(true);
                    clone.ownerNode = ownerNode;
                    clone.isOwned(true);
                    clone.isSpecified(false);
                        nodes.add(i, clone);
    ...
    protected final int addItem (Node arg) {
        ...
        final com.sun.org.apache.xerces.internal.dom.AttrImpl argn = (AttrImpl) arg;
