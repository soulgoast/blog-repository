...
implements XMLDTDScanner, XMLComponent, XMLEntityHandler {
    ...
    public XMLDTDScannerImpl(SymbolTable symbolTable,
            XMLErrorReporter errorReporter, com.sun.org.apache.xerces.internal.impl.XMLEntityManager entityManager) {
    ...
    private final void scanEntityDecl() throws IOException, XNIException {
        ...
        if (systemId != null) {
            ...
            if (fDTDHandler != null) {
                ...
                fResourceIdentifier.setValues(publicId, systemId, baseSystemId, com.sun.org.apache.xerces.internal.impl.XMLEntityManager.expandSystemId(systemId, baseSystemId ));
