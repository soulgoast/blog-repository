...
package goodman.com.sun.org.apache.xerces.internal.impl.xs.traversers;
...
abstract class XSDAbstractTraverser {
    ...
    //Shared data
    protected com.sun.org.apache.xerces.internal.impl.xs.traversers.XSDHandler fSchemaHandler = null;
    protected SymbolTable           fSymbolTable = null;
    protected com.sun.org.apache.xerces.internal.impl.xs.traversers.XSAttributeChecker fAttrChecker = null;
    ...
    XSDAbstractTraverser (com.sun.org.apache.xerces.internal.impl.xs.traversers.XSDHandler handler,
                          com.sun.org.apache.xerces.internal.impl.xs.traversers.XSAttributeChecker attrChecker) {
    ...
    XSAnnotationImpl traverseAnnotationDecl(Element annotationDecl, Object[] parentAttrs,
        ...
        Vector annotationLocalAttrs = (Vector)parentAttrs[com.sun.org.apache.xerces.internal.impl.xs.traversers.XSAttributeChecker.ATTIDX_NONSCHEMA];
    ...
    FacetInfo traverseFacets(Element content,
        ...
        while (content != null) {
            ...
            if (facet.equals(SchemaSymbols.ELT_ENUMERATION)) {
                ...
                String enumVal = (String)attrs[com.sun.org.apache.xerces.internal.impl.xs.traversers.XSAttributeChecker.ATTIDX_VALUE];
                ...
                NamespaceSupport nsDecls = (NamespaceSupport)attrs[com.sun.org.apache.xerces.internal.impl.xs.traversers.XSAttributeChecker.ATTIDX_ENUMNSDECLS];
                ...
                String patternVal = (String)attrs[com.sun.org.apache.xerces.internal.impl.xs.traversers.XSAttributeChecker.ATTIDX_VALUE];
                // The facet can't be used if the value is missing. Ignore
                // this facet element.
                if (patternVal == null) {
                ...
                // The facet can't be used if the value is missing. Ignore
                // this facet element.
                if (attrs[com.sun.org.apache.xerces.internal.impl.xs.traversers.XSAttributeChecker.ATTIDX_VALUE] == null) {
                ...
                if (((Boolean)attrs[com.sun.org.apache.xerces.internal.impl.xs.traversers.XSAttributeChecker.ATTIDX_FIXED]).booleanValue()) {
                    facetsFixed |= currentFacet;
                }
                switch (currentFacet) {
                case XSSimpleType.FACET_MINLENGTH:
                    xsFacets.minLength = ((XInt)attrs[com.sun.org.apache.xerces.internal.impl.xs.traversers.XSAttributeChecker.ATTIDX_VALUE]).intValue();
                    break;
                case XSSimpleType.FACET_MAXLENGTH:
                    xsFacets.maxLength = ((XInt)attrs[com.sun.org.apache.xerces.internal.impl.xs.traversers.XSAttributeChecker.ATTIDX_VALUE]).intValue();
                    break;
                case XSSimpleType.FACET_MAXEXCLUSIVE:
                    xsFacets.maxExclusive = (String)attrs[com.sun.org.apache.xerces.internal.impl.xs.traversers.XSAttributeChecker.ATTIDX_VALUE];
                    break;
                case XSSimpleType.FACET_MAXINCLUSIVE:
                    xsFacets.maxInclusive = (String)attrs[com.sun.org.apache.xerces.internal.impl.xs.traversers.XSAttributeChecker.ATTIDX_VALUE];
                    break;
                case XSSimpleType.FACET_MINEXCLUSIVE:
                    xsFacets.minExclusive = (String)attrs[com.sun.org.apache.xerces.internal.impl.xs.traversers.XSAttributeChecker.ATTIDX_VALUE];
                    break;
                case XSSimpleType.FACET_MININCLUSIVE:
                    xsFacets.minInclusive = (String)attrs[com.sun.org.apache.xerces.internal.impl.xs.traversers.XSAttributeChecker.ATTIDX_VALUE];
                    break;
                case XSSimpleType.FACET_TOTALDIGITS:
                    xsFacets.totalDigits = ((XInt)attrs[com.sun.org.apache.xerces.internal.impl.xs.traversers.XSAttributeChecker.ATTIDX_VALUE]).intValue();
                    break;
                case XSSimpleType.FACET_FRACTIONDIGITS:
                    xsFacets.fractionDigits = ((XInt)attrs[com.sun.org.apache.xerces.internal.impl.xs.traversers.XSAttributeChecker.ATTIDX_VALUE]).intValue();
                    break;
                case XSSimpleType.FACET_WHITESPACE:
                    xsFacets.whiteSpace = ((XInt)attrs[com.sun.org.apache.xerces.internal.impl.xs.traversers.XSAttributeChecker.ATTIDX_VALUE]).shortValue();
                    break;
                case XSSimpleType.FACET_LENGTH:
                    xsFacets.length = ((XInt)attrs[com.sun.org.apache.xerces.internal.impl.xs.traversers.XSAttributeChecker.ATTIDX_VALUE]).intValue();
                    break;
                }
    ...
    protected XSParticleDecl checkOccurrences(XSParticleDecl particle,
        ...
        boolean defaultMin = (defaultVals & (1 << com.sun.org.apache.xerces.internal.impl.xs.traversers.XSAttributeChecker.ATTIDX_MINOCCURS)) != 0;
