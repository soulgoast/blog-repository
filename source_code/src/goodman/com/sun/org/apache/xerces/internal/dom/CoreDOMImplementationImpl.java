...
public class CoreDOMImplementationImpl
    ...
    final void checkQName(String qname){
        ...
        if (index == 0 || index == length - 1 || lastIndex != index) {
            String msg =
                com.sun.org.apache.xerces.internal.dom.DOMMessageFormatter.formatMessage(
                    com.sun.org.apache.xerces.internal.dom.DOMMessageFormatter.DOM_DOMAIN,
                    "NAMESPACE_ERR",
                    null);
        ...
        public Document createDocument(
                ...
                com.sun.org.apache.xerces.internal.dom.CoreDocumentImpl doc = new CoreDocumentImpl(doctype);
