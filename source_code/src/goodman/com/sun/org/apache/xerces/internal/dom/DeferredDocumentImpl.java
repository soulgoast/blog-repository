...
public class DeferredDocumentImpl
    ...
    public int createDeferredElement(String elementURI, String elementName) {
        ...
        public int setDeferredAttribute(int elementNodeIndex,
                ...
                if (type != null) {
                        int extraDataIndex = createNode(com.sun.org.apache.xerces.internal.dom.DeferredNode.TYPE_NODE);
                        int echunk = extraDataIndex >> CHUNK_SHIFT;
                        int eindex = extraDataIndex & CHUNK_MASK;
    ...
    public int createDeferredAttribute(String attrName, String attrURI,
        ...
        // create node
        int nodeIndex = createNode(com.sun.org.apache.xerces.internal.dom.NodeImpl.ATTRIBUTE_NODE);
        int chunk = nodeIndex >> CHUNK_SHIFT;
        int index = nodeIndex & CHUNK_MASK;
    ...
    public int createDeferredElementDefinition(String elementName) {
        ...
        // create node
        int nodeIndex = createNode(com.sun.org.apache.xerces.internal.dom.NodeImpl.ELEMENT_DEFINITION_NODE);
        int chunk = nodeIndex >> CHUNK_SHIFT;
        int index = nodeIndex & CHUNK_MASK;
        ...
        if (fNodeCount > 1) {
            ...
            for (int index = getChunkIndex(fNodeLastChild, nchunk, nindex);
                ...
                if (getChunkIndex(fNodeType, nchunk, nindex) ==
                                           com.sun.org.apache.xerces.internal.dom.NodeImpl.ELEMENT_DEFINITION_NODE
    ...
    public com.sun.org.apache.xerces.internal.dom.DeferredNode getNodeObject(int nodeIndex) {
        ...
        // create new node
        com.sun.org.apache.xerces.internal.dom.DeferredNode node = null;
        switch (type) {
            ...
            case Node.DOCUMENT_TYPE_NODE: {
                ...
                docType = (com.sun.org.apache.xerces.internal.dom.DocumentTypeImpl)node;
                break;
            }
            ...
            for (int i = 0; i < fNodeType.length; i++) {
                if (fNodeType[i] != null) {
                    ...
                    switch (fNodeType[i][CHUNK_SIZE]) {
                        case com.sun.org.apache.xerces.internal.dom.DocumentImpl.ELEMENT_DEFINITION_NODE: { System.out.print("EDef"); break; }
                        ...
                        case com.sun.org.apache.xerces.internal.dom.DeferredNode.TYPE_NODE: { System.out.print("TypeInfo"); break; }
        ...
        if (fIdElement != null) {
            ...
            for (int i = 0; i < fIdCount; i++) {
                ...
                for (int j = path.size() - 2; j >= 0; j--) {
                    ...
                    while (child != null) {
                        if (child instanceof com.sun.org.apache.xerces.internal.dom.DeferredNode) {
                            int nodeIndex =
    ...
    protected void synchronizeChildren() {
        ...
        com.sun.org.apache.xerces.internal.dom.ChildNode first = null;
        com.sun.org.apache.xerces.internal.dom.ChildNode last = null;
        for (int index = getLastChild(0);
             index != -1;
             index = getPrevSibling(index)) {

            com.sun.org.apache.xerces.internal.dom.ChildNode node = (com.sun.org.apache.xerces.internal.dom.ChildNode)getNodeObject(index);
            if (last == null) {
                last = node;
            }
            else {
    ...
    protected final void synchronizeChildren(AttrImpl a, int nodeIndex) {
        ...
        if (prev == -1) {
            ...
            com.sun.org.apache.xerces.internal.dom.ChildNode firstNode = null;
            com.sun.org.apache.xerces.internal.dom.ChildNode lastNode = null;
    ...
    protected final void synchronizeChildren(ParentNode p, int nodeIndex) {
        ...
        for (int index = getLastChild(nodeIndex);
            ...
            com.sun.org.apache.xerces.internal.dom.ChildNode node = (ChildNode) getNodeObject(index);
            if (lastNode == null) {
                lastNode = node;
            }
            else {
