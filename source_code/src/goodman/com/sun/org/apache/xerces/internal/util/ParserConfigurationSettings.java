...
public class ParserConfigurationSettings
    ...
    public void setFeature(String featureId, boolean state)
        ...
        // check and store
        com.sun.org.apache.xerces.internal.util.FeatureState checkState = checkFeature(featureId);
    ...
    public void setProperty(String propertyId, Object value)
        ...
        // check and store
        com.sun.org.apache.xerces.internal.util.PropertyState checkState = checkProperty(propertyId);
        if (checkState.isExceptional()) {
    ...
    public final boolean getFeature(String featureId)
        ...
        com.sun.org.apache.xerces.internal.util.FeatureState state = getFeatureState(featureId);
    ...
    public com.sun.org.apache.xerces.internal.util.FeatureState getFeatureState(String featureId) {
        ...
        if (state == null) {
            ...
            return com.sun.org.apache.xerces.internal.util.FeatureState.is(false);
        }
        return com.sun.org.apache.xerces.internal.util.FeatureState.is(state);
    }
    ...
    public final Object getProperty(String propertyId)
        ...
        com.sun.org.apache.xerces.internal.util.PropertyState state = getPropertyState(propertyId);
        if (state.isExceptional()) {
    ...
    public com.sun.org.apache.xerces.internal.util.PropertyState getPropertyState(String propertyId) {
        Object propertyValue = fProperties.get(propertyId);

        if (propertyValue == null) {
            com.sun.org.apache.xerces.internal.util.PropertyState state = checkProperty(propertyId);
            if (state.isExceptional()) {
                return state;
            }
        }

        return com.sun.org.apache.xerces.internal.util.PropertyState.is(propertyValue);
    }
     ...
     *            requested feature is not known.
     */
    protected com.sun.org.apache.xerces.internal.util.FeatureState checkFeature(String featureId)
        throws XMLConfigurationException {
        ...
        if (!fRecognizedFeatures.contains(featureId)) {
            if (fParentSettings != null) {
                ...
                return com.sun.org.apache.xerces.internal.util.FeatureState.NOT_RECOGNIZED;
            }
        }
     ...
     *            requested feature is not known.
     */
    protected com.sun.org.apache.xerces.internal.util.PropertyState checkProperty(String propertyId)
        throws XMLConfigurationException {

        // check property
        if (!fRecognizedProperties.contains(propertyId)) {
            if (fParentSettings != null) {
                com.sun.org.apache.xerces.internal.util.PropertyState state = fParentSettings.getPropertyState(propertyId);
                if (state.isExceptional()) {
                    return state;
                }
            }
            else {
                return com.sun.org.apache.xerces.internal.util.PropertyState.NOT_RECOGNIZED;
            }
        }
