...
public class DocumentBuilderFactoryImpl extends DocumentBuilderFactory {
        ...
        throws ParserConfigurationException
    {
        ...
        if (grammar != null && attributes != null) {
            if (attributes.containsKey(com.sun.org.apache.xerces.internal.jaxp.JAXPConstants.JAXP_SCHEMA_LANGUAGE)) {
                throw new ParserConfigurationException(
                        SAXMessageFormatter.formatMessage(null,
                        "schema-already-specified", new Object[] {com.sun.org.apache.xerces.internal.jaxp.JAXPConstants.JAXP_SCHEMA_LANGUAGE}));
            }
            else if (attributes.containsKey(com.sun.org.apache.xerces.internal.jaxp.JAXPConstants.JAXP_SCHEMA_SOURCE)) {
                throw new ParserConfigurationException(
                        SAXMessageFormatter.formatMessage(null,
        ...
        try {
            return new com.sun.org.apache.xerces.internal.jaxp.DocumentBuilderImpl(this, attributes, features, fSecureProcess);
        ...
        throws IllegalArgumentException
    {
        ...
        try {
            new com.sun.org.apache.xerces.internal.jaxp.DocumentBuilderImpl(this, attributes, features);
        } catch (Exception e) {
            attributes.remove(name);
        ...
        throws IllegalArgumentException
    {
        ...
        try {
            ...
            domParser =
                new com.sun.org.apache.xerces.internal.jaxp.DocumentBuilderImpl(this, attributes, features).getDOMParser();
    ...
    public boolean getFeature(String name)
        ...
        try {
            DOMParser domParser = new com.sun.org.apache.xerces.internal.jaxp.DocumentBuilderImpl(this, attributes, features).getDOMParser();
