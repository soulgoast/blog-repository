...
public class XMLVersionDetector {
    ...
    public void reset(XMLComponentManager componentManager)
        ...
        fEntityManager = (com.sun.org.apache.xerces.internal.impl.XMLEntityManager)componentManager.getProperty(ENTITY_MANAGER);
    ...
    public void startDocumentParsing(XMLEntityHandler scanner, short version){
        ...
        if (version == com.sun.org.apache.xerces.internal.impl.Constants.XML_VERSION_1_0){
            fEntityManager.setScannerVersion(com.sun.org.apache.xerces.internal.impl.Constants.XML_VERSION_1_0);
        }
        else {
            fEntityManager.setScannerVersion(com.sun.org.apache.xerces.internal.impl.Constants.XML_VERSION_1_1);
        }
    ...
    public short determineDocVersion(XMLInputSource inputSource) throws IOException {
        ...
        try {
            if (!scanner.skipString("<?xml")) {
                ...
                return com.sun.org.apache.xerces.internal.impl.Constants.XML_VERSION_1_0;
            }
            ...
            if (matched == XML11_VERSION.length)
                return com.sun.org.apache.xerces.internal.impl.Constants.XML_VERSION_1_1;
            return com.sun.org.apache.xerces.internal.impl.Constants.XML_VERSION_1_0;
