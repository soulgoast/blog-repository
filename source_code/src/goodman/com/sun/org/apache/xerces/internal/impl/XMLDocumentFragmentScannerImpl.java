...
import goodman.java.io.EOFException;
import goodman.java.io.IOException;
import goodman.javax.xml.stream.XMLInputFactory;
import goodman.javax.xml.stream.XMLStreamConstants;
...
public class XMLDocumentFragmentScannerImpl
    ...
    protected static final String NOTIFY_BUILTIN_REFS =
            com.sun.org.apache.xerces.internal.impl.Constants.XERCES_FEATURE_PREFIX + com.sun.org.apache.xerces.internal.impl.Constants.NOTIFY_BUILTIN_REFS_FEATURE;
     ...
     */
    final static String EXTERNAL_ACCESS_DEFAULT = com.sun.org.apache.xerces.internal.impl.Constants.EXTERNAL_ACCESS_DEFAULT;
    ...
    private static final String[] RECOGNIZED_FEATURES = {
                ...
                NOTIFY_BUILTIN_REFS,
                NOTIFY_CHAR_REFS,
                com.sun.org.apache.xerces.internal.impl.Constants.STAX_REPORT_CDATA_EVENT
    };
    ...
    throws XMLConfigurationException {
        ...
        // xerces features
        fReportCdataEvent = componentManager.getFeature(com.sun.org.apache.xerces.internal.impl.Constants.STAX_REPORT_CDATA_EVENT, true);
        fSecurityManager = (XMLSecurityManager)componentManager.getProperty(com.sun.org.apache.xerces.internal.impl.Constants.SECURITY_MANAGER, null);
        ...
        fExternalSubsetResolver = (resolver instanceof com.sun.org.apache.xerces.internal.impl.ExternalSubsetResolver) ?
                (com.sun.org.apache.xerces.internal.impl.ExternalSubsetResolver) resolver : null;
    ...
    public void reset(PropertyManager propertyManager){
        ...
        Boolean cdata = (Boolean)propertyManager.getProperty(com.sun.org.apache.xerces.internal.impl.Constants.ZEPHYR_PROPERTY_PREFIX + com.sun.org.apache.xerces.internal.impl.Constants.STAX_REPORT_CDATA_EVENT) ;
        if(cdata != null)
        ...
        fSecurityManager = (XMLSecurityManager)propertyManager.getProperty(com.sun.org.apache.xerces.internal.impl.Constants.SECURITY_MANAGER);
        resetCommon();
    } // reset(XMLComponentManager)
    ...
    throws XMLConfigurationException {
        ...
        if (featureId.startsWith(com.sun.org.apache.xerces.internal.impl.Constants.XERCES_FEATURE_PREFIX)) {
            String feature = featureId.substring(com.sun.org.apache.xerces.internal.impl.Constants.XERCES_FEATURE_PREFIX.length());
            if (feature.equals(com.sun.org.apache.xerces.internal.impl.Constants.NOTIFY_BUILTIN_REFS_FEATURE)) {
    ...
    throws XMLConfigurationException {
        ...
        if (propertyId.startsWith(com.sun.org.apache.xerces.internal.impl.Constants.XERCES_PROPERTY_PREFIX)) {
            ...
            if (suffixLength == com.sun.org.apache.xerces.internal.impl.Constants.ENTITY_MANAGER_PROPERTY.length() &&
                    propertyId.endsWith(com.sun.org.apache.xerces.internal.impl.Constants.ENTITY_MANAGER_PROPERTY)) {
                fEntityManager = (com.sun.org.apache.xerces.internal.impl.XMLEntityManager)value;
                return;
            }
            if (suffixLength == com.sun.org.apache.xerces.internal.impl.Constants.ENTITY_RESOLVER_PROPERTY.length() &&
                ...
                fExternalSubsetResolver = (value instanceof com.sun.org.apache.xerces.internal.impl.ExternalSubsetResolver) ?
                ...
                // Xerces properties
        if (propertyId.startsWith(com.sun.org.apache.xerces.internal.impl.Constants.XERCES_PROPERTY_PREFIX)) {
            String property = propertyId.substring(com.sun.org.apache.xerces.internal.impl.Constants.XERCES_PROPERTY_PREFIX.length());
            if (property.equals(com.sun.org.apache.xerces.internal.impl.Constants.ENTITY_MANAGER_PROPERTY)) {
                fEntityManager = (com.sun.org.apache.xerces.internal.impl.XMLEntityManager)value;
            }
            return;
        }
            ...
            do {
                ...
                if (fSecurityManager != null && !fSecurityManager.isNoLimit(fElementAttributeLimit) &&
                    ...
                    fErrorReporter.reportError(XMLMessageFormatter.XML_DOMAIN,
                                                 ...
                                                 com.sun.org.apache.xerces.internal.impl.XMLErrorReporter.SEVERITY_FATAL_ERROR );
                }
        ...
        if (ch != -1) {
            ...
            if (fDocumentHandler != null) {
                ...
                if (fValidation && ch <= 0x20) {
                    ...
                    augs.putItem(com.sun.org.apache.xerces.internal.impl.Constants.CHAR_REF_PROBABLE_WS, Boolean.TRUE);
                }
