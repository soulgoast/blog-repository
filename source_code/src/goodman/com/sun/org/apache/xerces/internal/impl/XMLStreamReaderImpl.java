...
import goodman.java.io.BufferedReader;
...
import goodman.javax.xml.namespace.NamespaceContext;
import goodman.javax.xml.namespace.QName;
import goodman.javax.xml.stream.Location;
import goodman.javax.xml.stream.XMLInputFactory;
import goodman.javax.xml.stream.XMLStreamConstants;
import goodman.javax.xml.stream.XMLStreamException;
...
public class XMLStreamReaderImpl implements javax.xml.stream.XMLStreamReader {
    ...
    protected com.sun.org.apache.xerces.internal.impl.XMLEntityManager fEntityManager = new XMLEntityManager();
    ...
    protected com.sun.org.apache.xerces.internal.impl.XMLEntityScanner fEntityScanner = null;

    /** Input Source */
    protected XMLInputSource fInputSource = null;
    /** Store properties*/
    protected com.sun.org.apache.xerces.internal.impl.PropertyManager fPropertyManager = null ;
     ...
     */
    public XMLStreamReaderImpl(InputStream inputStream, com.sun.org.apache.xerces.internal.impl.PropertyManager props) throws  XMLStreamException {
        init(props);
     ...
     * @throws XMLStreamException
     */
    public XMLStreamReaderImpl(String systemid, com.sun.org.apache.xerces.internal.impl.PropertyManager props) throws  XMLStreamException {
        init(props);
        //publicId, systemid, baseSystemId, inputStream, enocding
     ...
     * @throws XMLStreamException
     */
    public XMLStreamReaderImpl(InputStream inputStream, String encoding, com.sun.org.apache.xerces.internal.impl.PropertyManager props ) throws  XMLStreamException {
        init(props);
        //publicId, systemid, baseSystemId, inputStream, enocding
     ...
     * @throws XMLStreamException
     */
    public XMLStreamReaderImpl(Reader reader, com.sun.org.apache.xerces.internal.impl.PropertyManager props) throws  XMLStreamException {
        init(props);
        //publicId, systemid, baseSystemId, inputStream, enocding
     ...
     * @throws XMLStreamException
     */
    public XMLStreamReaderImpl(XMLInputSource inputSource, com.sun.org.apache.xerces.internal.impl.PropertyManager props) throws  XMLStreamException {
        init(props);
        //pass the input source to document scanner impl.
        setInputSource(inputSource);
    }
    ...
    void init(com.sun.org.apache.xerces.internal.impl.PropertyManager propertyManager) throws XMLStreamException {
    ...
    public void reset(){
        ...
        fDTDDecl = null;
        fEntityScanner = (com.sun.org.apache.xerces.internal.impl.XMLEntityScanner)fEntityManager.getEntityScanner()  ;
