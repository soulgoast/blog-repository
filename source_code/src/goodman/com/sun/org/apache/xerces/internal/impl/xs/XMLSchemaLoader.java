...
import goodman.java.io.FileNotFoundException;
...
import goodman.javax.xml.XMLConstants;
...
XSLoader, DOMConfiguration {
    ...
    private com.sun.org.apache.xerces.internal.impl.xs.XSDDescription fXSDDescription = new com.sun.org.apache.xerces.internal.impl.xs.XSDDescription();
    ...
    throws IOException, XNIException {
        ...
        desc.fContextType = com.sun.org.apache.xerces.internal.impl.xs.XSDDescription.CONTEXT_PREPARSE;
        ...
        com.sun.org.apache.xerces.internal.impl.xs.SchemaGrammar grammar = loadSchema(desc, source, locationPairs);
        ...
        if(grammar != null && fGrammarPool != null) {
            ...
            if(fIsCheckedFully && fJAXPCache.get(grammar) != grammar) {
                com.sun.org.apache.xerces.internal.impl.xs.XSConstraints.fullSchemaChecking(fGrammarBucket, fSubGroupHandler, fCMBuilder, fErrorReporter);
            }
        }
        return grammar;
     ...
     * @throws XNIException
     */
    com.sun.org.apache.xerces.internal.impl.xs.SchemaGrammar loadSchema(com.sun.org.apache.xerces.internal.impl.xs.XSDDescription desc, XMLInputSource source,
        ...
        com.sun.org.apache.xerces.internal.impl.xs.SchemaGrammar grammar = fSchemaHandler.parseSchema(source, desc, locationPairs);
     ...
     * @throws IOException
     */
    public static XMLInputSource resolveDocument(com.sun.org.apache.xerces.internal.impl.xs.XSDDescription desc,
        ...
        if (desc.getContextType() == com.sun.org.apache.xerces.internal.impl.xs.XSDDescription.CONTEXT_IMPORT ||
                desc.fromInstance()) {
    ...
    public static void processExternalHints(String sl, String nsl,
        ...
        if (sl != null) {
            try {
                ...
                XSAttributeDecl attrDecl = com.sun.org.apache.xerces.internal.impl.xs.SchemaGrammar.SG_XSI.getGlobalAttributeDecl(com.sun.org.apache.xerces.internal.impl.xs.SchemaSymbols.XSI_SCHEMALOCATION);
        ...
        if (nsl != null) {
            try {
                ...
                XSAttributeDecl attrDecl = com.sun.org.apache.xerces.internal.impl.xs.SchemaGrammar.SG_XSI.getGlobalAttributeDecl(SchemaSymbols.XSI_NONAMESPACESCHEMALOCATION);
    ...
    private void processJAXPSchemaSource(
        ...
        if (componentType == null) {
            ...
            if(fJAXPSource instanceof InputStream ||
                ...
                com.sun.org.apache.xerces.internal.impl.xs.SchemaGrammar g = (com.sun.org.apache.xerces.internal.impl.xs.SchemaGrammar)fJAXPCache.get(fJAXPSource);
                if(g != null) {
            ...
            sid = xis.getSystemId();
            fXSDDescription.fContextType = com.sun.org.apache.xerces.internal.impl.xs.XSDDescription.CONTEXT_PREPARSE;
            if (sid != null) {
            ...
            com.sun.org.apache.xerces.internal.impl.xs.SchemaGrammar g = loadSchema(fXSDDescription, xis, locationPairs);
        ...
        for (int i = 0; i < objArr.length; i++) {
            if(objArr[i] instanceof InputStream ||
                ...
                com.sun.org.apache.xerces.internal.impl.xs.SchemaGrammar g = (com.sun.org.apache.xerces.internal.impl.xs.SchemaGrammar)fJAXPCache.get(objArr[i]);
                if (g != null) {
                    fGrammarBucket.putGrammar(g);
                    continue;
                }
            ...
            // load schema
            com.sun.org.apache.xerces.internal.impl.xs.SchemaGrammar grammar = fSchemaHandler.parseSchema(xis,fXSDDescription, locationPairs);
    ...
    private void initGrammarBucket(){
        if(fGrammarPool != null) {
            ...
            for (int i = 0; i < initialGrammars.length; i++) {
                ...
                if (!fGrammarBucket.putGrammar((com.sun.org.apache.xerces.internal.impl.xs.SchemaGrammar)(initialGrammars[i]), true)) {
    ...
    public XSModel loadInputList(LSInputList is) {
        ...
        com.sun.org.apache.xerces.internal.impl.xs.SchemaGrammar[] gs = new com.sun.org.apache.xerces.internal.impl.xs.SchemaGrammar[length];
        for (int i = 0; i < length; i++) {
            try {
                gs[i] = (com.sun.org.apache.xerces.internal.impl.xs.SchemaGrammar) loadGrammar(dom2xmlInputSource(is.item(i)));
            } catch (Exception e) {
                reportDOMFatalError(e);
                return null;
            }
        }
        return new com.sun.org.apache.xerces.internal.impl.xs.XSModelImpl(gs);
    }
