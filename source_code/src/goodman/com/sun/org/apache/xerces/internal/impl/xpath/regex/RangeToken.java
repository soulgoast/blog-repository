 ...
 *
 */
final class RangeToken extends com.sun.org.apache.xerces.internal.impl.xpath.regex.Token implements java.io.Serializable {
    ...
    protected void mergeRanges(com.sun.org.apache.xerces.internal.impl.xpath.regex.Token token) {
    ...
    protected void subtractRanges(com.sun.org.apache.xerces.internal.impl.xpath.regex.Token token) {
     ...
     */
    protected void intersectRanges(com.sun.org.apache.xerces.internal.impl.xpath.regex.Token token) {
        RangeToken tok = (RangeToken)token;
        if (tok.ranges == null || this.ranges == null)
            return;
        this.icaseCache = null;
    ...
    static com.sun.org.apache.xerces.internal.impl.xpath.regex.Token complementRanges(com.sun.org.apache.xerces.internal.impl.xpath.regex.Token token) {
        ...
        if (last == UTF16_MAX)
            len -= 2;
        RangeToken ret = com.sun.org.apache.xerces.internal.impl.xpath.regex.Token.createRange();
    ...
    synchronized RangeToken getCaseInsensitiveToken() {
        ...
        RangeToken uppers = this.type == com.sun.org.apache.xerces.internal.impl.xpath.regex.Token.RANGE ? com.sun.org.apache.xerces.internal.impl.xpath.regex.Token.createRange() : com.sun.org.apache.xerces.internal.impl.xpath.regex.Token.createNRange();
        ...
        RangeToken lowers = this.type == com.sun.org.apache.xerces.internal.impl.xpath.regex.Token.RANGE ? com.sun.org.apache.xerces.internal.impl.xpath.regex.Token.createRange() : com.sun.org.apache.xerces.internal.impl.xpath.regex.Token.createNRange();
    ...
    public String toString(int options) {
        String ret;
        if (this.type == RANGE) {
            if (this == com.sun.org.apache.xerces.internal.impl.xpath.regex.Token.token_dot)
                ret = ".";
            else if (this == com.sun.org.apache.xerces.internal.impl.xpath.regex.Token.token_0to9)
                ret = "\\d";
            else if (this == com.sun.org.apache.xerces.internal.impl.xpath.regex.Token.token_wordchars)
                ret = "\\w";
            else if (this == com.sun.org.apache.xerces.internal.impl.xpath.regex.Token.token_spaces)
                ret = "\\s";
            else {
            ...
            if (this == com.sun.org.apache.xerces.internal.impl.xpath.regex.Token.token_not_0to9)
                ret = "\\D";
            else if (this == com.sun.org.apache.xerces.internal.impl.xpath.regex.Token.token_not_wordchars)
                ret = "\\W";
            else if (this == com.sun.org.apache.xerces.internal.impl.xpath.regex.Token.token_not_spaces)
                ret = "\\S";
            else {
                StringBuffer sb = new StringBuffer();
                sb.append("[^");
