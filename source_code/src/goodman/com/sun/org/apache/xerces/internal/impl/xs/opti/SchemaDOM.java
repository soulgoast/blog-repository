...
package goodman.com.sun.org.apache.xerces.internal.impl.xs.opti;

import goodman.java.util.ArrayList;
import goodman.java.util.Enumeration;

import com.sun.org.apache.xerces.internal.impl.xs.opti.*;
...
public class SchemaDOM extends DefaultDocument {
    ...
    private void resizeRelations() {
        com.sun.org.apache.xerces.internal.impl.xs.opti.NodeImpl[][] temp = new com.sun.org.apache.xerces.internal.impl.xs.opti.NodeImpl[relations.length+relationsRowResizeFactor][];
        System.arraycopy(relations, 0, temp, 0, relations.length);
        for (int i = relations.length ; i < temp.length ; i++) {
            temp[i] = new com.sun.org.apache.xerces.internal.impl.xs.opti.NodeImpl[relationsColResizeFactor];
        }
        relations = temp;
    }

    private void resizeRelations(int i) {
        com.sun.org.apache.xerces.internal.impl.xs.opti.NodeImpl[] temp = new com.sun.org.apache.xerces.internal.impl.xs.opti.NodeImpl[relations[i].length+relationsColResizeFactor];
        ...
        if(relations != null)
            for(int i=0; i<relations.length; i++)
                for(int j=0; j<relations[i].length; j++)
                    relations[i][j] = null;
        relations = new com.sun.org.apache.xerces.internal.impl.xs.opti.NodeImpl[relationsRowResizeFactor][];
