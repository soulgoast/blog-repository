...
import goodman.javax.xml.stream.XMLOutputFactory;
import goodman.javax.xml.stream.XMLResolver;
...
public class PropertyManager {
    ...
    private static final String SECURITY_MANAGER = com.sun.org.apache.xerces.internal.impl.Constants.SECURITY_MANAGER;
    ...
    private void initConfigurableReaderProperties(){
        ...
        supportedProps.put(com.sun.org.apache.xerces.internal.impl.Constants.SAX_FEATURE_PREFIX + com.sun.org.apache.xerces.internal.impl.Constants.STRING_INTERNING_FEATURE , new Boolean(true));
        //recognizing java encoding names by default
        supportedProps.put(com.sun.org.apache.xerces.internal.impl.Constants.XERCES_FEATURE_PREFIX + com.sun.org.apache.xerces.internal.impl.Constants.ALLOW_JAVA_ENCODINGS_FEATURE,  new Boolean(true)) ;
        //in stax mode, namespace declarations are not added as attributes
        supportedProps.put(com.sun.org.apache.xerces.internal.impl.Constants.ADD_NAMESPACE_DECL_AS_ATTRIBUTE ,  Boolean.FALSE) ;
        supportedProps.put(com.sun.org.apache.xerces.internal.impl.Constants.READER_IN_DEFINED_STATE, new Boolean(true));
        supportedProps.put(com.sun.org.apache.xerces.internal.impl.Constants.REUSE_INSTANCE, new Boolean(true));
        supportedProps.put(com.sun.org.apache.xerces.internal.impl.Constants.ZEPHYR_PROPERTY_PREFIX + com.sun.org.apache.xerces.internal.impl.Constants.STAX_REPORT_CDATA_EVENT , new Boolean(false));
        supportedProps.put(com.sun.org.apache.xerces.internal.impl.Constants.ZEPHYR_PROPERTY_PREFIX + com.sun.org.apache.xerces.internal.impl.Constants.IGNORE_EXTERNAL_DTD, Boolean.FALSE);
        supportedProps.put(com.sun.org.apache.xerces.internal.impl.Constants.XERCES_FEATURE_PREFIX + com.sun.org.apache.xerces.internal.impl.Constants.WARN_ON_DUPLICATE_ATTDEF_FEATURE, new Boolean(false));
        supportedProps.put(com.sun.org.apache.xerces.internal.impl.Constants.XERCES_FEATURE_PREFIX + com.sun.org.apache.xerces.internal.impl.Constants.WARN_ON_DUPLICATE_ENTITYDEF_FEATURE, new Boolean(false));
        supportedProps.put(com.sun.org.apache.xerces.internal.impl.Constants.XERCES_FEATURE_PREFIX + com.sun.org.apache.xerces.internal.impl.Constants.WARN_ON_UNDECLARED_ELEMDEF_FEATURE, new Boolean(false));
    ...
    private void initWriterProps(){
        ...
        supportedProps.put(com.sun.org.apache.xerces.internal.impl.Constants.ESCAPE_CHARACTERS , Boolean.TRUE);
        supportedProps.put(com.sun.org.apache.xerces.internal.impl.Constants.REUSE_INSTANCE, new Boolean(true));
    }
    ...
    public void setProperty(String property, Object value){
        ...
        if(property == XMLInputFactory.IS_NAMESPACE_AWARE || property.equals(XMLInputFactory.IS_NAMESPACE_AWARE)){
            equivalentProperty = com.sun.org.apache.xerces.internal.impl.Constants.XERCES_FEATURE_PREFIX + com.sun.org.apache.xerces.internal.impl.Constants.NAMESPACES_FEATURE ;
        }
            ...
            supportedProps.put( com.sun.org.apache.xerces.internal.impl.Constants.XERCES_PROPERTY_PREFIX + com.sun.org.apache.xerces.internal.impl.Constants.STAX_ENTITY_RESOLVER_PROPERTY , new StaxEntityResolverWrapper((XMLResolver)value)) ;
        }
         ...
         */
        if (property.equals(com.sun.org.apache.xerces.internal.impl.Constants.SECURITY_MANAGER)) {
            fSecurityManager = XMLSecurityManager.convert(value, fSecurityManager);
            supportedProps.put(com.sun.org.apache.xerces.internal.impl.Constants.SECURITY_MANAGER, fSecurityManager);
            return;
        }
        if (property.equals(com.sun.org.apache.xerces.internal.impl.Constants.XML_SECURITY_PROPERTY_MANAGER)) {
            if (value == null) {
                fSecurityPropertyMgr = new XMLSecurityPropertyManager();
            } else {
