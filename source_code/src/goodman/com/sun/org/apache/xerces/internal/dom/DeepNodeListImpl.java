...
public class DeepNodeListImpl
    ...
    protected com.sun.org.apache.xerces.internal.dom.NodeImpl rootNode; // Where the search started
    ...
    /** Constructor. */
    public DeepNodeListImpl(com.sun.org.apache.xerces.internal.dom.NodeImpl rootNode, String tagName) {
    ...
    public DeepNodeListImpl(com.sun.org.apache.xerces.internal.dom.NodeImpl rootNode,
    ...
    protected Node nextMatchingElementAfter(Node current) {
            ...
            while (current != null) {
                    ...
                    if (current != rootNode
                        ...
                        if (!enableNS) {
                            if (tagName.equals("*") ||
                                ((com.sun.org.apache.xerces.internal.dom.ElementImpl) current).getTagName().equals(tagName))
                            {
                                return current;
                            }
                        } else {
                            ...
                            if (tagName.equals("*")) {
                                if (nsName != null && nsName.equals("*")) {
                                    ...
                                    com.sun.org.apache.xerces.internal.dom.ElementImpl el = (com.sun.org.apache.xerces.internal.dom.ElementImpl) current;
                                    if ((nsName == null
                                ...
                                com.sun.org.apache.xerces.internal.dom.ElementImpl el = (ElementImpl) current;
