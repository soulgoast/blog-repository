...
class XSDAttributeTraverser extends com.sun.org.apache.xerces.internal.impl.xs.traversers.XSDAbstractTraverser {
    ...
    public XSDAttributeTraverser (com.sun.org.apache.xerces.internal.impl.xs.traversers.XSDHandler handler,
    ...
    protected XSAttributeUseImpl traverseLocal(Element attrDecl,
        ...
        XInt   useAtt     = (XInt)   attrValues[com.sun.org.apache.xerces.internal.impl.xs.traversers.XSAttributeChecker.ATTIDX_USE];
        ...
        if (attrDecl.getAttributeNode(SchemaSymbols.ATT_REF) != null) {
            if (refAtt != null) {
                attribute = (XSAttributeDecl)fSchemaHandler.getGlobalDecl(schemaDoc, com.sun.org.apache.xerces.internal.impl.xs.traversers.XSDHandler.ATTRIBUTE_TYPE, refAtt, attrDecl);
