...
public abstract class ParentNode
    ...
    /** First child. */
    protected com.sun.org.apache.xerces.internal.dom.ChildNode firstChild = null;
    ...
    public Node cloneNode(boolean deep) {
        ...
        if (deep) {
            for (com.sun.org.apache.xerces.internal.dom.ChildNode child = firstChild;
                 child != null;
    ...
    Node internalInsertBefore(Node newChild, Node refChild, boolean replace)
        ...
        if (errorChecking) {
            ...
            if (ownerDocument.ancestorChecking) {
                ...
                for (com.sun.org.apache.xerces.internal.dom.NodeImpl a = this; treeSafe && a != null; a = a.parentNode())
                {
                    treeSafe = newChild != a;
                }
                if(!treeSafe) {
        ...
        com.sun.org.apache.xerces.internal.dom.ChildNode newInternal = (com.sun.org.apache.xerces.internal.dom.ChildNode)newChild;
        ...
        // Convert to internal type, to avoid repeated casting
        com.sun.org.apache.xerces.internal.dom.ChildNode refInternal = (com.sun.org.apache.xerces.internal.dom.ChildNode)refChild;
        ...
        if (firstChild == null) {
            ...
            if (refInternal == null) {
                // this is an append
                com.sun.org.apache.xerces.internal.dom.ChildNode lastChild = firstChild.previousSibling;
                ...
                if (refChild == firstChild) {
                    ...
                    com.sun.org.apache.xerces.internal.dom.ChildNode prev = refInternal.previousSibling;
    ...
    Node internalRemoveChild(Node oldChild, boolean replace)
        ...
        com.sun.org.apache.xerces.internal.dom.ChildNode oldInternal = (com.sun.org.apache.xerces.internal.dom.ChildNode) oldChild;
        ...
        if (oldInternal == firstChild) {
            ...
            com.sun.org.apache.xerces.internal.dom.ChildNode prev = oldInternal.previousSibling;
            com.sun.org.apache.xerces.internal.dom.ChildNode next = oldInternal.nextSibling;
        ...
        com.sun.org.apache.xerces.internal.dom.ChildNode oldPreviousSibling = oldInternal.previousSibling();
    ...
    public String getTextContent() throws DOMException {
        ...
        if (child != null) {
            ...
            if (next == null) {
                return hasTextContent(child) ? ((com.sun.org.apache.xerces.internal.dom.NodeImpl) child).getTextContent() : "";
            }
            if (fBufferStr == null){
    ...
    void getTextContent(StringBuffer buf) throws DOMException {
        ...
        while (child != null) {
            if (hasTextContent(child)) {
                ((com.sun.org.apache.xerces.internal.dom.NodeImpl) child).getTextContent(buf);
            }
    ...
    private int nodeListGetLength() {
        ...
        if (fNodeListCache.fLength == -1) { // is the cached length invalid ?
            int l;
            com.sun.org.apache.xerces.internal.dom.ChildNode n;
    ...
    private Node nodeListItem(int index) {
        ...
        com.sun.org.apache.xerces.internal.dom.ChildNode n = fNodeListCache.fChild;
    ...
    public void normalize() {
        ...
        com.sun.org.apache.xerces.internal.dom.ChildNode kid;
    ...
    public void setReadOnly(boolean readOnly, boolean deep) {
        ...
        if (deep) {
            ...
            for (com.sun.org.apache.xerces.internal.dom.ChildNode mykid = firstChild;
                 mykid != null;
     ...
     */
    void checkNormalizationAfterInsert(com.sun.org.apache.xerces.internal.dom.ChildNode insertedChild) {
        // See if insertion caused this node to be unnormalized.
        if (insertedChild.getNodeType() == Node.TEXT_NODE) {
            com.sun.org.apache.xerces.internal.dom.ChildNode prev = insertedChild.previousSibling();
            com.sun.org.apache.xerces.internal.dom.ChildNode next = insertedChild.nextSibling;
     ...
     * <code>null</code>
     */
    void checkNormalizationAfterRemove(com.sun.org.apache.xerces.internal.dom.ChildNode previousSibling) {
