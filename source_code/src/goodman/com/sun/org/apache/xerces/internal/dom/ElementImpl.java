   ...
   /**
     ...
     */
     public void setAttributeNS(String namespaceURI,String qualifiedName,
            ...
            if (newAttr instanceof com.sun.org.apache.xerces.internal.dom.AttrNSImpl){
                String origNodeName = ((com.sun.org.apache.xerces.internal.dom.AttrNSImpl) newAttr).name;
                String newName = (prefix!=null) ? (prefix+":"+localName) : localName;

                ((com.sun.org.apache.xerces.internal.dom.AttrNSImpl) newAttr).name = newName;
        ...
        if (hasAttrs) {
            ...
            for (int i = 0; i < len; i++) {
                ...
                if (n1.getLocalName() == null) { // DOM Level 1 Node
                    ...
                    if (n2 == null || !((com.sun.org.apache.xerces.internal.dom.NodeImpl) n1).isEqualNode(n2)) {
                        return false;
                    }
                }
                else {
    ...
    public void setIdAttributeNode(Attr at, boolean makeId) {
        ...
        ((com.sun.org.apache.xerces.internal.dom.AttrImpl) at).isIdAttribute(makeId);
        if (!makeId) {
