...
package goodman.com.sun.org.apache.xerces.internal.impl.xpath.regex;

import goodman.java.text.CharacterIterator;
...
public class RegularExpression implements java.io.Serializable {
     ...
     */
    private synchronized void compile(com.sun.org.apache.xerces.internal.impl.xpath.regex.Token tok) {
     ...
     */
    private com.sun.org.apache.xerces.internal.impl.xpath.regex.Op compile(com.sun.org.apache.xerces.internal.impl.xpath.regex.Token tok, com.sun.org.apache.xerces.internal.impl.xpath.regex.Op next, boolean reverse) {
        com.sun.org.apache.xerces.internal.impl.xpath.regex.Op ret;
        switch (tok.type) {
        case com.sun.org.apache.xerces.internal.impl.xpath.regex.Token.DOT:
            ret = com.sun.org.apache.xerces.internal.impl.xpath.regex.Op.createDot();
            ret.next = next;
            break;

        case com.sun.org.apache.xerces.internal.impl.xpath.regex.Token.CHAR:
            ret = com.sun.org.apache.xerces.internal.impl.xpath.regex.Op.createChar(tok.getChar());
            ret.next = next;
            break;

        case com.sun.org.apache.xerces.internal.impl.xpath.regex.Token.ANCHOR:
            ret = com.sun.org.apache.xerces.internal.impl.xpath.regex.Op.createAnchor(tok.getChar());
            ret.next = next;
            break;

        case com.sun.org.apache.xerces.internal.impl.xpath.regex.Token.RANGE:
        case com.sun.org.apache.xerces.internal.impl.xpath.regex.Token.NRANGE:
            ret = com.sun.org.apache.xerces.internal.impl.xpath.regex.Op.createRange(tok);
            ret.next = next;
            break;

        case com.sun.org.apache.xerces.internal.impl.xpath.regex.Token.CONCAT:
            ret = next;
            if (!reverse) {
        ...
        case com.sun.org.apache.xerces.internal.impl.xpath.regex.Token.UNION:
            com.sun.org.apache.xerces.internal.impl.xpath.regex.Op.UnionOp uni = com.sun.org.apache.xerces.internal.impl.xpath.regex.Op.createUnion(tok.size());
            for (int i = 0;  i < tok.size();  i ++) {
        ...
        case com.sun.org.apache.xerces.internal.impl.xpath.regex.Token.CLOSURE:
        case com.sun.org.apache.xerces.internal.impl.xpath.regex.Token.NONGREEDYCLOSURE:
            com.sun.org.apache.xerces.internal.impl.xpath.regex.Token child = tok.getChild(0);
            int min = tok.getMin();
            int max = tok.getMax();
            if (min >= 0 && min == max) { // {n}
                ret = next;
            ...
            if (max > 0) {
                ...
                ret = next;
                for (int i = 0;  i < max;  i ++) {
                    com.sun.org.apache.xerces.internal.impl.xpath.regex.Op.ChildOp q = com.sun.org.apache.xerces.internal.impl.xpath.regex.Op.createQuestion(tok.type == com.sun.org.apache.xerces.internal.impl.xpath.regex.Token.NONGREEDYCLOSURE);
                    q.next = next;
                    q.setChild(compile(child, ret, reverse));
                    ret = q;
                }
            } else {
                com.sun.org.apache.xerces.internal.impl.xpath.regex.Op.ChildOp op;
                if (tok.type == com.sun.org.apache.xerces.internal.impl.xpath.regex.Token.NONGREEDYCLOSURE) {
                    op = com.sun.org.apache.xerces.internal.impl.xpath.regex.Op.createNonGreedyClosure();
                } else {                        // Token.CLOSURE
                    op = com.sun.org.apache.xerces.internal.impl.xpath.regex.Op.createClosure(this.numberOfClosures++);
                }
                op.next = next;
        ...
        case com.sun.org.apache.xerces.internal.impl.xpath.regex.Token.EMPTY:
            ret = next;
            break;

        case com.sun.org.apache.xerces.internal.impl.xpath.regex.Token.STRING:
            ret = com.sun.org.apache.xerces.internal.impl.xpath.regex.Op.createString(tok.getString());
            ret.next = next;
            break;

        case com.sun.org.apache.xerces.internal.impl.xpath.regex.Token.BACKREFERENCE:
            ret = com.sun.org.apache.xerces.internal.impl.xpath.regex.Op.createBackReference(tok.getReferenceNumber());
            ret.next = next;
            break;

        case com.sun.org.apache.xerces.internal.impl.xpath.regex.Token.PAREN:
            if (tok.getParenNumber() == 0) {
                ret = compile(tok.getChild(0), next, reverse);
            } else if (reverse) {
                next = com.sun.org.apache.xerces.internal.impl.xpath.regex.Op.createCapture(tok.getParenNumber(), next);
                next = compile(tok.getChild(0), next, reverse);
                ret = com.sun.org.apache.xerces.internal.impl.xpath.regex.Op.createCapture(-tok.getParenNumber(), next);
            } else {
                next = com.sun.org.apache.xerces.internal.impl.xpath.regex.Op.createCapture(-tok.getParenNumber(), next);
                next = compile(tok.getChild(0), next, reverse);
                ret = com.sun.org.apache.xerces.internal.impl.xpath.regex.Op.createCapture(tok.getParenNumber(), next);
        ...
        case com.sun.org.apache.xerces.internal.impl.xpath.regex.Token.LOOKAHEAD:
            ret = com.sun.org.apache.xerces.internal.impl.xpath.regex.Op.createLook(com.sun.org.apache.xerces.internal.impl.xpath.regex.Op.LOOKAHEAD, next, compile(tok.getChild(0), null, false));
            break;
        case com.sun.org.apache.xerces.internal.impl.xpath.regex.Token.NEGATIVELOOKAHEAD:
            ret = com.sun.org.apache.xerces.internal.impl.xpath.regex.Op.createLook(com.sun.org.apache.xerces.internal.impl.xpath.regex.Op.NEGATIVELOOKAHEAD, next, compile(tok.getChild(0), null, false));
            break;
        case com.sun.org.apache.xerces.internal.impl.xpath.regex.Token.LOOKBEHIND:
            ret = com.sun.org.apache.xerces.internal.impl.xpath.regex.Op.createLook(com.sun.org.apache.xerces.internal.impl.xpath.regex.Op.LOOKBEHIND, next, compile(tok.getChild(0), null, true));
            break;
        case com.sun.org.apache.xerces.internal.impl.xpath.regex.Token.NEGATIVELOOKBEHIND:
            ret = com.sun.org.apache.xerces.internal.impl.xpath.regex.Op.createLook(com.sun.org.apache.xerces.internal.impl.xpath.regex.Op.NEGATIVELOOKBEHIND, next, compile(tok.getChild(0), null, true));
            break;

        case com.sun.org.apache.xerces.internal.impl.xpath.regex.Token.INDEPENDENT:
            ret = com.sun.org.apache.xerces.internal.impl.xpath.regex.Op.createIndependent(next, compile(tok.getChild(0), null, reverse));
            break;

        case com.sun.org.apache.xerces.internal.impl.xpath.regex.Token.MODIFIERGROUP:
            ret = com.sun.org.apache.xerces.internal.impl.xpath.regex.Op.createModifier(next, compile(tok.getChild(0), null, reverse),
                                    ((com.sun.org.apache.xerces.internal.impl.xpath.regex.Token.ModifierToken)tok).getOptions(),
                                    ((com.sun.org.apache.xerces.internal.impl.xpath.regex.Token.ModifierToken)tok).getOptionsMask());
            break;

        case com.sun.org.apache.xerces.internal.impl.xpath.regex.Token.CONDITION:
            com.sun.org.apache.xerces.internal.impl.xpath.regex.Token.ConditionToken ctok = (com.sun.org.apache.xerces.internal.impl.xpath.regex.Token.ConditionToken)tok;
            int ref = ctok.refNumber;
            com.sun.org.apache.xerces.internal.impl.xpath.regex.Op condition = ctok.condition == null ? null : compile(ctok.condition, null, reverse);
            com.sun.org.apache.xerces.internal.impl.xpath.regex.Op yes = compile(ctok.yes, next, reverse);
            com.sun.org.apache.xerces.internal.impl.xpath.regex.Op no = ctok.no == null ? null : compile(ctok.no, next, reverse);
            ret = com.sun.org.apache.xerces.internal.impl.xpath.regex.Op.createCondition(next, ref, condition, yes, no);
            break;
...
//Public
    ...
    public boolean matches(char[]  target) {
        return this.matches(target, 0,  target .length , (com.sun.org.apache.xerces.internal.impl.xpath.regex.Match)null);
    }
    ...
    public boolean matches(char[]  target, int start, int end) {
        return this.matches(target, start, end, (com.sun.org.apache.xerces.internal.impl.xpath.regex.Match)null);
    }
     ...
     */
    public boolean matches(char[]  target, com.sun.org.apache.xerces.internal.impl.xpath.regex.Match match) {
     ...
     * @return Offset of the start position in <VAR>target</VAR>; or -1 if not match.
     */
    public boolean matches(char[] target, int start, int end, com.sun.org.apache.xerces.internal.impl.xpath.regex.Match match) {
        ...
        if (match != null) {
            ...
            match = new com.sun.org.apache.xerces.internal.impl.xpath.regex.Match();
            match.setNumberOfGroups(this.nofparen);
         ...
         */
        if (this.operations != null
            && this.operations.type == com.sun.org.apache.xerces.internal.impl.xpath.regex.Op.CLOSURE && this.operations.getChild().type == com.sun.org.apache.xerces.internal.impl.xpath.regex.Op.DOT) {
         ...
         */
            ...
            for (matchStart = con.start;  matchStart <= limit;  matchStart ++) {
                int ch =  target [matchStart] ;
                if (com.sun.org.apache.xerces.internal.impl.xpath.regex.REUtil.isHighSurrogate(ch) && matchStart+1 < con.limit) {
                    ch = com.sun.org.apache.xerces.internal.impl.xpath.regex.REUtil.composeFromSurrogates(ch, target[matchStart+1]);
                }
                if (!range.match(ch))  {
                    continue;
                }
     ...
     * @return Offset of the start position in <VAR>target</VAR>; or -1 if not match.
     */
    public boolean matches(String  target, com.sun.org.apache.xerces.internal.impl.xpath.regex.Match match) {
        return this.matches(target, 0,  target .length() , match);
    }
     ...
     * @return Offset of the start position in <VAR>target</VAR>; or -1 if not match.
     */
    public boolean matches(String  target, int start, int end, com.sun.org.apache.xerces.internal.impl.xpath.regex.Match match) {
         ...
         */
            ...
            for (matchStart = con.start;  matchStart <= limit;  matchStart ++) {
                int ch =  target .charAt(  matchStart ) ;
                if (com.sun.org.apache.xerces.internal.impl.xpath.regex.REUtil.isHighSurrogate(ch) && matchStart+1 < con.limit) {
                    ch = com.sun.org.apache.xerces.internal.impl.xpath.regex.REUtil.composeFromSurrogates(ch, target.charAt(matchStart+1));
                }
                if (!range.match(ch)) {
                    continue;
                }
     ...
     */
    private int match(Context con, com.sun.org.apache.xerces.internal.impl.xpath.regex.Op op, int offset, int dx, int opts) {
        ...
        for (;;) {
            if (op == null || offset > con.limit || offset < con.start) {
                ...
                switch (op.type) {
                case com.sun.org.apache.xerces.internal.impl.xpath.regex.Op.CHAR:
                    {
                ...
                case com.sun.org.apache.xerces.internal.impl.xpath.regex.Op.DOT:
                    {
                        ...
                        if (isSet(opts, SINGLE_LINE)) {
                            if (com.sun.org.apache.xerces.internal.impl.xpath.regex.REUtil.isHighSurrogate(target.charAt(o1)) && o1+dx >= 0 && o1+dx < con.limit) {
                                o1 += dx;
                            }
                        }
                        else {
                            int ch = target.charAt(o1);
                            if (com.sun.org.apache.xerces.internal.impl.xpath.regex.REUtil.isHighSurrogate(ch) && o1+dx >= 0 && o1+dx < con.limit) {
                                o1 += dx;
                                ch = com.sun.org.apache.xerces.internal.impl.xpath.regex.REUtil.composeFromSurrogates(ch, target.charAt(o1));
                            }
                            if (isEOLChar(ch)) {
                                returned = true;
                                break;
                ...
                case com.sun.org.apache.xerces.internal.impl.xpath.regex.Op.RANGE:
                case com.sun.org.apache.xerces.internal.impl.xpath.regex.Op.NRANGE:
                    {
                        int o1 = (dx > 0) ? offset : offset -1;
                        if (o1 >= con.limit || o1 < 0) {
                            returned = true;
                        ...
                        if (com.sun.org.apache.xerces.internal.impl.xpath.regex.REUtil.isHighSurrogate(ch) && o1+dx < con.limit && o1+dx >=0) {
                            o1 += dx;
                            ch = com.sun.org.apache.xerces.internal.impl.xpath.regex.REUtil.composeFromSurrogates(ch, target.charAt(o1));
                        }
                ...
                case com.sun.org.apache.xerces.internal.impl.xpath.regex.Op.ANCHOR:
                    {
                ...
                case com.sun.org.apache.xerces.internal.impl.xpath.regex.Op.BACKREFERENCE:
                    {
                ...
                case com.sun.org.apache.xerces.internal.impl.xpath.regex.Op.STRING:
                    {
                ...
                case com.sun.org.apache.xerces.internal.impl.xpath.regex.Op.CLOSURE:
                    {
                ...
                case com.sun.org.apache.xerces.internal.impl.xpath.regex.Op.QUESTION:
                    {
                        opStack.push(op);
                ...
                case com.sun.org.apache.xerces.internal.impl.xpath.regex.Op.NONGREEDYCLOSURE:
                case com.sun.org.apache.xerces.internal.impl.xpath.regex.Op.NONGREEDYQUESTION:
                    {
                        opStack.push(op);
                        dataStack.push(offset);
                        op = op.next;
                ...
                case com.sun.org.apache.xerces.internal.impl.xpath.regex.Op.UNION:
                    if (op.size() == 0) {
                        returned = true;
                    }
                    else {
                ...
                case com.sun.org.apache.xerces.internal.impl.xpath.regex.Op.CAPTURE:
                    {
                ...
                case com.sun.org.apache.xerces.internal.impl.xpath.regex.Op.LOOKAHEAD:
                case com.sun.org.apache.xerces.internal.impl.xpath.regex.Op.NEGATIVELOOKAHEAD:
                case com.sun.org.apache.xerces.internal.impl.xpath.regex.Op.LOOKBEHIND:
                case com.sun.org.apache.xerces.internal.impl.xpath.regex.Op.NEGATIVELOOKBEHIND:
                    {
                        opStack.push(op);
                        dataStack.push(dx);
                        dataStack.push(offset);
                        dx = (op.type == com.sun.org.apache.xerces.internal.impl.xpath.regex.Op.LOOKAHEAD || op.type == com.sun.org.apache.xerces.internal.impl.xpath.regex.Op.NEGATIVELOOKAHEAD) ? 1 : -1;
                        op = op.getChild();
                    }
                    break;

                case com.sun.org.apache.xerces.internal.impl.xpath.regex.Op.INDEPENDENT:
                    {
                        opStack.push(op);
                        dataStack.push(offset);
                        op = op.getChild();
                ...
                case com.sun.org.apache.xerces.internal.impl.xpath.regex.Op.MODIFIER:
                    {
                        int localopts = opts;
                ...
                case com.sun.org.apache.xerces.internal.impl.xpath.regex.Op.CONDITION:
                    {
                        com.sun.org.apache.xerces.internal.impl.xpath.regex.Op.ConditionOp cop = (com.sun.org.apache.xerces.internal.impl.xpath.regex.Op.ConditionOp)op;
                        if (cop.refNumber > 0) {
            ...
            while (returned) {
                ...
                op = (com.sun.org.apache.xerces.internal.impl.xpath.regex.Op) opStack.pop();
                ...
                case com.sun.org.apache.xerces.internal.impl.xpath.regex.Op.CONDITION:
                    {
                        final com.sun.org.apache.xerces.internal.impl.xpath.regex.Op.ConditionOp cop = (com.sun.org.apache.xerces.internal.impl.xpath.regex.Op.ConditionOp)op;
                        if (0 <= retValue) {
                            op = cop.yes;
                        }
                        else if (cop.no != null) {
    ...
    boolean matchAnchor(ExpressionTarget target, com.sun.org.apache.xerces.internal.impl.xpath.regex.Op op, Context con, int offset, int opts) {
        boolean go = false;
        switch (op.getData()) {
        case '^':
    ...
    public boolean matches(CharacterIterator target) {
        return this.matches(target, (com.sun.org.apache.xerces.internal.impl.xpath.regex.Match)null);
    }
     ...
     * @return Offset of the start position in <VAR>target</VAR>; or -1 if not match.
     */
    public boolean matches(CharacterIterator  target, com.sun.org.apache.xerces.internal.impl.xpath.regex.Match match) {
         ...
         */
            ...
            for (matchStart = con.start;  matchStart <= limit;  matchStart ++) {
                int ch =  target .setIndex(  matchStart ) ;
                if (com.sun.org.apache.xerces.internal.impl.xpath.regex.REUtil.isHighSurrogate(ch) && matchStart+1 < con.limit) {
                    ch = com.sun.org.apache.xerces.internal.impl.xpath.regex.REUtil.composeFromSurrogates(ch, target.setIndex(matchStart+1));
                }
                if (!range.match(ch)) {
                    continue;
                }
     ...
     * @serial
     */
    com.sun.org.apache.xerces.internal.impl.xpath.regex.Token tokentree;

    boolean hasBackReferences = false;

    transient int minlength;
    transient com.sun.org.apache.xerces.internal.impl.xpath.regex.Op operations = null;
    ...
    transient com.sun.org.apache.xerces.internal.impl.xpath.regex.BMPattern fixedStringTable = null;
     ...
     */
    void prepare() {
        if (com.sun.org.apache.xerces.internal.impl.xpath.regex.Op.COUNT)  com.sun.org.apache.xerces.internal.impl.xpath.regex.Op.nofinstances = 0;
        ...
        */
        if (com.sun.org.apache.xerces.internal.impl.xpath.regex.Op.COUNT)  System.err.println("DEBUG: The number of operations: "+ com.sun.org.apache.xerces.internal.impl.xpath.regex.Op.nofinstances);
        ...
        if (!isSet(this.options, PROHIBIT_HEAD_CHARACTER_OPTIMIZATION)
            ...
            com.sun.org.apache.xerces.internal.impl.xpath.regex.RangeToken firstChar = com.sun.org.apache.xerces.internal.impl.xpath.regex.Token.createRange();
            int fresult = this.tokentree.analyzeFirstCharacter(firstChar, this.options);
            if (fresult == com.sun.org.apache.xerces.internal.impl.xpath.regex.Token.FC_TERMINAL) {
        ...
        if (this.operations != null
            && (this.operations.type == com.sun.org.apache.xerces.internal.impl.xpath.regex.Op.STRING || this.operations.type == com.sun.org.apache.xerces.internal.impl.xpath.regex.Op.CHAR)
            && this.operations.next == null) {
            if (DEBUG)
                System.err.print(" *** Only fixed string! *** ");
            this.fixedStringOnly = true;
            if (this.operations.type == com.sun.org.apache.xerces.internal.impl.xpath.regex.Op.STRING)
                this.fixedString = this.operations.getString();
            else if (this.operations.getData() >= 0x10000) { // Op.CHAR
                this.fixedString = com.sun.org.apache.xerces.internal.impl.xpath.regex.REUtil.decomposeToSurrogates(this.operations.getData());
            } else {
                char[] ac = new char[1];
            ...
            this.fixedStringTable = new com.sun.org.apache.xerces.internal.impl.xpath.regex.BMPattern(this.fixedString, 256,
                                                  isSet(this.fixedStringOptions, IGNORE_CASE));
        } else if (!isSet(this.options, PROHIBIT_FIXED_STRING_OPTIMIZATION)
                   && !isSet(this.options, XMLSCHEMA_MODE)) {
            com.sun.org.apache.xerces.internal.impl.xpath.regex.Token.FixedStringContainer container = new com.sun.org.apache.xerces.internal.impl.xpath.regex.Token.FixedStringContainer();
            ...
            if (this.fixedString != null) {
                ...
                if (DEBUG) {
                    System.err.println("DEBUG: The longest fixed string: "+this.fixedString.length()
                                       +"/" //+this.fixedString
                                       +"/"+ com.sun.org.apache.xerces.internal.impl.xpath.regex.REUtil.createOptionString(this.fixedStringOptions));
                    System.err.print("String: ");
                    com.sun.org.apache.xerces.internal.impl.xpath.regex.REUtil.dumpString(this.fixedString);
                }
            }
        }
    }
     ...
     */
    public RegularExpression(String regex) throws com.sun.org.apache.xerces.internal.impl.xpath.regex.ParseException {
        this(regex, null);
    }
     ...
     * @exception org.apache.xerces.utils.regex.ParseException <VAR>regex</VAR> is not conforming to the syntax.
     */
    public RegularExpression(String regex, String options) throws com.sun.org.apache.xerces.internal.impl.xpath.regex.ParseException {
     ...
     * @exception org.apache.xerces.utils.regex.ParseException <VAR>regex</VAR> is not conforming to the syntax.
     */
    public RegularExpression(String regex, String options, Locale locale) throws com.sun.org.apache.xerces.internal.impl.xpath.regex.ParseException {
        this.setPattern(regex, options, locale);
    }

    RegularExpression(String regex, com.sun.org.apache.xerces.internal.impl.xpath.regex.Token tok, int parens, boolean hasBackReferences, int options) {
        this.regex = regex;
        this.tokentree = tok;
     ...
     *
     */
    public void setPattern(String newPattern) throws com.sun.org.apache.xerces.internal.impl.xpath.regex.ParseException {
        this.setPattern(newPattern, Locale.getDefault());
    }

    public void setPattern(String newPattern, Locale locale) throws com.sun.org.apache.xerces.internal.impl.xpath.regex.ParseException {
        this.setPattern(newPattern, this.options, locale);
    }

    private void setPattern(String newPattern, int options, Locale locale) throws com.sun.org.apache.xerces.internal.impl.xpath.regex.ParseException {
        this.regex = newPattern;
        this.options = options;
        com.sun.org.apache.xerces.internal.impl.xpath.regex.RegexParser rp = RegularExpression.isSet(this.options, RegularExpression.XMLSCHEMA_MODE)
                         ? new ParserForXMLSchema(locale) : new com.sun.org.apache.xerces.internal.impl.xpath.regex.RegexParser(locale);
     ...
     *
     */
    public void setPattern(String newPattern, String options) throws com.sun.org.apache.xerces.internal.impl.xpath.regex.ParseException {
    ...
    public void setPattern(String newPattern, String options, Locale locale) throws ParseException {
        this.setPattern(newPattern, com.sun.org.apache.xerces.internal.impl.xpath.regex.REUtil.parseOptions(options), locale);
    }
    ...
    private static final int getWordType0(char ch, int opts) {
        if (!isSet(opts, UNICODE_WORD_BOUNDARY)) {
            if (isSet(opts, USE_UNICODE_CATEGORY)) {
                return (com.sun.org.apache.xerces.internal.impl.xpath.regex.Token.getRange("IsWord", true).match(ch)) ? WT_LETTER : WT_OTHER;
            }
