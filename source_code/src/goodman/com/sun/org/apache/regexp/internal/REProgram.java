 ...
 * this class.
*
 * @see com.sun.org.apache.regexp.internal.RE
 * @see RECompiler
 *
...
public class REProgram implements Serializable
{
    ...
    public void setInstructions(char[] instruction, int lenInstruction)
    {
        ...
        if (instruction != null && lenInstruction != 0)
        {
            ...
            if (lenInstruction >= com.sun.org.apache.regexp.internal.RE.nodeSize && instruction[0 + com.sun.org.apache.regexp.internal.RE.offsetOpcode] == com.sun.org.apache.regexp.internal.RE.OP_BRANCH)
            {
                // to the end node
                int next = instruction[0 + com.sun.org.apache.regexp.internal.RE.offsetNext];
                if (instruction[next + com.sun.org.apache.regexp.internal.RE.offsetOpcode] == com.sun.org.apache.regexp.internal.RE.OP_END)
                {
                    // and the branch starts with an atom
                    if (lenInstruction >= (com.sun.org.apache.regexp.internal.RE.nodeSize * 2) && instruction[com.sun.org.apache.regexp.internal.RE.nodeSize + com.sun.org.apache.regexp.internal.RE.offsetOpcode] == com.sun.org.apache.regexp.internal.RE.OP_ATOM)
                    {
                        // then get that atom as an prefix because there's no other choice
                        int lenAtom = instruction[com.sun.org.apache.regexp.internal.RE.nodeSize + com.sun.org.apache.regexp.internal.RE.offsetOpdata];
                        prefix = new char[lenAtom];
                        System.arraycopy(instruction, com.sun.org.apache.regexp.internal.RE.nodeSize * 2, prefix, 0, lenAtom);
                    }
                }
            }
            ...
            for (int i = 0; i < lenInstruction; i += com.sun.org.apache.regexp.internal.RE.nodeSize)
            {
                switch (instruction[i + com.sun.org.apache.regexp.internal.RE.offsetOpcode])
                {
                    case com.sun.org.apache.regexp.internal.RE.OP_ANYOF:
                        i += (instruction[i + com.sun.org.apache.regexp.internal.RE.offsetOpdata] * 2);
                        break;

                    case com.sun.org.apache.regexp.internal.RE.OP_ATOM:
                        i += instruction[i + com.sun.org.apache.regexp.internal.RE.offsetOpdata];
                        break;
