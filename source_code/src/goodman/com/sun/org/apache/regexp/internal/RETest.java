...
import goodman.java.io.FileReader;
import goodman.java.io.InputStreamReader;
...
import goodman.java.io.StringBufferInputStream;
...
public class RETest
{
    ...
    {
        com.sun.org.apache.regexp.internal.RE r = new com.sun.org.apache.regexp.internal.RE();
        try
        {
            // Compile expression
     ...
     */
    void showParens(com.sun.org.apache.regexp.internal.RE r)
    {
    ...
    void testOther() throws Exception
    {
        ...
        com.sun.org.apache.regexp.internal.RE r = new com.sun.org.apache.regexp.internal.RE("(a*)b");
        say("Serialized/deserialized (a*)b");
        ByteArrayOutputStream out = new ByteArrayOutputStream(128);
        new ObjectOutputStream(out).writeObject(r);
        ByteArrayInputStream in = new ByteArrayInputStream(out.toByteArray());
        r = (com.sun.org.apache.regexp.internal.RE)new ObjectInputStream(in).readObject();
        if (!r.match("aaab"))
        {
        ...
        r = new com.sun.org.apache.regexp.internal.RE("abc(\\w*)");
        say("MATCH_CASEINDEPENDENT abc(\\w*)");
        r.setMatchFlags(com.sun.org.apache.regexp.internal.RE.MATCH_CASEINDEPENDENT);
        say("abc(d*)");
        if (!r.match("abcddd"))
        {
        ...
        r = new com.sun.org.apache.regexp.internal.RE("(A*)b\\1");
        r.setMatchFlags(com.sun.org.apache.regexp.internal.RE.MATCH_CASEINDEPENDENT);
        ...
        r = new com.sun.org.apache.regexp.internal.RE("[A-Z]*");
        r.setMatchFlags(com.sun.org.apache.regexp.internal.RE.MATCH_CASEINDEPENDENT);
        if (!r.match("CaBgDe12"))
        {
        ...
        r = new com.sun.org.apache.regexp.internal.RE("^abc$", com.sun.org.apache.regexp.internal.RE.MATCH_MULTILINE);
        if (!r.match("\nabc")) {
        ...
        r = new com.sun.org.apache.regexp.internal.RE("^a.*b$", com.sun.org.apache.regexp.internal.RE.MATCH_MULTILINE);
        if (r.match("a\nb")) {
            fail("\"a\\nb\" matches \"^a.*b$\"");
        }
        if (r.match("a\rb")) {
    ...
    private void testPrecompiledRE()
    {
        ...
        com.sun.org.apache.regexp.internal.RE r = new com.sun.org.apache.regexp.internal.RE(re1);
        say("a*b");
    ...
    private void testSplitAndGrep()
    {
        ...
        r = new com.sun.org.apache.regexp.internal.RE("x+");
    ...
    private void testSubst()
    {
        ...
        r = new com.sun.org.apache.regexp.internal.RE("http://[\\.\\w\\-\\?/~_@&=%]+");
        actual = r.subst("visit us: http://www.apache.org!",
                         "1234<a href=\"$0\">$0</a>", com.sun.org.apache.regexp.internal.RE.REPLACE_BACKREFERENCES);
        ...
        r = new com.sun.org.apache.regexp.internal.RE("(.*?)=(.*)");
        actual = r.subst("variable=value",
                         "$1_test_$212", com.sun.org.apache.regexp.internal.RE.REPLACE_BACKREFERENCES);
        assertEquals("Wrong subst() result", "variable_test_value12", actual);

        // Test subst() with NO backreferences
        r = new com.sun.org.apache.regexp.internal.RE("^a$");
        actual = r.subst("a",
                         "b", com.sun.org.apache.regexp.internal.RE.REPLACE_BACKREFERENCES);
        assertEquals("Wrong subst() result", "b", actual);

        // Test subst() with NO backreferences
        r = new com.sun.org.apache.regexp.internal.RE("^a$", com.sun.org.apache.regexp.internal.RE.MATCH_MULTILINE);
        actual = r.subst("\r\na\r\n",
                         "b", com.sun.org.apache.regexp.internal.RE.REPLACE_BACKREFERENCES);
...
final class RETestCase
{
    ...
    private com.sun.org.apache.regexp.internal.RE regexp;
