...
final class Whitespace extends TopLevelElement {
    ...
    private final static class WhitespaceRule {
        ...
        public WhitespaceRule(int action, String element, int precedence) {
            ...
            if (colon >= 0) {
                ...
                _namespace = com.sun.org.apache.xalan.internal.xsltc.compiler.Constants.EMPTYSTRING;
                _element = element;
            }
            ...
            if (_element.equals("*")) {
                if (_namespace == com.sun.org.apache.xalan.internal.xsltc.compiler.Constants.EMPTYSTRING) {
    ...
    public void parseContents(com.sun.org.apache.xalan.internal.xsltc.compiler.Parser parser) {
        ...
        StringBuffer elements = new StringBuffer(com.sun.org.apache.xalan.internal.xsltc.compiler.Constants.EMPTYSTRING);
    ...
    */
    ...
    private static void compilePredicate(Vector rules,
        ...
        final com.sun.org.apache.xalan.internal.xsltc.compiler.XSLTC xsltc = classGen.getParser().getXSLTC();
