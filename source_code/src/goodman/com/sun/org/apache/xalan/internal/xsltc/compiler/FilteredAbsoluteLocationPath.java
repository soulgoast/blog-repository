 ...
 */
final class FilteredAbsoluteLocationPath extends com.sun.org.apache.xalan.internal.xsltc.compiler.Expression {
    private com.sun.org.apache.xalan.internal.xsltc.compiler.Expression _path;   // may be null

    public FilteredAbsoluteLocationPath() {
        _path = null;
    }

    public FilteredAbsoluteLocationPath(com.sun.org.apache.xalan.internal.xsltc.compiler.Expression path) {
        _path = path;
        if (path != null) {
    ...
    public com.sun.org.apache.xalan.internal.xsltc.compiler.Expression getPath() {
        return(_path);
    }
