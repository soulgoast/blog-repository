...
class FilterExpr extends com.sun.org.apache.xalan.internal.xsltc.compiler.Expression {
     ...
     */
    private com.sun.org.apache.xalan.internal.xsltc.compiler.Expression _primary;
    ...
    public FilterExpr(com.sun.org.apache.xalan.internal.xsltc.compiler.Expression primary, Vector predicates) {
        _primary = primary;
    ...
    protected com.sun.org.apache.xalan.internal.xsltc.compiler.Expression getExpr() {
        if (_primary instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.CastExpr)
            return ((com.sun.org.apache.xalan.internal.xsltc.compiler.CastExpr)_primary).getExpr();
        else
            return _primary;
    }
    ...
    public void setParser(Parser parser) {
        ...
        if (_predicates != null) {
            ...
            for (int i = 0; i < n; i++) {
                final com.sun.org.apache.xalan.internal.xsltc.compiler.Expression exp = (com.sun.org.apache.xalan.internal.xsltc.compiler.Expression)_predicates.elementAt(i);
    ...
    public Type typeCheck(SymbolTable stable) throws TypeCheckError {
        ...
        boolean canOptimize = _primary instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.KeyCall;

        if (ptype instanceof NodeSetType == false) {
            if (ptype instanceof ReferenceType)  {
                _primary = new com.sun.org.apache.xalan.internal.xsltc.compiler.CastExpr(_primary, Type.NodeSet);
            }
            else {
