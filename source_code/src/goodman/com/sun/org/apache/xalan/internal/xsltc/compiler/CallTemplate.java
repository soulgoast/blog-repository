 ...
 */
final class CallTemplate extends com.sun.org.apache.xalan.internal.xsltc.compiler.Instruction {
     ...
     */
    private com.sun.org.apache.xalan.internal.xsltc.compiler.Template _calleeTemplate = null;
    ...
    public Type typeCheck(com.sun.org.apache.xalan.internal.xsltc.compiler.SymbolTable stable) throws TypeCheckError {
        final com.sun.org.apache.xalan.internal.xsltc.compiler.Template template = stable.lookupTemplate(_name);
        if (template != null) {
    ...
    public void translate(ClassGenerator classGen, MethodGenerator methodGen) {
        ...
        if (_parameters != null) {
            for (int i = 0; i < _parameters.length; i++) {
                if (_parameters[i] instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.WithParam) {
                    ((com.sun.org.apache.xalan.internal.xsltc.compiler.WithParam)_parameters[i]).releaseResultTree(classGen, methodGen);
                }
            }
        }
     ...
     */
    public com.sun.org.apache.xalan.internal.xsltc.compiler.Template getCalleeTemplate() {
    ...
    private void buildParameterList() {
        ...
        Vector<com.sun.org.apache.xalan.internal.xsltc.compiler.Param> defaultParams = _calleeTemplate.getParameters();
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (node instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.WithParam) {
                ...
                for (int k = 0; k < numParams; k++) {
                    ...
                    if (parm instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.Param
                        && ((com.sun.org.apache.xalan.internal.xsltc.compiler.Param)parm).getName().equals(name)) {
                        withParam.setDoParameterOptimization(true);
                        _parameters[k] = withParam;
                        break;
                    }
                    else if (parm instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.WithParam
                        && ((com.sun.org.apache.xalan.internal.xsltc.compiler.WithParam)parm).getName().equals(name)) {
                        withParam.setDoParameterOptimization(true);
                        _parameters[k] = withParam;
                        break;
                    }
