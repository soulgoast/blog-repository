 ...
 */
public final class ResultTreeType extends com.sun.org.apache.xalan.internal.xsltc.compiler.util.Type {
    ...
    public com.sun.org.apache.bcel.internal.generic.Type toJCType() {
        return com.sun.org.apache.xalan.internal.xsltc.compiler.util.Util.getJCRefType(toSignature());
    }
     ...
     */
    public void translateTo(com.sun.org.apache.xalan.internal.xsltc.compiler.util.ClassGenerator classGen, MethodGenerator methodGen,
                            com.sun.org.apache.xalan.internal.xsltc.compiler.util.Type type) {
        if (type == com.sun.org.apache.xalan.internal.xsltc.compiler.util.Type.String) {
            translateTo(classGen, methodGen, (com.sun.org.apache.xalan.internal.xsltc.compiler.util.StringType)type);
        }
        else if (type == com.sun.org.apache.xalan.internal.xsltc.compiler.util.Type.Boolean) {
            translateTo(classGen, methodGen, (com.sun.org.apache.xalan.internal.xsltc.compiler.util.BooleanType)type);
        }
        else if (type == com.sun.org.apache.xalan.internal.xsltc.compiler.util.Type.Real) {
            translateTo(classGen, methodGen, (com.sun.org.apache.xalan.internal.xsltc.compiler.util.RealType)type);
        }
        else if (type == com.sun.org.apache.xalan.internal.xsltc.compiler.util.Type.NodeSet) {
            translateTo(classGen, methodGen, (com.sun.org.apache.xalan.internal.xsltc.compiler.util.NodeSetType)type);
        }
        else if (type == com.sun.org.apache.xalan.internal.xsltc.compiler.util.Type.Reference) {
            translateTo(classGen, methodGen, (com.sun.org.apache.xalan.internal.xsltc.compiler.util.ReferenceType)type);
        }
        else if (type == com.sun.org.apache.xalan.internal.xsltc.compiler.util.Type.Object) {
            translateTo(classGen, methodGen, (com.sun.org.apache.xalan.internal.xsltc.compiler.util.ObjectType) type);
        }
        else {
            com.sun.org.apache.xalan.internal.xsltc.compiler.util.ErrorMsg err = new com.sun.org.apache.xalan.internal.xsltc.compiler.util.ErrorMsg(com.sun.org.apache.xalan.internal.xsltc.compiler.util.ErrorMsg.DATA_CONVERSION_ERR,
     ...
     */
    public void translateTo(com.sun.org.apache.xalan.internal.xsltc.compiler.util.ClassGenerator classGen, MethodGenerator methodGen,
                            com.sun.org.apache.xalan.internal.xsltc.compiler.util.BooleanType type) {
        ...
        if (_methodName == null) {
            ...
            final LocalVariableGen handler =
                methodGen.addLocalVariable("rt_to_string_handler",
                                           com.sun.org.apache.xalan.internal.xsltc.compiler.util.Util.getJCRefType(STRING_VALUE_HANDLER_SIG),
                                           null, null);
    ...
    public void translateTo(com.sun.org.apache.xalan.internal.xsltc.compiler.util.ClassGenerator classGen, MethodGenerator methodGen,
                            RealType type) {
        translateTo(classGen, methodGen, com.sun.org.apache.xalan.internal.xsltc.compiler.util.Type.String);
        com.sun.org.apache.xalan.internal.xsltc.compiler.util.Type.String.translateTo(classGen, methodGen, com.sun.org.apache.xalan.internal.xsltc.compiler.util.Type.Real);
    }
    ...
    public void translateTo(com.sun.org.apache.xalan.internal.xsltc.compiler.util.ClassGenerator classGen, MethodGenerator methodGen,
        ...
        if (_methodName == null) {
            ...
            newDom = methodGen.addLocalVariable("rt_to_reference_dom",
                                                com.sun.org.apache.xalan.internal.xsltc.compiler.util.Util.getJCRefType(DOM_INTF_SIG),
                                                null, null);
     ...
     */
    public FlowList translateToDesynthesized(com.sun.org.apache.xalan.internal.xsltc.compiler.util.ClassGenerator classGen,
                                             MethodGenerator methodGen,
                                             BooleanType type) {
        final InstructionList il = methodGen.getInstructionList();
        translateTo(classGen, methodGen, com.sun.org.apache.xalan.internal.xsltc.compiler.util.Type.Boolean);
    ...
    public void translateTo(com.sun.org.apache.xalan.internal.xsltc.compiler.util.ClassGenerator classGen, MethodGenerator methodGen,
        ...
        if (className.equals("org.w3c.dom.Node")) {
            translateTo(classGen, methodGen, com.sun.org.apache.xalan.internal.xsltc.compiler.util.Type.NodeSet);
            int index = cpg.addInterfaceMethodref(DOM_INTF,
                                                  MAKE_NODE,
                                                  MAKE_NODE_SIG2);
            ...
            com.sun.org.apache.xalan.internal.xsltc.compiler.util.ErrorMsg err = new com.sun.org.apache.xalan.internal.xsltc.compiler.util.ErrorMsg(ErrorMsg.DATA_CONVERSION_ERR,
                                        toString(), className);
            classGen.getParser().reportError(Constants.FATAL, err);
        }
    }
     ...
     */
    public void translateBox(com.sun.org.apache.xalan.internal.xsltc.compiler.util.ClassGenerator classGen,
                             MethodGenerator methodGen) {
