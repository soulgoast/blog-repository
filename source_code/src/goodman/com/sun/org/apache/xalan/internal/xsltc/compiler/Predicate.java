...
import com.sun.org.apache.xalan.internal.xsltc.compiler.Step;
 ...
 */
final class Predicate extends Expression implements com.sun.org.apache.xalan.internal.xsltc.compiler.Closure {
     ...
     */
    private com.sun.org.apache.xalan.internal.xsltc.compiler.Closure _parentClosure = null;
     ...
     * Cached value of method <code>getCompareValue()</code>.
     */
    private com.sun.org.apache.xalan.internal.xsltc.compiler.Step _step = null;
    ...
    public com.sun.org.apache.xalan.internal.xsltc.compiler.Closure getParentClosure() {
        if (_parentClosure == null) {
            ...
            do {
                if (node instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.Closure) {
                    _parentClosure = (com.sun.org.apache.xalan.internal.xsltc.compiler.Closure) node;
                    break;
                }
    ...
    public void addVariable(VariableRefBase variableRef) {
        ...
        if (!_closureVars.contains(variableRef)) {
            ...
            com.sun.org.apache.xalan.internal.xsltc.compiler.Closure parentClosure = getParentClosure();
    ...
    public int getPosType() {
        if (_ptype == -1) {
            ...
            if (parent instanceof StepPattern) {
                ...
                if (exp instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.Step) {
                    _ptype = ((com.sun.org.apache.xalan.internal.xsltc.compiler.Step)exp).getNodeType();
                }
            }
            ...
            else if (parent instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.Step) {
                _ptype = ((com.sun.org.apache.xalan.internal.xsltc.compiler.Step)parent).getNodeType();
            }
        }
        return _ptype;
    }
    ...
    public Type typeCheck(SymbolTable stable) throws TypeCheckError {
        ...
        if (texp instanceof ReferenceType) {
            _exp = new com.sun.org.apache.xalan.internal.xsltc.compiler.CastExpr(_exp, texp = Type.Real);
        }
        ...
        if (texp instanceof ResultTreeType) {
            _exp = new com.sun.org.apache.xalan.internal.xsltc.compiler.CastExpr(_exp, Type.Boolean);
            _exp = new com.sun.org.apache.xalan.internal.xsltc.compiler.CastExpr(_exp, Type.Real);
        ...
        if (texp instanceof NumberType) {
            ...
            if (texp instanceof IntType == false) {
                _exp = new com.sun.org.apache.xalan.internal.xsltc.compiler.CastExpr(_exp, Type.Int);
            }
            ...
            if (_canOptimize) {
                ...
                if (_nthPositionFilter) {
                    SyntaxTreeNode parent = getParent();
                    _nthDescendant = (parent instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.Step) &&
   ...
   /**
    ...
    public com.sun.org.apache.xalan.internal.xsltc.compiler.Step getStep() {
        ...
        if (_exp instanceof EqualityExpr) {
            ...
            if (left instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.CastExpr) {
                left = ((com.sun.org.apache.xalan.internal.xsltc.compiler.CastExpr) left).getExpr();
            }
            if (left instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.Step) {
                _step = (com.sun.org.apache.xalan.internal.xsltc.compiler.Step) left;
            }

            // Unwrap and set _step if appropriate
            if (right instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.CastExpr) {
                right = ((com.sun.org.apache.xalan.internal.xsltc.compiler.CastExpr)right).getExpr();
            }
            if (right instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.Step) {
                _step = (com.sun.org.apache.xalan.internal.xsltc.compiler.Step)right;
            }
        }
        return _step;
    }
    ...
    public void translate(ClassGenerator classGen, MethodGenerator methodGen) {
        ...
        else if (isNodeValueTest() && (getParent() instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.Step)) {
