...
public class XSLTCDTMManager extends DTMManagerDefault
{
                    ...
                    boolean buildIdIndex, boolean newNameTable)
  {
        ...
        if ((null != source) && source instanceof StAXSource) {
            ...
            com.sun.org.apache.xalan.internal.xsltc.dom.SAXImpl dtm;

            if (size <= 0) {
                dtm = new com.sun.org.apache.xalan.internal.xsltc.dom.SAXImpl(this, source, documentID,
        ...
        else
        {
            ...
            if (isSAXSource || isStreamSource) {
                ...
                com.sun.org.apache.xalan.internal.xsltc.dom.SAXImpl dtm;
                if (size <= 0) {
                    dtm = new com.sun.org.apache.xalan.internal.xsltc.dom.SAXImpl(this, source, documentID, whiteSpaceFilter,
                                      null, doIndexing,
                                      DTMDefaultBase.DEFAULT_BLOCKSIZE,
                                      buildIdIndex, newNameTable);
                } else {
