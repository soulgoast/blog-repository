...
import com.sun.org.apache.xalan.internal.xsltc.compiler.ParameterRef;
...
import com.sun.org.apache.xalan.internal.xsltc.compiler.VariableRef;
...
final class UnresolvedRef extends VariableRefBase {
    ...
    private VariableRefBase resolve(Parser parser, com.sun.org.apache.xalan.internal.xsltc.compiler.SymbolTable stable) {
        // At this point the AST is already built and we should be able to
        // find any declared global variable or parameter
        com.sun.org.apache.xalan.internal.xsltc.compiler.VariableBase ref = parser.lookupVariable(_variableName);
        if (ref == null) {
            ref = (com.sun.org.apache.xalan.internal.xsltc.compiler.VariableBase)stable.lookupName(_variableName);
        }
        if (ref == null) {
            reportError();
            return null;
        ...
        if (ref instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.Variable) {
            return new com.sun.org.apache.xalan.internal.xsltc.compiler.VariableRef((com.sun.org.apache.xalan.internal.xsltc.compiler.Variable) ref);
        }
