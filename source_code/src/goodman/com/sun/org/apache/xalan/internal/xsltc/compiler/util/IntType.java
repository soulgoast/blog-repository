...
public final class IntType extends NumberType {
    ...
    public void translateTo(ClassGenerator classGen, MethodGenerator methodGen,
                            final com.sun.org.apache.xalan.internal.xsltc.compiler.util.Type type) {
        if (type == com.sun.org.apache.xalan.internal.xsltc.compiler.util.Type.Real) {
            translateTo(classGen, methodGen, (RealType) type);
        }
        else if (type == com.sun.org.apache.xalan.internal.xsltc.compiler.util.Type.String) {
