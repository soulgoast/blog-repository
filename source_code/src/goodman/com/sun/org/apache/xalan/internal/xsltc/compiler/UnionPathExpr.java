 ...
 */
final class UnionPathExpr extends com.sun.org.apache.xalan.internal.xsltc.compiler.Expression {
    ...
    public UnionPathExpr(com.sun.org.apache.xalan.internal.xsltc.compiler.Expression pathExpr, com.sun.org.apache.xalan.internal.xsltc.compiler.Expression rest) {
        _pathExpr = pathExpr;
        _rest     = rest;
    }
    ...
    public void setParser(Parser parser) {
        ...
        _components = (com.sun.org.apache.xalan.internal.xsltc.compiler.Expression[])components.toArray(new com.sun.org.apache.xalan.internal.xsltc.compiler.Expression[size]);
        for (int i = 0; i < size; i++) {
            _components[i].setParser(parser);
            _components[i].setParent(this);
            if (_components[i] instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.Step) {
                final com.sun.org.apache.xalan.internal.xsltc.compiler.Step step = (com.sun.org.apache.xalan.internal.xsltc.compiler.Step)_components[i];
        ...
        if (getParent() instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.Expression) _reverse = false;
    }
    ...
    public Type typeCheck(com.sun.org.apache.xalan.internal.xsltc.compiler.SymbolTable stable) throws TypeCheckError {
        ...
        for (int i = 0; i < length; i++) {
            if (_components[i].typeCheck(stable) != Type.NodeSet) {
                _components[i] = new com.sun.org.apache.xalan.internal.xsltc.compiler.CastExpr(_components[i], Type.NodeSet);
            }
        }
