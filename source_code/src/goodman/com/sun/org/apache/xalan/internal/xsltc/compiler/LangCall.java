...
final class LangCall extends FunctionCall {
     ...
     *   lang(string)
     */
    public LangCall(com.sun.org.apache.xalan.internal.xsltc.compiler.QName fname, Vector arguments) {
    ...
    public Type typeCheck(SymbolTable stable) throws TypeCheckError {
        ...
        if (!(_langType instanceof StringType)) {
            _lang = new com.sun.org.apache.xalan.internal.xsltc.compiler.CastExpr(_lang, Type.String);
        }
        return Type.Boolean;
    }
