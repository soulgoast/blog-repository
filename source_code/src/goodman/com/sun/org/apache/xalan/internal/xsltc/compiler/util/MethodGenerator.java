...
public class MethodGenerator extends MethodGen
     ...
     * methods by
     * {@link #outline(InstructionHandle,InstructionHandle,String, com.sun.org.apache.xalan.internal.xsltc.compiler.util.ClassGenerator)},
     ...
     */
    private ArrayList getCandidateChunks(com.sun.org.apache.xalan.internal.xsltc.compiler.util.ClassGenerator classGen,
                                         int totalMethodSize) {
        ...
        if (m_openChunks != 0) {
            String msg =
                (new com.sun.org.apache.xalan.internal.xsltc.compiler.util.ErrorMsg(com.sun.org.apache.xalan.internal.xsltc.compiler.util.ErrorMsg.OUTLINE_ERR_UNBALANCED_MARKERS))
                    .toString();
            throw new com.sun.org.apache.xalan.internal.xsltc.compiler.util.InternalError(msg);
        }
     ...
     *         method itself
     */
    public Method[] outlineChunks(com.sun.org.apache.xalan.internal.xsltc.compiler.util.ClassGenerator classGen,
        ...
        if (currentMethodSize > MAX_METHOD_SIZE) {
            String msg = (new com.sun.org.apache.xalan.internal.xsltc.compiler.util.ErrorMsg(com.sun.org.apache.xalan.internal.xsltc.compiler.util.ErrorMsg.OUTLINE_ERR_METHOD_TOO_BIG))
                                  .toString();
            throw new com.sun.org.apache.xalan.internal.xsltc.compiler.util.InternalError(msg);
        }
     ...
     * @param classGen The {@link com.sun.org.apache.xalan.internal.xsltc.compiler.util.ClassGenerator} of which the original
    ...
    private Method outline(InstructionHandle first, InstructionHandle last,
                           String outlinedMethodName, com.sun.org.apache.xalan.internal.xsltc.compiler.util.ClassGenerator classGen) {
        // We're not equipped to deal with exception handlers yet.  Bail out!
        if (getExceptionHandlers().length != 0) {
            String msg = (new com.sun.org.apache.xalan.internal.xsltc.compiler.util.ErrorMsg(com.sun.org.apache.xalan.internal.xsltc.compiler.util.ErrorMsg.OUTLINE_ERR_TRY_CATCH))
                                  .toString();
            throw new com.sun.org.apache.xalan.internal.xsltc.compiler.util.InternalError(msg);
        }
        ...
        com.sun.org.apache.xalan.internal.xsltc.compiler.util.ClassGenerator copyAreaCG
            = new com.sun.org.apache.xalan.internal.xsltc.compiler.util.ClassGenerator(argTypeName, OBJECT_CLASS, argTypeName+".java",
    ...
    public void markChunkEnd() {
        ...
        m_openChunks--;
        if (m_openChunks < 0) {
            String msg = (new com.sun.org.apache.xalan.internal.xsltc.compiler.util.ErrorMsg(com.sun.org.apache.xalan.internal.xsltc.compiler.util.ErrorMsg.OUTLINE_ERR_UNBALANCED_MARKERS))
                                 .toString();
            throw new com.sun.org.apache.xalan.internal.xsltc.compiler.util.InternalError(msg);
        }
    }
     ...
     * @param classGen the {@link com.sun.org.apache.xalan.internal.xsltc.compiler.util.ClassGenerator} of which these methods are
     *                 members
            ...
            if (inst instanceof IfInstruction) {
                ...
                if ((relativeTargetOffset - maxOffsetChange
                    ...
                    try {
                        ...
                        String msg =
                            new com.sun.org.apache.xalan.internal.xsltc.compiler.util.ErrorMsg(ErrorMsg.OUTLINE_ERR_DELETED_TARGET,
