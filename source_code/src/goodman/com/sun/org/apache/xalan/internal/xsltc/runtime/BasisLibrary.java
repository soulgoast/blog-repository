...
package goodman.com.sun.org.apache.xalan.internal.xsltc.runtime;
...
import goodman.java.text.DecimalFormat;
import goodman.java.text.DecimalFormatSymbols;
import goodman.java.text.FieldPosition;
import goodman.java.text.MessageFormat;
import goodman.java.text.NumberFormat;
import goodman.java.util.Locale;
import goodman.java.util.ResourceBundle;
import goodman.java.util.concurrent.atomic.AtomicInteger;
import goodman.javax.xml.transform.dom.DOMSource;
...
public final class BasisLibrary {
    ...
    public static String stringF(Object obj, DOM dom) {
        ...
        else if (obj instanceof com.sun.org.apache.xalan.internal.xsltc.runtime.Node) {
            return dom.getStringValueX(((com.sun.org.apache.xalan.internal.xsltc.runtime.Node)obj).node);
        }
    ...
    public static double numberF(Object obj, DOM dom) {
        if (obj instanceof Double) {
            ...
            return stringToReal(dom.getStringValueX(((com.sun.org.apache.xalan.internal.xsltc.runtime.Node) obj).node));
        }
        else if (obj instanceof DOM) {
    ...
    private static boolean compareStrings(String lstring, String rstring,
                                          int op, DOM dom) {
        switch (op) {
    case com.sun.org.apache.xalan.internal.xsltc.runtime.Operators.EQ:
            return lstring.equals(rstring);

    case com.sun.org.apache.xalan.internal.xsltc.runtime.Operators.NE:
            return !lstring.equals(rstring);

    case com.sun.org.apache.xalan.internal.xsltc.runtime.Operators.GT:
            return numberF(lstring, dom) > numberF(rstring, dom);

    case com.sun.org.apache.xalan.internal.xsltc.runtime.Operators.LT:
            return numberF(lstring, dom) < numberF(rstring, dom);

    case com.sun.org.apache.xalan.internal.xsltc.runtime.Operators.GE:
            return numberF(lstring, dom) >= numberF(rstring, dom);

    case com.sun.org.apache.xalan.internal.xsltc.runtime.Operators.LE:
            return numberF(lstring, dom) <= numberF(rstring, dom);
    ...
    public static boolean compare(DTMAxisIterator left, DTMAxisIterator right,
        ...
        while ((lnode = left.next()) != DTMAxisIterator.END) {
            ...
            while ((rnode = right.next()) != DTMAxisIterator.END) {
                ...
                if (lnode == rnode) {
                    if (op == com.sun.org.apache.xalan.internal.xsltc.runtime.Operators.EQ) {
                        return true;
                    } else if (op == com.sun.org.apache.xalan.internal.xsltc.runtime.Operators.NE) {
                        continue;
                    }
                }
    ...
    if (op != com.sun.org.apache.xalan.internal.xsltc.runtime.Operators.EQ && op != com.sun.org.apache.xalan.internal.xsltc.runtime.Operators.NE) {
            // If node-boolean comparison -> convert node to boolean
            if (left instanceof com.sun.org.apache.xalan.internal.xsltc.runtime.Node || right instanceof com.sun.org.apache.xalan.internal.xsltc.runtime.Node) {
        ...
        if (hasSimpleArgs) {
            ...
            if (op == com.sun.org.apache.xalan.internal.xsltc.runtime.Operators.NE) {
                result = !result;
            }
        }
        else {
            if (left instanceof com.sun.org.apache.xalan.internal.xsltc.runtime.Node) {
                left = new SingletonIterator(((com.sun.org.apache.xalan.internal.xsltc.runtime.Node)left).node);
            }
            if (right instanceof com.sun.org.apache.xalan.internal.xsltc.runtime.Node) {
                right = new SingletonIterator(((com.sun.org.apache.xalan.internal.xsltc.runtime.Node)right).node);
            }
            ...
            if (hasSimpleType(left) ||
                ...
                op = com.sun.org.apache.xalan.internal.xsltc.runtime.Operators.swapOp(op);
            }

            if (left instanceof DOM) {
                if (right instanceof Boolean) {
                    result = ((Boolean)right).booleanValue();
                    return result == (op == com.sun.org.apache.xalan.internal.xsltc.runtime.Operators.EQ);
                }
    ...
    private static boolean hasSimpleType(Object obj) {
        return obj instanceof Boolean || obj instanceof Double ||
            ...
            obj instanceof com.sun.org.apache.xalan.internal.xsltc.runtime.Node || obj instanceof DOM;
    }
    ...
    public static DTMAxisIterator referenceToNodeSet(Object obj) {
        ...
        if (obj instanceof com.sun.org.apache.xalan.internal.xsltc.runtime.Node) {
            return(new SingletonIterator(((com.sun.org.apache.xalan.internal.xsltc.runtime.Node)obj).node));
        }
    ...
    public static NodeList referenceToNodeList(Object obj, DOM dom) {
        if (obj instanceof com.sun.org.apache.xalan.internal.xsltc.runtime.Node || obj instanceof DTMAxisIterator) {
