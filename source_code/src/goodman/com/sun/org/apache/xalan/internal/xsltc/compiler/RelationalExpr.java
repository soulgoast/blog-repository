...
import com.sun.org.apache.xalan.internal.xsltc.compiler.VariableRefBase;
 ...
 */
final class RelationalExpr extends com.sun.org.apache.xalan.internal.xsltc.compiler.Expression {

    private int _op;
    private com.sun.org.apache.xalan.internal.xsltc.compiler.Expression _left, _right;

    public RelationalExpr(int op, com.sun.org.apache.xalan.internal.xsltc.compiler.Expression left, com.sun.org.apache.xalan.internal.xsltc.compiler.Expression right) {
        _op = op;
    ...
    public Type typeCheck(com.sun.org.apache.xalan.internal.xsltc.compiler.SymbolTable stable) throws TypeCheckError {
        ...
        if (hasReferenceArgs()) {
            ...
            if (tleft instanceof ReferenceType) {
                if (_left instanceof VariableRefBase) {
                    ...
                    com.sun.org.apache.xalan.internal.xsltc.compiler.VariableBase var = ref.getVariable();
                    typeL = var.getType();
                }
            }
            ...
            _right = new com.sun.org.apache.xalan.internal.xsltc.compiler.CastExpr(_right, type);
            _left = new com.sun.org.apache.xalan.internal.xsltc.compiler.CastExpr(_left, type);
            return _type = Type.Boolean;
        }
        ...
        if (hasNodeSetArgs()) {
            ...
            if (tright instanceof NodeSetType) {
                final com.sun.org.apache.xalan.internal.xsltc.compiler.Expression temp = _right; _right = _left; _left = temp;
    ...
    MethodType ptype = lookupPrimop(stable, Operators.getOpNames(_op),
        ...
        if (ptype != null) {
            ...
            if (!arg1.identicalTo(tleft)) {
                _left = new com.sun.org.apache.xalan.internal.xsltc.compiler.CastExpr(_left, arg1);
            }
            Type arg2 = (Type) ptype.argsType().elementAt(1);
            if (!arg2.identicalTo(tright)) {
                _right = new com.sun.org.apache.xalan.internal.xsltc.compiler.CastExpr(_right, arg1);
            }
