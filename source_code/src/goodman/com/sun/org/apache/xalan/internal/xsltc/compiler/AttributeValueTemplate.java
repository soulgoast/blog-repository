...
final class AttributeValueTemplate extends com.sun.org.apache.xalan.internal.xsltc.compiler.AttributeValue {
    ...
    public AttributeValueTemplate(String value, com.sun.org.apache.xalan.internal.xsltc.compiler.Parser parser,
    ...
    private void parseAVTemplate(String text, Parser parser) {
        ...
        while (tokenizer.hasMoreTokens()) {
            ...
            if (t.equals(DELIMITER)) {
                ...
                addElement(new com.sun.org.apache.xalan.internal.xsltc.compiler.LiteralExpr(t));
            }
        }
    }

    public Type typeCheck(com.sun.org.apache.xalan.internal.xsltc.compiler.SymbolTable stable) throws TypeCheckError {
        final List<com.sun.org.apache.xalan.internal.xsltc.compiler.SyntaxTreeNode> contents = getContents();
        final int n = contents.size();
        for (int i = 0; i < n; i++) {
            final com.sun.org.apache.xalan.internal.xsltc.compiler.Expression exp = (com.sun.org.apache.xalan.internal.xsltc.compiler.Expression)contents.get(i);
            if (!exp.typeCheck(stable).identicalTo(Type.String)) {
                contents.set(i, new com.sun.org.apache.xalan.internal.xsltc.compiler.CastExpr(exp, Type.String));
            }
        }
    ...
    public void translate(ClassGenerator classGen, MethodGenerator methodGen) {
        if (elementCount() == 1) {
            final com.sun.org.apache.xalan.internal.xsltc.compiler.Expression exp = (com.sun.org.apache.xalan.internal.xsltc.compiler.Expression)elementAt(0);
            ...
            while (elements.hasNext()) {
                final com.sun.org.apache.xalan.internal.xsltc.compiler.Expression exp = (com.sun.org.apache.xalan.internal.xsltc.compiler.Expression)elements.next();
                exp.translate(classGen, methodGen);
                il.append(append);
            }
