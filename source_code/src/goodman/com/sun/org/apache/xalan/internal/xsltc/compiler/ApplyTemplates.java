...
final class ApplyTemplates extends com.sun.org.apache.xalan.internal.xsltc.compiler.Instruction {
    ...
    public void translate(ClassGenerator classGen, MethodGenerator methodGen) {
        ...
        final Vector<com.sun.org.apache.xalan.internal.xsltc.compiler.Sort> sortObjects = new Vector<>();
        for (final SyntaxTreeNode child : getContents()) {
            if (child instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.Sort) {
                sortObjects.addElement((com.sun.org.apache.xalan.internal.xsltc.compiler.Sort)child);
            }
        }
        ...
        if ((_type != null) && (_type instanceof ResultTreeType)) {
            ...
            if (sortObjects.size() > 0) {
                com.sun.org.apache.xalan.internal.xsltc.compiler.Sort.translateSortIterator(classGen, methodGen,
                                           _select, sortObjects);
        ...
        for (final SyntaxTreeNode child : getContents()) {
            if (child instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.WithParam) {
                ((com.sun.org.apache.xalan.internal.xsltc.compiler.WithParam)child).releaseResultTree(classGen, methodGen);
            }
        }
