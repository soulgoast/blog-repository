 ...
 */
final class XslAttribute extends com.sun.org.apache.xalan.internal.xsltc.compiler.Instruction {
    ...
    public void parseContents(Parser parser) {
        ...
        for (int i = 0; i < parent.elementCount(); i++) {
            ...
            if (item instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.If) continue;
            if (item instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.Choose) continue;
            if (item instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.CopyOf) continue;
            if (item instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.VariableBase) continue;
        ...
        if (namespace != null && namespace != com.sun.org.apache.xalan.internal.xsltc.compiler.Constants.EMPTYSTRING) {
            _prefix = lookupPrefix(namespace);
            _namespace = new AttributeValueTemplate(namespace, parser, this);
        }
        // Get namespace from prefix in name attribute?
        else if (prefix != null && prefix != com.sun.org.apache.xalan.internal.xsltc.compiler.Constants.EMPTYSTRING) {
            _prefix = prefix;
