...
import com.sun.org.apache.xalan.internal.xsltc.compiler.Mode;
...
public final class Stylesheet extends SyntaxTreeNode {
     ...
     */
    private final Map<String, com.sun.org.apache.xalan.internal.xsltc.compiler.Mode> _modes = new HashMap<>();
     ...
     */
    private Map<String, com.sun.org.apache.xalan.internal.xsltc.compiler.Key> _keys = new HashMap<>();
     ...
     */
    private com.sun.org.apache.xalan.internal.xsltc.compiler.Output _lastOutputElement = null;
    ...
    public void setImportPrecedence(final int precedence) {
        ...
        while (elements.hasNext()) {
            ...
            if (child instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.Include) {
                Stylesheet included = ((com.sun.org.apache.xalan.internal.xsltc.compiler.Include)child).getIncludedStylesheet();
        ...
        if (_importedFrom != null) {
            if (_importedFrom.getImportPrecedence() < precedence) {
                final com.sun.org.apache.xalan.internal.xsltc.compiler.Parser parser = getParser();
    ...
    public boolean hasLocalParams() {
        if (_hasLocalParams == null) {
            ...
            for (int i = 0; i < n; i++) {
                final com.sun.org.apache.xalan.internal.xsltc.compiler.Template template = (com.sun.org.apache.xalan.internal.xsltc.compiler.Template)templates.elementAt(i);
    ...
    public void declareExtensionPrefixes(com.sun.org.apache.xalan.internal.xsltc.compiler.Parser parser) {
    ...
    public void parseContents(com.sun.org.apache.xalan.internal.xsltc.compiler.Parser parser) {
        ...
        */
        ...
        if (sheet != null) {
            ...
            parser.reportError(com.sun.org.apache.xalan.internal.xsltc.compiler.Constants.ERROR, err);
        }
        ...
        if (_simplified) {
            ...
            com.sun.org.apache.xalan.internal.xsltc.compiler.Template template = new com.sun.org.apache.xalan.internal.xsltc.compiler.Template();
    ...
    public final void parseOwnChildren(Parser parser) {
        ...
        stable.excludeURI(com.sun.org.apache.xalan.internal.xsltc.compiler.Constants.XSLT_URI);
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (!_templateInlining && (child instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.Template)) {
                com.sun.org.apache.xalan.internal.xsltc.compiler.Template template = (com.sun.org.apache.xalan.internal.xsltc.compiler.Template)child;
    ...
    public void processModes() {
        if (_defaultMode == null)
            _defaultMode = new com.sun.org.apache.xalan.internal.xsltc.compiler.Mode(null, this, com.sun.org.apache.xalan.internal.xsltc.compiler.Constants.EMPTYSTRING);
        _defaultMode.processPatterns(_keys);
        for (com.sun.org.apache.xalan.internal.xsltc.compiler.Mode mode : _modes.values()) {
    ...
    public com.sun.org.apache.xalan.internal.xsltc.compiler.Mode getMode(com.sun.org.apache.xalan.internal.xsltc.compiler.QName modeName) {
        if (modeName == null) {
            ...
            com.sun.org.apache.xalan.internal.xsltc.compiler.Mode mode = _modes.get(modeName.getStringRep());
            if (mode == null) {
                final String suffix = Integer.toString(_nextModeSerial++);
                _modes.put(modeName.getStringRep(), mode = new com.sun.org.apache.xalan.internal.xsltc.compiler.Mode(modeName, this, suffix));
            }
            return mode;
        }
    }
    ...
    public void translate() {
        ...
        final ClassGenerator classGen =
            new ClassGenerator(_className,
                               TRANSLET_CLASS,
                               com.sun.org.apache.xalan.internal.xsltc.compiler.Constants.EMPTYSTRING,
        ...
        while (elements.hasNext()) {
            ...
            // xsl:template
            if (element instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.Template) {
                // Separate templates by modes
                final com.sun.org.apache.xalan.internal.xsltc.compiler.Template template = (com.sun.org.apache.xalan.internal.xsltc.compiler.Template)element;
            ...
            else if (element instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.Output) {
                // save the element for later to pass to compileConstructor
                com.sun.org.apache.xalan.internal.xsltc.compiler.Output output = (com.sun.org.apache.xalan.internal.xsltc.compiler.Output)element;
     ...
     */
    private void compileConstructor(ClassGenerator classGen, com.sun.org.apache.xalan.internal.xsltc.compiler.Output output) {
    ...
    private String compileTopLevel(ClassGenerator classGen) {
        ...
        while (elements.hasNext()) {
            SyntaxTreeNode element = elements.next();
            if (element instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.Key) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (tle instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.Key) {
                final com.sun.org.apache.xalan.internal.xsltc.compiler.Key key = (com.sun.org.apache.xalan.internal.xsltc.compiler.Key) tle;
    ...
    private String compileBuildKeys(ClassGenerator classGen) {
        ...
        while (elements.hasNext()) {
            ...
            if (element instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.Key) {
                final com.sun.org.apache.xalan.internal.xsltc.compiler.Key key = (com.sun.org.apache.xalan.internal.xsltc.compiler.Key)element;
