 ...
 */
final class LiteralElement extends com.sun.org.apache.xalan.internal.xsltc.compiler.Instruction {
    ...
    public void registerNamespace(String prefix, String uri,
                                  com.sun.org.apache.xalan.internal.xsltc.compiler.SymbolTable stable, boolean declared) {
     ...
     */
    private String translateQName(com.sun.org.apache.xalan.internal.xsltc.compiler.QName qname, com.sun.org.apache.xalan.internal.xsltc.compiler.SymbolTable stable) {
        ...
        if (prefix != com.sun.org.apache.xalan.internal.xsltc.compiler.Constants.EMPTYSTRING)
    ...
    public void translate(ClassGenerator classGen, MethodGenerator methodGen) {
        ...
        if (_attributeElements != null) {
            for (SyntaxTreeNode node : _attributeElements) {
                if (!(node instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.XslAttribute)) {
    ...
    private boolean checkAttributesUnique() {
         ...
         if (_attributeElements != null) {
             ...
             for (int i = 0; i < numAttrs; i++) {
                 ...
                 if (node instanceof UseAttributeSets) {
                 ...
                 else if (node instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.XslAttribute) {
                     if (attrsTable == null) {
                     ...
                     com.sun.org.apache.xalan.internal.xsltc.compiler.XslAttribute xslAttr = (com.sun.org.apache.xalan.internal.xsltc.compiler.XslAttribute)node;
    ...
    private boolean canProduceAttributeNodes(SyntaxTreeNode node, boolean ignoreXslAttribute) {
        ...
        for (SyntaxTreeNode child : contents) {
            ...
            // We can safely return false when the instruction can produce an output node.
                ...
                || child instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.XslElement
                ...
                return false;
            else if (child instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.XslAttribute) {
            ...
            else if (child instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.CallTemplate
                || child instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.ApplyTemplates
                || child instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.Copy
                || child instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.CopyOf)
                return true;
            else if ((child instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.If
                       || child instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.ForEach)
                     && canProduceAttributeNodes(child, false)) {
                return true;
            }
            else if (child instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.Choose) {
                List<SyntaxTreeNode> chooseContents = child.getContents();
                for (SyntaxTreeNode chooseChild : chooseContents) {
                    if (chooseChild instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.When || chooseChild instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.Otherwise) {
