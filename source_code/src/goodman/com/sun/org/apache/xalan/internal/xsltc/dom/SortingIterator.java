...
public final class SortingIterator extends DTMAxisIteratorBase {
    ...
    private com.sun.org.apache.xalan.internal.xsltc.dom.NodeSortRecord[] _data;
    private int _free = 0;
    ...
    public DTMAxisIterator setStartNode(int node) {
        try {
            ...
            _data = new com.sun.org.apache.xalan.internal.xsltc.dom.NodeSortRecord[INIT_DATA_SIZE];
            _free = 0;
    ...
    private void addRecord(com.sun.org.apache.xalan.internal.xsltc.dom.NodeSortRecord record) {
        if (_free == _data.length) {
            com.sun.org.apache.xalan.internal.xsltc.dom.NodeSortRecord[] newArray = new com.sun.org.apache.xalan.internal.xsltc.dom.NodeSortRecord[_data.length * 2];
    ...
    private int partition(int p, int r) {
        final com.sun.org.apache.xalan.internal.xsltc.dom.NodeSortRecord x = _data[(p + r) >>> 1];
        int i = p - 1;
        int j = r + 1;
        while (true) {
