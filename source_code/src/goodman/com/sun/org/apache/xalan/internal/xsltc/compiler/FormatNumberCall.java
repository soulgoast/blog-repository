 ...
 */
final class FormatNumberCall extends com.sun.org.apache.xalan.internal.xsltc.compiler.FunctionCall {
    private com.sun.org.apache.xalan.internal.xsltc.compiler.Expression _value;
    private com.sun.org.apache.xalan.internal.xsltc.compiler.Expression _format;
    ...
    public Type typeCheck(com.sun.org.apache.xalan.internal.xsltc.compiler.SymbolTable stable) throws TypeCheckError {
        ...
        if (tvalue instanceof RealType == false) {
            _value = new com.sun.org.apache.xalan.internal.xsltc.compiler.CastExpr(_value, Type.Real);
        }
        final Type tformat = _format.typeCheck(stable);
        if (tformat instanceof StringType == false) {
            _format = new com.sun.org.apache.xalan.internal.xsltc.compiler.CastExpr(_format, Type.String);
        }
        if (argumentCount() == 3) {
