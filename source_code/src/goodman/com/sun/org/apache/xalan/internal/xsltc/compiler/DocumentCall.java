...
final class DocumentCall extends FunctionCall {
    ...
    private com.sun.org.apache.xalan.internal.xsltc.compiler.Expression _arg1 = null;
    private com.sun.org.apache.xalan.internal.xsltc.compiler.Expression _arg2 = null;
    ...
    public Type typeCheck(com.sun.org.apache.xalan.internal.xsltc.compiler.SymbolTable stable) throws TypeCheckError {
        ...
        if ((_arg1Type != Type.NodeSet) && (_arg1Type != Type.String)) {
            _arg1 = new com.sun.org.apache.xalan.internal.xsltc.compiler.CastExpr(_arg1, Type.String);
        }
        ...
        if (ac == 2) {
            ...
            if (arg2Type.identicalTo(Type.Node)) {
                _arg2 = new com.sun.org.apache.xalan.internal.xsltc.compiler.CastExpr(_arg2, Type.NodeSet);
