...
import goodman.java.io.BufferedOutputStream;
...
public abstract class AbstractTranslet implements Translet {
    ...
    public final Object addParameter(String name, Object value) {
        name = com.sun.org.apache.xalan.internal.xsltc.runtime.BasisLibrary.mapQNameToJavaName (name);
        ...
        boolean isDefault)
    {
        ...
        for (int i = pframe - 1; i >= pbase; i--) {
            final com.sun.org.apache.xalan.internal.xsltc.runtime.Parameter param = (com.sun.org.apache.xalan.internal.xsltc.runtime.Parameter) paramsStack.get(i);
        ...
        paramsStack.add(pframe++, new com.sun.org.apache.xalan.internal.xsltc.runtime.Parameter(name, value, isDefault));
        return value;
    }
    ...
    public final Object getParameter(String name) {
        ...
        for (int i = pframe - 1; i >= pbase; i--) {
            final com.sun.org.apache.xalan.internal.xsltc.runtime.Parameter param = (Parameter)paramsStack.get(i);
    ...
    private com.sun.org.apache.xalan.internal.xsltc.runtime.MessageHandler _msgHandler = null;
    ...
    public final void postInitialization() {
        ...
        if (transletVersion > CURRENT_TRANSLET_VERSION) {
            com.sun.org.apache.xalan.internal.xsltc.runtime.BasisLibrary.runTimeError(BasisLibrary.UNKNOWN_TRANSLET_VERSION_ERR,
