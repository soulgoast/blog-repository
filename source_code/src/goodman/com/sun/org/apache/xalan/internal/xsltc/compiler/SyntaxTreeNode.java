 ...
 */
public abstract class SyntaxTreeNode implements com.sun.org.apache.xalan.internal.xsltc.compiler.Constants {
    ...
    private com.sun.org.apache.xalan.internal.xsltc.compiler.Stylesheet _stylesheet;      // Stylesheet ancestor node
    private com.sun.org.apache.xalan.internal.xsltc.compiler.Template _template;        // Template ancestor node
    ...
    protected String lookupNamespace(String prefix) {
        ...
        if ((uri == null) && (_parent != null)) {
            ...
            if ((prefix == com.sun.org.apache.xalan.internal.xsltc.compiler.Constants.EMPTYSTRING) && (uri == null))
                uri = com.sun.org.apache.xalan.internal.xsltc.compiler.Constants.EMPTYSTRING;
        }
    ...
    protected String lookupPrefix(String uri) {
        ...
        // ... but if we can't find it there we ask our parent for the mapping
            ...
            if ((uri == com.sun.org.apache.xalan.internal.xsltc.compiler.Constants.EMPTYSTRING) && (prefix == null))
                prefix = com.sun.org.apache.xalan.internal.xsltc.compiler.Constants.EMPTYSTRING;
        }
        return(prefix);
    }
     ...
     */
    protected void setParser(com.sun.org.apache.xalan.internal.xsltc.compiler.Parser parser) {
        _parser = parser;
    }
    ...
    protected int getImportPrecedence() {
        com.sun.org.apache.xalan.internal.xsltc.compiler.Stylesheet stylesheet = getStylesheet();
    ...
    public com.sun.org.apache.xalan.internal.xsltc.compiler.Stylesheet getStylesheet() {
        if (_stylesheet == null) {
            ...
            while (parent != null) {
                if (parent instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.Stylesheet)
                    return((com.sun.org.apache.xalan.internal.xsltc.compiler.Stylesheet)parent);
                parent = parent.getParent();
            }
            _stylesheet = (com.sun.org.apache.xalan.internal.xsltc.compiler.Stylesheet)parent;
        }
        return(_stylesheet);
    }
    ...
    protected com.sun.org.apache.xalan.internal.xsltc.compiler.Template getTemplate() {
        if (_template == null) {
            SyntaxTreeNode parent = this;
            while ((parent != null) && (!(parent instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.Template)))
                parent = parent.getParent();
     ...
     * @param parser reference to the XSLT parser
     */
    protected final void parseChildren(com.sun.org.apache.xalan.internal.xsltc.compiler.Parser parser) {

        List<com.sun.org.apache.xalan.internal.xsltc.compiler.QName> locals = null;   // only create when needed
        ...
        if (locals != null) {
            for (com.sun.org.apache.xalan.internal.xsltc.compiler.QName varOrParamName : locals) {
     ...
     */
    protected com.sun.org.apache.xalan.internal.xsltc.compiler.QName updateScope(com.sun.org.apache.xalan.internal.xsltc.compiler.Parser parser, SyntaxTreeNode node) {
        ...
        else if (node instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.Param) {
            final com.sun.org.apache.xalan.internal.xsltc.compiler.Param param = (com.sun.org.apache.xalan.internal.xsltc.compiler.Param)node;
     ...
     */
    public abstract Type typeCheck(com.sun.org.apache.xalan.internal.xsltc.compiler.SymbolTable stable) throws TypeCheckError;

    /**
     * Call typeCheck() on all child syntax tree nodes.
     * @param stable The compiler/parser's symbol table
     */
    protected Type typeCheckContents(com.sun.org.apache.xalan.internal.xsltc.compiler.SymbolTable stable) throws TypeCheckError {
    ...
    protected void translateContents(ClassGenerator classGen,
        ...
        for (int i = 0; i < n; i++) {
            if ( _contents.get(i) instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.VariableBase) {
                final com.sun.org.apache.xalan.internal.xsltc.compiler.VariableBase var = (com.sun.org.apache.xalan.internal.xsltc.compiler.VariableBase)_contents.get(i);
    ...
    private boolean isTextElement(SyntaxTreeNode node, boolean doExtendedCheck) {
        if (node instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.ValueOf || node instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.Number
            || node instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.Text)
        {
            return true;
        }
        else if (node instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.If) {
            return doExtendedCheck ? isAdaptiveRTF(node) : isSimpleRTF(node);
        }
        else if (node instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.Choose) {
            List<SyntaxTreeNode> contents = node.getContents();
            for (SyntaxTreeNode item : contents) {
                if (item instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.Text ||
                     ((item instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.When || item instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.Otherwise)
            ...
            return true;
                  ...
                  (node instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.CallTemplate
                   || node instanceof com.sun.org.apache.xalan.internal.xsltc.compiler.ApplyTemplates))
            return true;
        else
            return false;
    }
     ...
     */
    protected void reportError(SyntaxTreeNode element, com.sun.org.apache.xalan.internal.xsltc.compiler.Parser parser,
                               String errorCode, String message) {
        final ErrorMsg error = new ErrorMsg(errorCode, message, element);
        parser.reportError(com.sun.org.apache.xalan.internal.xsltc.compiler.Constants.ERROR, error);
    }
