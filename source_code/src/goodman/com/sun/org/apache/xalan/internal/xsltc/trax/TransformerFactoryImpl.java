...
package goodman.com.sun.org.apache.xalan.internal.xsltc.trax;
...
import goodman.java.io.FilenameFilter;
...
import goodman.java.util.zip.ZipEntry;
import goodman.java.util.zip.ZipFile;
...
import goodman.javax.xml.transform.Templates;
...
import goodman.javax.xml.transform.URIResolver;
import goodman.javax.xml.transform.dom.DOMResult;
import goodman.javax.xml.transform.dom.DOMSource;
import goodman.javax.xml.transform.sax.SAXResult;
import goodman.javax.xml.transform.sax.SAXSource;
import goodman.javax.xml.transform.sax.SAXTransformerFactory;
import goodman.javax.xml.transform.sax.TemplatesHandler;
...
import goodman.javax.xml.transform.stream.StreamResult;
import goodman.javax.xml.transform.stream.StreamSource;
    ...
    extends SAXTransformerFactory implements SourceLoader, ErrorListener
{
    ...
    public Source  getAssociatedStylesheet(Source source, String media,
        ...
        try {
            ...
            if (source instanceof DOMSource ) {
                ...
                final com.sun.org.apache.xalan.internal.xsltc.trax.DOM2SAX dom2sax = new DOM2SAX(node);
    ...
    public Transformer newTransformer()
        throws TransformerConfigurationException
    {
        com.sun.org.apache.xalan.internal.xsltc.trax.TransformerImpl result = new com.sun.org.apache.xalan.internal.xsltc.trax.TransformerImpl(new Properties(),
            _indentNumber, this);
        if (_uriResolver != null) {
        ...
        throws TransformerConfigurationException
    {
        ...
        if (_useClasspath) {
            ...
            try {
                ...
                return new com.sun.org.apache.xalan.internal.xsltc.trax.TemplatesImpl(new Class[]{clazz}, transletName, null, _indentNumber, this);
            }
        ...
        if (_autoTranslet)  {
            ...
            if (bytecodes != null) {
                ...
                resetTransientAttributes();
                return new com.sun.org.apache.xalan.internal.xsltc.trax.TemplatesImpl(bytecodes, transletClassName, null, _indentNumber, this);
            }
        }
        ...
        final InputSource input = com.sun.org.apache.xalan.internal.xsltc.trax.Util.getInputSource(xsltc, source);
    ...
    public TemplatesHandler newTemplatesHandler()
        throws TransformerConfigurationException
    {
        final com.sun.org.apache.xalan.internal.xsltc.trax.TemplatesHandlerImpl handler =
        ...
        throws TransformerConfigurationException
    {
        ...
        return new TransformerHandlerImpl((com.sun.org.apache.xalan.internal.xsltc.trax.TransformerImpl) transformer);
    }
    ...
    {
        final Transformer transformer = templates.newTransformer();
        final com.sun.org.apache.xalan.internal.xsltc.trax.TransformerImpl internal = (TransformerImpl)transformer;
    ...
    public InputSource loadSource(String href, String context, XSLTC xsltc) {
        try {
            if (_uriResolver != null) {
                ...
                if (source != null) {
                    return com.sun.org.apache.xalan.internal.xsltc.trax.Util.getInputSource(xsltc, source);
                }
            }
        }
        catch (TransformerException e) {
    ...
    private String getTransletBaseName(Source source)
    {
        ...
        if (!_transletName.equals(DEFAULT_TRANSLET_NAME))
            ...
            if (systemId != null) {
                String baseName = com.sun.org.apache.xalan.internal.xsltc.trax.Util.baseName(systemId);
                if (baseName != null) {
                    baseName = com.sun.org.apache.xalan.internal.xsltc.trax.Util.noExtName(baseName);
