...
public class NodeSortRecordFactory {
         ...
         try {
             ...
             for (int i = 0; i < levels; i++) {
                  if (order[i].length() == DESCENDING) {
                      iOrder[i] = com.sun.org.apache.xalan.internal.xsltc.dom.NodeSortRecord.COMPARE_DESCENDING;
                  }
                  if (type[i].length() == NUMBER) {
                      iType[i] = com.sun.org.apache.xalan.internal.xsltc.dom.NodeSortRecord.COMPARE_NUMERIC;
                  }
             }
     ...
     */
    public com.sun.org.apache.xalan.internal.xsltc.dom.NodeSortRecord makeNodeSortRecord(int node, int last)
        ...
        final com.sun.org.apache.xalan.internal.xsltc.dom.NodeSortRecord sortRecord =
