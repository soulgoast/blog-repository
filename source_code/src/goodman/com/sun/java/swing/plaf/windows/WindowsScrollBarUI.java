...
public class WindowsScrollBarUI extends BasicScrollBarUI {
    ...
    private static Dimension getSize(Component component, com.sun.java.swing.plaf.windows.XPStyle xp, Part part) {
    ...
    protected ArrowButtonListener createArrowButtonListener(){
        ...
        if(com.sun.java.swing.plaf.windows.XPStyle.isVista()) {
    ...
    protected void paintThumb(Graphics g, JComponent c, Rectangle thumbBounds) {
        ...
        if (xp != null) {
            ...
            if (!sb.isEnabled()) {
                ...
                state = State.HOT;
            } else if (com.sun.java.swing.plaf.windows.XPStyle.isVista()) {
    ...
    protected void setThumbRollover(boolean active) {
        ...
        if(com.sun.java.swing.plaf.windows.XPStyle.isVista() && active != old) {
            scrollbar.repaint();
        }
    }
    ...
    private class WindowsArrowButton extends BasicArrowButton {
        ...
        public void paint(Graphics g) {
            ...
            if (xp != null) {
                ...
                boolean jointRollover = com.sun.java.swing.plaf.windows.XPStyle.isVista() && (isThumbRollover() ||
