...
public class WindowsSpinnerUI extends BasicSpinnerUI {
    ...
    protected Component createPreviousButton() {
        if (com.sun.java.swing.plaf.windows.XPStyle.getXP() != null) {
            JButton xpButton = new com.sun.java.swing.plaf.windows.XPStyle.GlyphButton(spinner, Part.SPNP_DOWN);
    ...
    protected Component createNextButton() {
        if (com.sun.java.swing.plaf.windows.XPStyle.getXP() != null) {
            JButton xpButton = new com.sun.java.swing.plaf.windows.XPStyle.GlyphButton(spinner, Part.SPNP_UP);
            Dimension size = UIManager.getDimension("Spinner.arrowButtonSize");
            xpButton.setPreferredSize(size);
            xpButton.setRequestFocusEnabled(false);
