...
public class WindowsInternalFrameTitlePane extends BasicInternalFrameTitlePane {
    ...
    protected void installDefaults() {
        ...
        if (com.sun.java.swing.plaf.windows.XPStyle.getXP() != null) {
            ...
            Dimension d = com.sun.java.swing.plaf.windows.XPStyle.getPartSize(Part.WP_CLOSEBUTTON, State.NORMAL);
    ...
    public void paintComponent(Graphics g)  {
        ...
        if (title != null) {
            ...
            int titleW;
            int gap = 2;
            if (com.sun.java.swing.plaf.windows.WindowsGraphicsUtils.isLeftToRight(frame)) {
    ...
    public class WindowsTitlePaneLayout extends TitlePaneLayout {
        ...
        private com.sun.java.swing.plaf.windows.XPStyle xp = com.sun.java.swing.plaf.windows.XPStyle.getXP();
