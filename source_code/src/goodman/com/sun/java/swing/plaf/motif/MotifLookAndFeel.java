...
import goodman.javax.swing.plaf.basic.BasicComboBoxRenderer;
import goodman.javax.swing.plaf.basic.BasicComboBoxEditor;
...
public class MotifLookAndFeel extends BasicLookAndFeel
{
    ...
    protected void initComponentDefaults(UIDefaults table)
    {
        ...
        Border loweredBevelBorder = new com.sun.java.swing.plaf.motif.MotifBorders.BevelBorder(false,
                                           table.getColor("controlShadow"),
                                           table.getColor("controlLtHighlight"));

        Border raisedBevelBorder = new com.sun.java.swing.plaf.motif.MotifBorders.BevelBorder(true,                                                                  table.getColor("controlShadow"),
                                           table.getColor("controlLtHighlight"));

        Border marginBorder = new BasicBorders.MarginBorder();

        Border focusBorder = new com.sun.java.swing.plaf.motif.MotifBorders.FocusBorder(
        ...
        Object menuItemCheckIcon = new UIDefaults.LazyValue() {
            public Object createValue(UIDefaults table) {
                return com.sun.java.swing.plaf.motif.MotifIconFactory.getMenuItemCheckIcon();
            }
        };

        Object menuItemArrowIcon = new UIDefaults.LazyValue() {
            public Object createValue(UIDefaults table) {
                return com.sun.java.swing.plaf.motif.MotifIconFactory.getMenuItemArrowIcon();
            }
        };

        Object menuArrowIcon = new UIDefaults.LazyValue() {
            public Object createValue(UIDefaults table) {
                return com.sun.java.swing.plaf.motif.MotifIconFactory.getMenuArrowIcon();
            }
        };

        Object checkBoxIcon = new UIDefaults.LazyValue() {
            public Object createValue(UIDefaults table) {
                return com.sun.java.swing.plaf.motif.MotifIconFactory.getCheckBoxIcon();
            }
        };
        ...
        Object treeExpandedIcon = new UIDefaults.LazyValue() {
            public Object createValue(UIDefaults table) {
                return com.sun.java.swing.plaf.motif.MotifTreeUI.MotifExpandedIcon.createExpandedIcon();
            }
        };
