...
public class WindowsToggleButtonUI extends BasicToggleButtonUI
{
    ...
    protected void installDefaults(AbstractButton b) {
        ...
        if (xp != null) {
            b.setBorder(xp.getBorder(b, com.sun.java.swing.plaf.windows.WindowsButtonUI.getXPButtonType(b)));
    ...
    protected void paintButtonPressed(Graphics g, AbstractButton b) {
        if (com.sun.java.swing.plaf.windows.XPStyle.getXP() == null && b.isContentAreaFilled()) {
