...
public class WindowsIconFactory implements Serializable
{
    ...
    private static class MenuArrowIcon implements Icon, UIResource, Serializable {
        public void paintIcon(Component c, Graphics g, int x, int y) {
            com.sun.java.swing.plaf.windows.XPStyle xp = com.sun.java.swing.plaf.windows.XPStyle.getXP();
            if (com.sun.java.swing.plaf.windows.WindowsMenuItemUI.isVistaPainting(xp)) {
        ...
        private static class VistaMenuItemCheckIcon
            ...
            private static WindowsMenuItemUIAccessor getAccessor(
                ...
                ButtonUI uiObject = (menuItem != null) ? menuItem.getUI()
                        : null;
                if (uiObject instanceof com.sun.java.swing.plaf.windows.WindowsMenuItemUI) {
                    rv = ((WindowsMenuItemUI) uiObject).accessor;
                } else if (uiObject instanceof com.sun.java.swing.plaf.windows.WindowsMenuUI) {
