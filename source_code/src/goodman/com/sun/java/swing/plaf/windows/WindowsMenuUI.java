...
import goodman.javax.swing.plaf.basic.BasicMenuUI;
import goodman.javax.swing.event.MouseInputListener;
...
public class WindowsMenuUI extends BasicMenuUI {
    ...
    protected void paintBackground(Graphics g, JMenuItem menuItem, Color bgColor) {
        ...
        if (WindowsLookAndFeel.isClassicWindows() ||
            !menu.isTopLevelMenu() ||
            (com.sun.java.swing.plaf.windows.XPStyle.getXP() != null && (model.isArmed() || model.isSelected()))) {
    ...
    protected void paintText(Graphics g, JMenuItem menuItem,
        ...
        if ((model.isSelected() && (WindowsLookAndFeel.isClassicWindows() ||
                                    !menu.isTopLevelMenu())) ||
            (com.sun.java.swing.plaf.windows.XPStyle.getXP() != null && (paintRollover ||
                                         model.isArmed() ||
                                         model.isSelected()))) {
