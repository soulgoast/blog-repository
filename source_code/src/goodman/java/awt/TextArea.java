...
import goodman.java.awt.peer.TextAreaPeer;
...
public class TextArea extends TextComponent {
     ...
     */
    private static Set<java.awt.AWTKeyStroke> forwardTraversalKeys, backwardTraversalKeys;
    ...
    static {
        ...
        forwardTraversalKeys = java.awt.KeyboardFocusManager.initFocusTraversalKeysSet(
            "ctrl TAB",
            new HashSet<java.awt.AWTKeyStroke>());
        backwardTraversalKeys = java.awt.KeyboardFocusManager.initFocusTraversalKeysSet(
            "ctrl shift TAB",
     ...
     * @see GraphicsEnvironment#isHeadless()
     */
    public TextArea(String text) throws java.awt.HeadlessException {
    ...
    public TextArea(String text, int rows, int columns, int scrollbars)
        ...
        setFocusTraversalKeys(java.awt.KeyboardFocusManager.FORWARD_TRAVERSAL_KEYS,
                              forwardTraversalKeys);
        setFocusTraversalKeys(java.awt.KeyboardFocusManager.BACKWARD_TRAVERSAL_KEYS,
