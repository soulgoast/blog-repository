...
import goodman.java.awt.SystemTray;
import goodman.java.awt.Toolkit;
import goodman.java.awt.event.*;
import goodman.java.awt.peer.TrayIconPeer;
 ...
 * added to the {@link java.awt.SystemTray system tray}. A
 ...
 * SecurityException.
 *
 * <p> See the {@link java.awt.SystemTray} class overview for an example on how
 * to use the <code>TrayIcon</code> API.
 *
 * @since 1.6
 * @see java.awt.SystemTray#add
...
public class TrayIcon {
    ...
    static {
        ...
        AWTAccessor.setTrayIconAccessor(
            new AWTAccessor.TrayIconAccessor() {
                public void addNotify(TrayIcon trayIcon) throws java.awt.AWTException {
                    trayIcon.addNotify();
                }
    ...
    private TrayIcon()
      throws UnsupportedOperationException, java.awt.HeadlessException, SecurityException
    {
     ...
     * is not granted
     * @see java.awt.SystemTray#add(TrayIcon)
     * @see TrayIcon#TrayIcon(java.awt.Image, String, java.awt.PopupMenu)
     ...
     * @see AWTPermission
     */
    public TrayIcon(java.awt.Image image, String tooltip, java.awt.PopupMenu popup) {
        this(image, tooltip);
        setPopupMenu(popup);
    }
    ...
    public synchronized MouseListener[] getMouseListeners() {
        return java.awt.AWTEventMulticaster.getListeners(mouseListener, MouseListener.class);
    }
    ...
    public synchronized MouseMotionListener[] getMouseMotionListeners() {
        return java.awt.AWTEventMulticaster.getListeners(mouseMotionListener, MouseMotionListener.class);
    }
     ...
     * result of the {@link java.awt.SystemTray#getTrayIconSize}.
     *
