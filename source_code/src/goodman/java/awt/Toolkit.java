...
import goodman.java.awt.FileDialog;
...
import goodman.java.awt.JobAttributes;
import goodman.java.awt.Menu;
import goodman.java.awt.MenuBar;
import goodman.java.awt.MenuItem;
import goodman.java.awt.PageAttributes;
import goodman.java.awt.Point;
import goodman.java.awt.PopupMenu;
import goodman.java.awt.PrintJob;
import goodman.java.awt.RenderingHints;
import goodman.java.awt.TextComponent;
import goodman.java.beans.PropertyChangeEvent;
import goodman.java.awt.event.*;
import goodman.java.awt.peer.*;
import goodman.java.awt.im.InputMethodHighlight;
import goodman.java.awt.image.ImageObserver;
import goodman.java.awt.image.ImageProducer;
import goodman.java.awt.image.ColorModel;
import goodman.java.awt.datatransfer.Clipboard;
import goodman.java.awt.dnd.DragSource;
import goodman.java.awt.dnd.DragGestureRecognizer;
import goodman.java.awt.dnd.DragGestureEvent;
import goodman.java.awt.dnd.DragGestureListener;
import goodman.java.awt.dnd.InvalidDnDOperationException;
import goodman.java.awt.dnd.peer.DragSourceContextPeer;
...
public abstract class Toolkit {
     ...
     * @since 1.6
     */
    protected abstract DesktopPeer createDesktopPeer(java.awt.Desktop target)
     ...
     * @since     JDK1.1
     */
    protected abstract ScrollPanePeer createScrollPane(java.awt.ScrollPane target)
        throws java.awt.HeadlessException;
    ...
    protected abstract CheckboxMenuItemPeer createCheckboxMenuItem(
        CheckboxMenuItem target) throws java.awt.HeadlessException;
     ...
     * @exception java.awt.HeadlessException if the GraphicsEnvironment.isHeadless()
     *            method returns true
     * @see       #setDynamicLayout(boolean dynamic)
     * @see       #isDynamicLayoutSet()
     * @see       #getDesktopProperty(String propertyName)
        ...
        if (atNames != null) {
            ...
            while (parser.hasMoreTokens()) {
                ...
                try {
                    ...
                    throw new java.awt.AWTError("Assistive Technology not found: "
                            + atName);
                } catch (InstantiationException e) {
                    throw new java.awt.AWTError("Could not instantiate Assistive"
                            + " Technology: " + atName);
                } catch (IllegalAccessException e) {
                    throw new java.awt.AWTError("Could not access Assistive"
                            + " Technology: " + atName);
                } catch (Exception e) {
                    throw new java.awt.AWTError("Error trying to install Assistive"
                            + " Technology: " + atName + " " + e);
                }
            }
        }
     ...
     * @exception java.awt.AWTError  if a toolkit could not be found, or
     ...
     * @see       java.awt.Image
     * @see       ImageProducer
     * @see       java.awt.Component#createImage(ImageProducer)
     */
     ...
     * @since   JDK1.1
     */
    public abstract java.awt.PrintJob getPrintJob(java.awt.Frame frame, String jobtitle,
                                                  Properties props);
     ...
     */
    protected static Container getNativeContainer(java.awt.Component c) {
    ...
    public java.awt.Dimension getBestCursorSize(int preferredWidth,
                                                int preferredHeight) throws java.awt.HeadlessException {
        java.awt.GraphicsEnvironment.checkHeadless();
