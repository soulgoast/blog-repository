...
import goodman.java.awt.Conditional;
...
public class Container extends java.awt.Component {
    ...
    private boolean removeDelicately(java.awt.Component comp, Container newParent, int newIndex) {
        ...
        if (comp.parent == null) { // was actually removed
            if (containerListener != null ||
                ...
                Toolkit.enabledOnToolkit(java.awt.AWTEvent.CONTAINER_EVENT_MASK)) {
     ...
     * @since 1.2
     */
    public java.awt.Component findComponentAt(Point p) {
