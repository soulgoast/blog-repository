 ...
 * an instance of {@link java.awt.GridBagConstraints}.  The constraints object
 ...
 *
 * <dl>
 * <dt>{@link java.awt.GridBagConstraints#gridx},
 * {@link java.awt.GridBagConstraints#gridy}
 ...
 * <dt>{@link java.awt.GridBagConstraints#gridwidth},
 * {@link java.awt.GridBagConstraints#gridheight}
 ...
 *
 * <dt>{@link java.awt.GridBagConstraints#fill}
 ...
 * <dt>{@link java.awt.GridBagConstraints#ipadx},
 * {@link java.awt.GridBagConstraints#ipady}
 ...
 * <dt>{@link java.awt.GridBagConstraints#insets}
 * <dd>Specifies the component's external padding, the minimum
 * amount of space between the component and the edges of its display area.
 * <dt>{@link java.awt.GridBagConstraints#anchor}
 ...
 * </tr>
 * </table></center>
 * <dt>{@link java.awt.GridBagConstraints#weightx},
 * {@link java.awt.GridBagConstraints#weighty}
...
java.io.Serializable {
     ...
     * @see java.awt.GridBagConstraints
     */
    protected Hashtable<java.awt.Component, java.awt.GridBagConstraints> comptable;
     ...
     * @see #setConstraints(java.awt.Component, java.awt.GridBagConstraints)
    ...
    public GridBagLayout () {
        comptable = new Hashtable<java.awt.Component, java.awt.GridBagConstraints>();
        defaultConstraints = new java.awt.GridBagConstraints();
    }
     ...
     */
    public void setConstraints(java.awt.Component comp, java.awt.GridBagConstraints constraints) {
        comptable.put(comp, (java.awt.GridBagConstraints)constraints.clone());
    }
    ...
    public java.awt.GridBagConstraints getConstraints(java.awt.Component comp) {
        java.awt.GridBagConstraints constraints = comptable.get(comp);
        if (constraints == null) {
            setConstraints(comp, defaultConstraints);
            constraints = comptable.get(comp);
        }
        return (java.awt.GridBagConstraints)constraints.clone();
    }
    ...
    public void addLayoutComponent(java.awt.Component comp, Object constraints) {
        if (constraints instanceof java.awt.GridBagConstraints) {
            setConstraints(comp, (java.awt.GridBagConstraints)constraints);
    ...
    protected GridBagLayoutInfo GetLayoutInfo(java.awt.Container parent, int sizeflag) {
        synchronized (parent.getTreeLock()) {
            ...
            for (compindex = 0 ; compindex < components.length ; compindex++) {
                ...
                if (hasBaseline) {
                    switch(anchor) {
                    case java.awt.GridBagConstraints.BASELINE:
                    case java.awt.GridBagConstraints.BASELINE_LEADING:
                    case java.awt.GridBagConstraints.BASELINE_TRAILING:
                        ...
                        break;
                    case java.awt.GridBagConstraints.ABOVE_BASELINE:
                    case java.awt.GridBagConstraints.ABOVE_BASELINE_LEADING:
                    case java.awt.GridBagConstraints.ABOVE_BASELINE_TRAILING:
                        ...
                        maxDescent[curY] = Math.max(maxDescent[curY],
                                                    constraints.insets.bottom);
                        break;
                    case java.awt.GridBagConstraints.BELOW_BASELINE:
                    case java.awt.GridBagConstraints.BELOW_BASELINE_LEADING:
                    case java.awt.GridBagConstraints.BELOW_BASELINE_TRAILING:
    ...
    private boolean calculateBaseline(java.awt.Component c,
        ...
        if (anchor == java.awt.GridBagConstraints.BASELINE ||
                anchor == java.awt.GridBagConstraints.BASELINE_LEADING ||
                anchor == java.awt.GridBagConstraints.BASELINE_TRAILING) {
     ...
     * @since 1.4
     */
    protected void adjustForGravity(java.awt.GridBagConstraints constraints,
                                    Rectangle r) {
     ...
     * This method is obsolete and supplied for backwards
     * compatibility only; new code should call {@link
     * #adjustForGravity(java.awt.GridBagConstraints, Rectangle)
    ...
    protected void AdjustForGravity(java.awt.GridBagConstraints constraints,
        ...
        diffx = 0;
        if ((constraints.fill != java.awt.GridBagConstraints.HORIZONTAL &&
        ...
        diffy = 0;
        if ((constraints.fill != java.awt.GridBagConstraints.VERTICAL &&
             constraints.fill != java.awt.GridBagConstraints.BOTH)
        ...
        switch (constraints.anchor) {
          ...
          case java.awt.GridBagConstraints.CENTER:
              ...
              r.y += diffy/2;
              break;
          case java.awt.GridBagConstraints.PAGE_START:
          ...
          case java.awt.GridBagConstraints.SOUTHEAST:
              ...
              r.y += diffy;
              break;
          case java.awt.GridBagConstraints.PAGE_END:
          ...
          case java.awt.GridBagConstraints.NORTHWEST:
              break;
          case java.awt.GridBagConstraints.LINE_START:
              if (rightToLeft) {
                  r.x += diffx;
              }
              r.y += diffy/2;
              break;
          case java.awt.GridBagConstraints.LINE_END:
              if (!rightToLeft) {
                  r.x += diffx;
              }
              r.y += diffy/2;
              break;
          case java.awt.GridBagConstraints.FIRST_LINE_START:
              if (rightToLeft) {
                  r.x += diffx;
              }
              break;
          case java.awt.GridBagConstraints.FIRST_LINE_END:
              if (!rightToLeft) {
                  r.x += diffx;
              }
              break;
          case java.awt.GridBagConstraints.LAST_LINE_START:
              if (rightToLeft) {
                  r.x += diffx;
              }
              r.y += diffy;
              break;
          case java.awt.GridBagConstraints.LAST_LINE_END:
              if (!rightToLeft) {
                  r.x += diffx;
              }
              r.y += diffy;
     ...
     *        ipady
     */
    private void alignOnBaseline(java.awt.GridBagConstraints cons, Rectangle r,
     ...
     */
    private void alignAboveBaseline(java.awt.GridBagConstraints cons, Rectangle r,
                                    int cellY, int cellHeight) {
     ...
     */
    private void alignBelowBaseline(java.awt.GridBagConstraints cons, Rectangle r,
                                    int cellY, int cellHeight) {
        if (layoutInfo.hasBaseline(cons.tempY)) {
            if (layoutInfo.hasConstantDescent(cons.tempY)) {
                // Prefer descent
    ...
    private void centerVertically(java.awt.GridBagConstraints cons, Rectangle r,
                                  int cellHeight) {
        if (!cons.isVerticallyResizable()) {
