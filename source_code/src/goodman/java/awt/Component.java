...
import goodman.java.awt.Canvas;
import goodman.java.awt.Color;
import goodman.java.io.PrintStream;
...
import goodman.java.awt.peer.ContainerPeer;
                                           ...
                                           Serializable
{
     ...
     * @since 1.4
     */
    Set<java.awt.AWTKeyStroke>[] focusTraversalKeys;
            ...
            synchronized (getTreeLock()) {
                ...
                if (peer != null) {
                    ...
                    createHierarchyEvents(HierarchyEvent.HIERARCHY_CHANGED,
                                          ...
                                          Toolkit.enabledOnToolkit(java.awt.AWTEvent.HIERARCHY_EVENT_MASK));
                ...
                if (componentListener != null ||
                    ...
                    Toolkit.enabledOnToolkit(java.awt.AWTEvent.COMPONENT_EVENT_MASK)) {
            ...
            || Toolkit.enabledOnToolkit(java.awt.AWTEvent.COMPONENT_EVENT_MASK))
            {
                ...
                if (this instanceof Container && ((Container)this).countComponents() > 0) {
                    boolean enabledOnToolkit =
                        Toolkit.enabledOnToolkit(java.awt.AWTEvent.HIERARCHY_BOUNDS_EVENT_MASK);
                    if (resized) {
     ...
     *
     * @see     ImageObserver
     * @see     Graphics#drawImage(Image, int, int, java.awt.Color, ImageObserver)
     * @see     Graphics#drawImage(Image, int, int, ImageObserver)
     * @see     Graphics#drawImage(Image, int, int, int, int, java.awt.Color, ImageObserver)
     ...
     * @exception java.awt.AWTException if an image with the specified capabilities cannot
     * be created
     ...
     */
    public VolatileImage createVolatileImage(int width, int height,
                                             ImageCapabilities caps) throws java.awt.AWTException {
        // REMIND : check caps
    ...
    void createBufferStrategy(int numBuffers) {
        ...
        if (numBuffers > 1) {
            ...
            bufferCaps = new java.awt.BufferCapabilities(new ImageCapabilities(true),
        ...
        bufferCaps = new java.awt.BufferCapabilities(new ImageCapabilities(false),
     ...
     */
    void createBufferStrategy(int numBuffers,
                              java.awt.BufferCapabilities caps) throws java.awt.AWTException {
        // Check arguments
        if (numBuffers < 1) {
            throw new IllegalArgumentException(
    ...
    protected class FlipBufferStrategy extends BufferStrategy {
         ...
         */
        protected java.awt.BufferCapabilities caps; // = null
        /**
         * The drawing buffer
         */
         ...
         * {@code true}.
         * @see #createBuffers(int, java.awt.BufferCapabilities)
         */
        protected FlipBufferStrategy(int numBuffers, java.awt.BufferCapabilities caps)
         ...
         */
        protected void createBuffers(int numBuffers, java.awt.BufferCapabilities caps)
            throws java.awt.AWTException
        {
            if (numBuffers < 2) {
                throw new IllegalArgumentException(
        ...
        synchronized (this) {
            notifyAncestors =
                (hierarchyListener != null &&
                 (eventMask & java.awt.AWTEvent.HIERARCHY_EVENT_MASK) == 0);
            hierarchyListener =
                java.awt.AWTEventMulticaster.remove(hierarchyListener, l);
            notifyAncestors = (notifyAncestors && hierarchyListener == null);
        }
        if (notifyAncestors) {
            synchronized (getTreeLock()) {
    ...
    public void addHierarchyBoundsListener(HierarchyBoundsListener l) {
        ...
        synchronized (this) {
            ...
            hierarchyBoundsListener =
                java.awt.AWTEventMulticaster.add(hierarchyBoundsListener, l);
        ...
        synchronized (this) {
            notifyAncestors =
                (hierarchyBoundsListener != null &&
                 (eventMask & java.awt.AWTEvent.HIERARCHY_BOUNDS_EVENT_MASK) == 0);
            hierarchyBoundsListener =
                java.awt.AWTEventMulticaster.remove(hierarchyBoundsListener, l);
            notifyAncestors = (notifyAncestors &&
                               hierarchyBoundsListener == null);
        }
        if (notifyAncestors) {
    ...
    final void setFocusTraversalKeys_NoIDCheck(int id, Set<? extends java.awt.AWTKeyStroke> keystrokes) {
        ...
        synchronized (this) {
            ...
            focusTraversalKeys[id] = (keystrokes != null)
                ? Collections.unmodifiableSet(new HashSet<java.awt.AWTKeyStroke>(keystrokes))
                : null;
        }
    ...
    final Set<java.awt.AWTKeyStroke> getFocusTraversalKeys_NoIDCheck(int id) {
      ...
      throws IOException
    {
        ...
        java.awt.AWTEventMulticaster.save(s, componentListenerK, componentListener);
        java.awt.AWTEventMulticaster.save(s, focusListenerK, focusListener);
        java.awt.AWTEventMulticaster.save(s, keyListenerK, keyListener);
        java.awt.AWTEventMulticaster.save(s, mouseListenerK, mouseListener);
        java.awt.AWTEventMulticaster.save(s, mouseMotionListenerK, mouseMotionListener);
        java.awt.AWTEventMulticaster.save(s, inputMethodListenerK, inputMethodListener);

        s.writeObject(null);
        s.writeObject(componentOrientation);

        java.awt.AWTEventMulticaster.save(s, hierarchyListenerK, hierarchyListener);
        java.awt.AWTEventMulticaster.save(s, hierarchyBoundsListenerK,
                                 hierarchyBoundsListener);
        s.writeObject(null);
