...
import goodman.java.awt.peer.MenuPeer;
...
public class Menu extends MenuItem implements MenuContainer, Accessible {
     ...
     * @see GraphicsEnvironment#isHeadless
     */
    public Menu(String label) throws java.awt.HeadlessException {
        this(label, false);
    }
     ...
     * @since       JDK1.0.
     */
    public Menu(String label, boolean tearOff) throws java.awt.HeadlessException {
        super(label);
