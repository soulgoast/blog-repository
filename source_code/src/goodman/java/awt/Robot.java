...
import goodman.java.awt.peer.RobotPeer;
...
public class Robot {
     ...
     * <p>
     *
     * @throws java.awt.AWTException if the platform configuration does not allow
    ...
    private void init(java.awt.GraphicsDevice screen) throws AWTException {
        checkRobotAllowed();
     ...
     * @see     AWTPermission
     */
    public synchronized BufferedImage createScreenCapture(java.awt.Rectangle screenRect) {
        checkScreenCaptureAllowed();
