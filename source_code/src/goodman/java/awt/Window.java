...
import goodman.java.awt.AWTEventMulticaster;
import goodman.java.awt.AWTException;
import goodman.java.awt.AWTKeyStroke;
import goodman.java.awt.AWTPermission;
import goodman.java.awt.AlphaComposite;
import goodman.java.awt.BorderLayout;
import goodman.java.awt.BufferCapabilities;
import goodman.java.awt.Color;
import goodman.java.awt.Component;
import goodman.java.awt.ComponentOrientation;
import goodman.java.awt.Container;
import goodman.java.awt.Cursor;
import goodman.java.awt.Dialog;
import goodman.java.awt.Dimension;
import goodman.java.awt.Event;
import goodman.java.awt.EventQueue;
import goodman.java.awt.Frame;
import goodman.java.awt.Graphics;
import goodman.java.awt.Graphics2D;
import goodman.java.awt.GraphicsConfiguration;
import goodman.java.awt.GraphicsDevice;
import goodman.java.awt.GraphicsEnvironment;
import goodman.java.awt.HeadlessException;
import goodman.java.awt.IllegalComponentStateException;
import goodman.java.awt.Image;
import goodman.java.awt.Insets;
import goodman.java.awt.KeyboardFocusManager;
import goodman.java.awt.Point;
import goodman.java.awt.Rectangle;
import goodman.java.awt.Shape;
import goodman.java.awt.SplashScreen;
import goodman.java.awt.Toolkit;
import goodman.java.awt.event.*;
import goodman.java.awt.geom.Path2D;
import goodman.java.awt.geom.Point2D;
import goodman.java.awt.im.InputContext;
import goodman.java.awt.image.BufferStrategy;
import goodman.java.awt.image.BufferedImage;
import goodman.java.awt.peer.ComponentPeer;
import goodman.java.awt.peer.WindowPeer;
...
import goodman.java.io.OptionalDataException;
 ...
 * with {@link #Window(Window, java.awt.GraphicsConfiguration)}.  The
 ...
 * @since       JDK1.0
 */
public class Window extends java.awt.Container implements Accessible {
    ...
    public Window(java.awt.Frame owner) {
        this(owner == null ? (java.awt.GraphicsConfiguration)null :
     ...
     * @since     1.3
     */
    public Window(Window owner, java.awt.GraphicsConfiguration gc) {
        this(gc);
        ownedInit(owner);
    }
    ...
    synchronized void postWindowEvent(int id) {
        if (windowListener != null
            || (eventMask & java.awt.AWTEvent.WINDOW_EVENT_MASK) != 0
            ||  java.awt.Toolkit.enabledOnToolkit(java.awt.AWTEvent.WINDOW_EVENT_MASK)) {
 ...
 */
    ...
    boolean eventEnabled(java.awt.AWTEvent e) {
        switch(e.id) {
          ...
          case WindowEvent.WINDOW_DEACTIVATED:
            if ((eventMask & java.awt.AWTEvent.WINDOW_EVENT_MASK) != 0 ||
                windowListener != null) {
                return true;
            }
            return false;
          ...
          case WindowEvent.WINDOW_LOST_FOCUS:
            if ((eventMask & java.awt.AWTEvent.WINDOW_FOCUS_EVENT_MASK) != 0 ||
                windowFocusListener != null) {
                return true;
            }
            return false;
          case WindowEvent.WINDOW_STATE_CHANGED:
            if ((eventMask & java.awt.AWTEvent.WINDOW_STATE_EVENT_MASK) != 0 ||
     ...
     * current platform, use {@link java.awt.Toolkit#isAlwaysOnTopSupported()} and
     ...
     * @see #getToolkit
     * @see java.awt.Toolkit#isAlwaysOnTopSupported
     * @since 1.5
     */
    ...
    public java.awt.Component getMostRecentFocusOwner() {
        if (isFocused()) {
            ...
            java.awt.Component mostRecent =
                java.awt.KeyboardFocusManager.getMostRecentFocusOwner(this);
            if (mostRecent != null) {
                return mostRecent;
            } else {
     ...
     * @see java.awt.Container#setFocusTraversalKeys
     ...
     * @see java.awt.KeyboardFocusManager#DOWN_CYCLE_TRAVERSAL_KEYS
            ...
            for (Window owner = getOwner();
                 ...
                 owner = owner.getOwner())
                {
                    java.awt.Component toFocus =
                        java.awt.KeyboardFocusManager.getMostRecentFocusOwner(owner);
    ...
    */
     ...
     * {@link java.awt.Component#applyComponentOrientation Component.applyComponentOrientation}.
     */
    @Deprecated
    ...
    */
     ...
     *
     * @throws java.awt.IllegalComponentStateException if the window
     *         is displayable.
     ...
     *      {@code Window} object
     *
     * @see java.awt.AWTEventMulticaster#save(ObjectOutputStream, String, EventListener)
     * @see java.awt.Component#windowListenerK
     * @see java.awt.Component#windowFocusListenerK
    ...
    private void writeObject(ObjectOutputStream s) throws IOException {
        synchronized (this) {
            ...
            java.awt.AWTEventMulticaster.save(s, windowListenerK, windowListener);
            java.awt.AWTEventMulticaster.save(s, windowFocusListenerK, windowFocusListener);
    ...
    private void deserializeResources(ObjectInputStream s)
        throws ClassNotFoundException, IOException, java.awt.HeadlessException {
     ...
     * cannot be {@code null}
     * @exception java.awt.AWTException if the capabilities supplied could not be
     ...
     * @see java.awt.GraphicsDevice.WindowTranslucency
     *
     * @since 1.7
     */
     ...
     * less than {@code 1.0f}:
     * <ul>
     * <li>The {@link java.awt.GraphicsDevice.WindowTranslucency#TRANSLUCENT TRANSLUCENT}
     ...
     *     [0..1]
     * @throws java.awt.IllegalComponentStateException if the window is decorated and
     *     the opacity is less than {@code 1.0f}
     * @throws java.awt.IllegalComponentStateException if the window is in full screen
     ...
     * @see java.awt.GraphicsDevice.WindowTranslucency
     * @see java.awt.GraphicsDevice#isWindowTranslucencySupported(java.awt.GraphicsDevice.WindowTranslucency)
     *
     * @since 1.7
     */
     ...
     * <ul>
     * <li>The {@link java.awt.GraphicsDevice.WindowTranslucency#PERPIXEL_TRANSPARENT
     ...
     * java.awt.GraphicsDevice.WindowTranslucency} for more details.
     *
     * @param shape the shape to set to the window
     *
     * @throws java.awt.IllegalComponentStateException if the shape is not {@code
     ...
     *     null} and {@link java.awt.GraphicsDevice.WindowTranslucency#PERPIXEL_TRANSPARENT
     ...
     * java.awt.GraphicsDevice.WindowTranslucency#PERPIXEL_TRANSLUCENT PERPIXEL_TRANSLUCENT}
     ...
     * <ul>
     * <li>The {@link java.awt.GraphicsDevice.WindowTranslucency#PERPIXEL_TRANSLUCENT
     ...
     *
     * @throws java.awt.IllegalComponentStateException if the alpha value of the given
     ...
     * @see java.awt.GraphicsDevice.WindowTranslucency
     * @see java.awt.GraphicsDevice#isWindowTranslucencySupported(java.awt.GraphicsDevice.WindowTranslucency)
     * @see java.awt.GraphicsConfiguration#isTranslucencyCapable()
     */
    @Override
        ...
        if (!isOpaque()) {
            ...
            try {
                if (gg instanceof java.awt.Graphics2D) {
                    ...
                    ((Graphics2D)gg).setComposite(java.awt.AlphaComposite.getInstance(AlphaComposite.SRC));
    ...
    static {
        AWTAccessor.setWindowAccessor(new AWTAccessor.WindowAccessor() {
            ...
            public java.awt.Dimension getSecurityWarningSize(Window window) {
