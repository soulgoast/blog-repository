 ...
 * @since       JDK1.0
 */
public class List extends Component implements java.awt.ItemSelectable, Accessible {
    /**
      ...
      throws IOException
    {
      ...
      java.awt.AWTEventMulticaster.save(s, itemListenerK, itemListener);
