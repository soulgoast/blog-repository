...
import goodman.java.awt.EventDispatchThread;
import goodman.java.awt.EventFilter;
...
import goodman.java.util.concurrent.locks.Lock;
...
public class EventQueue {
    ...
    private class FwSecondaryLoopWrapper implements SecondaryLoop {
        ...
        final private java.awt.EventFilter filter;

        public FwSecondaryLoopWrapper(SecondaryLoop loop, java.awt.EventFilter filter) {
            this.loop = loop;
            this.filter = filter;
        }
    ...
    SecondaryLoop createSecondaryLoop(java.awt.Conditional cond, java.awt.EventFilter filter, long interval) {
        pushPopLock.lock();
        try {
            if (nextQueue != null) {
        ...
        try {
            if (dispatchThread == null && !threadGroup.isDestroyed() && !appContext.isDisposed()) {
                dispatchThread = AccessController.doPrivileged(
                    new PrivilegedAction<java.awt.EventDispatchThread>() {
                        public java.awt.EventDispatchThread run() {
                            java.awt.EventDispatchThread t =
                                new java.awt.EventDispatchThread(threadGroup,
                                                        name,
                                                        EventQueue.this);
