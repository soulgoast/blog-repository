...
import goodman.java.util.function.DoubleConsumer;
 ...
 * non-deterministic results when using the {@code stream} framework.
 *
 ...
 * {@code stream} package, would use Spliterator in a parallel
 ...
 *
 * @implNote
 * If the boolean system property {@code org.openjdk.stream.tripwire}
