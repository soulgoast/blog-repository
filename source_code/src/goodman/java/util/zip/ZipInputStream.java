...
import goodman.java.util.zip.CRC32;
import goodman.java.util.zip.Inflater;
import goodman.java.util.zip.InflaterInputStream;
import goodman.java.util.zip.ZipCoder;
import goodman.java.util.zip.ZipConstants;
import goodman.java.util.zip.ZipEntry;
import goodman.java.util.zip.ZipException;
