...
import goodman.java.net.DefaultInterface;
import goodman.java.net.Inet4Address;
import goodman.java.net.Inet6Address;
import goodman.java.net.InetAddress;
import goodman.java.net.InterfaceAddress;
import goodman.java.net.NetPermission;
...
public final class NetworkInterface {
    ...
    public static NetworkInterface getByInetAddress(java.net.InetAddress addr) throws java.net.SocketException {
        ...
        if (addr instanceof java.net.Inet4Address) {
            java.net.Inet4Address inet4Address = (java.net.Inet4Address) addr;
            if (inet4Address.holder.family != java.net.InetAddress.IPv4) {
            ...
            java.net.Inet6Address inet6Address = (Inet6Address) addr;
            if (inet6Address.holder.family != java.net.InetAddress.IPv6) {
                throw new IllegalArgumentException("invalid family type: "
