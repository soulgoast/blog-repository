...
import goodman.java.beans.MethodRef;
import goodman.java.beans.NameGenerator;
...
public class PropertyDescriptor extends FeatureDescriptor {
     ...
     * @since 1.7
     */
    PropertyDescriptor(Class<?> bean, String base, Method read, Method write) throws java.beans.IntrospectionException {
        if (bean == null) {
            throw new java.beans.IntrospectionException("Target Bean class is null");
        }
        setClass0(bean);
     ...
     * @throws java.beans.IntrospectionException if the read or write method is invalid
     */
    private Class<?> findPropertyType(Method readMethod, Method writeMethod)
        ...
        try {
            if (readMethod != null) {
                ...
                if (params.length != 0) {
                    throw new java.beans.IntrospectionException("bad read method arg count: "
                                                     + readMethod);
                }
                propertyType = getReturnType(getClass0(), readMethod);
                if (propertyType == Void.TYPE) {
                    throw new java.beans.IntrospectionException("read method " +
            ...
            if (writeMethod != null) {
                ...
                if (params.length != 1) {
                    throw new java.beans.IntrospectionException("bad write method arg count: "
                                                     + writeMethod);
                }
