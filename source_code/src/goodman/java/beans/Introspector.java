...
import goodman.java.beans.BeanDescriptor;
import goodman.java.beans.BeanInfo;
import goodman.java.beans.Customizer;
import goodman.java.beans.EventSetDescriptor;
import goodman.java.beans.FeatureDescriptor;
import goodman.java.beans.IndexedPropertyDescriptor;
...
public class Introspector {
    ...
    private Map<String, java.beans.EventSetDescriptor> events;

    private final static java.beans.EventSetDescriptor[] EMPTY_EVENTSETDESCRIPTORS = new java.beans.EventSetDescriptor[0];
     ...
     */
    public static java.beans.BeanInfo getBeanInfo(Class<?> beanClass, Class<?> stopClass,
                                                  int flags) throws java.beans.IntrospectionException {
    ...
    private Introspector(Class<?> beanClass, Class<?> stopClass, int flags)
        ...
        if (stopClass != null) {
            ...
            if (!isSuper) {
                throw new java.beans.IntrospectionException(stopClass.getName() + " not superclass of " +
                                        beanClass.getName());
            }
        }
     ...
     */
    private java.beans.BeanInfo getBeanInfo() throws java.beans.IntrospectionException {

        // the evaluation order here is import, as we evaluate the
        // event sets and locate PropertyChangeListeners before we
        // look for properties.
        java.beans.BeanDescriptor bd = getTargetBeanDescriptor();
        MethodDescriptor mds[] = getTargetMethodInfo();
        java.beans.EventSetDescriptor esds[] = getTargetEventInfo();
                ...
                try {
                    ...
                    if (argCount == 0) {
                        ...
                        if (int.class.equals(argTypes[0]) && name.startsWith(GET_PREFIX)) {
                            pd = new java.beans.IndexedPropertyDescriptor(this.beanClass, name.substring(3), null, null, method, null);
                            ...
                            pd = new java.beans.IndexedPropertyDescriptor(this.beanClass, name.substring(3), null, null, null, method);
                            if (throwsException(method, PropertyVetoException.class)) {
                                pd.setConstrained(true);
                            }
                        }
    ...
    private void addPropertyDescriptor(PropertyDescriptor pd) {
        ...
        if (this.beanClass != pd.getClass0()) {
            ...
            if (pd instanceof java.beans.IndexedPropertyDescriptor) {
                java.beans.IndexedPropertyDescriptor ipd = (java.beans.IndexedPropertyDescriptor) pd;
                ...
                if (!cls) {
                    pd = new java.beans.IndexedPropertyDescriptor(ipd);
    ...
    private void processPropertyDescriptors() {
        ...
        java.beans.IndexedPropertyDescriptor ipd, igpd, ispd;
        ...
        while (it.hasNext()) {
            ...
            for (int i = 0; i < list.size(); i++) {
                pd = list.get(i);
                if (pd instanceof java.beans.IndexedPropertyDescriptor) {
                    ipd = (java.beans.IndexedPropertyDescriptor)pd;
                    if (ipd.getIndexedReadMethod() != null) {
                        if (igpd != null) {
                            igpd = new java.beans.IndexedPropertyDescriptor(igpd, ipd);
                        } else {
                            igpd = ipd;
                        }
                    }
                    ...
                    if (ipd.getIndexedWriteMethod() != null) {
                        if (igpd != null) {
                            if (isAssignable(igpd.getIndexedPropertyType(), ipd.getIndexedPropertyType())) {
                                if (ispd != null) {
                                    ispd = new java.beans.IndexedPropertyDescriptor(ispd, ipd);
                                } else {
                                    ispd = ipd;
                                }
                            }
            ...
            if (igpd != null && ispd != null) {
                ...
                if ((gpd == spd) || (gpd == null)) {
                    ...
                    pd = gpd;
                } else if (spd instanceof java.beans.IndexedPropertyDescriptor) {
                    pd = mergePropertyWithIndexedProperty(gpd, (java.beans.IndexedPropertyDescriptor) spd);
                } else if (gpd instanceof java.beans.IndexedPropertyDescriptor) {
                    pd = mergePropertyWithIndexedProperty(spd, (java.beans.IndexedPropertyDescriptor) gpd);
                } else {
                ...
                if (pd == null) {
                    ...
                    if (propType.isArray() && propType.getComponentType() == ipropType) {
                        pd = pd.getClass0().isAssignableFrom(ipd.getClass0())
                                ? new java.beans.IndexedPropertyDescriptor(pd, ipd)
                                : new java.beans.IndexedPropertyDescriptor(ipd, pd);
    ...
    private PropertyDescriptor mergePropertyWithIndexedProperty(PropertyDescriptor pd, java.beans.IndexedPropertyDescriptor ipd) {
     ...
     */
    private PropertyDescriptor mergePropertyDescriptor(java.beans.IndexedPropertyDescriptor ipd,
        ...
        if (propType.isArray() && propType.getComponentType() == ipropType) {
            if (pd.getClass0().isAssignableFrom(ipd.getClass0())) {
                result = new java.beans.IndexedPropertyDescriptor(pd, ipd);
            } else {
                result = new java.beans.IndexedPropertyDescriptor(ipd, pd);
            }
            ...
            if (pd.getClass0().isAssignableFrom(ipd.getClass0())) {
                ...
                if (write == null && read != null) {
                    write = findMethod(result.getClass0(),
                                       ...
                                       new Class<?>[] { java.beans.FeatureDescriptor.getReturnType(result.getClass0(), read) });
                    if (write != null) {
                        try {
    ...
    private java.beans.IndexedPropertyDescriptor mergePropertyDescriptor(java.beans.IndexedPropertyDescriptor ipd1,
                                                                         java.beans.IndexedPropertyDescriptor ipd2) {
        if (ipd1.getClass0().isAssignableFrom(ipd2.getClass0())) {
            return new java.beans.IndexedPropertyDescriptor(ipd1, ipd2);
        } else {
            return new java.beans.IndexedPropertyDescriptor(ipd2, ipd1);
        }
    }
     ...
     */
    private java.beans.EventSetDescriptor[] getTargetEventInfo() throws IntrospectionException {
        if (events == null) {
            events = new HashMap<>();
        }
        ...
        // Check if the bean has its own BeanInfo that will provide
        // explicit information.
        java.beans.EventSetDescriptor[] explicitEvents = null;
        if (explicitBeanInfo != null) {
        ...
        if (explicitEvents == null && superBeanInfo != null) {
            ...
            java.beans.EventSetDescriptor supers[] = superBeanInfo.getEventSetDescriptors();
        ...
        for (int i = 0; i < additionalBeanInfo.length; i++) {
            java.beans.EventSetDescriptor additional[] = additionalBeanInfo[i].getEventSetDescriptors();
            if (additional != null) {
        ...
        if (explicitEvents != null) {
            ...
            for (int i = 0; i < methodList.length; i++) {
                ...
                if (name.startsWith(ADD_PREFIX)) {
                    ...
                    if (parameterTypes.length == 0) {
                        Class<?> returnType = java.beans.FeatureDescriptor.getReturnType(beanClass, method);
            ...
            if (adds != null && removes != null) {
                ...
                while (keys.hasNext()) {
                    ...
                    java.beans.EventSetDescriptor esd = new java.beans.EventSetDescriptor(eventName, argType,
                                                                    methods, addMethod,
                                                                    removeMethod,
                                                                    getMethod);
        ...
        java.beans.EventSetDescriptor[] result;
        if (events.size() == 0) {
            result = EMPTY_EVENTSETDESCRIPTORS;
        } else {
            // Allocate and populate the result array.
            result = new java.beans.EventSetDescriptor[events.size()];
    ...
    private void addEvent(java.beans.EventSetDescriptor esd) {
        ...
        java.beans.EventSetDescriptor old = events.get(key);
        if (old == null) {
            events.put(key, esd);
            return;
        }
        java.beans.EventSetDescriptor composite = new java.beans.EventSetDescriptor(old, esd);
    ...
    private java.beans.BeanDescriptor getTargetBeanDescriptor() {
        ...
        if (explicitBeanInfo != null) {
            java.beans.BeanDescriptor bd = explicitBeanInfo.getBeanDescriptor();
            if (bd != null) {
                return (bd);
            }
        }
        // OK, fabricate a default BeanDescriptor.
        return new java.beans.BeanDescriptor(this.beanClass, findCustomizerClass(this.beanClass));
    }
...
class GenericBeanInfo extends SimpleBeanInfo {
    ...
    public GenericBeanInfo(java.beans.BeanDescriptor beanDescriptor,
                           java.beans.EventSetDescriptor[] events, int defaultEvent,
    ...
    GenericBeanInfo(GenericBeanInfo old) {
        ...
        beanDescriptor = new java.beans.BeanDescriptor(old.beanDescriptor);
        if (old.events != null) {
            int len = old.events.length;
            events = new java.beans.EventSetDescriptor[len];
            for (int i = 0; i < len; i++) {
                events[i] = new java.beans.EventSetDescriptor(old.events[i]);
            }
        }
        ...
        if (old.properties != null) {
            ...
            for (int i = 0; i < len; i++) {
                ...
                if (oldp instanceof java.beans.IndexedPropertyDescriptor) {
                    properties[i] = new java.beans.IndexedPropertyDescriptor(
