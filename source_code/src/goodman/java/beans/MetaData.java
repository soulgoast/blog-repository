...
import goodman.java.awt.AWTKeyStroke;
import goodman.java.awt.BorderLayout;
import goodman.java.awt.Dimension;
import goodman.java.awt.Color;
import goodman.java.awt.Font;
import goodman.java.awt.GridBagConstraints;
import goodman.java.awt.Insets;
import goodman.java.awt.Point;
import goodman.java.awt.Rectangle;
import goodman.java.awt.event.KeyEvent;
import goodman.java.awt.font.TextAttribute;

import goodman.java.beans.*;
import goodman.java.beans.ConstructorProperties;
import goodman.java.beans.DefaultPersistenceDelegate;
import goodman.java.beans.Encoder;
import goodman.java.beans.EventHandler;
import goodman.java.beans.Expression;
import goodman.java.beans.IntrospectionException;
import goodman.java.beans.Introspector;
...
import goodman.java.lang.reflect.Modifier;
...
import goodman.javax.swing.Box;
import goodman.javax.swing.JLayeredPane;
import goodman.javax.swing.border.MatteBorder;
import goodman.javax.swing.plaf.ColorUIResource;
...
static final class NullPersistenceDelegate extends PersistenceDelegate {
    ...
    protected java.beans.Expression instantiate(Object oldInstance, java.beans.Encoder out) { return null; }
...
static final class EnumPersistenceDelegate extends PersistenceDelegate {
    ...
    protected java.beans.Expression instantiate(Object oldInstance, java.beans.Encoder out) {
        ...
        return new java.beans.Expression(e, Enum.class, "valueOf", new Object[]{e.getDeclaringClass(), e.name()});
    }
}
...
static final class PrimitivePersistenceDelegate extends PersistenceDelegate {
    ...
    protected java.beans.Expression instantiate(Object oldInstance, java.beans.Encoder out) {
        return new java.beans.Expression(oldInstance, oldInstance.getClass(),
...
static final class ArrayPersistenceDelegate extends PersistenceDelegate {
    ...
    protected java.beans.Expression instantiate(Object oldInstance, java.beans.Encoder out) {
        ...
        return new java.beans.Expression(oldInstance, Array.class, "newInstance",
    ...
    protected void initialize(Class<?> type, Object oldInstance, Object newInstance, java.beans.Encoder out) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            java.beans.Expression oldGetExp = new java.beans.Expression(oldInstance, "get", new Object[]{index});
            java.beans.Expression newGetExp = new java.beans.Expression(newInstance, "get", new Object[]{index});
            try {
                ...
                if (!Objects.equals(newValue, out.get(oldValue))) {
                    ...
                    java.beans.DefaultPersistenceDelegate.invokeStatement(oldInstance, "set", new Object[]{index, oldValue}, out);
                }
            }
            catch (Exception e) {
...
static final class ProxyPersistenceDelegate extends PersistenceDelegate {
    protected java.beans.Expression instantiate(Object oldInstance, java.beans.Encoder out) {
        ...
        if (ih instanceof java.beans.EventHandler) {
            java.beans.EventHandler eh = (java.beans.EventHandler)ih;
...
static final class java_lang_Class_PersistenceDelegate extends PersistenceDelegate {
    ...
    protected java.beans.Expression instantiate(Object oldInstance, java.beans.Encoder out) {
        ...
        if (c.isPrimitive()) {
            ...
            return new java.beans.Expression(oldInstance, field, "get", new Object[]{null});
        }
        else if (oldInstance == String.class) {
            return new java.beans.Expression(oldInstance, "", "getClass", new Object[]{});
        }
        else if (oldInstance == Class.class) {
            return new java.beans.Expression(oldInstance, String.class, "getClass", new Object[]{});
        }
        else {
            java.beans.Expression newInstance = new java.beans.Expression(oldInstance, Class.class, "forName", new Object[] { c.getName() });
...
static class java_util_Date_PersistenceDelegate extends PersistenceDelegate {
    ...
    protected java.beans.Expression instantiate(Object oldInstance, java.beans.Encoder out) {
        ...
        return new java.beans.Expression(date, date.getClass(), "new", new Object[] {date.getTime()});
    }
}
...
private static abstract class java_util_Collections extends PersistenceDelegate {
    ...
    static final class EmptyList_PersistenceDelegate extends java_util_Collections {
        protected java.beans.Expression instantiate(Object oldInstance, java.beans.Encoder out) {
            return new java.beans.Expression(oldInstance, Collections.class, "emptyList", null);
        }
    }

    static final class EmptySet_PersistenceDelegate extends java_util_Collections {
        protected java.beans.Expression instantiate(Object oldInstance, java.beans.Encoder out) {
            return new java.beans.Expression(oldInstance, Collections.class, "emptySet", null);
        }
    }

    static final class EmptyMap_PersistenceDelegate extends java_util_Collections {
        protected java.beans.Expression instantiate(Object oldInstance, java.beans.Encoder out) {
            return new java.beans.Expression(oldInstance, Collections.class, "emptyMap", null);
        }
    }
    ...
    static final class SingletonList_PersistenceDelegate extends java_util_Collections {
        protected java.beans.Expression instantiate(Object oldInstance, java.beans.Encoder out) {
            ...
            return new java.beans.Expression(oldInstance, Collections.class, "singletonList", new Object[]{list.get(0)});
        }
    }
    ...
    static final class SingletonSet_PersistenceDelegate extends java_util_Collections {
        protected java.beans.Expression instantiate(Object oldInstance, java.beans.Encoder out) {
            ...
            return new java.beans.Expression(oldInstance, Collections.class, "singleton", new Object[]{set.iterator().next()});
        }
    }
    ...
    static final class SingletonMap_PersistenceDelegate extends java_util_Collections {
        protected java.beans.Expression instantiate(Object oldInstance, java.beans.Encoder out) {
            ...
            return new java.beans.Expression(oldInstance, Collections.class, "singletonMap", new Object[]{key, map.get(key)});
        }
    }
    ...
    static final class UnmodifiableCollection_PersistenceDelegate extends java_util_Collections {
        protected java.beans.Expression instantiate(Object oldInstance, java.beans.Encoder out) {
            ...
            return new java.beans.Expression(oldInstance, Collections.class, "unmodifiableCollection", new Object[]{list});
        }
    }
    ...
    static final class UnmodifiableList_PersistenceDelegate extends java_util_Collections {
        protected java.beans.Expression instantiate(Object oldInstance, java.beans.Encoder out) {
            ...
            return new java.beans.Expression(oldInstance, Collections.class, "unmodifiableList", new Object[]{list});
        }
    }
    ...
    static final class UnmodifiableSet_PersistenceDelegate extends java_util_Collections {
        protected java.beans.Expression instantiate(Object oldInstance, java.beans.Encoder out) {
            ...
            return new java.beans.Expression(oldInstance, Collections.class, "unmodifiableSet", new Object[]{set});
        }
    }
    ...
    static final class UnmodifiableSortedSet_PersistenceDelegate extends java_util_Collections {
        protected java.beans.Expression instantiate(Object oldInstance, java.beans.Encoder out) {
            ...
            return new java.beans.Expression(oldInstance, Collections.class, "unmodifiableSortedSet", new Object[]{set});
        }
    }
    ...
    static final class UnmodifiableMap_PersistenceDelegate extends java_util_Collections {
        protected java.beans.Expression instantiate(Object oldInstance, java.beans.Encoder out) {
            ...
            return new java.beans.Expression(oldInstance, Collections.class, "unmodifiableMap", new Object[]{map});
        }
    }
    ...
    static final class UnmodifiableSortedMap_PersistenceDelegate extends java_util_Collections {
        protected java.beans.Expression instantiate(Object oldInstance, java.beans.Encoder out) {
            ...
            return new java.beans.Expression(oldInstance, Collections.class, "unmodifiableSortedMap", new Object[]{map});
        }
    }
    ...
    static final class SynchronizedCollection_PersistenceDelegate extends java_util_Collections {
        protected java.beans.Expression instantiate(Object oldInstance, java.beans.Encoder out) {
            List<?> list = new ArrayList<>((Collection<?>) oldInstance);
            return new java.beans.Expression(oldInstance, Collections.class, "synchronizedCollection", new Object[]{list});
        }
    }
    ...
    static final class SynchronizedList_PersistenceDelegate extends java_util_Collections {
        protected java.beans.Expression instantiate(Object oldInstance, java.beans.Encoder out) {
            List<?> list = new LinkedList<>((Collection<?>) oldInstance);
            return new java.beans.Expression(oldInstance, Collections.class, "synchronizedList", new Object[]{list});
        }
    }
    ...
    static final class SynchronizedSet_PersistenceDelegate extends java_util_Collections {
        protected java.beans.Expression instantiate(Object oldInstance, java.beans.Encoder out) {
            Set<?> set = new HashSet<>((Set<?>) oldInstance);
            return new java.beans.Expression(oldInstance, Collections.class, "synchronizedSet", new Object[]{set});
        }
    }
    ...
    static final class SynchronizedSortedSet_PersistenceDelegate extends java_util_Collections {
        protected java.beans.Expression instantiate(Object oldInstance, java.beans.Encoder out) {
            SortedSet<?> set = new TreeSet<>((SortedSet<?>) oldInstance);
            return new java.beans.Expression(oldInstance, Collections.class, "synchronizedSortedSet", new Object[]{set});
        }
    }
    ...
    static final class SynchronizedMap_PersistenceDelegate extends java_util_Collections {
        protected java.beans.Expression instantiate(Object oldInstance, java.beans.Encoder out) {
            Map<?,?> map = new HashMap<>((Map<?,?>) oldInstance);
            return new java.beans.Expression(oldInstance, Collections.class, "synchronizedMap", new Object[]{map});
        }
    }
    ...
    static final class SynchronizedSortedMap_PersistenceDelegate extends java_util_Collections {
        protected java.beans.Expression instantiate(Object oldInstance, java.beans.Encoder out) {
            SortedMap<?,?> map = new TreeMap<>((SortedMap<?,?>) oldInstance);
            return new java.beans.Expression(oldInstance, Collections.class, "synchronizedSortedMap", new Object[]{map});
        }
    }
    ...
    static final class CheckedCollection_PersistenceDelegate extends java_util_Collections {
        protected java.beans.Expression instantiate(Object oldInstance, java.beans.Encoder out) {
            ...
            List<?> list = new ArrayList<>((Collection<?>) oldInstance);
            return new java.beans.Expression(oldInstance, Collections.class, "checkedCollection", new Object[]{list, type});
        }
    }
    ...
    static final class CheckedList_PersistenceDelegate extends java_util_Collections {
        protected java.beans.Expression instantiate(Object oldInstance, java.beans.Encoder out) {
            Object type = MetaData.getPrivateFieldValue(oldInstance, "java.util.Collections$CheckedCollection.type");
            List<?> list = new LinkedList<>((Collection<?>) oldInstance);
            return new java.beans.Expression(oldInstance, Collections.class, "checkedList", new Object[]{list, type});
        }
    }
    ...
    static final class CheckedSet_PersistenceDelegate extends java_util_Collections {
        protected java.beans.Expression instantiate(Object oldInstance, java.beans.Encoder out) {
            Object type = MetaData.getPrivateFieldValue(oldInstance, "java.util.Collections$CheckedCollection.type");
            Set<?> set = new HashSet<>((Set<?>) oldInstance);
            return new java.beans.Expression(oldInstance, Collections.class, "checkedSet", new Object[]{set, type});
        }
    }
    ...
    static final class CheckedSortedSet_PersistenceDelegate extends java_util_Collections {
        protected java.beans.Expression instantiate(Object oldInstance, java.beans.Encoder out) {
            Object type = MetaData.getPrivateFieldValue(oldInstance, "java.util.Collections$CheckedCollection.type");
            SortedSet<?> set = new TreeSet<>((SortedSet<?>) oldInstance);
            return new java.beans.Expression(oldInstance, Collections.class, "checkedSortedSet", new Object[]{set, type});
        }
    }
    ...
    static final class CheckedMap_PersistenceDelegate extends java_util_Collections {
        protected java.beans.Expression instantiate(Object oldInstance, java.beans.Encoder out) {
            ...
            Map<?,?> map = new HashMap<>((Map<?,?>) oldInstance);
            return new java.beans.Expression(oldInstance, Collections.class, "checkedMap", new Object[]{map, keyType, valueType});
        }
    }
    ...
    static final class CheckedSortedMap_PersistenceDelegate extends java_util_Collections {
        protected java.beans.Expression instantiate(Object oldInstance, java.beans.Encoder out) {
            ...
            Object valueType = MetaData.getPrivateFieldValue(oldInstance, "java.util.Collections$CheckedMap.valueType");
            SortedMap<?,?> map = new TreeMap<>((SortedMap<?,?>) oldInstance);
            return new java.beans.Expression(oldInstance, Collections.class, "checkedSortedMap", new Object[]{map, keyType, valueType});
        }
    }
}
...
static final class java_util_EnumMap_PersistenceDelegate extends PersistenceDelegate {
    ...
    protected java.beans.Expression instantiate(Object oldInstance, java.beans.Encoder out) {
        return new java.beans.Expression(oldInstance, EnumMap.class, "new", new Object[] {getType(oldInstance)});
    }
...
static final class java_util_EnumSet_PersistenceDelegate extends PersistenceDelegate {
    ...
    protected java.beans.Expression instantiate(Object oldInstance, java.beans.Encoder out) {
        return new java.beans.Expression(oldInstance, EnumSet.class, "noneOf", new Object[] {getType(oldInstance)});
    }
...
// Collection
static class java_util_Collection_PersistenceDelegate extends java.beans.DefaultPersistenceDelegate {
    protected void initialize(Class<?> type, Object oldInstance, Object newInstance, java.beans.Encoder out) {
...
// List
static class java_util_List_PersistenceDelegate extends java.beans.DefaultPersistenceDelegate {
    protected void initialize(Class<?> type, Object oldInstance, Object newInstance, java.beans.Encoder out) {
...
// Map
static class java_util_Map_PersistenceDelegate extends java.beans.DefaultPersistenceDelegate {
    protected void initialize(Class<?> type, Object oldInstance, Object newInstance, java.beans.Encoder out) {
        ...
        for ( Object oldKey : oldMap.keySet() ) {
            java.beans.Expression oldGetExp = new java.beans.Expression(oldInstance, "get", new Object[]{oldKey});
            // Pending: should use newKey.
            java.beans.Expression newGetExp = new java.beans.Expression(newInstance, "get", new Object[]{oldKey});
            try {
                Object oldValue = oldGetExp.getValue();
                Object newValue = newGetExp.getValue();
                out.writeExpression(oldGetExp);
 ...
 * It is impossible to use {@link java.beans.DefaultPersistenceDelegate}
...
static final class java_awt_Insets_PersistenceDelegate extends PersistenceDelegate {
    ...
    protected java.beans.Expression instantiate(Object oldInstance, java.beans.Encoder out) {
        ...
        return new java.beans.Expression(insets, insets.getClass(), "new", args);
    }
}
...
static final class java_awt_Font_PersistenceDelegate extends PersistenceDelegate {
    ...
    protected java.beans.Expression instantiate(Object oldInstance, java.beans.Encoder out) {
        ...
        if (count == clone.size()) {
            return new java.beans.Expression(font, type, "new", new Object[]{family, style, size});
        }
        if (type == Font.class) {
            return new java.beans.Expression(font, type, "getFont", new Object[]{clone});
        }
        return new java.beans.Expression(font, type, "new", new Object[]{Font.getFont(clone)});
    }
}
...
static final class java_awt_AWTKeyStroke_PersistenceDelegate extends PersistenceDelegate {
    ...
    protected java.beans.Expression instantiate(Object oldInstance, java.beans.Encoder out) {
        ...
        return new java.beans.Expression( key, type, "get" + name, args );
    }
}
        ...
        if (Modifier.isPublic(cls.getModifiers()) && isPackageAccessible(cls)) {
            ...
            for(int i = 0; i < fields.length; i++) {
                ...
                if (Object.class.isAssignableFrom(field.getType())) {
                    out.writeExpression(new java.beans.Expression(field, "get", new Object[]{null}));
                }
            }
        }
    }
...
static final class java_awt_MenuShortcut_PersistenceDelegate extends PersistenceDelegate {
    ...
    protected java.beans.Expression instantiate(Object oldInstance, java.beans.Encoder out) {
        ...
        return new java.beans.Expression(oldInstance, m.getClass(), "new",
                   new Object[]{new Integer(m.getKey()), Boolean.valueOf(m.usesShiftModifier())});
    }
}

// Component
static final class java_awt_Component_PersistenceDelegate extends java.beans.DefaultPersistenceDelegate {
    protected void initialize(Class<?> type, Object oldInstance, Object newInstance, java.beans.Encoder out) {
...
// Container
static final class java_awt_Container_PersistenceDelegate extends java.beans.DefaultPersistenceDelegate {
    protected void initialize(Class<?> type, Object oldInstance, Object newInstance, java.beans.Encoder out) {
        super.initialize(type, oldInstance, newInstance, out);
...
// Choice
static final class java_awt_Choice_PersistenceDelegate extends java.beans.DefaultPersistenceDelegate {
    protected void initialize(Class<?> type, Object oldInstance, Object newInstance, java.beans.Encoder out) {
        super.initialize(type, oldInstance, newInstance, out);
...
// Menu
static final class java_awt_Menu_PersistenceDelegate extends java.beans.DefaultPersistenceDelegate {
    protected void initialize(Class<?> type, Object oldInstance, Object newInstance, java.beans.Encoder out) {
        super.initialize(type, oldInstance, newInstance, out);
...
// MenuBar
static final class java_awt_MenuBar_PersistenceDelegate extends java.beans.DefaultPersistenceDelegate {
    protected void initialize(Class<?> type, Object oldInstance, Object newInstance, java.beans.Encoder out) {
        super.initialize(type, oldInstance, newInstance, out);
...
// List
static final class java_awt_List_PersistenceDelegate extends java.beans.DefaultPersistenceDelegate {
    protected void initialize(Class<?> type, Object oldInstance, Object newInstance, java.beans.Encoder out) {
        super.initialize(type, oldInstance, newInstance, out);
...
// BorderLayout
static final class java_awt_BorderLayout_PersistenceDelegate extends java.beans.DefaultPersistenceDelegate {
...
// CardLayout
static final class java_awt_CardLayout_PersistenceDelegate extends java.beans.DefaultPersistenceDelegate {
    protected void initialize(Class<?> type, Object oldInstance,
                              Object newInstance, java.beans.Encoder out) {
        super.initialize(type, oldInstance, newInstance, out);
...
// GridBagLayout
static final class java_awt_GridBagLayout_PersistenceDelegate extends java.beans.DefaultPersistenceDelegate {
    protected void initialize(Class<?> type, Object oldInstance,
                              Object newInstance, java.beans.Encoder out) {
        super.initialize(type, oldInstance, newInstance, out);
...
// will appear blank).
static final class javax_swing_JFrame_PersistenceDelegate extends java.beans.DefaultPersistenceDelegate {
    protected void initialize(Class<?> type, Object oldInstance, Object newInstance, java.beans.Encoder out) {
        super.initialize(type, oldInstance, newInstance, out);
...
// DefaultListModel
static final class javax_swing_DefaultListModel_PersistenceDelegate extends java.beans.DefaultPersistenceDelegate {
    protected void initialize(Class<?> type, Object oldInstance, Object newInstance, java.beans.Encoder out) {
...
static final class javax_swing_DefaultComboBoxModel_PersistenceDelegate extends java.beans.DefaultPersistenceDelegate {
    protected void initialize(Class<?> type, Object oldInstance, Object newInstance, java.beans.Encoder out) {
        super.initialize(type, oldInstance, newInstance, out);
...
static final class javax_swing_tree_DefaultMutableTreeNode_PersistenceDelegate extends java.beans.DefaultPersistenceDelegate {
...
static final class javax_swing_ToolTipManager_PersistenceDelegate extends PersistenceDelegate {
    protected java.beans.Expression instantiate(Object oldInstance, java.beans.Encoder out) {
        return new java.beans.Expression(oldInstance, javax.swing.ToolTipManager.class,
                              "sharedInstance", new Object[]{});
    }
}

// JTabbedPane
static final class javax_swing_JTabbedPane_PersistenceDelegate extends java.beans.DefaultPersistenceDelegate {
    protected void initialize(Class<?> type, Object oldInstance, Object newInstance, java.beans.Encoder out) {
        super.initialize(type, oldInstance, newInstance, out);
...
// Box
static final class javax_swing_Box_PersistenceDelegate extends java.beans.DefaultPersistenceDelegate {
    protected boolean mutatesTo(Object oldInstance, Object newInstance) {
        return super.mutatesTo(oldInstance, newInstance) && getAxis(oldInstance).equals(getAxis(newInstance));
    }

    protected java.beans.Expression instantiate(Object oldInstance, java.beans.Encoder out) {
        return new java.beans.Expression(oldInstance, oldInstance.getClass(), "new", new Object[] {getAxis(oldInstance)});
    }
...
static final class javax_swing_JMenu_PersistenceDelegate extends java.beans.DefaultPersistenceDelegate {
    protected void initialize(Class<?> type, Object oldInstance, Object newInstance, java.beans.Encoder out) {
        super.initialize(type, oldInstance, newInstance, out);
...
static final class javax_swing_border_MatteBorder_PersistenceDelegate extends PersistenceDelegate {
    protected java.beans.Expression instantiate(Object oldInstance, java.beans.Encoder out) {
        ...
        return new java.beans.Expression(border, border.getClass(), "new", args);
    }
}
...
static final class sun_swing_PrintColorUIResource_PersistenceDelegate extends PersistenceDelegate {
    ...
    private static PersistenceDelegate defaultPersistenceDelegate = new java.beans.DefaultPersistenceDelegate();
    ...
    private static String[] getAnnotationValue(Constructor<?> constructor) {
        java.beans.ConstructorProperties annotation = constructor.getAnnotation(ConstructorProperties.class);
