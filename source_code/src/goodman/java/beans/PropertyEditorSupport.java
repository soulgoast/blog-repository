...
import goodman.java.beans.PropertyEditor;
...
public class PropertyEditorSupport implements PropertyEditor {
    ...
    public void firePropertyChange() {
        java.util.Vector<java.beans.PropertyChangeListener> targets;
        synchronized (this) {
            if (listeners == null) {
                return;
            }
        ...
        for (int i = 0; i < targets.size(); i++) {
            java.beans.PropertyChangeListener target = targets.elementAt(i);
