...
import goodman.java.beans.IndexedPropertyChangeEvent;
import goodman.java.beans.PropertyChangeEvent;
import goodman.java.beans.PropertyChangeListener;
import goodman.java.beans.PropertyChangeListenerProxy;
...
public class PropertyChangeSupport implements Serializable {
    ...
    public void addPropertyChangeListener(java.beans.PropertyChangeListener listener) {
        ...
        if (listener instanceof java.beans.PropertyChangeListenerProxy) {
            java.beans.PropertyChangeListenerProxy proxy =
                   (java.beans.PropertyChangeListenerProxy)listener;
    ...
    public void firePropertyChange(java.beans.PropertyChangeEvent event) {
        ...
        if (oldValue == null || newValue == null || !oldValue.equals(newValue)) {
            ...
            java.beans.PropertyChangeListener[] common = this.map.get(null);
            java.beans.PropertyChangeListener[] named = (name != null)
                        ? this.map.get(name)
                        : null;
    ...
    private static void fire(java.beans.PropertyChangeListener[] listeners, java.beans.PropertyChangeEvent event) {
        if (listeners != null) {
    ...
    private void writeObject(ObjectOutputStream s) throws IOException {
        ...
        java.beans.PropertyChangeListener[] listeners = null;
        synchronized (this.map) {
            for (Entry<String, java.beans.PropertyChangeListener[]> entry : this.map.getEntries()) {
    ...
    private void readObject(ObjectInputStream s) throws ClassNotFoundException, IOException {
        ...
        while (null != (listenerOrNull = s.readObject())) {
            this.map.add(null, (java.beans.PropertyChangeListener)listenerOrNull);
        }
        if (children != null) {
            for (Entry<String, PropertyChangeSupport> entry : children.entrySet()) {
                for (java.beans.PropertyChangeListener listener : entry.getValue().getPropertyChangeListeners()) {
     ...
     * that works with {@link java.beans.PropertyChangeListener PropertyChangeListener} objects.
     */
    private static final class PropertyChangeListenerMap extends java.beans.ChangeListenerMap<java.beans.PropertyChangeListener> {
        private static final java.beans.PropertyChangeListener[] EMPTY = {};

        /**
         * Creates an array of {@link java.beans.PropertyChangeListener PropertyChangeListener} objects.
        ...
        protected java.beans.PropertyChangeListener[] newArray(int length) {
            return (0 < length)
                    ? new java.beans.PropertyChangeListener[length]
                    : EMPTY;
        }

        /**
         * Creates a {@link java.beans.PropertyChangeListenerProxy PropertyChangeListenerProxy}
         ...
         */
        @Override
        protected java.beans.PropertyChangeListener newProxy(String name, java.beans.PropertyChangeListener listener) {
         ...
         * {@inheritDoc}
         */
        public final java.beans.PropertyChangeListener extract(PropertyChangeListener listener) {
            while (listener instanceof java.beans.PropertyChangeListenerProxy) {
