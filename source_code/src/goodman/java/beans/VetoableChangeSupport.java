...
import goodman.java.beans.ChangeListenerMap;
...
import goodman.java.beans.VetoableChangeListenerProxy;
...
import goodman.java.util.Map.Entry;
 ...
 * The {@link java.beans.VetoableChangeListener} can be registered for all properties
...
public class VetoableChangeSupport implements Serializable {
    ...
    public void addVetoableChangeListener(java.beans.VetoableChangeListener listener) {
        ...
        if (listener instanceof java.beans.VetoableChangeListenerProxy) {
            java.beans.VetoableChangeListenerProxy proxy =
                    (java.beans.VetoableChangeListenerProxy)listener;
     ...
     * }</pre>
     *
     * @see java.beans.VetoableChangeListenerProxy
    ...
    public void fireVetoableChange(java.beans.PropertyChangeEvent event)
        ...
        if (oldValue == null || newValue == null || !oldValue.equals(newValue)) {
            ...
            java.beans.VetoableChangeListener[] common = this.map.get(null);
            java.beans.VetoableChangeListener[] named = (name != null)
                        ? this.map.get(name)
                        : null;

            java.beans.VetoableChangeListener[] listeners;
            if (common == null) {
                listeners = named;
            }
            else if (named == null) {
                ...
                listeners = new java.beans.VetoableChangeListener[common.length + named.length];
    ...
    private void writeObject(ObjectOutputStream s) throws IOException {
        ...
        java.beans.VetoableChangeListener[] listeners = null;
        synchronized (this.map) {
            for (Entry<String, java.beans.VetoableChangeListener[]> entry : this.map.getEntries()) {
        ...
        if (listeners != null) {
            for (java.beans.VetoableChangeListener l : listeners) {
    ...
    private void readObject(ObjectInputStream s) throws ClassNotFoundException, IOException {
        ...
        while (null != (listenerOrNull = s.readObject())) {
            this.map.add(null, (java.beans.VetoableChangeListener)listenerOrNull);
        }
        if (children != null) {
            for (Entry<String, VetoableChangeSupport> entry : children.entrySet()) {
                for (java.beans.VetoableChangeListener listener : entry.getValue().getVetoableChangeListeners()) {
     ...
     * that works with {@link java.beans.VetoableChangeListener VetoableChangeListener} objects.
     */
    private static final class VetoableChangeListenerMap extends java.beans.ChangeListenerMap<java.beans.VetoableChangeListener> {
        private static final java.beans.VetoableChangeListener[] EMPTY = {};

        /**
         * Creates an array of {@link java.beans.VetoableChangeListener VetoableChangeListener} objects.
         ...
         */
        @Override
        protected java.beans.VetoableChangeListener[] newArray(int length) {
            return (0 < length)
                    ? new java.beans.VetoableChangeListener[length]
                    : EMPTY;
        }

        /**
         * Creates a {@link java.beans.VetoableChangeListenerProxy VetoableChangeListenerProxy}
         ...
         */
        @Override
        protected java.beans.VetoableChangeListener newProxy(String name, java.beans.VetoableChangeListener listener) {
            return new java.beans.VetoableChangeListenerProxy(name, listener);
        }

        /**
         * {@inheritDoc}
         */
        public final java.beans.VetoableChangeListener extract(VetoableChangeListener listener) {
            while (listener instanceof java.beans.VetoableChangeListenerProxy) {
