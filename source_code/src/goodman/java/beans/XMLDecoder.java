...
import goodman.java.beans.ExceptionListener;
import goodman.java.beans.Statement;
import goodman.java.beans.XMLEncoder;
...
public class XMLDecoder implements AutoCloseable {
     ...
     */
    public XMLDecoder(InputStream in, Object owner, java.beans.ExceptionListener exceptionListener) {
     ...
     */
    public XMLDecoder(InputStream in, Object owner,
                      java.beans.ExceptionListener exceptionListener, ClassLoader cl) {
     ...
     * @since 1.7
     */
    private XMLDecoder(InputSource is, Object owner, java.beans.ExceptionListener el, ClassLoader cl) {
        this.input = is;
        this.owner = owner;
