...
package goodman.java.concurrent.atomic;
 ...
 *
 * <p>
 * 一个可以进行原子更新的int类型的值。请参阅atomic的规范。
 * 一个AtomicInteger用于诸如原子增量计数器的应用程序中，不能用作Integer的替代品。
 * 但是这个类确实扩展了Number，提供基于数字类的工具和实用程序的统一访问。
 * </p>
 *
 * @since 1.5
 * @author Doug Lea
...
public class AtomicInteger extends Number implements java.io.Serializable {
     ...
     *
     * @param updateFunction a side-effect-free function 无副作用的功能
     * @return the previous value
     * @since 1.8
     */
